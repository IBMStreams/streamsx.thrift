...
#ifndef STREAMS_BOOST_UNITS_DETAIL_STATIC_RATIONAL_POWER_HPP
#define STREAMS_BOOST_UNITS_DETAIL_STATIC_RATIONAL_POWER_HPP
...
struct typeof_pow
{
#if defined(STREAMS_BOOST_UNITS_HAS_STREAMS_BOOST_TYPEOF)
    STREAMS_BOOST_TYPEOF_NESTED_TYPEDEF_TPL(nested, pow(typeof_::make<Y>(), 0.0))
    typedef typename nested::type type;
#elif defined(STREAMS_BOOST_UNITS_HAS_MWERKS_TYPEOF)
    typedef __typeof__(pow(typeof_::make<Y>(), 0.0)) type;
#elif defined(STREAMS_BOOST_UNITS_HAS_GNU_TYPEOF)
