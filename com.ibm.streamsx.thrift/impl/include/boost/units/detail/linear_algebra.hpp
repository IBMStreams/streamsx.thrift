...
#ifndef STREAMS_BOOST_UNITS_DETAIL_LINEAR_ALGEBRA_HPP
#define STREAMS_BOOST_UNITS_DETAIL_LINEAR_ALGEBRA_HPP
...
#include <streams_boost/units/detail/sort.hpp>
...
struct add_zeroes_impl {
    ...
    STREAMS_BOOST_MPL_ASSERT_MSG((N > 0), base_units_are_probably_not_linearly_independent, (void));
    template<class T>
    struct apply {
        typedef list<
            static_rational<0>,
