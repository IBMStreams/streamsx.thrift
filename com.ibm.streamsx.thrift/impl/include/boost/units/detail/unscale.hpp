...
#ifndef STREAMS_BOOST_UNITS_DETAIL_UNSCALE_HPP_INCLUDED
#define STREAMS_BOOST_UNITS_DETAIL_UNSCALE_HPP_INCLUDED
...
/// INTERNAL ONLY
template<>
struct less_impl<streams_boost::units::scale_dim_tag, streams_boost::units::scale_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<streams_boost::units::scale_dim_tag, streams_boost::units::scale_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef streams_boost::units::scale_list_dim<
            streams_boost::units::scale<
                (T0::base),
...
/// INTERNAL ONLY
template<>
struct negate_impl<streams_boost::units::scale_dim_tag>
{
    template<class T0>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct times_impl<streams_boost::units::scale_dim_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
