...
#ifndef STREAMS_BOOST_UNITS_DIM_IMPL_HPP
#define STREAMS_BOOST_UNITS_DIM_IMPL_HPP
...
template<>
struct less_impl<streams_boost::units::detail::dim_tag, streams_boost::units::detail::dim_tag>
{
...
#endif // STREAMS_BOOST_UNITS_DIM_IMPL_HPP
