...
#ifndef STREAMS_BOOST_UNITS_DETAIL_CONVERSION_IMPL_HPP
#define STREAMS_BOOST_UNITS_DETAIL_CONVERSION_IMPL_HPP
...
#include <streams_boost/units/detail/heterogeneous_conversion.hpp>
...
struct base_unit_converter_base<Source, STREAMS_BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Source, typename Source::dimension_type)>
{
...
#define STREAMS_BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, Dest)\
    base_unit_converter<\
...
template<class Source, class Dest>
struct call_base_unit_converter : call_base_unit_converter_impl<STREAMS_BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, Dest)>::template apply<Source, Dest>
{
};

template<class Source, class Dest>
struct call_base_unit_converter<Source, STREAMS_BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Dest, typename Source::dimension_type)> :
    call_base_unit_converter_base_unit_impl<
        STREAMS_BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Source, typename Dest::unit_type),
        STREAMS_BOOST_UNITS_DETAIL_BASE_UNIT_CONVERTER_IS_DEFINED(Dest, typename Source::unit_type)
...
#endif // STREAMS_BOOST_UNITS_CONVERSION_IMPL_HPP
