...
#ifndef STREAMS_BOOST_UNITS_DETAIL_HETEROGENEOUS_CONVERSION_HPP
#define STREAMS_BOOST_UNITS_DETAIL_HETEROGENEOUS_CONVERSION_HPP
...
struct try_add_unit_impl {
    ...
    struct apply {
        ...
        STREAMS_BOOST_STATIC_ASSERT((next::size::value - 1 == type::size::value));
    };
};
