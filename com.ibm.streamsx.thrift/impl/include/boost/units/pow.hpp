...
#ifndef STREAMS_BOOST_UNITS_POW_HPP 
#define STREAMS_BOOST_UNITS_POW_HPP

#include <streams_boost/math_fwd.hpp>
...
{ 
    typedef typename mpl::if_<streams_boost::is_integral<T>, double, T>::type internal_type;
