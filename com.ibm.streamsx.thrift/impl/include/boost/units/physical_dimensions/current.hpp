...
#ifndef STREAMS_BOOST_UNITS_CURRENT_BASE_DIMENSION_HPP
#define STREAMS_BOOST_UNITS_CURRENT_BASE_DIMENSION_HPP
...
struct current_base_dimension : 
    streams_boost::units::base_dimension<current_base_dimension,-6> 
{ };                       
...
STREAMS_BOOST_TYPEOF_REGISTER_TYPE(streams_boost::units::current_base_dimension)
...
#endif // STREAMS_BOOST_UNITS_CURRENT_BASE_DIMENSION_HPP
