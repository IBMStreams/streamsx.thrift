...
#ifndef STREAMS_BOOST_UNITS_PLANE_ANGLE_BASE_DIMENSION_HPP
#define STREAMS_BOOST_UNITS_PLANE_ANGLE_BASE_DIMENSION_HPP
...
struct plane_angle_base_dimension : 
    streams_boost::units::base_dimension<plane_angle_base_dimension,-2> 
{ };               
...
STREAMS_BOOST_TYPEOF_REGISTER_TYPE(streams_boost::units::plane_angle_base_dimension)
...
#endif // STREAMS_BOOST_UNITS_PLANE_ANGLE_BASE_DIMENSION_HPP
