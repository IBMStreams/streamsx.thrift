...
#ifndef STREAMS_BOOST_UNITS_LENGTH_BASE_DIMENSION_HPP
#define STREAMS_BOOST_UNITS_LENGTH_BASE_DIMENSION_HPP
...
struct length_base_dimension : 
    streams_boost::units::base_dimension<length_base_dimension, -9> 
{ }; 
...
STREAMS_BOOST_TYPEOF_REGISTER_TYPE(streams_boost::units::length_base_dimension)
...
#endif // STREAMS_BOOST_UNITS_LENGTH_BASE_DIMENSION_HPP
