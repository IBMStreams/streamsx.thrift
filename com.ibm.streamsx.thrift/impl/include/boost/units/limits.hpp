...
#ifndef STREAMS_BOOST_UNITS_LIMITS_HPP
#define STREAMS_BOOST_UNITS_LIMITS_HPP
...
class numeric_limits< ::streams_boost::units::quantity<Unit, T> >
{
    public:
        typedef ::streams_boost::units::quantity<Unit, T> quantity_type;
...
#endif // STREAMS_BOOST_UNITS_LIMITS_HPP
