...
#ifndef STREAMS_BOOST_UNITS_IO_HPP
#define STREAMS_BOOST_UNITS_IO_HPP
...
#include <streams_boost/units/detail/utility.hpp>
...
inline void serialize(Archive& ar,streams_boost::units::unit<Dim,System>&,const unsigned int /*version*/)
{ }

/// Boost Serialization library support for quantities.
template<class Archive,class Unit,class Y>
inline void serialize(Archive& ar,streams_boost::units::quantity<Unit,Y>& q,const unsigned int /*version*/)
{
    ar & streams_boost::serialization::make_nvp("value", units::quantity_cast<Y&>(q));
}
