...
#ifndef STREAMS_BOOST_UNITS_CONSTANTS_HPP
#define STREAMS_BOOST_UNITS_CONSTANTS_HPP
...
#define STREAMS_BOOST_UNITS_DEFINE_HELPER(name, symbol, template_name)  \
                                                                \
...
STREAMS_BOOST_UNITS_DEFINE_HELPER(add, +, unit)
STREAMS_BOOST_UNITS_DEFINE_HELPER(add, +, quantity)
STREAMS_BOOST_UNITS_DEFINE_HELPER(subtract, -, unit)
STREAMS_BOOST_UNITS_DEFINE_HELPER(subtract, -, quantity)
STREAMS_BOOST_UNITS_DEFINE_HELPER(multiply, *, unit)
STREAMS_BOOST_UNITS_DEFINE_HELPER(multiply, *, quantity)
STREAMS_BOOST_UNITS_DEFINE_HELPER(divide, /, unit)
STREAMS_BOOST_UNITS_DEFINE_HELPER(divide, /, quantity)

#undef STREAMS_BOOST_UNITS_DEFINE_HELPER

#define STREAMS_BOOST_UNITS_DEFINE_HELPER(name, symbol)                     \
                                                                    \
...
STREAMS_BOOST_UNITS_DEFINE_HELPER(add, +)
STREAMS_BOOST_UNITS_DEFINE_HELPER(subtract, -)
STREAMS_BOOST_UNITS_DEFINE_HELPER(multiply, *)
STREAMS_BOOST_UNITS_DEFINE_HELPER(divide, /)

#undef STREAMS_BOOST_UNITS_DEFINE_HELPER

#define STREAMS_BOOST_UNITS_PHYSICAL_CONSTANT(name, type, value_, uncertainty_) \
struct name ## _t {                                                     \
...
STREAMS_BOOST_UNITS_STATIC_CONSTANT(name, streams_boost::units::constant<streams_boost::units::physical_constant<name ## _t> >) = { }
...
{
    streams_boost::io::ios_precision_saver precision_saver(os);
    //streams_boost::io::ios_width_saver width_saver(os);
    streams_boost::io::ios_flags_saver flags_saver(os);
...
#endif // STREAMS_BOOST_UNITS_CONSTANTS_HPP
