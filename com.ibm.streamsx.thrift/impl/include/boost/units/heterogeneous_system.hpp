...
#ifndef STREAMS_BOOST_UNITS_HETEROGENEOUS_SYSTEM_HPP
#define STREAMS_BOOST_UNITS_HETEROGENEOUS_SYSTEM_HPP
...
#include <streams_boost/units/detail/push_front_or_add.hpp>
#include <streams_boost/units/detail/linear_algebra.hpp>
#include <streams_boost/units/detail/unscale.hpp>
...
/// INTERNAL ONLY
#define STREAMS_BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(BaseUnit, Dimensions)   \
    streams_boost::units::unit<                                             \
        Dimensions,                                                 \
        streams_boost::units::heterogeneous_system<                         \
            streams_boost::units::heterogeneous_system_impl<                \
                streams_boost::units::list<                       \
                    streams_boost::units::heterogeneous_system_dim<         \
                        BaseUnit,                                   \
                        streams_boost::units::static_rational<1>            \
                    >,                                              \
                    streams_boost::units::dimensionless_type                \
                >,                                                  \
                Dimensions,                                         \
                streams_boost::units::no_scale                              \
            >                                                       \
        >                                                           \
    >
...
STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(streams_boost::units::heterogeneous_system_impl, (class)(class)(class))
STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(streams_boost::units::heterogeneous_system, (class))
STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(streams_boost::units::heterogeneous_system_dim, (class)(class))
...
/// INTERNAL ONLY
template<>
struct less_impl<streams_boost::units::heterogeneous_system_dim_tag, streams_boost::units::heterogeneous_system_dim_tag>
{
...
/// INTERNAL ONLY
template<>
struct plus_impl<streams_boost::units::heterogeneous_system_dim_tag, streams_boost::units::heterogeneous_system_dim_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef streams_boost::units::heterogeneous_system_dim<
...
/// INTERNAL ONLY
template<>
struct times_impl<streams_boost::units::heterogeneous_system_dim_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct divides_impl<streams_boost::units::heterogeneous_system_dim_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
/// INTERNAL ONLY
template<>
struct negate_impl<streams_boost::units::heterogeneous_system_dim_tag>
{
    template<class T>
    struct apply
    {
        typedef streams_boost::units::heterogeneous_system_dim<typename T::tag_type, typename mpl::negate<typename T::value_type>::type> type;
    };
};
...
struct make_heterogeneous_system
{
    ...
    STREAMS_BOOST_MPL_ASSERT_MSG((!streams_boost::is_same<exponents, inconsistent>::value), the_specified_dimension_is_not_representible_in_the_given_system, (types<Dimensions, System>));
