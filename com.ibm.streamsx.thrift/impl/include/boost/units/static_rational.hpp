...
#ifndef STREAMS_BOOST_UNITS_STATIC_RATIONAL_HPP 
#define STREAMS_BOOST_UNITS_STATIC_RATIONAL_HPP
...
struct static_abs
{
    STREAMS_BOOST_STATIC_CONSTANT(integer_type,value = Value < 0 ? -Value : Value);
};
...
struct make_integral_c {
    typedef streams_boost::mpl::integral_c<integer_type, X> type;
};
...
class static_rational
{
    public:
        ...
        typedef streams_boost::mpl::integral_c<integer_type, N> N_type;
        typedef streams_boost::mpl::integral_c<integer_type, D> D_type;

        typedef typename make_integral_c<
            (::streams_boost::math::static_gcd<
                ::streams_boost::units::static_abs<N>::value,
                ::streams_boost::units::static_abs<D>::value
            >::value)>::type gcd_type;
        typedef typename streams_boost::mpl::eval_if<
            streams_boost::mpl::less<
                D_type,
                streams_boost::mpl::integral_c<integer_type, 0>
            >,
            streams_boost::mpl::negate<gcd_type>,
            gcd_type
        >::type den_type;
    ...
    public: 
        ...
        STREAMS_BOOST_STATIC_CONSTANT(integer_type, Numerator =
            (::streams_boost::mpl::divides<N_type, den_type>::value));
        STREAMS_BOOST_STATIC_CONSTANT(integer_type, Denominator =
            (::streams_boost::mpl::divides<D_type, den_type>::value));
...
class static_rational
{
    private:
        ...
        static const integer_type   den = 
            static_cast<integer_type>(streams_boost::math::static_gcd<nabs,dabs>::value) * ((D < 0) ? -1 : 1);
...
STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(streams_boost::units::static_rational, (long)(long))
...
template<>
struct plus_impl<streams_boost::units::detail::static_rational_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename streams_boost::units::static_rational<
            ::streams_boost::mpl::plus<
                streams_boost::mpl::times<typename T0::N_type, typename T1::D_type>,
                streams_boost::mpl::times<typename T1::N_type, typename T0::D_type>
            >::value,
            ::streams_boost::mpl::times<typename T0::D_type, typename T1::D_type>::value
        >::type type;
    };
};

template<>
struct minus_impl<streams_boost::units::detail::static_rational_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename streams_boost::units::static_rational<
            ::streams_boost::mpl::minus<
                streams_boost::mpl::times<typename T0::N_type, typename T1::D_type>,
                streams_boost::mpl::times<typename T1::N_type, typename T0::D_type>
            >::value,
            ::streams_boost::mpl::times<typename T0::D_type, typename T1::D_type>::value
...
template<>
struct times_impl<streams_boost::units::detail::static_rational_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename streams_boost::units::static_rational<
            ::streams_boost::mpl::times<typename T0::N_type, typename T1::N_type>::value,
            ::streams_boost::mpl::times<typename T0::D_type, typename T1::D_type>::value
        >::type type;
    };
};
...
template<>
struct divides_impl<streams_boost::units::detail::static_rational_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply {
        typedef typename streams_boost::units::static_rational<
            ::streams_boost::mpl::times<typename T0::N_type, typename T1::D_type>::value,
            ::streams_boost::mpl::times<typename T0::D_type, typename T1::N_type>::value
        >::type type;
    };
};

template<>
struct negate_impl<streams_boost::units::detail::static_rational_tag>
{
    template<class T0>
    struct apply {
        typedef typename streams_boost::units::static_rational<
            ::streams_boost::mpl::negate<typename T0::N_type>::value,
            ::streams_boost::mpl::identity<T0>::type::Denominator
        >::type type;
    };
};

template<>
struct less_impl<streams_boost::units::detail::static_rational_tag, streams_boost::units::detail::static_rational_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
struct negate_impl<streams_boost::units::detail::static_rational_tag>
{
    template<class T0>
    struct apply {
        typedef typename streams_boost::units::static_rational<-T0::Numerator,T0::Denominator>::type type;
    };
};
...
#endif // STREAMS_BOOST_UNITS_STATIC_RATIONAL_HPP
