...
#ifndef STREAMS_BOOST_UNITS_QUANTITY_HPP
#define STREAMS_BOOST_UNITS_QUANTITY_HPP
...
template<class T>
struct is_base_unit<T, typename T::streams_boost_units_is_base_unit_type> : mpl::true_ {};
...
struct is_non_narrowing_conversion :
    mpl::and_<
        streams_boost::is_convertible<Source, Destination>,
        mpl::not_<
            mpl::and_<
                streams_boost::is_arithmetic<Source>,
                streams_boost::is_arithmetic<Destination>,
                mpl::or_<
                    mpl::and_<
...
class quantity
{
        ...
        STREAMS_BOOST_MPL_ASSERT_NOT((detail::is_base_unit<Unit>));
    ...
    public:
        ...
        quantity() : val_() 
        { 
            STREAMS_BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
        }
        ...
        quantity(const quantity<Unit,YY>& source,
            typename streams_boost::enable_if<detail::is_non_narrowing_conversion<YY, Y> >::type* = 0) :
            val_(source.value())
        { 
            STREAMS_BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
        }
        ...
        explicit quantity(const quantity<Unit,YY>& source,
            typename streams_boost::disable_if<detail::is_non_narrowing_conversion<YY, Y> >::type* = 0) :
        ...
        { 
            STREAMS_BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_convertible<YY, Y>::value == true));
        }
        ...
        quantity(const quantity<Unit2,YY>& source, 
                 typename streams_boost::disable_if<
                    mpl::and_<
        ...
        template<class Unit2,class YY> 
        quantity(const quantity<Unit2,YY>& source, 
                 typename streams_boost::enable_if<
                     mpl::and_<
                         typename is_implicitly_convertible<Unit2,Unit>::type,
                         detail::is_non_narrowing_conversion<YY, Y>
                     >,
        ...
        this_type& operator=(const quantity<Unit2,YY>& source)
        {
            ...
            STREAMS_BOOST_STATIC_ASSERT((is_implicitly_convertible<Unit2,unit_type>::value == true));
            STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_convertible<YY,Y>::value == true));
        ...
        this_type& operator+=(const quantity<Unit2, YY>& source)
        {
            STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_same<typename add_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ += source.value();
            return *this;
        }  
        ...
        this_type& operator-=(const quantity<Unit2, YY>& source)
        {
            STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_same<typename subtract_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ -= source.value();
            return *this;
        }  
        ...
        this_type& operator*=(const quantity<Unit2, YY>& source)
        {
            STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_same<typename multiply_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ *= source.value();
            return *this;
        }  
        ...
        this_type& operator/=(const quantity<Unit2, YY>& source)
        {
            STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_same<typename divide_typeof_helper<Unit, Unit2>::type, Unit>::value));
            val_ /= source.value();
            return *this;
        }
...
class quantity<STREAMS_BOOST_UNITS_DIMENSIONLESS_UNIT(System),Y>
{
    public:
        ...
        quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            ...
            >::type* = 0
        #else
            typename streams_boost::enable_if<detail::is_non_narrowing_conversion<Y2, Y> >::type* = 0,
            typename detail::disable_if_is_same<System, System2>::type* = 0,
            typename streams_boost::enable_if<detail::is_dimensionless_system<System2> >::type* = 0
        #endif
            ) :
            val_(source.value()) 
        {
        ...
        explicit quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            ...
            typename streams_boost::enable_if<
                streams_boost::mpl::and_<
                    streams_boost::mpl::not_<detail::is_non_narrowing_conversion<Y2, Y> >,
                    detail::is_dimensionless_system<System2>
                > 
            >::type* = 0
        #else
            typename streams_boost::disable_if<detail::is_non_narrowing_conversion<Y2, Y> >::type* = 0,
            typename detail::disable_if_is_same<System, System2>::type* = 0,
            typename streams_boost::enable_if<detail::is_dimensionless_system<System2> >::type* = 0
        #endif
            ) :
        ...
        {
            STREAMS_BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_convertible<Y2, Y>::value == true));
        }
        ...
        template<class System2, class Y2> 
        explicit quantity(const quantity<unit<dimensionless_type, System2>,Y2>& source,
            typename streams_boost::disable_if<detail::is_dimensionless_system<System2> >::type* = 0) :
        ...
        this_type& operator=(const quantity<STREAMS_BOOST_UNITS_DIMENSIONLESS_UNIT(System2),Y>& source)
        {
            *this = this_type(source);
...
STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(streams_boost::units::quantity, 2)
...
#endif // STREAMS_BOOST_UNITS_QUANTITY_HPP
