...
#ifndef STREAMS_BOOST_UNITS_DIMENSION_HPP
#define STREAMS_BOOST_UNITS_DIMENSION_HPP
...
#include <streams_boost/units/detail/dimension_impl.hpp>
...
template<>
struct plus_impl<streams_boost::units::detail::dimension_list_tag,streams_boost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_same<T0,T1>::value == true));
        typedef T0 type;
    };
};

template<>
struct minus_impl<streams_boost::units::detail::dimension_list_tag,streams_boost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
...
template<>
struct times_impl<streams_boost::units::detail::dimension_list_tag,streams_boost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef typename streams_boost::units::detail::merge_dimensions<T0,T1>::type type;
    };
};

template<>
struct divides_impl<streams_boost::units::detail::dimension_list_tag,streams_boost::units::detail::dimension_list_tag>
{
    template<class T0, class T1>
    struct apply
    {
        typedef typename streams_boost::units::detail::merge_dimensions<
            T0,
            typename streams_boost::units::detail::static_inverse_impl<
                T1::size::value
            >::template apply<
                T1
            >::type
...
template<>
struct negate_impl<streams_boost::units::detail::dimension_list_tag>
{
    template<class T0>
    struct apply
    {
...
#endif // STREAMS_BOOST_UNITS_DIMENSION_HPP
