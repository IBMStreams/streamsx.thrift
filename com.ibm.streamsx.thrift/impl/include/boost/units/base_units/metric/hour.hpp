...
#ifndef STREAMS_BOOST_UNIT_SYSTEMS_METRIC_HOUR_HPP_INCLUDED
#define STREAMS_BOOST_UNIT_SYSTEMS_METRIC_HOUR_HPP_INCLUDED
...
typedef scaled_base_unit<streams_boost::units::si::second_base_unit, scale<60, static_rational<2> > > hour_base_unit;
...
#endif // STREAMS_BOOST_UNIT_SYSTEMS_METRIC_HOUR_HPP_INCLUDED
