...
#ifndef STREAMS_BOOST_UNIT_SYSTEMS_METRIC_FERMI_HPP_INCLUDED
#define STREAMS_BOOST_UNIT_SYSTEMS_METRIC_FERMI_HPP_INCLUDED
...
typedef scaled_base_unit<streams_boost::units::si::meter_base_unit, scale<10, static_rational<-15> > > fermi_base_unit;
...
#endif // STREAMS_BOOST_UNIT_SYSTEMS_METRIC_FERMI_HPP_INCLUDED
