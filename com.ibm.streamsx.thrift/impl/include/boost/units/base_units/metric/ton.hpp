...
#ifndef STREAMS_BOOST_UNIT_SYSTEMS_METRIC_TON_HPP_INCLUDED
#define STREAMS_BOOST_UNIT_SYSTEMS_METRIC_TON_HPP_INCLUDED
...
//typedef scaled_base_unit<streams_boost::units::cgs::gram_base_unit, scale<10, static_rational<6> > > ton_base_unit;
typedef scaled_base_unit<streams_boost::units::si::kilogram_base_unit, scale<1000, static_rational<1> > > ton_base_unit;
...
#endif // STREAMS_BOOST_UNIT_SYSTEMS_METRIC_TON_HPP_INCLUDED
