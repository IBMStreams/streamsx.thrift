...
#ifndef STREAMS_BOOST_UNITS_ANGLE_RADIAN_BASE_UNIT_HPP
#define STREAMS_BOOST_UNITS_ANGLE_RADIAN_BASE_UNIT_HPP
...
STREAMS_BOOST_TYPEOF_REGISTER_TYPE(streams_boost::units::angle::radian_base_unit)

#endif

//#include <streams_boost/units/base_units/angle/conversions.hpp>

#endif // STREAMS_BOOST_UNITS_ANGLE_RADIAN_BASE_UNIT_HPP
