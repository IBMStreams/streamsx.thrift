...
#ifndef STREAMS_BOOST_UNITS_CONVERSION_HPP
#define STREAMS_BOOST_UNITS_CONVERSION_HPP

#include <streams_boost/units/detail/conversion_impl.hpp>
...
#define STREAMS_BOOST_UNITS_DEFINE_CONVERSION_FACTOR(Source, Destination, type_, value_)    \
    namespace streams_boost {                                                       \
    namespace units {                                                       \
    template<>                                                              \
...
#define STREAMS_BOOST_UNITS_DEFINE_CONVERSION_FACTOR_TEMPLATE(Params, Source, Destination, type_, value_)   \
    namespace streams_boost {                                                       \
    namespace units {                                                       \
    template<STREAMS_BOOST_PP_SEQ_ENUM(Params)>                                     \
    struct base_unit_converter<                                             \
        Source,                                                             \
        STREAMS_BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(Destination, typename Source::dimension_type)\
    >                                                                       \
    {                                                                       \
        static const bool is_defined = true;                                \
        typedef type_ type;                                                 \
...
/// same dimensions.
#define STREAMS_BOOST_UNITS_DEFAULT_CONVERSION(Source, Dest)                \
    namespace streams_boost {                                               \
    namespace units {                                               \
    template<>                                                      \
...
/// base unit.
#define STREAMS_BOOST_UNITS_DEFAULT_CONVERSION_TEMPLATE(Params, Source, Dest)   \
    namespace streams_boost {                                                   \
    namespace units {                                                   \
    template<STREAMS_BOOST_PP_SEQ_ENUM(Params)>                                 \
...
/// INTERNAL ONLY
/// Users should not create their units in namespace streams_boost::units.
...
#define STREAMS_BOOST_UNITS_DEFINE_BASE_UNIT_WITH_CONVERSIONS(namespace_, name_, name_string_, symbol_string_, factor, unit, id)\
namespace streams_boost {                                                           \
namespace units {                                                           \
...
STREAMS_BOOST_UNITS_DEFINE_CONVERSION_FACTOR(namespace_::name_ ## _base_unit, unit, double, factor); \
STREAMS_BOOST_UNITS_DEFAULT_CONVERSION(namespace_::name_ ## _base_unit, unit)
...
#endif // STREAMS_BOOST_UNITS_CONVERSION_HPP
