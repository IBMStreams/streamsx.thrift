...
#if !defined(STREAMS_BOOST_FUNCTIONAL_HASH_EXTENSIONS_HPP)
#define STREAMS_BOOST_FUNCTIONAL_HASH_EXTENSIONS_HPP
...
namespace streams_boost
{
    ...
    namespace hash_detail
    {
        ...
        struct call_hash_impl<true>
        {
            ...
            struct inner
            {
...
#endif
                {
                    ...
                    return streams_boost::hash_range(v, v + size);
                }
            };
        };
        ...
        template <class T>
        struct call_hash
            : public call_hash_impl<streams_boost::is_array<T>::value>
        ...
        : std::unary_function<T[n], std::size_t>
    {
        ...
        {
            return streams_boost::hash_range(val, val+n);
        }
    };
#endif
    ...
    // On compilers without partial specialization, streams_boost::hash<T>
    ...
    namespace hash_detail
    {
        ...
        struct hash_impl_msvc2
            : public hash_impl_msvc<streams_boost::is_const<T>::value>
                    ::STREAMS_BOOST_NESTED_TEMPLATE inner<T> {};
