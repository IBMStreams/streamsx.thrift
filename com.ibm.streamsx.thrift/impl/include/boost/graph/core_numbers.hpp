...
//=======================================================================
//
#ifndef STREAMS_BOOST_GRAPH_CORE_NUMBERS_HPP
#define STREAMS_BOOST_GRAPH_CORE_NUMBERS_HPP
...
namespace streams_boost {
    ...
    namespace detail {
        ...
        class constant_value_property_map
          : public streams_boost::put_get_helper<ValueType,
        ...
        core_numbers_impl(Graph& g, CoreMap c, PositionMap pos, Visitor vis)
        {
            ...
            std::copy(streams_boost::make_reverse_iterator(bin.end()-2),
                streams_boost::make_reverse_iterator(bin.begin()),
                streams_boost::make_reverse_iterator(bin.end()-1));
...
#endif // STREAMS_BOOST_GRAPH_CORE_NUMBERS_HPP
