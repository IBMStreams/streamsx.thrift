...
//=======================================================================
//
#ifndef STREAMS_BOOST_GRAPH_MATRIX2GRAPH_HPP
#define STREAMS_BOOST_GRAPH_MATRIX2GRAPH_HPP

#include <utility>
#include <streams_boost/config.hpp>
#include <streams_boost/operators.hpp>
#include <streams_boost/int_iterator.hpp>
...
#define STREAMS_BOOST_GRAPH_ADAPT_MATRIX_TO_GRAPH(Matrix)  \
namespace streams_boost { \
  template <> \
  struct graph_traits< Matrix > { \
    ...
    typedef streams_boost::matrix_incidence_iterator<Iter, V> out_edge_iterator; \
    typedef streams_boost::matrix_adj_iterator<Iter, V> adjacency_iterator; \
    typedef Matrix::size_type size_type; \
    typedef streams_boost::int_iterator<size_type> vertex_iterator; \
    \
...
#endif /* STREAMS_BOOST_GRAPH_MATRIX2GRAPH_HPP*/
