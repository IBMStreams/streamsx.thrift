...
#ifndef STREAMS_BOOST_GRAPH_COPY_HPP
#define STREAMS_BOOST_GRAPH_COPY_HPP
...
namespace streams_boost {
                  ...
                  const bgl_named_params<P, T, R>& params)
  {
    ...
    if (n == 0)
      return;
    std::vector<STREAMS_BOOST_DEDUCED_TYPENAME graph_traits<MutableGraph>::vertex_descriptor> 
      orig2copy(n);
...
#endif // STREAMS_BOOST_GRAPH_COPY_HPP
