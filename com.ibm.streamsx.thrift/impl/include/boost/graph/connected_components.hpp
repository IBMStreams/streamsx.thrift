...
//=======================================================================
//
#ifndef STREAMS_BOOST_GRAPH_CONNECTED_COMPONENTS_HPP
#define STREAMS_BOOST_GRAPH_CONNECTED_COMPONENTS_HPP
...
namespace streams_boost {
                       ...
                       STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph, vertex_list_graph_tag))
  {
    ...
    typedef typename streams_boost::graph_traits<Graph>::directed_category directed;
    STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_same<directed, undirected_tag>::value));
...
#endif // STREAMS_BOOST_GRAPH_CONNECTED_COMPONENTS_HPP
