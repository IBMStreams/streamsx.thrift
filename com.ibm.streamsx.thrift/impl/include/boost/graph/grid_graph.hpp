...
#ifndef STREAMS_BOOST_GRAPH_GRID_GRAPH_HPP
#define STREAMS_BOOST_GRAPH_GRID_GRAPH_HPP
...
#define STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS \
  std::size_t DimensionsT, typename VertexIndexT, \
    typename EdgeIndexT

#define STREAMS_BOOST_GRID_GRAPH_TYPE \
  grid_graph<DimensionsT, VertexIndexT, EdgeIndexT>

#define STREAMS_BOOST_GRID_GRAPH_TYPE_MEM typename STREAMS_BOOST_GRID_GRAPH_TYPE::

#define STREAMS_BOOST_GRID_GRAPH_TYPE_TD(mem) \
  typedef typename STREAMS_BOOST_GRID_GRAPH_TYPE::mem mem

#define STREAMS_BOOST_GRID_GRAPH_TRAITS_T \
  typename graph_traits<STREAMS_BOOST_GRID_GRAPH_TYPE >

namespace streams_boost {

  // Class prototype for grid_graph
  template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
  class grid_graph;
  ...
  template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
  struct property_map<STREAMS_BOOST_GRID_GRAPH_TYPE, vertex_index_t> {
    typedef grid_graph_index_map<STREAMS_BOOST_GRID_GRAPH_TYPE,
                                 STREAMS_BOOST_GRID_GRAPH_TRAITS_T::vertex_descriptor,
                                 STREAMS_BOOST_GRID_GRAPH_TRAITS_T::vertices_size_type> type;
    typedef type const_type;
  };

  template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
  struct property_map<STREAMS_BOOST_GRID_GRAPH_TYPE, edge_index_t> {
    typedef grid_graph_index_map<STREAMS_BOOST_GRID_GRAPH_TYPE,
                                 STREAMS_BOOST_GRID_GRAPH_TRAITS_T::edge_descriptor,
                                 STREAMS_BOOST_GRID_GRAPH_TRAITS_T::edges_size_type> type;
    typedef type const_type;
  };
  ...
  private:
    typedef streams_boost::array<bool, Dimensions> WrapDimensionArray;
    grid_graph() { };
  ...
  public:
    ...
    // descriptors
    typedef streams_boost::array<VertexIndex, Dimensions> vertex_descriptor;
  ...
  protected:
    ...
    streams_boost::array<edges_size_type, Dimensions> m_edge_count;
  ...
  public:
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline std::pair<STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_iterator,
                            STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_iterator> 
    vertices(const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(vertex_iterator);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(vertex_function);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(vertex_index_iterator);
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline  STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertices_size_type
    num_vertices(const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      return (graph.num_vertices());
    }

    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor
    vertex(STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertices_size_type vertex_index,
           const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline std::pair<STREAMS_BOOST_GRID_GRAPH_TYPE_MEM out_edge_iterator,
                            STREAMS_BOOST_GRID_GRAPH_TYPE_MEM out_edge_iterator>
    out_edges(STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
              const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(degree_iterator);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(out_edge_function);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(out_edge_iterator);
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM degree_size_type
    out_degree
    (STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
     const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      return (graph.out_degree(vertex));
    }

    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor
    out_edge_at(STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
                STREAMS_BOOST_GRID_GRAPH_TYPE_MEM degree_size_type out_edge_index,
                const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
    ...
    template <STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend typename std::pair<STREAMS_BOOST_GRID_GRAPH_TYPE_MEM adjacency_iterator,
                              STREAMS_BOOST_GRID_GRAPH_TYPE_MEM adjacency_iterator>
    adjacent_vertices (STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
                       const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(degree_iterator);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(adjacent_vertex_function);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(adjacency_iterator);
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edges_size_type
    num_edges(const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      return (graph.num_edges());
    }

    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor
    edge_at(STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edges_size_type edge_index,
            const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      return (graph.edge_at(edge_index));
    }

    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline std::pair<STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_iterator,
                            STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_iterator>
    edges(const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(edge_index_iterator);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(edge_function);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(edge_iterator);
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline std::pair<STREAMS_BOOST_GRID_GRAPH_TYPE_MEM in_edge_iterator,
                            STREAMS_BOOST_GRID_GRAPH_TYPE_MEM in_edge_iterator>
    in_edges(STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
             const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(in_edge_function);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(degree_iterator);
      STREAMS_BOOST_GRID_GRAPH_TYPE_TD(in_edge_iterator);
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM degree_size_type
    in_degree (STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
               const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM degree_size_type
    degree (STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
            const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor
    in_edge_at(STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor vertex,
               STREAMS_BOOST_GRID_GRAPH_TYPE_MEM degree_size_type in_edge_index,
               const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
    ...
    template<STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend std::pair<STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor, bool>
    edge (STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor source_vertex,
          STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor destination_vertex,
          const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {

      std::pair<STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor, bool> edge_exists =
      ...
      for (std::size_t dimension_index = 0;
        ...
        STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertices_size_type dim_difference = 0;
        STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertices_size_type
    ...
    get(edge_index_t,
        const STREAMS_BOOST_GRID_GRAPH_TYPE& graph,
        STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor edge) {
      return (graph.index_of(edge));
    }

    template <STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline grid_graph_index_map<
                    STREAMS_BOOST_GRID_GRAPH_TYPE,
                    STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor,
                    STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertices_size_type>
    get(vertex_index_t, const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      return (grid_graph_index_map<
                STREAMS_BOOST_GRID_GRAPH_TYPE,
                STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertex_descriptor,
                STREAMS_BOOST_GRID_GRAPH_TYPE_MEM vertices_size_type>(graph));
    }

    template <STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS>
    friend inline grid_graph_index_map<
                    STREAMS_BOOST_GRID_GRAPH_TYPE,
                    STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor,
                    STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edges_size_type>
    get(edge_index_t, const STREAMS_BOOST_GRID_GRAPH_TYPE& graph) {
      return (grid_graph_index_map<
                STREAMS_BOOST_GRID_GRAPH_TYPE,
                STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edge_descriptor,
                STREAMS_BOOST_GRID_GRAPH_TYPE_MEM edges_size_type>(graph));
    }                                       
...
#undef STREAMS_BOOST_GRID_GRAPH_TYPE
#undef STREAMS_BOOST_GRID_GRAPH_TYPE_TD
#undef STREAMS_BOOST_GRID_GRAPH_TYPE_MEM
#undef STREAMS_BOOST_GRID_GRAPH_TEMPLATE_PARAMS
#undef STREAMS_BOOST_GRID_GRAPH_TRAITS_T

#endif // STREAMS_BOOST_GRAPH_GRID_GRAPH_HPP
