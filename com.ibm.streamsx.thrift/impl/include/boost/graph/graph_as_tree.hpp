...
//=======================================================================
//
#ifndef STREAMS_BOOST_GRAPH_GRAPH_AS_TREE_HPP
#define STREAMS_BOOST_GRAPH_GRAPH_AS_TREE_HPP

#include <vector>
#include <streams_boost/config.hpp>
#include <streams_boost/property_map/property_map.hpp>
#include <streams_boost/graph/tree_traits.hpp>
...
namespace streams_boost {
  ...
  public:
    ...
    friend Node parent(N n, const Tree& t) { 
      return streams_boost::get(t.parent_pa(), n); 
    }
  ...
  public:
    ...
    graph_as_tree(Graph& g, Node root, ParentMap p) : super(g, root), _p(p) { 
      breadth_first_search(g, root, 
                   ...
                   (record_predecessors(p, streams_boost::on_tree_edge()))));
    }
...
#endif //  STREAMS_BOOST_GRAPH_GRAPH_AS_TREE_HPP
