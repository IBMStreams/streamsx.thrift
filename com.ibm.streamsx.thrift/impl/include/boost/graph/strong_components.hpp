...
#ifndef STREAMS_BOOST_GRAPH_STRONG_COMPONENTS_HPP
#define STREAMS_BOOST_GRAPH_STRONG_COMPONENTS_HPP
...
namespace streams_boost {
                    ...
                    STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph, vertex_list_graph_tag))
  {
    ...
    STREAMS_BOOST_STATIC_ASSERT((is_convertible<DirCat*, directed_tag*>::value == true));
...
#include <queue>
#include <vector>
#include <streams_boost/graph/transpose_graph.hpp>
#include <streams_boost/pending/indirect_cmp.hpp>
#include <streams_boost/graph/connected_components.hpp> // for components_recorder
...
#  include <streams_boost/graph/distributed/strong_components.hpp>
#endif

#endif // STREAMS_BOOST_GRAPH_STRONG_COMPONENTS_HPP
