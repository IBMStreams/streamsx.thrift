...
#ifndef STREAMS_BOOST_GRAPH_DETAIL_GEODESIC_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_GEODESIC_HPP
...
namespace detail {
    ...
    struct maximize : public std::binary_function<T, T, T>
    {
        ...
        { STREAMS_BOOST_USING_STD_MAX(); return max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION (x, y); }
    };
