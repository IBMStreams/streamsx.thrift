...
#ifndef STREAMS_BOOST_LIST_BASE_HPP
#define STREAMS_BOOST_LIST_BASE_HPP

#include <streams_boost/iterator_adaptors.hpp>

// Perhaps this should go through formal review, and move to <streams_boost/>.
...
#endif // STREAMS_BOOST_LIST_BASE_HPP
