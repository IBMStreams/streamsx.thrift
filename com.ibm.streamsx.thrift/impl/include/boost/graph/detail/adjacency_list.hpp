...
#ifndef STREAMS_BOOST_GRAPH_DETAIL_ADJACENCY_LIST_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_ADJACENCY_LIST_HPP
...
#include <streams_boost/pending/integer_range.hpp>
...
#include <streams_boost/pending/container_traits.hpp>
#include <streams_boost/graph/detail/adj_list_edge_iterator.hpp>
...
namespace streams_boost {
  ...
  namespace detail {
    ...
    {
      streams_boost::graph_detail::erase_if(el, detail::target_is<vertex_descriptor>(v));
    }
    // O(log(E/V))
    template <class EdgeList, class vertex_descriptor>
    void erase_from_incidence_list(EdgeList& el, vertex_descriptor v,
    ...
    template <class Vertex>
    class stored_edge
      : public streams_boost::equality_comparable1< stored_edge<Vertex>,
        streams_boost::less_than_comparable1< stored_edge<Vertex> > >
    {
    public:
      ...
      const detail::stored_ra_edge_iter<Vertex, EdgeVec, Property>& e)
  {
    ...
    namespace detail {
      ...
      remove_directed_edge_if_dispatch(incidence_iterator first,
                                       ...
                                       streams_boost::allow_parallel_edge_tag)
      {
        // remove_if
      ...
      remove_directed_edge_if_dispatch(incidence_iterator first,
                                       ...
                                       EdgeList& el,
                                       Predicate pred,
                                       streams_boost::disallow_parallel_edge_tag)
      {
                                             ...
                                             streams_boost::allow_parallel_edge_tag)
      {
        ...
        STREAMS_BOOST_STATIC_ASSERT((!is_same<EdgeListS, vecS>::value));
                 ...
                 directed_graph_helper<Config>& g_)
    {
      ...
      for (streams_boost::tie(vi, viend) = vertices(g); vi != viend; ++vi)
    ...
    num_edges(const directed_graph_helper<Config>& g_)
    {
      ...
      typename Config::vertex_iterator vi, vi_end;
      for (streams_boost::tie(vi, vi_end) = vertices(g); vi != vi_end; ++vi)
             ...
             directed_graph_helper<Config>& g_)
    {
      ...
      bool inserted;
      streams_boost::tie(i, inserted) = streams_boost::graph_detail::push(g.out_edge_list(u),
                                            StoredEdge(v, p));
    ...
    namespace detail {
      ...
      remove_edge_and_property(Graph& g, EdgeList& el, Vertex v,
                               streams_boost::allow_parallel_edge_tag cat)
      {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        STREAMS_BOOST_STATIC_ASSERT((!is_same<EdgeListS, vecS>::value));
        ...
        for (; i != end; ++i) {
          if ((*i).get_target() == v) {
            ...
            bool skip = (streams_boost::next(i) != end && i->get_iter() == streams_boost::next(i)->get_iter());
    ...
    struct list_edge // short name due to VC++ truncation and linker problems
      : public streams_boost::detail::edge_base<streams_boost::undirected_tag, Vertex>
    {
      typedef EdgeProperty property_type;
      typedef streams_boost::detail::edge_base<streams_boost::undirected_tag, Vertex> Base;
             ...
             undirected_graph_helper<Config>& g_)
    {
      ...
      if (inserted) {
        streams_boost::graph_detail::push(g.out_edge_list(v), StoredEdge(u, p_iter, &g.m_edges));
             ...
             bidirectional_graph_helper_with_property<Config>& g_)
    {
      ...
      streams_boost::tie(i, inserted) = streams_boost::graph_detail::push(g.out_edge_list(u),
                                        StoredEdge(v, p_iter, &g.m_edges));
      if (inserted) {
        streams_boost::graph_detail::push(in_edge_list(g, v), StoredEdge(u, p_iter, &g.m_edges));
    ...
    struct adj_list_helper : public Base
    {
      ...
      edge_dispatch(const AdjList& g,
                    ...
                    streams_boost::allow_parallel_edge_tag) const
      {
        bool found;
      ...
      edge_dispatch(const AdjList& g,
                    vertex_descriptor u, vertex_descriptor v,
                    streams_boost::disallow_parallel_edge_tag) const
      {
        bool found;
                      ...
                      const adj_list_helper<Config, Base>& g_)
    {
      ...
      typedef typename Config::adjacency_iterator adjacency_iterator;
      typename Config::out_edge_iterator first, last;
      streams_boost::tie(first, last) = out_edges(u, g);
                          ...
                          const adj_list_helper<Config, Base>& g_)
    {
      ...
      typedef typename Config::inv_adjacency_iterator inv_adjacency_iterator;
      typename Config::in_edge_iterator first, last;
      streams_boost::tie(first, last) = in_edges(u, g);
    ...
    namespace detail {
      ...
      inline
      typename streams_boost::property_map<typename Config::graph_type,
        Property>::type
      get_dispatch(adj_list_helper<Config,Base>&, Property,
                   streams_boost::edge_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename streams_boost::property_map<Graph, Property>::type PA;
        return PA();
      }
      template <class Config, class Base, class Property>
      inline
      ...
      get_dispatch(const adj_list_helper<Config,Base>&, Property,
                   streams_boost::edge_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename streams_boost::property_map<Graph, Property>::const_type PA;
        return PA();
      }
      ...
      get_dispatch(adj_list_helper<Config,Base>& g, Property,
                   streams_boost::vertex_property_tag) {
        typedef typename Config::graph_type Graph;
        typedef typename streams_boost::property_map<Graph, Property>::type PA;
    ...
    template <class Config, class Base, class Property>
    inline
    typename streams_boost::property_map<typename Config::graph_type, Property>::type
    ...
    inline
    typename streams_boost::property_traits<
      typename streams_boost::property_map<typename Config::graph_type,
        Property>::type
    >::reference
    ...
    {
      typedef typename Config::graph_type Graph;
      typedef typename streams_boost::property_map<Graph, Property>::type Map;
    ...
    add_vertex(adj_list_impl<Derived, Config, Base>& g_)
    {
      ...
      bool inserted;
      streams_boost::tie(pos,inserted) = streams_boost::graph_detail::push(g.m_vertices, v);
      v->m_position = pos;
      g.added_vertex(v);
      return v;
    }
    ...
    namespace detail {
      ...
      inline void
      remove_vertex_dispatch(Graph& g, vertex_descriptor u,
                             streams_boost::bidirectional_tag)
      {
        typedef typename Graph::global_edgelist_selector EdgeListS;
        STREAMS_BOOST_STATIC_ASSERT((!is_same<EdgeListS, vecS>::value));
    ...
    public:
      ...
      //    protected:
      inline streams_boost::integer_range<vertex_descriptor> vertex_set() const {
        return streams_boost::integer_range<vertex_descriptor>(0, m_vertices.size());
      }
      inline OutEdgeList& out_edge_list(vertex_descriptor v) {
             ...
             vec_adj_list_impl<Graph, Config, Base>& g_)
    {
      ...
      typename Config::vertex_descriptor x = max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(u, v);
  ...
  namespace detail {
    ...
    struct adj_list_gen
    {
      ...
      struct config
      {
        ...
        typedef streams_boost::integer_range<vertex_descriptor> RandVertexList;
        ...
        typedef streams_boost::detail::iterator_traits<OutEdgeIter> OutEdgeIterTraits;
        ...
        typedef streams_boost::detail::iterator_traits<EdgeIter> EdgeIterTraits;
    ...
    struct adj_list_vertex_property_map
      : public streams_boost::put_get_helper<
          Reference,
        ...
        >
    {
      ...
      typedef streams_boost::lvalue_property_map_tag category;
    ...
    struct adj_list_vertex_all_properties_map
      : public streams_boost::put_get_helper<PropRef,
        ...
        >
    {
      typedef ValueType value_type;
      typedef Reference reference;
      typedef typename streams_boost::graph_traits<Graph>::vertex_descriptor key_type;
      typedef streams_boost::lvalue_property_map_tag category;
    ...
    struct vec_adj_list_vertex_all_properties_map
      : public streams_boost::put_get_helper<PropertyRef,
        ...
        >
    {
      ...
      typedef streams_boost::readable_property_map_tag category;
...
namespace streams_boost {
  ...
  #if STREAMS_BOOST_WORKAROUND( _STLPORT_VERSION, >= 0x500 )
  ...
  template <typename V>
  struct hash< streams_boost::detail::stored_edge<V> >
  {
    std::size_t
    operator()(const streams_boost::detail::stored_edge<V>& e) const
    {
  ...
  struct hash< streams_boost::detail::stored_edge_property <V,P> >
  {
    std::size_t
    operator()(const streams_boost::detail::stored_edge_property<V,P>& e) const
    {
      return hash<V>()(e.m_target);
    }
  };
  ...
  struct hash< streams_boost::detail::stored_edge_iter<V,I, P> >
  {
    std::size_t
    operator()(const streams_boost::detail::stored_edge_iter<V,I,P>& e) const
    {
      return hash<V>()(e.m_target);
    }
  };
...
#endif // STREAMS_BOOST_GRAPH_DETAIL_DETAIL_ADJACENCY_LIST_CCT
