...
//=======================================================================//
#ifndef STREAMS_BOOST_GRAPH_DETAIL_SPARSE_ORDERING_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_SPARSE_ORDERING_HPP
...
namespace streams_boost {
  ...
  namespace sparse {
    ...
    class sparse_ordering_queue : public streams_boost::queue<Tp, Sequence>{
    public:      
                         ...
                         ColorMap color, DegreeMap degree)
  {
    ...
    typename streams_boost::graph_traits<Graph>::vertex_iterator ui, ui_end;
