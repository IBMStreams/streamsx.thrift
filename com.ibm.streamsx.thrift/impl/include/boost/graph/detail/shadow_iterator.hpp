...
#ifndef STREAMS_BOOST_SHADOW_ITERATOR_HPP
#define STREAMS_BOOST_SHADOW_ITERATOR_HPP
...
namespace streams_boost {
  ...
  namespace detail {
    ...
    class shadow_proxy
      : streams_boost::operators< shadow_proxy<A,B,D> >
    {
...
namespace std {
  ...
  void swap(streams_boost::detail::shadow_proxy<A1&,B1&,D1> x,
            streams_boost::detail::shadow_proxy<A2&,B2&,D2> y)
  {
    std::swap(x.a, y.a);
    std::swap(x.b, y.b);
  }
...
#endif // STREAMS_BOOST_SHADOW_ITERATOR_HPP
