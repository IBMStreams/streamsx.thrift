...
#ifndef STREAMS_BOOST_READ_GRAPHVIZ_SPIRIT_HPP
#define STREAMS_BOOST_READ_GRAPHVIZ_SPIRIT_HPP

// Phoenix/Spirit set these limits to 3, but I need more.
#define PHOENIX_LIMIT 6
#define STREAMS_BOOST_SPIRIT_CLOSURE_LIMIT 6
...
#include <streams_boost/spirit/include/classic_distinct.hpp>
#include <streams_boost/spirit/include/classic_lists.hpp>
#include <streams_boost/spirit/include/classic_escape_char.hpp>
#include <streams_boost/spirit/include/classic_attribute.hpp>
#include <streams_boost/spirit/include/classic_dynamic.hpp>
#include <streams_boost/spirit/include/classic_actor.hpp>
#include <streams_boost/spirit/include/classic_closure.hpp>
#include <streams_boost/spirit/include/phoenix1.hpp>
#include <streams_boost/spirit/include/phoenix1_binders.hpp>
...
#include <utility>
#include <map>
#include <streams_boost/graph/graphviz.hpp>
...
typedef streams_boost::function2<void, id_t const&, id_t const&> actor_t;
...
/////////////////////////////////////////////////////////////////////////////
struct id_closure : streams_boost::spirit::classic::closure<id_closure, node_t> {
  member1 name;
};


struct node_id_closure : streams_boost::spirit::classic::closure<node_id_closure, node_t> {
  member1 name;
};

struct attr_list_closure : streams_boost::spirit::classic::closure<attr_list_closure, actor_t> {
  member1 prop_actor;
};

struct property_closure : streams_boost::spirit::classic::closure<property_closure, id_t, id_t> {
  member1 key;
  member2 value;
};

struct data_stmt_closure : streams_boost::spirit::classic::closure<data_stmt_closure,
...
struct subgraph_closure : streams_boost::spirit::classic::closure<subgraph_closure,
...
struct dot_grammar : public streams_boost::spirit::classic::grammar<dot_grammar> { 
  mutate_graph& graph_;
  ...
  struct definition {
    ...
    keyword_p("0-9a-zA-Z_") {
      ...
      edgeop = ch_p('-') >> ch_p(streams_boost::ref(edge_head));
...
#ifdef STREAMS_BOOST_GRAPH_DEBUG
                      (std::cout << val("AcTive Node: ") << arg1 << "\n"),
#endif // STREAMS_BOOST_GRAPH_DEBUG
    ...
    typedef streams_boost::spirit::classic::rule<ScannerT> rule_t;
    ...
    void check_undirected() {
      if(self.graph_.is_directed())
          streams_boost::throw_exception(streams_boost::undirected_graph_error());
    }

    void check_directed() {
      if(!self.graph_.is_directed())
          streams_boost::throw_exception(streams_boost::directed_graph_error());
    }
   ...
   void default_edge_prop(id_t const& key, id_t const& value) {
    ...
    // Keywords;
    const streams_boost::spirit::classic::distinct_parser<> keyword_p;
    //
    // rules that make up the grammar
    //
    streams_boost::spirit::classic::rule<ScannerT,id_closure::context_t> ID;
    streams_boost::spirit::classic::rule<ScannerT,property_closure::context_t> a_list;
    streams_boost::spirit::classic::rule<ScannerT,attr_list_closure::context_t> attr_list;
    rule_t port_location;
    rule_t port_angle;
    rule_t port;
    streams_boost::spirit::classic::rule<ScannerT,node_id_closure::context_t> node_id;
    streams_boost::spirit::classic::rule<ScannerT,property_closure::context_t> graph_stmt;
    rule_t attr_stmt;
    streams_boost::spirit::classic::rule<ScannerT,data_stmt_closure::context_t> data_stmt;
    streams_boost::spirit::classic::rule<ScannerT,subgraph_closure::context_t> subgraph;
    rule_t edgeop;
    rule_t edgeRHS;
    rule_t stmt;
    rule_t stmt_list;
...
//
struct dot_skipper : public streams_boost::spirit::classic::grammar<dot_skipper>
{
    dot_skipper() {}
...
#ifdef STREAMS_BOOST_SPIRIT_DEBUG
               STREAMS_BOOST_SPIRIT_DEBUG_RULE(skip);
#endif
        }

      streams_boost::spirit::classic::rule<ScannerT>  skip;
      streams_boost::spirit::classic::rule<ScannerT> const&
...
bool read_graphviz(MultiPassIterator begin, MultiPassIterator end,
  ...
  typedef skip_parser_iteration_policy< streams_boost::detail::graph::dot_skipper>
    iter_policy_t;
  typedef scanner_policies<iter_policy_t> scanner_policies_t;
  typedef scanner<iterator_t, scanner_policies_t> scanner_t;

  ::streams_boost::detail::graph::mutate_graph_impl<MutableGraph> 
      m_graph(graph, dp, node_id);

  ::streams_boost::detail::graph::dot_grammar p(m_graph);
  ::streams_boost::detail::graph::dot_skipper skip_p;
...
#endif // STREAMS_BOOST_READ_GRAPHVIZ_SPIRIT_HPP
