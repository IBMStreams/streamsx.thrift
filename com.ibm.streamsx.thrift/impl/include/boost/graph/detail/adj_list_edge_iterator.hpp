...
//=======================================================================
//
#ifndef STREAMS_BOOST_GRAPH_DETAIL_ADJ_LIST_EDGE_ITERATOR_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_ADJ_LIST_EDGE_ITERATOR_HPP
...
#  define STREAMS_BOOST_GRAPH_NO_OPTIONAL
#endif

#ifdef STREAMS_BOOST_GRAPH_NO_OPTIONAL
#  define STREAMS_BOOST_GRAPH_MEMBER .
#else 
#  define STREAMS_BOOST_GRAPH_MEMBER ->
#  include <streams_boost/optional.hpp>
#endif // ndef STREAMS_BOOST_GRAPH_NO_OPTIONAL
    ...
    public:
      ...
      */
      inline self& operator++() {
        ++edges STREAMS_BOOST_GRAPH_MEMBER first;
        if (edges STREAMS_BOOST_GRAPH_MEMBER first == edges STREAMS_BOOST_GRAPH_MEMBER second) 
        {
          ++vCurr;
          while ( vCurr != vEnd && out_degree(*vCurr, *m_g) == 0 )
            ++vCurr;
      ...
      { return *edges STREAMS_BOOST_GRAPH_MEMBER first; } 
      inline bool operator==(const self& x) const {
        return vCurr == x.vCurr 
          && (vCurr == vEnd 
              || edges STREAMS_BOOST_GRAPH_MEMBER first == x.edges STREAMS_BOOST_GRAPH_MEMBER first);
      }
      inline bool operator!=(const self& x) const {
        return vCurr != x.vCurr 
          || (vCurr != vEnd 
...
#else
      streams_boost::optional<std::pair<OutEdgeIterator, OutEdgeIterator> >
        edges;
#endif // ndef STREAMS_BOOST_GRAPH_NO_OPTIONAL
      const Graph* m_g;
    };
...
#undef STREAMS_BOOST_GRAPH_MEMBER

#endif // STREAMS_BOOST_GRAPH_DETAIL_ADJ_LIST_EDGE_ITERATOR_HPP
