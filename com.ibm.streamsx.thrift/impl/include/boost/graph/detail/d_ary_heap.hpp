...
//=======================================================================
//
#ifndef STREAMS_BOOST_D_ARY_HEAP_HPP
#define STREAMS_BOOST_D_ARY_HEAP_HPP
...
namespace streams_boost {
  ...
  inline void property_map_swap(
         PropMap prop_map,
         const typename streams_boost::property_traits<PropMap>::key_type& ka, 
         const typename streams_boost::property_traits<PropMap>::key_type& kb) {
    typename streams_boost::property_traits<PropMap>::value_type va = get(prop_map, ka);
  ...
  namespace detail {
    ...
    class fixed_max_size_vector {
      streams_boost::shared_array<Value> m_data;
      std::size_t m_size;
  ...
  class d_ary_heap_indirect {
    STREAMS_BOOST_STATIC_ASSERT (Arity >= 2);
    ...
    // distance map
    typedef typename streams_boost::property_traits<DistanceMap>::value_type distance_type;
...
#endif // STREAMS_BOOST_D_ARY_HEAP_HPP
