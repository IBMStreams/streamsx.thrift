...
#ifndef STREAMS_BOOST_GRAPH_DETAIL_EDGE_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_EDGE_HPP
...
namespace std {
  ...
  template <class D, class V>
  std::ostream& 
  operator<<(std::ostream& os, const streams_boost::detail::edge_desc_impl<D,V>& e)
  {
  ...
  operator<<(std::basic_ostream<Char, Traits>& os,
             const streams_boost::detail::edge_desc_impl<D,V>& e)
  {
    return os << "(" << e.m_source << "," << e.m_target << ")";
  }
#endif
...
#endif // STREAMS_BOOST_GRAPH_DETAIL_DETAIL_EDGE_HPP
