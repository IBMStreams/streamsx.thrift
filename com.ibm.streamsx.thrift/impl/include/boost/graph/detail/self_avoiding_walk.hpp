...
//=======================================================================
#ifndef STREAMS_BOOST_SELF_AVOIDING_WALK_HPP
#define STREAMS_BOOST_SELF_AVOIDING_WALK_HPP
...
namespace streams_boost {
  ...
  */
  ...
  {
    typedef typename streams_boost::property_traits<IteratorD>::value_type iter;
    /*use streams_boost shared_ptr*/
