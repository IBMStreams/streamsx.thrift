...
//=======================================================================
#ifndef STREAMS_BOOST_GRAPH_DETAIL_CONNECTED_COMPONENTS_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_CONNECTED_COMPONENTS_HPP
...
namespace streams_boost {
  ...
  namespace detail {
    ...
    class component_iterator 
      : streams_boost::forward_iterator_helper< 
