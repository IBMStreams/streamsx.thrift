...
#ifndef STREAMS_BOOST_GRAPH_DETAIL_INCREMENTAL_COMPONENTS_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_INCREMENTAL_COMPONENTS_HPP
...
namespace streams_boost {
  ...
  namespace detail {
    ...
    class component_index_iterator :
      streams_boost::forward_iterator_helper<component_index_iterator<IndexRandomAccessIterator>,
...
#endif // STREAMS_BOOST_GRAPH_DETAIL_INCREMENTAL_COMPONENTS_HPP
