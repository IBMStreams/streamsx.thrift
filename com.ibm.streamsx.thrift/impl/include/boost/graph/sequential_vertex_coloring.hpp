...
//=======================================================================
#ifndef STREAMS_BOOST_GRAPH_SEQUENTIAL_VERTEX_COLORING_HPP
#define STREAMS_BOOST_GRAPH_SEQUENTIAL_VERTEX_COLORING_HPP
...
#ifdef STREAMS_BOOST_NO_TEMPLATED_ITERATOR_CONSTRUCTORS
#  include <iterator>
#endif
...
namespace streams_boost {
                             ...
                             ColorMap color)
  {
    ...
    std::vector<size_type> mark(V, 
                                std::numeric_limits<size_type>::max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION());
