...
class reverse_graph {
 ...
 public:
  ...
  typedef typename adjacency_iterator_generator<Self,
    ...
    { return m_g[x]; }
#endif // STREAMS_BOOST_GRAPH_NO_BUNDLED_PROPERTIES
...
struct vertex_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename streams_boost::vertex_property_type<BidirectionalGraph>::type type;
};

template <class BidirectionalGraph, class GraphRef>
struct edge_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename streams_boost::edge_property_type<BidirectionalGraph>::type type;
};
...
typename streams_boost::mpl::if_<
           streams_boost::is_const<typename streams_boost::remove_reference<GRef>::type>,
