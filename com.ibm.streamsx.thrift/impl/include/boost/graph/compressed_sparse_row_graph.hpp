...
#ifndef STREAMS_BOOST_GRAPH_COMPRESSED_SPARSE_ROW_GRAPH_HPP
#define STREAMS_BOOST_GRAPH_COMPRESSED_SPARSE_ROW_GRAPH_HPP
...
#include <streams_boost/graph/filtered_graph.hpp> // For keep_all
#include <streams_boost/graph/detail/indexed_properties.hpp>
#include <streams_boost/graph/detail/compressed_sparse_row_struct.hpp>
...
#include <streams_boost/iterator/zip_iterator.hpp>
...
#ifdef STREAMS_BOOST_GRAPH_NO_BUNDLED_PROPERTIES
 ...
 ****************************************************************************/
#define STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS                                  \
  typename Directed, typename VertexProperty, typename EdgeProperty,    \
  typename GraphProperty, typename Vertex, typename EdgeIndex
#define STREAMS_BOOST_CSR_GRAPH_TYPE                                            \
   compressed_sparse_row_graph<Directed, VertexProperty, EdgeProperty,  \
                               GraphProperty, Vertex, EdgeIndex>
#define STREAMS_BOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS                              \
  typename VertexProperty, typename EdgeProperty,                       \
  typename GraphProperty, typename Vertex, typename EdgeIndex
#define STREAMS_BOOST_DIR_CSR_GRAPH_TYPE                                        \
   compressed_sparse_row_graph<directedS, VertexProperty, EdgeProperty, \
                               GraphProperty, Vertex, EdgeIndex>
#define STREAMS_BOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS                            \
  typename VertexProperty, typename EdgeProperty,                       \
  typename GraphProperty, typename Vertex, typename EdgeIndex
#define STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE                                      \
   compressed_sparse_row_graph<bidirectionalS, VertexProperty, EdgeProperty, \
                               GraphProperty, Vertex, EdgeIndex>

namespace detail {
  template <typename T>
  struct default_construct_iterator: public streams_boost::iterator_facade<default_construct_iterator<T>, T, streams_boost::random_access_traversal_tag, const T&> {
    typedef streams_boost::iterator_facade<default_construct_iterator<T>, T, std::random_access_iterator_tag, const T&> base_type;
    T saved_value;
...
class compressed_sparse_row_graph<directedS, VertexProperty, EdgeProperty, GraphProperty, Vertex, EdgeIndex>
   : public detail::indexed_vertex_properties<STREAMS_BOOST_DIR_CSR_GRAPH_TYPE,
                                              VertexProperty, Vertex>
{
 ...
 public:
   ...
   */
  // STREAMS_BOOST_STATIC_ASSERT((is_same<Directed, directedS>::value));
  ...
  compressed_sparse_row_graph(construct_inplace_from_sources_and_targets_t,
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
  {
    m_forward.assign_sources_and_targets_global(sources, targets, numverts, streams_boost::identity_property_map());
  }
  ...
  compressed_sparse_row_graph(construct_inplace_from_sources_and_targets_t,
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
  {
    m_forward.assign_sources_and_targets_global(sources, targets, edge_props, numverts, streams_boost::identity_property_map());
  }
    ...
    : inherited_vertex_properties(numverts), m_property(prop)
  {
    ...
    streams_boost::graph::detail::split_into_separate_coords
  ...
  {
    std::vector<vertex_descriptor> sources, targets;
    streams_boost::graph::detail::split_into_separate_coords_filtered
  ...
  add_edges_internal(InputIterator first, InputIterator last, 
    ...
    typedef typename streams_boost::graph_traits<Graph>::vertex_descriptor vertex_t;
    typedef typename streams_boost::graph_traits<Graph>::vertices_size_type vertex_num;
    typedef typename streams_boost::graph_traits<Graph>::edges_size_type edge_num;
  ...
  add_edges_internal(InputIterator first, InputIterator last,
    ...
    typedef std::vector<
              streams_boost::tuple<vertex_pair,
                           edge_bundled> >
      edge_vector_t;
    edge_vector_t new_edges
      (streams_boost::make_zip_iterator(streams_boost::make_tuple(first, ep_iter)),
       streams_boost::make_zip_iterator(streams_boost::make_tuple(last, ep_iter_end)));
    if (new_edges.empty()) return;
    std::sort(new_edges.begin(), new_edges.end(),
              streams_boost::detail::compare_first<
                std::less<vertex_pair> >());
    m_forward.add_edges_sorted_internal
      (streams_boost::make_transform_iterator(
         new_edges.begin(),
         streams_boost::detail::my_tuple_get_class<0, vertex_pair>()),
       streams_boost::make_transform_iterator(
         new_edges.end(),
         streams_boost::detail::my_tuple_get_class<0, vertex_pair>()),
       streams_boost::make_transform_iterator(
         new_edges.begin(),
         streams_boost::detail::my_tuple_get_class
           <1, edge_bundled>()),
       global_to_local);
  }
...
class compressed_sparse_row_graph<bidirectionalS, VertexProperty, EdgeProperty, GraphProperty, Vertex, EdgeIndex>
   : public detail::indexed_vertex_properties<STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE,
                                              VertexProperty, Vertex>
{
 public:
  typedef detail::indexed_vertex_properties<compressed_sparse_row_graph,
 ...
 public:
  ...
  typedef detail::compressed_sparse_row_structure<EdgeProperty, Vertex, EdgeIndex> forward_type;
  typedef EdgeIndex /* typename streams_boost::mpl::if_c<streams_boost::is_same<EdgeProperty, streams_boost::no_property>, streams_boost::no_property, EdgeIndex> */ backward_edge_property;
  ...
  void set_up_backward_property_links() {
    ...
    m_backward.assign_unsorted_multi_pass_edges
      (detail::transpose_edges(
       ...
       streams_boost::counting_iterator<EdgeIndex>(0),
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertex(STREAMS_BOOST_CSR_GRAPH_TYPE& g) {
  add_vertex(g, typename STREAMS_BOOST_CSR_GRAPH_TYPE::vertex_bundled());
}

template<STREAMS_BOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertex(STREAMS_BOOST_DIR_CSR_GRAPH_TYPE& g, 
           typename STREAMS_BOOST_DIR_CSR_GRAPH_TYPE::vertex_bundled const& p) {
...
template<STREAMS_BOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertex(STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE& g, 
           typename STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE::vertex_bundled const& p) {
  Vertex old_num_verts_plus_one = g.m_forward.m_rowstart.size();
  g.m_forward.m_rowstart.push_back(g.m_forward.m_rowstart.back());
...
template<STREAMS_BOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
add_vertices(typename STREAMS_BOOST_DIR_CSR_GRAPH_TYPE::vertices_size_type count, STREAMS_BOOST_DIR_CSR_GRAPH_TYPE& g) {
  Vertex old_num_verts_plus_one = g.m_forward.m_rowstart.size();
  ...
  // Add edges from a sorted (smallest sources first) range of pairs and edge
  // properties
  template <STREAMS_BOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS, typename BidirectionalIteratorOrig,
            typename EPIterOrig>
  void
  add_edges_sorted(
      BidirectionalIteratorOrig first_sorted,
      BidirectionalIteratorOrig last_sorted,
      EPIterOrig ep_iter_sorted,
      STREAMS_BOOST_DIR_CSR_GRAPH_TYPE& g) {
  ...
  // Add edges from a range of (source, target) pairs that are unsorted
  template <STREAMS_BOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS, typename InputIterator,
            typename GlobalToLocal>
  inline void
  add_edges_global(InputIterator first, InputIterator last, 
                   const GlobalToLocal& global_to_local, STREAMS_BOOST_DIR_CSR_GRAPH_TYPE& g) {
  ...
  template <STREAMS_BOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS, typename InputIterator>
  inline void
  add_edges(InputIterator first, InputIterator last, STREAMS_BOOST_DIR_CSR_GRAPH_TYPE& g) {
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
num_vertices(const STREAMS_BOOST_CSR_GRAPH_TYPE& g) {
  return g.m_forward.m_rowstart.size() - 1;
}

template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
std::pair<counting_iterator<Vertex>, counting_iterator<Vertex> >
inline vertices(const STREAMS_BOOST_CSR_GRAPH_TYPE& g) {
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
source(typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor e,
       const STREAMS_BOOST_CSR_GRAPH_TYPE&)
{
  return e.src;
}
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline Vertex
target(typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor e,
       const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  return g.m_forward.m_column[e.idx];
}

template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_CSR_GRAPH_TYPE::out_edge_iterator,
                 typename STREAMS_BOOST_CSR_GRAPH_TYPE::out_edge_iterator>
out_edges(Vertex v, const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor ed;
  typedef typename STREAMS_BOOST_CSR_GRAPH_TYPE::out_edge_iterator it;
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline EdgeIndex
out_degree(Vertex v, const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  EdgeIndex v_row_start = g.m_forward.m_rowstart[v];
  EdgeIndex next_row_start = g.m_forward.m_rowstart[v + 1];
...
template<STREAMS_BOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE::in_edge_iterator,
                 typename STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE::in_edge_iterator>
in_edges(Vertex v, const STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE::edge_descriptor ed;
  typedef typename STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE::in_edge_iterator it;
...
template<STREAMS_BOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS>
inline EdgeIndex
in_degree(Vertex v, const STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE& g)
{
  EdgeIndex v_row_start = g.m_backward.m_rowstart[v];
  EdgeIndex next_row_start = g.m_backward.m_rowstart[v + 1];
  return next_row_start - v_row_start;
...
// From AdjacencyGraph
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_CSR_GRAPH_TYPE::adjacency_iterator,
                 typename STREAMS_BOOST_CSR_GRAPH_TYPE::adjacency_iterator>
adjacent_vertices(Vertex v, const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  EdgeIndex v_row_start = g.m_forward.m_rowstart[v];
  EdgeIndex next_row_start = g.m_forward.m_rowstart[v + 1];
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename graph_traits<STREAMS_BOOST_CSR_GRAPH_TYPE>::vertex_descriptor
vertex(typename graph_traits<STREAMS_BOOST_CSR_GRAPH_TYPE>::vertex_descriptor i, 
       const STREAMS_BOOST_CSR_GRAPH_TYPE&)
{
  return i;
}
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor, bool>
edge(Vertex i, Vertex j, const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_CSR_GRAPH_TYPE::out_edge_iterator out_edge_iter;
  ...
  return std::make_pair(typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor(),
                        false);
}

// Find an edge given its index in the graph
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor
edge_from_index(EdgeIndex idx, const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  ...
  return typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor(src, idx);
}

template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline EdgeIndex
num_edges(const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  return g.m_forward.m_column.size();
}

template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
std::pair<typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_iterator,
          typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_iterator>
edges(const STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_iterator ei;
  typedef typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor edgedesc;
...
// Graph properties
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS, class Tag, class Value>
inline void
set_property(STREAMS_BOOST_CSR_GRAPH_TYPE& g, Tag, const Value& value)
{
  get_property_value(g.m_property, Tag()) = value;
}

template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS, class Tag>
inline
typename graph_property<STREAMS_BOOST_CSR_GRAPH_TYPE, Tag>::type&
get_property(STREAMS_BOOST_CSR_GRAPH_TYPE& g, Tag)
{
...
const
typename graph_property<STREAMS_BOOST_CSR_GRAPH_TYPE, Tag>::type&
get_property(const STREAMS_BOOST_CSR_GRAPH_TYPE& g, Tag)
{
  return get_property_value(g.m_property, Tag());
}
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
struct property_map<STREAMS_BOOST_CSR_GRAPH_TYPE, vertex_index_t>
{
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
struct property_map<STREAMS_BOOST_CSR_GRAPH_TYPE, edge_index_t>
{
private:
  typedef typename graph_traits<STREAMS_BOOST_CSR_GRAPH_TYPE>::edge_descriptor
    edge_descriptor;
...
get(vertex_index_t, const STREAMS_BOOST_CSR_GRAPH_TYPE&)
{
...
inline Vertex
get(vertex_index_t,
    const STREAMS_BOOST_CSR_GRAPH_TYPE&, Vertex v)
{
  return v;
}

template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS>
inline typename property_map<STREAMS_BOOST_CSR_GRAPH_TYPE, edge_index_t>::const_type
get(edge_index_t, const STREAMS_BOOST_CSR_GRAPH_TYPE&)
{
  typedef typename property_map<STREAMS_BOOST_CSR_GRAPH_TYPE, edge_index_t>::const_type
    result_type;
  return result_type();
}
...
inline EdgeIndex
get(edge_index_t, const STREAMS_BOOST_CSR_GRAPH_TYPE&,
    typename STREAMS_BOOST_CSR_GRAPH_TYPE::edge_descriptor e)
{
  return e.idx;
}

template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS, typename T, typename Bundle>
inline
typename property_map<STREAMS_BOOST_CSR_GRAPH_TYPE, T Bundle::*>::type
get(T Bundle::* p, STREAMS_BOOST_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_CSR_GRAPH_TYPE,
                                T Bundle::*>::type
    result_type;
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS, typename T, typename Bundle>
inline
typename property_map<STREAMS_BOOST_CSR_GRAPH_TYPE, T Bundle::*>::const_type
get(T Bundle::* p, STREAMS_BOOST_CSR_GRAPH_TYPE const & g)
{
  typedef typename property_map<STREAMS_BOOST_CSR_GRAPH_TYPE,
                                T Bundle::*>::const_type
    result_type;
...
template<STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS, typename T, typename Bundle,
         typename Key>
inline void
put(T Bundle::* p, STREAMS_BOOST_CSR_GRAPH_TYPE& g,
    const Key& key, const T& value)
{
  put(get(p, g), key, value);
}

#undef STREAMS_BOOST_CSR_GRAPH_TYPE
#undef STREAMS_BOOST_CSR_GRAPH_TEMPLATE_PARMS
#undef STREAMS_BOOST_DIR_CSR_GRAPH_TYPE
#undef STREAMS_BOOST_DIR_CSR_GRAPH_TEMPLATE_PARMS
#undef STREAMS_BOOST_BIDIR_CSR_GRAPH_TYPE
#undef STREAMS_BOOST_BIDIR_CSR_GRAPH_TEMPLATE_PARMS

} // end namespace streams_boost

#endif // STREAMS_BOOST_GRAPH_COMPRESSED_SPARSE_ROW_GRAPH_HPP
