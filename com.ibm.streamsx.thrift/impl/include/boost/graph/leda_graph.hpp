...
//=======================================================================
#ifndef STREAMS_BOOST_GRAPH_LEDA_HPP
#define STREAMS_BOOST_GRAPH_LEDA_HPP
...
// treat a LEDA GRAPH object as a streams_boost graph "as is". No
...
namespace streams_boost {
    ...
    leda::GRAPH<vtype,etype>& g)
  {
    typename graph_traits< leda::GRAPH<vtype,etype> >::out_edge_iterator 
      i,iend;
    for (streams_boost::tie(i,iend) = out_edges(u,g); i != iend; ++i)
      if (target(*i,g) == v)
        g.del_edge(*i);
  }
  ...
  typename streams_boost::property_traits<
    typename streams_boost::property_map<leda::GRAPH<vtype, etype>,PropertyTag>::const_type
::value_type
...
#endif // STREAMS_BOOST_GRAPH_LEDA_HPP
