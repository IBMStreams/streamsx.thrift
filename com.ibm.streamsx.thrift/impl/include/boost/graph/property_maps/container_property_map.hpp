...
#ifndef STREAMS_BOOST_GRAPH_CONTAINER_PROPERTY_MAP_HPP
#define STREAMS_BOOST_GRAPH_CONTAINER_PROPERTY_MAP_HPP

#include <streams_boost/graph/detail/index.hpp>
