...
#ifndef STREAMS_BOOST_GRAPH_TRAITS_HPP
#define STREAMS_BOOST_GRAPH_TRAITS_HPP
...
namespace streams_boost {
    ...
    typedef streams_boost::forward_traversal_tag multi_pass_input_iterator_tag;
...
// of source() and target() unless we bring them into the streams_boost
// namespace.
namespace streams_boost {
  using std::source;
  using std::target;
...
#endif // STREAMS_BOOST_GRAPH_TRAITS_HPP
