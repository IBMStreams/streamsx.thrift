...
#ifndef STREAMS_BOOST_GRAPH_TRANSITIVE_REDUCTION_HPP
#define STREAMS_BOOST_GRAPH_TRANSITIVE_REDUCTION_HPP

#include <vector>
#include <algorithm> //std::find
#include <streams_boost/concept/requires.hpp>
...
>
STREAMS_BOOST_CONCEPT_REQUIRES(
