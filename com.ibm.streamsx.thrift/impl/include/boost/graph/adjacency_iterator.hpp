...
#ifndef STREAMS_BOOST_ADJACENCY_ITERATOR_HPP
#define STREAMS_BOOST_ADJACENCY_ITERATOR_HPP
...
namespace streams_boost
{
  ...
  {
    typedef typename streams_boost::detail::iterator_traits<OutEdgeIter>
  ...
  class inv_adjacency_iterator_generator {
    typedef typename streams_boost::detail::iterator_traits<InEdgeIter>
      ::difference_type difference_type;
  public:
...
#endif // STREAMS_BOOST_DETAIL_ADJACENCY_ITERATOR_HPP
