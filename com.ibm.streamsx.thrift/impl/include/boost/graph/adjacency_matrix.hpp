...
#ifndef STREAMS_BOOST_ADJACENCY_MATRIX_HPP
#define STREAMS_BOOST_ADJACENCY_MATRIX_HPP
...
namespace streams_boost {
  ...
  public:
    ...
    STREAMS_BOOST_STATIC_ASSERT(type_traits::ice_not<(is_same<Directed, bidirectionalS>::value)>::value);
#endif
  ...
  public:
    ...
    // functionality required for a Bidirectional Graph (in_edges,
    // in_degree, etc.).
    STREAMS_BOOST_STATIC_ASSERT(!(is_same<Directed, bidirectionalS>::value));
#endif
...
#if (defined(STREAMS_BOOST_MSVC) && STREAMS_BOOST_MSVC <= 1300) || defined(STREAMS_BOOST_NO_STD_ALLOCATOR)
  ...
  struct adj_matrix_vertex_id_map
    : public streams_boost::put_get_helper<Vertex,
  ...
  namespace detail {
    ...
    struct adj_matrix_any_vertex_pa {
      ...
      struct bind_ {
        ...
        typedef typename streams_boost::graph_traits<Graph>::vertex_descriptor Vertex;
  ...
  namespace detail {
    ...
    typename streams_boost::property_map<adjacency_matrix<D,VP,EP,GP,A>,
      Property>::type
    get_dispatch(adjacency_matrix<D,VP,EP,GP,A>& g, Property,
                 vertex_property_tag)
    {
      typedef adjacency_matrix<D,VP,EP,GP,A> Graph;
      typedef typename streams_boost::property_map<adjacency_matrix<D,VP,EP,GP,A>,
        Property>::type PA;
      return PA(&g);
    }
    template <typename Property, typename D, typename VP, typename EP,
...
#endif // STREAMS_BOOST_ADJACENCY_MATRIX_HPP
