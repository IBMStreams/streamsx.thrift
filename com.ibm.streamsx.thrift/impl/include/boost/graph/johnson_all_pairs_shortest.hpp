...
#ifndef STREAMS_BOOST_GRAPH_JOHNSON_HPP
#define STREAMS_BOOST_GRAPH_JOHNSON_HPP
...
#include <streams_boost/graph/bellman_ford_shortest_paths.hpp>
                     ...
                     Weight w, VertexID id)
    {
      ...
      return johnson_all_pairs_shortest_paths
        ...
        choose_param(get_param(params, distance_inf_t()), 
          std::numeric_limits<WT>::max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION()),
...
#endif // STREAMS_BOOST_GRAPH_JOHNSON_HPP
