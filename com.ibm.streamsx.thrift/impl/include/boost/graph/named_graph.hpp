...
#ifndef STREAMS_BOOST_GRAPH_NAMED_GRAPH_HPP
#define STREAMS_BOOST_GRAPH_NAMED_GRAPH_HPP
...
public:
  ...
  VertexProperty operator()(const vertex_name_type& name)
  {
      streams_boost::throw_exception(std::runtime_error("add_vertex: "
...
namespace detail {
  ...
  {
    typedef streams_boost::detail::error_property_not_found type;
  };
}
...
#endif // STREAMS_BOOST_GRAPH_NAMED_GRAPH_HPP
