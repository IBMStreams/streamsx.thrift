...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_RMAT_GENERATOR_HPP
#define STREAMS_BOOST_GRAPH_RMAT_GENERATOR_HPP
...
using streams_boost::uniform_01;
  ...
  */
  ...
  public:
...

    {
      ...
      assert(streams_boost::test_tools::check_is_close(a + b + c + d, 1., streams_boost::test_tools::fraction_tolerance(1.e-5)));
...
#include <streams_boost/graph/distributed/rmat_graph_generator.hpp>
#endif // STREAMS_BOOST_GRAPH_USE_MPI

#endif // STREAMS_BOOST_GRAPH_RMAT_GENERATOR_HPP
