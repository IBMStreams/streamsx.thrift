...
//=======================================================================
#ifndef STREAMS_BOOST_GRAPH_CUTHILL_MCKEE_HPP
#define STREAMS_BOOST_GRAPH_CUTHILL_MCKEE_HPP

#include <streams_boost/config.hpp>
#include <streams_boost/graph/detail/sparse_ordering.hpp>
#include <streams_boost/graph/graph_utility.hpp>
#include <algorithm>
...
namespace streams_boost {
                         ...
                         ColorMap color, DegreeMap degree)
  {
    ...
    typedef typename streams_boost::sparse::sparse_ordering_queue<Vertex> queue;
  ...
  cuthill_mckee_ordering(const Graph& G, OutputIterator permutation, 
                         ColorMap color, DegreeMap degree)
  {
    if (streams_boost::graph::has_no_vertices(G))
      return permutation;

    typedef typename streams_boost::graph_traits<Graph>::vertex_descriptor Vertex;
    typedef typename streams_boost::graph_traits<Graph>::vertex_iterator   VerIter;
    typedef typename property_traits<ColorMap>::value_type ColorValue;
    typedef color_traits<ColorValue> Color;
...
#endif // STREAMS_BOOST_GRAPH_CUTHILL_MCKEE_HPP
