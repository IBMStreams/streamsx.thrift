...
//=======================================================================
#ifndef STREAMS_BOOST_GRAPH_SGB_GRAPH_HPP
#define STREAMS_BOOST_GRAPH_SGB_GRAPH_HPP
...
namespace streams_boost {
  ...
  template <> struct graph_traits<sgb_graph_ptr> {
    ...
    typedef streams_boost::sgb_edge edge_descriptor;
...
namespace streams_boost {
  ...
  class sgb_out_edge_iterator
    : public streams_boost::forward_iterator_helper<
        sgb_out_edge_iterator, streams_boost::sgb_edge, 
        std::ptrdiff_t, streams_boost::sgb_edge*, streams_boost::sgb_edge>
  {
    typedef sgb_out_edge_iterator self;
  public:
    sgb_out_edge_iterator() : _src(0), _arc(0) {}
    sgb_out_edge_iterator(Vertex* s, Arc* d) : _src(s), _arc(d) {}
    streams_boost::sgb_edge operator*() { return streams_boost::sgb_edge(_arc, _src); }
  ...
  // Vertex, which avoids problems with streams_boost passing vertex descriptors
...
namespace streams_boost {
  ...
  inline streams_boost::graph_traits<sgb_graph_ptr>::degree_size_type
  out_degree(Vertex* u, sgb_const_graph_ptr g)
  {
    streams_boost::graph_traits<sgb_graph_ptr>::out_edge_iterator i, i_end;
    streams_boost::tie(i, i_end) = out_edges(u, g);
  ...
  class sgb_vertex_id_map
    : public streams_boost::put_get_helper<long, sgb_vertex_id_map>
  {
  public:
  ...
  class sgb_vertex_name_map
    : public streams_boost::put_get_helper<char*, sgb_vertex_name_map>
  {
  public:
    typedef streams_boost::readable_property_map_tag category;
...
#define SGB_GET_UTIL_FIELD(KIND,X) \
  ...
  class sgb_vertex_util_map
    : public streams_boost::put_get_helper<Ref, sgb_vertex_util_map<Tag, Ref> >
  {
  public:
  ...
  class sgb_edge_util_map
    : public streams_boost::put_get_helper<Ref, sgb_edge_util_map<Tag, Ref> >
  {
  public:
    typedef streams_boost::lvalue_property_map_tag category;
    typedef typename Tag::type value_type;
  ...
  class sgb_edge_length_map
    : public streams_boost::put_get_helper<Ref, sgb_edge_length_map<Ref> >
  {
  public:
    typedef streams_boost::lvalue_property_map_tag category;
    typedef long value_type;
...
#endif // STREAMS_BOOST_GRAPH_SGB_GRAPH_HPP
