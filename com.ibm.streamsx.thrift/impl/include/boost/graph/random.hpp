...
//=======================================================================
#ifndef STREAMS_BOOST_GRAPH_RANDOM_HPP
#define STREAMS_BOOST_GRAPH_RANDOM_HPP
...
namespace streams_boost {
     ...
     bool self_edges = false)
  {
    ...
    if (!allow_parallel) {
      ...
      typedef typename streams_boost::graph_traits<MutableGraph>::directed_category dir;
