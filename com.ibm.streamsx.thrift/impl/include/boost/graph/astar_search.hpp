...
#ifndef STREAMS_BOOST_GRAPH_ASTAR_SEARCH_HPP
#define STREAMS_BOOST_GRAPH_ASTAR_SEARCH_HPP
...
namespace streams_boost {
     ...
     CostInf /*inf*/, CostZero zero)
  {
    typedef typename graph_traits<VertexListGraph>::vertex_descriptor
      Vertex;
    typedef streams_boost::vector_property_map<std::size_t> IndexInHeapMap;
      ...
      astar_search
        (g, s, h,
         ...
         choose_param(get_param(params, distance_inf_t()),
                      std::numeric_limits<C>::max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION ()),
...
#endif // STREAMS_BOOST_GRAPH_ASTAR_SEARCH_HPP
