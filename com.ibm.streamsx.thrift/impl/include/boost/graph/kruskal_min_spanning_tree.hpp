...
//=======================================================================
//
#ifndef STREAMS_BOOST_GRAPH_MST_KRUSKAL_HPP
#define STREAMS_BOOST_GRAPH_MST_KRUSKAL_HPP
...
namespace streams_boost {
  ...
  namespace detail {
                     ...
                     Rank rank, Parent parent, Weight weight)
    {
      ...
      for (streams_boost::tie(ui, uiend) = vertices(G); ui != uiend; ++ui)
        dset.make_set(*ui);
      ...
      for (streams_boost::tie(ei, eiend) = edges(G); ei != eiend; ++ei) 
        Q.push(*ei);
...
#endif // STREAMS_BOOST_GRAPH_MST_KRUSKAL_HPP
