...
#ifndef STREAMS_BOOST_GRAPH_METRIC_TSP_APPROX_HPP
#define STREAMS_BOOST_GRAPH_METRIC_TSP_APPROX_HPP
...
#include <streams_boost/graph/graph_as_tree.hpp>
#include <streams_boost/graph/adjacency_list.hpp>
#include <streams_boost/graph/prim_minimum_spanning_tree.hpp>
#include <streams_boost/graph/lookup_edge.hpp>
...
namespace streams_boost
{
    ...
    public:
        ...
        STREAMS_BOOST_CONCEPT_USAGE(TSPVertexVisitorConcept)
        {
                                       ...
                                       TSPVertexVisitor vis)
    {
        ...
        STREAMS_BOOST_CONCEPT_ASSERT((VertexListGraphConcept<VertexListGraph>));
        STREAMS_BOOST_CONCEPT_ASSERT((TSPVertexVisitorConcept<TSPVertexVisitor, VertexListGraph>));
    ...
    public:
        ...
        {
            STREAMS_BOOST_CONCEPT_ASSERT((OutputIterator<OutItr, Vertex>));
            *itr_++ = v;
        }
    ...
    {
        typedef typename graph_traits<Graph>::vertex_descriptor Vertex;
        STREAMS_BOOST_CONCEPT_ASSERT((OutputIterator<OutIter, Vertex>));
...
#endif // STREAMS_BOOST_GRAPH_METRIC_TSP_APPROX_HPP
