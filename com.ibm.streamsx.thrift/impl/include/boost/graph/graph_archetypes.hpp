...
#ifndef STREAMS_BOOST_GRAPH_ARCHETYPES_HPP
#define STREAMS_BOOST_GRAPH_ARCHETYPES_HPP
...
namespace streams_boost { // should use a different namespace for this
  ...
  {
    typedef typename streams_boost::property_map<property_graph_archetype<G, P, V>, P>::type Map;
    Map pmap = get(p, g);
    put(pmap, key, value);
  }
...
#endif // STREAMS_BOOST_GRAPH_ARCHETYPES_HPP
