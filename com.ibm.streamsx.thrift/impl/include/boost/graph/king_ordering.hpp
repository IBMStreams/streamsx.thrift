...
//=======================================================================//
#ifndef STREAMS_BOOST_GRAPH_KING_HPP
#define STREAMS_BOOST_GRAPH_KING_HPP
  ...
  namespace detail {
    ...
    public:
      ...
      void finish_vertex(Vertex, Graph& g) {
        ...
        std::make_heap(rbegin, rend, streams_boost::bind<bool>(comp, _2, _1));
...
#endif // STREAMS_BOOST_GRAPH_KING_HPP
