...
#ifndef STREAMS_BOOST_GRAPH_CLOSENESS_CENTRALITY_HPP
#define STREAMS_BOOST_GRAPH_CLOSENESS_CENTRALITY_HPP

#include <streams_boost/graph/detail/geodesic.hpp>
#include <streams_boost/graph/exterior_property.hpp>
