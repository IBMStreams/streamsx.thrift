...
#ifndef STREAMS_BOOST_VECTOR_AS_GRAPH_HPP
#define STREAMS_BOOST_VECTOR_AS_GRAPH_HPP
...
namespace streams_boost {
  ...
  namespace detail {
    ...
    // need rewrite this using streams_boost::iterator_adaptor
    template <class V, class Iter>
    class val_out_edge_iterator
      : public streams_boost::iterator<std::input_iterator_tag, std::pair<V,V>,
  ...
  template <class EdgeList, class Alloc>
  std::pair<typename streams_boost::integer_range<typename EdgeList::value_type>
              ::iterator,
            typename streams_boost::integer_range<typename EdgeList::value_type>
              ::iterator >
  vertices(const std::vector<EdgeList, Alloc>& v)
  {
    typedef typename streams_boost::integer_range<typename EdgeList::value_type>
      ::iterator Iter;
...
#endif // STREAMS_BOOST_VECTOR_AS_GRAPH_HPP
