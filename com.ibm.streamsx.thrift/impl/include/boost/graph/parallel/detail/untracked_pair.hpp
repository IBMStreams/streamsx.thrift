...
#ifndef STREAMS_BOOST_PARALLEL_DETAIL_UNTRACKED_PAIR_HPP
#define STREAMS_BOOST_PARALLEL_DETAIL_UNTRACKED_PAIR_HPP
...
namespace streams_boost { namespace parallel { namespace detail {
...
template<typename T, typename U>
struct is_mpi_datatype<streams_boost::parallel::detail::untracked_pair<T, U> >
...
inline void serialize(
    Archive & ar,
    streams_boost::parallel::detail::untracked_pair<F, S> & p,
    const unsigned int /* file_version */
){
    ar & streams_boost::serialization::make_nvp("first", p.first);
    ar & streams_boost::serialization::make_nvp("second", p.second);
}

template<typename T, typename U>
struct is_bitwise_serializable<
        streams_boost::parallel::detail::untracked_pair<T, U> >
  : is_bitwise_serializable<std::pair<T, U> > {};

template<typename T, typename U>
struct implementation_level<streams_boost::parallel::detail::untracked_pair<T, U> >
 : mpl::int_<object_serializable> {} ;

template<typename T, typename U>
struct tracking_level<streams_boost::parallel::detail::untracked_pair<T, U> >
 : mpl::int_<track_never> {} ;

} } // end namespace streams_boost::serialization

#endif // STREAMS_BOOST_PARALLEL_DETAIL_UNTRACKED_PAIR_HPP
