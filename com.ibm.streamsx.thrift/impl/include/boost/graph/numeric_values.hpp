...
#ifndef STREAMS_BOOST_GRAPH_NUMERIC_VALUES_HPP
#define STREAMS_BOOST_GRAPH_NUMERIC_VALUES_HPP
...
#define STREAMS_BOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(type) \
    ...
    STREAMS_BOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(float)
    STREAMS_BOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(double)
    STREAMS_BOOST_GRAPH_SPECIALIZE_NUMERIC_FLOAT(long double)

#undef STREAMS_BOOST_GRAPH_SPECIALIZE_NUMERIC_VALUE
}
