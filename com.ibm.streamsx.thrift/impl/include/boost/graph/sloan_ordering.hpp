...
#ifndef STREAMS_BOOST_GRAPH_SLOAN_HPP
#define STREAMS_BOOST_GRAPH_SLOAN_HPP
...
#include <streams_boost/graph/cuthill_mckee_ordering.hpp>
...
namespace streams_boost {
                           ...
                           DegreeMap degree)
  {
    ...
    streams_boost::iterator_property_map<vec_iter, VertexID, size_type, size_type&> dist_pmap(dist.begin(), get(vertex_index, G));
...
#endif // STREAMS_BOOST_GRAPH_SLOAN_HPP
