...
#ifndef STREAMS_BOOST_GRAPH_EDGE_LIST_HPP
#define STREAMS_BOOST_GRAPH_EDGE_LIST_HPP
...
namespace streams_boost {
  ...
  public:
    ...
    typedef V vertex_descriptor;
    typedef typename streams_boost::integer_range<edge_id>::iterator edge_iterator;
    typedef void out_edge_iterator;
    typedef void in_edge_iterator;
    typedef void adjacency_iterator;
    typedef void vertex_iterator;
...
#endif /* STREAMS_BOOST_GRAPH_EDGE_LIST_HPP */
