...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_KAMADA_KAWAI_SPRING_LAYOUT_HPP
#define STREAMS_BOOST_GRAPH_KAMADA_KAWAI_SPRING_LAYOUT_HPP
...
#include <streams_boost/graph/johnson_all_pairs_shortest.hpp>
...
namespace streams_boost {
  ...
  struct layout_tolerance
  {
    ...
    bool 
    operator()(T delta_p, 
               typename streams_boost::graph_traits<Graph>::vertex_descriptor p,
               const Graph& g,
               bool global)
    {
      if (global) {
   ...
   * display area, and must be either @c streams_boost::edge_length(e) or @c
   * streams_boost::side_length(s), respectively.
   *
  ...
  kamada_kawai_spring_layout(
    ...
    PartialDerivativeMap partial_derivatives)
  {
    STREAMS_BOOST_STATIC_ASSERT((is_convertible<
...
#endif // STREAMS_BOOST_GRAPH_KAMADA_KAWAI_SPRING_LAYOUT_HPP
