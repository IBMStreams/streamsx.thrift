...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_CIRCLE_LAYOUT_HPP
#define STREAMS_BOOST_GRAPH_CIRCLE_LAYOUT_HPP
...
namespace streams_boost {
  ...
  circle_graph_layout(const VertexListGraph& g, PositionMap position,
                      Radius radius)
  {
    STREAMS_BOOST_STATIC_ASSERT (property_traits<PositionMap>::value_type::dimensions >= 2);
    const double pi = streams_boost::math::constants::pi<double>();
...
#endif // STREAMS_BOOST_GRAPH_CIRCLE_LAYOUT_HPP
