...
#ifndef STREAMS_BOOST_GRAPH_BICONNECTED_COMPONENTS_HPP
#define STREAMS_BOOST_GRAPH_BICONNECTED_COMPONENTS_HPP
    ...
    struct biconnected_components_visitor : public dfs_visitor<>
    {
      ...
      void back_edge(const Edge& e, Graph& g)
      {
        ...
        if ( target(e, g) != get(pred, source(e, g)) ) {
          ...
          put(lowpt, source(e, g),
              min STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(get(lowpt, source(e, g)),
                                                   get(dtm, target(e, g))));
        }
        vis.back_edge(e, g);
      }
      ...
      void finish_vertex(const Vertex& u, Graph& g)
      {
        ...
        if ( parent == u ) { // at top
          ...
          put(lowpt, parent,
              min STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(get(lowpt, parent),
                                                   get(lowpt, u)));
...
#endif  /* STREAMS_BOOST_GRAPH_BICONNECTED_COMPONENTS_HPP */
