...
#ifndef STREAMS_BOOST_GRAPH_GRAPHML_HPP
#define STREAMS_BOOST_GRAPH_GRAPHML_HPP
...
#include <streams_boost/graph/graphviz.hpp> // for exceptions
#include <typeinfo>
#include <streams_boost/mpl/bool.hpp>
#include <streams_boost/mpl/vector.hpp>
#include <streams_boost/mpl/find.hpp>
#include <streams_boost/mpl/for_each.hpp>
#include <streams_boost/property_tree/detail/xml_parser_utils.hpp>
#include <exception>
#include <sstream>
...
public:
    ...
    virtual streams_boost::any do_add_vertex() = 0;
    virtual std::pair<streams_boost::any,bool> do_add_edge(streams_boost::any source, streams_boost::any target) = 0;

    virtual void
    set_graph_property(const std::string& name, const std::string& value, const std::string& value_type) = 0;

    virtual void
    set_vertex_property(const std::string& name, streams_boost::any vertex, const std::string& value, const std::string& value_type) = 0;

    virtual void
    set_edge_property(const std::string& name, streams_boost::any edge, const std::string& value, const std::string& value_type) = 0;
};
              ...
              const dynamic_properties& dp, bool ordered_vertices=false)
{
    ...
    using streams_boost::property_tree::xml_parser::encode_char_entities;
...
} // streams_boost namespace

#endif // STREAMS_BOOST_GRAPH_GRAPHML_HPP
