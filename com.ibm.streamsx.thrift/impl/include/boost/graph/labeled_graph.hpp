...
#ifndef STREAMS_BOOST_GRAPH_LABELED_GRAPH_HPP
#define STREAMS_BOOST_GRAPH_LABELED_GRAPH_HPP
...
namespace graph_detail {
    ...
    { typedef streams_boost::unordered_map<Label, Vertex> type; };

    template <typename Label, typename Vertex>
    struct generate_label_map<hash_multimapS, Label, Vertex>
    { typedef streams_boost::unordered_multimap<Label, Vertex> type; };
...
public:
    ...
    { return streams_boost::remove_vertex(vertex(l), _graph); }
...
#include <streams_boost/graph/detail/labeled_graph_traits.hpp>

#endif // STREAMS_BOOST_GRAPH_LABELED_GRAPH_HPP
