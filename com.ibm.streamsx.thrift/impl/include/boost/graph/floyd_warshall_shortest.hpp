...
#ifndef STREAMS_BOOST_GRAPH_FLOYD_WARSHALL_HPP
#define STREAMS_BOOST_GRAPH_FLOYD_WARSHALL_HPP
      ...
      const bgl_named_params<P, T, R>& params)
    {
      ...
      return floyd_warshall_initialized_all_pairs_shortest_paths(g, d,
        ...
        choose_param(get_param(params, distance_inf_t()), 
          std::numeric_limits<WM>::max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION()),
