...
#ifndef STREAMS_BOOST_GRAPH_MAXIMUM_CARDINALITY_MATCHING_HPP
#define STREAMS_BOOST_GRAPH_MAXIMUM_CARDINALITY_MATCHING_HPP
...
#include <streams_boost/utility.hpp>             // for streams_boost::tie
...
namespace streams_boost
{
  ...
  public:
    ...
    { 
      typedef streams_boost::iterator_property_map<typename std::vector<X>::iterator,
                                           VertexIndexMap> type; 
    };
  ...
  struct maximum_cardinality_matching_verifier
  {
    ...
    struct non_odd_vertex {
      ...
      {
        STREAMS_BOOST_ASSERT(vertex_state);
...
#endif //STREAMS_BOOST_GRAPH_MAXIMUM_CARDINALITY_MATCHING_HPP
