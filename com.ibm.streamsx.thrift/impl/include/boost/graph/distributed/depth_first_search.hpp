...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_DFS_HPP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_DFS_HPP
...
namespace streams_boost {
  namespace graph { namespace distributed { namespace detail {
    ...
    class parallel_dfs
    {
       ...
       */
      typedef streams_boost::parallel::detail::untracked_pair<vertex_descriptor, vertex_descriptor> vertex_pair;
...
#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_DFS_HPP
