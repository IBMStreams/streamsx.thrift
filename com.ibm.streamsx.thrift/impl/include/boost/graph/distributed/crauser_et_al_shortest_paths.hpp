 ...
 **************************************************************************/
#ifndef STREAMS_BOOST_GRAPH_CRAUSER_ET_AL_SHORTEST_PATHS_HPP
#define STREAMS_BOOST_GRAPH_CRAUSER_ET_AL_SHORTEST_PATHS_HPP
...
#include <streams_boost/property_map/property_map_iterator.hpp>
...
#include <streams_boost/graph/distributed/detail/remote_update_set.hpp>
#include <vector>
#include <streams_boost/graph/breadth_first_search.hpp>
#include <streams_boost/graph/dijkstra_shortest_paths.hpp>
...
namespace detail {
  ...
  class crauser_et_al_dijkstra_queue
    : public graph::detail::remote_update_set<
               ...
               typename streams_boost::graph::parallel::process_group_type<Graph>::type,
  ...
  public:
    ...
    crauser_et_al_dijkstra_queue(const Graph& g,
      ...
      : inherited(streams_boost::graph::parallel::process_group(g), get(vertex_owner, g)),
...
crauser_et_al_shortest_paths
  (const DistributedGraph& g,
   ...
   DijkstraVisitor vis)
{
  typedef typename streams_boost::graph::parallel::process_group_type<DistributedGraph>::type
    process_group_type;
  typedef typename process_group_type::process_id_type process_id_type;
  ...
  ::streams_boost::detail::dijkstra_bfs_visitor<
      DijkstraVisitor, Queue, WeightMap,
      streams_boost::parallel::caching_property_map<PredecessorMap>,
      streams_boost::parallel::caching_property_map<DistanceMap>, Combine, Compare
    > bfs_vis(vis, Q, weight,
              streams_boost::parallel::make_caching_property_map(predecessor),
              streams_boost::parallel::make_caching_property_map(distance),
...
#endif // STREAMS_BOOST_GRAPH_CRAUSER_ET_AL_SHORTEST_PATHS_HPP
