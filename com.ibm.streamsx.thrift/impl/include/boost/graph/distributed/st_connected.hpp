...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_ST_CONNECTED_HPP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_ST_CONNECTED_HPP
             ...
             ColorMap color, OwnerMap owner)
{
  ...
  while (true) {
    ...
    std::pair<bool, bool> results = all_reduce(pg, 
            streams_boost::parallel::detail::make_untracked_pair(Q.empty(), found),
            detail::pair_and_or());
...
#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_ST_CONNECTED_HPP
