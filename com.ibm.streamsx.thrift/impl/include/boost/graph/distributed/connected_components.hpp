...
//           Douglas Gregor
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_PARALLEL_CC_HPP
#define STREAMS_BOOST_GRAPH_PARALLEL_CC_HPP
...
#include <streams_boost/graph/connected_components.hpp>
...
namespace streams_boost { namespace graph { namespace distributed {
  namespace cc_detail {
                          ...
                          RootIterator r_end, AdjacencyMap& adj)
    {
      ...
      STREAMS_BOOST_STATIC_ASSERT((is_same<typename AdjacencyMap::mapped_type,
      ...
      if (id == 0) {
        ...
        typedef streams_boost::adjacency_list<vecS, vecS, undirectedS, 
    ...
    {
      typedef typename streams_boost::graph::parallel::process_group_type<Graph>
    ...
    {
      using streams_boost::connected_components;
      ...
      typedef typename streams_boost::graph::parallel::process_group_type<DistributedGraph>
        ::type process_group_type;
      typedef typename process_group_type::process_id_type process_id_type;
...
#endif // STREAMS_BOOST_GRAPH_PARALLEL_CC_HPP
