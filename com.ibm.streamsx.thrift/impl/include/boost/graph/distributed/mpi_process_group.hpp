...
//           Matthias Troyer
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_MPI_PROCESS_GROUP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_MPI_PROCESS_GROUP
...
class mpi_process_group
{
 ...
 public:
  ...
  typedef streams_boost::mpi::packed_oprimitive::buffer_type buffer_type;
  ...
  typedef streams_boost::mpi::communicator communicator_type;
...
private:
   ...
   */
  class trigger_base : streams_boost::noncopyable
  {
  public:
...
public:
  ...
  std::pair<streams_boost::mpi::communicator, int> 
...
private:
  ...
  void receive_batch(streams_boost::mpi::status& status) const;
...
send_oob(const mpi_process_group& pg, mpi_process_group::process_id_type dest,
         int tag, const T& value, int block=-1)
{
  using streams_boost::mpi::packed_oarchive;
...
STREAMS_BOOST_IS_BITWISE_SERIALIZABLE(streams_boost::graph::distributed::mpi_process_group::message_header)
namespace streams_boost { namespace mpi {
    template<>
    struct is_mpi_datatype<streams_boost::graph::distributed::mpi_process_group::message_header> : mpl::true_ { };
} } // end namespace streams_boost::mpi

namespace std {
/// optimized swap for outgoing messages
inline void 
swap(streams_boost::graph::distributed::mpi_process_group::outgoing_messages& x,
     streams_boost::graph::distributed::mpi_process_group::outgoing_messages& y)
{
  x.swap(y);
}
...
STREAMS_BOOST_CLASS_IMPLEMENTATION(streams_boost::graph::distributed::mpi_process_group::outgoing_messages,object_serializable)
STREAMS_BOOST_CLASS_TRACKING(streams_boost::graph::distributed::mpi_process_group::outgoing_messages,track_never)

#include <streams_boost/graph/distributed/detail/mpi_process_group.ipp>

#endif // STREAMS_BOOST_PARALLEL_MPI_MPI_PROCESS_GROUP_HPP
