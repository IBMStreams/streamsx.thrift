...
template<STREAMS_BOOST_DISTRIBUTED_QUEUE_PARMS>
STREAMS_BOOST_DISTRIBUTED_QUEUE_TYPE::
...
template<STREAMS_BOOST_DISTRIBUTED_QUEUE_PARMS>
void
STREAMS_BOOST_DISTRIBUTED_QUEUE_TYPE::push(const value_type& x)
{
...
template<STREAMS_BOOST_DISTRIBUTED_QUEUE_PARMS>
bool
STREAMS_BOOST_DISTRIBUTED_QUEUE_TYPE::empty() const
{
...
template<STREAMS_BOOST_DISTRIBUTED_QUEUE_PARMS>
typename STREAMS_BOOST_DISTRIBUTED_QUEUE_TYPE::size_type
STREAMS_BOOST_DISTRIBUTED_QUEUE_TYPE::size() const
{
  empty();
  return buffer.size();
}
...
template<STREAMS_BOOST_DISTRIBUTED_QUEUE_PARMS>
void STREAMS_BOOST_DISTRIBUTED_QUEUE_TYPE::setup_triggers()
{
...
template<STREAMS_BOOST_DISTRIBUTED_QUEUE_PARMS>
bool
STREAMS_BOOST_DISTRIBUTED_QUEUE_TYPE::do_synchronize() const
{
