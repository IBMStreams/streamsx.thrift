...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_DETAIL_REMOTE_UPDATE_SET_STREAMS_HPP
#define STREAMS_BOOST_GRAPH_DETAIL_REMOTE_UPDATE_SET_STREAMS_HPP
...
{ 
  using streams_boost::parallel::synchronize;
  synchronize(pg);
}
...
#endif // STREAMS_BOOST_GRAPH_DETAIL_REMOTE_UPDATE_SET_STREAMS_HPP
