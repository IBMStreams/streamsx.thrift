...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_PARALLEL_DIJKSTRA_HPP
#define STREAMS_BOOST_GRAPH_PARALLEL_DIJKSTRA_HPP
...
#include <streams_boost/graph/distributed/crauser_et_al_shortest_paths.hpp>
#include <streams_boost/graph/distributed/eager_dijkstra_shortest_paths.hpp>
...
namespace streams_boost {
  ...
  namespace graph { namespace detail {
    ...
    template<>
    struct parallel_dijkstra_impl2< ::streams_boost::detail::error_property_not_found >
    {
      template<typename DistributedGraph, typename DijkstraVisitor,
               typename PredecessorMap, typename DistanceMap, 
               typename WeightMap, typename IndexMap, typename ColorMap, 
    ...
    template<>
    struct parallel_dijkstra_impl< ::streams_boost::detail::error_property_not_found >
    {
    private:
      template<typename DistributedGraph, typename DijkstraVisitor,
               typename PredecessorMap, typename DistanceMap, 
  ...
  dijkstra_shortest_paths
    (const DistributedGraph& g,
     ...
     STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(DistributedGraph,distributed_graph_tag))
  {
    typedef typename graph_traits<DistributedGraph>::vertices_size_type
      vertices_size_type;
...
#endif // STREAMS_BOOST_GRAPH_PARALLEL_DIJKSTRA_HPP
