...
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_GRAPH_UTILITY_INCLUDE
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_GRAPH_UTILITY_INCLUDE
...
namespace streams_boost { namespace graph {
  ...
  namespace distributed {
    ...
    protected:
      streams_boost::parallel::global_index_map<VertexIndexMap, VertexGlobalMap> 
      global_index_map;
    };
...
}} // namespace streams_boost::graph

#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_GRAPH_UTILITY_INCLUDE
