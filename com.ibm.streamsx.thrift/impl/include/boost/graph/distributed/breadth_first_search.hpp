...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_PARALLEL_BFS_HPP
#define STREAMS_BOOST_GRAPH_PARALLEL_BFS_HPP
...
namespace streams_boost {
  namespace detail {
       ...
       VertexIndexMap vertex_index)
    {
      ...
      typedef streams_boost::graph::distributed::distributed_queue<
...
#endif // STREAMS_BOOST_GRAPH_PARALLEL_BFS_HPP
