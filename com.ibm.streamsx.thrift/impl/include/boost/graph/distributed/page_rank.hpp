...
//           Andrew Lumsdaine
//           Brian Barrett
#ifndef STREAMS_BOOST_PARALLEL_GRAPH_PAGE_RANK_HPP
#define STREAMS_BOOST_PARALLEL_GRAPH_PAGE_RANK_HPP
...
#include <streams_boost/graph/page_rank.hpp>
               ...
               RankMap2 rank_map2)
{
  ...
  synchronize(streams_boost::graph::parallel::process_group(g));
  ...
  rank_map.set_consistency_model(streams_boost::parallel::cm_flush | streams_boost::parallel::cm_reset);
  rank_map2.set_consistency_model(streams_boost::parallel::cm_flush | streams_boost::parallel::cm_reset);
...
remove_dangling_links(MutableGraph& g
                      STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(MutableGraph, 
...
#endif // STREAMS_BOOST_PARALLEL_GRAPH_PAGE_RANK_HPP
