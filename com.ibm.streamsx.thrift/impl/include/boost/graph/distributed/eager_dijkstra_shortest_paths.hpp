 ...
 **************************************************************************/
#ifndef STREAMS_BOOST_GRAPH_EAGER_DIJKSTRA_SHORTEST_PATHS_HPP
#define STREAMS_BOOST_GRAPH_EAGER_DIJKSTRA_SHORTEST_PATHS_HPP
 ...
 struct parallel_dijkstra_bfs_visitor : bfs_visitor<>
{
  ...
  void examine_edge(Edge e, Graph& g) {
    ...
    streams_boost::parallel::caching_property_map<PredecessorMap> c_pred(m_predecessor);
    streams_boost::parallel::caching_property_map<DistanceMap> c_dist(m_distance);
...
#endif // STREAMS_BOOST_GRAPH_EAGER_DIJKSTRA_SHORTEST_PATHS_HPP
