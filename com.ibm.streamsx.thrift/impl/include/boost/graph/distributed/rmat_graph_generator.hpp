...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_RMAT_GENERATOR_HPP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_RMAT_GENERATOR_HPP
...
namespace streams_boost {
  ...
  public:
          ...
          : gen(), done(false)
      {
          ...
          streams_boost::uniform_01<RandomGenerator> prob(gen);
          ...
          do {
              ...
              tossed = all_reduce(pg, tossed, streams_boost::parallel::sum<vertices_size_type>());
              generated -= (tossed / 2);
          } while (generated < m);
...
#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_RMAT_GENERATOR_HPP
