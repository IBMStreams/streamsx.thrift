...
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_CSR_HPP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_CSR_HPP
...
#include <streams_boost/graph/compressed_sparse_row_graph.hpp>
#include <streams_boost/graph/distributed/selector.hpp>
#include <streams_boost/mpl/if.hpp>
#include <streams_boost/type_traits/is_same.hpp>
#include <streams_boost/graph/distributed/concepts.hpp>
#include <streams_boost/graph/parallel/properties.hpp>
#include <streams_boost/graph/parallel/distribution.hpp>
#include <streams_boost/property_map/parallel/local_property_map.hpp>
#include <streams_boost/property_map/parallel/distributed_property_map.hpp>
         ...
         InEdgeIndex>
{
 ...
 public:
  ...
  typedef streams_boost::parallel::variant_distribution<process_group_type, Vertex>
    distribution_type;
  ...
  vertex_descriptor add_vertex()
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = streams_boost::add_vertex(m_base);
  ...
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = streams_boost::add_vertex(m_base, p);
  ...
  {
    typename graph_traits<base_type>::vertex_descriptor v 
      = streams_boost::add_vertices(count, m_base);
  ...
  { streams_boost::add_edges_global(first, last, get(vertex_local, *this), m_base); }
  ...
  { streams_boost::add_edges_global(first, last, ep_iter, ep_iter_end, 
                            get(vertex_local, *this), m_base); }

  template <typename InputIterator>
  void 
  add_edges_sorted(InputIterator first, InputIterator last)
  { streams_boost::add_edges_sorted_global(first, last, 
                                   get(vertex_local, *this), m_base); }
  ...
  { streams_boost::add_edges_sorted_global(first_sorted, last_sorted, ep_iter_sorted, 
                                   get(vertex_local, *this), m_base); }
 ...
 *  graph type.
 */
#define STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS                          \
 ...
 *  STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS). It is used to reduce
 *  the amount of typing required to declare free functions for this
 *  graph type.
 */
#define STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE                            \
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::null_vertex()
{
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
source(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor e,
       const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE&)
{ return e.src; }

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
target(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor e,
       const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return target(e, g.base()); }

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator,
                 typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator>
out_edges(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor u,
          const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type
    edges_size_type;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor ed;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator it;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::degree_size_type
out_degree(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor u,
           const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
void synchronize(const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE graph_type;
  synchronize(g.process_group());
}

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS> 
ProcessGroup
process_group(const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
...
// Adjacency Graph concept requirements
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::adjacency_iterator,
                 typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::adjacency_iterator>
adjacent_vertices(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor u,
                  const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::degree_size_type
num_vertices(const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  return num_vertices(g.base());
}

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator,
                 typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator>
vertices(const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_iterator
    vertex_iterator;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator
{
 public:
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type
num_edges(const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  return g.base().m_forward.m_column.size();
}

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
std::pair<typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator,
          typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator>
edges(const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor Vertex;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_iterator ei;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor edgedesc;
...
struct index_to_vertex_func {
  ...
  typedef typename streams_boost::graph_traits<Graph>::vertex_descriptor vertex_descriptor;
  typedef typename streams_boost::graph_traits<Graph>::vertices_size_type vertices_size_type;
...
streams_boost::transform_iterator<index_to_vertex_func<Distribution, Graph>, IndexIterator>
make_index_to_vertex_iterator(IndexIterator it, const Distribution& dist, 
                              const Graph& g) {
  return streams_boost::make_transform_iterator(
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
template<typename InputIterator>
STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::
compressed_sparse_row_graph(edges_are_unsorted_t,
                            InputIterator edge_begin, InputIterator edge_end,
                            vertices_size_type numverts,
                            const ProcessGroup& pg,
  ...
  : m_process_group(pg),
    ...
    m_base(edges_are_unsorted_global,
           index_to_vertex_iterator<InputIterator, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE>(edge_begin, *this),
           index_to_vertex_iterator<InputIterator, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE>(edge_end, *this),
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>
{
 public:
  typedef csr_vertex_global_map<
            typename ProcessGroup::process_id_type,
            typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor> type;
  typedef type const_type;
};

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>::type
get(vertex_global_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>
    ::type result_type;
  return result_type();
}
...
std::pair<typename ProcessGroup::process_id_type,
          typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor>
get(vertex_global_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor k)
{
  return get(vertex_global, 
             const_cast<const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE&>(g), 
             k);
}

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>::const_type
get(vertex_global_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_global_t>
...
get(vertex_global_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor k)
{
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
    vertex_descriptor;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
vertex(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertices_size_type i,
       const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
inline std::pair<typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator,
                 typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator>
edge_range(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor i,
           typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor j,
           const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor Vertex;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type EdgeIndex;
  typedef typename std::vector<Vertex>::const_iterator adj_iter;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator out_edge_iter;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor edge_desc;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline std::pair<typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor, bool>
edge(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor i,
     typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor j,
     const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::out_edge_iterator out_edge_iter;
  ...
  if (range.first == range.second)
    return std::make_pair(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor(),
                          false);
  else
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename Property>
class property_map<const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, Property>
{
 public:
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, Property>
    ::const_type type;
  typedef type const_type;
};
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
add_vertex(STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return g.add_vertex(); }

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
add_vertex(const typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_bundled& p, 
           STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return g.add_vertex(p); }

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor
add_vertices(typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertices_size_type count, 
             STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{ return g.add_vertices(count); }

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename InputIterator>
void 
add_edges(InputIterator first, InputIterator last,
          STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>
{
 public:
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>::type
get(vertex_owner_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>
    ::type result_type;
  return result_type();
}
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>::const_type
get(vertex_owner_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_owner_t>
    ::const_type result_type;
  return result_type();
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
{
 public:
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>::type
get(vertex_local_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
    ::type result_type;
  return result_type();
}
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>::const_type
get(vertex_local_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t>
    ::const_type result_type;
  return result_type();
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, 
                                vertex_global_t>::const_type
    global_map;
  typedef typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::process_group_type
    process_group_type;

  typedef property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t> local;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>::type
get(vertex_index_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>
    ::type result_type;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertices_size_type
get(vertex_index_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor k)
{
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>::const_type
get(vertex_index_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_index_t>
    ::const_type result_type;
  return result_type(g.process_group(), get(vertex_global, g),
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_index_t>
  : public property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_t> { };

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_index_t>::type
get(vertex_local_index_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, vertex_local_index_t>::const_type
get(vertex_local_index_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  return get(vertex_local, g);
}
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
{
 public:
  typedef csr_edge_global_map<
            typename ProcessGroup::process_id_type,
            typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::vertex_descriptor,
            typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type> type;
  typedef type const_type;
};

template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>::type
get(edge_global_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
    ::type result_type;
  return result_type();
}
...
inline
std::pair<typename ProcessGroup::process_id_type,
          typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edges_size_type>
get(edge_global_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g,
    typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::edge_descriptor k)
{
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>::const_type
get(edge_global_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
    ::const_type result_type;
  return result_type();
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>
{
   typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_global_t>
    ::type global_map;
 ...
 public:
  typedef local_property_map<
            typename STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE::process_group_type,
            global_map,
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>::type
get(edge_index_t, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>
    ::type result_type;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS>
inline
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>::const_type
get(edge_index_t, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, edge_index_t>
    ::const_type result_type;
  return result_type(g.process_group(), get(edge_global, g),
...
// -----------------------------------------------------------------
// Bundled Properties
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename T, typename Bundle>
class property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, T Bundle::*>
{
  typedef STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE Graph;
...
public:
  ...
  typedef ::streams_boost::parallel::distributed_property_map<
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename T, typename Bundle>
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, T Bundle::*>::type
get(T Bundle::* p, STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE Graph;
...
template<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TEMPLATE_PARMS, typename T, typename Bundle>
typename property_map<STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE, T Bundle::*>::const_type
get(T Bundle::* p, const STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE& g)
{
  typedef STREAMS_BOOST_DISTRIB_CSR_GRAPH_TYPE Graph;
...
namespace mpi {
  ...
  struct is_mpi_datatype<streams_boost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };
}

namespace serialization {
  template<typename Vertex, typename EdgeIndex>
  struct is_bitwise_serializable<streams_boost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
    : mpl::true_ { };

  template<typename Vertex, typename EdgeIndex>
  struct implementation_level<streams_boost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
   : mpl::int_<object_serializable> {} ;

  template<typename Vertex, typename EdgeIndex>
  struct tracking_level<streams_boost::detail::csr_edge_descriptor<Vertex, EdgeIndex> >
...
#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_CSR_HPP
