...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_LOCAL_SUBGRAPH_HPP
#define STREAMS_BOOST_GRAPH_LOCAL_SUBGRAPH_HPP
...
public:
  ...
  { 
    using streams_boost::graph::parallel::process_group;
    return streams_boost::graph::parallel::process_group(g); 
  }
...
#endif // STREAMS_BOOST_GRAPH_LOCAL_SUBGRAPH_HPP
