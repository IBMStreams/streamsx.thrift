...
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_ADJACENCY_LIST_HPP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_ADJACENCY_LIST_HPP
...
#include <streams_boost/graph/adjacency_list.hpp>
...
#include <streams_boost/graph/adjacency_iterator.hpp>
...
#include <streams_boost/graph/parallel/detail/property_holders.hpp>
...
#include <streams_boost/graph/parallel/algorithm.hpp>
#include <streams_boost/graph/distributed/selector.hpp>
#include <streams_boost/graph/parallel/process_group.hpp>
...
#include <streams_boost/pending/property_serialize.hpp>
#include <streams_boost/graph/distributed/unsafe_serialize.hpp>

// Named vertices
#include <streams_boost/graph/distributed/named_graph.hpp>

#include <streams_boost/graph/distributed/shuffled_distribution.hpp>
...
namespace streams_boost {
  ...
  namespace detail {
    ...
    serialize(Archiver& ar, edge_desc_impl<Directed, Vertex>& e,
              const unsigned int /*version*/)
    {
      ar & streams_boost::serialization::base_object<edge_base<Directed, Vertex> >(e)
  ...
  namespace detail { namespace parallel {
    ...
    struct edge_descriptor
    {
      ...
      public:
        typedef typename streams_boost::mpl::if_<is_same<DirectedS, bidirectionalS>,
                                         stored_in_edge<Edge>,
    ...
    struct adjacency_list_config
    {
      ...
      typedef typename streams_boost::mpl::if_<is_same<DirectedS, undirectedS>,
      ...
      typedef typename inherited::vertices_size_type vertices_size_type;
          ...
          typedef typename ::streams_boost::graph::distributed::select_distribution<
              in_distribution_type, VertexProperty, vertices_size_type, 
              ProcessGroup>::type 
        base_distribution_type;

          typedef ::streams_boost::graph::distributed::shuffled_distribution<
    ...
    maybe_initialize_vertex_indices(IteratorPair p,
                                    ::streams_boost::detail::error_property_not_found)
    { }
    ...
    public:
      ...
      void serialize(Archiver& ar, const unsigned int /*version*/)
      {
        ar & streams_boost::serialization::base_object<inherited_data>(*this) 
           & streams_boost::serialization::base_object<inherited_property>(*this);
      }
    };
    ...
    struct get_adj_list_pmap<vertex_local_index_t>
    {
      template<typename Graph>
      struct apply
        : ::streams_boost::property_map<typename Graph::inherited, vertex_index_t>
      { };
    };
    ...
    add_local_edge(typename Config::vertex_descriptor u,
                   typename Config::vertex_descriptor v,
                   const typename Config::edge_property_type& p,
                   streams_boost::adj_list_impl<Graph, Config, Base>& g)
    {
      return add_edge(u, v, p, g);
    }
      ...
      : public detail::parallel::maybe_store_property<EdgeProperty>
    {
      ...
      void serialize(Archiver& ar, const unsigned int /*version*/)
      {
        ar & streams_boost::serialization::base_object<inherited>(*this) & e;
      }
    };
  ...
  public:
    ...
    typedef typename streams_boost::mpl::if_<typename DirectedS::is_bidir_t,
      bidirectional_tag,
      typename streams_boost::mpl::if_<typename DirectedS::is_directed_t,
...
//    typedef typename inherited::edge_descriptor   edge_descriptor;
    ...
    STREAMS_BOOST_STATIC_ASSERT((is_same<edge_parallel_category,
    ...
    typedef typename streams_boost::mpl::if_<
              ...
              typename streams_boost::mpl::if_<is_same<DirectedS, bidirectionalS>,
  ...
  public:
    ...
    typedef streams_boost::adjacency_iterator<
  ...
  public:
    ...
    streams_boost::function<void(vertex_descriptor, adjacency_list&)> on_add_vertex;

    // Callback that will be invoked whenever a new edge is added locally
    streams_boost::function<void(edge_descriptor, adjacency_list&)> on_add_edge;
  ...
  public:
    ...
    typedef  streams_boost::detail::parallel::msg_nonlocal_edge_data<
      edge_property_type,local_edge_descriptor> msg_nonlocal_edge_data;

    typedef streams_boost::detail::parallel::msg_remove_edge_data<edge_descriptor>
      msg_remove_edge_data;
    ...
    streams_boost::parallel::detail::untracked_pair<edge_descriptor, bool>
  ...
  protected:
                    ...
                    processor_id_type other_proc, bidirectionalS)
    {
      ...
      streams_boost::graph_detail::push(get(vertex_in_edges, base())[v], edge);
    }
                      ...
                      processor_id_type other_proc, bidirectionalS)
    {
      ...
      if (src.owner == process_id(process_group_)) {
        ...
        if (ei != ei_end) streams_boost::remove_edge(ei, base());
  ...
  PBGL_DISTRIB_ADJLIST_TYPE::lazy_add_edge::commit() const
  {
    ...
    if (source.owner == self.processor())
      ...
      streams_boost::parallel::detail::untracked_pair<edge_descriptor, bool> result;
  ...
  add_local_edge(const edge_property_type& property, bidirectionalS) const
  {
    ...
    if (result.second) {
      if (target.owner == self.processor()) {
        ...
        streams_boost::graph_detail::push(get(vertex_in_edges, 
      ...
      bool operator()(const argument_type& le)
      {
        ...
        if (predicate(e)) {
          if (source(e, g).owner != target(e, g).owner
            ...
            ::streams_boost::detail::parallel::remove_in_edge(e, g,
                                                      directed_selector());
      ...
      bool operator()(const argument_type& e)
      {
        if (predicate(e)) {
          if (source(e, g).owner != target(e, g).owner)
            g.send_remove_edge_request(e);
          if (target(e, g).owner == g.processor())
            ::streams_boost::detail::parallel::remove_in_edge(e, g, undirectedS());
          if (source(e, g).owner == g.processor())
            remove_edge(e.local, g.base());
          return true;
        } else return false;
  ...
  struct property_map<PBGL_DISTRIB_ADJLIST_TYPE const, Property>
          : streams_boost::detail::parallel::get_adj_list_pmap<Property>
// FIXME: in the original code the following was not const
  ...
  namespace mpi {
    ...
    struct is_mpi_datatype<streams_boost::detail::edge_base<Directed, Vertex> >
      : is_mpi_datatype<Vertex> { };

    template<typename Directed, typename Vertex>
    struct is_mpi_datatype<streams_boost::detail::edge_desc_impl<Directed, Vertex> >
      : is_mpi_datatype<streams_boost::detail::edge_base<Directed, Vertex> > { };

    template<typename LocalDescriptor>
    struct is_mpi_datatype<streams_boost::detail::parallel::global_descriptor<LocalDescriptor> >
      : is_mpi_datatype<LocalDescriptor> { };

    template<typename Edge>
    struct is_mpi_datatype<streams_boost::detail::parallel::edge_descriptor<Edge> >
      : is_mpi_datatype<Edge> { };

    template<typename Vertex, typename LocalVertex>
    struct is_mpi_datatype<streams_boost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : is_mpi_datatype<Vertex> { };
   ...
   struct is_mpi_datatype<streams_boost::detail::parallel::msg_nonlocal_edge_data<
                          EdgeProperty,EdgeDescriptor> >
           : mpl::and_<
               is_mpi_datatype<streams_boost::detail::parallel::maybe_store_property<
                           EdgeProperty> >,
  ...
  {};
   ...
   struct is_mpi_datatype<
            streams_boost::detail::parallel::msg_remove_edge_data<EdgeDescriptor> >
           : is_mpi_datatype<EdgeDescriptor> {};
  }
  ...
  namespace serialization {
    template<typename Directed, typename Vertex>
    struct is_bitwise_serializable<streams_boost::detail::edge_base<Directed, Vertex> >
      : is_bitwise_serializable<Vertex> { };

    template<typename Directed, typename Vertex>
    struct is_bitwise_serializable<streams_boost::detail::edge_desc_impl<Directed, Vertex> >
      : is_bitwise_serializable<streams_boost::detail::edge_base<Directed, Vertex> > { };

    template<typename LocalDescriptor>
    struct is_bitwise_serializable<streams_boost::detail::parallel::global_descriptor<LocalDescriptor> >
      : is_bitwise_serializable<LocalDescriptor> { };

    template<typename Edge>
    struct is_bitwise_serializable<streams_boost::detail::parallel::edge_descriptor<Edge> >
      : is_bitwise_serializable<Edge> { };

    template<typename Vertex, typename LocalVertex>
    struct is_bitwise_serializable<streams_boost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : is_bitwise_serializable<Vertex> { };
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct is_bitwise_serializable<streams_boost::detail::parallel::msg_nonlocal_edge_data<
                                  EdgeProperty,EdgeDescriptor> >
           : mpl::and_<
               is_bitwise_serializable<
                streams_boost::detail::parallel::maybe_store_property<EdgeProperty> >,
  ...
  {};
   ...
   struct is_bitwise_serializable<
    ...
    template<typename Directed, typename Vertex>
    struct implementation_level<streams_boost::detail::edge_base<Directed, Vertex> >
      : mpl::int_<object_serializable> {};

    template<typename Directed, typename Vertex>
    struct implementation_level<streams_boost::detail::edge_desc_impl<Directed, Vertex> >
      : mpl::int_<object_serializable> {};

    template<typename LocalDescriptor>
    struct implementation_level<streams_boost::detail::parallel::global_descriptor<LocalDescriptor> >
      : mpl::int_<object_serializable> {};

    template<typename Edge>
    struct implementation_level<streams_boost::detail::parallel::edge_descriptor<Edge> >
      : mpl::int_<object_serializable> {};

    template<typename Vertex, typename LocalVertex>
    struct implementation_level<streams_boost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : mpl::int_<object_serializable> {};
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct implementation_level<streams_boost::detail::parallel::msg_nonlocal_edge_data<
                               EdgeProperty,EdgeDescriptor> >
           : mpl::int_<object_serializable> {};
   ...
   struct implementation_level<
    ...
    template<typename Directed, typename Vertex>
    struct tracking_level<streams_boost::detail::edge_base<Directed, Vertex> >
      : mpl::int_<track_never> {};

    template<typename Directed, typename Vertex>
    struct tracking_level<streams_boost::detail::edge_desc_impl<Directed, Vertex> >
      : mpl::int_<track_never> {};

    template<typename LocalDescriptor>
    struct tracking_level<streams_boost::detail::parallel::global_descriptor<LocalDescriptor> >
      : mpl::int_<track_never> {};

    template<typename Edge>
    struct tracking_level<streams_boost::detail::parallel::edge_descriptor<Edge> >
      : mpl::int_<track_never> {};

    template<typename Vertex, typename LocalVertex>
    struct tracking_level<streams_boost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : mpl::int_<track_never> {};
   ...
   template<typename EdgeProperty, typename EdgeDescriptor>
   struct tracking_level<streams_boost::detail::parallel::msg_nonlocal_edge_data<
                         EdgeProperty,EdgeDescriptor> >
           : mpl::int_<track_never> {};
...
#include <streams_boost/graph/distributed/adjlist/handlers.hpp>
#include <streams_boost/graph/distributed/adjlist/initialize.hpp>
#include <streams_boost/graph/distributed/adjlist/redistribute.hpp>
#include <streams_boost/graph/distributed/adjlist/serialization.hpp>

#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_ADJACENCY_LIST_HPP
