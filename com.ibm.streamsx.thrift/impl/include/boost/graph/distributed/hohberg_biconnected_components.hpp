...
//
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_HOHBERG_BICONNECTED_COMPONENTS_HPP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_HOHBERG_BICONNECTED_COMPONENTS_HPP
...
#include <streams_boost/graph/distributed/connected_components.hpp>
...
{
  using namespace streams_boost::graph::parallel;
  using namespace hohberg_detail;
  ...
  do {
    ...
    minimum_phase = all_reduce(pg, minimum_phase, streams_boost::mpi::minimum<char>());
    ...
    if (minimum_phase == 4
        && all_reduce(pg, maximum_phase, streams_boost::mpi::maximum<char>()) == 4) {
...
#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_HOHBERG_BICONNECTED_COMPONENTS_HPP
