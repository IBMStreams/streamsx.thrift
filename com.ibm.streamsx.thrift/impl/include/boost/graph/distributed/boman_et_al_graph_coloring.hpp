...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_DISTRIBUTED_BOMAN_ET_AL_GRAPH_COLORING_HPP
#define STREAMS_BOOST_GRAPH_DISTRIBUTED_BOMAN_ET_AL_GRAPH_COLORING_HPP
   ...
   VertexOrdering ordering, VertexIndexMap vertex_index)
{
  ...
  rounds = all_reduce(pg, rounds, streams_boost::parallel::maximum<std::size_t>());
  ...
  num_colors = 
    all_reduce(pg, num_colors, streams_boost::parallel::maximum<color_type>());
...
#endif // STREAMS_BOOST_GRAPH_DISTRIBUTED_BOMAN_ET_AL_GRAPH_COLORING_HPP
