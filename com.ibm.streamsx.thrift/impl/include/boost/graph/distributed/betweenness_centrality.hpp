...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_GRAPH_PARALLEL_BRANDES_BETWEENNESS_CENTRALITY_HPP
#define STREAMS_BOOST_GRAPH_PARALLEL_BRANDES_BETWEENNESS_CENTRALITY_HPP
...
#include <streams_boost/graph/betweenness_centrality.hpp>
#include <streams_boost/graph/overloading.hpp>
...
#include <streams_boost/graph/distributed/distributed_graph_utility.hpp>
...
#include <streams_boost/graph/distributed/detail/dijkstra_shortest_paths.hpp>
...
struct append_reducer {
  STREAMS_BOOST_STATIC_CONSTANT(bool, non_default_resolver = true);
...
namespace streams_boost {
  ...
  namespace serialization {
    ...
    void serialize(Archive & ar,
                   streams_boost::tuple<T1,T2,T3, T4>& t,
                   const unsigned int)
    {
      ar & streams_boost::tuples::get<0>(t);
      ar & streams_boost::tuples::get<1>(t);
      ar & streams_boost::tuples::get<2>(t);
      ar & streams_boost::tuples::get<3>(t);
    }
  ...
  public:
    ...
    owner_type get_owner(Tuple t) { return get(owner, streams_boost::tuples::get<0>(t)); }
  ...
  class betweenness_centrality_delta_stepping_impl { 
    ...
    typedef typename streams_boost::graph::parallel::process_group_type<Graph>::type 
      ProcessGroup;
  ...
  private:
    ...
    void synchronize()
    {
      using streams_boost::graph::parallel::synchronize;
      synchronize(pg);
    }
    ...
    void setup_triggers()
    {
      using streams_boost::graph::parallel::simple_trigger;
...
#endif
      delta(delta),
      pg(streams_boost::graph::parallel::process_group_adl(g), attach_distributed_object()),
  ...
  run(Vertex s)
  {
    ...
    do {
      ...
      using streams_boost::parallel::all_reduce;
      using streams_boost::parallel::minimum;
      ...
      typedef streams_boost::queue<queue_value_type> local_queue_type;
      typedef streams_boost::graph::distributed::distributed_queue<process_group_type,
                                                           IndirectOwnerMap,
  ...
  private:
    ...
    {
      using streams_boost::parallel::all_reduce;
      using streams_boost::parallel::maximum;
      using std::max;
      ...
      BGL_FORALL_VERTICES_T(u, g, Graph) {
        max_degree = max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION (max_degree, out_degree(u, g));
        BGL_FORALL_OUTEDGES_T(u, e, g, Graph)
          max_edge_weight = max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION (max_edge_weight, get(weight, e));
      }
  ...
  do_brandes_sssp(const Graph& g, 
                  ...
                  typename graph_traits<Graph>::vertex_descriptor s)
  {
    using streams_boost::detail::graph::update_centrality;      
    using streams_boost::graph::parallel::process_group;
    ...
    typedef streams_boost::tuple<vertex_descriptor, vertex_descriptor, dependency_type, path_count_type>
      queue_value_type;
    ...
    dependency_count.set_reduce(streams_boost::graph::distributed::additive_reducer<dependency_type>());
    ...
    BGL_FORALL_VERTICES_T(v, g, Graph) {
      if (get(distance, v) < (std::numeric_limits<distance_type>::max)()
        ...
        Q.push(streams_boost::make_tuple(v, v, get(dependency, v), get(path_count, v)));
    }
    ...
    while(!Q.empty()) {
      ...
      vertex_descriptor w = streams_boost::tuples::get<0>(x);
      vertex_descriptor source = streams_boost::tuples::get<1>(x);
      dependency_type dep = streams_boost::tuples::get<2>(x);
      path_count_type pc = streams_boost::tuples::get<3>(x);
      ...
      if (get(dependency_count, w) == 0) { 
        ...
        for (incoming_iterator vw = el.begin(); vw != el.end(); ++vw)
          Q.push(streams_boost::make_tuple(*vw, w, get(dependency, w), get(path_count, w)));
      }
    }
  }
  ...
  brandes_betweenness_centrality_impl(const Graph& g, 
                                      ...
                                      Buffer sources)
  {
    using streams_boost::detail::graph::init_centrality_map;
    using streams_boost::detail::graph::divide_centrality_by_two;       
    using streams_boost::graph::parallel::process_group;
    ...
    dependency.set_reduce(streams_boost::graph::distributed::additive_reducer<dependency_type>()); 
    distance.set_reduce(streams_boost::graph::distributed::choose_min_reducer<distance_type>());
    ...
    if (!sources.empty()) {
      ...
      n = streams_boost::parallel::all_reduce(pg, n, std::plus<vertices_size_type>());
...
brandes_betweenness_centrality(const Graph& g, 
                               ...
                               STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  typedef typename property_traits<DistanceMap>::value_type distance_type;
...
namespace graph { namespace parallel { namespace detail {
  ...
  struct brandes_betweenness_centrality_dispatch1
  {
    ...
    {
      streams_boost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
       g, centrality, edge_centrality_map, weight_map, vertex_index, sources, delta);
    }
  };

  template<>
  struct brandes_betweenness_centrality_dispatch1<streams_boost::detail::error_property_not_found> 
  {
    template<typename Graph, typename CentralityMap, typename EdgeCentralityMap, 
             typename VertexIndexMap, typename Buffer>
    static void 
                               ...
                               STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  graph::parallel::detail::brandes_betweenness_centrality_dispatch1<ew>::run(
    ...
    choose_param(get_param(params, buffer_param_t()), streams_boost::ref(q)),
                               ...
                               STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  streams_boost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, dummy_property_map(), get(vertex_index, g), streams_boost::ref(q), 0);
}
                               ...
                               STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  streams_boost::graph::parallel::detail::brandes_betweenness_centrality_dispatch2(
    g, centrality, edge_centrality_map, get(vertex_index, g), streams_boost::ref(q), 0);
}
                                               ...
                                               CentralityMap centrality)
{
  ...
  detail::graph::non_distributed_brandes_betweenness_centrality_dispatch2(
    pg, g, centrality, dummy_property_map(), get(vertex_index, g), streams_boost::ref(q));
}
                        ...
                        STREAMS_BOOST_GRAPH_ENABLE_IF_MODELS_PARM(Graph,distributed_graph_tag))
{
  ...
  typedef typename streams_boost::graph::parallel::process_group_type<Graph>::type 
    process_group_type;
  process_group_type pg = streams_boost::graph::parallel::process_group(g);
  ...
  max_centrality = all_reduce(pg, max_centrality, streams_boost::parallel::maximum<centrality_type>());
...
#endif // STREAMS_BOOST_GRAPH_PARALLEL_BRANDES_BETWEENNESS_CENTRALITY_HPP
