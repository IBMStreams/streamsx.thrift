...
#ifndef STREAMS_BOOST_INCREMENTAL_COMPONENTS_HPP
#define STREAMS_BOOST_INCREMENTAL_COMPONENTS_HPP

#include <streams_boost/detail/iterator.hpp>
#include <streams_boost/graph/detail/incremental_components.hpp>
...
namespace streams_boost {
  ...
  // streams_boost/pending/disjoint_sets.hpp
  ...
  template <class ParentIterator>
  typename streams_boost::detail::iterator_traits<ParentIterator>::difference_type
  ...
  public:
    ...
    component_index(ParentIterator parent_start,
      ...
      build_index_lists(parent_start, streams_boost::identity_property_map());
...
#endif // STREAMS_BOOST_INCREMENTAL_COMPONENTS_HPP
