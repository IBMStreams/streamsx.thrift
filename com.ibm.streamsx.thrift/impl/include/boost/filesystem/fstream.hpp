//  streams_boost/filesystem/fstream.hpp  --------------------------------------------//
...
#ifndef STREAMS_BOOST_FILESYSTEM_FSTREAM_HPP
#define STREAMS_BOOST_FILESYSTEM_FSTREAM_HPP

#include <streams_boost/filesystem/operations.hpp> // for 8.3 hack (see below)
...
#     if !defined(STREAMS_BOOST_DINKUMWARE_STDLIB) || STREAMS_BOOST_DINKUMWARE_STDLIB < 405
      // The 8.3 hack:
      ...
      STREAMS_BOOST_FILESYSTEM_DECL bool create_file_api( const std::wstring & ph,
        std::ios_base::openmode mode ); // true if succeeds
      STREAMS_BOOST_FILESYSTEM_DECL std::string narrow_path_api(
...
#   ifndef STREAMS_BOOST_FILESYSTEM_NARROW_ONLY
      template<class Path>
      typename streams_boost::enable_if<is_basic_path<Path>,
...
#   if !STREAMS_BOOST_WORKAROUND( STREAMS_BOOST_MSVC, <= 1200 ) // VC++ 6.0 can't handle this
      basic_filebuf<charT,traits> *
      open( const path & file_ph, std::ios_base::openmode mode );
#   endif
    };
...
#   ifndef STREAMS_BOOST_FILESYSTEM_NARROW_ONLY
      ...
      explicit basic_ifstream( const Path & file_ph,
        typename streams_boost::enable_if<is_basic_path<Path> >::type* dummy = 0 );
      ...
      template<class Path>
      typename streams_boost::enable_if<is_basic_path<Path>, void>::type
...
//  basic_filebuf definitions  -----------------------------------------------//
    ...
    basic_filebuf<charT, traits>::open( const wpath & file_ph,
      std::ios_base::openmode mode )
    {
      return this->STREAMS_BOOST_NESTED_TEMPLATE open<wpath>( file_ph, mode );
    }
...
//  basic_ifstream definitions  ----------------------------------------------//
    ...
    basic_ifstream<charT,traits>::basic_ifstream(const Path & file_ph,
      typename streams_boost::enable_if<is_basic_path<Path> >::type* )
...
#endif  // STREAMS_BOOST_FILESYSTEM_FSTREAM_HPP
