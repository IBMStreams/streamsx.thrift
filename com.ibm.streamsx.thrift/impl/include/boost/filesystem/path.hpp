//  streams_boost/filesystem/path.hpp  -----------------------------------------------//
...
#ifndef STREAMS_BOOST_FILESYSTEM_PATH_HPP
#define STREAMS_BOOST_FILESYSTEM_PATH_HPP

#include <streams_boost/filesystem/config.hpp>
...
{
  namespace STREAMS_BOOST_FILESYSTEM_NAMESPACE
  {
...
# ifndef STREAMS_BOOST_FILESYSTEM_NARROW_ONLY
    ...
    struct STREAMS_BOOST_FILESYSTEM_DECL wpath_traits;
...
//      STREAMS_BOOST_STATIC_ASSERT( ::streams_boost::is_same<String,typename Traits::internal_string_type>::value );
//      STREAMS_BOOST_STATIC_ASSERT( ::streams_boost::is_same<typename Traits::external_string_type,std::string>::value || ::streams_boost::is_same<typename Traits::external_string_type,std::wstring>::value );
...
#     ifndef STREAMS_BOOST_NO_MEMBER_TEMPLATES
...
#     endif
     ~basic_path() {}
      ...
      {
#     if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_DINKUMWARE_STDLIB, >= 310)
        m_path.clear();
#     else
...
#       ifdef STREAMS_BOOST_CYGWIN_PATH
...
# endif
      ...
      // iterators
      class iterator : public streams_boost::iterator_facade<
        iterator,
        string_type const,
      ...
      private:
        ...
        friend class streams_boost::STREAMS_BOOST_FILESYSTEM_NAMESPACE::basic_path<String, Traits>;
        ...
        friend class streams_boost::STREAMS_BOOST_FILESYSTEM_NAMESPACE::detail::iterator_helper<path_type>;

        void increment()
        { 
          streams_boost::STREAMS_BOOST_FILESYSTEM_NAMESPACE::detail::iterator_helper<path_type>::do_increment(
            *this );
        }
        void decrement()
        { 
          streams_boost::STREAMS_BOOST_FILESYSTEM_NAMESPACE::detail::iterator_helper<path_type>::do_decrement(
            *this );
        }
...
# endif
  ...
  //  basic_path non-member functions  ---------------------------------------//
    ...
    {
      typedef typename
        streams_boost::STREAMS_BOOST_FILESYSTEM_NAMESPACE::basic_path<String, Traits> path_type;
...
# if !STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1300) && !STREAMS_BOOST_WORKAROUND(__BORLANDC__, < 0x610)
    template< class Path >
...
# elif STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x564))
    template< class String, class Traits >
    std::basic_ostream< STREAMS_BOOST_DEDUCED_TYPENAME String::value_type,
      STREAMS_BOOST_DEDUCED_TYPENAME String::traits_type > &
      operator<<
      ( std::basic_ostream< STREAMS_BOOST_DEDUCED_TYPENAME String::value_type,
          STREAMS_BOOST_DEDUCED_TYPENAME String::traits_type >& os, 
    ...
    template< class String, class Traits >
    std::basic_istream< STREAMS_BOOST_DEDUCED_TYPENAME String::value_type, 
      STREAMS_BOOST_DEDUCED_TYPENAME String::traits_type > &
      operator>>
      ( std::basic_istream< STREAMS_BOOST_DEDUCED_TYPENAME String::value_type,
          STREAMS_BOOST_DEDUCED_TYPENAME String::traits_type> & is,
...
# endif
    ...
    namespace detail
    {
      // STREAMS_BOOST_FILESYSTEM_DECL version works for VC++ but not GCC. Go figure!
      inline
    ...
    {
    // see http://www.streams_boost.org/more/error_handling.html for design rationale
    public:
      // compiler generates copy constructor and copy assignment
    ...
    private:
      ...
      streams_boost::shared_ptr<m_imp> m_imp_ptr;
    };
...
# endif
  ...
  //  path::name_checks  -----------------------------------------------------//
    ...
    STREAMS_BOOST_FILESYSTEM_DECL bool portable_posix_name( const std::string & name );
    STREAMS_BOOST_FILESYSTEM_DECL bool windows_name( const std::string & name );
    STREAMS_BOOST_FILESYSTEM_DECL bool portable_name( const std::string & name );
    STREAMS_BOOST_FILESYSTEM_DECL bool portable_directory_name( const std::string & name );
    STREAMS_BOOST_FILESYSTEM_DECL bool portable_file_name( const std::string & name );
    STREAMS_BOOST_FILESYSTEM_DECL bool native( const std::string & name );
...
#       if !STREAMS_BOOST_WORKAROUND( STREAMS_BOOST_MSVC, <= 1310 ) // VC++ 7.1
...
#       endif
          )
      {
        ...
        typedef typename streams_boost::STREAMS_BOOST_FILESYSTEM_NAMESPACE::basic_path<String, Traits> path_type;
...
#     endif
      ...
      {
        typedef typename
          streams_boost::STREAMS_BOOST_FILESYSTEM_NAMESPACE::basic_path<String, Traits>
            path_type;
...
#   ifdef STREAMS_BOOST_WINDOWS_PATH
      // for STREAMS_BOOST_WINDOWS_PATH, convert alt_separator ('\') to separator ('/')
...
#   endif
    ...
    // except that it wouldn't work for STREAMS_BOOST_NO_MEMBER_TEMPLATES compilers,
...
#endif // STREAMS_BOOST_FILESYSTEM_PATH_HPP
