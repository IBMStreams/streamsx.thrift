...
#if !defined(STREAMS_BOOST_SPIRIT_REPOSITORY_QI_ITER_POS_NOV_20_2009_1245PM)
#define STREAMS_BOOST_SPIRIT_REPOSITORY_QI_ITER_POS_NOV_20_2009_1245PM

#include <streams_boost/spirit/include/qi_parse.hpp>

///////////////////////////////////////////////////////////////////////////////
// definition the place holder 
namespace streams_boost { namespace spirit { namespace repository { namespace qi
{
    STREAMS_BOOST_SPIRIT_TERMINAL(iter_pos);
}}}} 
...
namespace streams_boost { namespace spirit { namespace repository { namespace qi
{
    struct iter_pos_parser 
      : streams_boost::spirit::qi::primitive_parser<iter_pos_parser>
    {
        ...
        {
            streams_boost::spirit::qi::skip_over(first, last, skipper);
            streams_boost::spirit::traits::assign_to(first, attr);
            return true;
        }
        ...
        {
            return streams_boost::spirit::info("iter_pos");
        }
    };
}}}}
