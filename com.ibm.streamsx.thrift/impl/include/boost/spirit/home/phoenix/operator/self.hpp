...
namespace streams_boost { namespace phoenix
{
    ...
    STREAMS_BOOST_UNARY_RESULT_OF(&x, result_of_reference)
    STREAMS_BOOST_UNARY_RESULT_OF(*x, result_of_dereference)
    STREAMS_BOOST_BINARY_RESULT_OF(x = y, result_of_assign)
    STREAMS_BOOST_ASYMMETRIC_BINARY_RESULT_OF(x[y], result_of_index)
