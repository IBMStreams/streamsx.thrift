...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1                                                           \
        (3, (1, PHOENIX_MEMBER_LIMIT, "streams_boost/spirit/home/phoenix/operator/detail/mem_fun_ptr_return.hpp"))
...
#define PHOENIX_ITERATION STREAMS_BOOST_PP_ITERATION()
    ...
    template<typename Ret, typename Class,
             STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION, typename T)>
    struct mem_fun_ptr_return<Ret (Class::*)(STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION, T))>
    {
        typedef Ret type;
    };
    ...
    template<typename Ret, typename Class,
             STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION, typename T)>
    struct mem_fun_ptr_return<Ret (Class::*)(STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION, T)) const>
    {
        typedef Ret type;
    };
