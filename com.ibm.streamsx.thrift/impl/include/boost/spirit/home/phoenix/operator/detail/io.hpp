...
#include <streams_boost/spirit/home/phoenix/operator/bitwise.hpp>
#include <streams_boost/spirit/home/phoenix/core/reference.hpp>
...
namespace streams_boost { namespace phoenix { namespace detail
{
    ...
    struct is_ostream
    {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool,
            value = sizeof(detail::ostream_test(streams_boost::addressof(x))) == sizeof(yes));
    };
    ...
    struct is_istream
    {
        static T x;
        STREAMS_BOOST_STATIC_CONSTANT(bool,
            value = sizeof(detail::istream_test(streams_boost::addressof(x))) == sizeof(yes));
    };
