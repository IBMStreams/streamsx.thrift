...
#include <streams_boost/spirit/home/phoenix/core/composite.hpp>
#include <streams_boost/spirit/home/phoenix/core/compose.hpp>
#include <streams_boost/spirit/home/phoenix/detail/type_deduction.hpp>
#include <streams_boost/spirit/home/phoenix/operator/detail/unary_eval.hpp>
#include <streams_boost/spirit/home/phoenix/operator/detail/unary_compose.hpp>
#include <streams_boost/spirit/home/phoenix/operator/detail/binary_eval.hpp>
#include <streams_boost/spirit/home/phoenix/operator/detail/binary_compose.hpp>
...
namespace streams_boost { namespace phoenix
{
    ...
    STREAMS_BOOST_UNARY_RESULT_OF(-x, result_of_negate)
    STREAMS_BOOST_UNARY_RESULT_OF(+x, result_of_posit)
    STREAMS_BOOST_UNARY_RESULT_OF(++x, result_of_pre_increment)
    STREAMS_BOOST_UNARY_RESULT_OF(--x, result_of_pre_decrement)
    STREAMS_BOOST_UNARY_RESULT_OF(x++, result_of_post_increment)
    STREAMS_BOOST_UNARY_RESULT_OF(x--, result_of_post_decrement)

    STREAMS_BOOST_BINARY_RESULT_OF(x += y, result_of_plus_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x -= y, result_of_minus_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x *= y, result_of_multiplies_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x /= y, result_of_divides_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x %= y, result_of_modulus_assign)

    STREAMS_BOOST_BINARY_RESULT_OF(x + y, result_of_plus)
    STREAMS_BOOST_BINARY_RESULT_OF(x - y, result_of_minus)
    STREAMS_BOOST_BINARY_RESULT_OF(x * y, result_of_multiplies)
    STREAMS_BOOST_BINARY_RESULT_OF(x / y, result_of_divides)
    STREAMS_BOOST_BINARY_RESULT_OF(x % y, result_of_modulus)
