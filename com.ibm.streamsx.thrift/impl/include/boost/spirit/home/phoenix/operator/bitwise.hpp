...
namespace streams_boost { namespace phoenix
{
    ...
    STREAMS_BOOST_UNARY_RESULT_OF(~x, result_of_invert)

    STREAMS_BOOST_BINARY_RESULT_OF(x &= y, result_of_and_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x |= y, result_of_or_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x ^= y, result_of_xor_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x <<= y, result_of_shift_left_assign)
    STREAMS_BOOST_BINARY_RESULT_OF(x >>= y, result_of_shift_right_assign)

    STREAMS_BOOST_BINARY_RESULT_OF(x & y, result_of_and)
    STREAMS_BOOST_BINARY_RESULT_OF(x | y, result_of_or)
    STREAMS_BOOST_BINARY_RESULT_OF(x ^ y, result_of_xor)
    STREAMS_BOOST_BINARY_RESULT_OF(x << y, result_of_shift_left)
    STREAMS_BOOST_BINARY_RESULT_OF(x >> y, result_of_shift_right)
