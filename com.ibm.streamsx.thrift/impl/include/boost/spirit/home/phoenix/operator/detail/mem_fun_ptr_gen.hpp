...
#include <streams_boost/spirit/home/phoenix/core/as_actor.hpp>
...
#include <streams_boost/spirit/home/phoenix/operator/detail/mem_fun_ptr_eval.hpp>
...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1                                                        \
        (3, (1, STREAMS_BOOST_PP_DEC(STREAMS_BOOST_PP_DEC(PHOENIX_MEMBER_LIMIT)), "streams_boost/spirit/home/phoenix/operator/detail/mem_fun_ptr_gen.hpp"))
...
#define PHOENIX_ITERATION STREAMS_BOOST_PP_ITERATION()
        ...
        template<STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION, typename Arg)>
        actor<typename as_composite<
            mem_fun_ptr_eval, Actor, typename as_actor<MemFunPtr>::type,
            STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION, Arg)>::type>
        operator()(
            STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(PHOENIX_ITERATION, const Arg, &arg)) const
        {
            return compose<mem_fun_ptr_eval>(
                mActor, as_actor<MemFunPtr>::convert(mMemFunPtr),
                STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_ITERATION, arg));
        }
