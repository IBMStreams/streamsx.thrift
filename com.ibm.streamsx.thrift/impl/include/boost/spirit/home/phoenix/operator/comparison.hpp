...
namespace streams_boost { namespace phoenix
{
    ...
    STREAMS_BOOST_BINARY_RESULT_OF(x == y, result_of_equal_to)
    STREAMS_BOOST_BINARY_RESULT_OF(x != y, result_of_not_equal_to)
    STREAMS_BOOST_BINARY_RESULT_OF(x < y, result_of_less)
    STREAMS_BOOST_BINARY_RESULT_OF(x <= y, result_of_less_equal)
    STREAMS_BOOST_BINARY_RESULT_OF(x > y, result_of_greater)
    STREAMS_BOOST_BINARY_RESULT_OF(x >= y, result_of_greater_equal)
