...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1                                             \
    ...
    "streams_boost/spirit/home/phoenix/object/detail/new.hpp"))
...
#define N STREAMS_BOOST_PP_ITERATION()
    ...
    new_(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(N, A, const& _))
    {
        return compose<detail::new_eval<T> >(STREAMS_BOOST_PP_ENUM_PARAMS(N, _));
    }
