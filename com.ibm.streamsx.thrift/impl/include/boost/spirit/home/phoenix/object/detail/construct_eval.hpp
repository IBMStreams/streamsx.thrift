...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1                                             \
    ...
    "streams_boost/spirit/home/phoenix/object/detail/construct_eval.hpp"))
...
#define N STREAMS_BOOST_PP_ITERATION()
    ...
    template <typename RT, typename Env, STREAMS_BOOST_PP_ENUM_PARAMS(N, typename A)>
    static RT
    eval(Env const& env, STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(N, A, & _))
    {
        return RT(STREAMS_BOOST_PP_ENUM(N, PHOENIX_EVAL_ARG, _));
    }
