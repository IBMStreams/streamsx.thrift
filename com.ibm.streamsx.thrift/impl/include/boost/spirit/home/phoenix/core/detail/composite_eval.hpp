...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1                                             \
    ...
    "streams_boost/spirit/home/phoenix/core/detail/composite_eval.hpp"))
...
#define N STREAMS_BOOST_PP_ITERATION()
    ...
    namespace detail
    {
        ...
        struct composite_eval<N>
        {
            ...
            struct result
            {
                STREAMS_BOOST_PP_REPEAT(N, PHOENIX_GET_ACTOR_TYPE, _)

                typedef typename
                    Composite::eval_policy_type::template result<
                        Env, STREAMS_BOOST_PP_ENUM_PARAMS(N, actor)
                    >::type
                type;
            };
            ...
            call(Composite const& composite, Env const& env)
            {
                ...
                return eval_policy_type::template eval<RT>(
                    env, STREAMS_BOOST_PP_ENUM(N, PHOENIX_GET_ACTOR, _));
            }
        };
    }
