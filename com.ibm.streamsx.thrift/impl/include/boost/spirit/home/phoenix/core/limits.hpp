...
# define PHOENIX_MEMBER_LIMIT STREAMS_BOOST_PP_DEC(STREAMS_BOOST_PP_DEC(PHOENIX_COMPOSITE_LIMIT))
...
# define PHOENIX_CATCH_LIMIT STREAMS_BOOST_PP_DEC(PHOENIX_COMPOSITE_LIMIT)
