...
#include <streams_boost/spirit/home/phoenix/core/value.hpp>
#include <streams_boost/spirit/home/phoenix/core/as_actor.hpp>

#define PHOENIX_AS_ACTOR(z, n, data)                                            \
    typename mpl::eval_if<                                                      \
        is_same<STREAMS_BOOST_PP_CAT(T, n), fusion::void_>                              \
      , mpl::identity<fusion::void_>                                            \
      , as_actor_base<STREAMS_BOOST_PP_CAT(T, n)>                                       \
    >::type
...
///////////////////////////////////////////////////////////////////////////////
    ...
    struct as_composite
    {
        typedef composite<
            EvalPolicy
          , fusion::vector<
                STREAMS_BOOST_PP_ENUM(PHOENIX_COMPOSITE_LIMIT, PHOENIX_AS_ACTOR, _)>
        >
        type;
    };
...
///////////////////////////////////////////////////////////////////////////////
    ...
    #include <streams_boost/spirit/home/phoenix/core/detail/compose.hpp>
    ...
    struct re_curry
    {
        typedef actor<
            typename as_composite<
                EvalPolicy
              , STREAMS_BOOST_PP_ENUM_PARAMS(PHOENIX_COMPOSITE_LIMIT, T)>::type
            >
        type;
    };
}}
