...
#if !defined(STREAMS_BOOST_RESULT_OF_NUM_ARGS)
# define STREAMS_BOOST_RESULT_OF_NUM_ARGS PHOENIX_ACTOR_LIMIT
#elif (STREAMS_BOOST_RESULT_OF_NUM_ARGS < PHOENIX_ACTOR_LIMIT)
# error "STREAMS_BOOST_RESULT_OF_NUM_ARGS < PHOENIX_ACTOR_LIMIT"
#endif

#include <streams_boost/spirit/home/phoenix/core/basic_environment.hpp>
#include <streams_boost/mpl/min.hpp>
...
namespace streams_boost { namespace phoenix
{
    ...
    struct actor : Eval
    {
        ...
        #include <streams_boost/spirit/home/phoenix/core/detail/actor.hpp>
