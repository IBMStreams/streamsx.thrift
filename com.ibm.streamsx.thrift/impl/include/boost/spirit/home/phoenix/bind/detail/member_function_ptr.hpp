...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1                                             \
    ...
    "streams_boost/spirit/home/phoenix/bind/detail/member_function_ptr.hpp"))
...
#define N STREAMS_BOOST_PP_ITERATION()
    ...
    struct member_function_ptr_impl<N>
    {
        ...
        struct impl
        {
            template <typename Class, STREAMS_BOOST_PP_ENUM_PARAMS(N, typename T)>
            struct result
            {
                typedef RT type;
            };
            ...
            template <typename Class, STREAMS_BOOST_PP_ENUM_PARAMS(N, typename A)>
            RT operator()(Class& obj, STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(N, A, & _)) const
            {
                return (obj.*fp)(STREAMS_BOOST_PP_ENUM_PARAMS(N, _));
            }
