...
#include <streams_boost/spirit/home/phoenix/stl/container/detail/container.hpp>
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl
    {
        ...
        struct erase
        {
            ...
            struct result
            {
                //  STREAMS_BOOST_MSVC #if branch here in map_erase_result non-
                ...
                //  streams_boost::phoenix::stl::erase::operator() 'void' function
                //  returning a value. Oh well... :*

                typedef
                    streams_boost::mpl::eval_if<
                        streams_boost::is_same<Arg1, typename iterator_of<C>::type>
#if defined(STREAMS_BOOST_MSVC) && (STREAMS_BOOST_MSVC <= 1500)
                      , iterator_of<C>
#else
                      , streams_boost::mpl::identity<void>
#endif
                      , size_type_of<C>
                    >
                map_erase_result;
        ...
        struct insert
        {
                ...
                typedef
                    streams_boost::mpl::eval_if<
                        streams_boost::mpl::and_<
                            streams_boost::is_same<Arg3, fusion::void_>
                          , streams_boost::mpl::not_<streams_boost::is_same<Arg1, Arg2> > >
                      , iterator_of<C>
                      , streams_boost::mpl::identity<void>
                    >
                choice_2;
            ...
            public:
                ...
                typedef typename
                    streams_boost::mpl::eval_if<
                        streams_boost::is_same<Arg2, fusion::void_>
                      , choice_1
                      , choice_2
                    >::type
                type;
...
}} // namespace streams_boost::phoenix
