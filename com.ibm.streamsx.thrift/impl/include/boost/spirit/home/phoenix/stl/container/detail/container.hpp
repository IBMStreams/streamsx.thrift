...
namespace streams_boost { namespace phoenix { namespace stl
{
///////////////////////////////////////////////////////////////////////////////
//
...
#define MEMBER_TYPE_OF(MEMBER_TYPE)                                             \
    template <typename C>                                                       \
    struct STREAMS_BOOST_PP_CAT(MEMBER_TYPE, _of)                                       \
    {                                                                           \
...
///////////////////////////////////////////////////////////////////////////////
    namespace stl_impl
    {
        ...
        struct map_insert_returns_pair
        {
            ...
            typedef streams_boost::mpl::bool_<value == sizeof(one)> type;
        };
    }
...
}}} // namespace streams_boost::phoenix::stl
