...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_PARAMETERIZED_AUGUST_09_2009_0601AM)
#define STREAMS_BOOST_SPIRIT_KARMA_PARAMETERIZED_AUGUST_09_2009_0601AM
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : generator<parameterized_nonterminal<Subject, Params> >
    {
        ...
        streams_boost::reference_wrapper<Subject const> ref;
        Params params;
    };
}}}
