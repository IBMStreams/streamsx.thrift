...
#if !defined(STREAMS_BOOST_SPIRIT_GENERATOR_JANUARY_13_2009_1002AM)
#define STREAMS_BOOST_SPIRIT_GENERATOR_JANUARY_13_2009_1002AM
...
namespace streams_boost { namespace spirit { namespace traits // classification
{
    namespace detail
    {
        // generator tags
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(generator_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(primitive_generator_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(nary_generator_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(unary_generator_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(binary_generator_id)
    }
