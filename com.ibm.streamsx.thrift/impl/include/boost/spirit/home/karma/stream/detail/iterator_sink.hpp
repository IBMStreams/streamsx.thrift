...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_SINK_MAY_27_2007_0133PM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_SINK_MAY_27_2007_0133PM
...
namespace streams_boost { namespace spirit { namespace karma { namespace detail
{
    ...
    {
        typedef streams_boost::iostreams::sink_tag category;
