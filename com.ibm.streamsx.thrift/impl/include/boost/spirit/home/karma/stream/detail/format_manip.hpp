...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_FORMAT_MANIP_MAY_03_2007_1424PM)
#define STREAMS_BOOST_SPIRIT_KARMA_FORMAT_MANIP_MAY_03_2007_1424PM
...
namespace streams_boost { namespace spirit { namespace karma { namespace detail
{
    ...
    struct format_manip 
    {
        ...
        STREAMS_BOOST_SPIRIT_ASSERT_MSG(!CopyExpr::value || !CopyAttr::value
        ...
        format_manip(Expr const& xpr, Delimiter const& d
            , STREAMS_BOOST_SCOPED_ENUM(delimit_flag) pre_delimit, Attribute const& a) 
          : expr(xpr), delim(d), pre(pre_delimit), attr(a) {}

        Expr const& expr;
        Delimiter const& delim;
        STREAMS_BOOST_SCOPED_ENUM(delimit_flag) const pre;
    ...
    struct format
    {
        ...
        // #include <streams_boost/spirit/include/karma_format_auto.hpp>?
