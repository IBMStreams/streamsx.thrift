...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_STREAM_MAY_01_2007_0310PM)
#define STREAMS_BOOST_SPIRIT_KARMA_STREAM_MAY_01_2007_0310PM
...
#include <streams_boost/spirit/home/support/detail/hold_any.hpp>
...
#include <streams_boost/spirit/home/karma/stream/detail/format_manip.hpp>
#include <streams_boost/spirit/home/karma/stream/detail/iterator_sink.hpp>
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : primitive_generator<any_stream_generator<Char, CharEncoding, Tag> >
    {
          ...
          , Delimiter const& d, Attribute const& attr)
        {
            ...
            streams_boost::iostreams::stream<sink_device> ostr(sink);
        ...
        generate(OutputIterator&, Context&, Delimiter const&, unused_type)
        {
            ...
            STREAMS_BOOST_SPIRIT_ASSERT_MSG(false, stream_not_usable_without_attribute, ());
            return false;
        }
