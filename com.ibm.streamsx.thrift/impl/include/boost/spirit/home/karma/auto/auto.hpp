...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_AUTO_NOV_29_2009_0339PM)
#define STREAMS_BOOST_SPIRIT_KARMA_AUTO_NOV_29_2009_0339PM
...
#include <streams_boost/spirit/home/karma/auto/create_generator.hpp>
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : generator<auto_generator<Modifiers> >
    {
        ...
        generate(OutputIterator&, Context&, Delimiter const&, unused_type)
        {
            ...
            STREAMS_BOOST_SPIRIT_ASSERT_MSG(false, auto_not_usable_without_attribute, ());
            return false;
        }
