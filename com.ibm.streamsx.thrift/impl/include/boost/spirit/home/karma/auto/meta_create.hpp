...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_META_CREATE_NOV_21_2009_0425PM)
#define STREAMS_BOOST_SPIRIT_KARMA_META_CREATE_NOV_21_2009_0425PM
...
#include <streams_boost/spirit/home/support/auto/meta_create.hpp>
...
namespace streams_boost { namespace spirit { namespace karma
{
    ...
    // optional
    template <typename T> 
    struct meta_create<streams_boost::optional<T> > 
    {
        typedef make_unary_proto_expr<
    ...
    struct meta_create<streams_boost::variant<STREAMS_BOOST_VARIANT_ENUM_PARAMS(T)> > 
    {
        typedef make_nary_proto_expr<
            typename streams_boost::variant<STREAMS_BOOST_VARIANT_ENUM_PARAMS(T)>::types
    ...
    template <> 
    struct meta_create<streams_boost::long_long_type> 
    { 
        typedef spirit::long_long_type type; 
        static type const& call() { return spirit::long_long; }
    };
    template <> 
    struct meta_create<streams_boost::ulong_long_type> 
    { 
