...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_PADDING_MAY_06_2008_0436PM)
#define STREAMS_BOOST_SPIRIT_KARMA_PADDING_MAY_06_2008_0436PM
...
{
    using streams_boost::spirit::pad;
    using streams_boost::spirit::pad_type;
