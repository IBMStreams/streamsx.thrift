...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_LIT_FEB_22_2007_0534PM)
#define STREAMS_BOOST_SPIRIT_KARMA_LIT_FEB_22_2007_0534PM
...
#include <streams_boost/spirit/home/karma/detail/string_compare.hpp>
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : primitive_generator<any_string<CharEncoding, Tag> >
    {
            ...
            unused_type const&)
        {
            ...
            STREAMS_BOOST_SPIRIT_ASSERT_MSG(false, string_not_usable_without_attribute, ());
            return false;
        }
