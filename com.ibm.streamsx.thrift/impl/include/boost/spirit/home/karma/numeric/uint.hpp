...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_UINT_FEB_23_2007_0840PM)
#define STREAMS_BOOST_SPIRIT_KARMA_UINT_FEB_23_2007_0840PM
...
namespace streams_boost { namespace spirit 
{
    ...
    struct use_terminal<karma::domain, streams_boost::ulong_long_type> 
      : mpl::true_ {};
#endif
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : primitive_generator<any_uint_generator<T, CharEncoding, Tag, Radix> >
    {
        ...
        generate(OutputIterator&, Context&, Delimiter const&, unused_type)
        {
            ...
            STREAMS_BOOST_SPIRIT_ASSERT_MSG(false, uint_not_usable_without_attribute, ());
            return false;
        }
    ...
    struct make_primitive<tag::ulong_long, Modifiers> 
      : detail::make_uint<streams_boost::ulong_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_uint_direct<streams_boost::ulong_long_type, Modifiers> {};
#endif
...
#ifdef STREAMS_BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<streams_boost::ulong_long_type, Modifiers> 
      : detail::basic_uint_literal<streams_boost::ulong_long_type, Modifiers> {};
#endif
