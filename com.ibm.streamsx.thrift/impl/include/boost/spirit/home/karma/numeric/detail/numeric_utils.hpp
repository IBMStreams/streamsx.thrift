...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_NUMERIC_UTILS_FEB_23_2007_0841PM)
#define STREAMS_BOOST_SPIRIT_KARMA_NUMERIC_UTILS_FEB_23_2007_0841PM
...
#include <streams_boost/spirit/home/support/detail/pow10.hpp>
#include <streams_boost/spirit/home/support/detail/sign.hpp>
#include <streams_boost/spirit/home/karma/detail/generate_to.hpp>
#include <streams_boost/spirit/home/karma/detail/string_generate.hpp>

///////////////////////////////////////////////////////////////////////////////
//
//  The value STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL specifies, how to unroll the 
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL)
#define STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL 6
#endif

#if STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL < 0 
#error "Please set the STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL to a non-negative value!"
#endif
...
#define STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE(type, unsignedtype)                       \
        template <>                                                           \
    ...
    /**/
#define STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsignedtype)                    \
        template <>                                                           \
    ...
    /**/
        ...
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE(char, unsigned char);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE(short, unsigned short);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE(int, unsigned int);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE(long, unsigned long);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsigned char);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsigned short);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsigned int);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsigned long);
#ifdef STREAMS_BOOST_HAS_LONG_LONG
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE(streams_boost::long_long_type, streams_boost::ulong_long_type);
        STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(streams_boost::ulong_long_type);
#endif

#undef STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE
#undef STREAMS_BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED
    ...
    //
    //      Set the value STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL to some integer in 
    //      between 0 (no unrolling) and the largest expected generated integer 
    //      string length (complete unrolling). 
    //      If not specified, this value defaults to 6.
    //
    ///////////////////////////////////////////////////////////////////////////
#define STREAMS_BOOST_KARMA_NUMERICS_INNER_LOOP_PREFIX(z, x, data)                    \
        if (!detail::is_zero(n)) {                                            \
            int ch = radix_type::digit(remainder_type::call(n));              \
            n = divide_type::call(n, num, ++exp);                             \
    /**/

#define STREAMS_BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX(z, x, data)                    \
            *sink = char(ch);                                                 \
            ++sink;                                                           \
        }                                                                     \
    /**/
    ...
    struct int_inserter
    {
        ...
        call(OutputIterator& sink, T n, T& num, int exp)
        {
            ...
            STREAMS_BOOST_PP_REPEAT(
                STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL,
                STREAMS_BOOST_KARMA_NUMERICS_INNER_LOOP_PREFIX, _);
            ...
            STREAMS_BOOST_PP_REPEAT(
                STREAMS_BOOST_KARMA_NUMERICS_LOOP_UNROLL,
                STREAMS_BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX, _);
    ...
    private:
        ...
        // a streams_boost::long_long_type (if this does exist) or in a plain long
        // otherwise
#if defined(STREAMS_BOOST_HAS_LONG_LONG)
        typedef streams_boost::long_long_type biggest_long_type;
#else
...
#undef STREAMS_BOOST_KARMA_NUMERICS_INNER_LOOP_PREFIX
#undef STREAMS_BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX
