...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_INT_FEB_23_2007_0840PM)
#define STREAMS_BOOST_SPIRIT_KARMA_INT_FEB_23_2007_0840PM
...
#include <streams_boost/spirit/home/support/detail/get_encoding.hpp>
...
#include <streams_boost/spirit/home/karma/detail/get_casetag.hpp>
#include <streams_boost/spirit/home/karma/detail/extract_from.hpp>
#include <streams_boost/spirit/home/karma/domain.hpp>
#include <streams_boost/spirit/home/karma/numeric/detail/numeric_utils.hpp>
...
#ifdef STREAMS_BOOST_HAS_LONG_LONG
    template <>
    struct use_terminal<karma::domain, streams_boost::long_long_type> // enables lit(0LL)
      : mpl::true_ {};
#endif
...
namespace streams_boost { namespace spirit { namespace karma
{
    ...
    public:
        ...
        STREAMS_BOOST_SPIRIT_ASSERT_MSG(std::numeric_limits<T>::is_signed,
        ...
        generate(OutputIterator&, Context&, Delimiter const&, unused_type)
        {
            ...
            STREAMS_BOOST_SPIRIT_ASSERT_MSG(false, int_not_usable_without_attribute, ());
            return false;
        }
    ...
    struct make_primitive<tag::long_long, Modifiers> 
      : detail::make_int<streams_boost::long_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_int_direct<streams_boost::long_long_type, Modifiers> {};
#endif
...
#ifdef STREAMS_BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<streams_boost::long_long_type, Modifiers> 
      : detail::basic_int_literal<streams_boost::long_long_type, Modifiers> {};
#endif
