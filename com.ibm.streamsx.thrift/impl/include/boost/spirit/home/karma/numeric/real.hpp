...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_REAL_FEB_26_2007_0512PM)
#define STREAMS_BOOST_SPIRIT_KARMA_REAL_FEB_26_2007_0512PM
...
#include <streams_boost/spirit/home/karma/char.hpp>
...
#include <streams_boost/spirit/home/karma/numeric/real_policies.hpp>
#include <streams_boost/spirit/home/karma/numeric/detail/real_utils.hpp>
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : primitive_generator<any_real_generator<T, Policies, CharEncoding, Tag> >
    {
          ...
          , unused_type) 
        {
            ...
            STREAMS_BOOST_SPIRIT_ASSERT_MSG(false, real_not_usable_without_attribute, ());            return false;
        }
...
#endif // defined(STREAMS_BOOST_SPIRIT_KARMA_REAL_FEB_26_2007_0512PM)
