...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_MAXWIDTH_MAR_18_2009_0827AM)
#define STREAMS_BOOST_SPIRIT_KARMA_MAXWIDTH_MAR_18_2009_0827AM
...
namespace streams_boost { namespace spirit { namespace karma
{
    ...
    //  the STREAMS_BOOST_KARMA_DEFAULT_FIELD_MAXWIDTH constant).
    // 
