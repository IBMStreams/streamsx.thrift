...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_DELIMIT_MAR_02_2007_0217PM)
#define STREAMS_BOOST_SPIRIT_KARMA_DELIMIT_MAR_02_2007_0217PM
...
#include <streams_boost/spirit/home/karma/detail/unused_delimiter.hpp>
...
namespace streams_boost { namespace spirit
{
    ...
    struct use_directive<karma::domain
      ...
      : streams_boost::spirit::traits::matches<karma::domain, T> {};
