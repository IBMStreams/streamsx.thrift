...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_COLUMNS_DEC_03_2009_0736AM)
#define STREAMS_BOOST_SPIRIT_KARMA_COLUMNS_DEC_03_2009_0736AM
...
#include <streams_boost/spirit/home/karma/auxiliary/eol.hpp>
...
namespace streams_boost { namespace spirit
{
    ...
    struct use_directive<karma::domain
      ...
      : streams_boost::spirit::traits::matches<karma::domain, T2> {};
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : unary_generator<columns_generator<Subject, NumColumns, ColumnsDelimiter> >
    {
          ...
          : subject(subject), numcolumns(cols), column_delimiter(cdelimiter) 
        {
            ...
            STREAMS_BOOST_ASSERT(numcolumns > 0);
        }
