...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_EPS_APRIL_21_2007_0246PM)
#define STREAMS_BOOST_SPIRIT_KARMA_EPS_APRIL_21_2007_0246PM
...
{
    using streams_boost::spirit::eps;
    using streams_boost::spirit::eps_type;
