...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_LAZY_MARCH_27_2007_1231PM)
#define STREAMS_BOOST_SPIRIT_KARMA_LAZY_MARCH_27_2007_1231PM
...
namespace streams_boost { namespace spirit { namespace karma
{
    ...
    struct lazy_generator : generator<lazy_generator<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                streams_boost::result_of<karma_modify(tag::lazy_eval, Modifiers)>::type
            modifier;

            typedef typename
                remove_reference<
                    typename streams_boost::result_of<Function(unused_type, Context)>::type
                >::type
            expr_type;
            ...
            // expression.
            STREAMS_BOOST_SPIRIT_ASSERT_MATCH(karma::domain, expr_type);
