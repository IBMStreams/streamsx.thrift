...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_EXTRACT_FROM_SEP_30_2009_0732AM)
#define STREAMS_BOOST_SPIRIT_KARMA_EXTRACT_FROM_SEP_30_2009_0732AM
...
namespace streams_boost { namespace spirit { namespace traits
{
    ...
    struct extract_from_attribute<optional<Attribute> >
    {
        ...
        {
            return streams_boost::get<Attribute>(attr);
        }
    };
    ...
    struct extract_from_attribute<optional<Attribute const> >
    {
        ...
        {
            return streams_boost::get<Attribute const>(attr);
        }
    };

    // This handles attributes wrapped inside a streams_boost::ref(). 
    template <typename Attribute>
