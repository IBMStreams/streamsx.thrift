...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_OUTPUT_ITERATOR_MAY_26_2007_0506PM)
#define STREAMS_BOOST_SPIRIT_KARMA_OUTPUT_ITERATOR_MAY_26_2007_0506PM
...
#include <streams_boost/spirit/home/karma/stream/ostream_iterator.hpp>
...
namespace streams_boost { namespace spirit { namespace karma { namespace detail 
{
    ...
    class counting_sink : streams_boost::noncopyable
    {
    public:
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename OutputIterator>
    class buffer_sink : streams_boost::noncopyable
    {
    public:
        buffer_sink()
          : width(0) {}
        ...
        void output(T const& value)
        {
            STREAMS_BOOST_STATIC_ASSERT(sizeof(T) <= sizeof(wchar_t));
...
#pragma warning(pop)
    ...
    public:
        ...
        output_iterator(output_iterator const& rhs)
          : base_iterator(rhs), streams_boost::noncopyable(), sink(rhs.sink)
        {}
...
#pragma warning (pop)
    ...
    struct enable_buffering
    {
        ...
        {
            if (enabled) {
                STREAMS_BOOST_VERIFY(&buffer_data == sink.chain_buffering(prev_buffer));
                enabled = false;
            }
        }
