...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_PHOENIX_ATTRIBUTES_OCT_01_2009_1128AM)
#define STREAMS_BOOST_SPIRIT_KARMA_PHOENIX_ATTRIBUTES_OCT_01_2009_1128AM

#if defined(_MSC_VER)
#pragma once
#endif

#include <streams_boost/spirit/include/version.hpp>
...
namespace streams_boost { namespace spirit { namespace traits
{
    ...
    struct is_container<phoenix::actor<Eval> const>
      : is_container<typename streams_boost::result_of<phoenix::actor<Eval>()>::type>
    {};
    ...
    {
        typedef typename streams_boost::result_of<phoenix::actor<Eval>()>::type type;
        static type call(phoenix::actor<Eval> const& f)
        {
            return f();
        }
