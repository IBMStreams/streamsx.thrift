...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_CHAR_CLASS_AUG_10_2009_0720AM)
#define STREAMS_BOOST_SPIRIT_KARMA_CHAR_CLASS_AUG_10_2009_0720AM
...
#include <streams_boost/spirit/home/karma/char/char_generator.hpp>
...
namespace streams_boost { namespace spirit { namespace karma
{
    ...
    // the same name
    namespace ascii { using namespace streams_boost::spirit::ascii; }
    namespace iso8859_1 { using namespace streams_boost::spirit::iso8859_1; }
    namespace standard { using namespace streams_boost::spirit::standard; }
    namespace standard_wide { using namespace streams_boost::spirit::standard_wide; }
    ...
    using namespace streams_boost::spirit::standard;
...
}}}  // namespace streams_boost::spirit::karma

#endif // !defined(STREAMS_BOOST_SPIRIT_KARMA_CHAR_FEB_21_2007_0543PM)
