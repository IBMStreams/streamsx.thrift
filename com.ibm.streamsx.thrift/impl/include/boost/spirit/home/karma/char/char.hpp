...
#if !defined(STREAMS_BOOST_SPIRIT_KARMA_CHAR_FEB_21_2007_0543PM)
#define STREAMS_BOOST_SPIRIT_KARMA_CHAR_FEB_21_2007_0543PM
...
#include <streams_boost/spirit/home/support/char_set/basic_chset.hpp>
...
namespace streams_boost { namespace spirit { namespace karma
{
      ...
      : char_generator<any_char<CharEncoding, Tag>, CharEncoding, Tag>
    {
        ...
        bool test(unused_type, CharParam&, Context&) const
        {
            ...
            STREAMS_BOOST_SPIRIT_ASSERT_MSG(false, char_not_usable_without_attribute, ());
            return false;
        }
      ...
      : char_generator<char_range<CharEncoding, Tag>, CharEncoding, Tag>
    {
        ...
        info what(Context& /*context*/) const
        {
            ...
            streams_boost::get<std::string>(result.value) += '-';
            streams_boost::get<std::string>(result.value) += to_utf8(char_encoding::toucs4(to));
            return result;
        }
