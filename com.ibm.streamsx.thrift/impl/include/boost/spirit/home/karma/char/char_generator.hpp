...
#if !defined(STREAMS_BOOST_SPIRIT_CHAR_GENERATOR_SEP_07_2009_0417PM)
#define STREAMS_BOOST_SPIRIT_CHAR_GENERATOR_SEP_07_2009_0417PM
...
namespace streams_boost { namespace spirit { namespace traits // classification
{
    namespace detail
    {
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(char_generator_id)
    }
