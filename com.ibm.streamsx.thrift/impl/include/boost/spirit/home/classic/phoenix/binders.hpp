...
///////////////////////////////////////////////////////////////////////////////
#include <streams_boost/spirit/home/classic/phoenix/functions.hpp>
...
struct member_var_ptr_action {
    ...
    struct result {
        typedef typename streams_boost::mpl::if_<streams_boost::is_const<CT>, T const&, T&
            >::type type;
    };
...
> {
    ...
    typedef typename streams_boost::mpl::if_<streams_boost::is_const<ClassT>, cmf, mf>::type
        mem_func_ptr_t;
