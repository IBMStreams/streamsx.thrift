...
#include <streams_boost/spirit/home/classic/phoenix/composite.hpp>
...
#endif // !defined(STREAMS_BOOST_NO_INTRINSIC_WCHAR_T)
...
template <> struct rank< ::streams_boost::long_long_type>          { static int const value = 110; };
template <> struct rank< ::streams_boost::ulong_long_type> { static int const value = 120; };
#endif
