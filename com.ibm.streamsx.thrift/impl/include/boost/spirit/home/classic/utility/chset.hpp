...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_CHSET_HPP
#define STREAMS_BOOST_SPIRIT_CHSET_HPP
...
#include <streams_boost/spirit/home/classic/utility/impl/chset/basic_chset.hpp>
...
namespace utility { namespace impl {
    ...
    void construct_chset(streams_boost::shared_ptr<basic_chset<CharT> >& ptr,
...
private:
    ...
    streams_boost::shared_ptr<basic_chset<CharT> > ptr;
};
...
//////////////////////////////////
inline chset< ::streams_boost::long_long_type>
chset_p( ::streams_boost::long_long_type ch)
{ return chset< ::streams_boost::long_long_type>(ch); }

//////////////////////////////////
inline chset< ::streams_boost::ulong_long_type>
chset_p( ::streams_boost::ulong_long_type ch)
{ return chset< ::streams_boost::ulong_long_type>(ch); }
#endif
...
#include <streams_boost/spirit/home/classic/utility/impl/chset.ipp>
#include <streams_boost/spirit/home/classic/utility/chset_operators.hpp>
