...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_REGEX_IPP
#define STREAMS_BOOST_SPIRIT_REGEX_IPP

///////////////////////////////////////////////////////////////////////////////
#include <streams_boost/spirit/home/classic/core/primitives/impl/primitives.ipp>
...
public:
    ...
    {
        streams_boost::match_results<typename ScannerT::iterator_t> what;
        streams_boost::regex_search(scan.first, scan.last, what, rxstr,
            streams_boost::match_default);
...
private:
#if STREAMS_BOOST_VERSION >= 013300
    streams_boost::basic_regex<CharT> rxstr;       // regular expression to match
#else
    streams_boost::reg_expression<CharT> rxstr;    // regular expression to match
#endif
};
...
#endif // STREAMS_BOOST_SPIRIT_REGEX_IPP
