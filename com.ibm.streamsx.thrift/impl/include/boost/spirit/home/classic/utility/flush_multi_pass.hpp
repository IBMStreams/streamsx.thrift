...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_FLUSH_MULTI_PASS_HPP
#define STREAMS_BOOST_SPIRIT_FLUSH_MULTI_PASS_HPP

///////////////////////////////////////////////////////////////////////////////
#include <streams_boost/spirit/home/classic/namespace.hpp>
#include <streams_boost/spirit/home/classic/core.hpp>
#include <streams_boost/spirit/home/classic/iterator/multi_pass.hpp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    namespace impl {
        ...
        void flush_iterator(STREAMS_BOOST_SPIRIT_CLASSIC_NS::multi_pass<
            T1, T2, T3, T4, STREAMS_BOOST_SPIRIT_CLASSIC_NS::multi_pass_policies::std_deque> &i)
        {
            i.clear_queue();
        }
...
#endif // STREAMS_BOOST_SPIRIT_FLUSH_MULTI_PASS_HPP
