...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_LISTS_HPP
#define STREAMS_BOOST_SPIRIT_LISTS_HPP
...
#include <streams_boost/spirit/home/classic/utility/impl/lists.ipp>
...
// (the operator()(...) functions)
    ...
    operator()(ItemT const &item_, DelimT const &delim_) const
    {
        ...
        typedef list_parser<item_t, delim_t, no_list_endtoken,
                STREAMS_BOOST_DEDUCED_TYPENAME item_t::parser_category_t>
            return_t;
