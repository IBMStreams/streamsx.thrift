...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_ESCAPE_CHAR_HPP
#define STREAMS_BOOST_SPIRIT_ESCAPE_CHAR_HPP
...
#include <streams_boost/spirit/home/classic/utility/impl/escape_char.ipp>
...
struct escape_char_parser :
    ...
    STREAMS_BOOST_STATIC_ASSERT(Flags == c_escapes || Flags == lex_escapes);
