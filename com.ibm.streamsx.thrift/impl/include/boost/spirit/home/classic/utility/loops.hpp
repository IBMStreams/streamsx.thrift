...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_LOOPS_HPP)
#define STREAMS_BOOST_SPIRIT_LOOPS_HPP
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    public:
        ...
        parse(ScannerT const & scan) const
        {
            STREAMS_BOOST_SPIRIT_ASSERT(m_min <= m_max);
            typedef typename parser_result<self_t, ScannerT>::type result_t;
            result_t hit = scan.empty_match();
    ...
    namespace impl {
        ...
        struct loop_traits
        {
            typedef typename mpl::if_<
                streams_boost::is_same<MaxT, more_t>,
...
#endif // #if !defined(STREAMS_BOOST_SPIRIT_LOOPS_HPP)
