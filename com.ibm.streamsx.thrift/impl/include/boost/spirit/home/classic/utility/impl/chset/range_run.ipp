...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_RANGE_RUN_IPP
#define STREAMS_BOOST_SPIRIT_RANGE_RUN_IPP

///////////////////////////////////////////////////////////////////////////////
#include <algorithm> // for std::lower_bound
#include <streams_boost/spirit/home/classic/core/assert.hpp> // for STREAMS_BOOST_SPIRIT_ASSERT
#include <streams_boost/spirit/home/classic/utility/impl/chset/range_run.hpp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    namespace utility { namespace impl {
        ...
        {
            STREAMS_BOOST_SPIRIT_ASSERT(r.is_valid());
            if (!run.empty())
            {
                iterator iter =
                    std::lower_bound(
