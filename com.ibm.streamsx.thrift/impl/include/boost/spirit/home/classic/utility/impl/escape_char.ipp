...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_ESCAPE_CHAR_IPP
#define STREAMS_BOOST_SPIRIT_ESCAPE_CHAR_IPP
...
#pragma warning(pop)
    ...
    struct escape_char_parse {
        ...
        parse(ScannerT const &scan, ParserT const &/*p*/)
        {
            ...
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_NODE(p,
                (STREAMS_BOOST_SPIRIT_DEBUG_FLAGS & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_ESCAPE_CHAR) != 0);
