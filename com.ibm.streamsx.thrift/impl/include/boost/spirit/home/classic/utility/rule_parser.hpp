...
//
//   http://www.streams_boost.org/libs/spirit/doc/techniques.html#no_rules
//   http://www.streams_boost.org/libs/spirit/doc/techniques.html#typeof
//
...
// the the user must define the macro STREAMS_BOOST_SPIRIT__NAMESPACE (note the double
...
//   // [...]
// 
//   #define STREAMS_BOOST_SPIRIT__NAMESPACE (2,(my_project, my_module))
//   //                             | |     +- outer     +- inner
...
//   // [...]
// 
//   #define STREAMS_BOOST_SPIRIT__NAMESPACE (2,(my_project, (anonymous) ))
// 
...
// 
//   
//   #define STREAMS_BOOST_SPIRIT__NAMESPACE -
...
//   STREAMS_BOOST_SPIRIT_RULE_PARSER(skipper, 
//     -,-,-, 
// 
...
// 
// Parameters are passed to the STREAMS_BOOST_SPIRIT_RULE_PARSER macro as its second
...
// 
//   STREAMS_BOOST_SPIRIT_RULE_PARSER(new_name,
//     (1,( symbol_table )),-,-,
// 
...
// 
//   STREAMS_BOOST_SPIRIT_RULE_PARSER(enumeration_parser,
...
// 
//   STREAMS_BOOST_SPIRIT_ACTION_PLACEHOLDER(int_action)
// 
//   STREAMS_BOOST_SPIRIT_RULE_PARSER(int_list,
//     -,(1,( int_action )),-,
// 
...
// 
//   STREAMS_BOOST_SPIRIT_ACTION_PLACEHOLDER(feed_int)
//   STREAMS_BOOST_SPIRIT_ACTION_PLACEHOLDER(next_int)
// 
//   STREAMS_BOOST_SPIRIT_RULE_PARSER(int_list,
//     -,(2,( feed_int, next_int )),-,
// 
...
// 
//   STREAMS_BOOST_SPIRIT_RULE_PARSER( calc,
//     -,
//     -,
...
// explicitly by using STREAMS_BOOST_SPIRIT_OPAQUE_RULE_PARSER. 
...
// strictly typed, e.g:
//
//   STREAMS_BOOST_SPIRIT_OPAQUE_RULE_PARSER(new_identifier,
...
//
// --- --- - - --- - - --- - - - - --- - - - - - - - - - - - - - - - - - - - - -
#if !defined(STREAMS_BOOST_SPIRIT_UTILITY_RULE_PARSER_HPP_INCLUDED)
#   define STREAMS_BOOST_SPIRIT_UTILITY_RULE_PARSER_HPP_INCLUDED
//==============================================================================
// Dependencies
//==============================================================================
...
#   include <streams_boost/preprocessor/tuple/to_seq.hpp>
...
#   include <streams_boost/preprocessor/logical/nor.hpp>
...
#   define STREAMS_BOOST_SPIRIT_RULE_PARSER(name,params,actions,members,rule)          \
      STREAMS_BOOST_SPIRIT_RP_IMPL_I(name,params,actions,members,rule)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// Creates a non-templated rule parser. Use at namespace scope.
#   define STREAMS_BOOST_SPIRIT_OPAQUE_RULE_PARSER(name,params,members,rule)           \
      STREAMS_BOOST_SPIRIT_RP_OPAQUE_IMPL_I(name,params,members,rule)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// Defines an action placeholder. Use at namespace scope.
#   define STREAMS_BOOST_SPIRIT_ACTION_PLACEHOLDER(name)                               \
      STREAMS_BOOST_SPIRIT_RP_AP_IMPL(name,::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
//
// Boost.Typeof registration from within STREAMS_BOOST_SPIRIT__NAMESPACE 
#   define STREAMS_BOOST_SPIRIT_RP_REGISTER_TEMPLATE(name,params)                      \
      STREAMS_BOOST_SPIRIT_RP_EMIT(NS_CLOSE,STREAMS_BOOST_SPIRIT__NAMESPACE,-)                 \
    STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(                                            \
        STREAMS_BOOST_SPIRIT_RP_EMIT(NS_QUALIFY,STREAMS_BOOST_SPIRIT__NAMESPACE,-) name,       \
        params)                                                                \
      STREAMS_BOOST_SPIRIT_RP_EMIT(NS_OPEN,STREAMS_BOOST_SPIRIT__NAMESPACE,-)     
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_REGISTER_TYPE
//
// Boost.Typeof registration from within STREAMS_BOOST_SPIRIT__NAMESPACE 
#   define STREAMS_BOOST_SPIRIT_RP_REGISTER_TYPE(name)                                 \
      STREAMS_BOOST_SPIRIT_RP_EMIT(NS_CLOSE,STREAMS_BOOST_SPIRIT__NAMESPACE,-)                 \
    STREAMS_BOOST_TYPEOF_REGISTER_TYPE(                                                \
        STREAMS_BOOST_SPIRIT_RP_EMIT(NS_QUALIFY,STREAMS_BOOST_SPIRIT__NAMESPACE,-) name )      \
      STREAMS_BOOST_SPIRIT_RP_EMIT(NS_OPEN,STREAMS_BOOST_SPIRIT__NAMESPACE,-)     
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_AP_IMPL
...
#   define STREAMS_BOOST_SPIRIT_RP_AP_IMPL(name,ns)                                    \
...
#   define STREAMS_BOOST_SPIRIT_RP_IMPL_I(name,pars,acts,mbrs,expr)                    \
      STREAMS_BOOST_SPIRIT_RP_IMPL_II(name, name ## _t ,                               \
                              pars, STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE(pars),          \
                              acts, STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE(acts),          \
                              mbrs, STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE(mbrs), expr)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_IMPL_II
#   define STREAMS_BOOST_SPIRIT_RP_IMPL_II(name,name_t,pars,np,acts,na,mbrs,nm,x)      \
      STREAMS_BOOST_PP_IIF(STREAMS_BOOST_PP_OR(np,na),STREAMS_BOOST_SPIRIT_RP_IMPL_III,                \
                                      STREAMS_BOOST_SPIRIT_RP_OPAQUE_IMPL_II)          \
                                         (name,name_t,pars,np,acts,na,mbrs,nm,x)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_IMPL_III
//
// The rule parser definition
#   define STREAMS_BOOST_SPIRIT_RP_IMPL_III(name,name_t,pars,np,acts,na,mbrs,nm,x)     \
                                                                               \
      template< STREAMS_BOOST_SPIRIT_RP_TPL_PARAMS(pars,acts,typename __,1) >          \
      class name_t                                                             \
        : public ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::parser< name_t                               \
                       < STREAMS_BOOST_SPIRIT_RP_TPL_PARAMS(pars,acts,__,0) > >        \
      {                                                                        \
        class __rule                                                           \
        {                                                                      \
          STREAMS_BOOST_SPIRIT_RP_EMIT(PM_STATIC,pars,__T)                             \
          STREAMS_BOOST_SPIRIT_RP_EMIT(AP_STATIC,acts,-)                               \
          STREAMS_BOOST_SPIRIT_RP_EMIT(MV_STATIC,mbrs,STREAMS_BOOST_PP_IDENTITY(typename))     \
        public:                                                                \
          STREAMS_BOOST_TYPEOF_NESTED_TYPEDEF_TPL(__expr,                              \
            ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::depend_on_type<__Dummy>(x) )   \  
        };                                                                     \
                                                                               \
      public:                                                                  \
                                                                               \
        ...
        typedef typename __rule::__expr::type::parser_category_t               \
                                                           parser_category_t;  \
                                                                               \
        STREAMS_BOOST_PP_EXPR_IIF(STREAMS_BOOST_PP_NOR(np,na),typedef self_t const & embed_t;) \
                                                                               \
      protected:                                                               \
                                                                               \
        STREAMS_BOOST_SPIRIT_RP_EMIT(MV_NONSTATIC,mbrs,STREAMS_BOOST_PP_IDENTITY(typename))    \
        STREAMS_BOOST_SPIRIT_RP_IF(na,SPIRIT_RP_AP_EXTRA_MBRS,2)(np,na)                \
                                                                               \
        typename __rule::__expr::type::embed_t __parser;                       \
                                                                               \
      public:                                                                  \
                                                                               \
        explicit name_t ( STREAMS_BOOST_SPIRIT_RP_CTOR(PARAMS,pars,np,acts) )          \
          : STREAMS_BOOST_SPIRIT_RP_EMIT(MV_CTOR_INIT_LIST,mbrs,-)                     \
          STREAMS_BOOST_PP_COMMA_IF(nm)                                                \
          STREAMS_BOOST_SPIRIT_RP_IF(na,SPIRIT_RP_CTOR_COMMA,4)(INIT_LIST,pars,np,acts)\
            __parser(x)                                                        \
        { }                                                                    \
                                                                               \
        name_t( name_t const & that)                                           \
          : STREAMS_BOOST_SPIRIT_RP_EMIT(MV_CTOR_COPY_INIT_LIST,mbrs,that)             \
          STREAMS_BOOST_PP_COMMA_IF(nm)                                                \
          STREAMS_BOOST_SPIRIT_RP_IF(na,SPIRIT_RP_CTOR_COMMA,4)                        \
        ...
        {                                                                      \
          typedef typename ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::parser_result<                     \
                           typename __rule::__expr::type, Scanner>::type type; \
        };                                                                     \
                                                                               \
        template<typename Scanner>                                             \
        typename ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::parser_result<self_t, Scanner>::type         \
        parse(Scanner const & s) const { return __parser.parse(s); }           \
                                                                               \
        STREAMS_BOOST_SPIRIT_RP_IF(na,SPIRIT_RP_AP_HANDLER,5)                          \
                                  (name_t,np,acts,na,::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of) \
      };                                                                       \
                                                                               \
      STREAMS_BOOST_PP_IF(np,STREAMS_BOOST_SPIRIT_RP_GEN_FUNC,STREAMS_BOOST_SPIRIT_RP_GLOB_VAR)        \
                                                           (name,name_t,np,na) \
      STREAMS_BOOST_SPIRIT_RP_REGISTER_TEMPLATE                                        \
        (name_t,STREAMS_BOOST_PP_INC(STREAMS_BOOST_PP_ADD(np,na))) 
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_OPAQUE_IMPL_I
//
#   define STREAMS_BOOST_SPIRIT_RP_OPAQUE_IMPL_I(name,pars,mbrs,expr)                  \
      STREAMS_BOOST_SPIRIT_RP_OPAQUE_IMPL_II(name, name ## _t,                         \
                                     pars,STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE(pars),-,-,\
                                     mbrs,STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE(mbrs),expr)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_OPAQUE_IMPL_II
//
#   define STREAMS_BOOST_SPIRIT_RP_OPAQUE_IMPL_II(name,name_t,pars,np,_1,_2,mbrs,nm,x) \
      class name_t;                                                            \
                                                                               \
      STREAMS_BOOST_SPIRIT_RP_REGISTER_TYPE(name_t)                                    \
                                                                               \
      class name_t                                                             \
        : public ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::parser< name_t >                             \
      {                                                                        \
        class __rule                                                           \
        {                                                                      \
          STREAMS_BOOST_SPIRIT_RP_EMIT(PM_OPAQUE_STATIC,pars,-)                        \
          STREAMS_BOOST_SPIRIT_RP_EMIT(MV_STATIC,mbrs,STREAMS_BOOST_PP_EMPTY)                  \
        public:                                                                \
          STREAMS_BOOST_TYPEOF_NESTED_TYPEDEF(__expr,x)                                \
        };                                                                     \
                                                                               \
      public:                                                                  \
                                                                               \
        ...
        STREAMS_BOOST_PP_EXPR_IIF(STREAMS_BOOST_PP_NOT(np),typedef self_t const & embed_t;)    \
                                                                               \
      protected:                                                               \
                                                                               \
        STREAMS_BOOST_SPIRIT_RP_EMIT(MV_NONSTATIC,mbrs,STREAMS_BOOST_PP_EMPTY)                 \
                                                                               \
        __rule::__expr::type::embed_t __parser;                                \
                                                                               \
      public:                                                                  \
                                                                               \
        explicit name_t (STREAMS_BOOST_SPIRIT_RP_EMIT(PM_OPAQUE_CTOR_PARAMS,pars,-))   \
          : STREAMS_BOOST_SPIRIT_RP_EMIT(MV_CTOR_INIT_LIST,mbrs,-)                     \
            STREAMS_BOOST_PP_COMMA_IF(nm) __parser(x)                                  \
        { }                                                                    \
                                                                               \
        name_t(name_t const & that)                                            \
          : STREAMS_BOOST_SPIRIT_RP_EMIT(MV_CTOR_COPY_INIT_LIST,mbrs,that)             \
            STREAMS_BOOST_PP_COMMA_IF(nm) __parser(that.__parser)                      \
        { }                                                                    \
                                                                               \
        template<typename Scanner> struct result                               \
        {                                                                      \
        ...
        parse(Scanner const & s) const { return __parser.parse(s); }           \
                                                                               ...
                                                                               \
      STREAMS_BOOST_PP_IF(np,STREAMS_BOOST_SPIRIT_RP_GEN_OPAQUE,STREAMS_BOOST_SPIRIT_RP_GLOB_OPAQUE)   \
                                                         (name,name_t,np,pars)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_AP_HANDLER 
//
// Part of the rule parser definition for handling action placeholders
#   define STREAMS_BOOST_SPIRIT_RP_AP_HANDLER(name_t,np,acts,na,ns)                    \
      private:                                                                 \
        template<typename A> struct __rebound_1st                              \
        {                                                                      \
          typedef name_t < void STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(np,__T) ,        \
            typename ns ::action_concatenator<__A0,A>::type                    \
            STREAMS_BOOST_PP_COMMA_IF(STREAMS_BOOST_PP_DEC(na))                                \
            STREAMS_BOOST_PP_ENUM_SHIFTED_PARAMS(na,__A)                               \
          > type;                                                              \
        };                                                                     \
                                                                               \
        ...
        {                                                                      \
          typedef name_t <                                                     \
            void STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(np,__T)                         \
            STREAMS_BOOST_SPIRIT_RP_EMIT(AP_REBOUND_TPL_ARGS,acts,X)                   \
          > type;                                                              \
        };                                                                     \
      public:                                                                  \
        template<typename A>                                                   \
        ...
        {                                                                      \
          return typename __rebound_1st<A>::type (                             \
            STREAMS_BOOST_PP_ENUM_PARAMS(np,__p) STREAMS_BOOST_PP_COMMA_IF(np)                 \
        ...
        {                                                                      \
          return typename __rebound< ns ::action_chain<PH,M,A> >::type (       \
            STREAMS_BOOST_PP_ENUM_PARAMS(np,__p) STREAMS_BOOST_PP_COMMA_IF(np)                 \
            STREAMS_BOOST_SPIRIT_RP_EMIT(AP_REBOUND_ARGS,acts,x) );                    \
        }                                                                      \
...
#   define STREAMS_BOOST_SPIRIT_RP_AP_EXTRA_MBRS(np,na)                                \
      private:                                                                 \
        STREAMS_BOOST_PP_REPEAT(np,STREAMS_BOOST_SPIRIT_RP_PM_MBRS,-)                          \
        STREAMS_BOOST_PP_REPEAT(na,STREAMS_BOOST_SPIRIT_RP_AP_MBRS,-) 
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_PM_MBRS
//
// Member variables to remember parameters if there are action placeholder
#   define STREAMS_BOOST_SPIRIT_RP_PM_MBRS(z,i,d) __T ## i __p ## i ;
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_AP_MBRS
//
// Member variables to remember action placeholder substitutes
#   define STREAMS_BOOST_SPIRIT_RP_AP_MBRS(z,i,d) __A ## i __a ## i ;
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_CTOR
//
// Expands to a fragment of a constructor (parameters or init-list)
#   define STREAMS_BOOST_SPIRIT_RP_CTOR(what,pars,np,acts)                             \
      STREAMS_BOOST_SPIRIT_RP_EMIT(PM_CTOR_ ## what,pars,__T)                          \
      STREAMS_BOOST_SPIRIT_RP_EMIT(AP_CTOR_ ## what,acts,np)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_CTOR_COMMA
//
// RP_CTOR with a trailing comma
#   define STREAMS_BOOST_SPIRIT_RP_CTOR_COMMA(what,pars,np,acts)                       \
      STREAMS_BOOST_SPIRIT_RP_CTOR(what,pars,np,acts) ,
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_TPL_PARAMS
//
// Expands to the template parameters or arguments of the rule parser template 
#   define STREAMS_BOOST_SPIRIT_RP_TPL_PARAMS(pars,acts,prefix,defaults)               \
      prefix ## Dummy                                                          \
      STREAMS_BOOST_SPIRIT_RP_EMIT(PM_TEMPLATE_PARAMS,pars,prefix ## T)                \
      STREAMS_BOOST_SPIRIT_RP_EMIT(AP_TEMPLATE_PARAMS,acts,(prefix ## A,defaults))
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_GEN_FUNC
//
// Generator function
#   define STREAMS_BOOST_SPIRIT_RP_GEN_FUNC(name,name_t,np,na)                         \
      template< STREAMS_BOOST_PP_ENUM_PARAMS(np,typename T) >                          \
      inline name_t < void STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(np,T) >               \
      name( STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(np,T, const & p) )                     \
      { return name_t < void STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(np,T) >             \
                 (STREAMS_BOOST_PP_ENUM_PARAMS(np,p) STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(na, \
                ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::nop_functor() STREAMS_BOOST_PP_INTERCEPT) ); \
      }
// RP_GEN_OPAQUE
//
// non-templated version for opaque rule parsers.
#   define STREAMS_BOOST_SPIRIT_RP_GEN_OPAQUE(name,name_t,np,pars)                     \
      inline name_t name( STREAMS_BOOST_SPIRIT_RP_EMIT(PM_OPAQUE_GEN_PARAMS,pars,p))   \
      { return name_t (STREAMS_BOOST_PP_ENUM_PARAMS(np,p)); }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_GLOB_VAR
//
// Global variable -- used instead of the generator function if there are no
// parameters
#   define STREAMS_BOOST_SPIRIT_RP_GLOB_VAR(name,name_t,np,na)                         \
      static name_t <void> const name = name_t <void>(STREAMS_BOOST_PP_ENUM_PARAMS(na, \
                ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::nop_functor() STREAMS_BOOST_PP_INTERCEPT) );

// RP_GLOB_OPAQUE
//
// non-templated version for opaque rule parsers.
#   define STREAMS_BOOST_SPIRIT_RP_GLOB_OPAQUE(name,name_t,np,pars)                    \
...
// NS_OPEN
#   define STREAMS_BOOST_SPIRIT_RP__NS_OPEN(r,data,i,elem)                             \
      namespace STREAMS_BOOST_SPIRIT_RP_OPTIONAL(elem) {

// NS_QUALIFY
#   define STREAMS_BOOST_SPIRIT_RP__NS_QUALIFY(r,data,i,elem)                          \
      STREAMS_BOOST_SPIRIT_RP_OPTIONAL(elem ::)

// NS_CLOSE
#   define STREAMS_BOOST_SPIRIT_RP__NS_CLOSE(r,data,i,elem) }

// - - Parameter handling

// PM_STATIC
#   define STREAMS_BOOST_SPIRIT_RP__PM_STATIC(r,data,i,elem)                           \
      static typename ::streams_boost::call_traits< data ## i >::reference elem ;

// PM_CTOR_PARAMS
#   define STREAMS_BOOST_SPIRIT_RP__PM_CTOR_PARAMS(r,data,i,elem)                      \
      STREAMS_BOOST_PP_COMMA_IF(i)                                                     \
      typename ::streams_boost::call_traits< data ## i >::param_type elem 

// PM_CTOR_ARGS
#   define STREAMS_BOOST_SPIRIT_RP__PM_CTOR_ARGS(r,data,i,elem)                        \
      STREAMS_BOOST_PP_COMMA_IF(i) elem

// PM_CTOR_INIT_LIST
#   define STREAMS_BOOST_SPIRIT_RP__PM_CTOR_INIT_LIST(r,data,i,elem)                   \
      STREAMS_BOOST_PP_COMMA_IF(i) __p ## i ( elem )

// PM_CTOR_COPY_INIT_LIST
#   define STREAMS_BOOST_SPIRIT_RP__PM_CTOR_COPY_INIT_LIST(r,data,i,elem)              \
      STREAMS_BOOST_PP_COMMA_IF(i) __p ## i ( that. __p ## i )


// PM_TEMPLATE_PARAMS
#   define STREAMS_BOOST_SPIRIT_RP__PM_TEMPLATE_PARAMS(r,data,i,elem) , data ## i

// - strictly typed parameters of the opaque rule_parser

// PM_OPAQUE_STATIC
#   define STREAMS_BOOST_SPIRIT_RP__PM_OPAQUE_STATIC(r,data,i,elem)                    \
      static ::streams_boost::call_traits<                                             \
          STREAMS_BOOST_SPIRIT_RP_TYPE(STREAMS_BOOST_PP_TUPLE_ELEM(2,0,elem))                  \
        >::reference STREAMS_BOOST_PP_TUPLE_ELEM(2,1,elem) ;

// PM_OPAQUE_CTOR_PARAMS
#   define STREAMS_BOOST_SPIRIT_RP__PM_OPAQUE_CTOR_PARAMS(r,data,i,elem)               \
      STREAMS_BOOST_PP_COMMA_IF(i) ::streams_boost::call_traits<                               \
          STREAMS_BOOST_SPIRIT_RP_TYPE(STREAMS_BOOST_PP_TUPLE_ELEM(2,0,elem))                  \
        >::param_type STREAMS_BOOST_PP_TUPLE_ELEM(2,1,elem)

// PM_OPAQUE_GEN_PARAMS
#   define STREAMS_BOOST_SPIRIT_RP__PM_OPAQUE_GEN_PARAMS(r,data,i,elem)                \
      STREAMS_BOOST_PP_COMMA_IF(i) ::streams_boost::call_traits<                               \
          STREAMS_BOOST_SPIRIT_RP_TYPE(STREAMS_BOOST_PP_TUPLE_ELEM(2,0,elem))                  \
        >::param_type data ## i
...
// MV_NONSTATIC
#   define STREAMS_BOOST_SPIRIT_RP__MV_NONSTATIC(r,data,i,elem)                        \
      data() STREAMS_BOOST_SPIRIT_RP_TYPE(STREAMS_BOOST_PP_TUPLE_ELEM(3,0,elem))               \
        STREAMS_BOOST_PP_TUPLE_ELEM(3,1,elem) ;

// MV_STATIC
#   define STREAMS_BOOST_SPIRIT_RP__MV_STATIC(r,data,i,elem)                           \
      static data() ::streams_boost::call_traits<                                      \
            data() STREAMS_BOOST_SPIRIT_RP_TYPE(STREAMS_BOOST_PP_TUPLE_ELEM(3,0,elem))         \
        >::reference STREAMS_BOOST_PP_TUPLE_ELEM(3,1,elem) ;

// MV_CTOR_INIT_LIST
#   define STREAMS_BOOST_SPIRIT_RP__MV_CTOR_INIT_LIST(r,data,i,elem)                   \
      STREAMS_BOOST_PP_COMMA_IF(i)                                                     \
      STREAMS_BOOST_PP_TUPLE_ELEM(3,1,elem) STREAMS_BOOST_PP_TUPLE_ELEM(3,2,elem)

// MV_CTOR_COPY_INIT_LIST
#   define STREAMS_BOOST_SPIRIT_RP__MV_CTOR_COPY_INIT_LIST(r,data,i,elem)              \
      STREAMS_BOOST_PP_COMMA_IF(i)                                                     \
      STREAMS_BOOST_PP_TUPLE_ELEM(3,1,elem) (data . STREAMS_BOOST_PP_TUPLE_ELEM(3,1,elem))

// - - Action placeholder handling

// AP_STATIC
#   define STREAMS_BOOST_SPIRIT_RP__AP_STATIC(r,data,i,elem) static __A ## i & elem ;

// AP_CTOR_PARAMS
#   define STREAMS_BOOST_SPIRIT_RP__AP_CTOR_PARAMS(r,data,i,elem)                      \
      STREAMS_BOOST_SPIRIT_RP_COMMA_IF_OR(data,i)                                      \
      typename ::streams_boost::call_traits< __A ## i >::param_type elem

// AP_CTOR_ARGS
#   define STREAMS_BOOST_SPIRIT_RP__AP_CTOR_ARGS(r,data,i,elem)                        \
      STREAMS_BOOST_SPIRIT_RP_COMMA_IF_OR(data,i) elem

// AP_CTOR_INIT_LIST
#   define STREAMS_BOOST_SPIRIT_RP__AP_CTOR_INIT_LIST(r,data,i,elem)                   \
      STREAMS_BOOST_SPIRIT_RP_COMMA_IF_OR(data,i) __a ## i ( elem )

// AP_CTOR_COPY_INIT_LIST
#   define STREAMS_BOOST_SPIRIT_RP__AP_CTOR_COPY_INIT_LIST(r,data,i,elem)              \
      STREAMS_BOOST_SPIRIT_RP_COMMA_IF_OR(data,i) __a ## i ( that. __a ## i )

// AP_TEMPLATE_PARAMS
#   define STREAMS_BOOST_SPIRIT_RP__AP_TEMPLATE_PARAMS(r,data,i,elem)                  \
      , STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_TUPLE_ELEM(2,0,data),i)                          \
      STREAMS_BOOST_PP_EXPR_IIF(STREAMS_BOOST_PP_TUPLE_ELEM(2,1,data),                         \
          = ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::nop_functor)

// AP_REBOUND_ARGS
#   define STREAMS_BOOST_SPIRIT_RP__AP_REBOUND_ARGS(r,data,i,elem)                     \
      STREAMS_BOOST_PP_COMMA_IF(i)                                                     \
      ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::get_placeholdee< __action_placeholder:: elem > \
                                                           ( __a ## i , data )

// AP_REBOUND_TPL_ARGS
#   define STREAMS_BOOST_SPIRIT_RP__AP_REBOUND_TPL_ARGS(r,data,i,elem)                 \
      , typename ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::placeholdee<                        \
...
//
#   define STREAMS_BOOST_SPIRIT_RP_EMIT(op, array, data)                               \
      STREAMS_BOOST_SPIRIT_RP_ARRAY_FOR_EACH_I(STREAMS_BOOST_SPIRIT_RP__ ## op,data,array)
// --- --- - - --- - - --- - - - - --- - - - - - - - - - - - - - - - - - - - - -
// RP_ARRAY_FOR_EACH_I 
//
// Iterates an optional array. That is you can pass e.g.'-' or 'none' to denote
// emptiness.
#   define STREAMS_BOOST_SPIRIT_RP_ARRAY_FOR_EACH_I(macro,data,optional_array)         \
      STREAMS_BOOST_PP_IIF(STREAMS_BOOST_PP_IS_BINARY(optional_array),                         \
                   STREAMS_BOOST_SPIRIT_RP_ARRAY_FOR_EACH_I_IMPL,                      \
                   STREAMS_BOOST_PP_TUPLE_EAT(3))(macro,data,optional_array)

// RP_ARRAY_FOR_EACH_I_IMPL 
#   define STREAMS_BOOST_SPIRIT_RP_ARRAY_FOR_EACH_I_IMPL(macro,data,array)             \
      STREAMS_BOOST_SPIRIT_RP_IF(STREAMS_BOOST_PP_ARRAY_SIZE(array),PP_SEQ_FOR_EACH_I,3)       \
        (macro,data, STREAMS_BOOST_SPIRIT_RP_IF(STREAMS_BOOST_PP_ARRAY_SIZE(array),            \
...
// Examples:
//
//   STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE( (2,(a,b)) ) // 2
//   STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE( (0,()) )    // 0
//   STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE( none )      // 0
//   STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE( - )         // 0
//
#   define STREAMS_BOOST_SPIRIT_RP_ARRAY_SIZE(optional_array)                          \
      STREAMS_BOOST_PP_IIF(STREAMS_BOOST_PP_IS_BINARY(optional_array),                         \
                   STREAMS_BOOST_PP_ARRAY_SIZE, 0 STREAMS_BOOST_PP_TUPLE_EAT(1))(optional_array)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_OPTIONAL
// 
...
// Examples:
//
//   STREAMS_BOOST_SPIRIT_RP_OPTIONAL( foobar ) // foobar
//   STREAMS_BOOST_SPIRIT_RP_OPTIONAL( (none) ) // evaluates to nothing
//
#   define STREAMS_BOOST_SPIRIT_RP_OPTIONAL(elem)                                      \
      STREAMS_BOOST_PP_EXPR_IIF(STREAMS_BOOST_PP_COMPL(STREAMS_BOOST_PP_IS_UNARY(elem)),elem) 
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_COMMA_IF_OR
//
// Expands to nothing if both arguments are zero, otherwise expands to a comma.
//
#   define STREAMS_BOOST_SPIRIT_RP_COMMA_IF_OR(a,b)                                    \
      STREAMS_BOOST_PP_IIF(STREAMS_BOOST_PP_OR(a,b),STREAMS_BOOST_PP_COMMA,STREAMS_BOOST_PP_EMPTY)()
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// RP_IF
//
//   STREAMS_BOOST_SPIRIT_RP_IF(cond,name,arity)
//
// is equivalent to:
//
//   STREAMS_BOOST_PP_IF(cond,STREAMS_BOOST_name,STREAMS_BOOST_PP_TUPLE_EAT(arity))
//
#   define STREAMS_BOOST_SPIRIT_RP_IF(cond,name,arity) \
      STREAMS_BOOST_PP_IF(cond,STREAMS_BOOST_ ## name,STREAMS_BOOST_PP_TUPLE_EAT(arity))
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
  ...
  public:
    ...
    { typedef typename P::STREAMS_BOOST_NESTED_TEMPLATE result<ScannerT>::type type; };
  ...
  embed_by_reference(::STREAMS_BOOST_SPIRIT_CLASSIC_NS::parser<P> & p)
  { return p; }
...
STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(STREAMS_BOOST_SPIRIT_CLASSIC_NS::parser_reference, 1)
...
} } // namespace ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of

STREAMS_BOOST_TYPEOF_REGISTER_TYPE(STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::nop_functor)
STREAMS_BOOST_TYPEOF_REGISTER_TEMPLATE(STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::composite_action,2)
...
namespace type_of {
  ...
  #define STREAMS_BOOST_SPIRIT_RP_TYPE(x) \
    ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::remove_special_fptr \
      < ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::type_of::special_result & (*) x >::type
