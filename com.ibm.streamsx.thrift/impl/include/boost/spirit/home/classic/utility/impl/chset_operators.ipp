...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_CHSET_OPERATORS_IPP
#define STREAMS_BOOST_SPIRIT_CHSET_OPERATORS_IPP
...
namespace impl {
    ...
    template <typename CharT>
    inline STREAMS_BOOST_SPIRIT_CLASSIC_NS::range<CharT> const&
    full()
    {
        static STREAMS_BOOST_SPIRIT_CLASSIC_NS::range<CharT> full_(
    ...
    empty()
    {
        static STREAMS_BOOST_SPIRIT_CLASSIC_NS::range<CharT> empty_;
        return empty_;
    }
}
