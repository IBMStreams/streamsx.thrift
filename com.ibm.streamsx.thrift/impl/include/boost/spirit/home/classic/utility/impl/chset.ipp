...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_CHSET_IPP
#define STREAMS_BOOST_SPIRIT_CHSET_IPP

///////////////////////////////////////////////////////////////////////////////
#include <streams_boost/limits.hpp>
#include <streams_boost/spirit/home/classic/utility/chset.hpp>
...
namespace utility { namespace impl {
    ...
    inline void
    detach(streams_boost::shared_ptr<basic_chset<CharT> >& ptr)
    {
        if (!ptr.unique())
            ptr = streams_boost::shared_ptr<basic_chset<CharT> >
                (new basic_chset<CharT>(*ptr));
    }

    template <typename CharT>
    inline void
    detach_clear(streams_boost::shared_ptr<basic_chset<CharT> >& ptr)
    {
        if (ptr.unique())
            ptr->clear();
        else
    ...
    void chset_negated_set(streams_boost::shared_ptr<basic_chset<CharT> > &ptr, chlit<CharT> const &ch,
            FakeT)
    {
    ...
    template <typename CharT, typename FakeT>
    void chset_negated_set(streams_boost::shared_ptr<basic_chset<CharT> > &ptr,
