...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_REGEX_HPP
#define STREAMS_BOOST_SPIRIT_REGEX_HPP

#include <streams_boost/version.hpp>

///////////////////////////////////////////////////////////////////////////////
//
//  Include the regular expression library of streams_boost (Boost.Regex)
//
//  Note though, that this library is not distributed with Spirit. You have to
//  obtain a separate copy from http://www.streams_boost.org.
//
///////////////////////////////////////////////////////////////////////////////
#if defined(STREAMS_BOOST_SPIRIT_NO_REGEX_LIB) && STREAMS_BOOST_VERSION < 103300
//
//  Include all the Boost.regex library. Please note that this will not work,
//  if you are using the streams_boost/spirit/regex.hpp header from more than one
//  translation units.
//
#define STREAMS_BOOST_REGEX_NO_LIB
#define STREAMS_BOOST_REGEX_STATIC_LINK
#define STREAMS_BOOST_REGEX_NO_EXTERNAL_TEMPLATES
#include <streams_boost/regex.hpp>
#include <streams_boost/regex/src.cpp>
...
//
#include <streams_boost/regex.hpp>
#endif // defined(STREAMS_BOOST_SPIRIT_NO_REGEX_LIB)
...
#include <streams_boost/spirit/home/classic/utility/impl/regex.ipp>
...
struct rxstrlit : public parser<rxstrlit<CharT> > {
    ...
    {
    //  Due to limitations in the streams_boost::regex library the iterators wrapped in
    //  the ScannerT object should be at least bidirectional iterators. Plain
    //  forward iterators do not work here.
        typedef typename ScannerT::iterator_t iterator_t;
        typedef
            typename streams_boost::detail::iterator_traits<iterator_t>::iterator_category
            iterator_category;

        STREAMS_BOOST_STATIC_ASSERT((
            streams_boost::is_convertible<iterator_category,
...
private:
    impl::rx_parser<CharT> rx;   // contains the streams_boost regular expression parser
};
...
#endif // STREAMS_BOOST_SPIRIT_REGEX_HPP
