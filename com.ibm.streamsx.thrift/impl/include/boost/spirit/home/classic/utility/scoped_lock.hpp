/*=============================================================================
 ...
 =============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_UTILITY_SCOPED_LOCK_HPP
#define STREAMS_BOOST_SPIRIT_UTILITY_SCOPED_LOCK_HPP

///////////////////////////////////////////////////////////////////////////////
#include <streams_boost/spirit/home/classic/namespace.hpp>
#if !defined(STREAMS_BOOST_SPIRIT_COMPOSITE_HPP)
#include <streams_boost/spirit/home/classic/core/composite.hpp>
#endif
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct scoped_lock_parser_gen
    {
        ...
        {
            typedef ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::as_parser<ParserT> as_parser_t;
...
#endif // STREAMS_BOOST_SPIRIT_UTILITY_SCOPED_LOCK_HPP
