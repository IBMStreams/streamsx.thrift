...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_TREE_AST_HPP
#define STREAMS_BOOST_SPIRIT_TREE_AST_HPP

#include <streams_boost/spirit/home/classic/namespace.hpp>
#include <streams_boost/spirit/home/classic/tree/common.hpp>
    ...
    public common_tree_tree_policy<MatchPolicyT, NodeFactoryT>
{
    ...
    (STREAMS_BOOST_SPIRIT_DEBUG_FLAGS & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_NODES)
        ...
        {
            STREAMS_BOOST_SPIRIT_ASSERT(b.trees.size() == 1);
        ...
        {
            STREAMS_BOOST_SPIRIT_ASSERT(a.trees.size() == 1);
...
#if defined(STREAMS_BOOST_SPIRIT_DEBUG) && \
    (STREAMS_BOOST_SPIRIT_DEBUG_FLAGS & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_NODES)
        STREAMS_BOOST_SPIRIT_DEBUG_OUT << ">>>after AST concat. a = " << a << "<<<\n\n";
#endif
...
struct root_node_op
{
    ...
    {
        STREAMS_BOOST_SPIRIT_ASSERT(m.trees.size() > 0);
