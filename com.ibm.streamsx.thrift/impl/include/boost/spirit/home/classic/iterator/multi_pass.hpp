...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_ITERATOR_MULTI_PASS_HPP
#define STREAMS_BOOST_SPIRIT_ITERATOR_MULTI_PASS_HPP
...
#include <streams_boost/spirit/home/classic/core/assert.hpp> // for STREAMS_BOOST_SPIRIT_ASSERT
#include <streams_boost/spirit/home/classic/iterator/fixed_size_queue.hpp>
...
public:
    ...
    virtual const char*
    what() const throw()
    { return "STREAMS_BOOST_SPIRIT_CLASSIC_NS::illegal_backtracking"; }
};
...
class buf_id_check
{
    protected:
        ...
        void check() const
        {
            ...
            {
                streams_boost::throw_exception(illegal_backtracking());
            }
        }
...
class inner
{
    ...
    protected:
        ...
        void destroy()
        {
            STREAMS_BOOST_SPIRIT_ASSERT(NULL != queuedElements);
...
// STREAMS_BOOST_SPIRIT_CLASSIC_NS::fixed_size_queue class) that is size N+1 and stores N elements.
...
class inner
{
    private:
        ...
        typedef STREAMS_BOOST_SPIRIT_CLASSIC_NS::fixed_size_queue<ValueT, N> queue_type;
        queue_type * queuedElements;
...
class inner
{
    private:
        typedef
            typename streams_boost::detail::iterator_traits<InputT>::value_type
            result_type;
    ...
    public:
        typedef
            typename streams_boost::detail::iterator_traits<InputT>::difference_type
            difference_type;
        typedef
            typename streams_boost::detail::iterator_traits<InputT>::pointer
            pointer;
        typedef
            typename streams_boost::detail::iterator_traits<InputT>::reference
            reference;
    ...
    public:
        ...
        {
            STREAMS_BOOST_SPIRIT_ASSERT(NULL != data);
            ensure_initialized();
            return data->curtok;
        }
...
// We are using streams_boost::iterator<> because it offers an automatic workaround
//  for broken std::iterator<> implementations.
template <typename InputPolicyT, typename InputT>
struct iterator_base_creator
{
    typedef typename InputPolicyT::STREAMS_BOOST_NESTED_TEMPLATE inner<InputT> input_t;

    typedef streams_boost::iterator
    <
...
#if STREAMS_BOOST_WORKAROUND(__GLIBCPP__, == 20020514)
        multi_pass(int);
#endif // STREAMS_BOOST_WORKAROUND(__GLIBCPP__, == 20020514)
...
#endif // STREAMS_BOOST_SPIRIT_ITERATOR_MULTI_PASS_HPP
