...
#include <streams_boost/spirit/home/classic/core/nil.hpp>  // for nil_t
...
/* namespace streams_boost::spirit { */ namespace iterator_ { namespace impl {

///////////////////////////////////////////////////////////////////////////////
//
//  position_iterator_base_generator
//
//  Metafunction to generate the iterator type using streams_boost::iterator_adaptors,
...
{
private:
    typedef streams_boost::detail::iterator_traits<ForwardIterT> traits;
    typedef typename traits::value_type value_type;
    typedef typename traits::iterator_category iter_category_t;

    // Position iterator is always a non-mutable iterator
    typedef typename streams_boost::add_const<value_type>::type const_value_type;
...
public:
    ...
    typedef typename streams_boost::mpl::if_<
        typename streams_boost::is_same<MainIterT, nil_t>::type,
...
}} /* namespace streams_boost::spirit::iterator_::impl */
