...
#ifndef STREAMS_BOOST_SPIRIT_FILE_ITERATOR_IPP
#define STREAMS_BOOST_SPIRIT_FILE_ITERATOR_IPP

#ifdef STREAMS_BOOST_SPIRIT_FILEITERATOR_WINDOWS
#  include <windows.h>
#endif
...
#ifdef STREAMS_BOOST_SPIRIT_FILEITERATOR_POSIX
...
private:
    streams_boost::shared_ptr<std::FILE> m_file;
    std::size_t m_pos;
    CharT m_curChar;
    bool m_eof;
...
private:
    ...
    typedef streams_boost::remove_pointer<HANDLE>::type handle_t;
#else
    typedef void handle_t;
#endif

    streams_boost::shared_ptr<CharT> m_mem;
    std::size_t m_filesize;
    CharT* m_curChar;
};

#endif // STREAMS_BOOST_SPIRIT_FILEITERATOR_WINDOWS
...
private:
    ...
    streams_boost::shared_ptr<mapping> m_mem;
    CharT const* m_curChar;
};

#endif // STREAMS_BOOST_SPIRIT_FILEITERATOR_POSIX

///////////////////////////////////////////////////////////////////////////////
} /* namespace streams_boost::spirit::fileiter_impl */
...
#endif /* STREAMS_BOOST_SPIRIT_FILE_ITERATOR_IPP */
