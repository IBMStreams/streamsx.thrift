...
//  of streams_boost::iterator_adaptor, that is inhering an object created with it.
...
//  with streams_boost::iterator_adaptor only 5 functions are needed to implement
...
//  platforms, and uses memory mapped files, which gives a decent speed streams_boost.
//
///////////////////////////////////////////////////////////////////////////////
//
//  TODO LIST:
...
#ifndef STREAMS_BOOST_SPIRIT_FILE_ITERATOR_HPP
#define STREAMS_BOOST_SPIRIT_FILE_ITERATOR_HPP

#include <string>
#include <streams_boost/config.hpp>
#include <streams_boost/iterator_adaptors.hpp>
#include <streams_boost/spirit/home/classic/namespace.hpp>
#include <streams_boost/spirit/home/classic/core/safe_bool.hpp>

#include <streams_boost/spirit/home/classic/iterator/file_iterator_fwd.hpp>

#if !defined(STREAMS_BOOST_SPIRIT_FILEITERATOR_STD)
#  if (defined(WIN32) || defined(_WIN32) || defined(__WIN32__)) \
      && !defined(STREAMS_BOOST_DISABLE_WIN32)
#    define STREAMS_BOOST_SPIRIT_FILEITERATOR_WINDOWS
...
#      define STREAMS_BOOST_SPIRIT_FILEITERATOR_POSIX
#    endif // _POSIX_MAPPED_FILES
#  endif // STREAMS_BOOST_HAS_UNISTD_H

#  if !defined(STREAMS_BOOST_SPIRIT_FILEITERATOR_WINDOWS) && \
      !defined(STREAMS_BOOST_SPIRIT_FILEITERATOR_POSIX)
#    define STREAMS_BOOST_SPIRIT_FILEITERATOR_STD
#  endif
#endif // STREAMS_BOOST_SPIRIT_FILEITERATOR_STD
...
#ifdef STREAMS_BOOST_SPIRIT_FILEITERATOR_STD
...
namespace fileiter_impl {
    ...
    //  file_iter_generator
    //
    //  Template meta-function to invoke streams_boost::iterator_adaptor
...
#if !defined(STREAMS_BOOST_ITERATOR_ADAPTORS_VERSION) || \
     STREAMS_BOOST_ITERATOR_ADAPTORS_VERSION < 0x0200
#error "Please use at least Boost V1.31.0 while compiling the file_iterator class!"
#else // STREAMS_BOOST_ITERATOR_ADAPTORS_VERSION < 0x0200
    ...
    public:
        ...
        typedef streams_boost::iterator_adaptor <
            ...
            streams_boost::use_default,
            std::ptrdiff_t
        > type;
    };

#endif // STREAMS_BOOST_ITERATOR_ADAPTORS_VERSION < 0x0200
...
public:
    ...
    // operator bool. This borrows a trick from streams_boost::shared_ptr to avoid
...
///////////////////////////////////////////////////////////////////////////////
#include <streams_boost/spirit/home/classic/iterator/impl/file_iterator.ipp> /* implementation */

#endif /* STREAMS_BOOST_SPIRIT_FILE_ITERATOR_HPP */
