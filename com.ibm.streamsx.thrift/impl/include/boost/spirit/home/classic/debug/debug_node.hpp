...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_DEBUG_NODE_HPP)
#define STREAMS_BOOST_SPIRIT_DEBUG_NODE_HPP

#if !defined(STREAMS_BOOST_SPIRIT_DEBUG_MAIN_HPP)
#error "You must include streams_boost/spirit/debug.hpp, not streams_boost/spirit/debug/debug_node.hpp"
#endif
...
#include <streams_boost/spirit/home/classic/core/primitives/primitives.hpp> // for iscntrl_
...
///////////////////////////////////////////////////////////////////////////////
...
#if STREAMS_BOOST_SPIRIT_DEBUG_FLAGS & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_NODES
        ...
        IteratorT first, IteratorT last)
    {
        if (!name.empty())
        {
            ...
            STREAMS_BOOST_SPIRIT_DEBUG_OUT << name << ":\t\"";
            IteratorT iter = first;
            IteratorT ilast = last;
            for (int j = 0; j < STREAMS_BOOST_SPIRIT_DEBUG_PRINT_SOME; ++j)
            {
                if (iter == ilast)
                    break;

                token_printer(STREAMS_BOOST_SPIRIT_DEBUG_OUT, *iter);
                ++iter;
            }
            STREAMS_BOOST_SPIRIT_DEBUG_OUT << "\"\n";
        }
    }
#endif  // STREAMS_BOOST_SPIRIT_DEBUG_FLAGS & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_NODES

#if STREAMS_BOOST_SPIRIT_DEBUG_FLAGS & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CLOSURES
    ...
    print_closure_info(ResultT &hit, int level, std::string const& name)
    {
        ...
        // for now, print out the return value only
            ...
            if (hit.has_valid_attribute())
                STREAMS_BOOST_SPIRIT_DEBUG_OUT << hit.value();
            else
                STREAMS_BOOST_SPIRIT_DEBUG_OUT << "undefined attribute";
            STREAMS_BOOST_SPIRIT_DEBUG_OUT << "\n";
        }
        return hit;
    }
#endif // STREAMS_BOOST_SPIRIT_DEBUG_FLAGS & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CLOSURES
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(STREAMS_BOOST_SPIRIT_PARSER_CONTEXT_LINKER_DEFINED)
#define STREAMS_BOOST_SPIRIT_PARSER_CONTEXT_LINKER_DEFINED
...
#endif // !defined(STREAMS_BOOST_SPIRIT_PARSER_CONTEXT_LINKER_DEFINED)

#if !defined(STREAMS_BOOST_SPIRIT_PARSER_SCANNER_LINKER_DEFINED)
#define STREAMS_BOOST_SPIRIT_PARSER_SCANNER_LINKER_DEFINED
...
#endif // !defined(STREAMS_BOOST_SPIRIT_PARSER_SCANNER_LINKER_DEFINED)

#if !defined(STREAMS_BOOST_SPIRIT_CLOSURE_CONTEXT_LINKER_DEFINED)
#define STREAMS_BOOST_SPIRIT_CLOSURE_CONTEXT_LINKER_DEFINED
...
#endif // !defined(STREAMS_BOOST_SPIRIT_CLOSURE_CONTEXT_LINKER_DEFINED)
...
#endif // !defined(STREAMS_BOOST_SPIRIT_DEBUG_NODE_HPP)
