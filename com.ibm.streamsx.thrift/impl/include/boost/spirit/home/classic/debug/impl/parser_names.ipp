...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_PARSER_NAMES_IPP)
#define STREAMS_BOOST_SPIRIT_PARSER_NAMES_IPP
...
#include <strstream>
#define STREAMS_BOOST_SPIRIT_SSTREAM std::strstream
std::string STREAMS_BOOST_SPIRIT_GETSTRING(std::strstream& ss)
{
    ss << ends;
...
#define STREAMS_BOOST_SPIRIT_SSTREAM std::stringstream
#endif
...
//  from numerics.hpp
    ...
    {
        STREAMS_BOOST_SPIRIT_SSTREAM stream;
        stream << Radix << ", " << MinDigits << ", " << MaxDigits;
        return std::string("uint_parser<")
            + STREAMS_BOOST_SPIRIT_GETSTRING(stream)
            + std::string(">");
    }
    ...
    namespace impl {
        struct node_registry
        {
            ...
            bool trace_node(void const *r)
            {
                ...
                return STREAMS_BOOST_SPIRIT_DEBUG_TRACENODE;
            }
...
#undef STREAMS_BOOST_SPIRIT_SSTREAM
#undef STREAMS_BOOST_SPIRIT_GETSTRING

#endif // defined(STREAMS_BOOST_SPIRIT_DEBUG)

#endif // !defined(STREAMS_BOOST_SPIRIT_PARSER_NAMES_IPP)
