...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_FOR_HPP
#define STREAMS_BOOST_SPIRIT_FOR_HPP
////////////////////////////////////////////////////////////////////////////////
...
#include <streams_boost/spirit/home/classic/dynamic/impl/conditions.ipp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    namespace impl
    {
        ...
        struct for_functor
        {
            typedef typename streams_boost::call_traits<FuncT>::param_type  param_t;
            ...
            >
        {
            ...
            parse(ScannerT const &scan) const
            {
                ...
                STREAMS_BOOST_SPIRIT_CLASSIC_NS::nil_t attr;
...
#endif // STREAMS_BOOST_SPIRIT_FOR_HPP
