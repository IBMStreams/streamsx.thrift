...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_SELECT_IPP
#define STREAMS_BOOST_SPIRIT_SELECT_IPP
...
struct parse_tuple_element {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, index = (TupleT::length - N));
...
struct parse_tuple_element<1, ResultT, TupleT, BehaviourT> {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, index = (TupleT::length - 1));
...
#endif  // STREAMS_BOOST_SPIRIT_SELECT_IPP
