...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_SWITCH_IPP
#define STREAMS_BOOST_SPIRIT_SWITCH_IPP
...
struct default_delegate_parse<N, true, HasDefault> {
        ...
        ScannerT const &scan, typename ScannerT::iterator_t const save)
    {
        ...
        STREAMS_BOOST_STATIC_ASSERT((!streams_boost::is_same<DefaultT, nothing_parser>::value));
...
struct default_case {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_epsilon = (
...
struct default_case<CaseT, true> {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = CaseT::is_default);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_epsilon = (
        CaseT::is_default && CaseT::is_epsilon
    ));
...
struct case_chain {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, depth = (
...
struct case_chain<CaseT, true> {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, depth = 0);
};
        ...
        parser<compound_case_parser<LeftT, RightT, IsDefault> > >
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, value = RightT::value);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_default = IsDefault);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_simple = false);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_epsilon = (
        is_default &&
            streams_boost::is_same<typename RightT::subject_t, epsilon_parser>::value
    ));
    ...
    operator, (case_parser<N1, ParserT1, IsDefault1> const &p) const
    {
        ...
        STREAMS_BOOST_STATIC_ASSERT(!default_case<self_t>::value || !IsDefault1);
        ...
        STREAMS_BOOST_STATIC_ASSERT(
            case_chain<self_t>::depth < STREAMS_BOOST_SPIRIT_SWITCH_CASE_LIMIT
        );
...
//
///////////////////////////////////////////////////////////////////////////////
#define STREAMS_BOOST_SPIRIT_PARSE_SWITCH_TYPEDEFS(z, N, _)                         \
    typedef typename STREAMS_BOOST_PP_CAT(left_t, N)::left_t                        \
        STREAMS_BOOST_PP_CAT(left_t, STREAMS_BOOST_PP_INC(N));                              \
    /**/

#define STREAMS_BOOST_SPIRIT_PARSE_SWITCH_CASES(z, N, _)                            \
    case (long)(STREAMS_BOOST_PP_CAT(left_t, N)::value):                            \
        return delegate_parse(chain_parser<N, left_t1>::right(p.left()),    \
            scan, save);                                                    \
    /**/

#define STREAMS_BOOST_SPIRIT_PARSE_SWITCHES(z, N, _)                                \
    template <int Value, bool IsDefault>                                    \
    struct parse_switch<Value, STREAMS_BOOST_PP_INC(N), IsDefault> {                \
                                                                            \
        template <typename ParserT, typename ScannerT>                      \
        static typename parser_result<ParserT, ScannerT>::type              \
        do_(ParserT const &p, ScannerT const &scan, long cond_value,        \
        ...
        {                                                                   \
            typedef ParserT left_t0;                                        \
            STREAMS_BOOST_PP_REPEAT_FROM_TO_ ## z(0, STREAMS_BOOST_PP_INC(N),               \
                STREAMS_BOOST_SPIRIT_PARSE_SWITCH_TYPEDEFS, _)                      \
                                                                            \
            switch (cond_value) {                                           \
            case (long)(STREAMS_BOOST_PP_CAT(left_t, STREAMS_BOOST_PP_INC(N))::value):      \
                return delegate_parse(                                      \
                    chain_parser<                                           \
                        case_chain<ParserT>::depth, ParserT                 \
                    >::left(p), scan, save);                                \
                                                                            \
            STREAMS_BOOST_PP_REPEAT_FROM_TO_ ## z(1, STREAMS_BOOST_PP_INC(N),               \
                STREAMS_BOOST_SPIRIT_PARSE_SWITCH_CASES, _)                         \
                                                                            \
...
STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_PP_DEC(STREAMS_BOOST_SPIRIT_SWITCH_CASE_LIMIT),
    STREAMS_BOOST_SPIRIT_PARSE_SWITCHES, _)

#undef STREAMS_BOOST_SPIRIT_PARSE_SWITCH_TYPEDEFS
#undef STREAMS_BOOST_SPIRIT_PARSE_SWITCH_CASES
#undef STREAMS_BOOST_SPIRIT_PARSE_SWITCHES
///////////////////////////////////////////////////////////////////////////////
...
#endif  // STREAMS_BOOST_SPIRIT_SWITCH_IPP
