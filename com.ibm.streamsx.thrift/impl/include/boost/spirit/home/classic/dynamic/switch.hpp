...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_SWITCH_HPP
#define STREAMS_BOOST_SPIRIT_SWITCH_HPP
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(STREAMS_BOOST_SPIRIT_DEFAULTCASE_MAGIC)
#define STREAMS_BOOST_SPIRIT_DEFAULTCASE_MAGIC 0x15F97A7
#endif
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(STREAMS_BOOST_SPIRIT_SWITCH_CASE_LIMIT)
#define STREAMS_BOOST_SPIRIT_SWITCH_CASE_LIMIT 3
#endif // !defined(STREAMS_BOOST_SPIRIT_SWITCH_CASE_LIMIT)
...
///////////////////////////////////////////////////////////////////////////////
//
// Ensure   STREAMS_BOOST_SPIRIT_SELECT_LIMIT > 0
//
///////////////////////////////////////////////////////////////////////////////
STREAMS_BOOST_STATIC_ASSERT(STREAMS_BOOST_SPIRIT_SWITCH_CASE_LIMIT > 0);
...
#include <streams_boost/spirit/home/classic/dynamic/impl/switch.ipp>
...
//  STREAMS_BOOST_SPIRIT_SWITCH_CASE_LIMIT (this value defaults to 3 if not otherwise
//  defined).
//
///////////////////////////////////////////////////////////////////////////////
...
:   public unary<ParserT, parser<case_parser<N, ParserT, IsDefault> > >
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, value = N);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_default = IsDefault);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_simple = true);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_epsilon = (
        is_default && streams_boost::is_same<self_subject_t, epsilon_parser>::value
    ));
    ...
    operator, (case_parser<N1, ParserT1, IsDefault1> const &p) const
    {
        ...
        STREAMS_BOOST_STATIC_ASSERT(!is_default || !IsDefault1);
...
:   public case_parser<STREAMS_BOOST_SPIRIT_DEFAULTCASE_MAGIC, epsilon_parser, true>
{
    default_parser_gen()
    :   case_parser<STREAMS_BOOST_SPIRIT_DEFAULTCASE_MAGIC, epsilon_parser, true>
            (epsilon_p)
    {}

    template <typename ParserT>
    case_parser<STREAMS_BOOST_SPIRIT_DEFAULTCASE_MAGIC, ParserT, true>
    operator()(parser<ParserT> const &p) const
    {
        return case_parser<STREAMS_BOOST_SPIRIT_DEFAULTCASE_MAGIC, ParserT, true>(p);
    }
};
...
#endif // STREAMS_BOOST_SPIRIT_SWITCH_HPP
