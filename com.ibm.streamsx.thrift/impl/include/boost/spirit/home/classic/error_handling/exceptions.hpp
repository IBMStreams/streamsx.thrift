...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_EXCEPTIONS_HPP
#define STREAMS_BOOST_SPIRIT_EXCEPTIONS_HPP
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct parser_error : public parser_error_base
    {
        ...
        what() const throw()
        {
            return "STREAMS_BOOST_SPIRIT_CLASSIC_NS::parser_error";
        }
...
#include <streams_boost/spirit/home/classic/error_handling/impl/exceptions.ipp>
#endif
