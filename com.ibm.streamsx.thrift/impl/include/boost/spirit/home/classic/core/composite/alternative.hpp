...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_ALTERNATIVE_HPP)
#define STREAMS_BOOST_SPIRIT_ALTERNATIVE_HPP
...
#pragma warning(pop)
    ...
    struct alternative_parser_gen
    {
        ...
        {
            return alternative<STREAMS_BOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <streams_boost/spirit/home/classic/core/composite/impl/alternative.ipp>
