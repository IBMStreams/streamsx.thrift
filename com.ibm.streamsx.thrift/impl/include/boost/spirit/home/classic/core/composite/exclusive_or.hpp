...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_EXCLUSIVE_OR_HPP)
#define STREAMS_BOOST_SPIRIT_EXCLUSIVE_OR_HPP
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct exclusive_or_parser_gen
    {
        ...
        {
            return exclusive_or<STREAMS_BOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <streams_boost/spirit/home/classic/core/composite/impl/exclusive_or.ipp>
