...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_PRIMITIVES_HPP)
#define STREAMS_BOOST_SPIRIT_PRIMITIVES_HPP
...
#include <streams_boost/spirit/home/classic/core/composite/impl/directives.ipp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    ch_p(CharT const (& str)[N])
    {
        ...
        STREAMS_BOOST_STATIC_ASSERT(N < 3);
    ...
    struct range : public char_parser<range<CharT> >
    {
        ...
        {
            STREAMS_BOOST_SPIRIT_ASSERT(!(last < first));
        }
    ...
    public:
        ...
        parse(ScannerT const& scan) const
        {
            typedef typename streams_boost::unwrap_reference<IteratorT>::type striter_t;
            typedef typename parser_result<self_t, ScannerT>::type result_t;
