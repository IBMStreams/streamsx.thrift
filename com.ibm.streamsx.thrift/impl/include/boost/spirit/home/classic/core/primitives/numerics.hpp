...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_NUMERICS_HPP
#define STREAMS_BOOST_SPIRIT_NUMERICS_HPP
...
#include <streams_boost/spirit/home/classic/core/primitives/impl/numerics.ipp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct ureal_parser_policies
    {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, allow_leading_dot = true);
        STREAMS_BOOST_STATIC_CONSTANT(bool, allow_trailing_dot = true);
        STREAMS_BOOST_STATIC_CONSTANT(bool, expect_dot = false);
    ...
    {
        STREAMS_BOOST_STATIC_CONSTANT(bool, expect_dot = true);
    };
