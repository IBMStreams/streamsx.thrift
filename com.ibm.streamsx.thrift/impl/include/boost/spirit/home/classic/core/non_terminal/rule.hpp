...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_RULE_HPP)
#define STREAMS_BOOST_SPIRIT_RULE_HPP
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(STREAMS_BOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT)
#  define STREAMS_BOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT 1
#endif

//  Ensure a meaningful maximum number of simultaneously usable scanner types
STREAMS_BOOST_STATIC_ASSERT(STREAMS_BOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT > 0);

#include <streams_boost/scoped_ptr.hpp>
#include <streams_boost/spirit/home/classic/namespace.hpp>
#include <streams_boost/spirit/home/classic/core/non_terminal/impl/rule.ipp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    //      scanner types defined by the STREAMS_BOOST_SPIRIT_RULE_SCANNERTYPE_LIMIT
    //      constant. Example:
    //
