...
============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_SKIPPER_IPP)
#define STREAMS_BOOST_SPIRIT_SKIPPER_IPP
            ...
            skipper_iteration_policy<BaseT> const&)
        {
            typedef scanner_policies<
                no_skipper_iteration_policy<
                    STREAMS_BOOST_DEDUCED_TYPENAME ScannerT::iteration_policy_t>,
                STREAMS_BOOST_DEDUCED_TYPENAME ScannerT::match_policy_t,
                STREAMS_BOOST_DEDUCED_TYPENAME ScannerT::action_policy_t
            > policies_t;

            scanner<STREAMS_BOOST_DEDUCED_TYPENAME ScannerT::iterator_t, policies_t>
