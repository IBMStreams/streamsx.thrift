...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_CONFIG_HPP)
#define STREAMS_BOOST_SPIRIT_CONFIG_HPP
...
# error "Compiler not supported. See note in <streams_boost/spirit/core/config.hpp>"
#else
