...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_SUBRULE_HPP)
#define STREAMS_BOOST_SPIRIT_SUBRULE_HPP
...
#include <streams_boost/spirit/home/classic/core/non_terminal/impl/subrule.ipp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    : public parser<subrule_parser<ID, DefT, ContextT> >
    {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(int, id = ID);
