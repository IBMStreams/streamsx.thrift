...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_PARSER_HPP)
#define STREAMS_BOOST_SPIRIT_PARSER_HPP
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    {
        typedef typename streams_boost::remove_reference<ParserT>::type parser_type;
...
#include <streams_boost/spirit/home/classic/core/impl/parser.ipp>
