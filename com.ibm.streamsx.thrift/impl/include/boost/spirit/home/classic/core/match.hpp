...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_MATCH_HPP)
#define STREAMS_BOOST_SPIRIT_MATCH_HPP
...
#include <streams_boost/spirit/home/classic/core/impl/match_attr_traits.ipp>
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    public:
        ...
        typedef typename streams_boost::optional<T> optional_type;
        ...
        {
            STREAMS_BOOST_SPIRIT_ASSERT(*this && other);
            len += other.length();
        }
...
#endif
#include <streams_boost/spirit/home/classic/core/impl/match.ipp>
