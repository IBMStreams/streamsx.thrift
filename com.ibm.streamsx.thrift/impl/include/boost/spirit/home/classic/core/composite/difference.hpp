...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_DIFFERENCE_HPP)
#define STREAMS_BOOST_SPIRIT_DIFFERENCE_HPP
...
#pragma warning(pop)
    ...
    struct difference_parser_gen
    {
        ...
        {
            return difference<STREAMS_BOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <streams_boost/spirit/home/classic/core/composite/impl/difference.ipp>
