...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_SUBRULE_IPP)
#define STREAMS_BOOST_SPIRIT_SUBRULE_IPP
    ...
    namespace impl {
        ...
        //  otherwise it is equal to the dictated return value.
            ...
            typedef typename mpl::if_<
                streams_boost::is_same<T1, nil_t>, T2, T1
            >::type type;
        };
        ...
        {
            STREAMS_BOOST_STATIC_CONSTANT(bool, value = (SubruleT::id == ID));
        };
