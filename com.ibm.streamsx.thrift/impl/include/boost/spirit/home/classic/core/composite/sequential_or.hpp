...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_SEQUENTIAL_OR_HPP)
#define STREAMS_BOOST_SPIRIT_SEQUENTIAL_OR_HPP
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct sequential_or_parser_gen
    {
        ...
        {
            return sequential_or<STREAMS_BOOST_DEDUCED_TYPENAME as_parser<A>::type,
                STREAMS_BOOST_DEDUCED_TYPENAME as_parser<B>::type>
...
#include <streams_boost/spirit/home/classic/core/composite/impl/sequential_or.ipp>
