...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_INTERSECTION_HPP)
#define STREAMS_BOOST_SPIRIT_INTERSECTION_HPP
...
STREAMS_BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct intersection_parser_gen
    {
        ...
        {
            return intersection<STREAMS_BOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <streams_boost/spirit/home/classic/core/composite/impl/intersection.ipp>
