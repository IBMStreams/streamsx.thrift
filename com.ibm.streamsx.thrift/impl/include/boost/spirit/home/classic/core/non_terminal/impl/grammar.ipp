...
=============================================================================*/
#if !defined STREAMS_BOOST_SPIRIT_GRAMMAR_IPP
#define STREAMS_BOOST_SPIRIT_GRAMMAR_IPP

#if !defined(STREAMS_BOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE)
#include <streams_boost/spirit/home/classic/core/non_terminal/impl/object_with_id.ipp>
#include <algorithm>
#include <functional>
...
#include <streams_boost/spirit/home/classic/core/non_terminal/impl/static.hpp>
...
STREAMS_BOOST_SPIRIT_DEPENDENT_TEMPLATE_WRAPPER(grammar_definition_wrapper, definition);
...
struct grammar_definition
{
    ...
    struct grammar_helper : private grammar_helper_base<GrammarT>
    {
        ...
        typedef streams_boost::shared_ptr<helper_t> helper_ptr_t;
        typedef streams_boost::weak_ptr<helper_t>   helper_weak_ptr_t;
...
#ifdef STREAMS_BOOST_SPIRIT_THREADSAFE
            streams_boost::mutex::scoped_lock lock(helpers.mutex());
#endif
...
#endif /* defined(STREAMS_BOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE) */
...
# ifdef STREAMS_BOOST_SPIRIT_THREADSAFE
        streams_boost::thread_specific_ptr<ptr_t> & tld_helper
            = static_<streams_boost::thread_specific_ptr<ptr_t>,
...
# endif
    ...
    public:
        ...
        parse(ScannerT const& scan) const
        {
            ...
            STREAMS_BOOST_SPIRIT_CONTEXT_PARSE(scan, target_grammar, scanner_t,
                context_t, result_t)
        }
...
///////////////////////////////////////
#if !defined(STREAMS_BOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE)
#define STREAMS_BOOST_SPIRIT_GRAMMAR_ID , public impl::object_with_id<impl::grammar_tag>
#else
#define STREAMS_BOOST_SPIRIT_GRAMMAR_ID
#endif

///////////////////////////////////////
#if !defined(__GNUC__) || (__GNUC__ > 2)
#define STREAMS_BOOST_SPIRIT_GRAMMAR_ACCESS private:
#else
#define STREAMS_BOOST_SPIRIT_GRAMMAR_ACCESS
#endif

///////////////////////////////////////
#if !defined(STREAMS_BOOST_SPIRIT_SINGLE_GRAMMAR_INSTANCE)
#define STREAMS_BOOST_SPIRIT_GRAMMAR_STATE                            \
    STREAMS_BOOST_SPIRIT_GRAMMAR_ACCESS                               \
