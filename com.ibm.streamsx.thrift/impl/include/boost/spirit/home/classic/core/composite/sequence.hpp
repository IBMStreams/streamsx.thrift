...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_SEQUENCE_HPP)
#define STREAMS_BOOST_SPIRIT_SEQUENCE_HPP
...
#pragma warning(pop)
    ...
    struct sequence_parser_gen
    {
        ...
        {
            return sequence<STREAMS_BOOST_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <streams_boost/spirit/home/classic/core/composite/impl/sequence.ipp>
