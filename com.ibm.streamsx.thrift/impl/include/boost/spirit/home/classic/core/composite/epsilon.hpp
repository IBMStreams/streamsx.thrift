...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_EPSILON_HPP
#define STREAMS_BOOST_SPIRIT_EPSILON_HPP

////////////////////////////////////////////////////////////////////////////////
#include <streams_boost/spirit/home/classic/namespace.hpp>
#include <streams_boost/spirit/home/classic/core/parser.hpp>
#include <streams_boost/spirit/home/classic/meta/parser_traits.hpp>
...
///////////////////////////////////////////////////////////////////////////////
    ...
    STREAMS_BOOST_WORKAROUND(__SUNPRO_CC, <= 0x580)
...
// expressions of non-type template parameters in instantiations
    ...
    { return p.negate(); }
#else // STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, == 1310) || == 1400
    ...
    { return p.negate(); }
#endif // STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, == 1310) || == 1400
