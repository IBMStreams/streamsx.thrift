...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_PRIMITIVES_IPP)
#define STREAMS_BOOST_SPIRIT_PRIMITIVES_IPP

// This should eventually go to a config file.
#if defined(__GNUC__) && (__GNUC__ < 3) && !defined(_STLPORT_VERSION)
#  ifndef STREAMS_BOOST_SPIRIT_NO_CHAR_TRAITS
#    define STREAMS_BOOST_SPIRIT_NO_CHAR_TRAITS
#  endif
#endif

#include <cctype>
#if !defined(STREAMS_BOOST_NO_CWCTYPE)
#include <cwctype>
#endif
...
#ifndef STREAMS_BOOST_SPIRIT_NO_CHAR_TRAITS
#  define STREAMS_BOOST_SPIRIT_CHAR_TRAITS_NAMESPACE std
#else
...
#  define STREAMS_BOOST_SPIRIT_CHAR_TRAITS_NAMESPACE impl
#  ifndef STREAMS_BOOST_NO_CWCTYPE
...
#  endif
#endif // STREAMS_BOOST_SPIRIT_NO_CHAR_TRAITS
        ...
        {
            typedef CharT char_type;
            typedef typename STREAMS_BOOST_SPIRIT_CHAR_TRAITS_NAMESPACE
                ::char_traits<CharT>::int_type int_type;

            static int_type to_int_type(CharT c)
            {
                return STREAMS_BOOST_SPIRIT_CHAR_TRAITS_NAMESPACE
...
#endif // !defined(STREAMS_BOOST_NO_CWCTYPE)
