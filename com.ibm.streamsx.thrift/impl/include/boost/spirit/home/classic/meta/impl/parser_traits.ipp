...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_PARSER_TRAITS_IPP)
#define STREAMS_BOOST_SPIRIT_PARSER_TRAITS_IPP

#include <streams_boost/spirit/home/classic/core/composite/operators.hpp>
...
namespace impl
{
    ...
    struct parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_alternative = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_sequence = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_sequential_or = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_intersection = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_difference = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_exclusive_or = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_optional = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_kleene_star = false);
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_positive = false);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_alternative = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_sequence = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_sequential_or = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_intersection = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_difference = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_exclusive_or = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_optional = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_kleene_star = true);
    };
    ...
    :   public parser_type_traits_base {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_positive = true);
    };
...
#endif // !defined(STREAMS_BOOST_SPIRIT_PARSER_TRAITS_IPP)
