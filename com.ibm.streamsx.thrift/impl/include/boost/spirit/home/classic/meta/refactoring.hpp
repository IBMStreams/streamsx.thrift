...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_REFACTORING_HPP
#define STREAMS_BOOST_SPIRIT_REFACTORING_HPP
...
#include <streams_boost/spirit/home/classic/meta/impl/refactoring.ipp>
...
public:
    ...
    STREAMS_BOOST_STATIC_ASSERT((
        streams_boost::is_convertible<typename BinaryT::parser_category_t,
...
public:
    ...
    //  parser
    STREAMS_BOOST_STATIC_ASSERT((
        streams_boost::is_convertible<typename ActionT::parser_category_t,
...
#endif // STREAMS_BOOST_SPIRIT_REFACTORING_HPP
