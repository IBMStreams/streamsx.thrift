...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_PARSER_TRAITS_HPP)
#define STREAMS_BOOST_SPIRIT_PARSER_TRAITS_HPP
...
#include <streams_boost/spirit/home/classic/meta/impl/parser_traits.ipp>
...
struct is_parser
{
    STREAMS_BOOST_STATIC_CONSTANT(bool, value =
        (::streams_boost::is_base_and_derived<parser<T>, T>::value));

//  [JDG 2/3/03] simplified implementation by
//  using streams_boost::is_base_and_derived
};
...
struct is_unary_composite {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (::streams_boost::is_convertible<
...
struct is_composite_parser {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::is_unary_composite<CompositeT>::value ||
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::is_binary_composite<CompositeT>::value));
};
...
struct is_alternative {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_alternative));
};
...
struct is_sequence {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_sequence));
};
...
struct is_sequential_or {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_sequential_or));
};
...
struct is_intersection {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_intersection));
};
...
struct is_difference {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_difference));
};
...
struct is_exclusive_or {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_exclusive_or));
};
...
struct is_optional {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_optional));
};
...
struct is_kleene_star {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_kleene_star));
};
...
struct is_positive {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
        ::STREAMS_BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_positive));
};
...
struct unary_subject {
    ...
    STREAMS_BOOST_STATIC_ASSERT(STREAMS_BOOST_SPIRIT_CLASSIC_NS::is_unary_composite<UnaryT>::value);
...
struct binary_left_subject {
    ...
    STREAMS_BOOST_STATIC_ASSERT(::STREAMS_BOOST_SPIRIT_CLASSIC_NS::is_binary_composite<BinaryT>::value);
...
struct action_subject {
    ...
    STREAMS_BOOST_STATIC_ASSERT(::STREAMS_BOOST_SPIRIT_CLASSIC_NS::is_action_parser<ActionT>::value);
...
#endif // !defined(STREAMS_BOOST_SPIRIT_PARSER_TRAITS_HPP)
