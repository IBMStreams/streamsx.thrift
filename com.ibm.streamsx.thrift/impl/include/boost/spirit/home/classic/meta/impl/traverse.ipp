...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_TRAVERSE_IPP)
#define STREAMS_BOOST_SPIRIT_TRAVERSE_IPP

///////////////////////////////////////////////////////////////////////////////
#include <streams_boost/spirit/home/classic/meta/fundamental.hpp>
...
struct traverse_post_order_env {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, level = Level);
    STREAMS_BOOST_STATIC_CONSTANT(int, node = Node);
    STREAMS_BOOST_STATIC_CONSTANT(int, index = Index);
    STREAMS_BOOST_STATIC_CONSTANT(int, lastleft = LastLeft);
};
...
#endif // !defined(STREAMS_BOOST_SPIRIT_TRAVERSE_IPP)
