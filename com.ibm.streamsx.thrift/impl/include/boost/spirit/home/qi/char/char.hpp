...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_CHAR_APRIL_16_2006_1051AM)
#define STREAMS_BOOST_SPIRIT_CHAR_APRIL_16_2006_1051AM
...
#include <streams_boost/spirit/home/qi/char/char_parser.hpp>
#include <streams_boost/spirit/home/qi/char/char_class.hpp>
#include <streams_boost/spirit/home/qi/meta_compiler.hpp>
#include <streams_boost/spirit/home/qi/auxiliary/lazy.hpp>
...
namespace streams_boost { namespace spirit { namespace qi
{
      ...
      : char_parser<char_range<CharEncoding, true>, typename CharEncoding::char_type>
    {
        ...
        info what(Context& /*context*/) const
        {
            ...
            streams_boost::get<std::string>(result.value) += '-';
            streams_boost::get<std::string>(result.value) += to_utf8(char_encoding::toucs4(to_lo));
            return result;
        }
