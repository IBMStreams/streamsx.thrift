...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_CHAR_PARSER_APR_16_2006_0906AM)
#define STREAMS_BOOST_SPIRIT_CHAR_PARSER_APR_16_2006_0906AM
...
namespace streams_boost { namespace spirit { namespace traits // classification
{
    namespace detail
    {
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(char_parser_id)
    }
