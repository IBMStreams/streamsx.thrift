...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_LAZY_MARCH_27_2007_1002AM)
#define STREAMS_BOOST_SPIRIT_LAZY_MARCH_27_2007_1002AM
...
namespace streams_boost { namespace spirit { namespace qi
{
    ...
    struct lazy_parser : parser<lazy_parser<Function, Modifiers> >
    {
        ...
        {
            typedef typename
                streams_boost::result_of<qi_modify(tag::lazy_eval, Modifiers)>::type
            modifier;
            ...
            // expression.
            STREAMS_BOOST_SPIRIT_ASSERT_MATCH(qi::domain, expr_type);
