...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_ISTREAM_MAY_05_2007_0110PM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_ISTREAM_MAY_05_2007_0110PM
...
namespace streams_boost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct iterator_source
    {
        ...
        char_type;
        typedef streams_boost::iostreams::source_tag category;
