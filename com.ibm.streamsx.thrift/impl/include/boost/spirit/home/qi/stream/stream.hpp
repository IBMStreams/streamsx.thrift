...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_STREAM_MAY_05_2007_1228PM)
#define STREAMS_BOOST_SPIRIT_STREAM_MAY_05_2007_1228PM

#if defined(_MSC_VER)
#pragma once
#endif

#include <streams_boost/spirit/home/qi/detail/string_parse.hpp>
#include <streams_boost/spirit/home/qi/stream/detail/match_manip.hpp>
#include <streams_boost/spirit/home/qi/stream/detail/iterator_source.hpp>
...
namespace streams_boost { namespace spirit { namespace qi
{
      ...
      : primitive_parser<stream_parser<Char, T> >
    {
          ...
          , Attribute& attr) const
        {
            ...
            typedef streams_boost::iostreams::stream<source_device> instream;
