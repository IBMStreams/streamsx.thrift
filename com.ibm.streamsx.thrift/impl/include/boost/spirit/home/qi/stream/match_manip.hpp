...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_MATCH_MANIP_MAY_05_2007_1202PM)
#define STREAMS_BOOST_SPIRIT_MATCH_MANIP_MAY_05_2007_1202PM
...
namespace streams_boost { namespace spirit { namespace qi
{
    ...
    phrase_match(
        Expr const& expr
      , Skipper const& s
      , STREAMS_BOOST_SCOPED_ENUM(skip_flag) post_skip = skip_flag::postskip)
    {
