...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_MATCH_MANIP_MAY_05_2007_1203PM)
#define STREAMS_BOOST_SPIRIT_MATCH_MANIP_MAY_05_2007_1203PM
...
#include <streams_boost/spirit/home/support/iterators/istream_iterator.hpp>
...
namespace streams_boost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct match_manip
    {
        ...
        match_manip(Expr const& xpr, Skipper const& s
            , STREAMS_BOOST_SCOPED_ENUM(skip_flag) ps, Attribute& a)
          : expr(xpr), skipper(s), attr(a), post_skip(ps) {}

        Expr const& expr;
        Skipper const& skipper;
        Attribute& attr;
        STREAMS_BOOST_SCOPED_ENUM(skip_flag) const post_skip;
    ...
    struct match
    {
        ...
        // #include <streams_boost/spirit/include/qi_match_auto.hpp>?
