...
#include <streams_boost/spirit/home/qi/operator/sequence_base.hpp>
#include <streams_boost/spirit/home/qi/detail/expect_function.hpp>
...
namespace streams_boost { namespace spirit { namespace qi
{
    ...
    struct expectation_failure : std::runtime_error
    {
        expectation_failure(Iterator first, Iterator last, info const& what)
          : std::runtime_error("streams_boost::spirit::qi::expectation_failure")
