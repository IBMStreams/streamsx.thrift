...
namespace streams_boost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct radix_traits<2>
    {
        ...
        struct digits
        {
            ...
            STREAMS_BOOST_STATIC_CONSTANT(int, value = numeric_limits_::digits);
        };
    };
    ...
    struct radix_traits<8>
    {
        ...
        {
            typedef std::numeric_limits<T> numeric_limits_;
            STREAMS_BOOST_STATIC_CONSTANT(int, value = numeric_limits_::digits / 3);
        };
    };
    ...
    struct radix_traits<10>
    {
        ...
        {
            typedef std::numeric_limits<T> numeric_limits_;
            STREAMS_BOOST_STATIC_CONSTANT(int, value = numeric_limits_::digits10);
        };
    };
    ...
    struct radix_traits<16>
    {
        ...
        {
            typedef std::numeric_limits<T> numeric_limits_;
            STREAMS_BOOST_STATIC_CONSTANT(int, value = numeric_limits_::digits / 4);
        };
    };
