...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_NUMERIC_UTILS_APRIL_17_2006_0830AM)
#define STREAMS_BOOST_SPIRIT_NUMERIC_UTILS_APRIL_17_2006_0830AM
...
#include <streams_boost/spirit/home/qi/numeric/detail/numeric_utils.hpp>
...
namespace streams_boost { namespace spirit { namespace qi
{
    ...
    extract_sign(Iterator& first, Iterator const& last)
    {
        ...
        STREAMS_BOOST_ASSERT(first != last); // precondition
