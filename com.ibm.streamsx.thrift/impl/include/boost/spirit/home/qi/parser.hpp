...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_PARSER_OCTOBER_16_2008_0254PM)
#define STREAMS_BOOST_SPIRIT_PARSER_OCTOBER_16_2008_0254PM
...
namespace streams_boost { namespace spirit { namespace traits // classification
{
    namespace detail
    {
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(parser_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(primitive_parser_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(nary_parser_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(unary_parser_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(binary_parser_id)
    }
