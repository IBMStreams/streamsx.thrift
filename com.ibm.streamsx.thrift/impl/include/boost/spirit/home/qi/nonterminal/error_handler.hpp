...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_ERROR_HANDLER_APRIL_29_2007_1042PM)
#define STREAMS_BOOST_SPIRIT_ERROR_HANDLER_APRIL_29_2007_1042PM

#if defined(_MSC_VER)
#pragma once
#endif

#include <streams_boost/spirit/home/qi/operator/expect.hpp>
#include <streams_boost/spirit/home/qi/nonterminal/rule.hpp>
#include <streams_boost/spirit/home/support/multi_pass_wrapper.hpp>
            ...
            for(;;)
            {
                ...
                catch (expectation_failure<Iterator> const& x)
                {
                    ...
                    switch (r)
                    {
                        ...
                        case rethrow: streams_boost::throw_exception(x);
                    }
                }
            }
            return false;
