...
#if !defined(STREAMS_BOOST_SPIRIT_LEXER_PARSE_NOV_17_2007_0246PM)
#define STREAMS_BOOST_SPIRIT_LEXER_PARSE_NOV_17_2007_0246PM
...
namespace streams_boost { namespace spirit { namespace lex
{
    ...
    tokenize_and_phrase_parse(Iterator& first, Iterator last
      , Lexer const& lex, ParserExpr const& xpr, Skipper const& skipper
      , STREAMS_BOOST_SCOPED_ENUM(skip_flag) post_skip, Attribute& attr)
    {
        // Report invalid expression error as early as possible.
        // If you got an error_invalid_expression error message here,
        // then the expression (expr) is not a valid spirit qi expression.
