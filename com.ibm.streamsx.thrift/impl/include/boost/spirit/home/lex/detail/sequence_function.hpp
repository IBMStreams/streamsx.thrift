...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_SEQUENCE_FUNCTION_FEB_28_2007_0249PM)
#define STREAMS_BOOST_SPIRIT_LEX_SEQUENCE_FUNCTION_FEB_28_2007_0249PM
...
namespace streams_boost { namespace spirit { namespace lex { namespace detail
{
