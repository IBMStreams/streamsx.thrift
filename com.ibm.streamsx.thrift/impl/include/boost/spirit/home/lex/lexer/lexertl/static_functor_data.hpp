...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_LEXER_STATIC_FUNCTOR_DATA_FEB_10_2008_0755PM)
#define STREAMS_BOOST_SPIRIT_LEX_LEXER_STATIC_FUNCTOR_DATA_FEB_10_2008_0755PM
...
{ 
    namespace detail
    {
          ...
          , std::size_t numstates)
        {
            ...
            {
                if (streams_boost::algorithm::equals(f(i), state))
                    return i;
            }
            return streams_boost::lexer::npos;
        }
