...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_WRAP_ACTION_APR_19_2008_0103PM)
#define STREAMS_BOOST_SPIRIT_WRAP_ACTION_APR_19_2008_0103PM
...
#include <streams_boost/spirit/home/phoenix/core/argument.hpp>
#include <streams_boost/spirit/home/phoenix/bind.hpp>
#include <streams_boost/spirit/home/phoenix/scope.hpp>
        ...
        struct wrap_action
        {
            ...
            struct phoenix_action
            {
                ...
                void operator()(phoenix::actor<Eval> const& f, Iterator& start
                  , Iterator& end, STREAMS_BOOST_SCOPED_ENUM(pass_flags)& pass
            ...
            static void arg4_action(F* f, Iterator& start, Iterator& end
              , STREAMS_BOOST_SCOPED_ENUM(pass_flags)& pass, IdType& id
              , Context const&)
            {
                f(start, end, pass, id);
            }
            ...
            static FunctionType call(void (*f)(A0, A1, A2, A3))
            {
                void (*pf)(void(*)(A0, A1, A2, A3)
                  , Iterator&, Iterator&, STREAMS_BOOST_SCOPED_ENUM(pass_flags)&
            ...
            static void arg3_action(F* f, Iterator& start, Iterator& end
              , STREAMS_BOOST_SCOPED_ENUM(pass_flags)& pass, IdType
              , Context const&)
            {
                f(start, end, pass);
            }
            ...
            static FunctionType call(void (*f)(A0, A1, A2))
            {
                void (*pf)(void(*)(A0, A1, A2), Iterator&, Iterator&
                  , STREAMS_BOOST_SCOPED_ENUM(pass_flags)&, IdType
            ...
            static void arg2_action(F* f, Iterator& start, Iterator& end
              , STREAMS_BOOST_SCOPED_ENUM(pass_flags)&, IdType, Context const&)
            {
                f (start, end);
            }
            ...
            static FunctionType call(void (*f)(A0, A1))
            {
                void (*pf)(void(*)(A0, A1), Iterator&, Iterator&
                  , STREAMS_BOOST_SCOPED_ENUM(pass_flags)&
