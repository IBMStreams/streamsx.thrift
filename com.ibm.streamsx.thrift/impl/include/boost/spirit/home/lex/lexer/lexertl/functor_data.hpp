...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_LEXER_FUNCTOR_DATA_JUN_10_2009_0954AM)
#define STREAMS_BOOST_SPIRIT_LEX_LEXER_FUNCTOR_DATA_JUN_10_2009_0954AM
...
#include <streams_boost/spirit/home/lex/lexer/lexertl/iterator_tokenizer.hpp>
#include <streams_boost/spirit/home/lex/lexer/lexertl/semantic_action_data.hpp>
#include <streams_boost/spirit/home/lex/lexer/lexertl/wrap_action.hpp>
...
// needed leading to false static asserts
            ...
            STREAMS_BOOST_SCOPED_ENUM(pass_flags) invoke_actions(std::size_t
        ...
        public:
            ...
            { 
                ...
                // definition.
                STREAMS_BOOST_ASSERT(state_id != streams_boost::lexer::npos);

                if (state_id != streams_boost::lexer::npos)
                    state_ = state_id;
            }
        ...
        public:
            ...
            STREAMS_BOOST_SCOPED_ENUM(pass_flags) invoke_actions(std::size_t state
            ...
            bool lookahead(std::size_t id)
            {
                ...
                std::size_t unique_id = streams_boost::lexer::npos;
