...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_TOKEN_DEF_MAR_13_2007_0145PM)
#define STREAMS_BOOST_SPIRIT_LEX_TOKEN_DEF_MAR_13_2007_0145PM
...
#include <streams_boost/spirit/home/qi/detail/construct.hpp>
#include <streams_boost/spirit/home/qi/detail/assign_to.hpp>
#include <streams_boost/spirit/home/lex/reference.hpp>
#include <streams_boost/spirit/home/lex/lexer_type.hpp>
    ...
    public:
          ...
          , Attribute_& attr) const
        {
            ...
            if (first != last) {
                ...
                STREAMS_BOOST_ASSERT(std::size_t(~0) != token_state_);
        ...
        void collect(LexerDef& lexdef, String const& state) const
        {
            ...
            STREAMS_BOOST_ASSERT(std::size_t(~0) == token_state_ || state_id == token_state_);
