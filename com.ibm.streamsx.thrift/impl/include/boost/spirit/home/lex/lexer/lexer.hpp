...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_LEXER_MAR_13_2007_0145PM)
#define STREAMS_BOOST_SPIRIT_LEX_LEXER_MAR_13_2007_0145PM
...
#include <streams_boost/spirit/home/lex/meta_compiler.hpp>
    ...
    namespace detail
    {
            ...
            struct adder
            {
                  ...
                  , id_type token_id = id_type()) const
                {
                    ...
                    // instance has not been assigned a different id earlier
                        STREAMS_BOOST_ASSERT(id_type() == tokdef.id() 
                                  || token_id == tokdef.id());
                        tokdef.id(token_id);
                    }
        ...
        public:
            ...
            lexer_def_& operator= (Expr const& xpr)
            {
                ...
                // expression.
                STREAMS_BOOST_SPIRIT_ASSERT_MATCH(lex::domain, Expr);
