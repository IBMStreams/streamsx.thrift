...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_LEXER_FUNCTOR_NOV_18_2007_1112PM)
#define STREAMS_BOOST_SPIRIT_LEX_LEXER_FUNCTOR_NOV_18_2007_1112PM
...
#include <streams_boost/spirit/home/lex/lexer/pass_flags.hpp>
#include <streams_boost/assert.hpp>

#if 0 != __COMO_VERSION__ || !STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1310)
#define STREAMS_BOOST_SPIRIT_STATIC_EOF 1
#define STREAMS_BOOST_SPIRIT_EOF_PREFIX static
#else
#define STREAMS_BOOST_SPIRIT_EOF_PREFIX 
#endif
...
{ 
    ...
    public:
        ...
        STREAMS_BOOST_SPIRIT_EOF_PREFIX result_type const eof;
        ...
        static result_type& get_next(MultiPass& mp, result_type& result)
        {
            ...
            for(;;) 
            {
...
#if defined(STREAMS_BOOST_SPIRIT_STATIC_EOF)
                    return result = eof;
#else
                ...
                if (streams_boost::lexer::npos == id) {   // no match
                ...
                STREAMS_BOOST_SCOPED_ENUM(pass_flags) pass = 
...
#undef STREAMS_BOOST_SPIRIT_EOF_PREFIX
#undef STREAMS_BOOST_SPIRIT_STATIC_EOF
