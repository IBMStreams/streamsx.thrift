...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_LEXERTL_GENERATE_CPP_FEB_10_2008_0855PM)
#define STREAMS_BOOST_SPIRIT_LEX_LEXERTL_GENERATE_CPP_FEB_10_2008_0855PM

#if defined(_MSC_VER)
#pragma once
#endif

#include <streams_boost/spirit/home/support/detail/lexer/char_traits.hpp>
#include <streams_boost/spirit/home/support/detail/lexer/consts.hpp>
#include <streams_boost/spirit/home/support/detail/lexer/rules.hpp>
#include <streams_boost/spirit/home/support/detail/lexer/size_t.hpp>
#include <streams_boost/spirit/home/support/detail/lexer/state_machine.hpp>
#include <streams_boost/spirit/home/support/detail/lexer/debug.hpp>
#include <streams_boost/spirit/home/lex/lexer/lexertl/static_version.hpp>
#include <streams_boost/algorithm/string.hpp>
#include <streams_boost/lexical_cast.hpp>

///////////////////////////////////////////////////////////////////////////////
namespace streams_boost { namespace spirit { namespace lex { namespace lexertl 
{
    namespace detail
    {
    ...
    inline bool 
    generate_cpp_state_info (streams_boost::lexer::basic_rules<Char> const& rules_
      , std::ostream &os_, char const* name_suffix)
    {
        ...
        typedef typename 
            streams_boost::lexer::basic_rules<Char>::string_size_t_map::const_iterator
        state_iterator;
      ...
      , bool bol, bool eol)
    {
        ...
        os_ << "    enum\n";
        os_ << "    {\n        static_version = "
            << streams_boost::lexical_cast<std::string>(SPIRIT_STATIC_LEXER_VERSION) << ",\n";
    ...
    bool generate_function_body_dfa(std::ostream & os_
      , streams_boost::lexer::basic_state_machine<Char> const &sm_) 
    {
    ...
    inline std::string get_charlit(Char ch)
    {
        ...
        streams_boost::lexer::basic_string_token<Char>::escape_char (ch, result);
        return result;
    }

    // check whether state0_0 is referenced from any of the other states
    template <typename Char>
    bool need_label0_0(streams_boost::lexer::basic_state_machine<Char> const &sm_)
    {
        typedef typename streams_boost::lexer::basic_state_machine<Char>::iterator
            iterator_type;
      ...
      , streams_boost::lexer::basic_state_machine<Char> const &sm_) 
    {
        ...
        for (std::size_t dfa_ = 0; dfa_ < dfas_; ++dfa_)
        {
            ...
            for (std::size_t state_ = 0; state_ < states_; ++state_)
            {
                ...
                if (t_ < transitions_ || 
                    iter_->bol_index != streams_boost::lexer::npos ||
                    iter_->eol_index != streams_boost::lexer::npos)
                {
                    os_ << "    if (curr_ == end_) goto end;\n";
                    os_ << "    ch_ = *curr_;\n";
                    if (iter_->bol_index != streams_boost::lexer::npos)
                    {
                        os_ << "\n    if (bol) goto state" << dfa_ << '_' 
                            << iter_->bol_index << ";\n";
                    }
                    if (iter_->eol_index != streams_boost::lexer::npos)
                    {
                        os_ << "\n    if (ch_ == '\n') goto state" << dfa_ 
                            << '_' << iter_->eol_index << ";\n";
                    }
    ...
    inline bool 
    generate_cpp (streams_boost::lexer::basic_state_machine<Char> const& sm_
      , streams_boost::lexer::basic_rules<Char> const& rules_
      , std::ostream &os_, char const* name_suffix, F generate_function_body)
    {
        ...
        os_ << "// Auto-generated by streams_boost::lexer, do not edit\n\n";
        ...
        streams_boost::to_upper(guard);

        os_ << "#if !defined(STREAMS_BOOST_SPIRIT_LEXER_NEXT_TOKEN_" << guard << ")\n";
        os_ << "#define STREAMS_BOOST_SPIRIT_LEXER_NEXT_TOKEN_" << guard << "\n\n";

        os_ << "#include <streams_boost/detail/iterator.hpp>\n";
        os_ << "#include <streams_boost/spirit/home/support/detail/lexer/char_traits.hpp>\n\n";

        generate_delimiter(os_);
        os_ << "// the generated table of state names and the tokenizer have to be\n"
               "// defined in the streams_boost::spirit::lex::lexertl::static_ namespace\n";
        os_ << "namespace streams_boost { namespace spirit { namespace lex { "
        ...
        os_ << "}}}}}  // namespace streams_boost::spirit::lex::lexertl::static_\n\n";
