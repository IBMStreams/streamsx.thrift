...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_LEXER_SEMANTIC_ACTION_DATA_JUN_10_2009_0417PM)
#define STREAMS_BOOST_SPIRIT_LEX_LEXER_SEMANTIC_ACTION_DATA_JUN_10_2009_0417PM
    ...
    namespace detail
    {
        ...
        struct semantic_actions<Iterator, mpl::false_, Data>
        {
            typedef void functor_type(Iterator&, Iterator&
              , STREAMS_BOOST_SCOPED_ENUM(pass_flags)&, std::size_t&, Data&);
            typedef streams_boost::function<functor_type> functor_wrapper_type;
              ...
              , Data& data) const
            {
                ...
                //       action
                STREAMS_BOOST_SCOPED_ENUM(pass_flags) match = pass_flags::pass_normal;
