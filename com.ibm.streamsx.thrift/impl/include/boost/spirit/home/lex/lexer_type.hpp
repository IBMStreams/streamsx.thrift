...
#if !defined(STREAMS_BOOST_SPIRIT_LEXER_TYPE_APR_20_2009_0759PM)
#define STREAMS_BOOST_SPIRIT_LEXER_TYPE_APR_20_2009_0759PM
...
#include <streams_boost/spirit/home/lex/domain.hpp>
...
namespace streams_boost { namespace spirit { namespace traits // classification
{
    namespace detail
    {
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(lexer_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(primitive_lexer_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(unary_lexer_id)
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(nary_lexer_id)
    }
