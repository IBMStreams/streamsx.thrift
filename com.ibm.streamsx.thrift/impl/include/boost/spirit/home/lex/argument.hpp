...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_ARGUMENT_JUNE_07_2009_1106AM)
#define STREAMS_BOOST_SPIRIT_LEX_ARGUMENT_JUNE_07_2009_1106AM
...
#include <streams_boost/spirit/home/phoenix/operator/self.hpp>
...
namespace streams_boost { namespace spirit { namespace lex
{
    ...
    // definition).
    using streams_boost::spirit::_pass;
