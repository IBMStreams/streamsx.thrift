...
#if !defined(STREAMS_BOOST_SPIRIT_LEX_STATE_SWITCHER_SEP_23_2007_0714PM)
#define STREAMS_BOOST_SPIRIT_LEX_STATE_SWITCHER_SEP_23_2007_0714PM
...
namespace streams_boost { namespace spirit { namespace qi
{
    ...
    namespace detail
    {
        ...
        set_lexer_state(Iterator& it, Char const* statename)
        {
            ...
            STREAMS_BOOST_ASSERT(std::size_t(~0) != state);
            return it.set_state(state);
        }
    }
