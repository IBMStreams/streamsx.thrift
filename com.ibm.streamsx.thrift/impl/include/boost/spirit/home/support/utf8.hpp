...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_UC_TYPES_NOVEMBER_23_2008_0840PM)
#define STREAMS_BOOST_SPIRIT_UC_TYPES_NOVEMBER_23_2008_0840PM
...
{
    typedef ::streams_boost::uint32_t ucs4_char;
    ...
    to_utf8(std::basic_string<Char, Traits, Allocator> const& str)
    {
        ...
        utf8_output_iterator<insert_iter> utf8_iter(out_iter);
        typedef typename make_unsigned<Char>::type UChar;
        STREAMS_BOOST_FOREACH(Char ch, str)
        {
            *utf8_iter++ = (UChar)ch;
        }
        return result;
