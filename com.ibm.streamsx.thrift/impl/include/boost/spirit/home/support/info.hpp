...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_INFO_NOVEMBER_22_2008_1132AM)
#define STREAMS_BOOST_SPIRIT_INFO_NOVEMBER_22_2008_1132AM
...
#include <streams_boost/variant/recursive_variant.hpp>
#include <streams_boost/variant/apply_visitor.hpp>
...
namespace streams_boost { namespace spirit
{
    ...
    struct basic_info_walker
    {
        ...
        {
            callback.element(tag, "", depth);
            STREAMS_BOOST_FOREACH(info const& what, l)
            {
                streams_boost::apply_visitor(
                    this_type(callback, what.tag, depth+1), what.value);
            }
    ...
    Out& operator<<(Out& out, info const& what)
    {
        ...
        streams_boost::apply_visitor(walker, what.value);
        return out;
    }
}}
