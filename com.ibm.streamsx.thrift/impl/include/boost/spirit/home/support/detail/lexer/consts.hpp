...
#ifndef STREAMS_BOOST_LEXER_CONSTS_H
#define STREAMS_BOOST_LEXER_CONSTS_H
...
namespace lexer
{
    ...
    const std::size_t num_wchar_ts =
        (streams_boost::integer_traits<wchar_t>::const_max < 0x110000) ?
        streams_boost::integer_traits<wchar_t>::const_max + 1 : 0x110000;
