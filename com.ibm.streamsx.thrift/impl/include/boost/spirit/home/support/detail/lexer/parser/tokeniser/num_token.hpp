...
#ifndef STREAMS_BOOST_LEXER_NUM_TOKEN_HPP
#define STREAMS_BOOST_LEXER_NUM_TOKEN_HPP
...
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_INTEL_CXX_VERSION, STREAMS_BOOST_TESTED_AT(910))
