...
#ifndef STREAMS_BOOST_SPIRIT_MATH_FPCLASSIFY_HPP
#define STREAMS_BOOST_SPIRIT_MATH_FPCLASSIFY_HPP
...
template<class T> bool (isinf)(T x)
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::isinf_impl(x, STREAMS_BOOST_DEDUCED_TYPENAME traits::coverage());
}
...
template<class T> bool (isnan)(T x)
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::isnan_impl(x, STREAMS_BOOST_DEDUCED_TYPENAME traits::coverage());
}
...
template<class T> int (fpclassify)(T x)
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::fpclassify_impl(x, STREAMS_BOOST_DEDUCED_TYPENAME traits::coverage());
}
