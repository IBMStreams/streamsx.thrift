...
//  See http://www.streams_boost.org/LICENSE_1_0.txt

//  See library home page at http://www.streams_boost.org/libs/endian
...
#ifndef STREAMS_BOOST_SPIRIT_ENDIAN_HPP
#define STREAMS_BOOST_SPIRIT_ENDIAN_HPP

#if defined(_MSC_VER)
#pragma once
#endif

#ifdef STREAMS_BOOST_ENDIAN_LOG
# include <iostream>
#endif
...
#define STREAMS_BOOST_MINIMAL_INTEGER_COVER_OPERATORS
#define STREAMS_BOOST_NO_IO_COVER_OPERATORS
#include <streams_boost/spirit/home/support/detail/integer/cover_operators.hpp>
#undef  STREAMS_BOOST_NO_IO_COVER_OPERATORS
#undef  STREAMS_BOOST_MINIMAL_INTEGER_COVER_OPERATORS
...
# define STREAMS_BOOST_ENDIAN_DEFAULT_CONSTRUCT {}          // C++03

# if defined(STREAMS_BOOST_ENDIAN_FORCE_PODNESS)
#   define STREAMS_BOOST_ENDIAN_NO_CTORS
# endif
...
namespace streams_boost
{
  namespace detail
  {
    ...
    template <typename T, std::size_t n_bytes,
      bool sign=streams_boost::is_signed<T>::value >
...
# endif
  ...
  STREAMS_BOOST_SCOPED_ENUM_START(endianness) { big, little, native }; STREAMS_BOOST_SCOPED_ENUM_END
  STREAMS_BOOST_SCOPED_ENUM_START(alignment) { unaligned, aligned }; STREAMS_BOOST_SCOPED_ENUM_END

  template <STREAMS_BOOST_SCOPED_ENUM(endianness) E, typename T, std::size_t n_bits,
    STREAMS_BOOST_SCOPED_ENUM(alignment) A = alignment::unaligned>
    class endian;
    ...
    {
        STREAMS_BOOST_STATIC_ASSERT( (n_bits/8)*8 == n_bits );
      public:
        typedef T value_type;
#     ifndef STREAMS_BOOST_ENDIAN_NO_CTORS
        endian() STREAMS_BOOST_ENDIAN_DEFAULT_CONSTRUCT
...
#   ifndef STREAMS_BOOST_ENDIAN_NO_CTORS
        endian() STREAMS_BOOST_ENDIAN_DEFAULT_CONSTRUCT
#     ifdef STREAMS_BOOST_BIG_ENDIAN
...
#   endif
    ...
    {
        STREAMS_BOOST_STATIC_ASSERT( (n_bits/8)*8 == n_bits );
        STREAMS_BOOST_STATIC_ASSERT( sizeof(T) == n_bits/8 );
      public:
        typedef T value_type;
#   ifndef STREAMS_BOOST_ENDIAN_NO_CTORS
        endian() STREAMS_BOOST_ENDIAN_DEFAULT_CONSTRUCT
...
#   ifndef STREAMS_BOOST_ENDIAN_NO_CTORS
        endian() STREAMS_BOOST_ENDIAN_DEFAULT_CONSTRUCT
#     ifdef STREAMS_BOOST_LITTLE_ENDIAN
        endian(T val) : m_value(val) { }
#     else
...
#define STREAMS_BOOST_HAS_INT16_T
#define STREAMS_BOOST_HAS_INT32_T
#define STREAMS_BOOST_HAS_INT64_T
...
# if defined(STREAMS_BOOST_HAS_INT16_T)
...
# if defined(STREAMS_BOOST_HAS_INT32_T)
...
# if defined(STREAMS_BOOST_HAS_INT64_T)
...
#endif // STREAMS_BOOST_SPIRIT_ENDIAN_HPP
