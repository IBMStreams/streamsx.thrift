...
=============================================================================*/
#ifndef STREAMS_BOOST_SPIRIT_MAKE_CONS_OCTOBER_16_2008_1252PM
#define STREAMS_BOOST_SPIRIT_MAKE_CONS_OCTOBER_16_2008_1252PM
...
namespace streams_boost { namespace spirit { namespace detail
{
    ...
    // description: http://lists.streams_boost.org/Archives/streams_boost/2009/04/150743.php
    template <typename Car>
    fusion::cons<typename as_meta_element<Car>::type>
