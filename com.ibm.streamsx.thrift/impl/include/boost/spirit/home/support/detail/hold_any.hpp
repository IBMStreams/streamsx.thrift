/*=============================================================================
    ...
    The class streams_boost::spirit::hold_any is built based on the any class
    published here: http://www.codeproject.com/cpp/dynamic_typing.asp. It adds
    support for std streaming operator<<() and operator>>().
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_HOLD_ANY_MAY_02_2007_0857AM)
#define STREAMS_BOOST_SPIRIT_HOLD_ANY_MAY_02_2007_0857AM
...
// implicit casting is disabled by default for compatibility with streams_boost::any
#ifdef STREAMS_BOOST_SPIRIT_ANY_IMPLICIT_CASTING
    ...
    // streams_boost::any-like casting
    template <typename T>
    ...
    {
        typedef STREAMS_BOOST_DEDUCED_TYPENAME remove_reference<T>::type nonref;
        ...
        if(!result)
            streams_boost::throw_exception(bad_any_cast(operand.type(), typeid(T)));
        return *result;
    }
