...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_UNUSED_APRIL_16_2006_0616PM)
#define STREAMS_BOOST_SPIRIT_UNUSED_APRIL_16_2006_0616PM
...
#if !defined(STREAMS_BOOST_FUSION_UNUSED_HAS_IO)
...
{
    ///////////////////////////////////////////////////////////////////////////
    // since streams_boost::fusion now supports exactly what we need, unused is simply
    // imported from the fusion namespace
    ///////////////////////////////////////////////////////////////////////////
    using streams_boost::fusion::unused_type;
    using streams_boost::fusion::unused;
