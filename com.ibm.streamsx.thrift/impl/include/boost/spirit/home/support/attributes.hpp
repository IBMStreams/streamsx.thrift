...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_ATTRIBUTES_JANUARY_29_2007_0954AM)
#define STREAMS_BOOST_SPIRIT_ATTRIBUTES_JANUARY_29_2007_0954AM
...
#include <streams_boost/spirit/home/support/attributes_fwd.hpp>
#include <streams_boost/spirit/home/support/detail/as_variant.hpp>
#include <streams_boost/optional/optional.hpp>
#include <streams_boost/fusion/include/transform.hpp>
#include <streams_boost/fusion/include/filter_if.hpp>
#include <streams_boost/fusion/include/as_vector.hpp>
#include <streams_boost/fusion/include/push_front.hpp>
#include <streams_boost/fusion/include/pop_front.hpp>
#include <streams_boost/fusion/include/is_sequence.hpp>
...
namespace streams_boost { namespace spirit { namespace traits
{
    ...
    struct not_is_variant<streams_boost::variant<STREAMS_BOOST_VARIANT_ENUM_PARAMS(T)> >
      : mpl::false_ 
    {};

    template <typename T>
    struct not_is_variant<streams_boost::optional<T> >
      : not_is_variant<T>
    {};
    ...
    template <typename T>
    struct variant_type<streams_boost::optional<T> >
      : variant_type<T>
    {};
    ...
    template <typename T>
    struct not_is_optional<streams_boost::optional<T> >
      : mpl::false_ 
    {};
    ...
    // build_optional
    //
    // Build a streams_boost::optional from T. Return unused_type if T is unused_type.
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    ...
    // build_variant
    //
    // Build a streams_boost::variant from a fusion sequence. build_variant makes sure
    ...
    pre_transform(Exposed& attr STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(Exposed))
    {
    ...
    struct make_attribute
    {
        ...
        static Attribute call(unused_type)
        {
            ...
            return streams_boost::get(value_initialized<Attribute>());
        }
    ...
    // variants
    template <STREAMS_BOOST_VARIANT_ENUM_PARAMS(typename T)>
    struct clear_value<variant<STREAMS_BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        static void call(variant<STREAMS_BOOST_VARIANT_ENUM_PARAMS(T)>& val)
        {
