...
#if !defined(STREAMS_BOOST_SPIRIT_SUPPORT_META_CREATE_NOV_21_2009_0327PM)
#define STREAMS_BOOST_SPIRIT_SUPPORT_META_CREATE_NOV_21_2009_0327PM
...
// problems with the following template specialization
            ...
            {
                STREAMS_BOOST_STATIC_ASSERT((is_same<F, nary_proto_expr_function>::value));
#else
