...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_STANDARD_WIDE_NOVEMBER_10_2006_0913AM)
#define STREAMS_BOOST_SPIRIT_STANDARD_WIDE_NOVEMBER_10_2006_0913AM
...
namespace streams_boost { namespace spirit { namespace traits
{
    ...
    struct wchar_t_size
    {
        STREAMS_BOOST_SPIRIT_ASSERT_MSG(N == 1 || N == 2 || N == 4,
...
namespace streams_boost { namespace spirit { namespace char_encoding
{
    ...
    struct standard_wide
    {
        ...
        static bool
        isblank STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION (wchar_t ch)
        {
            return (ch == L' ' || ch == L'\t');
        }
