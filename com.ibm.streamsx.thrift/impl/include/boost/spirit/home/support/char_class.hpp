...
=============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_CHAR_CLASS_NOVEMBER_10_2006_0907AM)
#define STREAMS_BOOST_SPIRIT_CHAR_CLASS_NOVEMBER_10_2006_0907AM
...
namespace streams_boost { namespace spirit { namespace tag
{
    struct char_ {};
    struct string {};
...
namespace streams_boost { namespace spirit { namespace char_class
{
    ///////////////////////////////////////////////////////////////////////////
    ...
    struct classify
    {
        ...
        is(tag::blank, Char ch)
        {
            return CharEncoding::isblank
                STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION (char_type(ch));
        }
