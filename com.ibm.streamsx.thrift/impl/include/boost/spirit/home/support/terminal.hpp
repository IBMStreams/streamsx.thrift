...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_TERMINAL_NOVEMBER_04_2008_0906AM)
#define STREAMS_BOOST_SPIRIT_TERMINAL_NOVEMBER_04_2008_0906AM

#if defined(_MSC_VER)
#pragma once
#endif

#include <streams_boost/proto/proto.hpp>
#include <streams_boost/fusion/include/unused.hpp>
#include <streams_boost/fusion/include/void.hpp>
#include <streams_boost/spirit/include/phoenix_core.hpp>
#include <streams_boost/spirit/include/phoenix_function.hpp>
#include <streams_boost/spirit/home/support/meta_compiler.hpp>
#include <streams_boost/spirit/home/support/detail/make_vector.hpp>
...
// Common placeholders are placed in the main streams_boost::spirit namespace
// (see common_terminals.hpp)

#define STREAMS_BOOST_SPIRIT_TERMINAL(name)                                             \
    namespace tag { struct name {};  }                                          \
    typedef streams_boost::proto::terminal<tag::name>::type name##_type;                \
    name##_type const name = {{}};                                              \
    inline void silence_unused_warnings__##name() { (void) name; }              \
    /***/

#define STREAMS_BOOST_SPIRIT_DEFINE_TERMINALS_A(r, _, name)                             \
    STREAMS_BOOST_SPIRIT_TERMINAL(name)                                                 \
    /***/

#define STREAMS_BOOST_SPIRIT_DEFINE_TERMINALS(seq)                                      \
    STREAMS_BOOST_PP_SEQ_FOR_EACH(STREAMS_BOOST_SPIRIT_DEFINE_TERMINALS_A, _, seq)              \
    /***/
...
#define STREAMS_BOOST_SPIRIT_TERMINAL_EX(name)                                          \
    namespace tag { struct name {}; }                                           \
    typedef streams_boost::spirit::terminal<tag::name> name##_type;                     \
    name##_type const name = name##_type();                                     \
    inline void silence_unused_warnings__##name() { (void) name; }              \
    /***/

#define STREAMS_BOOST_SPIRIT_DEFINE_TERMINALS_EX_A(r, _, name)                          \
    STREAMS_BOOST_SPIRIT_TERMINAL_EX(name)                                              \
    /***/

#define STREAMS_BOOST_SPIRIT_DEFINE_TERMINALS_EX(seq)                                   \
    STREAMS_BOOST_PP_SEQ_FOR_EACH(STREAMS_BOOST_SPIRIT_DEFINE_TERMINALS_EX_A, _, seq)           \
    /***/
