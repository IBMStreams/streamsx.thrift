...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_CONTEXT_OCTOBER_31_2008_0654PM)
#define STREAMS_BOOST_SPIRIT_CONTEXT_OCTOBER_31_2008_0654PM
...
#include <streams_boost/spirit/home/support/nonterminal/expand_arg.hpp>
...
#define SPIRIT_DECLARE_ATTRIBUTE(z, n, data)                                    \
    phoenix::actor<attribute<n> > const                                         \
        STREAMS_BOOST_PP_CAT(_r, n) = attribute<n>();

#define SPIRIT_USING_ATTRIBUTE(z, n, data) using spirit::STREAMS_BOOST_PP_CAT(_r, n);
...
namespace streams_boost { namespace spirit
{
    ...
    namespace labels
    {
        STREAMS_BOOST_PP_REPEAT(SPIRIT_ARGUMENTS_LIMIT, SPIRIT_USING_ARGUMENT, _)
