...
==============================================================================*/
#if !defined(STREAMS_BOOST_SPIRIT_RANGE_RUN_MAY_16_2006_0807_PM)
#define STREAMS_BOOST_SPIRIT_RANGE_RUN_MAY_16_2006_0807_PM

#if defined(_MSC_VER)
#pragma once
#endif

#include <streams_boost/spirit/home/support/char_set/range_functions.hpp>
...
namespace streams_boost { namespace spirit { namespace support { namespace detail
{
    ...
    {
        STREAMS_BOOST_ASSERT(is_valid(range));
        if (run.empty())
        {
