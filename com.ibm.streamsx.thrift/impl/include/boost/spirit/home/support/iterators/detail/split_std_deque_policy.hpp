...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_SPLIT_DEQUE_POLICY_APR_06_2008_0138PM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_SPLIT_DEQUE_POLICY_APR_06_2008_0138PM
    ...
    struct split_std_deque
    {
        ...
        protected:
            ...
            dereference(MultiPass const& mp)
            {
                ...
                STREAMS_BOOST_ASSERT(mp.queued_position <= size);
