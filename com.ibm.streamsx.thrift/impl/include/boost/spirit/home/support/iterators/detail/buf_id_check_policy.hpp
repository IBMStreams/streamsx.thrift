...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_BUF_ID_CHECK_POLICY_MAR_16_2007_1108AM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_BUF_ID_CHECK_POLICY_MAR_16_2007_1108AM
...
namespace streams_boost { namespace spirit { namespace iterator_policies
{
    ...
    public:
        ...
        { 
            return "streams_boost::spirit::multi_pass::illegal_backtracking"; 
        }
    };
