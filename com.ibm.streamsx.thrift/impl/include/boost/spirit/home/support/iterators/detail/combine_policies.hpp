...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_COMBINE_POLICIES_APR_06_2008_0136PM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_COMBINE_POLICIES_APR_06_2008_0136PM
...
namespace streams_boost { namespace spirit { namespace iterator_policies
{
    ...
    template <typename T
      ...
      , bool OwnershipIsEmpty = streams_boost::is_empty<Ownership>::value
      , bool CheckingIsEmpty = streams_boost::is_empty<Checking>::value
      , bool InputIsEmpty = streams_boost::is_empty<Input>::value>
    struct multi_pass_unique;
    ...
    struct default_policy
    {
        ...
        struct unique : multi_pass_unique<T
          ...
          , typename Input::STREAMS_BOOST_NESTED_TEMPLATE unique<T>
          , typename Storage::STREAMS_BOOST_NESTED_TEMPLATE unique<
                typename Input::STREAMS_BOOST_NESTED_TEMPLATE unique<T>::value_type> >
        {
            typedef typename Ownership::unique ownership_policy;
            typedef typename Checking::unique checking_policy;
            typedef typename Input::STREAMS_BOOST_NESTED_TEMPLATE unique<T> 
                input_policy;
            typedef typename Storage::STREAMS_BOOST_NESTED_TEMPLATE unique<
        ...
        struct shared : multi_pass_shared<T
          ...
          , typename Input::STREAMS_BOOST_NESTED_TEMPLATE shared<T>
          , typename Storage::STREAMS_BOOST_NESTED_TEMPLATE shared<
                typename Input::STREAMS_BOOST_NESTED_TEMPLATE unique<T>::value_type> > 
        {
            typedef typename Ownership::shared ownership_policy;
            typedef typename Checking::shared checking_policy;
            typedef typename Input::STREAMS_BOOST_NESTED_TEMPLATE shared<T> 
                input_policy;
            typedef typename Storage::STREAMS_BOOST_NESTED_TEMPLATE shared<
                typename Input::STREAMS_BOOST_NESTED_TEMPLATE unique<T>::value_type> 
            storage_policy;
