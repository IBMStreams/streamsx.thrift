...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_FIXED_SIZE_QUEUE_POLICY_MAR_16_2007_1134AM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_FIXED_SIZE_QUEUE_POLICY_MAR_16_2007_1134AM

#include <streams_boost/spirit/home/support/iterators/detail/multi_pass.hpp>
#include <streams_boost/spirit/home/support/iterators/detail/fixed_size_queue.hpp>
...
namespace streams_boost { namespace spirit { namespace iterator_policies
{
    ...
    //  streams_boost::spirit::fixed_size_queue class) that is size N+1 and stores N 
    //  elements.
    // 
