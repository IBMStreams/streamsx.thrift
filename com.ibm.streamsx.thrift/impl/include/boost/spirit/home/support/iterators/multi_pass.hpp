...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_MULTI_PASS_MAR_16_2007_1124AM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_MULTI_PASS_MAR_16_2007_1124AM
...
namespace streams_boost { namespace spirit 
{
    ...
    class multi_pass 
      : private streams_boost::base_from_member<
            typename Policies::STREAMS_BOOST_NESTED_TEMPLATE shared<T>*>
      , public Policies::STREAMS_BOOST_NESTED_TEMPLATE unique<T>
    ...
    private:
        ...
        typedef typename Policies::STREAMS_BOOST_NESTED_TEMPLATE unique<T> 
            policies_base_type;
        typedef typename Policies::STREAMS_BOOST_NESTED_TEMPLATE shared<T> 
            shared_data_type;

        typedef streams_boost::base_from_member<shared_data_type*> member_base;
    ...
    public:
        ...
        void clear_queue(STREAMS_BOOST_SCOPED_ENUM(traits::clear_mode) mode = 
    ...
    namespace traits
    {
        ...
        void clear_queue(multi_pass<T, Policies>& mp
          , STREAMS_BOOST_SCOPED_ENUM(traits::clear_mode) mode)
        {
            mp.clear_queue(mode);
        }
