...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_REF_COUNTED_POLICY_MAR_16_2007_1108AM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_REF_COUNTED_POLICY_MAR_16_2007_1108AM
...
#if defined(STREAMS_BOOST_HAS_THREADS)
            streams_boost::detail::atomic_count count;
#else
            std::size_t count;
#endif
        };
