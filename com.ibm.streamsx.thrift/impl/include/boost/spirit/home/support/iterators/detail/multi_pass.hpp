...
#if !defined(STREAMS_BOOST_SPIRIT_ITERATOR_MULTI_PASS_MAR_16_2007_1122AM)
#define STREAMS_BOOST_SPIRIT_ITERATOR_MULTI_PASS_MAR_16_2007_1122AM
...
namespace streams_boost { namespace spirit { namespace detail
{
    ...
    {
        using std::swap;
        using streams_boost::spirit::swap;
        swap(t1, t2);
    }
    ...
    //
    //  We are using streams_boost::iterator<> because it offers an automatic 
    //  workaround for broken std::iterator<> implementations.
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, typename InputPolicy>
    struct iterator_base_creator
    {
        typedef typename InputPolicy::STREAMS_BOOST_NESTED_TEMPLATE unique<T> input_type;
