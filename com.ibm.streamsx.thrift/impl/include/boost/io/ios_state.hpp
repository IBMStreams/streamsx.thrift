...
#ifndef STREAMS_BOOST_IO_IOS_STATE_HPP
#define STREAMS_BOOST_IO_IOS_STATE_HPP

#include <streams_boost/io_fwd.hpp>  // self include
...
#endif  // STREAMS_BOOST_IO_IOS_STATE_HPP
