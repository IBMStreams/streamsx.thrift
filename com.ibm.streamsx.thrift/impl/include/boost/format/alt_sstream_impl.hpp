...
#ifndef STREAMS_BOOST_SK_ALT_SSTREAM_IMPL_HPP
#define STREAMS_BOOST_SK_ALT_SSTREAM_IMPL_HPP
...
// --- Implementation  ------------------------------------------------------//
        ...
        seekpos (pos_type pos, ::std::ios_base::openmode which) {
            ...
            if(off != off_type(-1)) {
                ...
                STREAMS_BOOST_ASSERT(0); // §27.4.3.2 allows undefined-behaviour here
                return pos_type(off_type(-1));
            }
        }
        // -end seekpos(..)
