// ----------------------------------------------------------------------------
// streams_boost/format/exceptions.hpp 
// ----------------------------------------------------------------------------
...
#ifndef STREAMS_BOOST_FORMAT_EXCEPTIONS_HPP
#define STREAMS_BOOST_FORMAT_EXCEPTIONS_HPP
...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "streams_boost::format_error: "
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "streams_boost::bad_format_string: format-string is ill-formed";
            }
        };
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "streams_boost::too_few_args: "
        ...
        public:
            ...
            std::size_t get_expected() const { return expected_; }
            virtual const char *what() const throw() {
                return "streams_boost::too_many_args: "
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "streams_boost::out_of_range: "
...
#endif // STREAMS_BOOST_FORMAT_EXCEPTIONS_HPP
