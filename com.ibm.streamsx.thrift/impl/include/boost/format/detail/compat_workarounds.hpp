...
#ifndef STREAMS_BOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
#define STREAMS_BOOST_FORMAT_COMPAT_WORKAROUNDS_HPP
...
#include <streams_boost/format/detail/config_macros.hpp>
   // sets-up macros and load compiler-specific workarounds headers.

#if !defined(STREAMS_BOOST_FORMAT_STREAMBUF_DEFINED)
// workarounds-gcc-2.95 might have defined own streambuf
#include <streambuf>
#endif

#if !defined(STREAMS_BOOST_FORMAT_OSTREAM_DEFINED)
