...
#ifndef STREAMS_BOOST_FORMAT_WORKAROUNDS_GCC295_H
#define STREAMS_BOOST_FORMAT_WORKAROUNDS_GCC295_H

// SGI STL doesnt have <ostream> and others, so we need iostream.
#include <iostream> 
#define STREAMS_BOOST_FORMAT_OSTREAM_DEFINED

#include <streambuf.h>
#define STREAMS_BOOST_FORMAT_STREAMBUF_DEFINED

#define STREAMS_BOOST_NO_TEMPLATE_STD_STREAM
