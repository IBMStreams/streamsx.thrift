...
#ifndef STREAMS_BOOST_FORMAT_FWD_HPP
#define STREAMS_BOOST_FORMAT_FWD_HPP
...
namespace streams_boost {
    ...
    // gcc-2.95's native  stdlid needs special treatment
        class Tr = STREAMS_BOOST_IO_STD char_traits<Ch>, class Alloc = std::allocator<Ch> > 
#else
...
#if !defined(STREAMS_BOOST_NO_STD_WSTRING)  && !defined(STREAMS_BOOST_NO_STD_WSTREAMBUF) \
    && !defined(STREAMS_BOOST_FORMAT_IGNORE_STRINGSTREAM)
...
#endif // STREAMS_BOOST_FORMAT_FWD_HPP
