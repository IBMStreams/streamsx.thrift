...
#ifndef STREAMS_BOOST_FORMAT_GROUP_HPP
#define STREAMS_BOOST_FORMAT_GROUP_HPP
...
inline
STREAMS_BOOST_IO_STD basic_ostream<Ch, Tr>&
operator << ( STREAMS_BOOST_IO_STD basic_ostream<Ch, Tr>& os,
             const group0& )
{ 
   return os; 
}
...
#endif  // - STREAMS_BOOST_NO_OVERLOAD_FOR_NON_CONST
...
#endif   // STREAMS_BOOST_FORMAT_GROUP_HPP
