...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_PTREE_FWD_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_PTREE_FWD_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree
{
    ...
    concept PropertyTreeTranslator<class Tr> {
        ...
        streams_boost::optional<external_type> Tr::get_value(internal_type);
        streams_boost::optional<internal_type> Tr::put_value(external_type);
    }
#endif
...
#   define STREAMS_BOOST_PROPERTY_TREE_THROW(e) { throw_exception(e); std::exit(1); }
#endif
