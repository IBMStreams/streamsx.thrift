...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_XML_PARSER_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_XML_PARSER_HPP_INCLUDED

#include <streams_boost/property_tree/ptree.hpp>
#include <streams_boost/property_tree/detail/xml_parser_write.hpp>
#include <streams_boost/property_tree/detail/xml_parser_error.hpp>
#include <streams_boost/property_tree/detail/xml_parser_writer_settings.hpp>
#include <streams_boost/property_tree/detail/xml_parser_flags.hpp>
#include <streams_boost/property_tree/detail/xml_parser_read_rapidxml.hpp>
...
namespace streams_boost { namespace property_tree { namespace xml_parser
{
    ...
    {
        STREAMS_BOOST_ASSERT(validate_flags(flags));
        std::basic_ifstream<typename Ptree::key_type::value_type>
            stream(filename.c_str());
        if (!stream)
            STREAMS_BOOST_PROPERTY_TREE_THROW(xml_parser_error(
