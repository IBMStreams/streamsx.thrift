...
#ifndef STREAMS_BOOST_PROPERTY_TREE_EXCEPTIONS_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_EXCEPTIONS_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree
{
    ...
    private:
        streams_boost::any m_path;
    };

}}

#include <streams_boost/property_tree/detail/exception_implementation.hpp>
