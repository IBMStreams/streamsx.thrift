...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_PTREE_SERIALIZATION_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_PTREE_SERIALIZATION_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    // streams_boost::serialization support
     ...
     *       library's @c streams_boost::property_tree::xml_parser::write_xml.
     ...
     *       streams_boost::property_tree::save.
