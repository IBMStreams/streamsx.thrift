...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_INFO_PARSER_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_INFO_PARSER_HPP_INCLUDED

#include <streams_boost/property_tree/ptree.hpp>
#include <streams_boost/property_tree/detail/info_parser_error.hpp>
#include <streams_boost/property_tree/detail/info_parser_writer_settings.hpp>
#include <streams_boost/property_tree/detail/info_parser_read.hpp>
#include <streams_boost/property_tree/detail/info_parser_write.hpp>
#include <istream>
