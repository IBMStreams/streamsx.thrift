...
#ifndef STREAMS_BOOST_PROPERTY_TREE_PTREE_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_PTREE_HPP_INCLUDED

#include <streams_boost/property_tree/ptree_fwd.hpp>
#include <streams_boost/property_tree/string_path.hpp>
#include <streams_boost/property_tree/stream_translator.hpp>
#include <streams_boost/property_tree/exceptions.hpp>
...
namespace streams_boost { namespace property_tree
{
    ...
    class basic_ptree
    {
#if defined(STREAMS_BOOST_PROPERTY_TREE_DOXYGEN_INVOKED)
    public:
#endif
        // Internal types
        /**
    ...
    public:
        ...
        /** Equivalent to erase(streams_boost::prior(end())). */
        void pop_back();
        ...
        /** Get the child at the given path, or return streams_boost::null. */
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the supplied translator. Return streams_boost::null if
         * this fails.
         */
        template<class Type, class Translator>
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the default translator. Return streams_boost::null if
         * this fails.
         */
        template<class Type>
...
#include <streams_boost/property_tree/detail/ptree_implementation.hpp>
