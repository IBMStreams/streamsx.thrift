...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_JSON_PARSER_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_JSON_PARSER_HPP_INCLUDED

#include <streams_boost/property_tree/ptree.hpp>
#include <streams_boost/property_tree/detail/json_parser_read.hpp>
#include <streams_boost/property_tree/detail/json_parser_write.hpp>
...
namespace streams_boost { namespace property_tree { namespace json_parser
{
                   ...
                   const std::locale &loc = std::locale())
    {
        ...
        if (!stream)
            STREAMS_BOOST_PROPERTY_TREE_THROW(json_parser_error(
