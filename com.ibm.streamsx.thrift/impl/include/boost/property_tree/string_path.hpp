...
#ifndef STREAMS_BOOST_PROPERTY_TREE_STRING_PATH_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_STRING_PATH_HPP_INCLUDED

#include <streams_boost/property_tree/ptree_fwd.hpp>
#include <streams_boost/property_tree/id_translator.hpp>
...
namespace streams_boost { namespace property_tree
{
    ...
    class string_path
    {
        STREAMS_BOOST_STATIC_ASSERT((is_same<String,
    ...
    typename Translator::external_type string_path<String, Translator>::reduce()
    {
        ...
        STREAMS_BOOST_PROPERTY_TREE_THROW(ptree_bad_path("Path syntax error", *this));
    }
