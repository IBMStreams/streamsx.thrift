...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_INI_PARSER_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_INI_PARSER_HPP_INCLUDED

#include <streams_boost/property_tree/ptree.hpp>
#include <streams_boost/property_tree/detail/ptree_utils.hpp>
#include <streams_boost/property_tree/detail/file_parser_error.hpp>
#include <fstream>
#include <string>
#include <sstream>
#include <stdexcept>
...
namespace streams_boost { namespace property_tree { namespace ini_parser
{
                  ...
                  Ptree &pt)
    {
        ...
        while (stream.good())
        {
            ...
            if (!stream.good() && !stream.eof())
                STREAMS_BOOST_PROPERTY_TREE_THROW(ini_parser_error(
                    "read error", "", line_no));
