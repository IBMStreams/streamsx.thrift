...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_DETAIL_PTREE_UTILS_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_DETAIL_PTREE_UTILS_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree { namespace detail
{
    ...
    struct is_character : public streams_boost::false_type {};
    template <>
    struct is_character<char> : public streams_boost::true_type {};
    template <>
    struct is_character<wchar_t> : public streams_boost::true_type {};


    STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(internal_type)
    STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(external_type)
    template <typename T>
    struct is_translator : public streams_boost::mpl::and_<
