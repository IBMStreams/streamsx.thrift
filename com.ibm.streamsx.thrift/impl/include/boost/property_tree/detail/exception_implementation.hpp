...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree
{
    ...
    {
        return streams_boost::any_cast<D>(m_data);
    }
    ...
    {
        return streams_boost::any_cast<P>(m_path);
    }
