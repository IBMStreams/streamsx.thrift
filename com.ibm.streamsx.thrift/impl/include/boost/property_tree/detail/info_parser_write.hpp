...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_DETAIL_INFO_PARSER_WRITE_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_DETAIL_INFO_PARSER_WRITE_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree { namespace info_parser
{
                             ...
                             const info_writer_settings<typename Ptree::key_type::value_type> &settings)
    {
        ...
        if (!stream.good())
            STREAMS_BOOST_PROPERTY_TREE_THROW(info_parser_error("write error", filename, 0));
    }
