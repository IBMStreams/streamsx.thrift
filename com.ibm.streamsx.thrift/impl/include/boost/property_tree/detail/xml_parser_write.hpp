...
// ----------------------------------------------------------------------------
#ifndef STREAMS_BOOST_PROPERTY_TREE_DETAIL_XML_PARSER_WRITE_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_DETAIL_XML_PARSER_WRITE_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree { namespace xml_parser
{
                            ...
                            const xml_writer_settings<typename Ptree::key_type::value_type> & settings)
    {
        ...
        if (!stream)
            STREAMS_BOOST_PROPERTY_TREE_THROW(xml_parser_error("write error", filename, 0));
    }
