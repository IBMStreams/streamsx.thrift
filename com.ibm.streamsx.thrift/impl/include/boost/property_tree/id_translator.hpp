...
#ifndef STREAMS_BOOST_PROPERTY_TREE_ID_TRANSLATOR_HPP_INCLUDED
#define STREAMS_BOOST_PROPERTY_TREE_ID_TRANSLATOR_HPP_INCLUDED
...
namespace streams_boost { namespace property_tree
{
    ...
    struct id_translator
    {
        ...
        streams_boost::optional<T> get_value(const T &v) { return v; }
        streams_boost::optional<T> put_value(const T &v) { return v; }
    };
