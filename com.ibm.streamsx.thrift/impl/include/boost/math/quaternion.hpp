//  streams_boost quaternion.hpp header file
...
#ifndef STREAMS_BOOST_QUATERNION_HPP
#define STREAMS_BOOST_QUATERNION_HPP
...
#include <streams_boost/config.hpp> // for STREAMS_BOOST_NO_STD_LOCALE
...
#include <streams_boost/math/special_functions/sinc.hpp>    // for the Sinus cardinal
#include <streams_boost/math/special_functions/sinhc.hpp>    // for the Hyperbolic Sinus cardinal
...
#define    STREAMS_BOOST_QUATERNION_ACCESSOR_GENERATOR(type)                    \
            type                    real() const                        \
            {                                                           \
                return(a);                                              \
            }                                                           \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(type)                               \
            template<typename X>                                                            \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_DATA_GENERATOR(type)       \
            type    a;                                        \
            type    b;                                        \
            type    c;                                        \
            type    d;
        ...
        public:
            ...
            STREAMS_BOOST_QUATERNION_ACCESSOR_GENERATOR(T)
            
            // assignment operators
            
            STREAMS_BOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(T)
        ...
        protected:
            ...
            STREAMS_BOOST_QUATERNION_MEMBER_DATA_GENERATOR(T)
...
#define    STREAMS_BOOST_QUATERNION_CONSTRUCTOR_GENERATOR(type)                                                 \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_1(type)             \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_2(type)                             \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_3(type)                      \
            template<typename X>                                              \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_1(type)             \
            quaternion<type> &        operator -= (type const & rhs) \
            {                                                        \
                a -= rhs;                                            \
                                                                     \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_2(type)                             \
            quaternion<type> &        operator -= (::std::complex<type> const & rhs) \
            {                                                                        \
                a -= rhs.real();                                                     \
                b -= rhs.imag();                                                     \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_3(type)                      \
            template<typename X>                                              \
            quaternion<type> &        operator -= (quaternion<X> const & rhs) \
            {                                                                 \
                a -= static_cast<type>(rhs.R_component_1());                  \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_1(type)             \
            quaternion<type> &        operator *= (type const & rhs) \
            {                                                        \
                a *= rhs;                                            \
                b *= rhs;                                            \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_2(type)                             \
            quaternion<type> &        operator *= (::std::complex<type> const & rhs) \
            {                                                                        \
                type    ar = rhs.real();                                             \
                type    br = rhs.imag();                                             \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_3(type)                      \
            template<typename X>                                              \
            quaternion<type> &        operator *= (quaternion<X> const & rhs) \
            {                                                                 \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_1(type)             \
            quaternion<type> &        operator /= (type const & rhs) \
            {                                                        \
                a /= rhs;                                            \
                b /= rhs;                                            \
    ...
    #define    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_2(type)                                            \
            quaternion<type> &        operator /= (::std::complex<type> const & rhs)                    \
            {                                                                                           \
                using    ::std::valarray;                                                               \
                                                                                                        \
...
#if defined(__GNUC__) && (__GNUC__ < 3)
    #define    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_3(type)                                            \
            template<typename X>                                                                        \
            quaternion<type> &        operator /= (quaternion<X> const & rhs)                           \
            {                                                                                           \
                using    ::std::valarray;                                                               \
...
#define    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR(type)   \
        STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_1(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_2(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_3(type)
        
#define    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR(type)   \
        STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_1(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_2(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_3(type)
        
#define    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR(type)   \
        STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_1(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_2(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_3(type)
        
#define    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR(type)   \
        STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_1(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_2(type)    \
        STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_3(type)
        
#define    STREAMS_BOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(type)   \
        STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR(type)            \
        STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR(type)            \
        STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR(type)            \
        STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR(type)
        ...
        public:
            ...
            STREAMS_BOOST_QUATERNION_CONSTRUCTOR_GENERATOR(float)
            ...
            STREAMS_BOOST_QUATERNION_ACCESSOR_GENERATOR(float)
            
            // assignment operators
            
            STREAMS_BOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(float)
            ...
            STREAMS_BOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(float)
            
            
        protected:
            
            STREAMS_BOOST_QUATERNION_MEMBER_DATA_GENERATOR(float)
        ...
        public:
            ...
            STREAMS_BOOST_QUATERNION_CONSTRUCTOR_GENERATOR(double)
            ...
            STREAMS_BOOST_QUATERNION_ACCESSOR_GENERATOR(double)
            
            // assignment operators
            
            STREAMS_BOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(double)
            ...
            STREAMS_BOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(double)
            
            
        protected:
            
            STREAMS_BOOST_QUATERNION_MEMBER_DATA_GENERATOR(double)
        ...
        public:
            ...
            STREAMS_BOOST_QUATERNION_CONSTRUCTOR_GENERATOR(long double)
            ...
            STREAMS_BOOST_QUATERNION_ACCESSOR_GENERATOR(long double)
            
            // assignment operators
            
            STREAMS_BOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR(long double)
            ...
            STREAMS_BOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR(long double)
            
            
        protected:
            
            STREAMS_BOOST_QUATERNION_MEMBER_DATA_GENERATOR(long double)
...
#undef    STREAMS_BOOST_QUATERNION_MEMBER_ALGEBRAIC_GENERATOR
#undef    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR
#undef    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR
#undef    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR
#undef    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR
#undef    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_1
#undef    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_2
#undef    STREAMS_BOOST_QUATERNION_MEMBER_ADD_GENERATOR_3
#undef    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_1
#undef    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_2
#undef    STREAMS_BOOST_QUATERNION_MEMBER_SUB_GENERATOR_3
#undef    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_1
#undef    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_2
#undef    STREAMS_BOOST_QUATERNION_MEMBER_MUL_GENERATOR_3
#undef    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_1
#undef    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_2
#undef    STREAMS_BOOST_QUATERNION_MEMBER_DIV_GENERATOR_3
        
#undef    STREAMS_BOOST_QUATERNION_CONSTRUCTOR_GENERATOR
        
        
#undef    STREAMS_BOOST_QUATERNION_MEMBER_ASSIGNMENT_GENERATOR
        
#undef    STREAMS_BOOST_QUATERNION_MEMBER_DATA_GENERATOR
        
#undef    STREAMS_BOOST_QUATERNION_ACCESSOR_GENERATOR
        
        
        // operators
        
#define    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)      \
        {                                                    \
...
#define    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_1_L(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (T const & lhs, quaternion<T> const & rhs)                  \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_1_R(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (quaternion<T> const & lhs, T const & rhs)                  \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_2_L(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (::std::complex<T> const & lhs, quaternion<T> const & rhs)  \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_2_R(op)                                                  \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (quaternion<T> const & lhs, ::std::complex<T> const & rhs)  \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_3(op)                                                    \
        template<typename T>                                                                            \
        inline quaternion<T>    operator op (quaternion<T> const & lhs, quaternion<T> const & rhs)      \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR(op)     \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_1_L(op)    \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_1_R(op)    \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_2_L(op)    \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_2_R(op)    \
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_3(op)
        
        
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR(+)
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR(-)
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR(*)
        STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR(/)


#undef    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR
        
#undef    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_1_L
#undef    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_1_R
#undef    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_2_L
#undef    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_2_R
#undef    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_3

#undef    STREAMS_BOOST_QUATERNION_OPERATOR_GENERATOR_BODY
...
#define    STREAMS_BOOST_QUATERNION_NOT_EQUAL_GENERATOR  \
        {                                        \
            return(!(lhs == rhs));               \
        }
        ...
        template<typename T>
        inline bool                                operator != (T const & lhs, quaternion<T> const & rhs)
        STREAMS_BOOST_QUATERNION_NOT_EQUAL_GENERATOR
...
#undef    STREAMS_BOOST_QUATERNION_NOT_EQUAL_GENERATOR
...
#define    STREAMS_BOOST_QUATERNION_VALARRAY_LOADER  \
            using    ::std::valarray;        \
                                             \
            valarray<T>    temp(4);          \
                                             \
        ...
        inline T                                sup(quaternion<T> const & q)
        {
            ...
            STREAMS_BOOST_QUATERNION_VALARRAY_LOADER
...
#undef    STREAMS_BOOST_QUATERNION_VALARRAY_LOADER
...
#endif /* STREAMS_BOOST_QUATERNION_HPP */
