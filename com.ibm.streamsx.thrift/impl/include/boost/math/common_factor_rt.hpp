...
#ifndef STREAMS_BOOST_MATH_COMMON_FACTOR_RT_HPP
#define STREAMS_BOOST_MATH_COMMON_FACTOR_RT_HPP

#include <streams_boost/math_fwd.hpp>  // self include

#include <streams_boost/config.hpp>  // for STREAMS_BOOST_NESTED_TEMPLATE, etc.
...
};  // streams_boost::math::gcd_evaluator
...
};  // streams_boost::math::lcm_evaluator
...
namespace detail
{
    ...
    struct gcd_optimal_evaluator_helper_t
        : gcd_optimal_evaluator_helper2_t<IsSpecialized, IsSigned>
           ::STREAMS_BOOST_NESTED_TEMPLATE helper<T>
    {
    };
#endif
...
#else // STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
    template < typename T >
    struct gcd_optimal_evaluator
    {
        T  operator ()( T const &a, T const &b )
...
#define STREAMS_BOOST_PRIVATE_GCD_UF( Ut )                  \
    template < >  struct gcd_optimal_evaluator<Ut>  \
    {  Ut  operator ()( Ut a, Ut b ) const  { return gcd_binary( a, b ); }  }

    STREAMS_BOOST_PRIVATE_GCD_UF( unsigned char );
    STREAMS_BOOST_PRIVATE_GCD_UF( unsigned short );
    STREAMS_BOOST_PRIVATE_GCD_UF( unsigned );
    STREAMS_BOOST_PRIVATE_GCD_UF( unsigned long );

#ifdef STREAMS_BOOST_HAS_LONG_LONG
    STREAMS_BOOST_PRIVATE_GCD_UF( streams_boost::ulong_long_type );
#elif defined(STREAMS_BOOST_HAS_MS_INT64)
    STREAMS_BOOST_PRIVATE_GCD_UF( unsigned __int64 );
#endif

#undef STREAMS_BOOST_PRIVATE_GCD_UF

#define STREAMS_BOOST_PRIVATE_GCD_SF( St, Ut )                            \
    ...
    STREAMS_BOOST_PRIVATE_GCD_SF( signed char, unsigned char );
    STREAMS_BOOST_PRIVATE_GCD_SF( short, unsigned short );
    STREAMS_BOOST_PRIVATE_GCD_SF( int, unsigned );
    STREAMS_BOOST_PRIVATE_GCD_SF( long, unsigned long );

    STREAMS_BOOST_PRIVATE_GCD_SF( char, unsigned char ); // should work even if unsigned

#ifdef STREAMS_BOOST_HAS_LONG_LONG
    STREAMS_BOOST_PRIVATE_GCD_SF( streams_boost::long_long_type, streams_boost::ulong_long_type );
#elif defined(STREAMS_BOOST_HAS_MS_INT64)
    STREAMS_BOOST_PRIVATE_GCD_SF( __int64, unsigned __int64 );
#endif

#undef STREAMS_BOOST_PRIVATE_GCD_SF
...
#endif  // STREAMS_BOOST_MATH_COMMON_FACTOR_RT_HPP
