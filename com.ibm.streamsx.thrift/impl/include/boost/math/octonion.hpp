//    streams_boost octonion.hpp header file
...
#ifndef STREAMS_BOOST_OCTONION_HPP
#define STREAMS_BOOST_OCTONION_HPP

#include <streams_boost/math/quaternion.hpp>
...
namespace streams_boost
{
    namespace math
    {
        ...
        // the result is not conforming. We need STREAMS_BOOST_GET_VALARRAY to get an
        // actual valarray result when we need to call a member function
    #define    STREAMS_BOOST_GET_VALARRAY(T,x)    ::std::valarray<T>(x)
        // gcc 2.95.x has an "std::ios" class that is similar to 
        // "std::ios_base", so we just use a #define
    #define    STREAMS_BOOST_IOS_BASE    ::std::ios
        ...
        using    ::std::exp;
        using    ::std::cosh;
#endif /* STREAMS_BOOST_WORKAROUND(__GNUC__, < 3) */
    
#define    STREAMS_BOOST_OCTONION_ACCESSOR_GENERATOR(type)                      \
            type                        real() const                    \
            {                                                           \
                return(a);                                              \
            }                                                           \
            ...
            {                                                           \
                return(::std::complex<type>(g,h));                      \
                                                                        ...
                                                                        \
            ::streams_boost::math::quaternion<type>    H_component_1() const    \
            {                                                           \
                return(::streams_boost::math::quaternion<type>(a,b,c,d));       \
            }                                                           \
                                                                        \
            ::streams_boost::math::quaternion<type>    H_component_2() const    \
            {                                                           \
                return(::streams_boost::math::quaternion<type>(e,f,g,h));       \
            }
        
    
#define    STREAMS_BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(type)                                         \
            template<typename X>                                                                    \
            ...
            {                                                                                       \
                ...
                return(*this);                                                                      \
                                                                                                    ...
                                                                                                    \
            octonion<type> &        operator = (::streams_boost::math::quaternion<type> const & a_affecter) \
            {                                                                                       \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_DATA_GENERATOR(type) \
            type    a;                                \
            type    b;                                \
            type    c;                                \
            type    d;                                \
        ...
        public:
            ...
            explicit                octonion(   ::streams_boost::math::quaternion<T> const & q0,
                                                ::streams_boost::math::quaternion<T> const & q1 = ::streams_boost::math::quaternion<T>())
            :   a(q0.R_component_1()),
                b(q0.R_component_2()),
                c(q0.R_component_3()),
                d(q0.R_component_4()),
            ...
            STREAMS_BOOST_OCTONION_ACCESSOR_GENERATOR(T)
            
            // assignment operators
            
            STREAMS_BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(T)
            ...
            octonion<T> &            operator += (::streams_boost::math::quaternion<T> const & rhs)
            {
        ...
        protected:
            ...
            STREAMS_BOOST_OCTONION_MEMBER_DATA_GENERATOR(T)
...
#define    STREAMS_BOOST_OCTONION_CONSTRUCTOR_GENERATOR(type)                                                                               \
            ...
            {                                                                                                                       \
                                                                                                                                    ...
                                                                                                                                    \
            explicit                    octonion(   ::streams_boost::math::quaternion<type> const & q0,                                     \
                                                    ::streams_boost::math::quaternion<type> const & q1 = ::streams_boost::math::quaternion<type>()) \
            :   a(q0.R_component_1()),                                                                                              \
                b(q0.R_component_2()),                                                                                              \
                c(q0.R_component_3()),                                                                                              \
                d(q0.R_component_4()),                                                                                              \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_1(type)                  \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_2(type)                                  \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)                                              \
            octonion<type> &            operator += (::streams_boost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
                a += rhs.R_component_1();                                                           \
                b += rhs.R_component_2();                                                           \
                c += rhs.R_component_3();                                                           \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_4(type)                          \
            template<typename X>                                                \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_1(type)                  \
            octonion<type> &            operator -= (type const & rhs)  \
            {                                                           \
                a -= rhs;                                               \
                                                                        \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_2(type)                                  \
            octonion<type> &            operator -= (::std::complex<type> const & rhs)  \
            {                                                                           \
                a -= rhs.real();                                                        \
                b -= rhs.imag();                                                        \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_3(type)                                              \
            octonion<type> &            operator -= (::streams_boost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
                a -= rhs.R_component_1();                                                           \
                b -= rhs.R_component_2();                                                           \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_4(type)                        \
            template<typename X>                                              \
            octonion<type> &            operator -= (octonion<X> const & rhs) \
            {                                                                 \
                a -= static_cast<type>(rhs.R_component_1());                  \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_1(type)                   \
            octonion<type> &            operator *= (type const & rhs)   \
            {                                                            \
                a *= rhs;                                                \
                b *= rhs;                                                \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_2(type)                                  \
            octonion<type> &            operator *= (::std::complex<type> const & rhs)  \
            {                                                                           \
                type    ar = rhs.real();                                                \
                type    br = rhs.imag();                                                \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_3(type)                                                    \
            octonion<type> &            operator *= (::streams_boost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_4(type)                          \
            template<typename X>                                                \
            octonion<type> &            operator *= (octonion<X> const & rhs)   \
            {                                                                   \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_1(type)                  \
            octonion<type> &            operator /= (type const & rhs)  \
            {                                                           \
                a /= rhs;                                               \
                b /= rhs;                                               \
    ...
    #define    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_2(type)                                              \
            octonion<type> &            operator /= (::std::complex<type> const & rhs)                  \
            {                                                                                           \
                using    ::std::valarray;                                                               \
                                                                                                        \
                ...
                tr[1] = rhs.imag();                                                                     \
                                                                                                        \
                type            mixam = (STREAMS_BOOST_GET_VALARRAY(type,static_cast<type>(1)/abs(tr)).max)();  \
                                                                                                        \
                tr *= mixam;                                                                            \
                                                                                                        \
                valarray<type>    tt(8);                                                                \
...
#elif    defined(STREAMS_BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
    #define    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_2(type)                              \
            octonion<type> &            operator /= (::std::complex<type> const & rhs)  \
            {                                                                           \
                using    ::std::valarray;                                               \
...
#endif    /* defined(__GNUC__) && (__GNUC__ < 3) */ /* STREAMS_BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP */
    
#if defined(__GNUC__) && (__GNUC__ < 3)
    #define    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_3(type)                                           \
            octonion<type> &            operator /= (::streams_boost::math::quaternion<type> const & rhs)    \
            {                                                                                        \
                using    ::std::valarray;                                                            \
                                                                                                     \
...
#if defined(__GNUC__) && (__GNUC__ < 3)
    #define    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_4(type)                                           \
            template<typename X>                                                                     \
            octonion<type> &            operator /= (octonion<X> const & rhs)                        \
            {                                                                                        \
                using    ::std::valarray;                                                            \
...
#define    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR(type)       \
        STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_1(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_2(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_4(type)
        
#define    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR(type)       \
        STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_1(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_2(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_3(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_4(type)
        
#define    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR(type)       \
        STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_1(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_2(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_3(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_4(type)
        
#define    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR(type)       \
        STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_1(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_2(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_3(type)        \
        STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_4(type)
        
#define    STREAMS_BOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(type) \
        STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR(type)          \
        STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR(type)          \
        STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR(type)          \
        STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR(type)
        ...
        public:
            ...
            STREAMS_BOOST_OCTONION_CONSTRUCTOR_GENERATOR(float)
            ...
            STREAMS_BOOST_OCTONION_ACCESSOR_GENERATOR(float)
            
            // assignment operators
            
            STREAMS_BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(float)
            ...
            STREAMS_BOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(float)
            
            
        protected:
            
            STREAMS_BOOST_OCTONION_MEMBER_DATA_GENERATOR(float)
        ...
        public:
            ...
            STREAMS_BOOST_OCTONION_CONSTRUCTOR_GENERATOR(double)
            ...
            STREAMS_BOOST_OCTONION_ACCESSOR_GENERATOR(double)
            
            // assignment operators
            
            STREAMS_BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(double)
            ...
            STREAMS_BOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(double)
            
            
        protected:
            
            STREAMS_BOOST_OCTONION_MEMBER_DATA_GENERATOR(double)
        ...
        public:
            ...
            STREAMS_BOOST_OCTONION_CONSTRUCTOR_GENERATOR(long double)
            ...
            STREAMS_BOOST_OCTONION_ACCESSOR_GENERATOR(long double)
            
            // assignment operators
            
            STREAMS_BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(long double)
            ...
            STREAMS_BOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR(long double)
            
            
        protected:
            
            STREAMS_BOOST_OCTONION_MEMBER_DATA_GENERATOR(long double)
...
#undef    STREAMS_BOOST_OCTONION_CONSTRUCTOR_GENERATOR
        
#undef    STREAMS_BOOST_OCTONION_MEMBER_ALGEBRAIC_GENERATOR
    
#undef    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR
#undef    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR
#undef    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR
#undef    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR
    
#undef    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_1
#undef    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_2
#undef    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_3
#undef    STREAMS_BOOST_OCTONION_MEMBER_ADD_GENERATOR_4
#undef    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_1
#undef    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_2
#undef    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_3
#undef    STREAMS_BOOST_OCTONION_MEMBER_SUB_GENERATOR_4
#undef    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_1
#undef    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_2
#undef    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_3
#undef    STREAMS_BOOST_OCTONION_MEMBER_MUL_GENERATOR_4
#undef    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_1
#undef    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_2
#undef    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_3
#undef    STREAMS_BOOST_OCTONION_MEMBER_DIV_GENERATOR_4
    
    
#undef    STREAMS_BOOST_OCTONION_MEMBER_DATA_GENERATOR
    
#undef    STREAMS_BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR
    
#undef    STREAMS_BOOST_OCTONION_ACCESSOR_GENERATOR
        
        
        // operators
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op) \
        {                                             \
            octonion<T>    res(lhs);                  \
            res op##= rhs;                            \
            return(res);                              \
...
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_1_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (T const & lhs, octonion<T> const & rhs)                            \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_1_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, T const & rhs)                            \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_2_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (::std::complex<T> const & lhs, octonion<T> const & rhs)            \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_2_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, ::std::complex<T> const & rhs)            \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (::streams_boost::math::quaternion<T> const & lhs, octonion<T> const & rhs) \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, ::streams_boost::math::quaternion<T> const & rhs) \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_4(op)                                                                                \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, octonion<T> const & rhs)                  \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR(op)     \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_1_L(op)    \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_1_R(op)    \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_2_L(op)    \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_2_R(op)    \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)    \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)    \
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_4(op)
        
        
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR(+)
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR(-)
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR(*)
        STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR(/)
        
        
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR
        
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_1_L
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_1_R
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_2_L
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_2_R
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_3_L
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_3_R
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_4
    
#undef    STREAMS_BOOST_OCTONION_OPERATOR_GENERATOR_BODY
        ...
        template<typename T>
        inline bool                                operator == (::streams_boost::math::quaternion<T> const & lhs, octonion<T> const & rhs)
        {
            return(
        ...
        template<typename T>
        inline bool                                operator == (octonion<T> const & lhs, ::streams_boost::math::quaternion<T> const & rhs)
        {
            return(
...
#define    STREAMS_BOOST_OCTONION_NOT_EQUAL_GENERATOR \
        {                                     \
            return(!(lhs == rhs));            \
        }
        ...
        template<typename T>
        inline bool                                operator != (T const & lhs, octonion<T> const & rhs)
        STREAMS_BOOST_OCTONION_NOT_EQUAL_GENERATOR
    ...
    #undef    STREAMS_BOOST_OCTONION_NOT_EQUAL_GENERATOR
...
#endif /* STREAMS_BOOST_WORKAROUND(__GNUC__, < 3) */
        {
...
#ifdef     STREAMS_BOOST_NO_STD_LOCALE
#else
            ...
            ::streams_boost::math::quaternion<T>    p = ::streams_boost::math::quaternion<T>();
            ::streams_boost::math::quaternion<T>    q = ::streams_boost::math::quaternion<T>();
                ...
                if    (cc == '(')                                // read "(("
                {
                    ...
                    if    (cc == '(')                                // read "((("
                    {
                        ...
                        if        (cc == ')')                        // read "((u)"
                        {
                            ...
                            {
                                p = ::streams_boost::math::quaternion<T>(u);
                        ...
                        else if    (cc ==',')                        // read "((u,"
                        {
                            ...
                            if        (cc == ')')                        // read "((u,v)"
                            {
                                p = ::streams_boost::math::quaternion<T>(u,v);
                            ...
                            else if    (cc == ',')                            // read "((a),"
                            {
                                ...
                                if        (cc == '(')                            // read "((a),("
                                {
                                    ...
                                    if        (cc == '(')                            // read "((a),(("
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a),q)"
                                        {
                                            p = ::streams_boost::math::quaternion<T>(a);
                                    ...
                                    else                                        // read "((a),(c" or "((a),(e"
                                    {
                                        ...
                                        else if    (cc == ',')                            // read "((a),(c," or "((a),(e,"
                                        {
                                            ...
                                            if        (cc == '(')                        // read "((a),(e,(" (ambiguity resolution)
                                            {
                                                ...
                                                if        (cc == ')')                        // read "((a),(e,y)"
                                                {
                                                    q = ::streams_boost::math::quaternion<T>(x,y);
                                            ...
                                            else                                    // read "((a),(c,d" or "((a),(e,f"
                                            {
                                                ...
                                                else if    (cc == ',')                        // read "((a),(e,f," (ambiguity resolution)
                                                {
                                                    ...
                                                    if        (cc == ')')                        // read "((a),(e,f,g)"
                                                    {
                                                        q = ::streams_boost::math::quaternion<T>(c,d,g);        // "c" was actually "e", and "d" was actually "f"
                                                    ...
                                                    else if    (cc == ',')                        // read "((a),(e,f,g,"
                                                    {
                                                        ...
                                                        {
                                                            q = ::streams_boost::math::quaternion<T>(c,d,g,h);    // "c" was actually "e", and "d" was actually "f"
                            ...
                            else
                            {
                                ...
                                if        (cc == ')')                            // read "((a,b)"
                                {
                                    ...
                                    else if    (cc == ',')                            // read "((a,b),"
                                    {
                                        ...
                                        if        (cc == '(')                            // read "((a,b),("
                                        {
                                            ...
                                            if        (cc == '(')                            // read "((a,b),(("
                                            {
                                                p = ::streams_boost::math::quaternion<T>(a,b);
                                            ...
                                            else                                        // read "((a,b),(c" or "((a,b),(e"
                                            {
                                                ...
                                                else if    (cc == ',')                            // read "((a,b),(c," or "((a,b),(e,"
                                                {
                                                    ...
                                                    else                                        // read "((a,b),(c,d" or "((a,b),(e,f"
                                                    {
                                                        ...
                                                        {
                                                            p = ::streams_boost::math::quaternion<T>(a,b);                // too late to backtrack
                                                            ...
                                                            if        (cc == ')')                            // read "((a,b),(e,f,g)"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g))"
                                                                {
                                                                    q = ::streams_boost::math::quaternion<T>(c,d,g);            // "c" is actually "e" and "d" is actually "f"
                                                            ...
                                                            else if    (cc == ',')                            // read "((a,b),(e,f,g,"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g,h)"
                                                                {
                                                                    ...
                                                                    if        (cc == ')')                            // read ((a,b),(e,f,g,h))"
                                                                    {
                                                                        q = ::streams_boost::math::quaternion<T>(c,d,g,h);            // "c" is actually "e" and "d" is actually "f"
                                ...
                                else if    (cc == ',')                            // read "((a,b,"
                                {
                                    ...
                                    if        (cc == ')')                            // read "((a,b,c)"
                                    {
                                        ...
                                        {
                                            p = ::streams_boost::math::quaternion<T>(a,b,c);
                                    ...
                                    else if    (cc == ',')                            // read "((a,b,c,"
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a,b,c,d)"
                                        {
                                            ...
                                            {
                                                p = ::streams_boost::math::quaternion<T>(a,b,c,d);
...
#define    STREAMS_BOOST_OCTONION_VALARRAY_LOADER   \
            using    ::std::valarray;       \
                                            \
            valarray<T>    temp(8);         \
                                            \
        ...
        inline T                                sup(octonion<T> const & o)
        {
            ...
            using    ::std::abs;
#endif    /* STREAMS_BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP */
            
            STREAMS_BOOST_OCTONION_VALARRAY_LOADER
            
#if    STREAMS_BOOST_WORKAROUND(__GNUC__, < 3)
            return((STREAMS_BOOST_GET_VALARRAY(T, abs(temp)).max)());
#else
            return((abs(temp).max)());
#endif /* STREAMS_BOOST_WORKAROUND(__GNUC__, < 3) */
        }
...
#if    STREAMS_BOOST_WORKAROUND(__GNUC__, < 3)
            return(STREAMS_BOOST_GET_VALARRAY(T, abs(temp)).sum());
#else
            return(abs(temp).sum());
#endif /* STREAMS_BOOST_WORKAROUND(__GNUC__, < 3) */
        }
...
#if    STREAMS_BOOST_WORKAROUND(__GNUC__, < 3)
            T            maxim = (STREAMS_BOOST_GET_VALARRAY(T,abs(temp)).max)();    // overflow protection
#else
...
#undef    STREAMS_BOOST_OCTONION_VALARRAY_LOADER
        ...
        inline octonion<T>                        exp(octonion<T> const & o)
        {
            ...
            using    ::streams_boost::math::sinc_pi;
        ...
        inline octonion<T>                        cos(octonion<T> const & o)
        {
            ...
            using    ::streams_boost::math::sinhc_pi;
...
#if    STREAMS_BOOST_WORKAROUND(__GNUC__, < 3)
    #undef    STREAMS_BOOST_GET_VALARRAY
#endif /* STREAMS_BOOST_WORKAROUND(__GNUC__, < 3) */


#endif /* STREAMS_BOOST_OCTONION_HPP */
