...
#ifndef STREAMS_BOOST_MATH_TOOLS_MINIMA_HPP
#define STREAMS_BOOST_MATH_TOOLS_MINIMA_HPP
...
std::pair<T, T> brent_find_minima(F f, T min, T max, int bits, streams_boost::uintmax_t& max_iter)
{
