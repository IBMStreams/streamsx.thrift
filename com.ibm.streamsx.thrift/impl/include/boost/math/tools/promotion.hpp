// streams_boost\math\tools\promotion.hpp
...
#ifndef STREAMS_BOOST_MATH_PROMOTION_HPP
#define STREAMS_BOOST_MATH_PROMOTION_HPP
...
#include <streams_boost/type_traits/is_floating_point.hpp> // for streams_boost::is_floating_point;
#include <streams_boost/type_traits/is_integral.hpp> // for streams_boost::is_integral
#include <streams_boost/type_traits/is_convertible.hpp> // for streams_boost::is_convertible
#include <streams_boost/type_traits/is_same.hpp>// for streams_boost::is_same
#include <streams_boost/type_traits/remove_cv.hpp>// for streams_boost::remove_cv
// Boost Template meta programming:
#include <streams_boost/mpl/if.hpp> // for streams_boost::mpl::if_c.
#include <streams_boost/mpl/and.hpp> // for streams_boost::mpl::if_c.
#include <streams_boost/mpl/or.hpp> // for streams_boost::mpl::if_c.
    ...
    namespace tools
    {
      ...
      { // Promote, if necessary, & pick the wider of the two floating-point types.
        ...
        typedef typename mpl::if_<
          ...
          typename mpl::if_< ::streams_boost::is_convertible<T1P, T2P>, T2P, T1P>::type>::type type;
      }; // promote_arg2
      // These full specialisations reduce mpl::if_ usage and speed up
      // compilation:
      ...
      struct promote_args
      {
         ...
         //
         STREAMS_BOOST_STATIC_ASSERT((0 == ::streams_boost::is_same<type, long double>::value));
#endif
      };
...
#endif // STREAMS_BOOST_MATH_PROMOTION_HPP
