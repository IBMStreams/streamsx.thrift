...
#ifndef STREAMS_BOOST_MATH_TOOLS_SERIES_INCLUDED
#define STREAMS_BOOST_MATH_TOOLS_SERIES_INCLUDED
...
inline typename Functor::result_type sum_series(Functor& func, const U& factor, streams_boost::uintmax_t& max_terms, const V& init_value)
{
...
inline typename Functor::result_type sum_series(Functor& func, const U& factor, streams_boost::uintmax_t& max_terms)
{
...
template <class Functor, class U>
inline typename Functor::result_type sum_series(Functor& func, int bits, streams_boost::uintmax_t& max_terms, const U& init_value)
{
   STREAMS_BOOST_MATH_STD_USING
   typedef typename Functor::result_type result_type;
...
inline typename Functor::result_type sum_series(Functor& func, int bits)
{
   STREAMS_BOOST_MATH_STD_USING
   typedef typename Functor::result_type result_type;
   streams_boost::uintmax_t iters = (std::numeric_limits<streams_boost::uintmax_t>::max)();
   result_type init_val = 0;
   return sum_series(func, bits, iters, init_val);
}

template <class Functor>
inline typename Functor::result_type sum_series(Functor& func, int bits, streams_boost::uintmax_t& max_terms)
{
   STREAMS_BOOST_MATH_STD_USING
   typedef typename Functor::result_type result_type;
   result_type init_val = 0;
...
template <class Functor>
inline typename Functor::result_type kahan_sum_series(Functor& func, int bits, streams_boost::uintmax_t& max_terms)
{
   STREAMS_BOOST_MATH_STD_USING
...
#endif // STREAMS_BOOST_MATH_TOOLS_SERIES_INCLUDED
