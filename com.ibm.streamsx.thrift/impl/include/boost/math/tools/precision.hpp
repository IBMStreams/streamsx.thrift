...
#ifndef STREAMS_BOOST_MATH_TOOLS_PRECISION_INCLUDED
#define STREAMS_BOOST_MATH_TOOLS_PRECISION_INCLUDED
...
// see streams_boost/math/tools/ntl.hpp  for examples like
// template <> NTL::RR max_value<NTL::RR> ...
// See  Conceptual Requirements for Real Number Types.

template <class T>
inline int digits(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(T))
{
...
template <class T>
inline T max_value(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   STREAMS_BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
#else
...
template <class T>
inline T min_value(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   STREAMS_BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
#else
...
//
template <class T>
inline T log_max_value(const mpl::int_<128>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   return 88.0f;
}

template <class T>
inline T log_min_value(const mpl::int_<128>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   return -87.0f;
}
//
...
//
template <class T>
inline T log_max_value(const mpl::int_<1024>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   return 709.0;
}

template <class T>
inline T log_min_value(const mpl::int_<1024>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   return -708.0;
}
//
...
//
template <class T>
inline T log_max_value(const mpl::int_<16384>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   return 11356.0L;
}

template <class T>
inline T log_min_value(const mpl::int_<16384>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
   return -11355.0L;
}

template <class T>
inline T log_max_value(const mpl::int_<0>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   STREAMS_BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
#else
...
template <class T>
inline T log_min_value(const mpl::int_<0>& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   STREAMS_BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
#else
...
template <class T>
inline T epsilon(const mpl::true_& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
...
template <>
inline long double epsilon<long double>(const mpl::true_& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(long double))
{
   // numeric_limits on Darwin tells lies here.
   // This static assert fails for some unknown reason, so
   // disabled for now...
   // STREAMS_BOOST_STATIC_ASSERT(std::numeric_limits<long double>::digits == 106);
   return 2.4651903288156618919116517665087e-32L;
}
#endif

template <class T>
inline T epsilon(const mpl::false_& STREAMS_BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE(T))
{
...
template <class T>
inline T log_max_value(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
template <class T>
inline T log_min_value(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
   typedef typename mpl::if_c<
      std::numeric_limits<T>::max_exponent == 128
...
template <class T>
inline T epsilon(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(T))
{
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#endif // STREAMS_BOOST_MATH_TOOLS_PRECISION_INCLUDED
