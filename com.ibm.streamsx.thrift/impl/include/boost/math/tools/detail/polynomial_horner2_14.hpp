...
#ifndef STREAMS_BOOST_MATH_TOOLS_POLY_EVAL_14_HPP
#define STREAMS_BOOST_MATH_TOOLS_POLY_EVAL_14_HPP

namespace streams_boost{ namespace math{ namespace tools{ namespace detail{
