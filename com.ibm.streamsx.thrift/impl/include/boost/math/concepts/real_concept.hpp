...
//   test_spots(streams_boost::math::concepts::real_concept(0.));
...
#ifndef STREAMS_BOOST_MATH_REAL_CONCEPT_HPP
#define STREAMS_BOOST_MATH_REAL_CONCEPT_HPP
...
public:
   ...
   real_concept(streams_boost::ulong_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   real_concept(streams_boost::long_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   ...
   real_concept& operator=(streams_boost::long_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
   real_concept& operator=(streams_boost::ulong_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
#endif
...
#ifdef STREAMS_BOOST_HAS_LONG_LONG
template <class Policy>
inline streams_boost::long_long_type llround(const concepts::real_concept& v, const Policy& pol)
{ return streams_boost::math::llround(v.value(), pol); }
inline streams_boost::long_long_type llround(const concepts::real_concept& v)
...
#ifdef STREAMS_BOOST_HAS_LONG_LONG
template <class Policy>
inline streams_boost::long_long_type lltrunc(const concepts::real_concept& v, const Policy& pol)
{ return streams_boost::math::lltrunc(v.value(), pol); }
inline streams_boost::long_long_type lltrunc(const concepts::real_concept& v)
...
{
#if defined(STREAMS_BOOST_MSVC) && defined(__SGI_STL_PORT)
   //
...
template <>
inline concepts::real_concept max_value<concepts::real_concept>(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(concepts::real_concept))
{
   return max_value<concepts::real_concept_base_type>();
}

template <>
inline concepts::real_concept min_value<concepts::real_concept>(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(concepts::real_concept))
{
   return min_value<concepts::real_concept_base_type>();
}

template <>
inline concepts::real_concept log_max_value<concepts::real_concept>(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(concepts::real_concept))
{
   return log_max_value<concepts::real_concept_base_type>();
}

template <>
inline concepts::real_concept log_min_value<concepts::real_concept>(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(concepts::real_concept))
{
   return log_min_value<concepts::real_concept_base_type>();
}

template <>
inline concepts::real_concept epsilon<concepts::real_concept>(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(concepts::real_concept))
{
#ifdef __SUNPRO_CC
...
template <>
inline int digits<concepts::real_concept>(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(concepts::real_concept))
{ 
