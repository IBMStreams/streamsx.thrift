...
#ifndef STREAMS_BOOST_MATH_COMPLEX_ATAN_INCLUDED
#define STREAMS_BOOST_MATH_COMPLEX_ATAN_INCLUDED
...
#  include <streams_boost/math/complex/atanh.hpp>
#endif
...
std::complex<T> atan(const std::complex<T>& x)
{
   ...
   return ::streams_boost::math::detail::mult_minus_i(::streams_boost::math::atanh(::streams_boost::math::detail::mult_i(x)));
}

} } // namespaces

#endif // STREAMS_BOOST_MATH_COMPLEX_ATAN_INCLUDED
