...
#ifndef STREAMS_BOOST_STATS_TRIANGULAR_HPP
#define STREAMS_BOOST_STATS_TRIANGULAR_HPP
...
namespace streams_boost{ namespace math
{
  namespace detail
  {
    ...
    inline bool check_triangular_mode(
      ...
      RealType* result, const Policy& pol)
    {
      if((streams_boost::math::isfinite)(mode))
      { // any finite value is OK.
        return true;
      }
      else
  ...
  public:
    ...
    { // Evans says 'standard triangular' is lower 0, mode 1/2, upper 1,
      ...
      RealType result;
      detail::check_triangular("streams_boost::math::triangular_distribution<%1%>::triangular_distribution",lower, mode, upper, &result, Policy());
    }
    // Accessor functions.
  ...
  {
    static const char* function = "streams_boost::math::pdf(const triangular_distribution<%1%>&, %1%)";
  ...
  {
    static const char* function = "streams_boost::math::cdf(const triangular_distribution<%1%>&, %1%)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result; // of checks.
  ...
  {
    STREAMS_BOOST_MATH_STD_USING  // for ADL of std functions (sqrt).
    static const char* function = "streams_boost::math::quantile(const triangular_distribution<%1%>&, %1%)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result; // of checks
  ...
  {
    STREAMS_BOOST_MATH_STD_USING  // Aid ADL for sqrt.
    static const char* function = "streams_boost::math::quantile(const triangular_distribution<%1%>&, %1%)";
  ...
  {
    static const char* function = "streams_boost::math::mean(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType mode = dist.mode();
    RealType upper = dist.upper();
    RealType result;  // of checks.
  ...
  {
    static const char* function = "streams_boost::math::mode(const triangular_distribution<%1%>&)";
    RealType mode = dist.mode();
    RealType result; // of checks.
  ...
  inline RealType median(const triangular_distribution<RealType, Policy>& dist)
  {
    ...
    static const char* function = "streams_boost::math::median(const triangular_distribution<%1%>&)";
    RealType mode = dist.mode();
    RealType result; // of checks.
    if(false == detail::check_triangular_mode(function, mode, &result, Policy()))
    { // This should never happen!
  ...
  inline RealType skewness(const triangular_distribution<RealType, Policy>& dist)
  {
    ...
    using namespace streams_boost::math::constants; // for root_two
    static const char* function = "streams_boost::math::skewness(const triangular_distribution<%1%>&)";
  ...
  { // These checks may be belt and braces as should have been checked on construction?
    static const char* function = "streams_boost::math::kurtosis(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType upper = dist.upper();
    RealType mode = dist.mode();
    RealType result;  // of checks.
  ...
  { // These checks may be belt and braces as should have been checked on construction?
    static const char* function = "streams_boost::math::kurtosis_excess(const triangular_distribution<%1%>&)";
    RealType lower = dist.lower();
    RealType upper = dist.upper();
    RealType mode = dist.mode();
    RealType result;  // of checks.
...
#endif // STREAMS_BOOST_STATS_TRIANGULAR_HPP
