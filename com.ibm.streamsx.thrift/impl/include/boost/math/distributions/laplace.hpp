...
#ifndef STREAMS_BOOST_STATS_LAPLACE_HPP
#define STREAMS_BOOST_STATS_LAPLACE_HPP
...
public:
   ...
   {
      RealType result;
      check_parameters("streams_boost::math::laplace_distribution<%1%>::laplace_distribution()", &result);
   }
...
inline RealType pdf(const laplace_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType result;
   const char* function = "streams_boost::math::pdf(const laplace_distribution<%1%>&, %1%))";
...
inline RealType cdf(const laplace_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   // Checking function argument
   RealType result;
   const char* function = "streams_boost::math::cdf(const laplace_distribution<%1%>&, %1%)";
   if (false == dist.check_parameters(function, &result)) return result;
   if (false == detail::check_x(function, x, &result, Policy())) return result;
...
inline RealType quantile(const laplace_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   // Checking function argument
   RealType result;
   const char* function = "streams_boost::math::quantile(const laplace_distribution<%1%>&, %1%)";
   if (false == dist.check_parameters(function, &result)) return result;
...
inline RealType cdf(const complemented2_type<laplace_distribution<RealType, Policy>, RealType>& c)
{
   ...
   // Checking function argument
   RealType result;
   const char* function = "streams_boost::math::cdf(const complemented2_type<laplace_distribution<%1%>, %1%>&)";
   if(false == detail::check_x(function, x, &result, Policy()))return result;
...
#endif // STREAMS_BOOST_STATS_LAPLACE_HPP
