...
#ifndef STREAMS_BOOST_STATS_UNIFORM_HPP
#define STREAMS_BOOST_STATS_UNIFORM_HPP
...
#include <streams_boost/math/distributions/detail/common_error_handling.hpp>
...
namespace streams_boost{ namespace math
{
  namespace detail
  {
    ...
    {
      if((streams_boost::math::isfinite)(lower))
    ...
    inline bool check_uniform_upper(
      ...
      RealType* result, const Policy& pol)
    {
      if((streams_boost::math::isfinite)(upper))
      { // Any finite value is OK.
        return true;
      }
      else
    ...
    inline bool check_uniform_x(
      ...
      RealType* result, const Policy& pol)
    {
      if((streams_boost::math::isfinite)(x))
      { // Any finite value is OK
        return true;
      }
      else
  ...
  public:
    ...
    {
      RealType result;
      detail::check_uniform("streams_boost::math::uniform_distribution<%1%>::uniform_distribution", lower, upper, &result, Policy());
    }
    // Accessor functions.
  ...
  inline RealType pdf(const uniform_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    if(false == detail::check_uniform("streams_boost::math::pdf(const uniform_distribution<%1%>&, %1%)", lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_uniform_x("streams_boost::math::pdf(const uniform_distribution<%1%>&, %1%)", x, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType cdf(const uniform_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    RealType upper = dist.upper();
    RealType result; // of checks.
    if(false == detail::check_uniform("streams_boost::math::cdf(const uniform_distribution<%1%>&, %1%)",lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_uniform_x("streams_boost::math::cdf(const uniform_distribution<%1%>&, %1%)", x, &result, Policy()))
    {
      return result;
    }
    if (x < lower)
  ...
  inline RealType quantile(const uniform_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    RealType upper = dist.upper();
    RealType result; // of checks
    if(false == detail::check_uniform("streams_boost::math::quantile(const uniform_distribution<%1%>&, %1%)",lower, upper, &result, Policy()))
    {
      return result;
    }
    if(false == detail::check_probability("streams_boost::math::quantile(const uniform_distribution<%1%>&, %1%)", p, &result, Policy()))
    {
      return result;
    }
    if(p == 0)
  ...
  inline RealType quantile(const complemented2_type<uniform_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    if(false == detail::check_probability("streams_boost::math::quantile(const uniform_distribution<%1%>&, %1%)", q, &result, Policy()))
      if(q == 0)
      {
        return lower;
      }
  ...
  inline RealType mean(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result;  // of checks.
    if(false == detail::check_uniform("streams_boost::math::mean(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType variance(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result; // of checks.
    if(false == detail::check_uniform("streams_boost::math::variance(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType mode(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result; // of checks.
    if(false == detail::check_uniform("streams_boost::math::mode(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
  ...
  inline RealType median(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result; // of checks.
    if(false == detail::check_uniform("streams_boost::math::median(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
    return (lower + upper) / 2; //
  ...
  inline RealType skewness(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result; // of checks.
    if(false == detail::check_uniform("streams_boost::math::skewness(const uniform_distribution<%1%>&)",lower, upper, &result, Policy()))
    {
      return result;
    }
    return 0;
  ...
  inline RealType kurtosis_excess(const uniform_distribution<RealType, Policy>& dist)
  {
    ...
    RealType upper = dist.upper();
    RealType result;  // of checks.
    if(false == detail::check_uniform("streams_boost::math::kurtosis_execess(const uniform_distribution<%1%>&)", lower, upper, &result, Policy()))
    {
      return result;
    }
...
#endif // STREAMS_BOOST_STATS_UNIFORM_HPP
