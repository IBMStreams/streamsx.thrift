...
#ifndef STREAMS_BOOST_MATH_DISTRIBUTIONS_DETAIL_INV_DISCRETE_QUANTILE
#define STREAMS_BOOST_MATH_DISTRIBUTIONS_DETAIL_INV_DISCRETE_QUANTILE
      ...
      streams_boost::uintmax_t& max_iter)
{
   ...
   static const char* function = "streams_boost::math::do_inverse_discrete_quantile<%1%>";
   ...
   //
   if((streams_boost::math::sign)(fb) == (streams_boost::math::sign)(fa))
   {
      if(fa < 0)
      {
         //
...
#endif // STREAMS_BOOST_MATH_DISTRIBUTIONS_DETAIL_INV_DISCRETE_QUANTILE
