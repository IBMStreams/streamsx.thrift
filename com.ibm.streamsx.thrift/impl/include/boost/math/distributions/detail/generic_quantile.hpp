...
#ifndef STREAMS_BOOST_MATH_DISTIBUTIONS_DETAIL_GENERIC_QUANTILE_HPP
#define STREAMS_BOOST_MATH_DISTIBUTIONS_DETAIL_GENERIC_QUANTILE_HPP
...
typename Dist::value_type generic_quantile(const Dist& dist, const typename Dist::value_type& p, const typename Dist::value_type& guess, bool comp, const char* function)
{
   ...
   streams_boost::uintmax_t max_iter = policies::get_max_root_iterations<forwarding_policy>();
...
#endif // STREAMS_BOOST_MATH_DISTIBUTIONS_DETAIL_GENERIC_QUANTILE_HPP
