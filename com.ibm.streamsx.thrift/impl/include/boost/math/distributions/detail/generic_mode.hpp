...
#ifndef STREAMS_BOOST_MATH_DISTRIBUTIONS_DETAIL_MODE_HPP
#define STREAMS_BOOST_MATH_DISTRIBUTIONS_DETAIL_MODE_HPP

#include <streams_boost/math/tools/minima.hpp> // function minimization for mode
...
typename Dist::value_type generic_find_mode(const Dist& dist, typename Dist::value_type guess, const char* function, typename Dist::value_type step = 0)
{
   ...
   streams_boost::uintmax_t max_iter = policies::get_max_root_iterations<policy_type>();
...
#endif // STREAMS_BOOST_MATH_DISTRIBUTIONS_DETAIL_MODE_HPP
