...
#ifndef STREAMS_BOOST_STATS_FIND_SCALE_HPP
#define STREAMS_BOOST_STATS_FIND_SCALE_HPP
...
namespace streams_boost
{
  namespace math
  {
    ...
    // STREAMS_BOOST_STATIC_ASSERTs, see below, are used to enforce this.
...
#endif
      static const char* function = "streams_boost::math::find_scale<Dist, Policy>(%1%, %1%, %1%, Policy)";
      ...
      complemented4_type<Real1, Real2, Real3, Policy> const& c)
    {
      ...
      STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::tools::is_scaled_distribution<Dist>::value); 
#endif
      static const char* function = "streams_boost::math::find_scale<Dist, Policy>(complement(%1%, %1%, %1%, Policy))";

      // Checks on arguments, as not complemented version,
      // Explicit policy.
      typename Dist::value_type q = c.param1;
      if(!(streams_boost::math::isfinite)(q) || (q < 0) || (q > 1))
      {
        return policies::raise_domain_error<typename Dist::value_type>(
...
#endif // STREAMS_BOOST_STATS_FIND_SCALE_HPP
