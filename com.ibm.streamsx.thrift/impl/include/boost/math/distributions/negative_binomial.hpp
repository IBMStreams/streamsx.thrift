// streams_boost\math\special_functions\negative_binomial.hpp
...
#ifndef STREAMS_BOOST_MATH_SPECIAL_NEGATIVE_BINOMIAL_HPP
#define STREAMS_BOOST_MATH_SPECIAL_NEGATIVE_BINOMIAL_HPP

#include <streams_boost/math/distributions/fwd.hpp>
#include <streams_boost/math/special_functions/beta.hpp> // for ibeta(a, b, x) == Ix(a, b).
#include <streams_boost/math/distributions/complement.hpp> // complement.
#include <streams_boost/math/distributions/detail/common_error_handling.hpp> // error checks domain_error & logic_error.
...
#include <streams_boost/math/distributions/detail/inv_discrete_quantile.hpp>
...
namespace streams_boost
{
  namespace math
  {
    namespace negative_binomial_detail
    {
      ...
      {
        if( !(streams_boost::math::isfinite)(r) || (r <= 0) )
        {
      ...
      inline bool check_dist_and_k(const char* function, const RealType& r, const RealType& p, RealType k, RealType* result, const Policy& pol)
      {
        ...
        if( !(streams_boost::math::isfinite)(k) || (k < 0) )
        { // Check k failures.
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      {
        static const char* function = "streams_boost::math::negative_binomial<%1%>::find_lower_bound_on_p";
      ...
      static RealType find_upper_bound_on_p(
        ...
        RealType alpha) // alpha 0.05 equivalent to 95% for one-sided test.
      {
        static const char* function = "streams_boost::math::negative_binomial<%1%>::find_upper_bound_on_p";
        RealType result;  // of error checks.
        RealType failures = trials - successes;
      ...
      {
        static const char* function = "streams_boost::math::negative_binomial<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result;
        if(false == negative_binomial_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
        ...
        RealType alpha) // risk level threshold 0 <= alpha <= 1.
      {
        static const char* function = "streams_boost::math::negative_binomial<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result;
        if(false == negative_binomial_detail::check_dist_and_k(
          function, RealType(1), p, k, &result, Policy())
    ...
    //  return policies::raise_domain_error<RealType>(STREAMS_BOOST_CURRENT_FUNCTION, "Median is not implemented, result is %1%!", std::numeric_limits<RealType>::quiet_NaN());
    //} // median
    ...
    { // Probability Density/Mass Function.
      ...
      static const char* function = "streams_boost::math::pdf(const negative_binomial_distribution<%1%>&, %1%)";
    ...
    { // Cumulative Distribution Function of Negative Binomial.
      static const char* function = "streams_boost::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using streams_boost::math::ibeta; // Regularized incomplete beta function.
      ...
      static const char* function = "streams_boost::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using streams_boost::math::ibetac; // Regularized incomplete beta function complement.
      // k argument may be integral, signed, or unsigned, or floating point.
      // If necessary, it has already been promoted from an integral type.
    ...
    { // Quantile, percentile/100 or Percent Point Negative Binomial function.
      ...
      static const char* function = "streams_boost::math::quantile(const negative_binomial_distribution<%1%>&, %1%)";
      STREAMS_BOOST_MATH_STD_USING // ADL of std functions.
      ...
      {  // Would need +infinity failures for total confidence.
       ...
       // unless #define STREAMS_BOOST_MATH_THROW_ON_OVERFLOW_ERROR
      }
      if (P == 0)
      ...
      using streams_boost::math::ibeta_invb;
      ...
      */
      ...
      STREAMS_BOOST_MATH_INSTRUMENT_CODE("guess = " << guess);
      //
    ...
    {  // Quantile or Percent Point Binomial function.
       ...
       if (-Q <= streams_boost::math::powm1(dist.success_fraction(), dist.successes(), Policy()))
...
#endif // STREAMS_BOOST_MATH_SPECIAL_NEGATIVE_BINOMIAL_HPP
