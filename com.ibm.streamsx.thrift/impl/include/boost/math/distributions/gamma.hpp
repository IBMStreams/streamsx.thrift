...
#ifndef STREAMS_BOOST_STATS_GAMMA_HPP
#define STREAMS_BOOST_STATS_GAMMA_HPP
...
public:
   ...
   {
      RealType result;
      detail::check_gamma("streams_boost::math::gamma_distribution<%1%>::gamma_distribution", scale, shape, &result, Policy());
   }
...
inline RealType pdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "streams_boost::math::pdf(const gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "streams_boost::math::cdf(const gamma_distribution<%1%>&, %1%)";
   ...
   result = streams_boost::math::gamma_p(shape, x / scale, Policy());
   return result;
} // cdf
...
inline RealType quantile(const gamma_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "streams_boost::math::quantile(const gamma_distribution<%1%>&, %1%)";
...
inline RealType mean(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::mean(const gamma_distribution<%1%>&)";
...
inline RealType variance(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::variance(const gamma_distribution<%1%>&)";
...
inline RealType mode(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::mode(const gamma_distribution<%1%>&)";
...
inline RealType skewness(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::skewness(const gamma_distribution<%1%>&)";
...
inline RealType kurtosis_excess(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::kurtosis_excess(const gamma_distribution<%1%>&)";
...
#endif // STREAMS_BOOST_STATS_GAMMA_HPP
