...
#ifndef STREAMS_BOOST_STATS_EXTREME_VALUE_HPP
#define STREAMS_BOOST_STATS_EXTREME_VALUE_HPP
...
public:
   ...
   {
      RealType err;
      detail::verify_scale_b("streams_boost::math::extreme_value_distribution<%1%>::extreme_value_distribution", b, &err, Policy());
...
inline RealType pdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType result;
   if(0 == detail::verify_scale_b("streams_boost::math::pdf(const extreme_value_distribution<%1%>&, %1%)", b, &result, Policy()))
      return result;
...
inline RealType cdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType b = dist.scale();
   RealType result;
   if(0 == detail::verify_scale_b("streams_boost::math::cdf(const extreme_value_distribution<%1%>&, %1%)", b, &result, Policy()))
      return result;
...
RealType quantile(const extreme_value_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "streams_boost::math::quantile(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType cdf(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   result = -streams_boost::math::expm1(-exp((a-c.param)/b), Policy());
...
RealType quantile(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   result = a - log(-streams_boost::math::log1p(-q, Policy())) * b;
...
inline RealType mean(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result;
   if(0 == detail::verify_scale_b("streams_boost::math::mean(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
...
inline RealType standard_deviation(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result;
   if(0 == detail::verify_scale_b("streams_boost::math::standard_deviation(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
...
#endif // STREAMS_BOOST_STATS_EXTREME_VALUE_HPP
