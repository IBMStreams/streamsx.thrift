...
#ifndef STREAMS_BOOST_STATS_WEIBULL_HPP
#define STREAMS_BOOST_STATS_WEIBULL_HPP
...
{
   if((shape < 0) || !(streams_boost::math::isfinite)(shape))
   {
...
inline bool check_weibull_x(
      ...
      RealType* result, const Policy& pol)
{
   if((x < 0) || !(streams_boost::math::isfinite)(x))
   {
      *result = policies::raise_domain_error<RealType>(
         function,
...
public:
   ...
   {
      RealType result;
      detail::check_weibull("streams_boost::math::weibull_distribution<%1%>::weibull_distribution", scale, shape, &result, Policy());
   }
...
{ // Range of supported values for random variable x.
   ...
   using streams_boost::math::tools::max_value;
   using streams_boost::math::tools::min_value;
...
{
   STREAMS_BOOST_MATH_STD_USING  // for ADL of std functions

   static const char* function = "streams_boost::math::pdf(const weibull_distribution<%1%>, %1%)";
...
inline RealType cdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "streams_boost::math::cdf(const weibull_distribution<%1%>, %1%)";
   ...
   result = -streams_boost::math::expm1(-pow(x / scale, shape), Policy());
...
inline RealType quantile(const weibull_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "streams_boost::math::quantile(const weibull_distribution<%1%>, %1%)";
   ...
   result = scale * pow(-streams_boost::math::log1p(-p, Policy()), 1 / shape);
...
inline RealType mean(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::mean(const weibull_distribution<%1%>)";
   ...
   result = scale * streams_boost::math::tgamma(1 + 1 / shape, Policy());
   return result;
}
...
inline RealType variance(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::variance(const weibull_distribution<%1%>)";
   ...
   result = streams_boost::math::tgamma(1 + 1 / shape, Policy());
   result *= -result;
   result += streams_boost::math::tgamma(1 + 2 / shape, Policy());
   result *= scale * scale;
   return result;
}
...
{
   STREAMS_BOOST_MATH_STD_USING  // for ADL of std function pow.

   static const char* function = "streams_boost::math::mode(const weibull_distribution<%1%>)";
...
inline RealType median(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::median(const weibull_distribution<%1%>)";
   ...
   using streams_boost::math::constants::ln_two;
...
inline RealType skewness(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::skewness(const weibull_distribution<%1%>)";
   ...
   g1 = streams_boost::math::tgamma(1 + 1 / shape, Policy());
   g2 = streams_boost::math::tgamma(1 + 2 / shape, Policy());
   g3 = streams_boost::math::tgamma(1 + 3 / shape, Policy());
...
inline RealType kurtosis_excess(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "streams_boost::math::kurtosis_excess(const weibull_distribution<%1%>)";
   ...
   g2 = streams_boost::math::tgamma(1 + 2 / shape, Policy());
   g3 = streams_boost::math::tgamma(1 + 3 / shape, Policy());
   g4 = streams_boost::math::tgamma(1 + 4 / shape, Policy());
   g1_2 = g1 * g1;
   g1_4 = g1_2 * g1_2;
   d = g2 - g1_2;
   d *= d;
...
#endif // STREAMS_BOOST_STATS_WEIBULL_HPP
