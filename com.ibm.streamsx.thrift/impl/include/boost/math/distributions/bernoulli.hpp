// streams_boost\math\distributions\bernoulli.hpp
...
#ifndef STREAMS_BOOST_MATH_SPECIAL_BERNOULLI_HPP
#define STREAMS_BOOST_MATH_SPECIAL_BERNOULLI_HPP
  ...
  namespace math
  {
    namespace bernoulli_detail
    {
      ...
      inline bool check_dist_and_k(const char* function, const RealType& p, RealType k, RealType* result, const Policy& pol)
      {
        ...
        if(!(streams_boost::math::isfinite)(k) || !((k == 0) || (k == 1)))
        {
          *result = policies::raise_domain_error<RealType>(
            function,
    ...
    public:
      ...
      { // Default probability = half suits 'fair' coin tossing
        ...
        bernoulli_detail::check_dist(
           "streams_boost::math::bernoulli_distribution<%1%>::bernoulli_distribution",
          m_p,
          &result, Policy());
    ...
    { // Probability Density/Mass Function.
      ...
      if(false == bernoulli_detail::check_dist_and_k(
        "streams_boost::math::pdf(bernoulli_distribution<%1%>, %1%)",
    ...
    { // Cumulative Distribution Function Bernoulli.
      ...
      RealType result;
      if(false == bernoulli_detail::check_dist_and_k(
        "streams_boost::math::cdf(bernoulli_distribution<%1%>, %1%)",
        p,
        k,
        &result, Policy()))
      {
    ...
    { // Quantile or Percent Point Bernoulli function.
      ...
      if(false == bernoulli_detail::check_dist_and_prob(
        "streams_boost::math::quantile(bernoulli_distribution<%1%>, %1%)",
...
#endif // STREAMS_BOOST_MATH_SPECIAL_BERNOULLI_HPP
