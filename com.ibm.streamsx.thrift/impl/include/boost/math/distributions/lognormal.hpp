...
#ifndef STREAMS_BOOST_STATS_LOGNORMAL_HPP
#define STREAMS_BOOST_STATS_LOGNORMAL_HPP
...
#include <streams_boost/math/distributions/normal.hpp>
...
public:
   ...
   {
      RealType result;
      detail::check_scale("streams_boost::math::lognormal_distribution<%1%>::lognormal_distribution", scale, &result, Policy());
   }
...
RealType pdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "streams_boost::math::pdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType cdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "streams_boost::math::cdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType quantile(const lognormal_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "streams_boost::math::quantile(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType mean(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result;
   if(0 == detail::check_scale("streams_boost::math::mean(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
...
inline RealType variance(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result;
   if(0 == detail::check_scale("streams_boost::math::variance(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;

   return streams_boost::math::expm1(sigma * sigma, Policy()) * exp(2 * mu + sigma * sigma);
}
...
inline RealType mode(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result;
   if(0 == detail::check_scale("streams_boost::math::mode(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
...
inline RealType skewness(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result;
   if(0 == detail::check_scale("streams_boost::math::skewness(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;

   return (ess + 2) * sqrt(streams_boost::math::expm1(ss, Policy()));
}
...
inline RealType kurtosis(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result;
   if(0 == detail::check_scale("streams_boost::math::kurtosis(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
...
inline RealType kurtosis_excess(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result;
   if(0 == detail::check_scale("streams_boost::math::kurtosis_excess(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
...
#endif // STREAMS_BOOST_STATS_STUDENTS_T_HPP
