...
#ifndef STREAMS_BOOST_MATH_SPECIAL_HERMITE_HPP
#define STREAMS_BOOST_MATH_SPECIAL_HERMITE_HPP
   ...
   hermite(unsigned n, T x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::hermite_imp(n, static_cast<value_type>(x)), "streams_boost::math::hermite<%1%>(unsigned, %1%)");
}
...
{
   return streams_boost::math::hermite(n, x, policies::policy<>());
}

} // namespace math
} // namespace streams_boost

#endif // STREAMS_BOOST_MATH_SPECIAL_HERMITE_HPP
