...
#ifndef STREAMS_BOOST_MATH_SF_CBRT_HPP
#define STREAMS_BOOST_MATH_SF_CBRT_HPP
...
T cbrt_imp(T z, const Policy& pol)
{
   ...
   policies::check_root_iterations("streams_boost::math::cbrt<%1%>", max_iter, pol);
   return guess;
}
...
#endif // STREAMS_BOOST_MATH_SF_CBRT_HPP
