...
#ifndef STREAMS_BOOST_MATH_ELLINT_RC_HPP
#define STREAMS_BOOST_MATH_ELLINT_RC_HPP
...
T ellint_rc_imp(T x, T y, const Policy& pol)
{
    ...
    static const char* function = "streams_boost::math::ellint_rc<%1%>(%1%,%1%)";
   ...
   ellint_rc(T1 x, T2 y, const Policy& pol)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_rc_imp(
         ...
         static_cast<value_type>(y), pol), "streams_boost::math::ellint_rc<%1%>(%1%,%1%)");
}
...
#endif // STREAMS_BOOST_MATH_ELLINT_RC_HPP
