//  streams_boost sinhc.hpp header file
...
#ifndef STREAMS_BOOST_SINHC_HPP
#define STREAMS_BOOST_SINHC_HPP
...
namespace streams_boost
{
    namespace math
    {
       namespace detail
       {
        ...
        {
#if defined(STREAMS_BOOST_NO_STDC_NAMESPACE) && !defined(__SUNPRO_CC)
            using    ::abs;
            using    ::sinh;
            using    ::sqrt;
#else    /* STREAMS_BOOST_NO_STDC_NAMESPACE */
            using    ::std::abs;
            using    ::std::sinh;
            using    ::std::sqrt;
#endif    /* STREAMS_BOOST_NO_STDC_NAMESPACE */
       ...
       {
          return streams_boost::math::sinhc_pi(x);
       }

#ifdef    STREAMS_BOOST_NO_TEMPLATE_TEMPLATES
#else    /* STREAMS_BOOST_NO_TEMPLATE_TEMPLATES */
        template<typename T, template<typename> class U>
        inline U<T>    sinhc_pi(const U<T> x)
        {
#if defined(STREAMS_BOOST_FUNCTION_SCOPE_USING_DECLARATION_BREAKS_ADL) || defined(__GNUC__)
            using namespace std;
#elif    defined(STREAMS_BOOST_NO_STDC_NAMESPACE) && !defined(__SUNPRO_CC)
            using    ::abs;
            using    ::sinh;
            using    ::sqrt;
#else    /* STREAMS_BOOST_NO_STDC_NAMESPACE */
...
#endif    /* STREAMS_BOOST_NO_TEMPLATE_TEMPLATES */
    }
}

#endif /* STREAMS_BOOST_SINHC_HPP */
