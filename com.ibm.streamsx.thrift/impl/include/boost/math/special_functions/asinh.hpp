//    streams_boost asinh.hpp header file
...
#ifndef STREAMS_BOOST_ASINH_HPP
#define STREAMS_BOOST_ASINH_HPP
...
namespace streams_boost
{
    namespace math
    {
       namespace detail{
            ...
            if        (x >= tools::forth_root_epsilon<T>())
            {
               if        (x > 1 / tools::root_epsilon<T>())
                ...
                else if(x < 0.5f)
                {
                   ...
                   return streams_boost::math::log1p(x + streams_boost::math::sqrt1pm1(x * x, pol), pol);
                }
                else
                {
        ...
        {
           return streams_boost::math::asinh(x, policies::policy<>());
        }
        ...
        inline typename tools::promote_args<T>::type asinh(T x, const Policy&)
        {
           ...
           return policies::checked_narrowing_cast<result_type, forwarding_policy>(
              ...
              "streams_boost::math::asinh<%1%>(%1%)");
        }

    }
}

#endif /* STREAMS_BOOST_ASINH_HPP */
