...
//
#ifndef STREAMS_BOOST_MATH_ELLINT_RF_HPP
#define STREAMS_BOOST_MATH_ELLINT_RF_HPP
...
T ellint_rf_imp(T x, T y, T z, const Policy& pol)
{
    ...
    static const char* function = "streams_boost::math::ellint_rf<%1%>(%1%,%1%,%1%)";
    ...
    STREAMS_BOOST_MATH_INSTRUMENT_VARIABLE(value);
   ...
   ellint_rf(T1 x, T2 y, T3 z, const Policy& pol)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_rf_imp(
         ...
         static_cast<value_type>(z), pol), "streams_boost::math::ellint_rf<%1%>(%1%,%1%,%1%)");
}
...
#endif // STREAMS_BOOST_MATH_ELLINT_RF_HPP
