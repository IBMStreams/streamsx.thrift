...
#ifndef STREAMS_BOOST_MATH_SPECIAL_FUNCTIONS_LANCZOS
#define STREAMS_BOOST_MATH_SPECIAL_FUNCTIONS_LANCZOS
...
#include <streams_boost/mpl/less_equal.hpp>
...
struct lanczos6 : public mpl::int_<35>
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const STREAMS_BOOST_MATH_INT_TABLE_TYPE(T, streams_boost::uint16_t) denom[6] = {
         static_cast<streams_boost::uint16_t>(0u),
         static_cast<streams_boost::uint16_t>(24u),
         static_cast<streams_boost::uint16_t>(50u),
         static_cast<streams_boost::uint16_t>(35u),
         static_cast<streams_boost::uint16_t>(10u),
         static_cast<streams_boost::uint16_t>(1u)
      };
      return streams_boost::math::tools::evaluate_rational(num, denom, z);
   }
...
struct lanczos11 : public mpl::int_<60>
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const STREAMS_BOOST_MATH_INT_TABLE_TYPE(T, streams_boost::uint32_t) denom[11] = {
         static_cast<streams_boost::uint32_t>(0u),
         static_cast<streams_boost::uint32_t>(362880u),
         static_cast<streams_boost::uint32_t>(1026576u),
         static_cast<streams_boost::uint32_t>(1172700u),
         static_cast<streams_boost::uint32_t>(723680u),
         static_cast<streams_boost::uint32_t>(269325u),
         static_cast<streams_boost::uint32_t>(63273u),
         static_cast<streams_boost::uint32_t>(9450u),
         static_cast<streams_boost::uint32_t>(870u),
         static_cast<streams_boost::uint32_t>(45u),
...
struct lanczos13 : public mpl::int_<72>
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const STREAMS_BOOST_MATH_INT_TABLE_TYPE(T, streams_boost::uint32_t) denom[13] = {
         static_cast<streams_boost::uint32_t>(0u),
...
struct lanczos22 : public mpl::int_<120>
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const STREAMS_BOOST_MATH_INT_TABLE_TYPE(T, streams_boost::uint64_t) denom[22] = {
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(0, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(2432902008176640000, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(8752948036761600000, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(13803759753640704000, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(12870931245150988800, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(8037811822645051776, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(3599979517947607200, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1206647803780373360, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(311333643161390640, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(63030812099294896, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(10142299865511450, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1307535010540395, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(135585182899530, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(11310276995381, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(756111184500, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(40171771630, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1672280820, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(53327946, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1256850, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(20615, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(210, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1, uLL)
      };
      return streams_boost::math::tools::evaluate_rational(num, denom, z);
   }
...
struct lanczos17m64 : public mpl::int_<64>
{
   ...
   static T lanczos_sum(const T& z)
   {
      ...
      static const STREAMS_BOOST_MATH_INT_TABLE_TYPE(T, streams_boost::uint64_t) denom[17] = {
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(0, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1307674368000, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(4339163001600, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(6165817614720, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(5056995703824, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(2706813345600, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1009672107080, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(272803210680, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(54631129553, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(8207628000, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(928095740, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(78558480, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(4899622, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(218400, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(6580, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(120, uLL),
         STREAMS_BOOST_MATH_INT_VALUE_SUFFIX(1, uLL)
      };
      return streams_boost::math::tools::evaluate_rational(num, denom, z);
   }
...
#define STREAMS_BOOST_MATH_FLT_DIGITS ::std::numeric_limits<float>::digits
#define STREAMS_BOOST_MATH_DBL_DIGITS ::std::numeric_limits<double>::digits
#define STREAMS_BOOST_MATH_LDBL_DIGITS ::std::numeric_limits<long double>::digits
#else
#define STREAMS_BOOST_MATH_FLT_DIGITS FLT_MANT_DIG
#define STREAMS_BOOST_MATH_DBL_DIGITS DBL_MANT_DIG
#define STREAMS_BOOST_MATH_LDBL_DIGITS LDBL_MANT_DIG
#endif
#endif
...
#include <streams_boost/math/special_functions/detail/lanczos_sse2.hpp>
#endif

#endif // STREAMS_BOOST_MATH_SPECIAL_FUNCTIONS_LANCZOS
