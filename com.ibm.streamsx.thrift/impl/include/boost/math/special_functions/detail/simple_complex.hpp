...
#ifndef STREAMS_BOOST_MATH_SF_DETAIL_SIMPLE_COMPLEX_HPP
#define STREAMS_BOOST_MATH_SF_DETAIL_SIMPLE_COMPLEX_HPP

#ifdef _MSC_VER
#pragma once
#endif

namespace streams_boost{ namespace math{ namespace detail{ namespace sc{
