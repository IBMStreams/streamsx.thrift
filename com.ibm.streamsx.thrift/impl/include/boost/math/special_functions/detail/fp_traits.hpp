...
#ifndef STREAMS_BOOST_MATH_FP_TRAITS_HPP
#define STREAMS_BOOST_MATH_FP_TRAITS_HPP
...
#   define STREAMS_BOOST_FPCLASSIFY_VAX_FORMAT
#endif
...
#define STREAMS_BOOST_HAS_FPCLASSIFY
...
#           define STREAMS_BOOST_FPCLASSIFY_PREFIX ::__std_alias:: 
#        else
#           define STREAMS_BOOST_FPCLASSIFY_PREFIX ::_STLP_VENDOR_CSTD:: 
#        endif
#     else
#        define STREAMS_BOOST_FPCLASSIFY_PREFIX ::std::
#     endif
#  else
#     undef STREAMS_BOOST_HAS_FPCLASSIFY
#     define STREAMS_BOOST_FPCLASSIFY_PREFIX
#  endif
...
#ifndef STREAMS_BOOST_FPCLASSIFY_VAX_FORMAT

template<> struct fp_traits_non_native<float, single_precision>
{
    typedef ieee_copy_all_bits_tag method;

    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7f800000);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00000000);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, significand = 0x007fffff);
...
#if defined(STREAMS_BOOST_NO_INT64_T) || defined(STREAMS_BOOST_NO_INCLASS_MEMBER_INITIALIZATION) \
...
template<> struct fp_traits_non_native<double, double_precision>
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7ff00000);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, flag        = 0);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, significand = 0x000fffff);
...
private:
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, offset_ = 0);
#elif defined(STREAMS_BOOST_LITTLE_ENDIAN)
    STREAMS_BOOST_STATIC_CONSTANT(int, offset_ = 4);
#else
    STREAMS_BOOST_STATIC_ASSERT(false);
#endif
};
...
#endif  // #ifndef STREAMS_BOOST_FPCLASSIFY_VAX_FORMAT
...
struct fp_traits_non_native<long double, extended_double_precision>
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, sign        = 0x80000000u);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7fff0000);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00008000);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, significand = 0x00007fff);
...
private:
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, offset_ = 0);
#elif defined(STREAMS_BOOST_LITTLE_ENDIAN)
    STREAMS_BOOST_STATIC_CONSTANT(int, offset_ = 12);
#else
    STREAMS_BOOST_STATIC_ASSERT(false);
#endif
};
...
struct fp_traits_non_native<long double, extended_double_precision>
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, exponent    = 0x7fff0000);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, flag        = 0x00000000);
    STREAMS_BOOST_STATIC_CONSTANT(uint32_t, significand = 0x0000ffff);
...
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME size_to_precision<sizeof(T), ::streams_boost::is_floating_point<T>::value>::type precision;
...
#if (defined(STREAMS_BOOST_MATH_USE_C99) && !(defined(__GNUC__) && (__GNUC__ < 4))) \
   && !defined(__hpux) \
   && !defined(__DECCXX)\
   && !defined(__osf__) \
   && !defined(__SGI_STL_PORT) && !defined(_STLPORT_VERSION)
#  define STREAMS_BOOST_MATH_USE_STD_FPCLASSIFY
#endif
