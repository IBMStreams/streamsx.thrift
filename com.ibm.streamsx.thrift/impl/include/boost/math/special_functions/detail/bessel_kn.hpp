...
#ifndef STREAMS_BOOST_MATH_BESSEL_KN_HPP
#define STREAMS_BOOST_MATH_BESSEL_KN_HPP

#ifdef _MSC_VER
#pragma once
#endif

#include <streams_boost/math/special_functions/detail/bessel_k0.hpp>
#include <streams_boost/math/special_functions/detail/bessel_k1.hpp>
...
T bessel_kn(int n, T x, const Policy& pol)
{
    ...
    static const char* function = "streams_boost::math::bessel_kn<%1%>(%1%,%1%)";
...
#endif // STREAMS_BOOST_MATH_BESSEL_KN_HPP
