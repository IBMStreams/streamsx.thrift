...
#ifndef STREAMS_BOOST_MATH_BESSEL_YN_HPP
#define STREAMS_BOOST_MATH_BESSEL_YN_HPP

#ifdef _MSC_VER
#pragma once
#endif

#include <streams_boost/math/special_functions/detail/bessel_y0.hpp>
#include <streams_boost/math/special_functions/detail/bessel_y1.hpp>
...
T bessel_yn(int n, T x, const Policy& pol)
{
    ...
    static const char* function = "streams_boost::math::bessel_yn<%1%>(%1%,%1%)";
...
#endif // STREAMS_BOOST_MATH_BESSEL_YN_HPP
