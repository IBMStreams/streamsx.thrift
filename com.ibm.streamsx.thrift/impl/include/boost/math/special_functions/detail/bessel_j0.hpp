...
#ifndef STREAMS_BOOST_MATH_BESSEL_J0_HPP
#define STREAMS_BOOST_MATH_BESSEL_J0_HPP
...
T bessel_j0(T x)
{
    ...
    {
        T y = x * x;
        STREAMS_BOOST_ASSERT(sizeof(P1) == sizeof(Q1));
    ...
    {
        T y = 1 - (x * x)/64;
        STREAMS_BOOST_ASSERT(sizeof(P2) == sizeof(Q2));
    ...
    else                                // x in (8, \infty)
    {
        ...
        T y2 = y * y;
        T z = x - 0.25f * pi<T>();
        STREAMS_BOOST_ASSERT(sizeof(PC) == sizeof(QC));
        STREAMS_BOOST_ASSERT(sizeof(PS) == sizeof(QS));
...
#endif // STREAMS_BOOST_MATH_BESSEL_J0_HPP
