...
#ifndef STREAMS_BOOST_MATH_BESSEL_K0_HPP
#define STREAMS_BOOST_MATH_BESSEL_K0_HPP
...
{
    STREAMS_BOOST_MATH_INSTRUMENT_CODE(x);
    ...
    static const char* function = "streams_boost::math::bessel_k0<%1%>(%1%,%1%)";
    ...
    else                                // x in (1, \infty)
    {
        ...
        factor = exp(-x) / sqrt(x);
        value = factor * r;
        STREAMS_BOOST_MATH_INSTRUMENT_CODE("y = " << y);
        STREAMS_BOOST_MATH_INSTRUMENT_CODE("r = " << r);
        STREAMS_BOOST_MATH_INSTRUMENT_CODE("factor = " << factor);
        STREAMS_BOOST_MATH_INSTRUMENT_CODE("value = " << value);
    }
...
#endif // STREAMS_BOOST_MATH_BESSEL_K0_HPP
