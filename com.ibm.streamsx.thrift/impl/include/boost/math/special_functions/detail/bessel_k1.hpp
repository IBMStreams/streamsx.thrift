...
#ifndef STREAMS_BOOST_MATH_BESSEL_K1_HPP
#define STREAMS_BOOST_MATH_BESSEL_K1_HPP
...
T bessel_k1(T x, const Policy& pol)
{
    ...
    static const char* function = "streams_boost::math::bessel_k1<%1%>(%1%,%1%)";
...
#endif // STREAMS_BOOST_MATH_BESSEL_K1_HPP
