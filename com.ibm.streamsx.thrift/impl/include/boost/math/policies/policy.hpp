...
template <class T>
int digits(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T));
template <class T>
T epsilon(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T));
...
//
#ifndef STREAMS_BOOST_MATH_DOMAIN_ERROR_POLICY
#define STREAMS_BOOST_MATH_DOMAIN_ERROR_POLICY throw_on_error
#endif
#ifndef STREAMS_BOOST_MATH_POLE_ERROR_POLICY
#define STREAMS_BOOST_MATH_POLE_ERROR_POLICY throw_on_error
#endif
#ifndef STREAMS_BOOST_MATH_OVERFLOW_ERROR_POLICY
#define STREAMS_BOOST_MATH_OVERFLOW_ERROR_POLICY throw_on_error
#endif
#ifndef STREAMS_BOOST_MATH_EVALUATION_ERROR_POLICY
#define STREAMS_BOOST_MATH_EVALUATION_ERROR_POLICY throw_on_error
#endif
#ifndef STREAMS_BOOST_MATH_ROUNDING_ERROR_POLICY
#define STREAMS_BOOST_MATH_ROUNDING_ERROR_POLICY throw_on_error
#endif
#ifndef STREAMS_BOOST_MATH_UNDERFLOW_ERROR_POLICY
#define STREAMS_BOOST_MATH_UNDERFLOW_ERROR_POLICY ignore_error
#endif
#ifndef STREAMS_BOOST_MATH_DENORM_ERROR_POLICY
#define STREAMS_BOOST_MATH_DENORM_ERROR_POLICY ignore_error
#endif
#ifndef STREAMS_BOOST_MATH_INDETERMINATE_RESULT_ERROR_POLICY
#define STREAMS_BOOST_MATH_INDETERMINATE_RESULT_ERROR_POLICY ignore_error
#endif
#ifndef STREAMS_BOOST_MATH_DIGITS10_POLICY
#define STREAMS_BOOST_MATH_DIGITS10_POLICY 0
#endif
#ifndef STREAMS_BOOST_MATH_PROMOTE_FLOAT_POLICY
#define STREAMS_BOOST_MATH_PROMOTE_FLOAT_POLICY true
#endif
#ifndef STREAMS_BOOST_MATH_PROMOTE_DOUBLE_POLICY
#ifdef STREAMS_BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
#define STREAMS_BOOST_MATH_PROMOTE_DOUBLE_POLICY false
#else
#define STREAMS_BOOST_MATH_PROMOTE_DOUBLE_POLICY true
#endif
#endif
#ifndef STREAMS_BOOST_MATH_DISCRETE_QUANTILE_POLICY
#define STREAMS_BOOST_MATH_DISCRETE_QUANTILE_POLICY integer_round_outwards
#endif
#ifndef STREAMS_BOOST_MATH_ASSERT_UNDEFINED_POLICY
#define STREAMS_BOOST_MATH_ASSERT_UNDEFINED_POLICY true
#endif
#ifndef STREAMS_BOOST_MATH_MAX_SERIES_ITERATION_POLICY
#define STREAMS_BOOST_MATH_MAX_SERIES_ITERATION_POLICY 1000000
#endif
#ifndef STREAMS_BOOST_MATH_MAX_ROOT_ITERATION_POLICY
#define STREAMS_BOOST_MATH_MAX_ROOT_ITERATION_POLICY 200
#endif

#if !defined(__BORLANDC__) \
   && !(defined(__GNUC__) && (__GNUC__ == 3) && (__GNUC_MINOR__ <= 2))
#define STREAMS_BOOST_MATH_META_INT(type, name, Default)\
   template <type N = Default> struct name : public streams_boost::mpl::int_<N>{};\
   namespace detail{\
   template <type N>\
   ...
   {\
      ...
      static double test(...);\
      STREAMS_BOOST_STATIC_CONSTANT(bool, value = sizeof(test(static_cast<T*>(0))) == 1);\
   };\
   }\
   template <class T> struct is_##name : public streams_boost::mpl::bool_< ::streams_boost::math::policies::detail::is_##name##_imp<T>::value>{};

#define STREAMS_BOOST_MATH_META_BOOL(name, Default)\
   template <bool N = Default> struct name : public streams_boost::mpl::bool_<N>{};\
   namespace detail{\
   template <bool N>\
   char test_is_valid_arg(const name<N>*);\
   char test_is_default_arg(const name<Default>*);\
...
#define STREAMS_BOOST_MATH_META_INT(Type, name, Default)\
   ...
   {\
      static T inst;\
      STREAMS_BOOST_STATIC_CONSTANT(bool, value = sizeof( ::streams_boost::math::policies::detail::is_##name##_tester<T>::test(inst)) == 1);\
   };\
   }\
   template <class T> struct is_##name : public streams_boost::mpl::bool_< ::streams_boost::math::policies::detail::is_##name##_imp<T>::value>\
   {\
...
STREAMS_BOOST_MATH_META_INT(error_policy_type, domain_error, STREAMS_BOOST_MATH_DOMAIN_ERROR_POLICY)
STREAMS_BOOST_MATH_META_INT(error_policy_type, pole_error, STREAMS_BOOST_MATH_POLE_ERROR_POLICY)
STREAMS_BOOST_MATH_META_INT(error_policy_type, overflow_error, STREAMS_BOOST_MATH_OVERFLOW_ERROR_POLICY)
STREAMS_BOOST_MATH_META_INT(error_policy_type, underflow_error, STREAMS_BOOST_MATH_UNDERFLOW_ERROR_POLICY)
STREAMS_BOOST_MATH_META_INT(error_policy_type, denorm_error, STREAMS_BOOST_MATH_DENORM_ERROR_POLICY)
STREAMS_BOOST_MATH_META_INT(error_policy_type, evaluation_error, STREAMS_BOOST_MATH_EVALUATION_ERROR_POLICY)
STREAMS_BOOST_MATH_META_INT(error_policy_type, rounding_error, STREAMS_BOOST_MATH_ROUNDING_ERROR_POLICY)
STREAMS_BOOST_MATH_META_INT(error_policy_type, indeterminate_result_error, STREAMS_BOOST_MATH_INDETERMINATE_RESULT_ERROR_POLICY)

//
// Policy types for internal promotion:
//
STREAMS_BOOST_MATH_META_BOOL(promote_float, STREAMS_BOOST_MATH_PROMOTE_FLOAT_POLICY)
STREAMS_BOOST_MATH_META_BOOL(promote_double, STREAMS_BOOST_MATH_PROMOTE_DOUBLE_POLICY)
STREAMS_BOOST_MATH_META_BOOL(assert_undefined, STREAMS_BOOST_MATH_ASSERT_UNDEFINED_POLICY)
//
...
STREAMS_BOOST_MATH_META_INT(discrete_quantile_policy_type, discrete_quantile, STREAMS_BOOST_MATH_DISCRETE_QUANTILE_POLICY)
//
// Precision:
//
STREAMS_BOOST_MATH_META_INT(int, digits10, STREAMS_BOOST_MATH_DIGITS10_POLICY)
STREAMS_BOOST_MATH_META_INT(int, digits2, 0)
//
// Iterations:
//
STREAMS_BOOST_MATH_META_INT(unsigned long, max_series_iterations, STREAMS_BOOST_MATH_MAX_SERIES_ITERATION_POLICY)
STREAMS_BOOST_MATH_META_INT(unsigned long, max_root_iterations, STREAMS_BOOST_MATH_MAX_ROOT_ITERATION_POLICY)
//
// Define the names for each possible policy:
//
#define STREAMS_BOOST_MATH_PARAMETER(name)\
   STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(name##_name)\
   STREAMS_BOOST_PARAMETER_NAME(name##_name)
...
#ifdef __BORLANDC__
   typedef typename mpl::if_c<
      (Digits2::value > ::streams_boost::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
public:
   typedef typename select_result<
      DefaultType, iter,
      ::streams_boost::is_same<iter, end_type>::value>::type type;
};
...
{
   STREAMS_BOOST_STATIC_CONSTANT(bool, value = sizeof(::streams_boost::math::policies::detail::test_is_valid_arg(static_cast<T*>(0))) == 1);
};

template <class T>
struct is_default_policy_imp
{
   STREAMS_BOOST_STATIC_CONSTANT(bool, value = sizeof(::streams_boost::math::policies::detail::test_is_default_arg(static_cast<T*>(0))) == 1);
};

template <class T> struct is_valid_policy 
: public mpl::bool_< 
   ::streams_boost::math::policies::detail::is_valid_policy_imp<T>::value>
{};

template <class T> struct is_default_policy 
: public mpl::bool_< 
   ::streams_boost::math::policies::detail::is_default_policy_imp<T>::value>
{
   template <class U>
   struct apply
   {
...
typedef default_args<STREAMS_BOOST_MATH_PROMOTE_FLOAT_POLICY, STREAMS_BOOST_MATH_PROMOTE_DOUBLE_POLICY>::arg1 forwarding_arg1;
typedef default_args<STREAMS_BOOST_MATH_PROMOTE_FLOAT_POLICY, STREAMS_BOOST_MATH_PROMOTE_DOUBLE_POLICY>::arg2 forwarding_arg2;
...
private:
   ...
   //
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A1>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A2>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A3>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A4>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A5>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A6>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A7>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A8>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A9>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A10>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A11>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A12>::value);
   STREAMS_BOOST_STATIC_ASSERT(::streams_boost::math::policies::detail::is_valid_policy<A13>::value);
   //
...
#if STREAMS_BOOST_MATH_DIGITS10_POLICY == 0
...
private:
   ...
   //
   typedef typename detail::append_N<reduced_list, default_policy, (14 - ::streams_boost::mpl::size<reduced_list>::value)>::type result_type;
public:
   typedef policy<
...
#ifdef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
inline int digits_imp(mpl::true_ const&)
{
   ...
   STREAMS_BOOST_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
#else
   STREAMS_BOOST_ASSERT(::std::numeric_limits<T>::is_specialized);
#endif
   typedef typename streams_boost::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}
...
template <class T, class Policy>
inline int digits(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
...
struct series_factor_calc<T, Digits, mpl::true_, mpl::true_>
{
   static T get()
   {
      return streams_boost::math::tools::epsilon<T>();
   }
};
template <class T, class Digits>
struct series_factor_calc<T, Digits, mpl::true_, mpl::false_>
{
   static T get()
   {
      static const streams_boost::uintmax_t v = static_cast<streams_boost::uintmax_t>(1u) << (Digits::value - 1);
...
#endif
   typedef typename streams_boost::math::policies::precision<T, Policy>::type p_t;
   typedef mpl::bool_<p_t::value <= std::numeric_limits<streams_boost::uintmax_t>::digits> is_small_int;
...
template <class T, class Policy>
inline T get_epsilon(STREAMS_BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
   typedef mpl::bool_< std::numeric_limits<T>::is_specialized > tag_type;
...
{
   STREAMS_BOOST_STATIC_CONSTANT(bool, value = (sizeof(::streams_boost::math::policies::detail::test_is_policy(static_cast<P*>(0))) == 1));
};

}

template <class P>
struct is_policy : public mpl::bool_< ::streams_boost::math::policies::detail::is_policy_imp<P>::value> {};

}}} // namespaces

#endif // STREAMS_BOOST_MATH_POLICY_HPP
