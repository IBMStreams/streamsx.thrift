#ifndef STREAMS_BOOST_RANGE_MFC_HPP
#define STREAMS_BOOST_RANGE_MFC_HPP
...
#if !defined(STREAMS_BOOST_RANGE_MFC_NO_CPAIR)
    #if (_MFC_VER < 0x0700) // dubious
        #define STREAMS_BOOST_RANGE_MFC_NO_CPAIR
    #endif
#endif


#if !defined(STREAMS_BOOST_RANGE_MFC_HAS_LEGACY_STRING)
    #if (_MFC_VER < 0x0700) // dubious
        #define STREAMS_BOOST_RANGE_MFC_HAS_LEGACY_STRING
    #endif
#endif
...
//
#if !defined(STREAMS_BOOST_RANGE_MFC_CONST_COL_RETURNS_NON_REF)
    #if (_MFC_VER < 0x0700) // dubious
        #define STREAMS_BOOST_RANGE_MFC_CONST_COL_RETURNS_NON_REF
    #endif
#endif
...
#include <streams_boost/range/atl.hpp>
...
namespace streams_boost { namespace range_detail_microsoft {
    ...
    public:
        ...
        explicit mfc_ptr_array_iterator(ArrayT& arr, INT_PTR index) :
            super_t(index), m_parr(streams_boost::addressof(arr))
        { }
    ...
    friend class iterator_core_access;
        ...
        {
            STREAMS_BOOST_ASSERT(0 <= this->base() && this->base() < m_parr->GetSize() && "out of range");
            return *( m_parr->GetData() + this->base() );
        }

        bool equal(self_t const& other) const
        {
            STREAMS_BOOST_ASSERT(m_parr == other.m_parr && "iterators incompatible");
    ...
    public:
        ...
        explicit mfc_map_iterator(MapT const& map, POSITION pos) :
            m_pmap(streams_boost::addressof(map)), m_posNext(pos)
        {
            increment();
        }
    ...
    friend class iterator_core_access;
        ...
        bool equal(self_t const& other) const
        {
            STREAMS_BOOST_ASSERT(m_pmap == other.m_pmap && "iterators incompatible");
    ...
    public:
        ...
        explicit mfc_cpair_map_iterator(MapT& map, PairT *pp) :
            m_pmap(streams_boost::addressof(map)), m_pp(pp)
        { }
    ...
    friend class iterator_core_access;
        ref_t dereference() const
        {
            STREAMS_BOOST_ASSERT(m_pp != 0 && "out of range");
            return *m_pp;
        }
...
#endif // !defined(STREAMS_BOOST_RANGE_MFC_NO_CPAIR)
    ...
    struct customization< ::CTypedPtrArray<BaseClass, PtrType> >
    {
        ...
        Iterator begin(X& x)
        {
            return Iterator(streams_boost::begin<BaseClass>(x), fun<X>());
        }

        template< class Iterator, class X >
        Iterator end(X& x)
        {
            return Iterator(streams_boost::end<BaseClass>(x), fun<X>());
        }
    };
...
#endif // defined(STREAMS_BOOST_RANGE_MFC_HAS_LEGACY_STRING)
...
STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    ...
    STREAMS_BOOST_PP_NIL, CByteArray
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CDWordArray
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CStringArray
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CUIntArray
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CWordArray
)
...
STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CObList
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CPtrList
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CStringList
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CObArray
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CPtrArray
)
...
STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMapPtrToWord
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMapPtrToPtr
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMapStringToOb
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMapStringToPtr
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMapStringToString
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMapWordToOb
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMapWordToPtr
)
...
STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CArray, 2
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CList, 2
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CMap, 4
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CTypedPtrArray, 2
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CTypedPtrList, 2
)

STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    STREAMS_BOOST_PP_NIL, CTypedPtrMap, 3
)
