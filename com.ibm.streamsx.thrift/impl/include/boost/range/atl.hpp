#ifndef STREAMS_BOOST_RANGE_ATL_HPP
#define STREAMS_BOOST_RANGE_ATL_HPP
...
#if !defined(STREAMS_BOOST_RANGE_ATL_NO_COLLECTIONS)
    #if (_ATL_VER < 0x0700)
        #define STREAMS_BOOST_RANGE_ATL_NO_COLLECTIONS
    #endif
#endif


#if !defined(STREAMS_BOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX)
    #if (_ATL_VER < 0x0700) // dubious
        #define STREAMS_BOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX
    #endif
#endif


#if !defined(STREAMS_BOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
    #if (_MSC_VER < 1310)   // from <streams_boost/regex/mfc.hpp>, but dubious
        #define STREAMS_BOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING
    #endif
#endif
...
#endif // !defined(STREAMS_BOOST_RANGE_ATL_NO_COLLECTIONS)
...
#endif // !defined(STREAMS_BOOST_RANGE_ATL_HAS_OLD_CSIMPLE_XXX)
...
#include <streams_boost/iterator/indirect_iterator.hpp>
#include <streams_boost/iterator/zip_iterator.hpp>
#include <streams_boost/range/detail/microsoft.hpp>
...
namespace streams_boost { namespace range_detail_microsoft {
...
#endif
    {
        ...
        Iterator begin(X& x)
        {
            return Iterator(streams_boost::make_tuple(x.m_aKey, x.m_aVal));
        }

        template< class Iterator, class X >
        Iterator end(X& x)
        {
            return Iterator(streams_boost::make_tuple(x.m_aKey + x.GetSize(), x.m_aVal + x.GetSize()));
        }
    };
...
//
    ...
    // arrays
    //
    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CAtlArray, 2
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CAutoPtrArray, 1
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CInterfaceArray, (class)(const IID *)
    )
    ...
    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CAtlList, 2
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CAutoPtrList, 1
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CHeapPtrList, 2
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CInterfaceList, (class)(const IID *)
    )
    ...
    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CAtlMap, 4
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CRBTree, 4
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CRBMap, 4
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::atl_rb_tree_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CRBMultiMap, 4
    )
    ...
    #if !defined(STREAMS_BOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
        STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
            streams_boost::range_detail_microsoft::atl_string_tag,
            (ATL, STREAMS_BOOST_PP_NIL), CSimpleStringT, (class)(bool)
        )
    #else
        STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
            streams_boost::range_detail_microsoft::atl_string_tag,
            (ATL, STREAMS_BOOST_PP_NIL), CSimpleStringT, 1
        )
    #endif

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::atl_string_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CStringT, 2
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::atl_string_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CFixedStringT, (class)(int)
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CStaticString, (class)(const int)
    )
...
STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(
    streams_boost::range_detail_microsoft::using_type_as_tag,
    (ATL, STREAMS_BOOST_PP_NIL), CComBSTR
)
...
//
    ...
    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CSimpleArray, 2
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CSimpleMap, 3
    )
    ...
    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CSimpleArray, 1
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CSimpleMap, 2
    )

    STREAMS_BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        streams_boost::range_detail_microsoft::using_type_as_tag,
        (ATL, STREAMS_BOOST_PP_NIL), CSimpleValArray, 1
    )
