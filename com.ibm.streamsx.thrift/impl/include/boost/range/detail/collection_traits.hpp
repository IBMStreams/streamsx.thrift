...
#ifndef STREAMS_BOOST_RANGE_STRING_COLLECTION_TRAITS_HPP
#define STREAMS_BOOST_RANGE_STRING_COLLECTION_TRAITS_HPP
...
// Implementation
#include <streams_boost/range/detail/collection_traits_detail.hpp>
...
//  collection_traits template class -----------------------------------------//
        ...
        */
        ...
        {
        private:
            typedef STREAMS_BOOST_STRING_TYPENAME ::streams_boost::mpl::eval_if< 
                    ::streams_boost::algorithm::detail::is_pair<T>, 
                        detail::pair_container_traits_selector<T>,
                        STREAMS_BOOST_STRING_TYPENAME ::streams_boost::mpl::eval_if< 
                        ::streams_boost::is_array<T>, 
                            detail::array_container_traits_selector<T>,
                            STREAMS_BOOST_STRING_TYPENAME ::streams_boost::mpl::eval_if<
                            ::streams_boost::is_pointer<T>,
...
//  collection_traits metafunctions -----------------------------------------//
        ...
        */
        ...
        {
            typedef STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::value_type type;
        };
        ...
        */
        ...
        {
            typedef STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::difference_type type;
        };
        ...
        */
        ...
        struct iterator_of
        {
            typedef STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::iterator type;
        };
        ...
        */
        ...
        {
            typedef STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::const_iterator type;
        };
        ...
        */
        ...
        {
            typedef STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::result_iterator type;
        };
...
//  collection_traits related functions -----------------------------------------//
        ...
        */
        template< typename C >
        inline STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::size_type
        size( const C& c )
        {
        ...
        */
        template< typename C >
        inline STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::iterator
        begin( C& c )
        {
        ...
        */
        template< typename C >
        inline STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::const_iterator
        begin( const C& c )
        {
            return collection_traits<C>::function_type::begin( c ); 
        }
        ...
        */
        template< typename C >
        inline STREAMS_BOOST_STRING_TYPENAME collection_traits<C>::result_iterator
        begin( C& c )
        {
            return collection_traits<C>::function_type::begin( c );
        }
...
#endif // STREAMS_BOOST_STRING_COLLECTION_TRAITS_HPP
