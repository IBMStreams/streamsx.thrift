...
#ifndef STREAMS_BOOST_RANGE_DETAIL_DETAIL_STR_HPP
#define STREAMS_BOOST_RANGE_DETAIL_DETAIL_STR_HPP
...
namespace streams_boost 
{
    ...
    namespace range_detail
    {
        ...
        { 
            ...
            struct pts
            {
                typedef const STREAMS_BOOST_RANGE_DEDUCED_TYPENAME 
                    remove_extent<T>::type* type;
            };
        };
...
#include <streams_boost/range/detail/size_type>
#include <streams_boost/range/detail/value_type>
...
namespace streams_boost 
{
    ...
    namespace range_detail
    {
        ...
        str_begin( C& c )
        {
            return range_detail::range_begin< STREAMS_BOOST_RANGE_DEDUCED_TYPENAME 
        ...
        struct range_end<char_ptr_>
        {
            static char* fun( char* s )
            {
                return streams_boost::range_detail::str_end( s );
            }
        };
        ...
        str_end( C& c )
        {
            return range_detail::range_end< STREAMS_BOOST_RANGE_DEDUCED_TYPENAME 
                range_detail::range<C>::type >::fun( c );
        }
