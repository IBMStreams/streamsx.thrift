...
#ifndef STREAMS_BOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP
#define STREAMS_BOOST_RANGE_DETAIL_REMOVE_BOUNDS_HPP

#include <streams_boost/config.hpp>  // MSVC, NO_INTRINSIC_WCHAR_T, put size_t in std.
#include <cstddef>
...
namespace streams_boost 
{
    namespace range_detail
    {
        ...
        struct remove_extent {
            static T* ar;
            STREAMS_BOOST_STATIC_CONSTANT(std::size_t, size = sizeof(*ar) / sizeof((*ar)[0]));
