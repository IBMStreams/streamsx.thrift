...
#ifndef STREAMS_BOOST_RANGE_DETAIL_CONST_ITERATOR_HPP
#define STREAMS_BOOST_RANGE_DETAIL_CONST_ITERATOR_HPP
...
namespace streams_boost 
{
    ...
    {      
        ...
        struct range_const_iterator_<std_container_>
        {
            ...
            struct pts
            {
                typedef STREAMS_BOOST_RANGE_DEDUCED_TYPENAME C::const_iterator type;
            };
        };
    ...
    public:
        typedef STREAMS_BOOST_DEDUCED_TYPENAME range_detail::range_const_iterator_<c_type>::STREAMS_BOOST_NESTED_TEMPLATE pts<C>::type type; 
    };
