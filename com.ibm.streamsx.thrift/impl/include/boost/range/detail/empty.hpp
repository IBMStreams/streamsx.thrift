...
#ifndef STREAMS_BOOST_RANGE_DETAIL_EMPTY_HPP
#define STREAMS_BOOST_RANGE_DETAIL_EMPTY_HPP
...
namespace streams_boost 
{
    namespace range_detail
    {
        ...
        struct range_empty<array_>
        {
            ...
            static bool fun( T STREAMS_BOOST_ARRAY_REF[sz] )
            {
                if( streams_boost_range_array == 0 )
                    return true;
                return false;
            }
        };
    ...
    empty( const C& c )
    {
        return range_detail::range_empty<  STREAMS_BOOST_RANGE_DEDUCED_TYPENAME range_detail::range<C>::type >::fun( c );
    }
