...
#ifndef STREAMS_BOOST_RANGE_AS_LITERAL_HPP
#define STREAMS_BOOST_RANGE_AS_LITERAL_HPP
...
#include <streams_boost/range/detail/as_literal.hpp>
#else
...
namespace streams_boost
{
    namespace range_detail
    {
        ...
        template< class T >
        inline iterator_range<STREAMS_BOOST_DEDUCED_TYPENAME range_iterator<T>::type> 
        make_range( T& r, long )
        {
