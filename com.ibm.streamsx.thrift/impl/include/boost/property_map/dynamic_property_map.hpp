...
namespace detail {
  ...
  { return streams_boost::lexical_cast<Value>(value); }
...
public:
  ...
  virtual streams_boost::any get(const any& key) = 0;
...
class dynamic_property_map_adaptor : public dynamic_property_map
{
  ...
  void do_put(const any& in_key, const any& in_value, mpl::bool_<true>)
  {
    ...
    if (in_value.type() == typeid(value_type)) {
#if defined(__GNUC__) && (__GNUC__ == 2) && (__GNUC_MINOR__ == 95)
      streams_boost::put(property_map, key, any_cast<value_type>(in_value));
#else
      ...
      if (v.empty()) {
#if defined(__GNUC__) && (__GNUC__ == 2) && (__GNUC_MINOR__ == 95)
        streams_boost::put(property_map, key, value_type());
#else
        put(property_map, key, value_type());
#endif
      } else {
#if defined(__GNUC__) && (__GNUC__ == 2) && (__GNUC_MINOR__ == 95)
        streams_boost::put(property_map, key, detail::read_value<value_type>(v));
#else
...
public:
  ...
  virtual streams_boost::any get(const any& key)
  {
#if defined(__GNUC__) && (__GNUC__ == 2) && (__GNUC_MINOR__ == 95)
    return streams_boost::get(property_map, any_cast<key_type>(key));
#else
  ...
  virtual std::string get_string(const any& key)
  {
    ...
    out << streams_boost::get(property_map, any_cast<key_type>(key));
    return out.str();
#else
    using streams_boost::get;
...
struct dynamic_properties
{
  typedef std::multimap<std::string, dynamic_property_map*>
    property_maps_type;
  typedef streams_boost::function3<std::auto_ptr<dynamic_property_map>,
                           const std::string&,
                           const streams_boost::any&,
                           const streams_boost::any&> generate_fn_type;
public:
...
#ifndef STREAMS_BOOST_NO_EXPLICIT_FUNCTION_TEMPLATE_ARGUMENTS 
...
inline
std::auto_ptr<streams_boost::dynamic_property_map> 
ignore_other_properties(const std::string&,
                        const streams_boost::any&,
                        const streams_boost::any&) {
  return std::auto_ptr<streams_boost::dynamic_property_map>(0);
}
