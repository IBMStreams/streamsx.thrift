...
#ifndef STREAMS_BOOST_SHARED_ARRAY_PROPERTY_MAP_HPP
#define STREAMS_BOOST_SHARED_ARRAY_PROPERTY_MAP_HPP

#include <streams_boost/smart_ptr/shared_array.hpp>
...
class shared_array_property_map
  : public streams_boost::put_get_helper<T&, shared_array_property_map<T, IndexMap> >
{
  public:
  ...
  private:
  streams_boost::shared_array<T> data;
  IndexMap index;
};
...
#endif // STREAMS_BOOST_SHARED_ARRAY_PROPERTY_MAP_HPP
