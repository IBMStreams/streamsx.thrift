...
//  See http://www.streams_boost.org/libs/property_map for documentation.

#ifndef STREAMS_BOOST_PROPERTY_MAP_HPP
#define STREAMS_BOOST_PROPERTY_MAP_HPP

#include <cassert>
#include <streams_boost/config.hpp>
#include <streams_boost/pending/cstddef.hpp>
#include <streams_boost/detail/iterator.hpp>
#include <streams_boost/concept_check.hpp>
#include <streams_boost/concept_archetype.hpp>
...
#define STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(TYPE) \
  template <> \
  ...
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(long);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(unsigned long);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(int);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(unsigned int);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(short);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(unsigned short);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(char);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(unsigned char);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(signed char);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(bool);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(float);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(double);
  STREAMS_BOOST_SPECIALIZE_PROPERTY_TRAITS_PTR(long double);
...
# endif
  ...
  // do streams_boost::get() anyways, and the using clause
...
namespace streams_boost {
  ...
  struct ReadablePropertyMapConcept
  {
    ...
    typedef streams_boost::readable_property_map_tag ReadableTag;
    void constraints() {
  ...
  struct WritablePropertyMapConcept
  {
    typedef typename property_traits<PMap>::key_type key_type;
    typedef typename property_traits<PMap>::category Category;
    typedef streams_boost::writable_property_map_tag WritableTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef streams_boost::read_write_property_map_tag ReadWriteTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef streams_boost::lvalue_property_map_tag LvalueTag;
    typedef typename property_traits<PMap>::reference reference;
    ...
    void constraints() {
      ...
      STREAMS_BOOST_MPL_ASSERT((streams_boost::mpl::or_<
                          streams_boost::is_same<const value_type&, reference>,
                          streams_boost::is_same<value_type&, reference> >));
  ...
  struct Mutable_LvaluePropertyMapConcept
  {
    ...
    typedef typename property_traits<PMap>::reference reference;
    void constraints() { 
      streams_boost::function_requires< ReadWritePropertyMapConcept<PMap, Key> >();
      streams_boost::function_requires<ConvertibleConcept<Category, LvalueTag> >();
      
      typedef typename property_traits<PMap>::value_type value_type;
      STREAMS_BOOST_MPL_ASSERT((streams_boost::is_same<value_type&, reference>));
  ...
  template <class RandomAccessIterator, 
    class IndexMap
#ifdef STREAMS_BOOST_NO_STD_ITERATOR_TRAITS
    , class T, class R
#else
  ...
  class iterator_property_map
    : public streams_boost::put_get_helper< R, 
  ...
  inline safe_iterator_property_map<
    RAIter, ID,
    typename streams_boost::detail::iterator_traits<RAIter>::value_type,
    typename streams_boost::detail::iterator_traits<RAIter>::reference>
  make_safe_iterator_property_map(RAIter iter, std::size_t n, ID id) {
    function_requires< RandomAccessIteratorConcept<RAIter> >();
    typedef safe_iterator_property_map<
      RAIter, ID,
      typename streams_boost::detail::iterator_traits<RAIter>::value_type,
      typename streams_boost::detail::iterator_traits<RAIter>::reference> PA;
    return PA(iter, n, id);
  }
#endif
  template <class RAIter, class Value, class ID>
  ...
  class static_property_map :
      public
  streams_boost::put_get_helper<ValueType,static_property_map<ValueType> >
  { 
    ValueType value;
  public:
  ...
  class ref_property_map :
    public
      streams_boost::put_get_helper<ValueType&,ref_property_map<KeyType,ValueType> >
  { 
    ValueType* value;
  public:
  ...
  template <typename T>
  struct typed_identity_property_map
    : public streams_boost::put_get_helper<T, typed_identity_property_map<T> >
  {
    typedef T key_type;
    typedef T value_type;
    typedef T reference;
...
//=========================================================================
  ...
  class dummy_property_map 
    : public streams_boost::put_get_helper<detail::dummy_pmap_reference,
        dummy_property_map  > 
  {
  public:
    typedef void key_type; 
    ...
    typedef streams_boost::read_write_property_map_tag category;
...
#include <streams_boost/property_map/vector_property_map.hpp>

#endif /* STREAMS_BOOST_PROPERTY_MAP_HPP */
