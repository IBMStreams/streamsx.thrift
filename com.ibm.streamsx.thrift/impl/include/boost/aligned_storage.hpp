//-----------------------------------------------------------------------------
// streams_boost aligned_storage.hpp header file
...
#ifndef STREAMS_BOOST_ALIGNED_STORAGE_HPP
#define STREAMS_BOOST_ALIGNED_STORAGE_HPP
...
STREAMS_BOOST_STATIC_CONSTANT(
      std::size_t
    , alignment_of_max_align = ::streams_boost::alignment_of<max_align>::value
    );
...
public: // constants
    ...
    STREAMS_BOOST_STATIC_CONSTANT(
        ...
        , alignment = (
              alignment_ == std::size_t(-1)
            ? ::streams_boost::detail::aligned_storage::alignment_of_max_align
            : alignment_
            )
        );
...
struct is_pod<streams_boost::detail::aligned_storage::aligned_storage_imp<size_,alignment_> >
   STREAMS_BOOST_TT_AUX_BOOL_C_BASE(true)
{ 
    STREAMS_BOOST_TT_AUX_BOOL_TRAIT_VALUE_DECL(true)
}; 
#endif
...
#endif // STREAMS_BOOST_ALIGNED_STORAGE_HPP
