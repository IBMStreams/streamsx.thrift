...
#ifndef STREAMS_BOOST_ASIO_SSL_CONTEXT_BASE_HPP
#define STREAMS_BOOST_ASIO_SSL_CONTEXT_BASE_HPP
...
#else
  STREAMS_BOOST_STATIC_CONSTANT(int, default_workarounds = SSL_OP_ALL);
  STREAMS_BOOST_STATIC_CONSTANT(int, single_dh_use = SSL_OP_SINGLE_DH_USE);
  STREAMS_BOOST_STATIC_CONSTANT(int, no_sslv2 = SSL_OP_NO_SSLv2);
  STREAMS_BOOST_STATIC_CONSTANT(int, no_sslv3 = SSL_OP_NO_SSLv3);
  STREAMS_BOOST_STATIC_CONSTANT(int, no_tlsv1 = SSL_OP_NO_TLSv1);
#endif
...
#else
  STREAMS_BOOST_STATIC_CONSTANT(int, verify_none = SSL_VERIFY_NONE);
  STREAMS_BOOST_STATIC_CONSTANT(int, verify_peer = SSL_VERIFY_PEER);
  STREAMS_BOOST_STATIC_CONSTANT(int,
      verify_fail_if_no_peer_cert = SSL_VERIFY_FAIL_IF_NO_PEER_CERT);
  STREAMS_BOOST_STATIC_CONSTANT(int, verify_client_once = SSL_VERIFY_CLIENT_ONCE);
#endif
...
#endif // STREAMS_BOOST_ASIO_SSL_CONTEXT_BASE_HPP
