...
#ifndef STREAMS_BOOST_ASIO_SSL_STREAM_HPP
#define STREAMS_BOOST_ASIO_SSL_STREAM_HPP
...
#include <streams_boost/asio/ssl/stream_service.hpp>
 ...
 * streams_boost::asio::ssl::context context(io_service, streams_boost::asio::ssl::context::sslv23);
 * streams_boost::asio::ssl::stream<streams_boost::asio::ip::tcp::socket> sock(io_service, context);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  explicit stream(Arg& arg, basic_context<Context_Service>& context)
    : next_layer_(arg),
      service_(streams_boost::asio::use_service<Service>(next_layer_.get_io_service())),
      impl_(service_.null())
  {
   ...
   */
  streams_boost::system::error_code handshake(handshake_type type,
      streams_boost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code shutdown(streams_boost::system::error_code& ec)
  {
...
#endif // STREAMS_BOOST_ASIO_SSL_STREAM_HPP
