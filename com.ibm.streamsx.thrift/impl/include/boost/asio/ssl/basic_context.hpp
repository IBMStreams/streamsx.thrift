...
#ifndef STREAMS_BOOST_ASIO_SSL_BASIC_CONTEXT_HPP
#define STREAMS_BOOST_ASIO_SSL_BASIC_CONTEXT_HPP
...
public:
  ...
  /// Constructor.
  basic_context(streams_boost::asio::io_service& io_service, method m)
    : service_(streams_boost::asio::use_service<Service>(io_service)),
      impl_(service_.null())
  {
   ...
   */
  streams_boost::system::error_code set_options(options o,
      streams_boost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code set_verify_mode(verify_mode v,
      streams_boost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code load_verify_file(const std::string& filename,
      streams_boost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code add_verify_path(const std::string& path,
      streams_boost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code use_certificate_file(const std::string& filename,
      file_format format, streams_boost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code use_certificate_chain_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code use_private_key_file(const std::string& filename,
      file_format format, streams_boost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code use_rsa_private_key_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  streams_boost::system::error_code use_tmp_dh_file(const std::string& filename,
      streams_boost::system::error_code& ec)
  {
   ...
   */
  template <typename PasswordCallback>
  streams_boost::system::error_code set_password_callback(PasswordCallback callback,
      streams_boost::system::error_code& ec)
  {
...
#endif // STREAMS_BOOST_ASIO_SSL_BASIC_CONTEXT_HPP
