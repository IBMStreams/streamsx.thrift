...
#ifndef STREAMS_BOOST_ASIO_SSL_DETAIL_OPENSSL_CONTEXT_SERVICE_HPP
#define STREAMS_BOOST_ASIO_SSL_DETAIL_OPENSSL_CONTEXT_SERVICE_HPP
...
#include <streams_boost/asio/ssl/detail/openssl_init.hpp>
...
class openssl_context_service
  : public streams_boost::asio::detail::service_base<openssl_context_service>
{
public:
  ...
  typedef streams_boost::function<std::string(std::size_t,
      context_base::password_purpose)> password_callback_type;

  // Constructor.
  openssl_context_service(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<openssl_context_service>(io_service)
  {
  }
  ...
  streams_boost::system::error_code set_password_callback(impl_type& impl,
      Password_Callback callback, streams_boost::system::error_code& ec)
  {
...
#endif // STREAMS_BOOST_ASIO_SSL_DETAIL_OPENSSL_CONTEXT_SERVICE_HPP
