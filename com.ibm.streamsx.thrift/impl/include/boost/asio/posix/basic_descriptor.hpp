...
#ifndef STREAMS_BOOST_ASIO_POSIX_BASIC_DESCRIPTOR_STREAMS_HPP
#define STREAMS_BOOST_ASIO_POSIX_BASIC_DESCRIPTOR_STREAMS_HPP
...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(streams_boost::asio::io_service& io_service)
   ...
   */
  basic_descriptor(streams_boost::asio::io_service& io_service,
   ...
   */
  streams_boost::system::error_code assign(const native_type& native_descriptor,
      streams_boost::system::error_code& ec)
  {
   ...
   * streams_boost::asio::posix::descriptor_base::bytes_readable @n
   * streams_boost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   ...
   * ...
   * streams_boost::asio::posix::stream_descriptor::bytes_readable command;
...
#endif // STREAMS_BOOST_ASIO_POSIX_BASIC_DESCRIPTOR_STREAMS_HPP
