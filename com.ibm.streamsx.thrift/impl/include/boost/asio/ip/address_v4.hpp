...
#ifndef STREAMS_BOOST_ASIO_IP_ADDRESS_V4_HPP
#define STREAMS_BOOST_ASIO_IP_ADDRESS_V4_HPP
...
/**
 * The streams_boost::asio::ip::address_v4 class provides the ability to use and
...
public:
  ...
  typedef streams_boost::array<unsigned char, 4> bytes_type;
  ...
  explicit address_v4(unsigned long addr)
  {
    ...
    addr_.s_addr = streams_boost::asio::detail::socket_ops::host_to_network_long(addr);
  }
  ...
  {
    return streams_boost::asio::detail::socket_ops::network_to_host_long(addr_.s_addr);
  }
  ...
  {
    char addr_str[streams_boost::asio::detail::max_addr_v4_str_len];
    const char* addr =
      streams_boost::asio::detail::socket_ops::inet_ntop(AF_INET, &addr_, addr_str,
          streams_boost::asio::detail::max_addr_v4_str_len, 0, ec);
    if (addr == 0)
      return std::string();
    return addr;
  }
  ...
  /// Create an address from an IP address string in dotted decimal form.
  static address_v4 from_string(const char* str, streams_boost::system::error_code& ec)
  {
    address_v4 tmp;
...
private:
  ...
  streams_boost::asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates streams_boost::asio::ip::address_v4
 */
...
#endif // STREAMS_BOOST_ASIO_IP_ADDRESS_V4_HPP
