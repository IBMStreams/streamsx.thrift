...
#ifndef STREAMS_BOOST_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
#define STREAMS_BOOST_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  multicast_request()
  {
    ipv4_value_.imr_multiaddr.s_addr =
      streams_boost::asio::detail::socket_ops::host_to_network_long(
          streams_boost::asio::ip::address_v4::any().to_ulong());
  ...
  explicit multicast_request(const streams_boost::asio::ip::address& multicast_address)
  {
    if (multicast_address.is_v6())
    {
      ...
      streams_boost::asio::ip::address_v6 ipv6_address = multicast_address.to_v6();
      streams_boost::asio::ip::address_v6::bytes_type bytes = ipv6_address.to_bytes();
  ...
  explicit multicast_request(
      const streams_boost::asio::ip::address_v4& multicast_address,
      const streams_boost::asio::ip::address_v4& network_interface
        = streams_boost::asio::ip::address_v4::any())
  {
    ipv4_value_.imr_multiaddr.s_addr =
      streams_boost::asio::detail::socket_ops::host_to_network_long(
  ...
  explicit multicast_request(
      const streams_boost::asio::ip::address_v6& multicast_address,
...
private:
  streams_boost::asio::detail::in4_mreq_type ipv4_value_;
  streams_boost::asio::detail::in6_mreq_type ipv6_value_;
};
...
public:
  ...
  explicit network_interface(const streams_boost::asio::ip::address_v4& ipv4_interface)
  {
    ipv4_value_.s_addr =
      streams_boost::asio::detail::socket_ops::host_to_network_long(
...
private:
  streams_boost::asio::detail::in4_addr_type ipv4_value_;
...
#endif // STREAMS_BOOST_ASIO_IP_DETAIL_SOCKET_OPTION_HPP
