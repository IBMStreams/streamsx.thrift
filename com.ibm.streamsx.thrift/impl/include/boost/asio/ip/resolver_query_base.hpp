...
#ifndef STREAMS_BOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
#define STREAMS_BOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
...
#else
  STREAMS_BOOST_STATIC_CONSTANT(int, canonical_name = AI_CANONNAME);
  STREAMS_BOOST_STATIC_CONSTANT(int, passive = AI_PASSIVE);
  STREAMS_BOOST_STATIC_CONSTANT(int, numeric_host = AI_NUMERICHOST);
# if defined(AI_NUMERICSERV)
  STREAMS_BOOST_STATIC_CONSTANT(int, numeric_service = AI_NUMERICSERV);
# else
  STREAMS_BOOST_STATIC_CONSTANT(int, numeric_service = 0);
# endif
...
# if defined(AI_V4MAPPED) && !defined(__QNXNTO__)
  STREAMS_BOOST_STATIC_CONSTANT(int, v4_mapped = AI_V4MAPPED);
# else
  STREAMS_BOOST_STATIC_CONSTANT(int, v4_mapped = 0);
# endif
# if defined(AI_ALL) && !defined(__QNXNTO__)
  STREAMS_BOOST_STATIC_CONSTANT(int, all_matching = AI_ALL);
# else
  STREAMS_BOOST_STATIC_CONSTANT(int, all_matching = 0);
# endif
# if defined(AI_ADDRCONFIG) && !defined(__QNXNTO__)
  STREAMS_BOOST_STATIC_CONSTANT(int, address_configured = AI_ADDRCONFIG);
# else
  STREAMS_BOOST_STATIC_CONSTANT(int, address_configured = 0);
# endif
#endif
...
#endif // STREAMS_BOOST_ASIO_IP_RESOLVER_QUERY_BASE_HPP
