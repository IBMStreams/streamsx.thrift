...
#ifndef STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_QUERY_HPP
#define STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_QUERY_HPP
...
/**
 * The streams_boost::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const streams_boost::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  streams_boost::asio::detail::addrinfo_type hints_;
...
#endif // STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_QUERY_HPP
