...
#ifndef STREAMS_BOOST_ASIO_IP_ADDRESS_V6_HPP
#define STREAMS_BOOST_ASIO_IP_ADDRESS_V6_HPP
...
/**
 * The streams_boost::asio::ip::address_v6 class provides the ability to use and
...
public:
  ...
  typedef streams_boost::array<unsigned char, 16> bytes_type;
  ...
  {
    char addr_str[streams_boost::asio::detail::max_addr_v6_str_len];
    const char* addr =
      streams_boost::asio::detail::socket_ops::inet_ntop(AF_INET6, &addr_, addr_str,
          streams_boost::asio::detail::max_addr_v6_str_len, scope_id_, ec);
    if (addr == 0)
      return std::string();
    return addr;
  }
  ...
  /// Create an address from an IP address string.
  static address_v6 from_string(const char* str, streams_boost::system::error_code& ec)
  {
    address_v6 tmp;
    if (streams_boost::asio::detail::socket_ops::inet_pton(
...
#else
    using namespace streams_boost::asio::detail;
  ...
  friend bool operator==(const address_v6& a1, const address_v6& a2)
  {
    ...
    return memcmp(&a1.addr_, &a2.addr_,
        sizeof(streams_boost::asio::detail::in6_addr_type)) == 0
  ...
  friend bool operator<(const address_v6& a1, const address_v6& a2)
  {
    ...
    int memcmp_result = memcmp(&a1.addr_, &a2.addr_,
        sizeof(streams_boost::asio::detail::in6_addr_type));
    if (memcmp_result < 0)
      return true;
    if (memcmp_result > 0)
      return false;
  ...
  {
    address_v6 tmp;
    streams_boost::asio::detail::in6_addr_type tmp_addr = IN6ADDR_LOOPBACK_INIT;
    tmp.addr_ = tmp_addr;
    return tmp;
  }
...
private:
  ...
  streams_boost::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates streams_boost::asio::ip::address_v6
 */
...
#endif // STREAMS_BOOST_ASIO_IP_ADDRESS_V6_HPP
