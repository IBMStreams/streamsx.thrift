...
#ifndef STREAMS_BOOST_ASIO_IP_UDP_HPP
#define STREAMS_BOOST_ASIO_IP_UDP_HPP
...
/**
 * The streams_boost::asio::ip::udp class contains flags necessary for UDP sockets.
 *
 * @par Thread Safety
...
#endif // STREAMS_BOOST_ASIO_IP_UDP_HPP
