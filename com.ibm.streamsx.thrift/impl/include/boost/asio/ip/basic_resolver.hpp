...
#ifndef STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_HPP
#define STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_HPP
...
public:
   ...
   */
  explicit basic_resolver(streams_boost::asio::io_service& io_service)
   ...
   * will be invoked with the streams_boost::asio::error::operation_aborted error code.
   */
  void cancel()
  {
   ...
   * entry.
   */
  iterator resolve(const query& q, streams_boost::system::error_code& ec)
  {
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, streams_boost::system::error_code& ec)
  {
...
#endif // STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_HPP
