...
#ifndef STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
#define STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
...
/**
 * The streams_boost::asio::ip::basic_resolver_iterator class template is used to define
...
public:
  ...
  static basic_resolver_iterator create(
      streams_boost::asio::detail::addrinfo_type* address_info,
...
private:
  ...
  streams_boost::shared_ptr<values_type> values_;
  streams_boost::optional<values_iter_type> iter_;
};
...
#endif // STREAMS_BOOST_ASIO_IP_BASIC_RESOLVER_ITERATOR_HPP
