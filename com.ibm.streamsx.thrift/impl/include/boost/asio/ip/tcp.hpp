...
#ifndef STREAMS_BOOST_ASIO_IP_TCP_HPP
#define STREAMS_BOOST_ASIO_IP_TCP_HPP
...
/**
 * The streams_boost::asio::ip::tcp class contains flags necessary for TCP sockets.
 *
 * @par Thread Safety
...
public:
   ...
   * streams_boost::asio::ip::tcp::socket socket(io_service); 
   * ...
   * streams_boost::asio::ip::tcp::no_delay option;
...
#endif // STREAMS_BOOST_ASIO_IP_TCP_HPP
