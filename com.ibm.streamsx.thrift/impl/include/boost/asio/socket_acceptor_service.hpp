...
#ifndef STREAMS_BOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
#define STREAMS_BOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
...
#else
  : public streams_boost::asio::detail::service_base<socket_acceptor_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit socket_acceptor_service(streams_boost::asio::io_service& io_service)
...
#endif // STREAMS_BOOST_ASIO_SOCKET_ACCEPTOR_SERVICE_HPP
