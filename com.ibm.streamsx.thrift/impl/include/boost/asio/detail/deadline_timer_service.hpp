...
#ifndef STREAMS_BOOST_ASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
#define STREAMS_BOOST_ASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
...
public:
  ...
  // Constructor.
  deadline_timer_service(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<
        deadline_timer_service<Time_Traits, Timer_Scheduler> >(io_service),
      scheduler_(streams_boost::asio::use_service<Timer_Scheduler>(io_service))
  {
  ...
  std::size_t cancel(implementation_type& impl, streams_boost::system::error_code& ec)
  {
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, streams_boost::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(implementation_type& impl,
      const duration_type& expiry_time, streams_boost::system::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, streams_boost::system::error_code& ec)
  {
    time_type now = Time_Traits::now();
    while (Time_Traits::less_than(now, impl.expiry))
    {
      streams_boost::posix_time::time_duration timeout =
  ...
  {
  public:
    wait_handler(streams_boost::asio::io_service& io_service, Handler handler)
    ...
    void operator()(const streams_boost::system::error_code& result)
    {
...
#endif // STREAMS_BOOST_ASIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
