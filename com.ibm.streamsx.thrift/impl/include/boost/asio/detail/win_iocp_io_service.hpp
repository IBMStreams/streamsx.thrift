...
#ifndef STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_IO_SERVICE_HPP
#define STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_IO_SERVICE_HPP
...
class win_iocp_io_service
  : public streams_boost::asio::detail::service_base<win_iocp_io_service>
{
public:
  ...
  // Constructor.
  win_iocp_io_service(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<win_iocp_io_service>(io_service),
      iocp_(),
      outstanding_work_(0),
  ...
  streams_boost::system::error_code register_handle(
      HANDLE handle, streams_boost::system::error_code& ec)
  {
  ...
  {
    streams_boost::asio::detail::mutex::scoped_lock lock(timer_mutex_);
...
private:
  ...
  // either 0 or 1).
  size_t do_one(bool block, streams_boost::system::error_code& ec)
  {
  ...
  DWORD get_timeout()
  {
    ...
    streams_boost::posix_time::time_duration minimum_wait_duration
      = streams_boost::posix_time::milliseconds(max_timeout);
...
#endif // STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_IO_SERVICE_HPP
