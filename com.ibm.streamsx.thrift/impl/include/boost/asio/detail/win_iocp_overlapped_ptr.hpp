...
#ifndef STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
#define STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
...
private:
    ...
    : public win_iocp_io_service::operation
  {
    ...
    streams_boost::system::error_code ec_;
  };
  ...
  private:
        ...
        DWORD last_error, size_t bytes_transferred)
    {
      ...
      streams_boost::system::error_code ec(handler_op->ec_);
      if (last_error)
...
#endif // STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
