...
#ifndef STREAMS_BOOST_ASIO_DETAIL_SERVICE_REGISTRY_HPP
#define STREAMS_BOOST_ASIO_DETAIL_SERVICE_REGISTRY_HPP
...
# if !defined(STREAMS_BOOST_ASIO_NO_TYPEID)
#  define STREAMS_BOOST_ASIO_NO_TYPEID
# endif // !defined(STREAMS_BOOST_ASIO_NO_TYPEID)
#endif // defined(STREAMS_BOOST_NO_TYPEID)
...
public:
  // Constructor.
  service_registry(streams_boost::asio::io_service& o)
    : owner_(o),
      first_service_(0)
  {
  }
  ...
  ~service_registry()
  {
    ...
    streams_boost::asio::io_service::service* service = first_service_;
    while (service)
    {
    ...
    {
      streams_boost::asio::io_service::service* next_service = first_service_->next_;
...
private:
  // Set a service's id.
  void init_service_id(streams_boost::asio::io_service::service& service,
      const streams_boost::asio::io_service::id& id)
  {
  ...
  template <typename Service>
  void init_service_id(streams_boost::asio::io_service::service& service,
      const streams_boost::asio::detail::service_id<Service>& /*id*/)
  {
  ...
  static bool service_id_matches(
      const streams_boost::asio::io_service::service& service,
      const streams_boost::asio::io_service::id& id)
  {
  ...
  mutable streams_boost::asio::detail::mutex mutex_;

  // The owner of this service registry and the services it contains.
  streams_boost::asio::io_service& owner_;

  // The first service in the list of contained services.
  streams_boost::asio::io_service::service* first_service_;
};
...
#endif // STREAMS_BOOST_ASIO_DETAIL_SERVICE_REGISTRY_HPP
