...
#ifndef STREAMS_BOOST_ASIO_DETAIL_DEV_POLL_REACTOR_HPP
#define STREAMS_BOOST_ASIO_DETAIL_DEV_POLL_REACTOR_HPP
...
#if defined(STREAMS_BOOST_ASIO_HAS_DEV_POLL)
...
#include <streams_boost/asio/detail/hash_map.hpp>
...
class dev_poll_reactor
  : public streams_boost::asio::detail::service_base<dev_poll_reactor<Own_Thread> >
{
public:
  // Per-descriptor data.
  ...
  // Constructor.
  dev_poll_reactor(streams_boost::asio::io_service& io_service)
    ...
    if (events_size > 0)
    {
      ...
      if (result != static_cast<int>(events_size))
      {
        for (std::size_t i = 0; i < pending_event_changes_.size(); ++i)
        {
          ...
          streams_boost::system::error_code ec = streams_boost::system::error_code(
  ...
  static int do_dev_poll_create()
  {
    ...
    if (fd == -1)
    {
      streams_boost::throw_exception(
          streams_boost::system::system_error(
            streams_boost::system::error_code(errno,
              streams_boost::asio::error::get_system_category()),
            "/dev/poll"));
    }
    return fd;
...
#endif // defined(STREAMS_BOOST_ASIO_HAS_DEV_POLL)

#include <streams_boost/asio/detail/pop_options.hpp>

#endif // STREAMS_BOOST_ASIO_DETAIL_DEV_POLL_REACTOR_HPP
