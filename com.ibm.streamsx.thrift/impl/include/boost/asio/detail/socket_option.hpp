...
#ifndef STREAMS_BOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
#define STREAMS_BOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  {
    enabled(e);
    timeout STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(t);
  }
  ...
  void timeout STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(int value)
  {
#if defined(WIN32)
  ...
  int timeout STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION() const
  {
...
#endif // STREAMS_BOOST_ASIO_DETAIL_SOCKET_OPTION_HPP
