...
#ifndef STREAMS_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_HPP
#define STREAMS_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif // defined(_MSC_VER) && (_MSC_VER >= 1200)

#if defined(STREAMS_BOOST_ASIO_ENABLE_TWO_LOCK_QUEUE)
#include <streams_boost/asio/detail/task_io_service_2lock.hpp>
#else // defined(STREAMS_BOOST_ASIO_ENABLE_TWO_LOCK_QUEUE)

#include <streams_boost/asio/detail/push_options.hpp>

#include <streams_boost/asio/io_service.hpp>
#include <streams_boost/asio/detail/call_stack.hpp>
#include <streams_boost/asio/detail/event.hpp>
#include <streams_boost/asio/detail/handler_alloc_helpers.hpp>
#include <streams_boost/asio/detail/handler_invoke_helpers.hpp>
#include <streams_boost/asio/detail/handler_queue.hpp>
...
class task_io_service
  : public streams_boost::asio::detail::service_base<task_io_service<Task> >
{
public:
  // Constructor.
  task_io_service(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<task_io_service<Task> >(io_service),
      mutex_(),
      task_(0),
  ...
  size_t run(streams_boost::system::error_code& ec)
  {
  ...
  size_t run_one(streams_boost::system::error_code& ec)
  {
    typename call_stack<task_io_service>::context ctx(this);
  ...
  size_t poll(streams_boost::system::error_code& ec)
  {
    typename call_stack<task_io_service>::context ctx(this);
  ...
  size_t poll_one(streams_boost::system::error_code& ec)
  {
    typename call_stack<task_io_service>::context ctx(this);
...
private:
  ...
  size_t do_one(streams_boost::asio::detail::mutex::scoped_lock& lock,
      idle_thread_info* this_idle_thread, streams_boost::system::error_code& ec)
  {
  ...
  {
  public:
    task_cleanup(streams_boost::asio::detail::mutex::scoped_lock& lock,
  ...
  private:
    streams_boost::asio::detail::mutex::scoped_lock& lock_;
  ...
  {
  public:
    handler_cleanup(streams_boost::asio::detail::mutex::scoped_lock& lock,
        task_io_service& task_io_svc)
      : lock_(lock),
        task_io_service_(task_io_svc)
    {
...
#endif // defined(STREAMS_BOOST_ASIO_ENABLE_TWO_LOCK_QUEUE)

#endif // STREAMS_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_HPP
