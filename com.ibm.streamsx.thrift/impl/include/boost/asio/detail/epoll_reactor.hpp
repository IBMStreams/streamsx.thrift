...
#ifndef STREAMS_BOOST_ASIO_DETAIL_EPOLL_REACTOR_HPP
#define STREAMS_BOOST_ASIO_DETAIL_EPOLL_REACTOR_HPP
...
class epoll_reactor
  : public streams_boost::asio::detail::service_base<epoll_reactor<Own_Thread> >
{
public:
  // Per-descriptor data.
  ...
  // Constructor.
  epoll_reactor(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<epoll_reactor<Own_Thread> >(io_service),
      mutex_(),
...
#endif // defined(STREAMS_BOOST_ASIO_HAS_EPOLL)

#include <streams_boost/asio/detail/pop_options.hpp>

#endif // STREAMS_BOOST_ASIO_DETAIL_EPOLL_REACTOR_HPP
