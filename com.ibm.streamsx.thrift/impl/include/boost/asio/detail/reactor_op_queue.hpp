...
#ifndef STREAMS_BOOST_ASIO_DETAIL_REACTOR_OP_QUEUE_HPP
#define STREAMS_BOOST_ASIO_DETAIL_REACTOR_OP_QUEUE_HPP
...
public:
  ...
  bool perform_operation(Descriptor descriptor,
      const streams_boost::system::error_code& result)
  {
    typename operation_map::iterator i = operations_.find(descriptor);
    if (i != operations_.end())
    {
  ...
  void get_descriptors(Descriptor_Set& descriptors)
  {
    ...
    while (i != operations_.end())
    {
      ...
      {
        streams_boost::system::error_code ec(error::fd_set_failure);
  ...
  void perform_cancellations()
  {
    while (cancelled_operations_)
    {
      ...
      this_op->next_ = complete_operations_;
      complete_operations_ = this_op;
      this_op->perform(streams_boost::asio::error::operation_aborted);
    }
  }
...
private:
  ...
  public:
    ...
    bool perform(const streams_boost::system::error_code& result)
    {
      result_ = result;
  ...
  protected:
    typedef bool (*perform_func_type)(op_base*,
        streams_boost::system::error_code&, std::size_t&);
    typedef void (*complete_func_type)(op_base*,
        const streams_boost::system::error_code&, std::size_t);
  ...
  private:
    ...
    streams_boost::system::error_code result_;
  ...
  public:
    ...
    static bool do_perform(op_base* base,
        streams_boost::system::error_code& result, std::size_t& bytes_transferred)
    {
    ...
    static void do_complete(op_base* base,
        const streams_boost::system::error_code& result, std::size_t bytes_transferred)
    {
      ...
      streams_boost::system::error_code ec(result);
...
#endif // STREAMS_BOOST_ASIO_DETAIL_REACTOR_OP_QUEUE_HPP
