...
#ifndef STREAMS_BOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
#define STREAMS_BOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
...
#include <streams_boost/asio/detail/descriptor_ops.hpp>
...
public:
  ...
  // Constructor.
  reactive_descriptor_service(streams_boost::asio::io_service& io_service)
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, streams_boost::system::error_code& ec)
  {
    if (!is_open(impl))
    {
      ec = streams_boost::asio::error::bad_descriptor;
  ...
  {
  public:
    write_operation(int descriptor, streams_boost::asio::io_service& io_service,
  ...
  {
  public:
    read_operation(int descriptor, streams_boost::asio::io_service& io_service,
...
#endif // STREAMS_BOOST_ASIO_DETAIL_REACTIVE_DESCRIPTOR_SERVICE_HPP
