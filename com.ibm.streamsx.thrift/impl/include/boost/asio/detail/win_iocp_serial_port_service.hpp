...
#ifndef STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_SERIAL_PORT_SERVICE_HPP
#define STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_SERIAL_PORT_SERVICE_HPP
...
class win_iocp_serial_port_service
  : public streams_boost::asio::detail::service_base<win_iocp_serial_port_service>
{
public:
  ...
  win_iocp_serial_port_service(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<
        win_iocp_serial_port_service>(io_service),
      handle_service_(
          streams_boost::asio::use_service<win_iocp_handle_service>(io_service))
  {
  }
  ...
  streams_boost::system::error_code send_break(implementation_type&,
      streams_boost::system::error_code& ec)
  {
...
#endif // STREAMS_BOOST_ASIO_DETAIL_WIN_IOCP_SERIAL_PORT_SERVICE_HPP
