...
#ifndef STREAMS_BOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
#define STREAMS_BOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
...
public:
  ...
  wrapped_handler(
      typename streams_boost::add_reference<Dispatcher>::type dispatcher,
      Handler handler)
...
#endif // STREAMS_BOOST_ASIO_DETAIL_WRAPPED_HANDLER_HPP
