...
#ifndef STREAMS_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_2LOCK_HPP
#define STREAMS_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_2LOCK_HPP
...
#include <streams_boost/asio/detail/indirect_handler_queue.hpp>
...
public:
  ...
  {
    streams_boost::asio::detail::mutex::scoped_lock back_lock(back_mutex_);
    back_shutdown_ = true;
    back_lock.unlock();
  ...
  void stop()
  {
    streams_boost::asio::detail::mutex::scoped_lock front_lock(front_mutex_);
    front_stopped_ = true;
    front_lock.unlock();
...
private:
  ...
  void interrupt_one_idle_thread(
      streams_boost::asio::detail::mutex::scoped_lock& back_lock)
  {
  ...
  streams_boost::asio::detail::mutex front_mutex_;
  streams_boost::asio::detail::mutex back_mutex_;
  ...
  streams_boost::detail::atomic_count outstanding_work_;
...
#endif // STREAMS_BOOST_ASIO_DETAIL_TASK_IO_SERVICE_2LOCK_HPP
