...
#ifndef STREAMS_BOOST_ASIO_DETAIL_HASH_MAP_HPP
#define STREAMS_BOOST_ASIO_DETAIL_HASH_MAP_HPP
...
{
  return streams_boost::hash_value(t);
}
...
private:
  ...
  static std::size_t hash_size(std::size_t num_elems)
  {
    ...
    {
#if defined(STREAMS_BOOST_ASIO_HASH_MAP_BUCKETS)
      STREAMS_BOOST_ASIO_HASH_MAP_BUCKETS
#else // STREAMS_BOOST_ASIO_HASH_MAP_BUCKETS
      3, 13, 23, 53, 97, 193, 389, 769, 1543, 3079, 6151, 12289, 24593,
      49157, 98317, 196613, 393241, 786433, 1572869, 3145739, 6291469,
      12582917, 25165843
#endif // STREAMS_BOOST_ASIO_HASH_MAP_BUCKETS
    };
...
#endif // STREAMS_BOOST_ASIO_DETAIL_HASH_MAP_HPP
