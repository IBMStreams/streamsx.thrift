...
#ifndef STREAMS_BOOST_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
#define STREAMS_BOOST_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
...
public:
  ...
  reactive_serial_port_service(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<
        reactive_serial_port_service>(io_service),
      descriptor_service_(streams_boost::asio::use_service<
...
#endif // STREAMS_BOOST_ASIO_DETAIL_REACTIVE_SERIAL_PORT_SERVICE_HPP
