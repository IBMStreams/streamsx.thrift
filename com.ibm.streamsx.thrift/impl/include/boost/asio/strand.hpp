...
#ifndef STREAMS_BOOST_ASIO_STRAND_HPP
#define STREAMS_BOOST_ASIO_STRAND_HPP
...
#include <streams_boost/asio/detail/strand_service.hpp>
...
public:
   ...
   */
  explicit strand(streams_boost::asio::io_service& io_service)
    : service_(streams_boost::asio::use_service<
        streams_boost::asio::detail::strand_service>(io_service))
  {
   ...
   * @code strand.dispatch(streams_boost::bind(f, a1, ... an)); @endcode
   */
  template <typename Handler>
...
private:
  streams_boost::asio::detail::strand_service& service_;
  streams_boost::asio::detail::strand_service::implementation_type impl_;
};

/// Typedef for backwards compatibility.
typedef streams_boost::asio::io_service::strand strand;
...
#endif // STREAMS_BOOST_ASIO_STRAND_HPP
