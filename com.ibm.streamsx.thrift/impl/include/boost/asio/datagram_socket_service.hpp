...
#ifndef STREAMS_BOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
#define STREAMS_BOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
...
#else
  : public streams_boost::asio::detail::service_base<datagram_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit datagram_socket_service(streams_boost::asio::io_service& io_service)
...
#endif // STREAMS_BOOST_ASIO_DATAGRAM_SOCKET_SERVICE_HPP
