...
#ifndef STREAMS_BOOST_ASIO_READ_AT_IPP
#define STREAMS_BOOST_ASIO_READ_AT_IPP
...
namespace detail
{
  ...
  public:
    read_at_streambuf_handler(AsyncRandomAccessReadDevice& stream,
        streams_boost::uint64_t offset, basic_streambuf<Allocator>& streambuf,
        CompletionCondition completion_condition, ReadHandler handler)
      : stream_(stream),
        offset_(offset),
...
#endif // STREAMS_BOOST_ASIO_READ_AT_IPP
