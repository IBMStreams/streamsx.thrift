...
#ifndef STREAMS_BOOST_ASIO_WRITE_IPP
#define STREAMS_BOOST_ASIO_WRITE_IPP
...
namespace detail
{
  ...
  {
  public:
    write_streambuf_handler(streams_boost::asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler handler)
...
inline void async_write(AsyncWriteStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b, WriteHandler handler)
{
...
#endif // STREAMS_BOOST_ASIO_WRITE_IPP
