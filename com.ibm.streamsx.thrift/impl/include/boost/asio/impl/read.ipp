...
#ifndef STREAMS_BOOST_ASIO_READ_IPP
#define STREAMS_BOOST_ASIO_READ_IPP
...
inline void async_read(AsyncReadStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b, ReadHandler handler)
{
...
#endif // STREAMS_BOOST_ASIO_READ_IPP
