...
#ifndef STREAMS_BOOST_ASIO_SERIAL_PORT_BASE_IPP
#define STREAMS_BOOST_ASIO_SERIAL_PORT_BASE_IPP
...
inline streams_boost::system::error_code serial_port_base::baud_rate::store(
    STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec) const
{
...
inline streams_boost::system::error_code serial_port_base::baud_rate::load(
    const STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec)
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
  ...
  : value_(t)
{
  if (t != none && t != software && t != hardware)
  {
    ...
    streams_boost::throw_exception(ex);
  }
}
...
inline streams_boost::system::error_code serial_port_base::flow_control::store(
    STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec) const
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
...
inline streams_boost::system::error_code serial_port_base::flow_control::load(
    const STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec)
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
...
inline streams_boost::system::error_code serial_port_base::parity::store(
    STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec) const
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
inline streams_boost::system::error_code serial_port_base::parity::load(
    const STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec)
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
...
inline streams_boost::system::error_code serial_port_base::stop_bits::store(
    STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec) const
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
inline streams_boost::system::error_code serial_port_base::stop_bits::load(
    const STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec)
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
...
inline streams_boost::system::error_code serial_port_base::character_size::store(
    STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec) const
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
...
inline streams_boost::system::error_code serial_port_base::character_size::load(
    const STREAMS_BOOST_ASIO_OPTION_STORAGE& storage, streams_boost::system::error_code& ec)
{
#if defined(STREAMS_BOOST_WINDOWS) || defined(__CYGWIN__)
...
#endif // STREAMS_BOOST_ASIO_SERIAL_PORT_BASE_IPP
