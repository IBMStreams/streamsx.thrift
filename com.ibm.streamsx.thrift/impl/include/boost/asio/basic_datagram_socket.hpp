...
#ifndef STREAMS_BOOST_ASIO_BASIC_DATAGRAM_SOCKET_HPP
#define STREAMS_BOOST_ASIO_BASIC_DATAGRAM_SOCKET_HPP
...
public:
   ...
   * socket.
   */
  explicit basic_datagram_socket(streams_boost::asio::io_service& io_service)
   ...
   */
  basic_datagram_socket(streams_boost::asio::io_service& io_service,
   ...
   * @code socket.send(streams_boost::asio::buffer(data, size)); @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * streams_boost::asio::ip::udp::endpoint destination(
   *     streams_boost::asio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(streams_boost::asio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, streams_boost::array or
   * std::vector.
   ...
   *     streams_boost::asio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, streams_boost::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(streams_boost::asio::buffer(data, size)); @endcode
   ...
   * follows:
   * @code
   * streams_boost::asio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     streams_boost::asio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, streams_boost::array or
   * std::vector.
   ...
   *     streams_boost::asio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, streams_boost::array or
   * std::vector.
   */
...
#endif // STREAMS_BOOST_ASIO_BASIC_DATAGRAM_SOCKET_HPP
