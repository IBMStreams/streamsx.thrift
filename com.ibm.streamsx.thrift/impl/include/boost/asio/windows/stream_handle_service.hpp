...
#ifndef STREAMS_BOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
#define STREAMS_BOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
...
#if !defined(STREAMS_BOOST_ASIO_DISABLE_WINDOWS_STREAM_HANDLE)
# if defined(STREAMS_BOOST_ASIO_HAS_IOCP)
#  define STREAMS_BOOST_ASIO_HAS_WINDOWS_STREAM_HANDLE 1
# endif // defined(STREAMS_BOOST_ASIO_HAS_IOCP)
#endif // !defined(STREAMS_BOOST_ASIO_DISABLE_WINDOWS_STREAM_HANDLE)
...
#else
  : public streams_boost::asio::detail::service_base<stream_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_handle_service(streams_boost::asio::io_service& io_service)
    : streams_boost::asio::detail::service_base<stream_handle_service>(io_service),
...
#endif // STREAMS_BOOST_ASIO_WINDOWS_STREAM_HANDLE_SERVICE_HPP
