...
#ifndef STREAMS_BOOST_ASIO_WINDOWS_BASIC_RANDOM_ACCESS_HANDLE_HPP
#define STREAMS_BOOST_ASIO_WINDOWS_BASIC_RANDOM_ACCESS_HANDLE_HPP
...
#if defined(STREAMS_BOOST_ASIO_HAS_WINDOWS_RANDOM_ACCESS_HANDLE) \
...
public:
   ...
   * handle.
   */
  explicit basic_random_access_handle(streams_boost::asio::io_service& io_service)
   ...
   */
  basic_random_access_handle(streams_boost::asio::io_service& io_service,
   ...
   * @code
   * handle.write_some_at(42, streams_boost::asio::buffer(data, size));
   * @endcode
  ...
  std::size_t write_some_at(streams_boost::uint64_t offset,
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_write_some_at(42, streams_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, streams_boost::array or
   * std::vector.
  ...
  void async_write_some_at(streams_boost::uint64_t offset,
   ...
   * @code
   * handle.read_some_at(42, streams_boost::asio::buffer(data, size));
   * @endcode
  ...
  std::size_t read_some_at(streams_boost::uint64_t offset,
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_read_some_at(42, streams_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, streams_boost::array or
   * std::vector.
  ...
  void async_read_some_at(streams_boost::uint64_t offset,
...
#endif // defined(STREAMS_BOOST_ASIO_HAS_WINDOWS_RANDOM_ACCESS_HANDLE)
       //   || defined(GENERATING_DOCUMENTATION)

#include <streams_boost/asio/detail/pop_options.hpp>

#endif // STREAMS_BOOST_ASIO_WINDOWS_BASIC_RANDOM_ACCESS_HANDLE_HPP
