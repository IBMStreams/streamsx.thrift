...
#ifndef STREAMS_BOOST_ASIO_WINDOWS_BASIC_HANDLE_HPP
#define STREAMS_BOOST_ASIO_WINDOWS_BASIC_HANDLE_HPP
...
public:
   ...
   */
  explicit basic_handle(streams_boost::asio::io_service& io_service)
   ...
   */
  basic_handle(streams_boost::asio::io_service& io_service,
   ...
   */
  streams_boost::system::error_code assign(const native_type& native_handle,
      streams_boost::system::error_code& ec)
  {
...
#endif // STREAMS_BOOST_ASIO_WINDOWS_BASIC_HANDLE_HPP
