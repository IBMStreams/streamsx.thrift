...
#ifndef STREAMS_BOOST_ASIO_WINDOWS_RANDOM_ACCESS_HANDLE_SERVICE_HPP
#define STREAMS_BOOST_ASIO_WINDOWS_RANDOM_ACCESS_HANDLE_SERVICE_HPP
...
#include <streams_boost/asio/detail/win_iocp_handle_service.hpp>

#if !defined(STREAMS_BOOST_ASIO_DISABLE_WINDOWS_RANDOM_ACCESS_HANDLE)
# if defined(STREAMS_BOOST_ASIO_HAS_IOCP)
#  define STREAMS_BOOST_ASIO_HAS_WINDOWS_RANDOM_ACCESS_HANDLE 1
# endif // defined(STREAMS_BOOST_ASIO_HAS_IOCP)
#endif // !defined(STREAMS_BOOST_ASIO_DISABLE_WINDOWS_RANDOM_ACCESS_HANDLE)
...
#else
  : public streams_boost::asio::detail::service_base<random_access_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit random_access_handle_service(streams_boost::asio::io_service& io_service)
  ...
  std::size_t write_some_at(implementation_type& impl, streams_boost::uint64_t offset,
  ...
  std::size_t read_some_at(implementation_type& impl, streams_boost::uint64_t offset,
...
#endif // STREAMS_BOOST_ASIO_WINDOWS_RANDOM_ACCESS_HANDLE_SERVICE_HPP
