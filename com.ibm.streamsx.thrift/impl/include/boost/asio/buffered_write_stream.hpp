...
#ifndef STREAMS_BOOST_ASIO_BUFFERED_WRITE_STREAM_HPP
#define STREAMS_BOOST_ASIO_BUFFERED_WRITE_STREAM_HPP
...
public:
  ...
  /// error occurred.
  std::size_t flush(streams_boost::system::error_code& ec)
  {
    std::size_t bytes_written = write(next_layer_,
        buffer(storage_.data(), storage_.size()),
        transfer_all(), ec);
  ...
  {
  public:
    flush_handler(streams_boost::asio::io_service& io_service,
  ...
  {
  public:
    write_some_handler(streams_boost::asio::io_service& io_service,
      ...
      WriteHandler handler)
  {
    ...
    else
    {
      ...
      get_io_service().post(detail::bind_handler(
            handler, streams_boost::system::error_code(), bytes_copied));
    }
  }
...
#endif // STREAMS_BOOST_ASIO_BUFFERED_WRITE_STREAM_HPP
