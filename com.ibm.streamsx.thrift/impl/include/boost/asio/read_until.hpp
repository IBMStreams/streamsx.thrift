...
#ifndef STREAMS_BOOST_ASIO_READ_UNTIL_HPP
#define STREAMS_BOOST_ASIO_READ_UNTIL_HPP
...
#else // STREAMS_BOOST_WORKAROUND(__CODEGEARC__, STREAMS_BOOST_TESTED_AT(0x610))
  template <typename T>
  struct has_result_type
  {
    struct big { char a[100]; };
...
#endif // STREAMS_BOOST_WORKAROUND(__CODEGEARC__, STREAMS_BOOST_TESTED_AT(0x610))
} // namespace detail
...
struct is_match_condition
{
  ...
  enum
  {
    value = streams_boost::is_function<typename streams_boost::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until streams_boost::asio::read_until
 *
 ...
 * @code streams_boost::asio::streambuf b;
 * streams_boost::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b, const std::string& delim);
 ...
 * @code streams_boost::asio::streambuf b;
 * streams_boost::asio::read_until(s, b, streams_boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 */
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b, const streams_boost::regex& expr);
 ...
 * @code typedef streams_boost::asio::buffers_iterator<
 *     streams_boost::asio::streambuf::const_buffers_type> iterator;
 *
 ...
 * }
 * ...
 * streams_boost::asio::streambuf b;
 * streams_boost::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 *     : public streams_boost::true_type {};
 * } // namespace asio
 * ...
 * streams_boost::asio::streambuf b;
 * streams_boost::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
    typename streams_boost::enable_if<is_match_condition<MatchCondition> >::type* = 0);
...
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b,
    MatchCondition match_condition, streams_boost::system::error_code& ec,
    typename streams_boost::enable_if<is_match_condition<MatchCondition> >::type* = 0);

/*@}*/
/**
 * @defgroup async_read_until streams_boost::asio::async_read_until
 *
 ...
 * @code void handler(
 *   // Result of operation.
 *   const streams_boost::system::error_code& error,
 *
 ...
 * @code streams_boost::asio::streambuf b;
 * ...
 * void handler(const streams_boost::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::istream is(&b);
 ...
 * }
 * ...
 * streams_boost::asio::async_read_until(s, b, '\n', handler); @endcode
 */
 ...
 * }
 * ...
 * streams_boost::asio::async_read_until(s, b, streams_boost::regex("\r\n"), handler); @endcode
 */
template <typename AsyncReadStream, typename Allocator, typename ReadHandler>
void async_read_until(AsyncReadStream& s,
    streams_boost::asio::basic_streambuf<Allocator>& b, const streams_boost::regex& expr,
 ...
 * ...
 * streams_boost::asio::streambuf b;
 * streams_boost::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * streams_boost::asio::streambuf b;
 * streams_boost::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
...
#include <streams_boost/asio/impl/read_until.ipp>

#endif // !defined(STREAMS_BOOST_NO_IOSTREAM)

#include <streams_boost/asio/detail/pop_options.hpp>

#endif // STREAMS_BOOST_ASIO_READ_UNTIL_HPP
