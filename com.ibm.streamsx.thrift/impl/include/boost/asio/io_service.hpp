...
#ifndef STREAMS_BOOST_ASIO_IO_SERVICE_HPP
#define STREAMS_BOOST_ASIO_IO_SERVICE_HPP
...
#include <streams_boost/asio/detail/dev_poll_reactor_fwd.hpp>
#include <streams_boost/asio/detail/epoll_reactor_fwd.hpp>
#include <streams_boost/asio/detail/kqueue_reactor_fwd.hpp>
#include <streams_boost/asio/detail/noncopyable.hpp>
#include <streams_boost/asio/detail/select_reactor_fwd.hpp>
#include <streams_boost/asio/detail/service_registry_fwd.hpp>
#include <streams_boost/asio/detail/signal_init.hpp>
#include <streams_boost/asio/detail/task_io_service_fwd.hpp>
#include <streams_boost/asio/detail/win_iocp_io_service_fwd.hpp>
#include <streams_boost/asio/detail/winsock_init.hpp>
#include <streams_boost/asio/detail/wrapped_handler.hpp>
 ...
 *
 * @li streams_boost::asio::ip::tcp::socket
 * @li streams_boost::asio::ip::tcp::acceptor
 * @li streams_boost::asio::ip::udp::socket
 * @li streams_boost::asio::deadline_timer.
 *
 ...
 * creating an object of type streams_boost::asio::io_service::work:
 *
 * @code streams_boost::asio::io_service io_service;
 * streams_boost::asio::io_service::work work(io_service);
 * ... @endcode
 *
 ...
 *
 * @code streams_boost::asio::io_service io_service;
 * auto_ptr<streams_boost::asio::io_service::work> work(
 *     new streams_boost::asio::io_service::work(io_service));
 * ...
...
public:
   ...
   * without blocking.
   */
  std::size_t run(streams_boost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  std::size_t run_one(streams_boost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  std::size_t poll(streams_boost::system::error_code& ec);
   ...
   * @return The number of handlers that were executed.
   */
  std::size_t poll_one(streams_boost::system::error_code& ec);
   ...
   * @code io_service.dispatch(streams_boost::bind(f, a1, ... an)); @endcode
   */
   ...
   *
   * @throws streams_boost::asio::service_already_exists Thrown if a service of the
   * given type is already present in the io_service.
   *
   * @throws streams_boost::asio::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  streams_boost::asio::detail::service_registry* service_registry_;
...
public:
   ...
   */
  explicit work(streams_boost::asio::io_service& io_service);
...
protected:
   ...
   */
  service(streams_boost::asio::io_service& owner);
...
private:
  ...
  friend class streams_boost::asio::detail::service_registry;
  streams_boost::asio::io_service& owner_;
  const std::type_info* type_info_;
  const streams_boost::asio::io_service::id* id_;
  service* next_;
};
...
#include <streams_boost/asio/impl/io_service.ipp>

#include <streams_boost/asio/detail/pop_options.hpp>

#endif // STREAMS_BOOST_ASIO_IO_SERVICE_HPP
