...
#ifndef STREAMS_BOOST_FENCED_PRIORITY_QUEUE_HPP
#define STREAMS_BOOST_FENCED_PRIORITY_QUEUE_HPP
...
namespace streams_boost {
  ...
  template<class T, class Compare = std::less<T>, bool implicit_fence = true,
           class Buffer = streams_boost::queue<T> >
...
#endif /* STREAMS_BOOST_FENCED_PRIORITY_QUEUE_HPP */
