...
#ifndef STREAMS_BOOST_FIBONACCI_HEAP_HPP
#define STREAMS_BOOST_FIBONACCI_HEAP_HPP
...
{
  typedef typename streams_boost::property_traits<ID>::value_type size_type;
...
#if defined(STREAMS_BOOST_MSVC) || defined(__ICL) // need a new macro?
...
#endif // STREAMS_BOOST_FIBONACCI_HEAP_HPP
