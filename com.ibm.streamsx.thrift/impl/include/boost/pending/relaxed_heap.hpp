...
//           Andrew Lumsdaine
#ifndef STREAMS_BOOST_RELAXED_HEAP_HEADER
#define STREAMS_BOOST_RELAXED_HEAP_HEADER
...
#ifdef STREAMS_BOOST_RELAXED_HEAP_DEBUG
#  include <iostream>
#endif // STREAMS_BOOST_RELAXED_HEAP_DEBUG
...
private:
  ...
  struct group {
     ...
     *  element). Note that the use of streams_boost::optional increases the
     ...
     */
    ::streams_boost::optional<value_type> value;
...
private:
  ...
  {
#if defined(STREAMS_BOOST_RELAXED_HEAP_DEBUG) && STREAMS_BOOST_RELAXED_HEAP_DEBUG > 1
   ...
   *  smaller.
   */
  std::vector< ::streams_boost::optional<value_type> > groups;
...
#endif // STREAMS_BOOST_RELAXED_HEAP_HEADER
