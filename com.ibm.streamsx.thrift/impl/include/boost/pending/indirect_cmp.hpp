...
#ifndef STREAMS_BOOST_INDIRECT_CMP_HPP
#define STREAMS_BOOST_INDIRECT_CMP_HPP
...
namespace streams_boost {
  ...
  class indirect_cmp {
  public:
    typedef typename streams_boost::property_traits<ReadablePropertyMap>::value_type T;
    typedef typename streams_boost::property_traits<ReadablePropertyMap>::key_type K;
