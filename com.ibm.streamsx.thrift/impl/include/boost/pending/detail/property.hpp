...
#ifndef STREAMS_BOOST_DETAIL_PROPERTY_HPP
#define STREAMS_BOOST_DETAIL_PROPERTY_HPP

#include <utility> // for std::pair
#include <streams_boost/type_traits/same_traits.hpp> // for is_same
  ...
  namespace detail {
    ...
    struct recursive_extract {
      ...
      struct bind_ {
        ...
        typedef typename streams_boost::ct_if< match, Value, 
...
#endif // STREAMS_BOOST_DETAIL_PROPERTY_HPP
