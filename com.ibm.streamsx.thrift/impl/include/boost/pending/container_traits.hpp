...
#ifndef STREAMS_BOOST_GRAPH_DETAIL_CONTAINER_TRAITS_H
#define STREAMS_BOOST_GRAPH_DETAIL_CONTAINER_TRAITS_H
...
#if !defined STREAMS_BOOST_NO_HASH
#  ifdef STREAMS_BOOST_HASH_SET_HEADER
#    include STREAMS_BOOST_HASH_SET_HEADER
#  else
#    include <hash_set>
#  endif
#  ifdef STREAMS_BOOST_HASH_MAP_HEADER
...
// sandbox/streams_boost/sequence_algo/container_traits.hpp
// The 'detail' subnamespace will still cause problems.
namespace streams_boost { namespace graph_detail {
  ...
  // std::slist
#ifndef STREAMS_BOOST_NO_SLIST
# ifndef STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
  template <class T, class Alloc>
  struct container_traits<STREAMS_BOOST_STD_EXTENSION_NAMESPACE::slist<T,Alloc> > {
  ...
  const STREAMS_BOOST_STD_EXTENSION_NAMESPACE::slist<T,Alloc>&
  )
 ...
 // hash_set, hash_map
...
#ifndef STREAMS_BOOST_NO_HASH
#ifndef STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
  template <class Key, class Eq, class Hash, class Alloc> 
  struct container_traits< STREAMS_BOOST_STD_EXTENSION_NAMESPACE::hash_set<Key,Eq,Hash,Alloc> > {
    typedef set_tag category;
    typedef stable_tag iterator_stability; // is this right?
  };
  template <class Key, class T, class Eq, class Hash, class Alloc>
  struct container_traits< STREAMS_BOOST_STD_EXTENSION_NAMESPACE::hash_map<Key,T,Eq,Hash,Alloc> > {
    typedef map_tag category;
    typedef stable_tag iterator_stability; // is this right?
  };
#endif
  template <class Key, class Eq, class Hash, class Alloc>
  set_tag container_category(const STREAMS_BOOST_STD_EXTENSION_NAMESPACE::hash_set<Key,Eq,Hash,Alloc>&)
  { return set_tag(); }

  template <class Key, class T, class Eq, class Hash, class Alloc>
  map_tag container_category(const STREAMS_BOOST_STD_EXTENSION_NAMESPACE::hash_map<Key,T,Eq,Hash,Alloc>&)
  { return map_tag(); }

  template <class Key, class Eq, class Hash, class Alloc>
  stable_tag iterator_stability(const STREAMS_BOOST_STD_EXTENSION_NAMESPACE::hash_set<Key,Eq,Hash,Alloc>&)
  { return stable_tag(); }

  template <class Key, class T, class Eq, class Hash, class Alloc>
  stable_tag iterator_stability(const STREAMS_BOOST_STD_EXTENSION_NAMESPACE::hash_map<Key,T,Eq,Hash,Alloc>&)
  { return stable_tag(); }
#endif
  ...
  {
    c.push_back(v);
    return std::make_pair(streams_boost::prior(c.end()), true);
  }
...
}} // namespace streams_boost::graph_detail
...
#endif // STREAMS_BOOST_GRAPH_DETAIL_CONTAINER_TRAITS_H
