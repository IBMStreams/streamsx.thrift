...
#ifndef STREAMS_BOOST_UUID_SEED_RNG_HPP
#define STREAMS_BOOST_UUID_SEED_RNG_HPP
...
#include <streams_boost/uuid/sha1.hpp>
//#include <streams_boost/nondet_random.hpp> //forward declare streams_boost::random_device

// can't use streams_boost::generator_iterator since streams_boost::random number seed(Iter&, Iter)
// functions need a last iterator
//#include <streams_boost/generator_iterator.hpp>
...
public:
    ...
    //STREAMS_BOOST_STATIC_CONSTANT(unsigned int, min_value = 0);
    //STREAMS_BOOST_STATIC_CONSTANT(unsigned int, max_value = UINT_MAX);
...
private:
    ...
    {
        streams_boost::uuids::detail::sha1 sha;
...
// almost a copy of streams_boost::generator_iterator
...
template <>
inline void seed<streams_boost::random_device>(streams_boost::random_device&) {}

// random_device does not / can not be seeded
template <>
inline void seed<seed_rng>(seed_rng&) {}

}}} //namespace streams_boost::uuids::detail
