...
//  25 Feb 2008 - moved to namespace streams_boost::uuids
//  19 Mar 2009 - changed to a POD, reorganized files
//  28 Nov 2009 - disabled deprecated warnings for MSVC
//  30 Nov 2009 - used STREAMS_BOOST_STATIC_CONSTANT
//  02 Dec 2009 - removed STREAMS_BOOST_STATIC_CONSTANT - not all compilers like it

#ifndef STREAMS_BOOST_UUID_HPP
#define STREAMS_BOOST_UUID_HPP

#include <streams_boost/config.hpp>
#include <stddef.h>
#include <streams_boost/cstdint.hpp>
#include <algorithm>
#include <streams_boost/config.hpp> // for static assert
...
public:
    ...
    // a cpp file
    //STREAMS_BOOST_STATIC_CONSTANT(size_type, static_size = 16);
...
// This is equivalent to streams_boost::hash_range(u.begin(), u.end());
