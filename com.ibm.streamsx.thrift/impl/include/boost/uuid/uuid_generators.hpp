...
#ifndef STREAMS_BOOST_UUID_GENERATORS_HPP
#define STREAMS_BOOST_UUID_GENERATORS_HPP

#include <streams_boost/uuid/uuid.hpp>
#include <streams_boost/uuid/sha1.hpp>
#include <streams_boost/uuid/seed_rng.hpp>
#include <algorithm>
#include <string>
#include <limits>
#include <cstring>
...
private:
    ...
    void process_characters(char_type const*const characters, size_t count) {
        STREAMS_BOOST_ASSERT(sizeof(uint32_t) >= sizeof(char_type));
...
#endif //STREAMS_BOOST_UUID_GENERATORS_HPP
