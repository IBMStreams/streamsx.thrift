// streams_boost/uuid/sha1.hpp header file  ----------------------------------------------//
...
#ifndef STREAMS_BOOST_UUID_SHA1_H
#define STREAMS_BOOST_UUID_SHA1_H
...
STREAMS_BOOST_STATIC_ASSERT(sizeof(unsigned char)*8 == 8);
STREAMS_BOOST_STATIC_ASSERT(sizeof(unsigned int)*8 == 32);
