...
#ifndef STREAMS_BOOST_PTR_CONTAINER_PTR_CIRCULAR_BUFFER_HPP
#define STREAMS_BOOST_PTR_CONTAINER_PTR_CIRCULAR_BUFFER_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif

#include <streams_boost/circular_buffer.hpp>
...
namespace streams_boost
{
    ...
    class ptr_circular_buffer : public 
        ptr_sequence_adapter< T, 
                              streams_boost::circular_buffer<void*,Allocator>, 
                              CloneAllocator >
    {  
        ...
        typedef streams_boost::circular_buffer<void*,Allocator>         circular_buffer_type;
    ...
    public: // constructors
        ...
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_circular_buffer,
                                                      base_type, this_type )
    ...
    public: // circular buffer functions
        ...
        {
            STREAMS_BOOST_ASSERT( capacity() > 0 );   
        ...
        {
            rinsert( before, streams_boost::begin(r), streams_boost::end(r) );
        }
        ...
        iterator rerase( iterator pos ) // nothrow
        {
            ...
            STREAMS_BOOST_ASSERT( pos != this->end() );
        ...
        {
            return rerase( streams_boost::begin(r), streams_boost::end(r) );
        }
    ...
    public: // transfer        
                       ...
                       PtrSeqAdapter& from ) // nothrow
        {
            ...
            if( from.empty() )
                return;
            for( STREAMS_BOOST_DEDUCED_TYPENAME PtrSeqAdapter::iterator begin = first; 
