...
#ifndef STREAMS_BOOST_PTR_CONTAINER_PTR_SET_ADAPTER_HPP
#define STREAMS_BOOST_PTR_CONTAINER_PTR_SET_ADAPTER_HPP
...
namespace ptr_container_detail
{
    ...
    struct set_config
    {
       ...
       typedef STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrSet::allocator_type 
                    allocator_type;
       ...
       typedef void_ptr_iterator<
                       STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrSet::iterator, Key > 
                    iterator;

       typedef void_ptr_iterator<
                        STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrSet::const_iterator, const Key >
                    const_iterator;
       ...
       STREAMS_BOOST_STATIC_CONSTANT(bool, allow_null = false );
    };
    ...
    public:
        ...
        bool transfer( STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator object, 
        ...
        template< class PtrSetAdapter >
        size_type 
        transfer( STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator first, 
                  STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator last, 
        ...
        STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::disable_if< streams_boost::is_same< Range,
                            STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator >,
                                                            size_type >::type
    ...
    public: // typedefs
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::auto_type
                       auto_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrMultiSet::allocator_type
                       allocator_type;        
    private:
        template< typename II >                                               
        void set_basic_clone_and_insert( II first, II last ) // basic                 
    ...
    public:
        ...
        template< class PtrSetAdapter >
        void transfer( STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator object, 
                       PtrSetAdapter& from ) // strong
        {
        ...
        template< class PtrSetAdapter >
        size_type transfer( STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator first, 
                            STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator last, 
                            PtrSetAdapter& from ) // basic
        {
        ...
        template< class PtrSetAdapter, class Range >
        STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::disable_if< streams_boost::is_same< Range,
                       STREAMS_BOOST_DEDUCED_TYPENAME PtrSetAdapter::iterator >, size_type >::type
        transfer(  const Range& r, PtrSetAdapter& from ) // basic
        {
            return transfer( streams_boost::begin(r), streams_boost::end(r), from );
        }
