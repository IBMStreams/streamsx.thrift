...
#ifndef STREAMS_BOOST_PTR_CONTAINER_DETAIL_REVERSIBLE_PTR_CONTAINER_HPP
#define STREAMS_BOOST_PTR_CONTAINER_DETAIL_REVERSIBLE_PTR_CONTAINER_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif

#include <streams_boost/ptr_container/detail/throw_exception.hpp>
#include <streams_boost/ptr_container/detail/scoped_deleter.hpp>
#include <streams_boost/ptr_container/detail/static_move_ptr.hpp>
#include <streams_boost/ptr_container/exception.hpp>
#include <streams_boost/ptr_container/clone_allocator.hpp>
#include <streams_boost/ptr_container/nullable.hpp>
...
namespace ptr_container_detail
{
    ...
    {
        STREAMS_BOOST_STATIC_CONSTANT(bool, value = is_pointer<T>::value || is_integral<T>::value );
    };
    ...
    {
    private:
        STREAMS_BOOST_STATIC_CONSTANT( bool, allow_null = Config::allow_null );
        
        typedef STREAMS_BOOST_DEDUCED_TYPENAME Config::value_type Ty_;
        ...
        struct null_clone_allocator
        {
            ...
            static Ty_* allocate_clone( const Ty_* x )
            {
                ...
                {
                    STREAMS_BOOST_ASSERT( x != 0 && "Cannot insert clone of null!" );
                }

                Ty_* res = CloneAllocator::allocate_clone( *x );
                STREAMS_BOOST_ASSERT( typeid(*res) == typeid(*x) &&
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME Config::void_container_type  Cont;
    ...
    public: // typedefs
        ...
        typedef  STREAMS_BOOST_DEDUCED_TYPENAME Config::iterator 
                                   iterator;
        typedef  STREAMS_BOOST_DEDUCED_TYPENAME Config::const_iterator
                                   const_iterator;
        typedef  streams_boost::reverse_iterator< iterator > 
                                   reverse_iterator;  
        typedef  streams_boost::reverse_iterator< const_iterator >     
                                   const_reverse_iterator;
        typedef  STREAMS_BOOST_DEDUCED_TYPENAME Cont::difference_type
                                   difference_type; 
        typedef  STREAMS_BOOST_DEDUCED_TYPENAME Cont::size_type
                                   size_type;
        typedef  STREAMS_BOOST_DEDUCED_TYPENAME Config::allocator_type
                                   allocator_type;
    ...
    protected: 
        ...
        typedef ptr_container_detail::scoped_deleter<Ty_,null_cloner_type>
                                   scoped_deleter;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME Cont::iterator
                                   ptr_iterator; 
        typedef STREAMS_BOOST_DEDUCED_TYPENAME Cont::const_iterator
                                   ptr_const_iterator; 
    private:
        ...
        {
            STREAMS_BOOST_ASSERT( size_type( std::distance( sd.begin(), sd.end() ) ) == c_.size() );
        ...
        {
            STREAMS_BOOST_ASSERT( first != last );
    ...
    protected:
        ...
        static void enforce_null_policy( const Ty_* x, const char* msg )
        {
            if( !allow_null )
            {
                STREAMS_BOOST_PTR_CONTAINER_THROW_EXCEPTION( 0 == x && "null not allowed", 
                                                     bad_pointer, msg );
            }
        }
    ...
    public: // modifiers
        ...
        {
            return erase( streams_boost::begin(r), streams_boost::end(r) );
        }
    ...
    public: // access interface
        ...
        { 
            STREAMS_BOOST_ASSERT( where != end() );
            
            STREAMS_BOOST_PTR_CONTAINER_THROW_EXCEPTION( empty(), bad_ptr_container_operation,
                                                 "'release()' on empty container" ); 
            
            auto_type ptr( Config::get_pointer( where ) );  // nothrow
            c_.erase( where.base() );                       // nothrow
            return streams_boost::ptr_container_detail::move( ptr ); 
        }
        ...
        { 
            ...
            return streams_boost::ptr_container_detail::move( old );
        }
        ...
        auto_type replace( size_type idx, Ty_* x ) // strong
        {
            ...
            STREAMS_BOOST_PTR_CONTAINER_THROW_EXCEPTION( idx >= size(), bad_index, 
...
#if STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x564))    
#define STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
    typename base_type::auto_type                   \
    release( typename base_type::iterator i )       \
    {                                               \
        return streams_boost::ptr_container_detail::move(base_type::release(i)); \
    }                                               
#else
#define STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
    ...
    //
#define STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( PC, base_type, this_type ) \
    ...
    STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
                                                    \
...
#define STREAMS_BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( PC, base_type ) \
                                                                      \
    template< class U >                                               \
...
#define STREAMS_BOOST_PTR_CONTAINER_DEFINE_CONSTRUCTORS( PC, base_type )                       \
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::const_reference const_reference;         \
    typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::allocator_type  allocator_type;          \
    PC() {}                                                                            \
...
#define STREAMS_BOOST_PTR_CONTAINER_DEFINE_NON_INHERITED_MEMBERS( PC, base_type, this_type )           \
   STREAMS_BOOST_PTR_CONTAINER_DEFINE_CONSTRUCTORS( PC, base_type )                                    \
   STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( PC, base_type, this_type )

#define STREAMS_BOOST_PTR_CONTAINER_DEFINE_SEQEUENCE_MEMBERS( PC, base_type, this_type )  \
    STREAMS_BOOST_PTR_CONTAINER_DEFINE_NON_INHERITED_MEMBERS( PC, base_type, this_type )  \
    STREAMS_BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( PC, base_type )
