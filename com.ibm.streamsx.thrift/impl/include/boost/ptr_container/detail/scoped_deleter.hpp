...
#ifndef STREAMS_BOOST_PTR_CONTAINER_SCOPED_DELETER_HPP
#define STREAMS_BOOST_PTR_CONTAINER_SCOPED_DELETER_HPP
    ...
    namespace ptr_container_detail
    {
        ...
        public:
                  ...
                  released_( false )
            {
                ...
                STREAMS_BOOST_ASSERT( stored_ > 0 );
            }
            ...
            void add( T* t )
            {
                STREAMS_BOOST_ASSERT( ptrs_.get() != 0 );
                ptrs_[stored_] = t;
                ++stored_;
            }
