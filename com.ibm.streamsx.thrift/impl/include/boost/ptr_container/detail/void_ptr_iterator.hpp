...
#ifndef STREAMS_BOOST_PTR_CONTAINER_DETAIL_VOID_PTR_ITERATOR_HPP
#define STREAMS_BOOST_PTR_CONTAINER_DETAIL_VOID_PTR_ITERATOR_HPP
...
namespace streams_boost
{
        ...
        {
        public:
            typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::remove_const<T>::type        
                             value_type;
            typedef T&       reference;
            typedef T*       pointer;

            typedef  STREAMS_BOOST_DEDUCED_TYPENAME iterator_difference<VoidIter>::type
                             difference_type;           
            typedef  STREAMS_BOOST_DEDUCED_TYPENAME iterator_category<VoidIter>::type
                             iterator_category;           
        private:
        ...
        operator+( void_ptr_iterator<VoidIter,T> l, 
                   STREAMS_BOOST_DEDUCED_TYPENAME void_ptr_iterator<VoidIter,T>::difference_type n )
        {
            l += n;
            return l;
        }
        ...
        template< class VoidIter, class T >
        inline void_ptr_iterator<VoidIter,T> 
        operator+( STREAMS_BOOST_DEDUCED_TYPENAME void_ptr_iterator<VoidIter,T>::difference_type n, 
        ...
        inline STREAMS_BOOST_DEDUCED_TYPENAME void_ptr_iterator<VoidIter,T>::difference_type
        operator-( void_ptr_iterator<VoidIter,T> l,
