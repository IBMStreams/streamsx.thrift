...
// "http://aspn.activestate.com/ASPN/Mail/Message/Attachments/streams_boost/
...
#ifndef STREAMS_BOOST_STATIC_MOVE_PTR_HPP_INCLUDED
#define STREAMS_BOOST_STATIC_MOVE_PTR_HPP_INCLUDED

#include <streams_boost/config.hpp> // Member template friends, put size_t in std.
#include <cstddef>          // size_t
#include <streams_boost/compressed_pair.hpp> 
#include <streams_boost/ptr_container/detail/default_deleter.hpp>       
#include <streams_boost/ptr_container/detail/is_convertible.hpp>       
#include <streams_boost/ptr_container/detail/move.hpp>       
...
private:
    ...
    typedef streams_boost::compressed_pair<element_type*, Deleter> impl_type;
...
public:
    ...
    element_type& operator*() 
        { 
            /*STREAMS_BOOST_STATIC_ASSERT(!is_array);*/ return *ptr(); 
        }
    ...
    void check(const static_move_ptr<TT, DD>& ptr)
        {
            ...
            STREAMS_BOOST_STATIC_ASSERT(convertible::value);
        }   

#if defined(STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING) || defined(STREAMS_BOOST_NO_SFINAE)
...
#endif // STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING || STREAMS_BOOST_NO_SFINAE
...
#endif      // #ifndef STREAMS_BOOST_STATIC_MOVE_PTR_HPP_INCLUDED
