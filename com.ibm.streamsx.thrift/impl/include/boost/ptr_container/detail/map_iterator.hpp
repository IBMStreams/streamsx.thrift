...
#ifndef STREAMS_BOOST_PTR_CONTAINER_MAP_ITERATOR_HPP
#define STREAMS_BOOST_PTR_CONTAINER_MAP_ITERATOR_HPP
...
{ 
        ...
        struct ref_pair
        {
            ...
            friend inline bool operator==( ref_pair l, ref_pair r )
            {
                return l.first == r.first && 
                       streams_boost::equal_pointees( l.second, r.second );
            }
            ...
            {
                if( l.first == r.first )
                    return streams_boost::less_pointees( l.second, r.second );
                else 
                    return l.first < r.first;
            }
    ...
    class ptr_map_iterator : 
        public streams_boost::iterator_adaptor< ptr_map_iterator<I,F,S>, I, 
                                        ptr_container_detail::ref_pair<F,S>, 
                                        use_default, 
                                        ptr_container_detail::ref_pair<F,S> >
    {
        typedef streams_boost::iterator_adaptor< ptr_map_iterator<I,F,S>, I, 
                                         ptr_container_detail::ref_pair<F,S>,
                                         use_default, 
                                         ptr_container_detail::ref_pair<F,S> > 
            base_type;
