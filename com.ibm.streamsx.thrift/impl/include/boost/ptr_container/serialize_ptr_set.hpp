...
#ifndef STREAMS_BOOST_PTR_CONTAINER_SERIALIZE_PTR_SET_HPP
#define STREAMS_BOOST_PTR_CONTAINER_SERIALIZE_PTR_SET_HPP

#include <streams_boost/ptr_container/detail/serialize_reversible_cont.hpp>
#include <streams_boost/ptr_container/ptr_set.hpp>
