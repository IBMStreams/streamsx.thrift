...
#ifndef STREAMS_BOOST_PTR_CONTAINER_PTR_LIST_HPP
#define STREAMS_BOOST_PTR_CONTAINER_PTR_LIST_HPP
...
namespace streams_boost
{
    ...
    public:
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_SEQEUENCE_MEMBERS( ptr_list, 
                                                      base_class,
                                                      this_type )

        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_class::value_type value_type;
    ...
    public:
        ...
        {
            this->base().remove_if( STREAMS_BOOST_DEDUCED_TYPENAME base_class:: 
                    STREAMS_BOOST_NESTED_TEMPLATE void_ptr_delete_if<Pred,value_type>
                                    (pred) );
        } 
