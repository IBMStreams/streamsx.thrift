...
#ifndef STREAMS_BOOST_PTR_CONTAINER_PTR_SET_HPP
#define STREAMS_BOOST_PTR_CONTAINER_PTR_SET_HPP
...
namespace streams_boost
{
    ...
    public:
        ...
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_set,
                                                      base_type,
                                                      this_type )
        
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_set, base_type )
    ...
    public:
        ...
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_multiset, 
                                                      base_type,
                                                      this_type )
        
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_multiset, 
                                                      base_type )     
