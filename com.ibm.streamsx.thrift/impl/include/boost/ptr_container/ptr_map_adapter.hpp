...
#ifndef STREAMS_BOOST_PTR_CONTAINER_DETAIL_PTR_MAP_ADAPTER_HPP
#define STREAMS_BOOST_PTR_CONTAINER_DETAIL_PTR_MAP_ADAPTER_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#endif

#include <streams_boost/ptr_container/detail/map_iterator.hpp>
#include <streams_boost/ptr_container/detail/associative_ptr_container.hpp>
#include <streams_boost/ptr_container/detail/meta_functions.hpp>
...
namespace ptr_container_detail
{
    ...
    struct map_config
    {
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrMap::allocator_type
                     allocator_type;
       ...
       typedef STREAMS_BOOST_DEDUCED_TYPENAME 
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrMap::key_type
                     key_type;
        
        typedef U    value_type;

        typedef ptr_map_iterator< STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrMap::iterator, key_type, U* const >
                     iterator;
        
        typedef ptr_map_iterator< STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrMap::const_iterator, key_type, const U* const>
                     const_iterator;
    ...
    public:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::allocator_type
                    allocator_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::iterator
                    iterator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::const_iterator
                    const_iterator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::size_type
                    size_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::key_type
                    key_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::auto_type
                    auto_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::value_type 
                    mapped_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::reference
                    mapped_reference;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::const_reference
                    const_mapped_reference;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_value<iterator>::type
                    value_type;
        typedef value_type
                    reference;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_value<const_iterator>::type
                    const_reference;
        typedef value_type 
                    pointer;
    ...
    private:
        const_mapped_reference lookup( const key_type& key ) const
        {
           ...
           if( i != this->end() )
               ...
               STREAMS_BOOST_PTR_CONTAINER_THROW_EXCEPTION( true, bad_ptr_container_operation,
    ...
    public:
        ...
        {                                                                            
            std::pair<STREAMS_BOOST_DEDUCED_TYPENAME base_type::ptr_iterator,
                      STREAMS_BOOST_DEDUCED_TYPENAME base_type::ptr_iterator>
        ...
        {                                                                            
            std::pair<STREAMS_BOOST_DEDUCED_TYPENAME base_type::ptr_const_iterator,
                      STREAMS_BOOST_DEDUCED_TYPENAME base_type::ptr_const_iterator> 
                p = this->base().equal_range( x ); 
        ...
        { 
            STREAMS_BOOST_ASSERT( where != this->end() );

            this->enforce_null_policy( x, "Null pointer in 'replace()'" );

            auto_type ptr( x );

            STREAMS_BOOST_PTR_CONTAINER_THROW_EXCEPTION( this->empty(),
            ...
            return streams_boost::ptr_container::move( old );
        }
    ...
    public:    
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrMap::allocator_type 
                    allocator_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::mapped_type
                    mapped_type;
    private:

        void safe_insert( const key_type& key, auto_type ptr ) // strong
        {
            std::pair<STREAMS_BOOST_DEDUCED_TYPENAME base_type::ptr_iterator,bool>
                res = 
            ...
            {                                            
                if( this->find( first->first ) == this->end() )
                {
                    ...
                    this->safe_insert( p.first, 
                                       streams_boost::ptr_container::move( ptr ) );
                                                           // strong, commit 
                }
                ++first;                                                      
            }                                                                 
    ...
    public:
        ...
        {
            insert( streams_boost::begin(r), streams_boost::end(r) );
        }
    ...
    public:
        ...
        bool transfer( STREAMS_BOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator object, 
        ...
        template< class PtrMapAdapter >
        size_type transfer( STREAMS_BOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator first, 
                            STREAMS_BOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator last, 
        ...
        STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::disable_if< streams_boost::is_same< Range,
                            STREAMS_BOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator >,
                                                            size_type >::type
        transfer( const Range& r, PtrMapAdapter& from ) // basic
        {
            return transfer( streams_boost::begin(r), streams_boost::end(r), from );
        }
  ...
  /////////////////////////////////////////////////////////////////////////
    ...
    public: // typedefs
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_type::auto_type
                    auto_type;            
        typedef STREAMS_BOOST_DEDUCED_TYPENAME VoidPtrMultiMap::allocator_type 
                    allocator_type;
    private:
    ...
    public:
        ...
        template< class PtrMapAdapter >
        void transfer( STREAMS_BOOST_DEDUCED_TYPENAME PtrMapAdapter::iterator object, 
                       PtrMapAdapter& from ) // strong
        {
        ...
        void transfer( PtrMapAdapter& from ) // basic
        {
            ...
            STREAMS_BOOST_ASSERT( from.empty() );
        }
