...
#ifndef STREAMS_BOOST_PTR_CONTAINER_PTR_UNORDERED_SET_HPP
#define STREAMS_BOOST_PTR_CONTAINER_PTR_UNORDERED_SET_HPP
...
#include <streams_boost/ptr_container/ptr_set_adapter.hpp>
...
namespace streams_boost
{
    ...
    class ptr_unordered_set : 
        public ptr_set_adapter< Key, 
                                streams_boost::unordered_set<void*,void_ptr_indirect_fun<Hash,Key>,
    ...
    public:
        ...
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_unordered_set,
                                                      base_type,
                                                      this_type )
        
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_unordered_set, 
                                                      base_type )
    ...
    class ptr_unordered_multiset : 
          public ptr_multiset_adapter< Key, 
                                streams_boost::unordered_multiset<void*,void_ptr_indirect_fun<Hash,Key>,
                                                                void_ptr_indirect_fun<Pred,Key>,Allocator>,
                                            CloneAllocator, false >
    {
    ...
    public:
        ...
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_unordered_multiset, 
                                                      base_type,
                                                      this_type )
         
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS( ptr_unordered_multiset, 
                                                      base_type )     
