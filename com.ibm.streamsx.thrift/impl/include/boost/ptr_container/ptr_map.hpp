...
#ifndef STREAMS_BOOST_PTR_CONTAINER_PTR_MAP_HPP
#define STREAMS_BOOST_PTR_CONTAINER_PTR_MAP_HPP
...
namespace streams_boost
{
    ...
    public:
        ...
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_map, base_type, 
                                                      this_type )
    ...
    public:
        ...
        STREAMS_BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE( ptr_multimap, 
                                                      base_type,
                                                      this_type )
