...
#ifndef STREAMS_BOOST_PTR_CONTAINER_PTR_ARRAY_HPP
#define STREAMS_BOOST_PTR_CONTAINER_PTR_ARRAY_HPP
...
namespace streams_boost
{
    ...
    namespace ptr_container_detail
    {
        ...
        >
        class ptr_array_impl : public streams_boost::array<T,N>
        {
        public:
    ...
    private:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME remove_nullable<T>::type U;
    ...
    public:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_class::auto_type
                            auto_type;
    ...
    public: // compile-time interface
        ...
        {
            STREAMS_BOOST_STATIC_ASSERT( idx < N );
            ...
            return streams_boost::ptr_container::move(res);                // nothrow 
        }
        ...
        auto_type replace( size_t idx, U* r ) // strong
        {
            ...
            STREAMS_BOOST_PTR_CONTAINER_THROW_EXCEPTION( idx >= N, bad_index,
