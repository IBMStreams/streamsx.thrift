...
#ifndef STREAMS_BOOST_TR1_DETAIL_CONFIG_ALL_HPP_INCLUDED
#  define STREAMS_BOOST_TR1_DETAIL_CONFIG_ALL_HPP_INCLUDED

//
// IMPORTANT: we must figure out the basics, such as how to
// forward to the real std lib headers *without* including
// streams_boost/config.hpp or any of the std lib headers.  A classic 
...
#        define STREAMS_BOOST_TR1_STD_CHEADER(name) <../include/ansi/name>
#     endif
#  endif
...
#        define STREAMS_BOOST_TR1_STD_HEADER(name) <../stlport4/name>
#     elif defined(__PGI)
#        define STREAMS_BOOST_TR1_STD_HEADER(name) <../CC/name>
#     else
#        define STREAMS_BOOST_TR1_STD_HEADER(name) <../stlport/name>
#     endif

#  elif defined(__HP_aCC)
      // HP aCC include path:
#     define STREAMS_BOOST_TR1_STD_HEADER(name) <../include_std/name>

#  elif defined(__DECCXX)
#     define STREAMS_BOOST_TR1_STD_HEADER(name) <../cxx/name>

#  elif defined(__BORLANDC__) && __BORLANDC__ >= 0x570
#     define STREAMS_BOOST_TR1_STD_HEADER(name) <../include/dinkumware/name>

#  elif defined(__GNUC__) && __GNUC__ >= 3
#    if defined(STREAMS_BOOST_TR1_GCC_INCLUDE_PATH)
#      define STREAMS_BOOST_TR1_STD_HEADER(name) <../STREAMS_BOOST_TR1_GCC_INCLUDE_PATH/name>
#    elif ( (__GNUC__ == 3 ) && ((__GNUC_MINOR__ == 0) || ((__GNUC_MINOR__ < 3) && defined(__APPLE_CC__))))
#      define STREAMS_BOOST_TR1_STD_HEADER(name) <../g++-v3/name>
#    else
#      if ( ((__GNUC__ == 3 ) && (__GNUC_MINOR__ >= 3)) && (defined(__APPLE_CC__) || defined(__CYGWIN__)))
#        define STREAMS_BOOST_TR1_STD_HEADER(name) <../c++/name>
#      elif ((__GLIBCXX__ == 20050421) && defined(__APPLE_CC__))
         // Some Darwin tools fix libstdc++ at 4.0.0 irrespective of the actual
         // compiler version:
#        define STREAMS_BOOST_TR1_STD_HEADER(name) <../4.0.0/name>
         /*
...
#      elif defined (__GNUC_PATCHLEVEL__) && ((__GNUC_PATCHLEVEL__ > 0) || \
                                              ...
                                              (__GNUC__ > 3))
#        define STREAMS_BOOST_TR1_STD_HEADER(name) <../__GNUC__.__GNUC_MINOR__.__GNUC_PATCHLEVEL__/name>
#      else
#        define STREAMS_BOOST_TR1_STD_HEADER(name) <../__GNUC__.__GNUC_MINOR__/name>
#      endif
#    endif

#      if !defined(STREAMS_BOOST_TR1_DISABLE_INCLUDE_NEXT) && !defined(__ICC) \
...
#        define STREAMS_BOOST_TR1_DISABLE_INCLUDE_NEXT
#      endif

#  else
#     define STREAMS_BOOST_TR1_STD_HEADER(name) <../include/name>
#  endif

#if !defined(STREAMS_BOOST_TR1_STD_CHEADER)
#  define STREAMS_BOOST_TR1_STD_CHEADER(name) STREAMS_BOOST_TR1_STD_HEADER(name)
#endif

#if defined(__GNUC__) && !defined(STREAMS_BOOST_HAS_INCLUDE_NEXT)
#  define STREAMS_BOOST_HAS_INCLUDE_NEXT
#endif
#ifdef __GXX_EXPERIMENTAL_CXX0X__
#  define STREAMS_BOOST_HAS_CPP_0X
#endif

//
// We may be in the middle of parsing streams_boost/config.hpp
...
//
// We don't take this branch if STREAMS_BOOST_TR1_DISABLE_INCLUDE_NEXT
...
#     define STREAMS_BOOST_TR1_NO_CONFIG_ALL_RECURSION
#  endif
...
#  endif
#  ifdef STREAMS_BOOST_TR1_NO_CONFIG_ALL_RECURSION
#     undef STREAMS_BOOST_TR1_NO_CONFIG_ALL_RECURSION
