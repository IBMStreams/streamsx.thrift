...
#ifndef STREAMS_BOOST_TR1_COMPLEX_HPP_INCLUDED
#  define STREAMS_BOOST_TR1_COMPLEX_HPP_INCLUDED
#  include <streams_boost/tr1/detail/config.hpp>
#  include <complex>

#ifndef STREAMS_BOOST_HAS_TR1_COMPLEX_INVERSE_TRIG

#include <streams_boost/math/complex.hpp>

namespace std {
namespace tr1 {

using streams_boost::math::acos;
using streams_boost::math::asin;
using streams_boost::math::atan;
using streams_boost::math::acosh;
using streams_boost::math::asinh;
using streams_boost::math::atanh;
using streams_boost::math::fabs;
...
#     include_next STREAMS_BOOST_TR1_HEADER(complex)
#  else
#     include <streams_boost/tr1/detail/config_all.hpp>
#     include STREAMS_BOOST_TR1_STD_HEADER(STREAMS_BOOST_TR1_PATH(complex))
#  endif

#endif

#ifndef STREAMS_BOOST_HAS_TR1_COMPLEX_OVERLOADS

#include <streams_boost/tr1/detail/math_overloads.hpp>
...
template <class T>
inline STREAMS_BOOST_TR1_MATH_RETURN(double) arg(const T& t)
{
...
#ifndef STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING
template <class T>
inline STREAMS_BOOST_TR1_MATH_RETURN(double) norm(const T& t)
{
...
#ifndef STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING
template <class T>
inline STREAMS_BOOST_TR1_MATH_RETURN(std::complex<double>) conj(const T& t)
{
...
#if !STREAMS_BOOST_WORKAROUND(__BORLANDC__, <=0x570) && !STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, < 1310)
...
inline complex<typename streams_boost::tr1_detail::promote_to_real<T, U>::type> 
   polar(const T& rho, const U& theta)
{
   typedef typename streams_boost::tr1_detail::promote_to_real<T, U>::type real_type;
...
#ifndef STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING
template <class T>
inline STREAMS_BOOST_TR1_MATH_RETURN(double) imag(const T& )
{
   return 0;
}
#else
...
#ifndef STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING
template <class T>
inline STREAMS_BOOST_TR1_MATH_RETURN(double) real(const T& t)
{
...
template<class T, class U>
inline complex<typename streams_boost::tr1_detail::largest_real<T, U>::type>
   pow(const complex<T>& x, const complex<U>& y)
{
   typedef complex<typename streams_boost::tr1_detail::largest_real<T, U>::type> result_type;
   typedef typename streams_boost::mpl::if_<streams_boost::is_same<result_type, complex<T> >, result_type const&, result_type>::type cast1_type;
   typedef typename streams_boost::mpl::if_<streams_boost::is_same<result_type, complex<U> >, result_type const&, result_type>::type cast2_type;
   cast1_type x1(x);
   cast2_type y1(y);
...
{
   typedef typename streams_boost::tr1_detail::promote_to_real<T, U>::type real_type;
   typedef complex<typename streams_boost::tr1_detail::promote_to_real<T, U>::type> result_type;
   typedef typename streams_boost::mpl::if_<streams_boost::is_same<result_type, complex<T> >, result_type const&, result_type>::type cast1_type;
   real_type r = y;
   cast1_type x1(x);
   ...
   pow (const T& x, const complex<U>& y)
{
   typedef typename streams_boost::tr1_detail::promote_to_real<T, U>::type real_type;
   typedef complex<typename streams_boost::tr1_detail::promote_to_real<T, U>::type> result_type;
   typedef typename streams_boost::mpl::if_<streams_boost::is_same<result_type, complex<U> >, result_type const&, result_type>::type cast_type;
   real_type r = x;
