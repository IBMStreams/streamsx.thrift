//  streams_boost/system/error_code.hpp  ---------------------------------------------//
...
//  See library home page at http://www.streams_boost.org/libs/system

#ifndef STREAMS_BOOST_ERROR_CODE_HPP
#define STREAMS_BOOST_ERROR_CODE_HPP

#include <streams_boost/system/config.hpp>
...
#if !defined(STREAMS_BOOST_POSIX_API) && !defined(STREAMS_BOOST_WINDOWS_API)
#  error STREAMS_BOOST_POSIX_API or STREAMS_BOOST_WINDOWS_API must be defined
#endif
...
# ifndef STREAMS_BOOST_SYSTEM_NO_DEPRECATED
...
# endif
    ...
    //
    //       <streams_boost/system/cygwin_error.hpp>
    //       <streams_boost/system/linux_error.hpp>
    //       <streams_boost/system/windows_error.hpp>
    //
    ...
    STREAMS_BOOST_SYSTEM_DECL const error_category &  get_system_category();
    STREAMS_BOOST_SYSTEM_DECL const error_category &  get_generic_category();
    ...
    public:
      ...
      template <class ErrorConditionEnum>
        error_condition(ErrorConditionEnum e,
          typename streams_boost::enable_if<is_error_condition_enum<ErrorConditionEnum> >::type* = 0)
      {
      ...
      template<typename ErrorConditionEnum>
        typename streams_boost::enable_if<is_error_condition_enum<ErrorConditionEnum>, error_condition>::type &
    ...
    public:
      ...
      template <class ErrorCodeEnum>
        error_code(ErrorCodeEnum e,
          typename streams_boost::enable_if<is_error_code_enum<ErrorCodeEnum> >::type* = 0)
      {
      ...
      template<typename ErrorCodeEnum>
        typename streams_boost::enable_if<is_error_code_enum<ErrorCodeEnum>, error_code>::type &
...
# ifndef STREAMS_BOOST_SYSTEM_NO_DEPRECATED
    STREAMS_BOOST_SYSTEM_DECL extern error_code throws;
# endif
    ...
    //  "throws" function in namespace streams_boost rather than namespace streams_boost::system.
...
# ifdef STREAMS_BOOST_ERROR_CODE_HEADER_ONLY
#   include <streams_boost/../libs/system/src/error_code.cpp>
# endif

#endif // STREAMS_BOOST_ERROR_CODE_HPP
