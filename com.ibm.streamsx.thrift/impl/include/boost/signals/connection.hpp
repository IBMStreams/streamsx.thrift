...
#ifndef STREAMS_BOOST_SIGNALS_CONNECTION_HPP
#define STREAMS_BOOST_SIGNALS_CONNECTION_HPP
...
namespace streams_boost {
  namespace STREAMS_BOOST_SIGNALS_NAMESPACE {
    ...
    class STREAMS_BOOST_SIGNALS_DECL connection :
    ...
    public: // TBD: CHANGE THIS
      ...
      shared_ptr<STREAMS_BOOST_SIGNALS_NAMESPACE::detail::basic_connection>
    ...
    private:
      ...
      void reset(STREAMS_BOOST_SIGNALS_NAMESPACE::detail::basic_connection*);

      // Add a bound object to this connection (not for users)
      void add_bound_object(const STREAMS_BOOST_SIGNALS_NAMESPACE::detail::bound_object& b);

      friend class STREAMS_BOOST_SIGNALS_NAMESPACE::detail::bound_objects_visitor;

      // Pointer to the actual contents of the connection
      shared_ptr<STREAMS_BOOST_SIGNALS_NAMESPACE::detail::basic_connection> con;
    ...
    class STREAMS_BOOST_SIGNALS_DECL scoped_connection : public connection {
    public:
...
#endif // STREAMS_BOOST_SIGNALS_CONNECTION_HPP
