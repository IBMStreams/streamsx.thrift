...
#ifndef STREAMS_BOOST_SIGNALS_NAMED_SLOT_MAP_HPP
#define STREAMS_BOOST_SIGNALS_NAMED_SLOT_MAP_HPP
...
namespace streams_boost { namespace STREAMS_BOOST_SIGNALS_NAMESPACE {
...
class STREAMS_BOOST_SIGNALS_DECL named_slot_map_iterator :
...
#if STREAMS_BOOST_WORKAROUND(_MSC_VER, <= 1600)
  void decrement();
...
class STREAMS_BOOST_SIGNALS_DECL named_slot_map
{
public:
...
#endif // STREAMS_BOOST_SIGNALS_NAMED_SLOT_MAP_HPP
