...
#ifndef STREAMS_BOOST_SIGNALS2_SLOT_GROUPS_HPP
#define STREAMS_BOOST_SIGNALS2_SLOT_GROUPS_HPP
...
namespace streams_boost {
  namespace signals2 {
    namespace detail {
      ...
      struct group_key
      {
        typedef std::pair<enum slot_meta_group, streams_boost::optional<Group> > type;
      };
      ...
      public:
          ...
          _group_map(other._group_map), _group_key_compare(other._group_key_compare)
        {
          ...
          {
            STREAMS_BOOST_ASSERT(this_map_it != _group_map.end());
        ...
        {
          STREAMS_BOOST_ASSERT(it != _list.end());
          map_iterator map_it = _group_map.lower_bound(key);
          STREAMS_BOOST_ASSERT(map_it != _group_map.end());
          STREAMS_BOOST_ASSERT(weakly_equivalent(map_it->first, key));
          if(map_it->second == it)
          {
            iterator next = it;
            ++next;
...
#endif // STREAMS_BOOST_SIGNALS2_SLOT_GROUPS_HPP
