/*
  Helper class used by variadic implementation of variadic streams_boost::signals2::signal.
...
#ifndef STREAMS_BOOST_SIGNALS2_DETAIL_VARIADIC_SLOT_INVOKER_HPP
#define STREAMS_BOOST_SIGNALS2_DETAIL_VARIADIC_SLOT_INVOKER_HPP

#include <streams_boost/signals2/detail/variadic_arg_type.hpp>
// if compiler has variadic template support, we assume they have
// a variadic std::tuple implementation here.  We don't use streams_boost::tuple
...
#endif // STREAMS_BOOST_SIGNALS2_DETAIL_VARIADIC_SLOT_INVOKER_HPP
