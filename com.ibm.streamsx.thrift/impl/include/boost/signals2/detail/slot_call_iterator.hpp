...
#ifndef STREAMS_BOOST_SIGNALS2_SLOT_CALL_ITERATOR_HPP
#define STREAMS_BOOST_SIGNALS2_SLOT_CALL_ITERATOR_HPP
...
#include <streams_boost/signals2/detail/auto_buffer.hpp>
  ...
  namespace signals2 {
    namespace detail {
      ...
      public:
        ...
        typedef auto_buffer<streams_boost::shared_ptr<void>, store_n_objects<10> > tracked_ptrs_type;
      ...
      class slot_call_iterator_t
        : public streams_boost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
        typename Function::result_type,
        streams_boost::single_pass_traversal_tag,
        typename Function::result_type const&>
      {
        typedef streams_boost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
          typename Function::result_type,
          streams_boost::single_pass_traversal_tag,
          typename Function::result_type const&>
        inherited;
...
#endif // STREAMS_BOOST_SIGNALS2_SLOT_CALL_ITERATOR_HPP
