...
#ifndef STREAMS_BOOST_SIGNALS2_TRACKED_OBJECTS_VISITOR_HPP
#define STREAMS_BOOST_SIGNALS2_TRACKED_OBJECTS_VISITOR_HPP
...
#include <streams_boost/signals2/trackable.hpp>
  ...
  namespace signals2
  {
    namespace detail
    {
      ...
      private:
        ...
        {
            m_visit_pointer(streams_boost::addressof(t), mpl::bool_<true>());
        }
        template<typename T>
...
#endif // STREAMS_BOOST_SIGNALS2_TRACKED_OBJECTS_VISITOR_HPP
