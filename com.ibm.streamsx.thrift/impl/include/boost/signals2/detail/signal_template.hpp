...
#define STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION \
  STREAMS_BOOST_SIGNALS2_SIGNATURE_TEMPLATE_INSTANTIATION(STREAMS_BOOST_SIGNALS2_NUM_ARGS), \
...
namespace streams_boost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      template<typename R>
        class STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
      {
      public:
        typedef R result_type;
        template<typename ExtendedSlotFunction STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
          ...
          result_type operator()(ExtendedSlotFunction &func, const connection &conn
            STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
            STREAMS_BOOST_SIGNALS2_FULL_REF_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS)) const
        {
          return func(conn STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
            STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
        }
      };
#ifdef STREAMS_BOOST_NO_VOID_RETURNS
      template<>
        class STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)<void>
      {
      public:
        ...
        template<typename ExtendedSlotFunction STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
          ...
          result_type operator()(ExtendedSlotFunction &func, const connection &conn
            ...
            STREAMS_BOOST_SIGNALS2_FULL_REF_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS)) const
        {
          func(conn STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
            STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
          return result_type();
        }
      };
...
// signalN::slot_function
      ...
      template<typename ExtendedSlotFunction>
        class STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
      {
      public:
        typedef typename result_type_wrapper<typename ExtendedSlotFunction::result_type>::type result_type;
        STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)(const ExtendedSlotFunction &fun):
...
#if STREAMS_BOOST_SIGNALS2_NUM_ARGS > 0
        template<STREAMS_BOOST_SIGNALS2_ARGS_TEMPLATE_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
#endif // STREAMS_BOOST_SIGNALS2_NUM_ARGS > 0
          result_type operator()(STREAMS_BOOST_SIGNALS2_FULL_REF_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS))
        {
          return STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
            <typename ExtendedSlotFunction::result_type>()
            (_fun, *_connection STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
              STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
        }
        // const overload
#if STREAMS_BOOST_SIGNALS2_NUM_ARGS > 0
        template<STREAMS_BOOST_SIGNALS2_ARGS_TEMPLATE_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
#endif // STREAMS_BOOST_SIGNALS2_NUM_ARGS > 0
          result_type operator()(STREAMS_BOOST_SIGNALS2_FULL_REF_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS)) const
        {
          return STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_INVOKER_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
            <typename ExtendedSlotFunction::result_type>()
            (_fun, *_connection STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
      ...
      private:
        STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)()
        {}

        ExtendedSlotFunction _fun;
        streams_boost::shared_ptr<connection> _connection;
      };

      template<STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
        class STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS);

      template<STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
      class STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS) STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION
      {
      public:
        ...
        typedef STREAMS_BOOST_SIGNALS2_EXTENDED_SLOT_TYPE(STREAMS_BOOST_SIGNALS2_NUM_ARGS) extended_slot_type;
      ...
      private:
        ...
        typedef STREAMS_BOOST_SIGNALS2_BOUND_EXTENDED_SLOT_FUNCTION_N(STREAMS_BOOST_SIGNALS2_NUM_ARGS)<extended_slot_function_type>
      ...
      public:
        ...
        STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)(const combiner_type &combiner,
        ...
        // emit signal
        result_type operator ()(STREAMS_BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS))
        {
          shared_ptr<invocation_state> local_state;
          typename connection_list_type::iterator it;
          {
          ...
          slot_invoker invoker = slot_invoker(STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
        ...
        result_type operator ()(STREAMS_BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS)) const
        {
          shared_ptr<invocation_state> local_state;
          typename connection_list_type::iterator it;
          {
...
#define STREAMS_BOOST_SIGNALS2_ADD_REF_ARG(z, n, data) \
  typename add_reference<STREAMS_BOOST_PP_CAT(T, STREAMS_BOOST_PP_INC(n))>::type \
  STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAME(~, n, ~)
// typename add_reference<T1>::type arg1, typename add_reference<T2>::type arg2, ..., typename add_reference<Tn>::type argn
#define STREAMS_BOOST_SIGNALS2_ADD_REF_ARGS(arity) \
  STREAMS_BOOST_PP_ENUM(arity, STREAMS_BOOST_SIGNALS2_ADD_REF_ARG, ~)
          slot_invoker(STREAMS_BOOST_SIGNALS2_ADD_REF_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS)) STREAMS_BOOST_PP_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS, :, )
#undef STREAMS_BOOST_SIGNALS2_ADD_REF_ARGS

// argn ( argn ) ,
#define STREAMS_BOOST_SIGNALS2_MISC_STATEMENT(z, n, data) \
  STREAMS_BOOST_PP_CAT(arg, n) ( STREAMS_BOOST_PP_CAT(arg, n) )
// arg1(arg1), arg2(arg2), ..., argn(argn)
            STREAMS_BOOST_PP_ENUM_SHIFTED(STREAMS_BOOST_PP_INC(STREAMS_BOOST_SIGNALS2_NUM_ARGS), STREAMS_BOOST_SIGNALS2_MISC_STATEMENT, ~)
#undef STREAMS_BOOST_SIGNALS2_MISC_STATEMENT
        ...
        private:
#define STREAMS_BOOST_SIGNALS2_ADD_REF_ARG_STATEMENT(z, n, data) \
  STREAMS_BOOST_SIGNALS2_ADD_REF_ARG(z, n, data) ;
          STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_SIGNALS2_NUM_ARGS, STREAMS_BOOST_SIGNALS2_ADD_REF_ARG_STATEMENT, ~)
#undef STREAMS_BOOST_SIGNALS2_ADD_REF_ARG_STATEMENT
#undef STREAMS_BOOST_SIGNALS2_ADD_REF_ARG
          result_type m_invoke(const connection_body_type &connectionBody,
            const void_type *) const
          {
            connectionBody->slot.slot_function()(STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
            return void_type();
          }
          result_type m_invoke(const connection_body_type &connectionBody, ...) const
          {
            return connectionBody->slot.slot_function()(STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
          }
        };
#endif // STREAMS_BOOST_NO_VARIADIC_TEMPLATES
        ...
        {
        public:
          typedef STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS) signal_type;
          invocation_janitor
          (
        ...
        {
          STREAMS_BOOST_ASSERT(_shared_state.unique());
          typename connection_list_type::iterator it;
      ...
      template<STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
        class STREAMS_BOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS);
    }

    template<STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_DEFAULTED_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
      class STREAMS_BOOST_SIGNALS2_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS);

    template<STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
    class STREAMS_BOOST_SIGNALS2_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
      STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION: public signal_base,
      public detail::STREAMS_BOOST_SIGNALS2_STD_FUNCTIONAL_BASE
        (typename detail::result_type_wrapper<typename Combiner::result_type>::type)
    {
      typedef detail::STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
        <STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> impl_class;
    public:
      typedef detail::STREAMS_BOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
        <STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> weak_signal_type;
      friend class detail::STREAMS_BOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
        <STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION>;
...
#undef STREAMS_BOOST_SIGNALS2_MISC_STATEMENT
      ...
      STREAMS_BOOST_SIGNALS2_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)(const combiner_type &combiner = combiner_type(),
        const group_compare_type &group_compare = group_compare_type()):
        _pimpl(new impl_class(combiner, group_compare))
      {};
      virtual ~STREAMS_BOOST_SIGNALS2_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)()
      {
      ...
      result_type operator ()(STREAMS_BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS))
      {
        return (*_pimpl)(STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
      }
      result_type operator ()(STREAMS_BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS)) const
      {
        return (*_pimpl)(STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
    ...
    namespace detail
    {
      ...
      template<STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION_DECL(STREAMS_BOOST_SIGNALS2_NUM_ARGS)>
        class STREAMS_BOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
        STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_SPECIALIZATION
      {
      public:
        typedef typename STREAMS_BOOST_SIGNALS2_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
          <STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION>::result_type
          result_type;

        STREAMS_BOOST_SIGNALS2_WEAK_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
          (const STREAMS_BOOST_SIGNALS2_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
          <STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION>
          &signal):
        ...
        result_type operator ()(STREAMS_BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS))
        {
          shared_ptr<detail::STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
            <STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> >
            shared_pimpl(_weak_pimpl.lock());
          if(shared_pimpl == 0) streams_boost::throw_exception(expired_slot());
          return (*shared_pimpl)(STREAMS_BOOST_SIGNALS2_SIGNATURE_ARG_NAMES(STREAMS_BOOST_SIGNALS2_NUM_ARGS));
        }
        result_type operator ()(STREAMS_BOOST_SIGNALS2_SIGNATURE_FULL_ARGS(STREAMS_BOOST_SIGNALS2_NUM_ARGS)) const
        {
          shared_ptr<detail::STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
      ...
      private:
        streams_boost::weak_ptr<detail::STREAMS_BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)
          <STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION> > _weak_pimpl;
      };

#ifndef STREAMS_BOOST_NO_VARIADIC_TEMPLATES
      ...
      template<typename Signature>
        class extended_signature<STREAMS_BOOST_SIGNALS2_NUM_ARGS, Signature>
      {
      public:
// typename function_traits<Signature>::result_type (
// const streams_boost::signals2::connection &,
...
#define STREAMS_BOOST_SIGNALS2_EXT_SIGNATURE(arity, Signature) \
  typename function_traits<Signature>::result_type ( \
  const streams_boost::signals2::connection & STREAMS_BOOST_SIGNALS2_PP_COMMA_IF(STREAMS_BOOST_SIGNALS2_NUM_ARGS) \
  STREAMS_BOOST_PP_ENUM(arity, STREAMS_BOOST_SIGNALS2_SIGNATURE_TO_ARGN_TYPE, Signature) )
        typedef function<STREAMS_BOOST_SIGNALS2_EXT_SIGNATURE(STREAMS_BOOST_SIGNALS2_NUM_ARGS, Signature)> function_type;
#undef STREAMS_BOOST_SIGNALS2_EXT_SIGNATURE
      };
      ...
      template<typename Signature, typename Combiner, typename Group,
        ...
        typename ExtendedSlotFunction, typename Mutex>
      class signalN<STREAMS_BOOST_SIGNALS2_NUM_ARGS, Signature, Combiner, Group,
        GroupCompare, SlotFunction, ExtendedSlotFunction, Mutex>
      {
      public:
        typedef STREAMS_BOOST_SIGNALS2_SIGNAL_CLASS_NAME(STREAMS_BOOST_SIGNALS2_NUM_ARGS)<
...
#undef STREAMS_BOOST_SIGNALS2_SIGNAL_TEMPLATE_INSTANTIATION
