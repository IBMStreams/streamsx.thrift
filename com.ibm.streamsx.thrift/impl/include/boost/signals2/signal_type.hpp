/*
  ...
  the streams_boost::signals2::signal class.
...
#ifndef STREAMS_BOOST_SIGNALS2_SIGNAL_TYPE_HPP
#define STREAMS_BOOST_SIGNALS2_SIGNAL_TYPE_HPP

// support for function types is currently broken in Boost.Parameter
// #define STREAMS_BOOST_SIGNALS2_NAMED_SIGNATURE_PARAMETER

#include <streams_boost/signals2/signal.hpp>

#if !defined(STREAMS_BOOST_PARAMETER_MAX_ARITY)
#define STREAMS_BOOST_PARAMETER_MAX_ARITY 7
#else
#if STREAMS_BOOST_PARAMETER_MAX_ARITY < 7
#error This header requires STREAMS_BOOST_PARAMETER_MAX_ARITY to be defined as 7 or greater prior to including Boost.Parameter headers
#endif // STREAMS_BOOST_PARAMETER_MAX_ARITY < 7
#endif // !defined(STREAMS_BOOST_PARAMETER_MAX_ARITY)
#include <streams_boost/parameter.hpp>
...
namespace streams_boost
{
  namespace signals2
  {
    namespace keywords
    {
#ifdef STREAMS_BOOST_SIGNALS2_NAMED_SIGNATURE_PARAMETER
      STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(signature_type)
#endif
      STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(combiner_type)
      STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(group_type)
      STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(group_compare_type)
      STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(slot_function_type)
      STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(extended_slot_function_type)
      STREAMS_BOOST_PARAMETER_TEMPLATE_KEYWORD(mutex_type)
    } // namespace keywords
...
#ifdef STREAMS_BOOST_SIGNALS2_NAMED_SIGNATURE_PARAMETER
          parameter::required<keywords::tag::signature_type, is_function<streams_boost::mpl::_> >,
#endif
    ...
    public:
      ...
      typedef typename parameter::value_type
        <
          ...
          optional_last_value
            <
              typename streams_boost::function_traits<signature_type>::result_type
            >
        >::type combiner_type;
...
#endif // STREAMS_BOOST_SIGNALS2_SIGNAL_TYPE_HPP
