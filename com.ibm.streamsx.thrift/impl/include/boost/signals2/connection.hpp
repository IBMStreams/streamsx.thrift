/*
  streams_boost::signals2::connection provides a handle to a signal/slot connection.
...
#ifndef STREAMS_BOOST_SIGNALS2_CONNECTION_HPP
#define STREAMS_BOOST_SIGNALS2_CONNECTION_HPP

#include <streams_boost/function.hpp>
#include <streams_boost/mpl/bool.hpp>
#include <streams_boost/noncopyable.hpp>
#include <streams_boost/shared_ptr.hpp>
#include <streams_boost/signals2/detail/null_output_iterator.hpp>
...
namespace streams_boost
{
  namespace signals2
  {
      ...
      public:
          ...
          void nolock_grab_tracked_objects(OutputIterator inserter) const
        {
            ...
            for(it = slot.tracked_objects().begin();
              ...
              ++it)
            {
              streams_boost::shared_ptr<void> locked_object = it->lock();
              streams_boost::shared_ptr<void> empty;
    ...
    public:
      ...
      {}
      connection(const streams_boost::weak_ptr<detail::connection_body_base> &connectionBody):
        _weak_connection_body(connectionBody)
      {}
      ~connection() {}
      void disconnect() const
      {
        streams_boost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
      ...
      {
        streams_boost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
        streams_boost::shared_ptr<detail::connection_body_base> otherConnectionBody(other._weak_connection_body.lock());
...
#endif  // STREAMS_BOOST_SIGNALS2_CONNECTION_HPP
