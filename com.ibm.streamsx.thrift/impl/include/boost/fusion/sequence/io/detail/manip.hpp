...
#else // defined(STREAMS_BOOST_NO_TEMPLATED_STREAMS)
...
#else // defined(STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING)
...
#endif // defined(STREAMS_BOOST_NO_TEMPLATED_STREAMS)
