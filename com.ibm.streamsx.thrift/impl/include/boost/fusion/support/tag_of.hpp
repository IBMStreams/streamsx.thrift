...
namespace streams_boost { namespace fusion
{
    ...
    namespace detail
    {
        STREAMS_BOOST_MPL_HAS_XXX_TRAIT_DEF(fusion_tag)
        ...
        template <typename T, std::size_t N>
        struct is_specialized<streams_boost::array<T, N> >
          : mpl::true_
        {};
    ...
    namespace traits
    {
        ...
        {
            STREAMS_BOOST_MPL_ASSERT_NOT((fusion::detail::is_specialized<Sequence>));
        };

        template <typename Sequence>
        struct tag_of<Sequence, typename streams_boost::enable_if<detail::has_fusion_tag<Sequence> >::type>
        {
