...
#if !defined(STREAMS_BOOST_FUSION_FUNCTIONAL_ADAPTER_UNFUSED_HPP_INCLUDED)
    ...
    template <class Function> class unfused<Function,false>
    {
      ...
      public:
        ...
        #define  STREAMS_BOOST_PP_FILENAME_1 \
            <streams_boost/fusion/functional/adapter/unfused.hpp>
        #define  STREAMS_BOOST_PP_ITERATION_LIMITS \
            (1,STREAMS_BOOST_FUSION_UNFUSED_MAX_ARITY)
...
{
    template<class F>
    struct result_of< streams_boost::fusion::unfused<F> const () >
    {
        typedef typename streams_boost::fusion::unfused<F>::call_const_0_result type;
    };
    template<class F>
    struct result_of< streams_boost::fusion::unfused<F>() >
    {
        typedef typename streams_boost::fusion::unfused<F>::call_0_result type;
    };
}

#define STREAMS_BOOST_FUSION_FUNCTIONAL_ADAPTER_UNFUSED_HPP_INCLUDED
