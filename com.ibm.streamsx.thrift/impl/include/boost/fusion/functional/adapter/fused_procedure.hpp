...
#if !defined(STREAMS_BOOST_FUSION_FUNCTIONAL_ADAPTER_FUSED_PROCEDURE_HPP_INCLUDED)
#define STREAMS_BOOST_FUSION_FUNCTIONAL_ADAPTER_FUSED_PROCEDURE_HPP_INCLUDED

#include <streams_boost/type_traits/add_reference.hpp>

#include <streams_boost/fusion/functional/adapter/detail/access.hpp>
#include <streams_boost/fusion/functional/invocation/invoke_procedure.hpp>
