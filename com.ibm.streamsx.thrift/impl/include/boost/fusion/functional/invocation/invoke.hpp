...
#if !defined(STREAMS_BOOST_FUSION_FUNCTIONAL_INVOCATION_INVOKE_HPP_INCLUDED)
...
#include <streams_boost/function_types/is_function.hpp>
#include <streams_boost/function_types/is_callable_builtin.hpp>
#include <streams_boost/function_types/is_member_pointer.hpp>
#include <streams_boost/function_types/is_member_function_pointer.hpp>
#include <streams_boost/function_types/result_type.hpp>
...
namespace streams_boost { namespace fusion
{
    ...
    namespace detail
    {
        ...
        #define  STREAMS_BOOST_PP_FILENAME_1 <streams_boost/fusion/functional/invocation/invoke.hpp>
        #define  STREAMS_BOOST_PP_ITERATION_LIMITS (0, STREAMS_BOOST_FUSION_INVOKE_MAX_ARITY)
        ...
        // use same implementation as for function objects but...
            : invoke_impl< // ...work around streams_boost::result_of bugs
                typename mpl::eval_if< ft::is_function<F>,
                    streams_boost::add_reference<F>, streams_boost::remove_cv<F> >::type,
        ...
        private:
            ...
            typedef mpl::or_< streams_boost::is_convertible<that,C*>,
                              streams_boost::is_convertible<that,C&>,
        ...
        public:
            ...
            typedef typename streams_boost::add_reference<qualified_type>::type
                result_type;
...
#define STREAMS_BOOST_FUSION_FUNCTIONAL_INVOCATION_INVOKE_HPP_INCLUDED
...
#define M(z,j,data) typename result_of::at_c<Sequence,j>::type
                    Function(STREAMS_BOOST_PP_ENUM(N,M,~)) >::type result_type;
#undef M
...
#define M(z,j,data) fusion::at_c<j>(s)
                return f( STREAMS_BOOST_PP_ENUM(N,M,~) );
            }
        };
...
#define M(z,j,data)                                                             \
            typename seq::I##j i##j =                                          \
                fusion::next(STREAMS_BOOST_PP_CAT(i,STREAMS_BOOST_PP_DEC(j)));
        ...
        public:
            ...
            typedef typename streams_boost::result_of<
                Function(STREAMS_BOOST_PP_ENUM_PARAMS(N,typename seq::T))
                >::type result_type;
...
#endif
                return f( STREAMS_BOOST_PP_ENUM_PARAMS(N,*i) );
            }
        };
...
#define M(z,i,data)                                                             \
            typedef typename result_of::next<                                  \
                STREAMS_BOOST_PP_CAT(I,STREAMS_BOOST_PP_DEC(i))>::type I##i;                   \
