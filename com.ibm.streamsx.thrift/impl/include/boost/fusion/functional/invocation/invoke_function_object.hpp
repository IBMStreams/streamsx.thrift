...
#if !defined(STREAMS_BOOST_FUSION_FUNCTIONAL_INVOCATION_INVOKE_FUNCTION_OBJECT_HPP_INCLUDED)
...
namespace streams_boost { namespace fusion
{
    ...
    namespace detail
    {
        ...
        #define  STREAMS_BOOST_PP_FILENAME_1 \
            <streams_boost/fusion/functional/invocation/invoke_function_object.hpp>
        #define  STREAMS_BOOST_PP_ITERATION_LIMITS \
            (0, STREAMS_BOOST_FUSION_INVOKE_FUNCTION_OBJECT_MAX_ARITY)
...
#define STREAMS_BOOST_FUSION_FUNCTIONAL_INVOCATION_INVOKE_FUNCTION_OBJECT_HPP_INCLUDED
