...
#include <streams_boost/fusion/tuple/tuple_fwd.hpp>
...
#include <streams_boost/fusion/sequence/comparison.hpp>
#include <streams_boost/fusion/sequence/io.hpp>
...
namespace streams_boost { namespace fusion
{
    ...
    struct tuple : vector<STREAMS_BOOST_PP_ENUM_PARAMS(FUSION_MAX_VECTOR_SIZE, T)>
    {
        typedef vector<
            STREAMS_BOOST_PP_ENUM_PARAMS(FUSION_MAX_VECTOR_SIZE, T)>
        base_type;
        ...
        #include <streams_boost/fusion/tuple/detail/tuple_expand.hpp>
