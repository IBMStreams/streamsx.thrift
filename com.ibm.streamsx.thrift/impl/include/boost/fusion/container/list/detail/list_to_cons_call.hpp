...
#define STREAMS_BOOST_PP_FILENAME_1 \
    <streams_boost/fusion/container/list/detail/list_to_cons_call.hpp>
...
#define N STREAMS_BOOST_PP_ITERATION()
    ...
    static type
    call(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(
        N, typename detail::call_param<T, >::type _))
    {
        return type(_0 
#if N > 1
            , tail_list_to_cons::call(STREAMS_BOOST_PP_ENUM_SHIFTED_PARAMS(N, _)));
#else
            );
#endif
    }
