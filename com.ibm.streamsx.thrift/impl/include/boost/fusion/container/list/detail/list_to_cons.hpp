...
#include <streams_boost/fusion/container/list/limits.hpp>
...
namespace streams_boost { namespace fusion { namespace detail
{
    ...
    struct list_to_cons
    {
        ...
        typedef list_to_cons<
            STREAMS_BOOST_PP_ENUM_SHIFTED_PARAMS(FUSION_MAX_LIST_SIZE, T), void_>
        tail_list_to_cons;
        typedef typename tail_list_to_cons::type tail_type;
        
        typedef cons<head_type, tail_type> type;
        
        #include <streams_boost/fusion/container/list/detail/list_to_cons_call.hpp>
    };

    template <>
    struct list_to_cons<STREAMS_BOOST_PP_ENUM(FUSION_MAX_LIST_SIZE, FUSION_VOID, _)>
    {
        typedef nil type;
    };    
}}}
