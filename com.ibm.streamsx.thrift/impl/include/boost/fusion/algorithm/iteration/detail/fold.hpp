...
==============================================================================*/
#if !defined(STREAMS_BOOST_FUSION_FOLD_HPP_20070528_1253)
#define STREAMS_BOOST_FUSION_FOLD_HPP_20070528_1253
...
namespace detail
{
    ...
    struct apply_fold_result
    {
        ...
        struct apply
            : streams_boost::result_of<F(State, Value)>
        {};
    };
    ...
    struct fold_apply
    {
        ...
        typedef typename streams_boost::result_of<F(lvalue_state, dereferenced)>::type type;
    };
