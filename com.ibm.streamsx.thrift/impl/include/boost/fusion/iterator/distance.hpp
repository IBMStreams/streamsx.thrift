...
#include <streams_boost/fusion/iterator/detail/distance.hpp>
...
namespace streams_boost { namespace fusion
{
    ...
    struct array_iterator_tag; // streams_boost::array iterator tag
    ...
    namespace extension
    {
        ...
        struct distance_impl
        {
            ...
            {
                STREAMS_BOOST_MPL_ASSERT_NOT((traits::is_random_access<First>));
                STREAMS_BOOST_MPL_ASSERT_NOT((traits::is_random_access<Last>));
            };
        };
    ...
    namespace result_of
    {
        ...
        template apply<First, Last>
        {
            ...
            STREAMS_BOOST_STATIC_CONSTANT(int, value = distance_application::value);
        };
    }
