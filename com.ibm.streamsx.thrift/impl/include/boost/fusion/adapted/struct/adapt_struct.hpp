...
==============================================================================*/
#if !defined(STREAMS_BOOST_FUSION_ADAPT_STRUCT_APRIL_2_2007_1158AM)
#define STREAMS_BOOST_FUSION_ADAPT_STRUCT_APRIL_2_2007_1158AM
...
#define STREAMS_BOOST_FUSION_ADAPT_STRUCT(name, bseq)                                   \
    STREAMS_BOOST_FUSION_ADAPT_STRUCT_I(                                                \
        name, STREAMS_BOOST_PP_CAT(STREAMS_BOOST_FUSION_ADAPT_STRUCT_X bseq, 0))                \
    /***/

#define STREAMS_BOOST_FUSION_ADAPT_STRUCT_X(x, y) ((x, y)) STREAMS_BOOST_FUSION_ADAPT_STRUCT_Y
#define STREAMS_BOOST_FUSION_ADAPT_STRUCT_Y(x, y) ((x, y)) STREAMS_BOOST_FUSION_ADAPT_STRUCT_X
#define STREAMS_BOOST_FUSION_ADAPT_STRUCT_X0
#define STREAMS_BOOST_FUSION_ADAPT_STRUCT_Y0

// STREAMS_BOOST_FUSION_ADAPT_STRUCT_I generates the overarching structure and uses
// SEQ_FOR_EACH_I to generate the "linear" substructures.
// Thanks to Paul Mensonides for the PP macro help

#define STREAMS_BOOST_FUSION_ADAPT_STRUCT_I(name, seq)                                  \
    ...
    {                                                                           \
        ...
        STREAMS_BOOST_PP_SEQ_FOR_EACH_I(STREAMS_BOOST_FUSION_ADAPT_STRUCT_C, name, seq)         \
    }}}                                                                         \
    /***/

#define STREAMS_BOOST_FUSION_ADAPT_STRUCT_C(r, name, i, xy)                             \
    template <>                                                                 \
    struct struct_member<name, i>                                               \
    {                                                                           \
        typedef STREAMS_BOOST_PP_TUPLE_ELEM(2, 0, xy) type;                             \
        static type& call(name& struct_)                                        \
        {                                                                       \
            return struct_.STREAMS_BOOST_PP_TUPLE_ELEM(2, 1, xy);                       \
        };                                                                      \
    };                                                                          \
    /***/
