...
==============================================================================*/
#if !defined(STREAMS_BOOST_FUSION_ARRAY_ITERATOR_26122005_2250)
#define STREAMS_BOOST_FUSION_ARRAY_ITERATOR_26122005_2250
...
namespace streams_boost { namespace fusion
{
    ...
    {
        STREAMS_BOOST_MPL_ASSERT_RELATION(Pos, >=, 0);
        STREAMS_BOOST_MPL_ASSERT_RELATION(Pos, <=, Array::static_size);
