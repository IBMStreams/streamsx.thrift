...
#include <streams_boost/fusion/view/single_view/single_view_iterator.hpp>
#include <streams_boost/fusion/view/single_view/detail/begin_impl.hpp>
#include <streams_boost/fusion/view/single_view/detail/end_impl.hpp>
