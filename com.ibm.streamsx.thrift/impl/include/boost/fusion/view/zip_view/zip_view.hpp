...
#include <streams_boost/fusion/view/detail/strictest_traversal.hpp>
#include <streams_boost/fusion/view/zip_view/detail/begin_impl.hpp>
#include <streams_boost/fusion/view/zip_view/detail/end_impl.hpp>
#include <streams_boost/fusion/view/zip_view/detail/size_impl.hpp>
#include <streams_boost/fusion/view/zip_view/detail/at_impl.hpp>
#include <streams_boost/fusion/view/zip_view/detail/value_at_impl.hpp>
#include <streams_boost/fusion/container/vector/convert.hpp>
#include <streams_boost/fusion/algorithm/query/find_if.hpp>
#include <streams_boost/fusion/sequence/intrinsic/end.hpp>
#include <streams_boost/fusion/sequence/intrinsic/size.hpp>
#include <streams_boost/fusion/mpl.hpp>
#include <streams_boost/fusion/algorithm/transformation/remove.hpp>
...
namespace streams_boost { namespace fusion {
    ...
    struct zip_view : sequence_base< zip_view<Sequences> >
    {
        ...
        STREAMS_BOOST_MPL_ASSERT((detail::all_references<Sequences>));
