...
#include <streams_boost/fusion/view/transform_view/transform_view_iterator.hpp>
#include <streams_boost/fusion/view/transform_view/transform_view_fwd.hpp>
#include <streams_boost/fusion/view/transform_view/detail/begin_impl.hpp>
#include <streams_boost/fusion/view/transform_view/detail/end_impl.hpp>
#include <streams_boost/fusion/view/transform_view/detail/at_impl.hpp>
#include <streams_boost/fusion/view/transform_view/detail/value_at_impl.hpp>
...
namespace streams_boost { namespace fusion
{
    ...
    {
        STREAMS_BOOST_STATIC_ASSERT(result_of::size<Sequence1>::value == result_of::size<Sequence2>::value);
