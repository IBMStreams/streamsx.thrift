...
#include <streams_boost/fusion/view/filter_view.hpp>
#include <streams_boost/fusion/container/list/cons.hpp> // for nil
#include <streams_boost/fusion/container/generation/make_cons.hpp>
...
namespace streams_boost { namespace fusion
{
    ...
    namespace detail
    {
        ...
        {
            STREAMS_BOOST_MPL_ASSERT_NOT((is_reference<Sequence>));
