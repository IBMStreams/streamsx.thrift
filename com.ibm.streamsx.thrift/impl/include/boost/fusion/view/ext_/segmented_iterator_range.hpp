...
#include <streams_boost/fusion/view/joint_view.hpp>
#include <streams_boost/fusion/view/single_view.hpp>
#include <streams_boost/fusion/view/transform_view.hpp>
#include <streams_boost/fusion/view/iterator_range.hpp>
#include <streams_boost/fusion/view/ext_/multiple_view.hpp>
    ...
    namespace extension
    {
        ...
        struct segments_impl<detail::segmented_view_tag<detail::center_view> >
        {
            ...
            struct apply
            {
                ...
                STREAMS_BOOST_MPL_ASSERT_RELATION(0, <=, size_minus_2::value);
