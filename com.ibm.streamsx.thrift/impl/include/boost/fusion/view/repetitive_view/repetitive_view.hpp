...
#if !defined(STREAMS_BOOST_FUSION_REPETITIVE_REPETITIVE_VIEW_VIEW_HPP_INCLUDED)
#define STREAMS_BOOST_FUSION_REPETITIVE_VIEW_REPETITIVE_VIEW_HPP_INCLUDED
...
#include <streams_boost/fusion/view/repetitive_view/detail/begin_impl.hpp>
#include <streams_boost/fusion/view/repetitive_view/detail/end_impl.hpp>
...
namespace streams_boost { namespace fusion
{
        ...
        : sequence_base< repetitive_view<Sequence> >
    {
        ...
        typedef typename streams_boost::remove_reference<Sequence>::type sequence_type;
        typedef typename 
