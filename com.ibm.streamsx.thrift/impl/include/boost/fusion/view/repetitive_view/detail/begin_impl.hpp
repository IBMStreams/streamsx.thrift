...
#if !defined(STREAMS_BOOST_FUSION_REPETITIVE_VIEW_BEGIN_IMPL_HPP_INCLUDED)
#define STREAMS_BOOST_FUSION_REPETITIVE_VIEW_BEGIN_IMPL_HPP_INCLUDED

#include <streams_boost/fusion/sequence/intrinsic/begin.hpp>
#include <streams_boost/fusion/view/repetitive_view/repetitive_view_fwd.hpp>
