#ifndef STREAMS_BOOST_STATECHART_RESULT_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_RESULT_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
class safe_reaction_result
{
  public:
      ...
      reactionResult( other.reactionResult )
    {
      ...
      STREAMS_BOOST_ASSERT( reactionResult != consumed );
...
struct result_utility
{
  static ::streams_boost::statechart::result make_result( reaction_result value )
  {
    return value;
  }

  static reaction_result get_result( ::streams_boost::statechart::result value )
  {
    return value;
  }
};
