#ifndef STREAMS_BOOST_STATECHART_PROCESSOR_CONTAINER_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_PROCESSOR_CONTAINER_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
#include <streams_boost/statechart/event_base.hpp>
#include <streams_boost/statechart/event_processor.hpp>
...
class processor_container : noncopyable
{
  ...
  public:
    ...
    class processor_context
    {
      ...
      #if STREAMS_BOOST_WORKAROUND( STREAMS_BOOST_INTEL, STREAMS_BOOST_TESTED_AT( 800 ) )
      public:
    ...
    WorkItem create_processor( processor_handle & handle, Scheduler & scheduler )
    {
      ...
      return WorkItem(
        streams_boost::bind( pImpl, this, pProcessor,
      ...
      processor_handle & handle, Scheduler & scheduler, Arg1 arg1 )
    {
      ...
      impl_fun_ptr pImpl =
        &processor_container::template create_processor_impl1<
          Processor, arg1_type >;
      return WorkItem(
        streams_boost::bind( pImpl, this, pProcessor, processor_context( scheduler, handle ),
          arg1 ),
        Allocator() );
    }
    ...
    {
      return WorkItem(
        streams_boost::bind( &processor_container::destroy_processor_impl, this, processor ),
        Allocator() );
    }
    ...
    {
      return WorkItem(
        streams_boost::bind( &processor_container::initiate_processor_impl, this,
          processor ),
        Allocator() );
    }
    ...
    {
      return WorkItem(
        streams_boost::bind( &processor_container::terminate_processor_impl, this,
          processor ),
        Allocator() );
    }
    ...
    {
      STREAMS_BOOST_ASSERT( pEvent.get() != 0 );

      return WorkItem(
        streams_boost::bind( &processor_container::queue_event_impl, this, processor,
          pEvent ),
        Allocator() );
    }
