#ifndef STREAMS_BOOST_STATECHART_EVENT_BASE_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_EVENT_BASE_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
#include <streams_boost/statechart/detail/counted_base.hpp>
...
inline void intrusive_ptr_add_ref( const ::streams_boost::statechart::event_base * pBase )
{
  pBase->add_ref();
}

inline void intrusive_ptr_release( const ::streams_boost::statechart::event_base * pBase )
{
  if ( pBase->release() )
  {
    ::streams_boost::statechart::detail::delete_helper::delete_object( pBase );
  }
}
