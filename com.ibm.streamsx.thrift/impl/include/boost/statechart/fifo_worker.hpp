#ifndef STREAMS_BOOST_STATECHART_FIFO_WORKER_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_FIFO_WORKER_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
// STREAMS_BOOST_HAS_THREADS, STREAMS_BOOST_MSVC
...
#  include <streams_boost/thread/condition.hpp>
...
class fifo_worker : noncopyable
{
  public:
    ...
    void terminate()
    {
      work_item item = streams_boost::bind( &fifo_worker::terminate_impl, this );
