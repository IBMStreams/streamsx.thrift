#ifndef STREAMS_BOOST_STATECHART_DETAIL_NODE_STATE_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_DETAIL_NODE_STATE_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
class node_state : public node_state_base< Allocator, RttiPolicy >
{
  ...
  public:
    ...
    {
      STREAMS_BOOST_ASSERT( ( position < OrthogonalRegionCount::value ) &&
      ...
      bool performFullExit )
    {
      ...
      if ( pFirstNonNull == pPastEnd )
      {
        ...
        STREAMS_BOOST_ASSERT( get_pointer( pOutermostUnstableState ) == this );
