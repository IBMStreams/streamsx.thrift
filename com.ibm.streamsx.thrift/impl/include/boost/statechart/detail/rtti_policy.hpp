#ifndef STREAMS_BOOST_STATECHART_DETAIL_RTTI_POLICY_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_DETAIL_RTTI_POLICY_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
struct id_provider
{
  ...
  #if defined( STREAMS_BOOST_ENABLE_ASSERT_HANDLER ) || !defined( NDEBUG )
...
struct rtti_policy
{
  #ifdef STREAMS_BOOST_STATECHART_USE_NATIVE_RTTI
  class id_type
  {
    public:
      ////////////////////////////////////////////////////////////////////////
  ...
  class rtti_base_type : public Base
  {
    public:
      ...
      #ifndef STREAMS_BOOST_STATECHART_USE_NATIVE_RTTI
