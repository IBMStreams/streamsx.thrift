#ifndef STREAMS_BOOST_STATECHART_DETAIL_COUNTED_BASE_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_DETAIL_COUNTED_BASE_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
#include <streams_boost/config.hpp> // STREAMS_BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP
...
class counted_base : private count_base< NeedsLocking >
{
  ...
  public:
    ...
    bool release() const
    {
      STREAMS_BOOST_ASSERT( base_type::count_ > 0 );
      return --base_type::count_ == 0;
    }
};
