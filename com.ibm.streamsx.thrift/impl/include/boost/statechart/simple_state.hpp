#ifndef STREAMS_BOOST_STATECHART_SIMPLE_STATE_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_SIMPLE_STATE_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
#include <streams_boost/statechart/detail/memory.hpp>
  ...
  typename Context::inner_context_type, InnerInitial >::type
{
  ...
  public:
    ...
    outermost_context_type & outermost_context()
    {
      ...
      STREAMS_BOOST_ASSERT( get_pointer( pContext_ ) != 0 );
  ...
  public:
    ...
    // inner states.
    STREAMS_BOOST_STATIC_ASSERT( ( mpl::less<
      orthogonal_position,
    ...
    STREAMS_BOOST_STATIC_ASSERT( ( mpl::or_<
      mpl::less<
    ...
    {
      STREAMS_BOOST_ASSERT( get_pointer( pContext ) != 0 );
      pContext_ = pContext;
  ...
  private:
    ...
    struct context_ptr_impl_other_context
    {
      ...
      context_ptr_impl( const State & stt )
      {
        ...
        // simple_state<>.
        STREAMS_BOOST_ASSERT( get_pointer( stt.pContext_ ) != 0 );
    ...
    result transit_impl( const TransitionAction & transitionAction )
    {
      ...
      #ifdef STREAMS_BOOST_STATECHART_RELAX_TRANSITION_CONTEXT
      typedef typename mpl::distance<
      ...
      STREAMS_BOOST_STATIC_ASSERT( ( mpl::equal_to<
    ...
    struct deep_construct_inner_impl_non_empty
    {
        ...
        outermost_context_base_type & outermostContextBase )
      {
        ...
        STREAMS_BOOST_STATIC_ASSERT( ( is_same<
          current_inner,
          typename mpl::at<
...
inline void intrusive_ptr_release( const ::streams_boost::statechart::simple_state<
