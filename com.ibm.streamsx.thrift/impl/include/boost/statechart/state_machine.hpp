#ifndef STREAMS_BOOST_STATECHART_STATE_MACHINE_HPP_INCLUDED
#define STREAMS_BOOST_STATECHART_STATE_MACHINE_HPP_INCLUDED
//////////////////////////////////////////////////////////////////////////////
...
#include <streams_boost/statechart/event.hpp>
#include <streams_boost/statechart/null_exception_translator.hpp>
#include <streams_boost/statechart/result.hpp>

#include <streams_boost/statechart/detail/rtti_policy.hpp>
#include <streams_boost/statechart/detail/state_base.hpp>
#include <streams_boost/statechart/detail/leaf_state.hpp>
#include <streams_boost/statechart/detail/node_state.hpp>
#include <streams_boost/statechart/detail/constructor.hpp>
...
#include <streams_boost/cast.hpp> // streams_boost::polymorphic_downcast
// STREAMS_BOOST_NO_EXCEPTIONS, STREAMS_BOOST_MSVC, STREAMS_BOOST_MSVC_STD_ITERATOR
...
class state_machine : noncopyable
{
  public:
    ...
    class state_iterator : public std::iterator<
      ...
      #ifndef STREAMS_BOOST_MSVC_STD_ITERATOR
  ...
  public:
    ...
    {
      STREAMS_BOOST_ASSERT( get_pointer( pEvent ) != 0 );
    ...
    {
      // If you receive a
      // "use of undefined type 'streams_boost::STATIC_ASSERTION_FAILURE<x>'" or
      ...
      STREAMS_BOOST_STATIC_ASSERT( HistoryContext::shallow_history::value );
    ...
    void clear_deep_history()
    {
      ...
      // statechart::has_full_history to its base class template
      STREAMS_BOOST_STATIC_ASSERT( HistoryContext::deep_history::value );
  ...
  public:
    ...
    {
      STREAMS_BOOST_ASSERT( position == 0 );
  ...
  private: // implementation
      ...
      state_base_type * pCurrentState )
    {
      ...
      STREAMS_BOOST_ASSERT( pHandlingState != 0 );
    ...
    void send_event( const event_base_type & evt )
    {
      ...
      STREAMS_BOOST_ASSERT( get_pointer( pOutermostUnstableState_ ) == 0 );
    ...
    void terminate_impl( state_base_type & theState, bool performFullExit )
    {
      ...
      {
        STREAMS_BOOST_ASSERT( currentStates_.size() > 1 );
