...
#ifndef STREAMS_BOOST_CONCEPT_ARCHETYPES_HPP
#define STREAMS_BOOST_CONCEPT_ARCHETYPES_HPP
...
#define STREAMS_BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(OP, NAME)                       \
  ...
  STREAMS_BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(==, equal_op)
  STREAMS_BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(!=, not_equal_op)
  STREAMS_BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(<, less_than_op)
  STREAMS_BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(<=, less_equal_op)
  STREAMS_BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(>, greater_than_op)
  STREAMS_BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(>=, greater_equal_op)

#define STREAMS_BOOST_DEFINE_OPERATOR_ARCHETYPE(OP, NAME) \
  template <class Base = null_archetype<> > \
  ...
  STREAMS_BOOST_DEFINE_OPERATOR_ARCHETYPE(+, addable)
  STREAMS_BOOST_DEFINE_OPERATOR_ARCHETYPE(-, subtractable)
  STREAMS_BOOST_DEFINE_OPERATOR_ARCHETYPE(*, multipliable)
  STREAMS_BOOST_DEFINE_OPERATOR_ARCHETYPE(/, dividable)
  STREAMS_BOOST_DEFINE_OPERATOR_ARCHETYPE(%, modable)

  // As is, these are useless because of the return type.
  // Need to invent a better way...
#define STREAMS_BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(OP, NAME) \
  ...
  STREAMS_BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(+, plus_op)
  STREAMS_BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(*, time_op)
  STREAMS_BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(/, divide_op)
  STREAMS_BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(-, subtract_op)
  STREAMS_BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(%, mod_op)
...
#endif // STREAMS_BOOST_CONCEPT_ARCHETYPES_H
