//-----------------------------------------------------------------------------
// streams_boost variant/detail/move.hpp header file
...
#ifndef STREAMS_BOOST_VARIANT_DETAIL_MOVE_HPP
#define STREAMS_BOOST_VARIANT_DETAIL_MOVE_HPP
...
//
 ...
 ||   STREAMS_BOOST_WORKAROUND(__GNUC__, STREAMS_BOOST_TESTED_AT(2))

// [Indicate that move_swap by overload is disabled...]
#define STREAMS_BOOST_NO_MOVE_SWAP_BY_OVERLOAD

// [...and provide straight swap-by-move implementation:]
template <typename T>
inline void move_swap(T& lhs, T& rhs)
{
    T tmp( streams_boost::detail::variant::move(lhs) );
    lhs = streams_boost::detail::variant::move(rhs);
    rhs = streams_boost::detail::variant::move(tmp);
}
...
#endif // STREAMS_BOOST_VARIANT_DETAIL_MOVE_HPP
