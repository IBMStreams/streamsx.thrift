//-----------------------------------------------------------------------------
// streams_boost variant/detail/over_sequence.hpp header file
...
#ifndef STREAMS_BOOST_VARIANT_DETAIL_OVER_SEQUENCE_HPP
#define STREAMS_BOOST_VARIANT_DETAIL_OVER_SEQUENCE_HPP
...
yes_over_sequence_t is_over_sequence_test(
      type< ::streams_boost::detail::variant::over_sequence<T> >
    );
...
struct is_over_sequence
    : mpl::bool_<
          ::streams_boost::detail::variant::is_over_sequence_impl<T>::value
        >
{
};
...
#endif // STREAMS_BOOST_VARIANT_DETAIL_OVER_SEQUENCE_HPP
