...
#ifndef STREAMS_BOOST_VARIANT_DETAIL_HAS_NOTHROW_MOVE_HPP_INCLUDED
#define STREAMS_BOOST_VARIANT_DETAIL_HAS_NOTHROW_MOVE_HPP_INCLUDED

#include "streams_boost/config.hpp" // for STATIC_CONSTANT
#include "streams_boost/variant/detail/has_trivial_move.hpp"
...
STREAMS_BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
      has_nothrow_move
    , T
    , (::streams_boost::detail::variant::has_nothrow_move_impl<T>::value)
    )
...
STREAMS_BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , (::streams_boost::detail::variant::has_nothrow_move_constructor_impl<T>::value)
    )
...
STREAMS_BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , (::streams_boost::detail::variant::has_nothrow_move_assign_impl<T>::value)
    )

}} // namespace detail::variant

STREAMS_BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::streams_boost::detail::variant::has_nothrow_move)
STREAMS_BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::streams_boost::detail::variant::has_nothrow_move_constructor)
STREAMS_BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::streams_boost::detail::variant::has_nothrow_move_assign)

} // namespace streams_boost

#include "streams_boost/variant/detail/bool_trait_undef.hpp"

#endif // STREAMS_BOOST_VARIANT_DETAIL_HAS_NOTHROW_MOVE_HPP_INCLUDED
