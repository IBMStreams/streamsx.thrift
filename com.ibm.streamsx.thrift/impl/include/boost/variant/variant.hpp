//-----------------------------------------------------------------------------
// streams_boost variant/variant.hpp header file
...
#ifndef STREAMS_BOOST_VARIANT_VARIANT_HPP
#define STREAMS_BOOST_VARIANT_VARIANT_HPP

#include <cstddef> // for std::size_t
#include <new> // for placement new

#if !defined(STREAMS_BOOST_NO_TYPEID)
#include <typeinfo> // for typeid, std::type_info
#endif // STREAMS_BOOST_NO_TYPEID
...
#include "streams_boost/mpl/max_element.hpp"
...
#include "streams_boost/mpl/sizeof.hpp"
...
//   Defined in streams_boost/variant/detail/visitation_impl.hpp.
//
// STREAMS_BOOST_VARIANT_MINIMIZE_SIZE
...
#if defined(STREAMS_BOOST_VARIANT_MINIMIZE_SIZE)
...
//
// This implementation is designed to prefer streams_boost::blank over other potential
...
private: // helpers, for metafunction result (below)
    ...
    // [...now search the rest of the sequence for streams_boost::blank...]

    typedef typename mpl::iter_fold_if<
          mpl::iterator_range< first_result_it,end_it >
        , first_result_index, mpl::protect< mpl::next<> >
        , mpl::protect< mpl::not_same_as<streams_boost::blank> >
        >::type second_result_;
...
public: // metafunction result
    ...
    typedef ::streams_boost::aligned_storage<
          STREAMS_BOOST_MPL_AUX_VALUE_WKND(max_size)::value
        , STREAMS_BOOST_MPL_AUX_VALUE_WKND(max_alignment)::value
        > type;

#else // MSVC7 and below

    STREAMS_BOOST_STATIC_CONSTANT(std::size_t, msvc_max_size_c = max_size::value);
    STREAMS_BOOST_STATIC_CONSTANT(std::size_t, msvc_max_alignment_c = max_alignment::value);
...
#if STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x0551)) || \
    STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, STREAMS_BOOST_TESTED_AT(1600))
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::streams_boost::detail::variant::forced_return< T& >();
    }
...
public: // internal visitor interface
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(streams_boost::detail::variant::backup_holder<T>& operand, long) const
    {
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(const streams_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
        STREAMS_BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::streams_boost::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        catch (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::streams_boost::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::streams_boost::detail::variant::move_swap( operand, other );
    }
...
#   if STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x0564))
    template <typename T>
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(streams_boost::recursive_wrapper<T>& operand, long)
    {
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const streams_boost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(streams_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const streams_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(streams_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        STREAMS_BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const streams_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
template <
      typename T0_
    , STREAMS_BOOST_VARIANT_ENUM_SHIFTED_PARAMS(typename T)
    >
class variant
{
...
private: // helpers, for typedefs (below)
    ...
    STREAMS_BOOST_STATIC_ASSERT((
          ::streams_boost::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
private: // helpers, for typedefs (below)
    ...
    #define STREAMS_BOOST_VARIANT_AUX_ENABLE_RECURSIVE_TYPEDEFS(z,N,_) \
        typedef typename mpl::eval_if< \
            ...
            , detail::variant::enable_recursive< \
                ...
                , wknd_self_t \
                > \
            , mpl::identity< STREAMS_BOOST_PP_CAT(T,N) > \
            >::type STREAMS_BOOST_PP_CAT(recursive_enabled_T,N); \
        /**/
    ...
    #define STREAMS_BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS(z,N,_) \
    ...
    STREAMS_BOOST_PP_REPEAT(
          STREAMS_BOOST_VARIANT_LIMIT_TYPES
        , STREAMS_BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS
        , _
        )

    #undef STREAMS_BOOST_VARIANT_AUX_UNWRAP_RECURSIVE_TYPEDEFS

public: // public typedefs

    typedef typename detail::variant::make_variant_list<
          STREAMS_BOOST_VARIANT_ENUM_PARAMS(public_T)
        >::type types;

private: // helpers, for internal typedefs (below)

    #define STREAMS_BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS(z,N,_) \
        typedef detail::make_reference_content< \
              STREAMS_BOOST_PP_CAT(recursive_enabled_T,N) \
            >::type STREAMS_BOOST_PP_CAT(internal_T,N); \
        /**/

    STREAMS_BOOST_PP_REPEAT(
          STREAMS_BOOST_VARIANT_LIMIT_TYPES
        , STREAMS_BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS
        , _
        )

    #undef STREAMS_BOOST_VARIANT_AUX_MAKE_REFERENCE_CONTENT_TYPEDEFS

private: // internal typedefs

    typedef typename detail::variant::make_variant_list<
          STREAMS_BOOST_VARIANT_ENUM_PARAMS(internal_T)
        >::type internal_types;
...
private: // static precondition assertions
    ...
    //
    STREAMS_BOOST_MPL_ASSERT_NOT(( is_sequence_based_ ));
...
#else // defined(STREAMS_BOOST_VARIANT_MINIMIZE_SIZE)
...
#endif // STREAMS_BOOST_VARIANT_MINIMIZE_SIZE switch
...
private: // helpers, for structors (below)
    ...
    struct initializer
        : STREAMS_BOOST_VARIANT_AUX_INITIALIZER_T(
...
#   endif
        ...
        template <typename T>
        int internal_visit(streams_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const streams_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(streams_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const streams_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(streams_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const streams_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below 
    ...
    template <STREAMS_BOOST_VARIANT_ENUM_PARAMS(typename U)>
    void convert_construct(
          streams_boost::variant<STREAMS_BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    template <STREAMS_BOOST_VARIANT_ENUM_PARAMS(typename U)>
    void convert_construct(
          const streams_boost::variant<STREAMS_BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);    
...
#elif defined(STREAMS_BOOST_VARIANT_AUX_HAS_CONSTRUCTOR_TEMPLATE_ORDERING_SFINAE_WKND)
...
#else // !defined(STREAMS_BOOST_VARIANT_AUX_HAS_CONSTRUCTOR_TEMPLATE_ORDERING_SFINAE_WKND)
...
#endif // STREAMS_BOOST_VARIANT_AUX_BROKEN_CONSTRUCTOR_TEMPLATE_ORDERING workarounds
    ...
    private: // helpers, for internal visitor interface (below)
            ...
            )
        {
            ...
            catch (...)
            {
                ...
                lhs_.indicate_which(
                      STREAMS_BOOST_MPL_AUX_VALUE_WKND(fallback_type_index_)::value
                    ); // nothrow
...
#   define STREAMS_BOOST_VARIANT_AUX_FAIL_COMPARISON_RETURN_TYPE \
    void
...
#   define STREAMS_BOOST_VARIANT_AUX_FAIL_COMPARISON_RETURN_TYPE \
    ...
    template <typename U>
        STREAMS_BOOST_VARIANT_AUX_FAIL_COMPARISON_RETURN_TYPE
    operator==(const U&) const
    {
        STREAMS_BOOST_STATIC_ASSERT( false && sizeof(U) );
    }
...
#else// defined(STREAMS_BOOST_NO_MEMBER_TEMPLATE_FRIENDS)

public:

#endif// !defined(STREAMS_BOOST_NO_MEMBER_TEMPLATE_FRIENDS)
...
inline void swap(
      variant< STREAMS_BOOST_VARIANT_ENUM_PARAMS(T) >& lhs
    , variant< STREAMS_BOOST_VARIANT_ENUM_PARAMS(T) >& rhs
    )
{
    lhs.swap(rhs);
}
...
#include "streams_boost/variant/detail/variant_io.hpp"
#endif // STREAMS_BOOST_NO_IOSTREAM

#endif // STREAMS_BOOST_VARIANT_VARIANT_HPP
