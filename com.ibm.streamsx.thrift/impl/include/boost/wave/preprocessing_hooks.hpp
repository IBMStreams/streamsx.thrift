...
struct default_preprocessing_hooks 
{
    ...
    //  a #include_next directive and the STREAMS_BOOST_WAVE_SUPPORT_INCLUDE_NEXT
    ...
    //  'command' is the value defined as the STREAMS_BOOST_WAVE_PRAGMA_KEYWORD constant
    ...
    //  information.
    //
    //  The default behavior is to call the function streams_boost::throw_exception.
    //  
    ///////////////////////////////////////////////////////////////////////////
