...
#if !defined(STREAMS_BOOST_WAVE_LEX_INTERFACE_GENERATOR_HPP_INCLUDED)
#define STREAMS_BOOST_WAVE_LEX_INTERFACE_GENERATOR_HPP_INCLUDED
...
#include <streams_boost/wave/cpplexer/cpp_lex_token.hpp>      // lex_token 
...
#define STREAMS_BOOST_WAVE_NEW_LEXER_DECL STREAMS_BOOST_WAVE_DECL
#else
#define STREAMS_BOOST_WAVE_NEW_LEXER_DECL
#endif 
...
>
struct STREAMS_BOOST_WAVE_NEW_LEXER_DECL new_lexer_gen
{
...
#undef STREAMS_BOOST_WAVE_NEW_LEXER_DECL
...
//  lexer/token configurations at compile time.
    ...
    static lex_input_interface<TokenT> *
    new_lexer(IteratorT const &first, IteratorT const &last, 
        position_type const &pos, streams_boost::wave::language_support language)
    { 
...
#endif // !defined(STREAMS_BOOST_WAVE_LEX_INTERFACE_GENERATOR_HPP_INCLUDED)
