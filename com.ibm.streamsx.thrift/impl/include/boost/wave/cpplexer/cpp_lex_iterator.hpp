...
#include <streams_boost/spirit/include/support_multi_pass.hpp>
...
#if 0 != __COMO_VERSION__ || !STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1310)
#define STREAMS_BOOST_WAVE_EOF_PREFIX static
#else
#define STREAMS_BOOST_WAVE_EOF_PREFIX 
#endif
...
// interface to the iterator_policies::split_functor_input policy
    ...
    STREAMS_BOOST_WAVE_EOF_PREFIX result_type const eof;
...
//            and a 4th parameter of the type streams_boost::wave::language_support
...
struct make_multi_pass
{
    ...
    typedef streams_boost::spirit::iterator_policies::split_functor_input input_policy;
    typedef streams_boost::spirit::iterator_policies::ref_counted ownership_policy;
#if defined(STREAMS_BOOST_WAVE_DEBUG)
    typedef streams_boost::spirit::iterator_policies::buf_id_check check_policy;
#else
    typedef streams_boost::spirit::iterator_policies::no_check check_policy;
#endif
    typedef streams_boost::spirit::iterator_policies::split_std_deque storage_policy;

    typedef streams_boost::spirit::iterator_policies::default_policy<
            ownership_policy, check_policy, input_policy, storage_policy>
        policy_type;
    typedef streams_boost::spirit::multi_pass<functor_data_type, policy_type> type;
};
...
#undef STREAMS_BOOST_WAVE_EOF_PREFIX
