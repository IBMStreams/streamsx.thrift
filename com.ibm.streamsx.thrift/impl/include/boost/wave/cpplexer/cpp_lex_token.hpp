...
private:
    ...
    streams_boost::detail::atomic_count refcnt;
};
...
{
    STREAMS_BOOST_ASSERT(sizeof(token_data<StringTypeT, PositionT>) == size);
    typedef streams_boost::singleton_pool<
...
template <typename PositionT = streams_boost::wave::util::file_position_type>
class lex_token;
