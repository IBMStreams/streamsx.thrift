...
=============================================================================*/
#if !defined(VALIDATE_UNIVERSAL_CHAR_STREAMS_HPP_55F1B811_CD76_4C72_8344_CBC69CF3B339_INCLUDED)
#define VALIDATE_UNIVERSAL_CHAR_STREAMS_HPP_55F1B811_CD76_4C72_8344_CBC69CF3B339_INCLUDED
...
typename StringT::size_type pos = name.find_first_of('\\');
    ...
    // the identifier name contains a backslash (must be universal char)
        STREAMS_BOOST_ASSERT('u' == name[pos+1] || 'U' == name[pos+1]);
    ...
    universal_char_type type = 
        ...
        StringT error_uchar(name.substr(pos, ('u' == name[pos+1]) ? 6 : 10));
            ...
            if (universal_char_type_invalid == type) {
                STREAMS_BOOST_WAVE_LEXER_THROW(lexing_exception, universal_char_invalid, 
                    error_uchar, line, column, file_name.c_str());
            }
            else if (universal_char_type_base_charset == type) {
                STREAMS_BOOST_WAVE_LEXER_THROW(lexing_exception, universal_char_base_charset, 
                    error_uchar, line, column, file_name.c_str());
            }
            else {
                STREAMS_BOOST_WAVE_LEXER_THROW(lexing_exception, universal_char_not_allowed, 
                    error_uchar, line, column, file_name.c_str());
            }
        }
...
#endif // !defined(VALIDATE_UNIVERSAL_CHAR_STREAMS_HPP_55F1B811_CD76_4C72_8344_CBC69CF3B339_INCLUDED)
