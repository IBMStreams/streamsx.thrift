...
namespace closures {
    ...
    :   streams_boost::spirit::classic::closure<chlit_closure, streams_boost::uint32_t, bool> 
    {
        member1 value;
        member2 long_lit;
    };
...
///////////////////////////////////////////////////////////////////////////////
    struct compose_character_literal {
        ...
        void 
        operator()(streams_boost::uint32_t& value, bool long_lit, bool& overflow,
            streams_boost::uint32_t character) const
        { 
            // The following assumes that wchar_t is max. 32 Bit
            STREAMS_BOOST_STATIC_ASSERT(sizeof(wchar_t) <= 4);
            
            static streams_boost::uint32_t masks[] = { 
                0x000000ff, 0x0000ffff, 0x00ffffff, 0xffffffff
            };
            static streams_boost::uint32_t overflow_masks[] = { 
...
#define TRACE_CHLIT_GRAMMAR \
    bool(STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CHLIT_GRAMMAR) \
    /**/

struct chlit_grammar :
    public streams_boost::spirit::classic::grammar<chlit_grammar, 
        closures::chlit_closure::context_t>
{
    chlit_grammar()
    :   overflow(false)
    {
        STREAMS_BOOST_SPIRIT_DEBUG_TRACE_GRAMMAR_NAME(*this, "chlit_grammar", 
            TRACE_CHLIT_GRAMMAR);
    }
    ...
    struct definition
    {
        ...
        definition(chlit_grammar const &self)
        {
            ...
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ch_lit, TRACE_CHLIT_GRAMMAR);
        }
...
#define STREAMS_BOOST_WAVE_CHLITGRAMMAR_GEN_INLINE
#else
#define STREAMS_BOOST_WAVE_CHLITGRAMMAR_GEN_INLINE inline
#endif 

template <typename TokenT>
STREAMS_BOOST_WAVE_CHLITGRAMMAR_GEN_INLINE 
unsigned int
...
chlit_grammar g;
streams_boost::uint32_t result = 0;
...
parse_info<typename TokenT::string_type::const_iterator> hit =
    ...
    if (!hit.hit) {
        STREAMS_BOOST_WAVE_THROW(preprocess_exception, ill_formed_character_literal, 
...
#undef STREAMS_BOOST_WAVE_CHLITGRAMMAR_GEN_INLINE
