...
#include <streams_boost/spirit/include/classic_closure.hpp>
#include <streams_boost/spirit/include/classic_if.hpp>
#include <streams_boost/spirit/include/classic_assign_actor.hpp>
#include <streams_boost/spirit/include/classic_push_back_actor.hpp>

#include <streams_boost/spirit/include/phoenix1_functions.hpp>
#include <streams_boost/spirit/include/phoenix1_operators.hpp>
#include <streams_boost/spirit/include/phoenix1_primitives.hpp>
#include <streams_boost/spirit/include/phoenix1_statements.hpp>
#include <streams_boost/spirit/include/phoenix1_casts.hpp>
...
#include <streams_boost/wave/grammars/cpp_literal_grammar_gen.hpp>  
#include <streams_boost/wave/grammars/cpp_expression_value.hpp>
#include <streams_boost/wave/util/pattern_parser.hpp>
#include <streams_boost/wave/util/macro_helpers.hpp>

#if !defined(spirit_append_actor)
#define spirit_append_actor(actor) streams_boost::spirit::classic::push_back_a(actor)
#define spirit_assign_actor(actor) streams_boost::spirit::classic::assign_a(actor)
...
///////////////////////////////////////////////////////////////////////////////
    ...
    :   streams_boost::spirit::classic::closure<cpp_expr_closure, closure_value> 
    {
        member1 val;
    };
...
///////////////////////////////////////////////////////////////////////////////
    struct convert_intlit {
        ...
        struct result { 
            ...
            typedef streams_boost::wave::grammars::closures::closure_value type; 
        };

        template <typename TokenT>
        streams_boost::wave::grammars::closures::closure_value 
        operator()(TokenT const &token) const
        { 
            typedef streams_boost::wave::grammars::closures::closure_value return_type;
...
///////////////////////////////////////////////////////////////////////////////
    struct operator_to_bool {
        ...
        { 
            typedef streams_boost::wave::grammars::closures::closure_value return_type;
            return return_type(
                streams_boost::wave::grammars::closures::as_bool(val), val.is_valid());
        }
    };
...
///////////////////////////////////////////////////////////////////////////////
    struct operator_as_bool {
        ...
        operator()(ArgT &val) const
        { 
            return streams_boost::wave::grammars::closures::as_bool(val);
        }
    };
...
//
///////////////////////////////////////////////////////////////////////////////
#define STREAMS_BOOST_WAVE_BINARYOP(op, optok)                                        \
    ...
    STREAMS_BOOST_WAVE_BINARYOP(and, &&);
    STREAMS_BOOST_WAVE_BINARYOP(or, ||);
    
    STREAMS_BOOST_WAVE_BINARYOP(bitand, &);
    STREAMS_BOOST_WAVE_BINARYOP(bitor, |);
    STREAMS_BOOST_WAVE_BINARYOP(bitxor, ^);
    
    STREAMS_BOOST_WAVE_BINARYOP(lesseq, <=);
    STREAMS_BOOST_WAVE_BINARYOP(less, <);
    STREAMS_BOOST_WAVE_BINARYOP(greater, >);
    STREAMS_BOOST_WAVE_BINARYOP(greateq, >=);
    STREAMS_BOOST_WAVE_BINARYOP(eq, ==);
    STREAMS_BOOST_WAVE_BINARYOP(ne, !=);

#undef STREAMS_BOOST_WAVE_BINARYOP

///////////////////////////////////////////////////////////////////////////////
#define STREAMS_BOOST_WAVE_UNARYOP(op, optok)                                         \
    ...
    STREAMS_BOOST_WAVE_UNARYOP(neg, !);
    
#undef STREAMS_BOOST_WAVE_UNARYOP
...
#define TRACE_CPP_EXPR_GRAMMAR \
    bool(STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP_EXPR_GRAMMAR) \
    /**/

struct expression_grammar :
    public streams_boost::spirit::classic::grammar<
        expression_grammar, 
    ...
    >
{
    expression_grammar()
    {
        STREAMS_BOOST_SPIRIT_DEBUG_TRACE_GRAMMAR_NAME(*this, "expression_grammar", 
    ...
    struct definition
    {
        ...
        typedef streams_boost::spirit::classic::rule<ScannerT, closure_type::context_t> rule_t;
        typedef streams_boost::spirit::classic::rule<ScannerT> simple_rule_t;
        ...
        streams_boost::spirit::classic::subrule<0, closure_type::context_t> const_exp_subrule;
        ...
        definition(expression_grammar const &self)
        {
            ...
            using streams_boost::wave::util::pattern_p;
            ...
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(pp_expression, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(const_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(logical_or_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(logical_and_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(inclusive_or_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(exclusive_or_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(and_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(cmp_equality, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(cmp_relational, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(shift_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(add_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(multiply_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(unary_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(primary_exp, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(constant, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(const_exp_subrule, TRACE_CPP_EXPR_GRAMMAR);

            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(const_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(logical_or_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(logical_and_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(inclusive_or_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(exclusive_or_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(and_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(cmp_equality_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(cmp_relational_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(shift_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(add_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(multiply_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(unary_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(primary_exp_nocalc, TRACE_CPP_EXPR_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(constant_nocalc, TRACE_CPP_EXPR_GRAMMAR);
        }
...
#define STREAMS_BOOST_WAVE_EXPRGRAMMAR_GEN_INLINE
#else
#define STREAMS_BOOST_WAVE_EXPRGRAMMAR_GEN_INLINE inline
#endif 

template <typename TokenT>
STREAMS_BOOST_WAVE_EXPRGRAMMAR_GEN_INLINE 
bool 
    ...
    bool if_block_status, value_error &status)
{
    using namespace streams_boost::spirit::classic;
    using namespace streams_boost::wave;
    using namespace streams_boost::wave::grammars::closures;
    
    using streams_boost::wave::util::impl::as_string;
...
#endif
    {
        ...
        // expression is illformed
            if (if_block_status) {
                ...
                STREAMS_BOOST_WAVE_THROW(preprocess_exception, ill_formed_expression, 
...
#undef STREAMS_BOOST_WAVE_EXPRGRAMMAR_GEN_INLINE
