...
#if STREAMS_BOOST_WAVE_DUMP_PARSE_TREE != 0
#include <map>
#include <streams_boost/spirit/include/classic_tree_to_xml.hpp>
#endif
...
///////////////////////////////////////////////////////////////////////////////
    ...
    :   public streams_boost::spirit::classic::parser<flush_underlying_parser>
    {
        typedef flush_underlying_parser this_t;

        template <typename ScannerT>
        typename streams_boost::spirit::classic::parser_result<this_t, ScannerT>::type
...
#define TRACE_CPP_GRAMMAR \
    bool(STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP_GRAMMAR) \
    /**/
...
struct cpp_grammar : 
    public streams_boost::spirit::classic::grammar<cpp_grammar<TokenT, ContainerT> >
{
    ...
    // non-parse_tree generating rule type
        ...
        typedef streams_boost::spirit::classic::match_policy match_policy_t;
        typedef typename ScannerT::action_policy_t action_policy_t;
        typedef 
            streams_boost::spirit::classic::scanner_policies<
                iteration_policy_t, match_policy_t, action_policy_t> 
            policies_t;
        typedef 
            streams_boost::spirit::classic::scanner<typename ScannerT::iterator_t, policies_t> 
            non_tree_scanner_t;
        typedef 
            streams_boost::spirit::classic::rule<
                non_tree_scanner_t, streams_boost::spirit::classic::dynamic_parser_tag> 
            no_tree_rule_type;
...
//         rule_type ppelse, ppendif;
        ...
        // set the rule id's for later use
            pp_statement.set_id(STREAMS_BOOST_WAVE_PP_STATEMENT_ID);
//             include_file.set_id(STREAMS_BOOST_WAVE_INCLUDE_FILE_ID);
//             system_include_file.set_id(STREAMS_BOOST_WAVE_SYSINCLUDE_FILE_ID);
            macro_include_file.set_id(STREAMS_BOOST_WAVE_MACROINCLUDE_FILE_ID);
            ...
            undefine.set_id(STREAMS_BOOST_WAVE_UNDEFINE_ID);
            ppifdef.set_id(STREAMS_BOOST_WAVE_IFDEF_ID);
            ppifndef.set_id(STREAMS_BOOST_WAVE_IFNDEF_ID);
            ppif.set_id(STREAMS_BOOST_WAVE_IF_ID);
            ppelif.set_id(STREAMS_BOOST_WAVE_ELIF_ID);
//             ppelse.set_id(STREAMS_BOOST_WAVE_ELSE_ID);
//             ppendif.set_id(STREAMS_BOOST_WAVE_ENDIF_ID);
            ppline.set_id(STREAMS_BOOST_WAVE_LINE_ID);
            pperror.set_id(STREAMS_BOOST_WAVE_ERROR_ID);
            ppwarning.set_id(STREAMS_BOOST_WAVE_WARNING_ID);
            pppragma.set_id(STREAMS_BOOST_WAVE_PRAGMA_ID);
            illformed.set_id(STREAMS_BOOST_WAVE_ILLFORMED_ID);
            ppsp.set_id(STREAMS_BOOST_WAVE_PPSPACE_ID);
            ppqualifiedname.set_id(STREAMS_BOOST_WAVE_PPQUALIFIEDNAME_ID);
#if STREAMS_BOOST_WAVE_SUPPORT_MS_EXTENSIONS != 0
            ppregion.set_id(STREAMS_BOOST_WAVE_REGION_ID);
            ppendregion.set_id(STREAMS_BOOST_WAVE_ENDREGION_ID);
#endif
...
//  Note: this may break the parser, though.
      ...
      (STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP_GRAMMAR) \
     )
                   >>  impl::flush_underlying_parser_p
#endif // !(defined(STREAMS_BOOST_SPIRIT_DEBUG) &&
                ;
...
//                 ;
        ...
        // end of line tokens
            ...
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(pp_statement, TRACE_CPP_GRAMMAR);
//             STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(include_file, TRACE_CPP_GRAMMAR);
//             STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(system_include_file, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(macro_include_file, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(plain_define, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(macro_definition, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(macro_parameters, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(undefine, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppifdef, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppifndef, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppif, TRACE_CPP_GRAMMAR);
//             STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppelse, TRACE_CPP_GRAMMAR);
//             STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppelif, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppendif, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppline, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(pperror, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppwarning, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(illformed, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppsp, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppqualifiedname, TRACE_CPP_GRAMMAR);
#if STREAMS_BOOST_WAVE_SUPPORT_MS_EXTENSIONS != 0
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppregion, TRACE_CPP_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(ppendregion, TRACE_CPP_GRAMMAR);
#endif
        }
    ...
    :   found_eof(found_eof_), 
        ...
        found_eoltokens(found_eoltokens_)
    { 
        STREAMS_BOOST_SPIRIT_DEBUG_TRACE_GRAMMAR_NAME(*this, "cpp_grammar", 
            TRACE_CPP_GRAMMAR); 
    }
...
// helper function and data to get readable names of the rules known to us
    struct map_ruleid_to_name :
        public std::map<streams_boost::spirit::classic::parser_id, std::string> 
    {
        typedef std::map<streams_boost::spirit::classic::parser_id, std::string> base_type;
        ...
        void init_rule_id_to_name_map(cpp_grammar const &self)
        {
            ...
            init_ruleid_name_map[] = {
                { STREAMS_BOOST_WAVE_PP_STATEMENT_ID, "pp_statement" },
//                 { STREAMS_BOOST_WAVE_INCLUDE_FILE_ID, "include_file" },
//                 { STREAMS_BOOST_WAVE_SYSINCLUDE_FILE_ID, "system_include_file" },
                { STREAMS_BOOST_WAVE_MACROINCLUDE_FILE_ID, "macro_include_file" },
                { STREAMS_BOOST_WAVE_PLAIN_DEFINE_ID, "plain_define" },
                { STREAMS_BOOST_WAVE_MACRO_PARAMETERS_ID, "macro_parameters" },
                { STREAMS_BOOST_WAVE_MACRO_DEFINITION_ID, "macro_definition" },
                { STREAMS_BOOST_WAVE_UNDEFINE_ID, "undefine" },
                { STREAMS_BOOST_WAVE_IFDEF_ID, "ppifdef" },
                { STREAMS_BOOST_WAVE_IFNDEF_ID, "ppifndef" },
                { STREAMS_BOOST_WAVE_IF_ID, "ppif" },
                { STREAMS_BOOST_WAVE_ELIF_ID, "ppelif" },
//                 { STREAMS_BOOST_WAVE_ELSE_ID, "ppelse" },
//                 { STREAMS_BOOST_WAVE_ENDIF_ID, "ppendif" },
                { STREAMS_BOOST_WAVE_LINE_ID, "ppline" },
                { STREAMS_BOOST_WAVE_ERROR_ID, "pperror" },
                { STREAMS_BOOST_WAVE_WARNING_ID, "ppwarning" },
                { STREAMS_BOOST_WAVE_PRAGMA_ID, "pppragma" },
                { STREAMS_BOOST_WAVE_ILLFORMED_ID, "illformed" },
                { STREAMS_BOOST_WAVE_PPSPACE_ID, "ppspace" },
                { STREAMS_BOOST_WAVE_PPQUALIFIEDNAME_ID, "ppqualifiedname" },
#if STREAMS_BOOST_WAVE_SUPPORT_MS_EXTENSIONS != 0
                { STREAMS_BOOST_WAVE_REGION_ID, "ppregion" },
                { STREAMS_BOOST_WAVE_ENDREGION_ID, "ppendregion" },
#endif
                { 0 }
            };
        ...
        // initialize parser_id to rule_name map
            for (int i = 0; 0 != init_ruleid_name_map[i].parser_id; ++i)
                base_type::insert(base_type::value_type(
                    streams_boost::spirit::classic::parser_id(init_ruleid_name_map[i].parser_id), 
...
inline streams_boost::spirit::classic::tree_parse_info<IteratorT, NodeFactoryT>
parsetree_parse(IteratorT const& first_, IteratorT const& last,
    streams_boost::spirit::classic::parser<ParserT> const& p)
{
    using namespace streams_boost::spirit::classic;
...
#define STREAMS_BOOST_WAVE_GRAMMAR_GEN_INLINE
#else
#define STREAMS_BOOST_WAVE_GRAMMAR_GEN_INLINE inline
#endif 

template <typename LexIteratorT, typename TokenContainerT>
STREAMS_BOOST_WAVE_GRAMMAR_GEN_INLINE 
streams_boost::spirit::classic::tree_parse_info<
    LexIteratorT, 
...
#if STREAMS_BOOST_WAVE_DUMP_PARSE_TREE != 0
    if (hit.match) {
        tree_to_xml (STREAMS_BOOST_WAVE_DUMP_PARSE_TREE_OUT, hit.trees, "", 
...
#undef STREAMS_BOOST_WAVE_GRAMMAR_GEN_INLINE
