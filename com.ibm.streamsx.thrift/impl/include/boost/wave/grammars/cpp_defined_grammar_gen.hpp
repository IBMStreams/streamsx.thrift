...
struct STREAMS_BOOST_WAVE_DECL defined_grammar_gen
{
...
//  generated by the compiler twice anyway.
    ...
    typedef streams_boost::wave::util::unput_queue_iterator<
...
//  parse the operator defined and return the found qualified name
    static streams_boost::spirit::classic::parse_info<iterator1_type> 
    parse_operator_defined (iterator1_type const &first, 
        iterator1_type const &last, token_sequence_type &found_qualified_name);

    static streams_boost::spirit::classic::parse_info<iterator2_type> 
