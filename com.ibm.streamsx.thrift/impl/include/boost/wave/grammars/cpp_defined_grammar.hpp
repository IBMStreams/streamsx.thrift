...
#define TRACE_CPP_DEFINED_GRAMMAR \
    bool(STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_DEFINED_GRAMMAR) \
    /**/

template <typename ContainerT>
struct defined_grammar :
    public streams_boost::spirit::classic::grammar<defined_grammar<ContainerT> >
{
    defined_grammar(ContainerT &result_seq_)
    :   result_seq(result_seq_)
    {
        STREAMS_BOOST_SPIRIT_DEBUG_TRACE_GRAMMAR_NAME(*this, "defined_grammar", 
    ...
    struct definition
    {
        ...
        definition(defined_grammar const &self)
        {
            ...
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(defined_op, TRACE_CPP_DEFINED_GRAMMAR);
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(identifier, TRACE_CPP_DEFINED_GRAMMAR);
        }
...
#define STREAMS_BOOST_WAVE_DEFINED_GRAMMAR_GEN_INLINE
#else
#define STREAMS_BOOST_WAVE_DEFINED_GRAMMAR_GEN_INLINE inline
#endif 
...
STREAMS_BOOST_WAVE_DEFINED_GRAMMAR_GEN_INLINE 
streams_boost::spirit::classic::parse_info<
    ...
    token_sequence_type &found_qualified_name)
{
    ...
    return streams_boost::spirit::classic::parse (
...
#undef STREAMS_BOOST_WAVE_DEFINED_GRAMMAR_GEN_INLINE
