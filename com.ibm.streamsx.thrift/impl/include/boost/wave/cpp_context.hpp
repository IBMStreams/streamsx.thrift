...
#include <streams_boost/wave/wave_config_constant.hpp>
#endif
#include <streams_boost/wave/token_ids.hpp>

#include <streams_boost/wave/util/unput_queue_iterator.hpp>
#include <streams_boost/wave/util/cpp_ifblock.hpp>
#include <streams_boost/wave/util/cpp_include_paths.hpp>
#include <streams_boost/wave/util/iteration_context.hpp>
#include <streams_boost/wave/util/cpp_iterator.hpp>
#include <streams_boost/wave/util/cpp_macromap.hpp>

#include <streams_boost/wave/preprocessing_hooks.hpp>
...
//
//      The streams_boost::wave::context template is the main interface class to 
...
>
class context : private streams_boost::noncopyable
{
private:
...
// the given iterator should be at least a forward iterator type
    STREAMS_BOOST_CLASS_REQUIRE(IteratorT, streams_boost, ForwardIteratorConcept);
...
// stack of shared_ptr's to the pending iteration contexts 
    typedef streams_boost::shared_ptr<base_iteration_context<context, lexer_type> > 
        iteration_ptr_type;
    typedef streams_boost::wave::util::iteration_context_stack<iteration_ptr_type> 
...
// iterator interface
    ...
    { 
        ...
        if (filename != "<Unknown>" && filename != "<stdin>") {
            using namespace streams_boost::filesystem;
...
// maintain defined macros
    ...
    { 
        return streams_boost::wave::util::add_macro_definition(*this, 
...
// Iterate over names of defined macros
    typedef streams_boost::wave::util::macromap<context> macromap_type;
...
// get the Wave version information 
    ...
    { 
        streams_boost::wave::util::predefined_macros p; 
...
// access current language options
    void set_language(streams_boost::wave::language_support language_,
    ...
    streams_boost::wave::language_support get_language() const { return language; }
...
protected:
    friend class streams_boost::wave::pp_iterator<context>;
    friend class streams_boost::wave::impl::pp_iterator_functor<context>;
#endif
...
// conditional compilation contexts
    ...
    typename streams_boost::wave::util::if_block_stack::size_type get_if_block_depth() const 
...
///////////////////////////////////////////////////////////////////////////////
    ...
    // remove any contained placeholder
        streams_boost::wave::util::impl::remove_placeholders(expanded);
    }
...
// maintain the list of known headers containing #pragma once 
    ...
    { 
        ...
        return includes.add_pragma_once_header(filename_, 
            "__STREAMS_BOOST_WAVE_PRAGMA_ONCE__"); 
    }
#endif 
...
private:
    ...
    void save(Archive & ar, const unsigned int version) const
    {
        ...
        string_type cfg(STREAMS_BOOST_PP_STRINGIZE(STREAMS_BOOST_WAVE_CONFIG));
        string_type kwd(STREAMS_BOOST_WAVE_PRAGMA_KEYWORD);
        string_type strtype(STREAMS_BOOST_PP_STRINGIZE((STREAMS_BOOST_WAVE_STRINGTYPE)));
    ...
    void load(Archive & ar, const unsigned int loaded_version)
    {
        ...
        if (version != (loaded_version & ~version_mask)) {
            STREAMS_BOOST_WAVE_THROW_CTX((*this), preprocess_exception, 
        ...
        // STREAMS_BOOST_PP_STRINGIZE(STREAMS_BOOST_WAVE_CONFIG)
        ar & make_nvp("config", config);
        if (config != STREAMS_BOOST_PP_STRINGIZE(STREAMS_BOOST_WAVE_CONFIG)) {
            STREAMS_BOOST_WAVE_THROW_CTX((*this), preprocess_exception, 
                incompatible_config, "STREAMS_BOOST_WAVE_CONFIG", get_main_pos());
            return;
        }

        // STREAMS_BOOST_WAVE_PRAGMA_KEYWORD
        ar & make_nvp("pragma_keyword", pragma_keyword);
        if (pragma_keyword != STREAMS_BOOST_WAVE_PRAGMA_KEYWORD) {
            STREAMS_BOOST_WAVE_THROW_CTX((*this), preprocess_exception, 
                incompatible_config, "STREAMS_BOOST_WAVE_PRAGMA_KEYWORD", 
                get_main_pos());
            return;
        }
        ...
        if (string_type_str != STREAMS_BOOST_PP_STRINGIZE((STREAMS_BOOST_WAVE_STRINGTYPE))) {
            STREAMS_BOOST_WAVE_THROW_CTX((*this), preprocess_exception, 
                incompatible_config, "STREAMS_BOOST_WAVE_STRINGTYPE", get_main_pos());
            return;
        }
...
// the main input stream
    ...
    streams_boost::wave::util::if_block_stack ifblocks;   // conditional compilation contexts
    streams_boost::wave::util::include_paths includes;    // lists of include directories to search
    iteration_context_stack_type iter_ctxs;       // iteration contexts
    macromap_type macros;                         // map of defined macros
    streams_boost::wave::language_support language;       // supported language/extensions
...
>
struct tracking_level<streams_boost::wave::context<Iterator, LexIterator, InputPolicy, Hooks> >
{
...
template<
    ...
    typename InputPolicy, typename Hooks
>
struct version<streams_boost::wave::context<Iterator, LexIterator, InputPolicy, Hooks> >
{
    typedef streams_boost::wave::context<Iterator, LexIterator, InputPolicy, Hooks>
        target_type;
