...
#else  // STREAMS_BOOST_WAVE_SUPPORT_VARIADICS_PLACEMARKERS != 0
...
#define STREAMS_BOOST_WAVE_NEED_OPTION(option)                                        \
...
#define STREAMS_BOOST_WAVE_ENABLE_OPTION(option)                                      \
    inline language_support                                                   \
...
#define STREAMS_BOOST_WAVE_OPTION(option)                                             \
    STREAMS_BOOST_WAVE_NEED_OPTION(option)                                            \
    STREAMS_BOOST_WAVE_ENABLE_OPTION(option)                                          \
    /**/
    
///////////////////////////////////////////////////////////////////////////////
STREAMS_BOOST_WAVE_OPTION(long_long)                // support_option_long_long
STREAMS_BOOST_WAVE_OPTION(no_character_validation)  // support_option_no_character_validation
STREAMS_BOOST_WAVE_OPTION(preserve_comments)        // support_option_preserve_comments
STREAMS_BOOST_WAVE_OPTION(prefer_pp_numbers)        // support_option_prefer_pp_numbers
STREAMS_BOOST_WAVE_OPTION(emit_line_directives)     // support_option_emit_line_directives
STREAMS_BOOST_WAVE_OPTION(single_line)              // support_option_single_line
STREAMS_BOOST_WAVE_OPTION(convert_trigraphs)        // support_option_convert_trigraphs
#if STREAMS_BOOST_WAVE_SUPPORT_PRAGMA_ONCE != 0
STREAMS_BOOST_WAVE_OPTION(include_guard_detection)  // support_option_include_guard_detection
#endif
#if STREAMS_BOOST_WAVE_SUPPORT_VARIADICS_PLACEMARKERS != 0
STREAMS_BOOST_WAVE_OPTION(variadics)                // support_option_variadics
#endif 
#if STREAMS_BOOST_WAVE_EMIT_PRAGMA_DIRECTIVES != 0
STREAMS_BOOST_WAVE_OPTION(emit_pragma_directives)   // support_option_emit_pragma_directives
#endif
STREAMS_BOOST_WAVE_OPTION(insert_whitespace)        // support_option_insert_whitespace

#undef STREAMS_BOOST_WAVE_NEED_OPTION
#undef STREAMS_BOOST_WAVE_ENABLE_OPTION
#undef STREAMS_BOOST_WAVE_OPTION
