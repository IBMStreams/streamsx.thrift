...
#include <streams_boost/wave/token_ids.hpp>     // token_id 
...
public:
    ...
    >   
    bool equal(
        streams_boost::iterator_adaptor<OtherDerivedT, OtherIteratorT, V, C, R, D> 
        const &x) const
    {
...
namespace impl {
    ...
    struct next_token 
    {
        static streams_boost::wave::token_id  
