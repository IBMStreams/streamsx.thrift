...
#include <streams_boost/spirit/include/classic_position_iterator.hpp>
...
namespace debug {
    ...
    //  Used only when STREAMS_BOOST_ASSERT expands to something
...
public:
    ...
    {
        STREAMS_BOOST_ASSERT(!debug::is_escaped_lit(file));
    }
...
typedef file_position<STREAMS_BOOST_WAVE_STRINGTYPE> file_position_type;
...
//  specialization of the streams_boost::spirit::classic::position_policy class is 
//  provided below.
//
///////////////////////////////////////////////////////////////////////////////
...
:   streams_boost::spirit::classic::position_iterator<IteratorT, PositionT>
{
    typedef streams_boost::spirit::classic::position_iterator<IteratorT, PositionT> base_type;
...
///////////////////////////////////////////////////////////////////////////////
//
//  The streams_boost::spirit::classic::position_policy has to be specialized for our 
//  file_position class
//
///////////////////////////////////////////////////////////////////////////////

    template <>
    class position_policy<streams_boost::wave::util::file_position_type> {
    ...
    public:
        ...
        void next_line(streams_boost::wave::util::file_position_type &pos)
        {
        ...
        void next_char(streams_boost::wave::util::file_position_type &pos)
        {
            pos.set_column(pos.get_column() + 1);
        }

        void tabulation(streams_boost::wave::util::file_position_type &pos)   
        {
