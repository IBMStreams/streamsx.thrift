...
// T_IDENTIFIER
    ...
    template <typename StringT>
    inline bool 
    handle_identifier(streams_boost::wave::token_id prev, 
        streams_boost::wave::token_id before, StringT const &value)
    {
...
// T_INTLIT
    inline bool 
    handle_intlit(streams_boost::wave::token_id prev, streams_boost::wave::token_id /*before*/)
    {
        using namespace streams_boost::wave;
        switch (static_cast<unsigned int>(prev)) {
        case T_IDENTIFIER:
...
// T_FLOATLIT
    inline bool 
    handle_floatlit(streams_boost::wave::token_id prev, 
        streams_boost::wave::token_id /*before*/)
    {
        using namespace streams_boost::wave;
        switch (static_cast<unsigned int>(prev)) {
        case T_IDENTIFIER:
...
// <% T_LEFTBRACE
    inline bool 
    handle_alt_leftbrace(streams_boost::wave::token_id prev, 
        streams_boost::wave::token_id /*before*/)
    {
        using namespace streams_boost::wave;
        switch (static_cast<unsigned int>(prev)) {
...
// <: T_LEFTBRACKET
    inline bool 
    handle_alt_leftbracket(streams_boost::wave::token_id prev, 
        streams_boost::wave::token_id /*before*/)
    {
        using namespace streams_boost::wave;
        switch (static_cast<unsigned int>(prev)) {
...
// T_FIXEDPOINTLIT
    inline bool 
    handle_fixedpointlit(streams_boost::wave::token_id prev, 
        streams_boost::wave::token_id /*before*/)
    {
        using namespace streams_boost::wave;
        switch (static_cast<unsigned int>(prev)) {
...
// T_DOT
    inline bool 
    handle_dot(streams_boost::wave::token_id prev, streams_boost::wave::token_id before)
    {
        using namespace streams_boost::wave;
        switch (static_cast<unsigned int>(prev)) {
        case T_DOT:
...
// T_QUESTION_MARK
    inline bool 
    handle_questionmark(streams_boost::wave::token_id prev, 
        streams_boost::wave::token_id /*before*/)
    {
        using namespace streams_boost::wave;
        switch(static_cast<unsigned int>(prev)) {
...
// T_NEWLINE
    inline bool
    handle_newline(streams_boost::wave::token_id prev, 
        streams_boost::wave::token_id before)
    {
        using namespace streams_boost::wave;
        switch(static_cast<unsigned int>(prev)) {
    ...
    inline bool 
    handle_parens(streams_boost::wave::token_id prev)
    {
        switch (static_cast<unsigned int>(prev)) {
        case T_LEFTPAREN:
        case T_RIGHTPAREN:
...
public:
    ...
    :   insert_whitespace(insert_whitespace_),
        prev(streams_boost::wave::T_EOF), beforeprev(streams_boost::wave::T_EOF) 
    {}
    
    template <typename StringT>
    bool must_insert(streams_boost::wave::token_id current, StringT const &value)
    {
...
//         }
    ...
    void shift_tokens (streams_boost::wave::token_id next_id)
    {
        if (insert_whitespace) {
            beforeprev = prev;
            prev = next_id;
...
private:
    ...
    streams_boost::wave::token_id prev;        // the previous analyzed token
    streams_boost::wave::token_id beforeprev;  // the token before the previous
};
