...
#define TRACE_CPP_TIME_CONVERSION \
    (STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_CPP & STREAMS_BOOST_SPIRIT_DEBUG_FLAGS_TIME_CONVERSION) \
    /**/
...
//  __DATE__ and __TIME__ 
    class time_conversion_grammar :
        public streams_boost::spirit::classic::grammar<time_conversion_grammar>
    {
    public:
        time_conversion_grammar() : fYearIsCorrected(false)
        {
            ...
            STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE_NAME(*this, "time_conversion_grammar",
        ...
        struct definition {
            ...
            {
                using streams_boost::spirit::classic::int_p;
                using streams_boost::spirit::classic::add;
            ...
            char const *m[] = {
                ...
                STREAMS_BOOST_SPIRIT_DEBUG_TRACE_RULE(time_rule, TRACE_CPP_TIME_CONVERSION);
            }
            
            streams_boost::spirit::classic::rule<ScannerT> time_rule;
            streams_boost::spirit::classic::symbols<> month;
...
// of the saved dfa table 
    ...
    public:
        ...
        parse_info<> pi = parse (act_time, g, space_p);
            ...
            STREAMS_BOOST_ASSERT(0 != compile_time);        
        }
...
// import time_conversion into the streams_boost::wave::util namespace
