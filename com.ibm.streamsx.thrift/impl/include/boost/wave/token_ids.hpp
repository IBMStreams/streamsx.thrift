...
#if !defined(STREAMS_BOOST_WAVE_TOKEN_IDS_DEFINED)
#define STREAMS_BOOST_WAVE_TOKEN_IDS_DEFINED
...
#undef TOKEN_FROM_ID
#define TOKEN_FROM_ID(id, cat)   streams_boost::wave::token_id((id) | (cat))

#undef ID_FROM_TOKEN
#define ID_FROM_TOKEN(tok)       ((tok) & ~streams_boost::wave::TokenTypeMask)

#undef BASEID_FROM_TOKEN
#define BASEID_FROM_TOKEN(tok)                                                \
    streams_boost::wave::token_id(((tok) & ~streams_boost::wave::ExtTokenTypeMask))           \
    /**/
#define BASE_TOKEN(tok)                                                       \
    streams_boost::wave::token_id((tok) & streams_boost::wave::MainTokenMask)                 \
    /**/
#define CATEGORY_FROM_TOKEN(tok) ((tok) & streams_boost::wave::TokenTypeMask)
#define EXTCATEGORY_FROM_TOKEN(tok) ((tok) & streams_boost::wave::ExtTokenTypeMask)
...
///////////////////////////////////////////////////////////////////////////////
//  return a token name
STREAMS_BOOST_WAVE_DECL 
STREAMS_BOOST_WAVE_STRINGTYPE get_token_name(token_id tokid);
...
#endif // #if !defined(STREAMS_BOOST_WAVE_TOKEN_IDS_DEFINED)
