...
#ifndef STREAMS_BOOST_OFFSET_PTR_HPP
#define STREAMS_BOOST_OFFSET_PTR_HPP
...
class offset_ptr
{
   ...
   void set_offset(const void *ptr)
   {
      ...
      if(!ptr){
         ...
         STREAMS_BOOST_ASSERT(m_offset != 1);
      }
   }
...
//!for offset_ptr
template<class T>
inline void swap (streams_boost::interprocess::offset_ptr<T> &pt, 
                  streams_boost::interprocess::offset_ptr<T> &pt2)
{  
...
inline streams_boost::interprocess::offset_ptr<T> 
   static_pointer_cast(streams_boost::interprocess::offset_ptr<U> const & r)
{  
   return streams_boost::interprocess::offset_ptr<T>
            (r, streams_boost::interprocess::detail::static_cast_tag());  
}

//!Simulation of const_cast between pointers. Never throws.
template<class T, class U> 
inline streams_boost::interprocess::offset_ptr<T>
   const_pointer_cast(streams_boost::interprocess::offset_ptr<U> const & r)
{  
   return streams_boost::interprocess::offset_ptr<T>
            (r, streams_boost::interprocess::detail::const_cast_tag());  
}

//!Simulation of dynamic_cast between pointers. Never throws.
template<class T, class U> 
inline streams_boost::interprocess::offset_ptr<T> 
   dynamic_pointer_cast(streams_boost::interprocess::offset_ptr<U> const & r)
{  
   return streams_boost::interprocess::offset_ptr<T>
            (r, streams_boost::interprocess::detail::dynamic_cast_tag());  
}

//!Simulation of reinterpret_cast between pointers. Never throws.
template<class T, class U> 
inline streams_boost::interprocess::offset_ptr<T>
   reinterpret_pointer_cast(streams_boost::interprocess::offset_ptr<U> const & r)
{  
   return streams_boost::interprocess::offset_ptr<T>
            (r, streams_boost::interprocess::detail::reinterpret_cast_tag());  
}
...
template <class T>
struct has_trivial_constructor< streams_boost::interprocess::offset_ptr<T> > 
{
   enum { value = true };
};
...
template <class T>
struct has_trivial_destructor< streams_boost::interprocess::offset_ptr<T> > 
{
   enum { value = true };
};
...
namespace interprocess {
//#endif
//!get_pointer() enables streams_boost::mem_fn to recognize offset_ptr. 
//!Never throws.
template<class T>
inline T * get_pointer(streams_boost::interprocess::offset_ptr<T> const & p)
{  return p.get();   }
//#if !defined(_MSC_VER) || (_MSC_VER >= 1400)
}  //namespace interprocess
//#endif
...
struct max_pointer_plus_bits<streams_boost::interprocess::offset_ptr<void>, Alignment>
{
   //The offset ptr can embed one bit less than the alignment since it
   //uses offset == 1 to store the null pointer.
   static const std::size_t value = ::streams_boost::interprocess::detail::ls_zeros<Alignment>::value - 1;
};
...
struct pointer_plus_bits<streams_boost::interprocess::offset_ptr<T>, NumBits>
{
   typedef streams_boost::interprocess::offset_ptr<T>         pointer;
...
#endif //#ifndef STREAMS_BOOST_OFFSET_PTR_HPP
