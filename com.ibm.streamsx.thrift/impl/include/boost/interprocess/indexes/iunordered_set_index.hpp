...
#ifndef STREAMS_BOOST_INTERPROCESS_IUNORDERED_SET_INDEX_HPP
#define STREAMS_BOOST_INTERPROCESS_IUNORDERED_SET_INDEX_HPP
...
#include <streams_boost/interprocess/containers/vector.hpp>
#include <streams_boost/intrusive/unordered_set.hpp>
#include <streams_boost/interprocess/allocators/allocator.hpp>

//!\file
//!Describes index adaptor of streams_boost::intrusive::unordered_set container, to use it
   ...
   struct equal_function
   {
      ...
      : std::unary_function<value_type, std::size_t>
    {
        std::size_t operator()(const value_type &val) const
        {
            ...
            return streams_boost::hash_range(beg, end);
        }
...
//!Index type based in streams_boost::intrusive::set.
//!Just derives from streams_boost::intrusive::set 
   ...
   ,  public iunordered_set_index_aux<MapConfig>::index_t
{
      ...
      , allocator_type &alloc, std::size_t new_size)
   {
      ...
      if(!alloc.allocation_command
         (streams_boost::interprocess::try_shrink_in_place | streams_boost::interprocess::nothrow_allocation, old_size, new_size, received_size, buckets).first){
         return old_size;
      }
      ...
      bucket_ptr shunk_p = alloc.allocation_command
         (streams_boost::interprocess::shrink_in_place | streams_boost::interprocess::nothrow_allocation, received_size, received_size, received_size, buckets).first;
      STREAMS_BOOST_ASSERT(buckets == shunk_p);
      ...
      , allocator_type &alloc,  const std::size_t new_num)
   {
      ...
      std::pair<bucket_ptr, bool> ret =
         alloc.allocation_command
            (streams_boost::interprocess::expand_fwd | streams_boost::interprocess::allocate_new, new_num, new_num, received_size, old_buckets);
...
struct is_intrusive_index
   <streams_boost::interprocess::iunordered_set_index<MapConfig> >
{
   enum{ value = true };
};
/// @endcond
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_IUNORDERED_SET_INDEX_HPP
