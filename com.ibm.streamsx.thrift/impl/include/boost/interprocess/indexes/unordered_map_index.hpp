...
#ifndef STREAMS_BOOST_INTERPROCESS_UNORDERED_MAP_INDEX_HPP
#define STREAMS_BOOST_INTERPROCESS_UNORDERED_MAP_INDEX_HPP
...
//!\file
//!Describes index adaptor of streams_boost::unordered_map container, to use it
...
struct is_node_index
   <streams_boost::interprocess::unordered_map_index<MapConfig> >
{
   enum {   value = true };
};
/// @endcond
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_UNORDERED_MAP_INDEX_HPP
