...
#ifndef STREAMS_BOOST_INTERPROCESS_ISET_INDEX_HPP
#define STREAMS_BOOST_INTERPROCESS_ISET_INDEX_HPP
...
//!\file
//!Describes index adaptor of streams_boost::intrusive::set container, to use it
...
struct is_intrusive_index
   <streams_boost::interprocess::iset_index<MapConfig> >
{
   enum{ value = true };
};
/// @endcond
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_ISET_INDEX_HPP
