...
#ifndef STREAMS_BOOST_INTERPROCESS_PRIVATE_ADAPTIVE_POOL_HPP
#define STREAMS_BOOST_INTERPROCESS_PRIVATE_ADAPTIVE_POOL_HPP
   ...
   >
{
   ...
   typedef streams_boost::interprocess::version_type
   ...
   /// @endcond
{
   ...
   public:
   typedef streams_boost::interprocess::version_type<private_adaptive_pool, 2>   version;
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_PRIVATE_ADAPTIVE_POOL_HPP
