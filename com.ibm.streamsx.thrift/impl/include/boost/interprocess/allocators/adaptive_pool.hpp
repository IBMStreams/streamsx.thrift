...
#ifndef STREAMS_BOOST_INTERPROCESS_ADAPTIVE_POOL_HPP
#define STREAMS_BOOST_INTERPROCESS_ADAPTIVE_POOL_HPP
...
#include <streams_boost/interprocess/allocators/detail/adaptive_node_pool.hpp>
   ...
   >
{
   ...
   STREAMS_BOOST_STATIC_ASSERT((Version <=2));
   ...
   typedef streams_boost::interprocess::version_type<adaptive_pool_base, Version>   version;
   ...
   /// @endcond
{
   ...
   #ifndef STREAMS_BOOST_INTERPROCESS_DOXYGEN_INVOKED
   typedef detail::adaptive_pool_base
         < 2, T, SegmentManager, NodesPerBlock, MaxFreeBlocks, OverheadPercent> base_t;
   public:
   typedef streams_boost::interprocess::version_type<adaptive_pool, 2>   version;
   ...
   #else //STREAMS_BOOST_INTERPROCESS_DOXYGEN_INVOKED
   public:
...
#ifdef STREAMS_BOOST_INTERPROCESS_DOXYGEN_INVOKED
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_ADAPTIVE_POOL_HPP
