...
#ifndef STREAMS_BOOST_INTERPROCESS_NODE_ALLOCATOR_HPP
#define STREAMS_BOOST_INTERPROCESS_NODE_ALLOCATOR_HPP
...
#include <streams_boost/interprocess/allocators/detail/node_pool.hpp>
   ...
   >
{
   ...
   typedef streams_boost::interprocess::version_type<node_allocator_base, Version>   version;
   ...
   /// @endcond
{
   ...
   public:
   typedef streams_boost::interprocess::version_type<node_allocator, 2>   version;
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_NODE_ALLOCATOR_HPP
