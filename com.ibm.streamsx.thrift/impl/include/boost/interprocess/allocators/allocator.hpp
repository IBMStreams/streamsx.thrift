...
#ifndef STREAMS_BOOST_INTERPROCESS_ALLOCATOR_HPP
#define STREAMS_BOOST_INTERPROCESS_ALLOCATOR_HPP
...
#include <streams_boost/interprocess/containers/version_type.hpp>
...
class allocator 
{
   ...
   typedef typename 
      streams_boost::pointer_to_other
   ...
   typedef streams_boost::interprocess::version_type<allocator, 2>   version;
   ...
   {  return this->deallocate_many(streams_boost::interprocess::move(chain)); }
...
template<class T, class SegmentManager>
struct has_trivial_destructor
   <streams_boost::interprocess::allocator <T, SegmentManager> >
{
   enum { value = true };
};
/// @endcond
...
#endif   //STREAMS_BOOST_INTERPROCESS_ALLOCATOR_HPP
