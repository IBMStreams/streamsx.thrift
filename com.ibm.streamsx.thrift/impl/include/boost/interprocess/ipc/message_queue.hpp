...
#ifndef STREAMS_BOOST_INTERPROCESS_MESSAGE_QUEUE_HPP
#define STREAMS_BOOST_INTERPROCESS_MESSAGE_QUEUE_HPP
...
class message_queue
{
   ...
   bool timed_send    (const void *buffer,     std::size_t buffer_size, 
                           unsigned int priority,  const streams_boost::posix_time::ptime& abs_time);
   ...
   /// @cond   
   private:
   typedef streams_boost::posix_time::ptime ptime;
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_MESSAGE_QUEUE_HPP
