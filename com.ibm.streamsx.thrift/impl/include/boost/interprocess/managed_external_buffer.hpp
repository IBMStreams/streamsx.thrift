...
#ifndef STREAMS_BOOST_INTERPROCESS_MANAGED_EXTERNAL_BUFFER_HPP
#define STREAMS_BOOST_INTERPROCESS_MANAGED_EXTERNAL_BUFFER_HPP
   ...
   : public detail::basic_managed_memory_impl <CharType, AllocationAlgorithm, IndexType>
{
   ...
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(basic_managed_external_buffer)
   /// @endcond
   ...
   basic_managed_external_buffer(STREAMS_BOOST_INTERPROCESS_RV_REF(basic_managed_external_buffer) moved)
   {
      this->swap(moved);
   }

   //!Moves the ownership of "moved"'s managed memory to *this. Does not throw
   basic_managed_external_buffer &operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(basic_managed_external_buffer) moved)
   {
      basic_managed_external_buffer tmp(streams_boost::interprocess::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#endif   //STREAMS_BOOST_INTERPROCESS_MANAGED_EXTERNAL_BUFFER_HPP
