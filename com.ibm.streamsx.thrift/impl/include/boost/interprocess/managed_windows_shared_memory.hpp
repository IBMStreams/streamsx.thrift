...
#ifndef STREAMS_BOOST_INTERPROCESS_MANAGED_WINDOWS_SHARED_MEMORY_HPP
#define STREAMS_BOOST_INTERPROCESS_MANAGED_WINDOWS_SHARED_MEMORY_HPP
...
#include <streams_boost/interprocess/windows_shared_memory.hpp>
      ...
      ,detail::managed_open_or_create_impl<windows_shared_memory>::ManagedOpenOrCreateUserOffset>
{
   ...
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(basic_managed_windows_shared_memory)
   /// @endcond
   ...
   //!Does not throw
   basic_managed_windows_shared_memory
      (STREAMS_BOOST_INTERPROCESS_RV_REF(basic_managed_windows_shared_memory) moved)
   {  this->swap(moved);   }

   //!Moves the ownership of "moved"'s managed memory to *this.
   //!Does not throw
   basic_managed_windows_shared_memory &operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(basic_managed_windows_shared_memory) moved)
   {
      basic_managed_windows_shared_memory tmp(streams_boost::interprocess::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#endif   //STREAMS_BOOST_INTERPROCESS_MANAGED_WINDOWS_SHARED_MEMORY_HPP
