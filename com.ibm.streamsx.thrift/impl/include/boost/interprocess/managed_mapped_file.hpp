...
#ifndef STREAMS_BOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
#define STREAMS_BOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
...
#include <streams_boost/interprocess/detail/file_wrapper.hpp>
#include <streams_boost/interprocess/detail/move.hpp>
#include <streams_boost/interprocess/file_mapping.hpp>
      ...
      ,detail::managed_open_or_create_impl<detail::file_wrapper>::ManagedOpenOrCreateUserOffset>
{
   ...
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(basic_managed_mapped_file)
   /// @endcond
   ...
   //!Does not throw
   basic_managed_mapped_file(STREAMS_BOOST_INTERPROCESS_RV_REF(basic_managed_mapped_file) moved)
   {
      this->swap(moved);
   }
   ...
   //!Moves the ownership of "moved"'s managed memory to *this.
   //!Does not throw
   basic_managed_mapped_file &operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(basic_managed_mapped_file) moved)
   {
      basic_managed_mapped_file tmp(streams_boost::interprocess::move(moved));
      this->swap(tmp);
      return *this;
   }
...
#endif   //STREAMS_BOOST_INTERPROCESS_MANAGED_MAPPED_FILE_HPP
