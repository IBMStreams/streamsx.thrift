...
#ifndef STREAMS_BOOST_INTERPROCESS_VECTORSTREAM_HPP
#define STREAMS_BOOST_INTERPROCESS_VECTORSTREAM_HPP
...
//!std::vector, streams_boost::interprocess::vector or streams_boost::interprocess::basic_string
...
//!contiguous storage, like std::vector, streams_boost::interprocess::vector or
//!streams_boost::interprocess::basic_string
template <class CharVector, class CharTraits>
...
#endif /* STREAMS_BOOST_INTERPROCESS_VECTORSTREAM_HPP */
