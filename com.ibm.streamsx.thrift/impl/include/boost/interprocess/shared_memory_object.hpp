...
#ifndef STREAMS_BOOST_INTERPROCESS_SHARED_MEMORY_OBJECT_HPP
#define STREAMS_BOOST_INTERPROCESS_SHARED_MEMORY_OBJECT_HPP
...
#if defined(STREAMS_BOOST_INTERPROCESS_XSI_SHARED_MEMORY_OBJECTS_ONLY)
#  include <sys/shm.h>      //System V shared memory...
#elif defined(STREAMS_BOOST_INTERPROCESS_POSIX_SHARED_MEMORY_OBJECTS)
...
class shared_memory_object
{
   ...
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(shared_memory_object)
   /// @endcond
   ...
   //!Does not throw
   shared_memory_object(STREAMS_BOOST_INTERPROCESS_RV_REF(shared_memory_object) moved)
   ...
   //!Does not throw
   shared_memory_object &operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(shared_memory_object) moved)
   {  
      shared_memory_object tmp(streams_boost::interprocess::move(moved));
      this->swap(tmp);
      return *this;  
   }
...
#if !defined(STREAMS_BOOST_INTERPROCESS_POSIX_SHARED_MEMORY_OBJECTS)
...
#else //!defined(STREAMS_BOOST_INTERPROCESS_POSIX_SHARED_MEMORY_OBJECTS)
...
inline bool shared_memory_object::priv_open_or_create
   (detail::create_enum_t type, 
    ...
    mode_t mode)
{
   #ifndef STREAMS_BOOST_INTERPROCESS_FILESYSTEM_BASED_POSIX_SHARED_MEMORY
...
#endif   //STREAMS_BOOST_INTERPROCESS_SHARED_MEMORY_OBJECT_HPP
