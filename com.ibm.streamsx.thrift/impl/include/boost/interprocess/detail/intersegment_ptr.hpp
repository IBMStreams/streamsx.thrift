...
#ifndef STREAMS_BOOST_INTERPROCESS_INTERSEGMENT_PTR_HPP
#define STREAMS_BOOST_INTERPROCESS_INTERSEGMENT_PTR_HPP
...
#include <streams_boost/interprocess/detail/cast_tags.hpp>
...
#include <streams_boost/interprocess/containers/flat_map.hpp>
#include <streams_boost/interprocess/containers/vector.hpp>   //vector
#include <streams_boost/interprocess/containers/set.hpp>      //set
#include <streams_boost/detail/no_exceptions_support.hpp>
#include <streams_boost/interprocess/detail/mpl.hpp>
#include <climits>
#include <iterator>
#include <streams_boost/static_assert.hpp>  //STREAMS_BOOST_STATIC_ASSERT
#include <climits>   //CHAR_BIT
#include <streams_boost/integer/static_log2.hpp>
#include <cassert>   //assert
#include <streams_boost/interprocess/detail/multi_segment_services.hpp>
...
struct intersegment_base
{
   ...
   STREAMS_BOOST_STATIC_ASSERT((sizeof(std::size_t) == sizeof(void*)));
   STREAMS_BOOST_STATIC_ASSERT((sizeof(void*)*CHAR_BIT == 32 || sizeof(void*)*CHAR_BIT == 64));
   ...
   STREAMS_BOOST_STATIC_ASSERT(((size_t_bits - pow_size_bits - frc_size_bits) >= ctrl_bits ));
   ...
   STREAMS_BOOST_STATIC_ASSERT(sizeof(members_t) == 2*sizeof(std::size_t));
   ...
   :  public intersegment_base
{
   ...
   typedef streams_boost::interprocess::flat_map
      <const void * 
      ,segment_info_t
   ...
   {
      //------------------------------------------------------------------
      streams_boost::interprocess::scoped_lock<typename mappings_t::mutex_type> lock(s_map);
      //------------------------------------------------------------------
      base = 0;
...
//! swap specialization
template<class T> inline
void swap (streams_boost::interprocess::intersegment_ptr<T> &pt, 
           streams_boost::interprocess::intersegment_ptr<T> &pt2)
{  pt.swap(pt2);  }

//!get_pointer() enables streams_boost::mem_fn to recognize intersegment_ptr. 
//!Never throws.
template<class T> inline
T * get_pointer(streams_boost::interprocess::intersegment_ptr<T> const & p)
{  return p.get();   }

//!Simulation of static_cast between pointers.
//!Never throws.
template<class T, class U> inline 
streams_boost::interprocess::intersegment_ptr<T> static_pointer_cast(const streams_boost::interprocess::intersegment_ptr<U> &r)
{  return streams_boost::interprocess::intersegment_ptr<T>(r, streams_boost::interprocess::detail::static_cast_tag());  }

//!Simulation of const_cast between pointers.
//!Never throws.
template<class T, class U> inline 
streams_boost::interprocess::intersegment_ptr<T> const_pointer_cast(const streams_boost::interprocess::intersegment_ptr<U> &r)
{  return streams_boost::interprocess::intersegment_ptr<T>(r, streams_boost::interprocess::detail::const_cast_tag());  }

//!Simulation of dynamic_cast between pointers.
//!Never throws.
template<class T, class U> inline 
streams_boost::interprocess::intersegment_ptr<T> dynamic_pointer_cast(const streams_boost::interprocess::intersegment_ptr<U> &r)
{  return streams_boost::interprocess::intersegment_ptr<T>(r, streams_boost::interprocess::detail::dynamic_cast_tag());  }

//!Simulation of reinterpret_cast between pointers.
//!Never throws.
template<class T, class U> inline
streams_boost::interprocess::intersegment_ptr<T> reinterpret_pointer_cast(const streams_boost::interprocess::intersegment_ptr<U> &r)
{  return streams_boost::interprocess::intersegment_ptr<T>(r, streams_boost::interprocess::detail::reinterpret_cast_tag());  }

//!Trait class to detect if an smart pointer has 
//!multi-segment addressing capabilities.
template <class T>
struct is_multisegment_ptr
   <streams_boost::interprocess::intersegment_ptr<T> >
{
...
#endif //#ifndef STREAMS_BOOST_INTERPROCESS_INTERSEGMENT_PTR_HPP
