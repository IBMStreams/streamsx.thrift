...
#ifndef STREAMS_BOOST_INTERPROCESS_MANAGED_MULTI_SHARED_MEMORY_HPP
#define STREAMS_BOOST_INTERPROCESS_MANAGED_MULTI_SHARED_MEMORY_HPP
...
#include <streams_boost/interprocess/containers/list.hpp>//list
#include <streams_boost/interprocess/mapped_region.hpp> //mapped_region
#include <streams_boost/interprocess/shared_memory_object.hpp>
#include <streams_boost/interprocess/detail/managed_open_or_create_impl.hpp> //managed_open_or_create_impl
#include <new>
#include <streams_boost/interprocess/containers/string.hpp>
#include <streams_boost/interprocess/streams/vectorstream.hpp>
#include <memory>
 ...
 public:
                          ...
                          const void *addr)
   {
      STREAMS_BOOST_TRY{
         ...
         streams_boost::interprocess::basic_ovectorstream<streams_boost::interprocess::string> formatter;
         ...
         switch(type){
            case create_open_func::DoCreate:
            {
               ...
               mshm = streams_boost::interprocess::move(shm);
            }
            break;
         ...
         //This can throw.
         m_shmem_list.push_back(streams_boost::interprocess::move(mshm));
         return true;
      }
      STREAMS_BOOST_CATCH(const std::bad_alloc&){
      }
...
#endif   //STREAMS_BOOST_INTERPROCESS_MANAGED_MULTI_SHARED_MEMORY_HPP
