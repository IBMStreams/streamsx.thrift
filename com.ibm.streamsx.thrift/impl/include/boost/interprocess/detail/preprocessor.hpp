...
#ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_PREPROCESSOR_HPP
#define STREAMS_BOOST_INTERPROCESS_DETAIL_PREPROCESSOR_HPP
...
#define STREAMS_BOOST_INTERPROCESS_MAX_CONSTRUCTOR_PARAMETERS 10
...
//bind rvalues with non-const references, we have to be ugly
   ...
   #define STREAMS_BOOST_INTERPROCESS_PP_PARAM_LIST(z, n, data) \
...
#ifdef STREAMS_BOOST_HAS_RVALUE_REFS
   #define STREAMS_BOOST_INTERPROCESS_PARAM(U, u) \
   U && u \
   //!
#else
   #define STREAMS_BOOST_INTERPROCESS_PARAM(U, u) \
...
#ifdef STREAMS_BOOST_HAS_RVALUE_REFS
#define STREAMS_BOOST_INTERPROCESS_AUX_PARAM_INIT(z, n, data) \
...
#define STREAMS_BOOST_INTERPROCESS_AUX_PARAM_INC(z, n, data)   \
  STREAMS_BOOST_PP_CAT(++m_p, n)                        \
//!

#ifdef STREAMS_BOOST_HAS_RVALUE_REFS
#define STREAMS_BOOST_INTERPROCESS_AUX_PARAM_DEFINE(z, n, data)  \
...
#define STREAMS_BOOST_INTERPROCESS_PP_PARAM_FORWARD(z, n, data) \
streams_boost::interprocess::forward< STREAMS_BOOST_PP_CAT(P, n) >( STREAMS_BOOST_PP_CAT(p, n) ) \
//!

#define STREAMS_BOOST_INTERPROCESS_PP_MEMBER_FORWARD(z, n, data) \
streams_boost::interprocess::forward< STREAMS_BOOST_PP_CAT(P, n) >( STREAMS_BOOST_PP_CAT(m_p, n) ) \
//!

#define STREAMS_BOOST_INTERPROCESS_PP_MEMBER_IT_FORWARD(z, n, data) \
STREAMS_BOOST_PP_CAT(*m_p, n) \
//!
...
#error "This file is not needed when perfect forwarding is available"
#endif
#endif //#ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_PREPROCESSOR_HPP
