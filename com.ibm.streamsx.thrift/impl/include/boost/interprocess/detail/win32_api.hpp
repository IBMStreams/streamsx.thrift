...
#ifndef STREAMS_BOOST_INTERPROCESS_WIN32_SYNC_PRIMITIVES_HPP
#define STREAMS_BOOST_INTERPROCESS_WIN32_SYNC_PRIMITIVES_HPP
...
#else
#  include <windows.h>
#endif   //#if !defined( STREAMS_BOOST_USE_WINDOWS_H )
...
{  return STREAMS_BOOST_INTERLOCKED_INCREMENT(addr);  }

inline long interlocked_decrement(long volatile *addr)
{  return STREAMS_BOOST_INTERLOCKED_DECREMENT(addr);  }

inline long interlocked_compare_exchange(long volatile *addr, long val1, long val2)
{  return STREAMS_BOOST_INTERLOCKED_COMPARE_EXCHANGE(addr, val1, val2);  }

inline long interlocked_exchange_add(long volatile* addend, long value)
{  return STREAMS_BOOST_INTERLOCKED_EXCHANGE_ADD(const_cast<long*>(addend), value);  }

inline long interlocked_exchange(long volatile* addend, long value)
{  return STREAMS_BOOST_INTERLOCKED_EXCHANGE(const_cast<long*>(addend), value);  }
...
#endif //#ifdef STREAMS_BOOST_INTERPROCESS_WIN32_SYNC_PRIMITIVES_HPP
