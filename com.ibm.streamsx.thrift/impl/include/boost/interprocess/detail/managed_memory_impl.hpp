...
#ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_MANAGED_MEMORY_IMPL_HPP
#define STREAMS_BOOST_INTERPROCESS_DETAIL_MANAGED_MEMORY_IMPL_HPP
...
#include <streams_boost/interprocess/mem_algo/rbtree_best_fit.hpp>
#include <streams_boost/interprocess/sync/mutex_family.hpp>
...
#include <streams_boost/interprocess/segment_manager.hpp>
...
class basic_managed_memory_impl
{
   ...
   //!memory is available throws a streams_boost::interprocess::bad_alloc exception
   ...
   {  return mp_header->deallocate_many(streams_boost::interprocess::move(chain)); }
   ...
   //!
   //!-> Throws streams_boost::interprocess::bad_alloc if there is no available memory 
   //!
...
#endif   //STREAMS_BOOST_INTERPROCESS_DETAIL_MANAGED_MEMORY_IMPL_HPP
