...
#ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
#define STREAMS_BOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
...
inline streams_boost::uint32_t atomic_inc32(volatile streams_boost::uint32_t *mem);

//! Atomically read an streams_boost::uint32_t from memory
inline streams_boost::uint32_t atomic_read32(volatile streams_boost::uint32_t *mem);

//! Atomically set an streams_boost::uint32_t in memory
//! "mem": pointer to the object
//! "param": val value that the object will assume
inline void atomic_write32(volatile streams_boost::uint32_t *mem, streams_boost::uint32_t val);

//! Compare an streams_boost::uint32_t's value with "cmp".
//! If they are the same swap the value with "with"
//! "mem": pointer to the value
//! "with": what to swap it with
//! "cmp": the value to compare it to
//! Returns the old value of *mem
inline streams_boost::uint32_t atomic_cas32
   (volatile streams_boost::uint32_t *mem, streams_boost::uint32_t with, streams_boost::uint32_t cmp);
...
//! Atomically decrement an streams_boost::uint32_t by 1
//! "mem": pointer to the atomic value
//! Returns the old value pointed to by mem
inline streams_boost::uint32_t atomic_dec32(volatile streams_boost::uint32_t *mem)
...
inline streams_boost::uint32_t atomic_cas32
   (volatile streams_boost::uint32_t *mem, streams_boost::uint32_t with, streams_boost::uint32_t cmp)
{
   streams_boost::uint32_t prev = cmp;
   asm volatile( "lock\n\t"
                 "cmpxchg %3,%1"
               : "=a" (prev), "=m" (*(mem))
               : "0" (prev), "r" (with)
...
//! Atomically add 'val' to an streams_boost::uint32_t
//! "mem": pointer to the object
//! "val": amount to add
//! Returns the old value pointed to by mem
inline streams_boost::uint32_t atomic_add32
   (volatile streams_boost::uint32_t *mem, streams_boost::uint32_t val)
{
   // int r = *pw;
   // *mem += val;
   // return r;
...
//! Returns the old value pointed to by mem
inline streams_boost::uint32_t atomic_dec32(volatile streams_boost::uint32_t *mem)
{  return atomic_add32(mem, (streams_boost::uint32_t)-1);  }
...
//! "val": amount to add
//! Returns the old value pointed to by mem
inline streams_boost::uint32_t atomic_add32(volatile streams_boost::uint32_t *mem, streams_boost::uint32_t val)
{
   streams_boost::uint32_t prev, temp;
...
//! Returns the old value pointed to by mem
inline streams_boost::uint32_t atomic_dec32(volatile streams_boost::uint32_t *mem)
{  return atomic_add32(mem, streams_boost::uint32_t(-1u));  }
...
inline streams_boost::uint32_t atomic_add32
   (volatile streams_boost::uint32_t *mem, streams_boost::uint32_t val)
{  return __sync_fetch_and_add(const_cast<streams_boost::uint32_t *>(mem), val);   }
...
inline streams_boost::uint32_t atomic_cas32
   (volatile streams_boost::uint32_t *mem, streams_boost::uint32_t with, streams_boost::uint32_t cmp)
{  return __sync_val_compare_and_swap(const_cast<streams_boost::uint32_t *>(mem), cmp, with);   }
...
//! Returns the old value pointed to by mem
inline streams_boost::uint32_t atomic_dec32(volatile streams_boost::uint32_t *mem)
{  return atomic_add_32_nv(reinterpret_cast<volatile ::uint32_t*>(mem), (streams_boost::uint32_t)-1) + 1; }
...
inline streams_boost::uint32_t atomic_dec32(volatile streams_boost::uint32_t *mem)
{  streams_boost::uint32_t old_val = __ATOMIC_DECREMENT_LONG(mem); __MB(); return old_val; }
...
inline streams_boost::uint32_t atomic_read32(volatile streams_boost::uint32_t *mem)
{  streams_boost::uint32_t old_val = *mem; __MB(); return old_val;  }
...
//first define streams_boost::uint32_t versions of __lwarx and __stwcx to avoid poluting  
...
inline streams_boost::uint32_t lwarxu(volatile streams_boost::uint32_t *mem)  
{  
   return static_cast<streams_boost::uint32_t>(__lwarx(reinterpret_cast<volatile int*>(mem)));  
}  
...
//!unsuccessful  
inline bool stwcxu(volatile streams_boost::uint32_t* mem, streams_boost::uint32_t val)  
{  
...
inline streams_boost::uint32_t atomic_add32  
   (volatile streams_boost::uint32_t *mem, streams_boost::uint32_t val)  
{  
   streams_boost::uint32_t oldValue;  
   do  
   {  
      oldValue = lwarxu(mem);  
...
{  
   streams_boost::uint32_t oldValue;  
   streams_boost::uint32_t valueToStore;  
   do  
   {  
      oldValue = lwarxu(mem);  
...
inline bool atomic_add_unless32
   (volatile streams_boost::uint32_t *mem, streams_boost::uint32_t value, volatile streams_boost::uint32_t unless_this)
{
   streams_boost::uint32_t old, c(atomic_read32(mem));
...
#endif   //STREAMS_BOOST_INTERPROCESS_DETAIL_ATOMIC_HPP
