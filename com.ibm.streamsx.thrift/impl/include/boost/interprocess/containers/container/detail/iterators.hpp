...
#ifndef STREAMS_BOOST_CONTAINERS_DETAIL_ITERATORS_HPP
#define STREAMS_BOOST_CONTAINERS_DETAIL_ITERATORS_HPP
...
struct emplace_functor
{
   ...
   {  ::new(ptr) T(streams_boost::interprocess::forward<Args>(containers_detail::get<IdxPack>(args_))...); }
...
#define STREAMS_BOOST_PP_LOCAL_MACRO(n)                                                        \
   template <class T, STREAMS_BOOST_PP_ENUM_PARAMS(n, class P) >                               \
   struct STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_CAT(emplace_functor, n), arg)                          \
   {                                                                                   \
      STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_CAT(emplace_functor, n), arg)                              \
         ( STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _) )                       \
      :  STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_AUX_PARAM_INIT, _) {}                       \
                                                                                       \
      void operator()(T *ptr)                                                          \
      {                                                                                \
         new(ptr)T (STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_MEMBER_FORWARD, _));          \
      }                                                                                \
...
#endif   //#ifndef STREAMS_BOOST_CONTAINERS_DETAIL_ITERATORS_HPP
