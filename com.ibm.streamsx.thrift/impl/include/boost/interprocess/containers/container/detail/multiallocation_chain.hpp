...
#ifndef STREAMS_BOOST_CONTAINERS_DETAIL_MULTIALLOCATION_CHAIN_HPP
#define STREAMS_BOOST_CONTAINERS_DETAIL_MULTIALLOCATION_CHAIN_HPP
...
#include <streams_boost/interprocess/containers/container/detail/transform_iterator.hpp>
...
class basic_multiallocation_chain
{
   ...
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(basic_multiallocation_chain)
   ...
   basic_multiallocation_chain(STREAMS_BOOST_INTERPROCESS_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_()
   {  slist_impl_.swap(other.slist_impl_); }

   basic_multiallocation_chain& operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(basic_multiallocation_chain) other)
   {
      basic_multiallocation_chain tmp(streams_boost::interprocess::move(other));
      this->swap(tmp);
      return *this;
   }
...
{
   private:
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(transform_multiallocation_chain)
   ...
   transform_multiallocation_chain(STREAMS_BOOST_INTERPROCESS_RV_REF(transform_multiallocation_chain) other)
      : holder_()
   {  this->swap(other); }

   transform_multiallocation_chain(STREAMS_BOOST_INTERPROCESS_RV_REF(MultiallocationChain) other)
      : holder_(streams_boost::interprocess::move(other))
   {}

   transform_multiallocation_chain& operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(transform_multiallocation_chain) other)
   {
      transform_multiallocation_chain tmp(streams_boost::interprocess::move(other));
      this->swap(tmp);
      return *this;
   }
   ...
   {
      return MultiallocationChain(streams_boost::interprocess::move(holder_));
   }
};
...
#endif   //STREAMS_BOOST_CONTAINERS_DETAIL_MULTIALLOCATION_CHAIN_HPP
