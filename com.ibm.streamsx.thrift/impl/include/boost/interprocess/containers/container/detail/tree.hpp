 ...
 *
 */
#ifndef STREAMS_BOOST_CONTAINERS_TREE_HPP
#define STREAMS_BOOST_CONTAINERS_TREE_HPP
...
#include <streams_boost/intrusive/rbtree.hpp>
...
#include <streams_boost/interprocess/containers/container/detail/node_alloc_holder.hpp>
   ...
   :  public rbtree_hook<VoidPointer>::type
{
   ...
   rbtree_node(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _))                        \
      : m_data(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _))                     \
   {}                                                                                        \
   //!
   ...
   #else //#ifndef STREAMS_BOOST_CONTAINERS_PERFECT_FORWARDING
   ...
   rbtree_node(Args &&...args)
      : m_data(streams_boost::interprocess::forward<Args>(args)...)
   {}
   #endif//#ifndef STREAMS_BOOST_CONTAINERS_PERFECT_FORWARDING
   ...
   static void construct(node_type *ptr, STREAMS_BOOST_INTERPROCESS_FWD_REF(Convertible) convertible)
   {  new(ptr) node_type(streams_boost::interprocess::forward<Convertible>(convertible));  }
};
...
struct has_own_construct_from_it
   < streams_boost::container::containers_detail::rbtree_node<T, VoidPointer> >
{
...
//         if(!m_icont.empty()){
   ...
   STREAMS_BOOST_COPYABLE_AND_MOVABLE(rbtree)
   ...
   rbtree(STREAMS_BOOST_INTERPROCESS_RV_REF(rbtree) x) 
      :  AllocHolder(x, x.key_comp())
   {  this->swap(x);  }
   ...
   rbtree& operator=(STREAMS_BOOST_INTERPROCESS_COPY_ASSIGN_REF(rbtree) x)
   {
      if (this != &x) {
   ...
   rbtree& operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(rbtree) mx)
   ...
   iterator insert_unique_commit
      (STREAMS_BOOST_INTERPROCESS_FWD_REF(MovableConvertible) mv, insert_commit_data &data)
   {
      NodePtr tmp = AllocHolder::create_node(streams_boost::interprocess::forward<MovableConvertible>(mv));
      iiterator it(this->icont().insert_unique_commit(*tmp, data));
      return iterator(it);
   }
   ...
   template<class MovableConvertible>
   std::pair<iterator,bool> insert_unique(STREAMS_BOOST_INTERPROCESS_FWD_REF(MovableConvertible) mv)
   {
      insert_commit_data data;
      std::pair<iterator,bool> ret =
      ...
      if(!ret.second)
         return ret;
      return std::pair<iterator,bool>
         (this->insert_unique_commit(streams_boost::interprocess::forward<MovableConvertible>(mv), data), true);
   }
   ...
   {  return this->emplace_unique_impl(AllocHolder::create_node(streams_boost::interprocess::forward<Args>(args)...));   }

   template <class... Args>
   iterator emplace_hint_unique(const_iterator hint, Args&&... args)
   {  return this->emplace_unique_hint_impl(hint, AllocHolder::create_node(streams_boost::interprocess::forward<Args>(args)...));   }

   template <class... Args>
   iterator emplace_equal(Args&&... args)
   {
      NodePtr p(AllocHolder::create_node(streams_boost::interprocess::forward<Args>(args)...));
   ...
   #define STREAMS_BOOST_PP_LOCAL_MACRO(n)                                                                          \
   template<STREAMS_BOOST_PP_ENUM_PARAMS(n, class P)>                                                               \
   iterator emplace_unique(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _))                           \
   {                                                                                                        \
      return this->emplace_unique_impl                                                                      \
         (AllocHolder::create_node(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _)));              \
   }                                                                                                        \
                                                                                                            \
   template<STREAMS_BOOST_PP_ENUM_PARAMS(n, class P)>                                                               \
   iterator emplace_hint_unique(const_iterator hint, STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _)) \
   {                                                                                                        \
      return this->emplace_unique_hint_impl                                                                 \
         (hint, AllocHolder::create_node(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _)));        \
   }                                                                                                        \
                                                                                                            \
   template<STREAMS_BOOST_PP_ENUM_PARAMS(n, class P)>                                                               \
   iterator emplace_equal(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _))                            \
   {                                                                                                        \
      NodePtr p(AllocHolder::create_node(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _)));        \
      return iterator(this->icont().insert_equal(this->icont().end(), *p));                                 \
   }                                                                                                        \
                                                                                                            \
   template<STREAMS_BOOST_PP_ENUM_PARAMS(n, class P)>                                                               \
   iterator emplace_hint_equal(const_iterator hint, STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _))  \
   {                                                                                                        \
      NodePtr p(AllocHolder::create_node(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _)));        \
      return iterator(this->icont().insert_equal(hint.get(), *p));                                          \
   }                                                                                                        \
   ...
   template<class MovableConvertible>
   iterator insert_unique(const_iterator hint, STREAMS_BOOST_INTERPROCESS_FWD_REF(MovableConvertible) mv)
   {
      insert_commit_data data;
      std::pair<iterator,bool> ret =
      ...
      if(!ret.second)
         return ret.first;
      return this->insert_unique_commit(streams_boost::interprocess::forward<MovableConvertible>(mv), data);
   }
   ...
   template<class MovableConvertible>
   iterator insert_equal(STREAMS_BOOST_INTERPROCESS_FWD_REF(MovableConvertible) mv)
   {
      NodePtr p(AllocHolder::create_node(streams_boost::interprocess::forward<MovableConvertible>(mv)));
      return iterator(this->icont().insert_equal(this->icont().end(), *p));
   }
   ...
   template<class MovableConvertible>
   iterator insert_equal(const_iterator hint, STREAMS_BOOST_INTERPROCESS_FWD_REF(MovableConvertible) mv)
   {
      NodePtr p(AllocHolder::create_node(streams_boost::interprocess::forward<MovableConvertible>(mv)));
      return iterator(this->icont().insert_equal(hint.get(), *p));
   }
...
struct has_trivial_destructor_after_move
   <streams_boost::container::containers_detail::rbtree<K, V, KOV, C, A> >
{
...
#endif //STREAMS_BOOST_CONTAINERS_TREE_HPP
