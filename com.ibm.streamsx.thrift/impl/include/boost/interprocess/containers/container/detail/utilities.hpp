...
#ifndef STREAMS_BOOST_CONTAINERS_DETAIL_UTILITIES_HPP
#define STREAMS_BOOST_CONTAINERS_DETAIL_UTILITIES_HPP
...
struct move_const_ref_type
   : if_c
   < ::streams_boost::is_fundamental<T>::value || ::streams_boost::is_pointer<T>::value
   ,const T &
   ,STREAMS_BOOST_INTERPROCESS_CATCH_CONST_RLVALUE(T)
   >
{};
...
#endif   //#ifndef STREAMS_BOOST_CONTAINERS_DETAIL_UTILITIES_HPP
