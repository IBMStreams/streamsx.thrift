...
#ifndef STREAMS_BOOST_CONTAINERS_DETAIL_ALGORITHMS_HPP
#define STREAMS_BOOST_CONTAINERS_DETAIL_ALGORITHMS_HPP
...
{
   static const bool value = streams_boost::has_trivial_assign<T>::value;
};
...
{
   static const bool value = streams_boost::has_trivial_copy<T>::value;
};
...
#endif   //#ifndef STREAMS_BOOST_CONTAINERS_DETAIL_ALGORITHMS_HPP
