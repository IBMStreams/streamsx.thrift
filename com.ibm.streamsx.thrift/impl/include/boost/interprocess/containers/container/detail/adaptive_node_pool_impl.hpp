...
#ifndef STREAMS_BOOST_CONTAINER_DETAIL_ADAPTIVE_NODE_POOL_IMPL_HPP
#define STREAMS_BOOST_CONTAINER_DETAIL_ADAPTIVE_NODE_POOL_IMPL_HPP
...
#include <streams_boost/interprocess/containers/container/detail/math_functions.hpp>
#include <streams_boost/interprocess/containers/container/detail/mpl.hpp>
#include <streams_boost/interprocess/containers/container/detail/pool_common.hpp>
#include <cassert>
#include <cstddef>
...
class private_adaptive_node_pool_impl
{
   ...
   multiallocation_chain allocate_nodes(const std::size_t n)
   {
      ...
      try{
         ...
         this->deallocate_nodes(streams_boost::interprocess::move(chain));
         throw;
      }
      priv_invariants();
   ...
   //#define STREAMS_BOOST_CONTAINER_ADAPTIVE_NODE_POOL_CHECK_INVARIANTS
   void priv_invariants()
   #ifdef STREAMS_BOOST_CONTAINER_ADAPTIVE_NODE_POOL_CHECK_INVARIANTS
   #undef STREAMS_BOOST_CONTAINER_ADAPTIVE_NODE_POOL_CHECK_INVARIANTS
   {
