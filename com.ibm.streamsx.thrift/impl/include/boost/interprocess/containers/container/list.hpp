...
#ifndef STREAMS_BOOST_CONTAINERS_LIST_HPP_
#define STREAMS_BOOST_CONTAINERS_LIST_HPP_
...
#include <streams_boost/intrusive/list.hpp>
   ...
   :  public list_hook<VoidPointer>::type
{
   ...
   list_node(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _))                          \
      ...
      <A, typename containers_detail::intrusive_list_type<A>::type>
{
   ...
   /// @cond
   private:
   STREAMS_BOOST_COPYABLE_AND_MOVABLE(list)
   ...
   //! 
   //! <b>Complexity</b>: Constant.
   list(STREAMS_BOOST_INTERPROCESS_RV_REF(list) x)
      : AllocHolder(streams_boost::interprocess::move(static_cast<AllocHolder&>(x)))
   {}
   ...
   //!
   //! <b>Complexity</b>: Amortized constant time.
   void push_front(STREAMS_BOOST_INTERPROCESS_RV_REF(T) x)
   {  this->insert(this->cbegin(), streams_boost::interprocess::move(x));  }
   ...
   ThisType& operator=(STREAMS_BOOST_INTERPROCESS_COPY_ASSIGN_REF(ThisType) x)
   {
      if (this != &x) {
   ...
   //!
   //! <b>Complexity</b>: Constant.
   ThisType& operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(ThisType) mx)
   {
      this->clear();
      this->swap(mx);
      return *this;
   ...
   //!
   //! <b>Complexity</b>: Amortized constant time.
   iterator insert(const_iterator p, STREAMS_BOOST_INTERPROCESS_RV_REF(T) x) 
   {
      NodePtr tmp = AllocHolder::create_node(streams_boost::interprocess::move(x));
   ...
   {
      this->emplace(this->cend(), streams_boost::interprocess::forward<Args>(args)...);
   }
   ...
   {
      this->emplace(this->cbegin(), streams_boost::interprocess::forward<Args>(args)...);
   }
   ...
   iterator emplace(const_iterator p, Args&&... args)
   {
      ...
      new ((void*)containers_detail::get_pointer(d.get())) Node(streams_boost::interprocess::forward<Args>(args)...);
      NodePtr node = d.get();
      d.release();
   ...
   {                                                                                            \
      this->emplace(this->cend(), STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _));    \
   }                                                                                            \
                                                                                                \
   template<STREAMS_BOOST_PP_ENUM_PARAMS(n, class P)>                                                   \
   void emplace_front(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_LIST, _))                    \
   {  this->emplace(this->cbegin(), STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _));} \
                                                                                                \
   template<STREAMS_BOOST_PP_ENUM_PARAMS(n, class P)>                                                   \
   ...
   {                                                                                            \
      ...
      new ((void*)containers_detail::get_pointer(d.get()))                                                 \
         Node(STREAMS_BOOST_PP_ENUM(n, STREAMS_BOOST_CONTAINERS_PP_PARAM_FORWARD, _));                        \
      NodePtr node = d.get();                                                                   \
      d.release();                                                                              \
      return iterator(this->icont().insert(p.get(), *node));                                    \
   }                                                                                            \
...
template <class T, class A>
struct has_trivial_destructor_after_move<streams_boost::container::list<T, A> >
{
...
#endif // STREAMS_BOOST_CONTAINERS_LIST_HPP_
