...
#ifndef STREAMS_BOOST_INTERPROCESS_UNIQUE_PTR_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_UNIQUE_PTR_HPP_INCLUDED
...
#include <streams_boost/interprocess/detail/pointer_type.hpp>
...
class unique_ptr
{
   ...
   //!   streams_boost::interprocess::forward<D>. -end note ]
   //!
   ...
   //!
   //!Throws: nothing.
   unique_ptr(STREAMS_BOOST_INTERPROCESS_RV_REF(unique_ptr) u)
      : ptr_(u.release(), streams_boost::interprocess::forward<D>(u.get_deleter()))
   {}
   ...
   unique_ptr(STREAMS_BOOST_INTERPROCESS_RV_REF_2_TEMPL_ARGS(unique_ptr, U, E) u,
      typename detail::enable_if_c<
            ...
            nat
            >::type = nat())
      : ptr_(const_cast<unique_ptr<U,E>&>(u).release(), streams_boost::interprocess::move<D>(u.get_deleter()))
   {}
   ...
   //!
   //!Throws: nothing.
   unique_ptr& operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(unique_ptr) u)
   {
      reset(u.release());
      ptr_.second() = streams_boost::interprocess::move(u.get_deleter());
      return *this;
   }
   ...
   //!Throws: nothing.
   template <class U, class E>
   unique_ptr& operator=(STREAMS_BOOST_INTERPROCESS_RV_REF_2_TEMPL_ARGS(unique_ptr, U, E) u)
   {
      reset(u.release());
      ptr_.second() = streams_boost::interprocess::move(u.get_deleter());
      return *this;
   ...
   /// @cond
   private:
   streams_boost::compressed_pair<pointer, D> ptr_;
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(unique_ptr)
...
private:
    ...
    template <class U, class E> unique_ptr(U p, E,
        typename streams_boost::enable_if<streams_boost::is_convertible<U, pointer> >::type* = 0);
...
//!of type T with streams_boost::interprocess::deleter deleter
...
//!with streams_boost::interproces::deleter from a pointer
...
#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_UNIQUE_PTR_HPP_INCLUDED
