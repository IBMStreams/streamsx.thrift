//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of streams_boost/weak_ptr.hpp
//
...
#ifndef STREAMS_BOOST_INTERPROCESS_WEAK_PTR_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_WEAK_PTR_HPP_INCLUDED

#include <streams_boost/interprocess/detail/config_begin.hpp>
#include <streams_boost/interprocess/detail/workaround.hpp>

#include <streams_boost/interprocess/smart_ptr/shared_ptr.hpp>
...
class weak_ptr
{
   ...
   shared_ptr<T, A, D> lock() const // never throws
   {
      ...
      STREAMS_BOOST_CATCH(bad_weak_ptr const &){
...
#endif  // #ifndef STREAMS_BOOST_INTERPROCESS_WEAK_PTR_HPP_INCLUDED
