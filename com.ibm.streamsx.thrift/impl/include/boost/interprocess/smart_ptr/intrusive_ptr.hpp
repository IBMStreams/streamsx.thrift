//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of streams_boost/intrusive_ptr.hpp
//
...
#ifndef STREAMS_BOOST_INTERPROCESS_INTRUSIVE_PTR_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_INTRUSIVE_PTR_HPP_INCLUDED
...
class intrusive_ptr
{
   ...
   typedef typename streams_boost::pointer_to_other<VoidPointer, T>::type pointer;
...
inline typename streams_boost::interprocess::intrusive_ptr<T, VP>::pointer
...
inline streams_boost::interprocess::intrusive_ptr<T, VP> static_pointer_cast
   (streams_boost::interprocess::intrusive_ptr<U, VP> const & p)
{  return do_static_cast<U>(p.get());  }
*/
/*Emulates const cast operator. Does not throw*/
/*
template<class T, class U, class VP>
inline streams_boost::interprocess::intrusive_ptr<T, VP> const_pointer_cast
   (streams_boost::interprocess::intrusive_ptr<U, VP> const & p)
...
/*
template<class T, class U, class VP>
inline streams_boost::interprocess::intrusive_ptr<T, VP> dynamic_pointer_cast
   (streams_boost::interprocess::intrusive_ptr<U, VP> const & p)
...
/*
template<class T, class U, class VP>
inline streams_boost::interprocess::intrusive_ptr<T, VP>reinterpret_pointer_cast
   (streams_boost::interprocess::intrusive_ptr<U, VP> const & p)
...
//!Does not throw
template<class T, class VP>
inline T *get_pointer(streams_boost::interprocess::intrusive_ptr<T, VP> p)
{  return p.get();   }
#endif
...
#endif  // #ifndef STREAMS_BOOST_INTERPROCESS_INTRUSIVE_PTR_HPP_INCLUDED
