//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of streams_boost/scoped_ptr.hpp
//
...
#ifndef STREAMS_BOOST_INTERPROCESS_SCOPED_PTR_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_SCOPED_PTR_HPP_INCLUDED
...
//            <typename Deleter::pointer, T>::type pointer;
   ...
   {  STREAMS_BOOST_ASSERT(p == 0 || p != m_ptr); this_type(p).swap(*this);  }
   ...
   {  STREAMS_BOOST_ASSERT(m_ptr != 0);  return *m_ptr; }
...
template<class T, class D> inline
T *get_pointer(streams_boost::interprocess::scoped_ptr<T, D> const & p)
{  return p.get();   }
#endif
...
#endif // #ifndef STREAMS_BOOST_INTERPROCESS_SCOPED_PTR_HPP_INCLUDED
