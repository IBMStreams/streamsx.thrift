//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of streams_boost/enable_shared_from_this.hpp
//
...
#ifndef STREAMS_BOOST_INTERPROCESS_ENABLE_SHARED_FROM_THIS_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_ENABLE_SHARED_FROM_THIS_HPP_INCLUDED
...
#include <streams_boost/interprocess/smart_ptr/weak_ptr.hpp>
...
class enable_shared_from_this
{
   ...
   shared_ptr<T, A, D> shared_from_this()
   {
      ...
      STREAMS_BOOST_ASSERT(detail::get_pointer(p.get()) == this);
      return p;
   }
...
#endif  // #ifndef STREAMS_BOOST_INTERPROCESS_ENABLE_SHARED_FROM_THIS_HPP_INCLUDED
