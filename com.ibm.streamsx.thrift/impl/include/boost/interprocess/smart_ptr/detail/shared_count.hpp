//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of streams_boost/detail/shared_count.hpp
//
...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_SHARED_COUNT_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_DETAIL_SHARED_COUNT_HPP_INCLUDED
...
#include <streams_boost/interprocess/smart_ptr/detail/bad_weak_ptr.hpp>
#include <streams_boost/interprocess/smart_ptr/detail/sp_counted_impl.hpp>
...
/*
      ...
      : m_pi( r.m_pi )
   {
      if( m_pi == 0 || !m_pi->add_ref_lock() ){
         streams_boost::throw_exception( streams_boost::interprocess::bad_weak_ptr() );
      }
   }
*/
   template<class Y>
   ...
   {
      if( m_pi == 0 || !m_pi->add_ref_lock() ){
         throw( streams_boost::interprocess::bad_weak_ptr() );
      }
   }
...
#endif  // #ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_SHARED_COUNT_HPP_INCLUDED
