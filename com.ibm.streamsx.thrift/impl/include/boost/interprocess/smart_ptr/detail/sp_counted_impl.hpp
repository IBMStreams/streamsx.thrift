#ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_SP_COUNTED_IMPL_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_DETAIL_SP_COUNTED_IMPL_HPP_INCLUDED
...
//  files of streams_boost/detail/sp_counted_impl.hpp
//
...
#include <streams_boost/interprocess/smart_ptr/detail/sp_counted_base.hpp>
#include <streams_boost/interprocess/smart_ptr/scoped_ptr.hpp>
...
struct scoped_ptr_dealloc_functor
{
   ...
   typedef detail::integral_constant<unsigned,
      streams_boost::interprocess::version<Allocator>::value>                   alloc_version;
   ...
   ,  D  // copy constructor must not throw
{
   ...
   void destroy() // nothrow
   {
      ...
      STREAMS_BOOST_ASSERT(a_copy == *this);
...
#endif  // #ifndef STREAMS_BOOST_INTERPROCESS_DETAIL_SP_COUNTED_IMPL_HPP_INCLUDED
