//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of streams_boost/shared_ptr.hpp
//
...
#ifndef STREAMS_BOOST_INTERPROCESS_SHARED_PTR_HPP_INCLUDED
#define STREAMS_BOOST_INTERPROCESS_SHARED_PTR_HPP_INCLUDED
...
#include <streams_boost/interprocess/smart_ptr/detail/shared_count.hpp>
...
class shared_ptr
{
   ...
   STREAMS_BOOST_COPYABLE_AND_MOVABLE(shared_ptr)
   public:
   ...
   {  
      ...
      typedef typename streams_boost::pointer_to_other<pointer, T>::type ParameterPointer;
      STREAMS_BOOST_STATIC_ASSERT((detail::is_same<pointer, ParameterPointer>::value) ||
   ...
   //!Throws: nothing.
   explicit shared_ptr(STREAMS_BOOST_INTERPROCESS_RV_REF(shared_ptr) other)
      :  m_pn()
   {  this->swap(other);   }
   ...
   //!Equivalent to shared_ptr(r).swap(*this).
   //!Never throws
   shared_ptr & operator=(STREAMS_BOOST_INTERPROCESS_COPY_ASSIGN_REF(shared_ptr) r)
   {
      m_pn = r.m_pn; // shared_count::op= doesn't throw
      return *this;
   }
   ...
   //!Never throws
   shared_ptr & operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(shared_ptr) other) // never throws
   {
   ...
   {  STREAMS_BOOST_ASSERT(m_pn.get_pointer() != 0);  return *m_pn.get_pointer(); }
...
//!of type T with the allocator streams_boost::interprocess::allocator allocator
//!and streams_boost::interprocess::deleter deleter
...
// get_pointer() enables streams_boost::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
T * get_pointer(streams_boost::interprocess::shared_ptr<T, VoidAllocator, Deleter> const & p)
{  return p.get();   }
#endif
...
#endif  // #ifndef STREAMS_BOOST_INTERPROCESS_SHARED_PTR_HPP_INCLUDED
