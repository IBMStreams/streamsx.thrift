...
#ifndef STREAMS_BOOST_INTERPROCESS_FILE_MAPPING_HPP
#define STREAMS_BOOST_INTERPROCESS_FILE_MAPPING_HPP
...
{
   /// @cond
   STREAMS_BOOST_INTERPROCESS_MOVABLE_BUT_NOT_COPYABLE(file_mapping)
   /// @endcond
   ...
   //!Does not throw
   file_mapping(STREAMS_BOOST_INTERPROCESS_RV_REF(file_mapping) moved)
   ...
   //!Does not throw
   file_mapping &operator=(STREAMS_BOOST_INTERPROCESS_RV_REF(file_mapping) moved)
   {
      file_mapping tmp(streams_boost::interprocess::move(moved));
      this->swap(tmp);
      return *this;  
   }
...
#endif   //STREAMS_BOOST_INTERPROCESS_FILE_MAPPING_HPP
