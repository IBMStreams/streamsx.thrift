...
#ifndef STREAMS_BOOST_INTERPROCESS_POSIX_SEMAPHORE_WRAPPER_STREAMS_HPP
#define STREAMS_BOOST_INTERPROCESS_POSIX_SEMAPHORE_WRAPPER_STREAMS_HPP
...
#ifdef SEM_FAILED
#define STREAMS_BOOST_INTERPROCESS_POSIX_SEM_FAILED (reinterpret_cast<sem_t*>(SEM_FAILED))
#else
#define STREAMS_BOOST_INTERPROCESS_POSIX_SEM_FAILED (reinterpret_cast<sem_t*>(-1))
#endif
...
{
   std::string name;
   #ifndef STREAMS_BOOST_INTERPROCESS_FILESYSTEM_BASED_POSIX_SEMAPHORES
   ...
   //Check for error
   if(handle == STREAMS_BOOST_INTERPROCESS_POSIX_SEM_FAILED){
...
inline bool semaphore_timed_wait(sem_t *handle, const streams_boost::posix_time::ptime &abs_time)
{
   #ifdef STREAMS_BOOST_INTERPROCESS_POSIX_TIMEOUTS
   ...
   return false;
   #else //#ifdef STREAMS_BOOST_INTERPROCESS_POSIX_TIMEOUTS
   streams_boost::posix_time::ptime now;
   ...
   return false;
   #endif   //#ifdef STREAMS_BOOST_INTERPROCESS_POSIX_TIMEOUTS
}
...
class named_semaphore_wrapper
{
   ...
   ~named_semaphore_wrapper()
   {
      if(mp_sem != STREAMS_BOOST_INTERPROCESS_POSIX_SEM_FAILED)
   ...
   {  mp_sem = STREAMS_BOOST_INTERPROCESS_POSIX_SEM_FAILED; }
...
#undef STREAMS_BOOST_INTERPROCESS_POSIX_SEM_FAILED

#endif   //#ifndef STREAMS_BOOST_INTERPROCESS_POSIX_SEMAPHORE_WRAPPER_STREAMS_HPP
