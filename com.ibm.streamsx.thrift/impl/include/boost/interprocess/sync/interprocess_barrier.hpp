...
#ifndef STREAMS_BOOST_INTERPROCESS_BARRIER_HPP
#define STREAMS_BOOST_INTERPROCESS_BARRIER_HPP
...
#if defined STREAMS_BOOST_INTERPROCESS_POSIX_PROCESS_SHARED && defined STREAMS_BOOST_INTERPROCESS_POSIX_BARRIERS
#  include <pthread.h>
#  include <errno.h>   
...
class barrier
{
   ...
   #else //#if defined STREAMS_BOOST_INTERPROCESS_USE_POSIX
      pthread_barrier_t    m_barrier;
   #endif//#if defined STREAMS_BOOST_INTERPROCESS_USE_POSIX
   /// @endcond
};
...
#  include <streams_boost/interprocess/sync/emulation/interprocess_barrier.hpp>
#endif

#ifdef STREAMS_BOOST_INTERPROCESS_USE_POSIX
#  undef STREAMS_BOOST_INTERPROCESS_USE_POSIX
#  include <streams_boost/interprocess/sync/posix/interprocess_barrier.hpp>
#endif
