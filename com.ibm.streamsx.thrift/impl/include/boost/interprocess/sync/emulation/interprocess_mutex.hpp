...
{
   do{
      streams_boost::uint32_t prev_s = detail::atomic_cas32(const_cast<streams_boost::uint32_t*>(&m_s), 1, 0);
...
inline bool interprocess_mutex::timed_lock(const streams_boost::posix_time::ptime &abs_time)
{
...
{  detail::atomic_cas32(const_cast<streams_boost::uint32_t*>(&m_s), 0, 1);   }
