...
#ifndef STREAMS_BOOST_INTERPROCESS_named_upgradable_mutex_HPP
#define STREAMS_BOOST_INTERPROCESS_named_upgradable_mutex_HPP
...
#include <streams_boost/interprocess/sync/interprocess_upgradable_mutex.hpp>
...
class named_upgradable_mutex
{
   ...
   //!Throws: interprocess_exception on error.
   bool timed_lock_sharable(const streams_boost::posix_time::ptime &abs_time);
   ...
   //!Throws: interprocess_exception on error.
   bool timed_lock_upgradable(const streams_boost::posix_time::ptime &abs_time);
   ...
   //!Returns: If acquires exclusive ownership, returns true. Otherwise returns false. 
   //!Throws: An exception derived from interprocess_exception on error.
   bool timed_unlock_upgradable_and_lock(const streams_boost::posix_time::ptime &abs_time);
...
#endif   //STREAMS_BOOST_INTERPROCESS_named_upgradable_mutex_HPP
