...
#ifndef STREAMS_BOOST_INTERPROCESS_NAMED_SEMAPHORE_HPP
#define STREAMS_BOOST_INTERPROCESS_NAMED_SEMAPHORE_HPP
...
#if defined(STREAMS_BOOST_INTERPROCESS_NAMED_SEMAPHORE_USES_POSIX_SEMAPHORES)
...
#include <streams_boost/interprocess/sync/interprocess_semaphore.hpp>
...
inline bool named_semaphore::timed_wait(const streams_boost::posix_time::ptime &abs_time)
{
...
#endif   //STREAMS_BOOST_INTERPROCESS_NAMED_SEMAPHORE_HPP
