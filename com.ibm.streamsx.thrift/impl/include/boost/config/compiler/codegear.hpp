...
#if !defined( STREAMS_BOOST_WITH_CODEGEAR_WARNINGS )
...
#if (__CODEGEARC__ <= 0x620)
#  define STREAMS_BOOST_NO_TYPENAME_WITH_CTOR    // Cannot use typename keyword when making temporaries of a dependant type
#  define STREAMS_BOOST_FUNCTION_SCOPE_USING_DECLARATION_BREAKS_ADL
#  define STREAMS_BOOST_NO_MEMBER_TEMPLATE_FRIENDS
#  define STREAMS_BOOST_NO_NESTED_FRIENDSHIP     // TC1 gives nested classes access rights as any other member
...
#define STREAMS_BOOST_HAS_SCOPED_ENUM
// #define STREAMS_BOOST_HAS_STATIC_ASSERT
#define STREAMS_BOOST_HAS_STD_TYPE_TRAITS
...
#define STREAMS_BOOST_COMPILER "CodeGear C++ version " STREAMS_BOOST_STRINGIZE(__CODEGEARC__)
