...
#   if __GNUC_MINOR__ < 95
      ...
      // work - define STREAMS_BOOST_MSVC6_MEMBER_TEMPLATES
...
#  ifndef __GXX_RTTI
#     define STREAMS_BOOST_NO_TYPEID
...
#  define STREAMS_BOOST_HAS_VARIADIC_TMPL
#else
...
// scoped enums have a serious bug in 4.4.0, so define STREAMS_BOOST_NO_SCOPED_ENUMS before 4.4.1
...
#  define STREAMS_BOOST_HAS_CONCEPTS
#  define STREAMS_BOOST_COMPILER "ConceptGCC version " __VERSION__
#else
#  define STREAMS_BOOST_NO_CONCEPTS
#endif

#ifndef STREAMS_BOOST_COMPILER
#  define STREAMS_BOOST_COMPILER "GNU C++ version " __VERSION__
#endif
