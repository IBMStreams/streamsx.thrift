...
#     define STREAMS_BOOST_NO_LIMITS
// Note: <streams_boost/limits.hpp> will provide compile-time constants
#     undef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
#define STREAMS_BOOST_STDLIB "SGI standard library"
