...
#ifdef __GLIBCXX__
#define STREAMS_BOOST_STDLIB "GNU libstdc++ version " STREAMS_BOOST_STRINGIZE(__GLIBCXX__)
#else
#define STREAMS_BOOST_STDLIB "GNU libstdc++ version " STREAMS_BOOST_STRINGIZE(__GLIBCPP__)
#endif
...
#  define STREAMS_BOOST_HAS_THREADS
    ...
    && defined(STREAMS_BOOST_HAS_LONG_LONG)
...
#  define STREAMS_BOOST_STD_EXTENSION_NAMESPACE __gnu_cxx
#  define STREAMS_BOOST_HAS_SLIST
#  define STREAMS_BOOST_HAS_HASH
#  define STREAMS_BOOST_SLIST_HEADER <ext/slist>
# if !defined(__GNUC__) || __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 3)
#   define STREAMS_BOOST_HASH_SET_HEADER <ext/hash_set>
#   define STREAMS_BOOST_HASH_MAP_HEADER <ext/hash_map>
# else
#   define STREAMS_BOOST_HASH_SET_HEADER <backward/hash_set>
#   define STREAMS_BOOST_HASH_MAP_HEADER <backward/hash_map>
# endif
#endif
