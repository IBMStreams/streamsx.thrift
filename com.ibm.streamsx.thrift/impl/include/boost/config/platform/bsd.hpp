...
#ifdef __FreeBSD__
#define STREAMS_BOOST_PLATFORM "FreeBSD " STREAMS_BOOST_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define STREAMS_BOOST_PLATFORM "NetBSD " STREAMS_BOOST_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define STREAMS_BOOST_PLATFORM "OpenBSD " STREAMS_BOOST_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define STREAMS_BOOST_PLATFORM "DragonFly " STREAMS_BOOST_STRINGIZE(__DragonFly__)
#endif
...
#  define STREAMS_BOOST_NO_CTYPE_FUNCTIONS
#endif
