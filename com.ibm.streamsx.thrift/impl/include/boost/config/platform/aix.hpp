...
#define STREAMS_BOOST_PLATFORM "IBM Aix"
...
// This needs support in "streams_boost/cstdint.hpp" exactly like FreeBSD.
...
#define STREAMS_BOOST_HAS_PTHREAD_DELAY_NP
#define STREAMS_BOOST_HAS_SCHED_YIELD
//#define STREAMS_BOOST_HAS_PTHREAD_YIELD
