...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(STREAMS_BOOST_HAS_WINTHREADS) && !defined(STREAMS_BOOST_HAS_MPTASKS)
#        define STREAMS_BOOST_HAS_PTHREADS
#     endif

      // STREAMS_BOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // STREAMS_BOOST_HAS_CLOCK_GETTIME:
...
#     endif
      ...
      // STREAMS_BOOST_HAS_GETTIMEOFDAY:
      // STREAMS_BOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
