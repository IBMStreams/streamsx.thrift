...
#ifndef STREAMS_BOOST_INTRUSIVE_CIRCULAR_SLIST_ALGORITHMS_HPP
#define STREAMS_BOOST_INTRUSIVE_CIRCULAR_SLIST_ALGORITHMS_HPP

#include <streams_boost/intrusive/detail/config_begin.hpp>
#include <streams_boost/intrusive/intrusive_fwd.hpp>
#include <streams_boost/intrusive/detail/common_slist_algorithms.hpp>
   ...
   /// @endcond
{
   ...
   #endif   //#if defined(STREAMS_BOOST_INTRUSIVE_DOXYGEN_INVOKED)
...
#endif //STREAMS_BOOST_INTRUSIVE_CIRCULAR_SLIST_ALGORITHMS_HPP
