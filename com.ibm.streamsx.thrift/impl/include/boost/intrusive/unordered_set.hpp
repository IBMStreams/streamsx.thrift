...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef STREAMS_BOOST_INTRUSIVE_UNORDERED_SET_HPP
#define STREAMS_BOOST_INTRUSIVE_UNORDERED_SET_HPP

#include <streams_boost/intrusive/detail/config_begin.hpp>
#include <streams_boost/intrusive/intrusive_fwd.hpp>
#include <streams_boost/intrusive/hashtable.hpp>
#include <iterator>
      ...
      >::type
{
   ...
   STREAMS_BOOST_STATIC_ASSERT((detail::is_same<typename Base::value_traits::value_type, T>::value));
...
#endif //STREAMS_BOOST_INTRUSIVE_UNORDERED_SET_HPP
