...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef STREAMS_BOOST_INTRUSIVE_TRIE_HPP
#define STREAMS_BOOST_INTRUSIVE_TRIE_HPP
...
#include <streams_boost/intrusive/treap_algorithms.hpp>
#include <streams_boost/intrusive/link_mode.hpp>
#include <streams_boost/intrusive/priority_compare.hpp>
...
struct treap_set_defaults
   :  pack_options
      ...
      , compare<std::less<T> >
      , priority<streams_boost::intrusive::priority_compare<T> >
      >::type
{};
...
#endif //STREAMS_BOOST_INTRUSIVE_TRIE_HPP
