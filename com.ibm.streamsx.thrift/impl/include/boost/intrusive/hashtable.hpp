...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef STREAMS_BOOST_INTRUSIVE_HASHTABLE_HPP
#define STREAMS_BOOST_INTRUSIVE_HASHTABLE_HPP
...
#include <streams_boost/intrusive/detail/hashtable_node.hpp>
#include <streams_boost/intrusive/detail/transform_iterator.hpp>
...
#include <streams_boost/intrusive/trivial_value_traits.hpp>
#include <streams_boost/intrusive/unordered_set_hook.hpp>
...
struct get_slist_impl
{
   ...
   struct type : make_slist
      ...
      , streams_boost::intrusive::value_traits<trivial_traits>
      , streams_boost::intrusive::constant_time_size<false>
      , streams_boost::intrusive::size_type<std::size_t>
      >::type
   {};
};
   ...
   :  private detail::clear_on_destructor_base<hashtable_impl<Config> >
{
   ...
   STREAMS_BOOST_STATIC_ASSERT((!compare_hash || store_hash));
   ...
   STREAMS_BOOST_STATIC_ASSERT(!(cache_begin && ((int)real_value_traits::link_mode == (int)auto_unlink)));
      ...
      :  data_(b_traits, hash_func, equal_func, v_traits)
   {
      ...
      STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(bucket_size != 0);
      //Check power of two bucket array if the option is activated
      STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT
   ...
   iterator insert_unique_commit(reference value, const insert_commit_data &commit_data)
   {
      ...
      if(safemode_or_autounlink)
         STREAMS_BOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(node_algorithms::unique(n));
   ...
   bool incremental_rehash(bool grow = true)
   {
      ...
      STREAMS_BOOST_STATIC_ASSERT(( incremental && power_2_buckets ));
...
#endif //STREAMS_BOOST_INTRUSIVE_HASHTABLE_HPP
