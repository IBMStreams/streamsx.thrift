...
#ifndef STREAMS_BOOST_INTRUSIVE_BS_SET_HOOK_HPP
#define STREAMS_BOOST_INTRUSIVE_BS_SET_HOOK_HPP
...
struct make_bs_set_base_hook
{
   ...
   STREAMS_BOOST_STATIC_ASSERT(((int)packed_options::link_mode != (int)auto_unlink));
...
#endif //STREAMS_BOOST_INTRUSIVE_BS_SET_HOOK_HPP
