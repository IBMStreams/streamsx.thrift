...
#ifndef STREAMS_BOOST_INTRUSIVE_SPLAYTREE_ALGORITHMS_HPP
#define STREAMS_BOOST_INTRUSIVE_SPLAYTREE_ALGORITHMS_HPP
...
//         data_->parent = find_leftmost();
   ...
   static void splay_up(node_ptr n, node_ptr header)
   {
      if(n == header){  // do a splay for the right most node instead
         // this is to streams_boost performance of equal_range/count on equivalent containers in the case
...
#endif //STREAMS_BOOST_INTRUSIVE_SPLAYTREE_ALGORITHMS_HPP
