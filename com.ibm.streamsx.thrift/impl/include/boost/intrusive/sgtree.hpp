...
#ifndef STREAMS_BOOST_INTRUSIVE_SGTREE_HPP
#define STREAMS_BOOST_INTRUSIVE_SGTREE_HPP
...
#include <streams_boost/intrusive/bs_set_hook.hpp>
#include <streams_boost/intrusive/detail/tree_node.hpp>
#include <streams_boost/intrusive/detail/ebo_functor_holder.hpp>
...
#include <streams_boost/intrusive/sgtree_algorithms.hpp>
...
struct alpha_holder
{
   typedef streams_boost::intrusive::detail::h_alpha_t           h_alpha_t;
   typedef streams_boost::intrusive::detail::alpha_by_max_size_t multiply_by_alpha_t;
...
struct alpha_holder<false>
{
   ...
   typedef streams_boost::intrusive::detail::h_alpha_sqrt2_t           h_alpha_t;
   typedef streams_boost::intrusive::detail::alpha_0_75_by_max_size_t  multiply_by_alpha_t;
   ...
   {  //alpha CAN't be changed.
      STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(0);
   }
   ...
   :  private detail::clear_on_destructor_base<sgtree_impl<Config> >
{
   ...
   STREAMS_BOOST_STATIC_ASSERT(((int)real_value_traits::link_mode != (int)auto_unlink));
   ...
   iterator insert_equal(reference value)
   {
      ...
      if(safemode_or_autounlink)
         STREAMS_BOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(node_algorithms::unique(to_insert));
   ...
   iterator erase(const_iterator i)
   {
      ...
      if(safemode_or_autounlink)
         STREAMS_BOOST_INTRUSIVE_SAFE_HOOK_DEFAULT_ASSERT(!node_algorithms::unique(to_erase));
   ...
   {
      STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT((new_alpha > 0.5f && new_alpha < 1.0f));
      ...
      STREAMS_BOOST_STATIC_ASSERT((floating_point));
...
/*
   ...
   static void remove_node(T& value)
   {
      ...
      //time lists. 
      //STREAMS_BOOST_STATIC_ASSERT((!(safemode_or_autounlink && constant_time_size)));
      STREAMS_BOOST_STATIC_ASSERT((!constant_time_size));
      STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_convertible<T, value_type>::value));
...
#endif //STREAMS_BOOST_INTRUSIVE_SGTREE_HPP
