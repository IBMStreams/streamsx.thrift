...
#ifndef STREAMS_BOOST_INTRUSIVE_AVLTREE_ALGORITHMS_HPP
#define STREAMS_BOOST_INTRUSIVE_AVLTREE_ALGORITHMS_HPP
...
#include <streams_boost/intrusive/detail/tree_algorithms.hpp>
...
class avltree_algorithms
{
   ...
   {
      return node_ptr(const_cast<node*>(::streams_boost::intrusive::detail::get_pointer(ptr)));
   }
   /// @endcond
      ...
      for (node_ptr root = NodeTraits::get_parent(header); x != root; root = NodeTraits::get_parent(header)) {
         ...
         if(x_parent_balance == NodeTraits::zero()){
            ...
            if (x == NodeTraits::get_left(x_parent)) {
               ...
               STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(a);
               if (NodeTraits::get_balance(a) == NodeTraits::positive()) {
                  // a MUST have a right child
                  STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(NodeTraits::get_right(a));
            ...
            if (x == NodeTraits::get_right(x_parent)) {
               ...
               if (NodeTraits::get_balance(a) == NodeTraits::negative()) {
                  ...
                  STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(NodeTraits::get_left(a));
            ...
            STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(false);  // never reached
         }
      }
   }
...
#endif //STREAMS_BOOST_INTRUSIVE_AVLTREE_ALGORITHMS_HPP
