...
//
/////////////////////////////////////////////////////////////////////////////
#ifndef STREAMS_BOOST_INTRUSIVE_SGTREE_ALGORITHMS_HPP
#define STREAMS_BOOST_INTRUSIVE_SGTREE_ALGORITHMS_HPP
      ...
      , std::size_t tree_size, H_Alpha h_alpha, std::size_t &max_tree_size)
   {
      ...
      if(tree_size != 1 && depth > h_alpha(tree_size)){
         ...
         for(std::size_t i = 1; true; ++i){
            ...
            if(i == depth){
               STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(tree_size == count(s));
               rebalance = true;
            }
...
#endif //STREAMS_BOOST_INTRUSIVE_SGTREE_ALGORITHMS_HPP
