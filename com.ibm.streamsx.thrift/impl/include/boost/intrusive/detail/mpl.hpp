...
#ifndef STREAMS_BOOST_INTRUSIVE_DETAIL_MPL_HPP
#define STREAMS_BOOST_INTRUSIVE_DETAIL_MPL_HPP
...
#if defined(STREAMS_BOOST_MSVC) || defined(__BORLANDC_)
#define STREAMS_BOOST_INTRUSIVE_TT_DECL __cdecl
#else
#define STREAMS_BOOST_INTRUSIVE_TT_DECL 
#endif

#if defined(_MSC_EXTENSIONS) && !defined(__BORLAND__) && !defined(_WIN64)
#define STREAMS_BOOST_INTRUSIVE_TT_TEST_MSC_FUNC_SIGS
#endif
...
{  static const bool value = true;  };
/*
#ifdef STREAMS_BOOST_INTRUSIVE_TT_TEST_MSC_FUNC_SIGS
...
//streams_boost::alignment_of yields to 10K lines of preprocessed code, so we
//need an alternative
...
#endif //STREAMS_BOOST_INTRUSIVE_DETAIL_MPL_HPP
