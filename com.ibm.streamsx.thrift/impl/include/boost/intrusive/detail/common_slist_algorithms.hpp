...
#ifndef STREAMS_BOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
#define STREAMS_BOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
...
class common_slist_algorithms
{
   ...
   static node_ptr get_previous_node(node_ptr prev_init_node, node_ptr this_node)
   {
      ...
      for( node_ptr p_next
         ...
         STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(p);
      }
      return p;
   }
...
#endif //STREAMS_BOOST_INTRUSIVE_COMMON_SLIST_ALGORITHMS_HPP
