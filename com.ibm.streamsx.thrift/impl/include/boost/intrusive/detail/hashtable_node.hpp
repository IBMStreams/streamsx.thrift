...
#ifndef STREAMS_BOOST_INTRUSIVE_HASHTABLE_NODE_HPP
#define STREAMS_BOOST_INTRUSIVE_HASHTABLE_NODE_HPP
...
#include <streams_boost/intrusive/detail/slist_node.hpp> //remove-me
#include <cstddef>
...
struct bucket_impl : public Slist
{
   ...
   ~bucket_impl()
   {
      ...
      STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(Slist::empty());
   }
