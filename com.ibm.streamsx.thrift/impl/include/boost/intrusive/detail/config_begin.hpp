...
#ifndef STREAMS_BOOST_INTRUSIVE_CONFIG_INCLUDED
#define STREAMS_BOOST_INTRUSIVE_CONFIG_INCLUDED
#include <streams_boost/config.hpp>
   ...
   #pragma warning (disable : 4541) //'typeid' used on polymorphic type 'streams_boost::exception' with /GR-
   #pragma warning (disable : 4512) //'typeid' used on polymorphic type 'streams_boost::exception' with /GR-
#endif

//#define STREAMS_BOOST_INTRUSIVE_USE_ITERATOR_FACADE
//#define STREAMS_BOOST_INTRUSIVE_USE_ITERATOR_ENABLE_IF_CONVERTIBLE
