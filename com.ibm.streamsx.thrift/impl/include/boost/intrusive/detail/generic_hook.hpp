...
#ifndef STREAMS_BOOST_INTRUSIVE_GENERIC_HOOK_HPP
#define STREAMS_BOOST_INTRUSIVE_GENERIC_HOOK_HPP
   ...
   /// @endcond
{
   ...
   public:
   struct streams_boost_intrusive_tags
   {
   ...
   generic_hook()
   {
      if(streams_boost_intrusive_tags::safemode_or_autounlink){
   ...
   {
      destructor_impl
         (*this, detail::link_dispatch<streams_boost_intrusive_tags::link_mode>());
   }
   ...
   bool is_linked() const 
   {
      ...
      STREAMS_BOOST_STATIC_ASSERT(( streams_boost_intrusive_tags::safemode_or_autounlink ));
   ...
   void unlink()
   {
      STREAMS_BOOST_STATIC_ASSERT(( (int)streams_boost_intrusive_tags::link_mode == (int)auto_unlink ));
...
#endif //STREAMS_BOOST_INTRUSIVE_GENERIC_HOOK_HPP
