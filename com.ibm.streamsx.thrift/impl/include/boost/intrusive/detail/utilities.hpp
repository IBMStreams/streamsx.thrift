...
#ifndef STREAMS_BOOST_INTRUSIVE_DETAIL_UTILITIES_HPP
#define STREAMS_BOOST_INTRUSIVE_DETAIL_UTILITIES_HPP

#include <streams_boost/intrusive/detail/config_begin.hpp>
#include <streams_boost/intrusive/detail/pointer_to_other.hpp>
#include <streams_boost/intrusive/detail/parent_from_member.hpp>
...
#include <streams_boost/intrusive/detail/is_stateful_value_traits.hpp>
...
struct internal_base_hook_bool
{
   ...
   template <class U> static two_or_three<U::streams_boost_intrusive_tags::is_base_hook> test (int);
...
{  //If this assertion raises, you might have destroyed an object
   ...
   (void)hook; STREAMS_BOOST_INTRUSIVE_SAFE_HOOK_DESTRUCTOR_ASSERT(!hook.is_linked());
}
...
struct base_hook_traits
{
   ...
   typedef typename streams_boost::pointer_to_other<node_ptr, T>::type       pointer;
   typedef typename streams_boost::pointer_to_other<node_ptr, const T>::type const_pointer;
...
struct member_hook_traits
{
   ...
   typedef typename hook_type::streams_boost_intrusive_tags::node_traits     node_traits;
   ...
   typedef typename std::iterator_traits<pointer>::reference         reference;
   typedef typename std::iterator_traits<const_pointer>::reference   const_reference;
   static const link_mode_type link_mode = Hook::streams_boost_intrusive_tags::link_mode;
...
inline std::size_t floor_log2 (std::size_t x)
{
   ...
   STREAMS_BOOST_STATIC_ASSERT(Size_t_Bits_Power_2);
...
{
   streams_boost::uint32_t * exp_ptr =
      static_cast<streams_boost::uint32_t *>(static_cast<void*>(&val));
   streams_boost::uint32_t x = *exp_ptr;
...
{
   static const streams_boost::uint32_t value = 0xb504f334;
...
{
   static const streams_boost::uint64_t value = 0xb504f333f9de6484ull;
...
#endif //STREAMS_BOOST_INTRUSIVE_DETAIL_UTILITIES_HPP
