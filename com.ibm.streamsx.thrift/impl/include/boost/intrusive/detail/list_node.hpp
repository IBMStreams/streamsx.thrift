...
#ifndef STREAMS_BOOST_INTRUSIVE_LIST_NODE_HPP
#define STREAMS_BOOST_INTRUSIVE_LIST_NODE_HPP
         ...
         >
{
   ...
   const Container *get_container() const
   {
      if(store_container_ptr){
         ...
         STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(c != 0);
         return c;
      }
      else{
         return 0;
...
#endif //STREAMS_BOOST_INTRUSIVE_LIST_NODE_HPP
