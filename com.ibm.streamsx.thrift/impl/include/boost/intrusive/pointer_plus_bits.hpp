...
#ifndef STREAMS_BOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP
#define STREAMS_BOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP

#include <streams_boost/intrusive/detail/mpl.hpp> //ls_zeros
#include <streams_boost/intrusive/detail/assert.hpp> //STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT
...
struct pointer_plus_bits<T*, NumBits>
{
   ...
   {
      STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(0 == (std::size_t(p) & Mask));
   ...
   {
      STREAMS_BOOST_INTRUSIVE_INVARIANT_ASSERT(c <= Mask);
...
#endif //STREAMS_BOOST_INTRUSIVE_POINTER_PLUS_BITS_HPP
