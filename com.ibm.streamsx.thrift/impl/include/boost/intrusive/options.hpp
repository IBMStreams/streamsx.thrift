...
#ifndef STREAMS_BOOST_INTRUSIVE_OPTIONS_HPP
#define STREAMS_BOOST_INTRUSIVE_OPTIONS_HPP
...
#define STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER) \
struct STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER : public default_hook_tag\
{\
   template <class T>\
   struct apply\
   {  typedef typename T::STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER type;  };\
}\

STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_list_hook);
STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_slist_hook);
STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_set_hook);
STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_uset_hook);
STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_avl_set_hook);
STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_splay_set_hook);
STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION(default_bs_set_hook);

#undef STREAMS_BOOST_INTRUSIVE_DEFAULT_HOOK_MARKER_DEFINITION
...
{
   typedef typename BaseHook::streams_boost_intrusive_tags tags;
...
{  typedef typename BaseHook::streams_boost_intrusive_tags::node_traits type;  };
...
#endif   //#ifndef STREAMS_BOOST_INTRUSIVE_OPTIONS_HPP
