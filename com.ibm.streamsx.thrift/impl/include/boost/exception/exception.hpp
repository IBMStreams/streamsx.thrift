...
#ifndef STREAMS_UUID_274DA366004E11DCB1DDFE2E56D89593
#define STREAMS_UUID_274DA366004E11DCB1DDFE2E56D89593
...
streams_boost
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing streams_boost::exception.
    ...
    exception_detail
        ...
        inline
        void
        copy_streams_boost_exception( exception * a, exception const * b )
            {
            *a = *b;
            }
        ...
        inline
        void
        copy_streams_boost_exception( void *, void const * )
            {
            }
        ...
        clone_impl:
            ...
            clone_impl( T const & x ):
                T(x)
                {
                copy_streams_boost_exception(this,&x);
                }
