...
#ifndef STREAMS_BOOST_UNORDERED_DETAIL_MANAGER_HPP_INCLUDED
#define STREAMS_BOOST_UNORDERED_DETAIL_MANAGER_HPP_INCLUDED

#include <streams_boost/config.hpp>
#include <streams_boost/assert.hpp>
#include <streams_boost/unordered/detail/node.hpp>
#include <streams_boost/unordered/detail/util.hpp>
...
namespace streams_boost { namespace unordered_detail {
    ...
    template <class A, class G>
    inline STREAMS_BOOST_DEDUCED_TYPENAME hash_buckets<A, G>::bucket_ptr
    ...
    template <class A, class G>
    inline STREAMS_BOOST_DEDUCED_TYPENAME hash_buckets<A, G>::node_ptr
    ...
    inline void hash_buckets<A, G>::delete_node(node_ptr b)
    {
        ...
        streams_boost::unordered_detail::destroy(&raw_ptr->value());
    ...
    {
        STREAMS_BOOST_ASSERT(node_alloc() == other.node_alloc());
        if(this->buckets_) { this->delete_buckets(); }
