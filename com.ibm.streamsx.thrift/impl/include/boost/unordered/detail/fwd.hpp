...
#ifndef STREAMS_BOOST_UNORDERED_DETAIL_FWD_HPP_INCLUDED
#define STREAMS_BOOST_UNORDERED_DETAIL_FWD_HPP_INCLUDED
...
#include <streams_boost/unordered/detail/allocator_helpers.hpp>
#include <algorithm>
...
#   else
#       define STREAMS_BOOST_UNORDERED_STD_FORWARD
#   endif
#endif

#if !defined(STREAMS_BOOST_UNORDERED_EMPLACE_LIMIT)
#define STREAMS_BOOST_UNORDERED_EMPLACE_LIMIT 10
#endif

#if !defined(STREAMS_BOOST_UNORDERED_STD_FORWARD)

#include <streams_boost/preprocessor/repetition/enum_params.hpp>
#include <streams_boost/preprocessor/repetition/enum_binary_params.hpp>
#include <streams_boost/preprocessor/repetition/repeat_from_to.hpp>

#define STREAMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, num_params) \
    STREAMS_BOOST_PP_ENUM_PARAMS_Z(z, num_params, class Arg)
#define STREAMS_BOOST_UNORDERED_FUNCTION_PARAMS(z, num_params) \
    STREAMS_BOOST_PP_ENUM_BINARY_PARAMS_Z(z, num_params, Arg, const& arg)
#define STREAMS_BOOST_UNORDERED_CALL_PARAMS(z, num_params) \
    STREAMS_BOOST_PP_ENUM_PARAMS_Z(z, num_params, arg)

#endif

namespace streams_boost { namespace unordered_detail {
...
#pragma warning(pop)
    ...
    public:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME
            streams_boost::unordered_detail::rebind_wrap<A, bucket>::type
            bucket_allocator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME bucket_allocator::pointer bucket_ptr;
    ...
    struct ungrouped_node_base : hash_bucket<A> {
        typedef hash_bucket<A> bucket;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME bucket::bucket_ptr bucket_ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME bucket::node_ptr node_ptr;
    ...
    struct value_base
    {
        ...
        STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::aligned_storage<
            sizeof(value_type),
            ::streams_boost::alignment_of<value_type>::value>::type data_;
    ...
    class hash_node :
        public G::STREAMS_BOOST_NESTED_TEMPLATE base<A>::type,
        public value_base<STREAMS_BOOST_DEDUCED_TYPENAME A::value_type>
    {
    public:
        typedef STREAMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME hash_bucket<A>::node_ptr node_ptr;
    ...
    public:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_base::node node;

        typedef STREAMS_BOOST_DEDUCED_TYPENAME bucket::bucket_allocator
            bucket_allocator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME bucket::bucket_ptr bucket_ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME bucket::node_ptr node_ptr;

        typedef STREAMS_BOOST_DEDUCED_TYPENAME rebind_wrap<value_allocator, node>::type
            node_allocator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME node_allocator::pointer real_node_ptr;

        // Members

        bucket_ptr buckets_;
        std::size_t bucket_count_;
        streams_boost::compressed_pair<bucket_allocator, node_allocator> allocators_;
    ...
    class hash_buffered_functions
    {
        ...
        typedef streams_boost::compressed_pair<H, P> function_pair;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::aligned_storage<
            sizeof(function_pair),
            ::streams_boost::alignment_of<function_pair>::value>::type aligned_function;
        ...
        {
            streams_boost::unordered_detail::destroy((function_pair*)(&funcs_[which]));
        }
    ...
    public:
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::hasher hasher;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::key_equal key_equal;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::value_allocator value_allocator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::key_type key_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::value_type value_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::buffered_functions base;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::buckets buckets;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::extractor extractor;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::node_constructor node_constructor;

        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::node node;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::bucket bucket;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::node_ptr node_ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::bucket_ptr bucket_ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::iterator_base iterator_base;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::node_allocator node_allocator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::iterator_pair iterator_pair;
    ...
    public:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::key_type key_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::value_type value_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::table table;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME T::node_constructor node_constructor;
...
#define STREAMS_BOOST_UNORDERED_INSERT_IMPL(z, n, _)                                   \
        template <STREAMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, n)>                         \
        emplace_return emplace(                                                \
            STREAMS_BOOST_UNORDERED_FUNCTION_PARAMS(z, n));                            \
        template <STREAMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, n)>                         \
        ...
        STREAMS_BOOST_PP_REPEAT_FROM_TO(1, STREAMS_BOOST_UNORDERED_EMPLACE_LIMIT,
            STREAMS_BOOST_UNORDERED_INSERT_IMPL, _)

#undef STREAMS_BOOST_UNORDERED_INSERT_IMPL
...
#define STREAMS_BOOST_UNORDERED_INSERT_IMPL(z, n, _)                                   \
        template <STREAMS_BOOST_UNORDERED_TEMPLATE_ARGS(z, n)>                         \
        iterator_base emplace(STREAMS_BOOST_UNORDERED_FUNCTION_PARAMS(z, n));
...
#undef STREAMS_BOOST_UNORDERED_INSERT_IMPL
        ...
        template <class I>
        void insert_for_range(I i, I j, streams_boost::incrementable_traversal_tag);
        template <class I>
    ...
    public:
        ...
        static STREAMS_BOOST_DEDUCED_TYPENAME Iterator::base const&
    ...
    class hash_local_iterator
        : public streams_boost::iterator <
            std::forward_iterator_tag,
            STREAMS_BOOST_DEDUCED_TYPENAME A::value_type,
            std::ptrdiff_t,
            STREAMS_BOOST_DEDUCED_TYPENAME A::pointer,
            STREAMS_BOOST_DEDUCED_TYPENAME A::reference>
    {
    public:
        typedef STREAMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
    ...
    private:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node_ptr node_ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node node;
    ...
    public:
        ...
        STREAMS_BOOST_DEDUCED_TYPENAME A::reference operator*() const {
    ...
    class hash_const_local_iterator
        : public streams_boost::iterator <
            ...
            STREAMS_BOOST_DEDUCED_TYPENAME A::value_type,
            std::ptrdiff_t,
            STREAMS_BOOST_DEDUCED_TYPENAME A::const_pointer,
            STREAMS_BOOST_DEDUCED_TYPENAME A::const_reference >
    {
    public:
        typedef STREAMS_BOOST_DEDUCED_TYPENAME A::value_type value_type;
    ...
    private:
        typedef hash_buckets<A, G> buckets;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node_ptr ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node node;
    ...
    private:
        typedef hash_buckets<A, G> buckets;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node node;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::iterator_base base;
    ...
    public:
        ...
        STREAMS_BOOST_DEDUCED_TYPENAME A::const_reference operator*() const {
            return *base_;
        }
        value_type const* operator->() const {
            return &*base_;
    ...
    public:
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node node;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::bucket bucket;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node_ptr node_ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::bucket_ptr bucket_ptr;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::iterator_base iterator_base;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME buckets::node_allocator node_allocator;
    ...
    struct set : public types<
        ...
        STREAMS_BOOST_DEDUCED_TYPENAME A::value_type,
        H, P, A,
        set_extractor<STREAMS_BOOST_DEDUCED_TYPENAME A::value_type>,
        ungrouped>
    {        
    ...
    struct map : public types<
        K, STREAMS_BOOST_DEDUCED_TYPENAME A::value_type,
        H, P, A,
        map_extractor<K, STREAMS_BOOST_DEDUCED_TYPENAME A::value_type>,
        ungrouped>
    {
