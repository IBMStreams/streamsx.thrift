...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_TAIL_HPP_EAN_28_10_2005
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_TAIL_HPP_EAN_28_10_2005
...
STREAMS_BOOST_PARAMETER_NESTED_KEYWORD(tag, right_tail_cache_size, cache_size)
STREAMS_BOOST_PARAMETER_NESTED_KEYWORD(tag, left_tail_cache_size, cache_size)
...
namespace detail
{
    ...
    struct tail_range
    {
        typedef streams_boost::iterator_range<
            streams_boost::reverse_iterator<streams_boost::permutation_iterator<ElementIterator, IndexIterator> >
        > type;
    };
    ...
    {
        return streams_boost::make_iterator_range(
            streams_boost::make_reverse_iterator(
                streams_boost::make_permutation_iterator(elem_begin, index_end)
            )
          , streams_boost::make_reverse_iterator(
                streams_boost::make_permutation_iterator(elem_begin, index_begin)
            )
        );
    }
...
namespace impl
{
    ...
    private:
        ...
        {
            STREAMS_BOOST_ASSERT(index < this->samples.size());
...
namespace tag
{
      ...
      , tail_cache_size_named_arg<LeftRight>
    {
        ...
        static streams_boost::parameter::keyword<tail_cache_size_named_arg<LeftRight> > const cache_size;
        #endif
    };
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(tail)
}
