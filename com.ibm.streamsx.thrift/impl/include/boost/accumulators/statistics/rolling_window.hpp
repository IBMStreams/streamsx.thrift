...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_ROLLING_WINDOW_HPP_EAN_26_12_2008
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_ROLLING_WINDOW_HPP_EAN_26_12_2008
...
STREAMS_BOOST_PARAMETER_NESTED_KEYWORD(tag, rolling_window_size, window_size)
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(rolling_window_plus1)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(rolling_window)
}
