...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_QUANTILE_HPP_DE_01_01_2006
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_QUANTILE_HPP_DE_01_01_2006
...
#include <streams_boost/accumulators/statistics/extended_p_square.hpp>
#include <streams_boost/accumulators/statistics/weighted_extended_p_square.hpp>
#include <streams_boost/accumulators/statistics/times2_iterator.hpp>
    ...
    */
      ...
      : accumulator_base
    {
        ...
        extended_p_square_quantile_impl(Args const &args)
          : probabilities(
                streams_boost::begin(args[extended_p_square_probabilities])
              , streams_boost::end(args[extended_p_square_probabilities])
            )
        {
        }
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(extended_p_square_quantile)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(extended_p_square_quantile_quadratic)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_extended_p_square_quantile)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_extended_p_square_quantile_quadratic)
}
