...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_MEAN_HPP_EAN_03_11_2005
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_MEAN_HPP_EAN_03_11_2005
...
#include <streams_boost/accumulators/framework/parameters/weights.hpp>
...
#include <streams_boost/accumulators/statistics/weighted_sum.hpp>
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_DEFINE_EXTRACTOR(tag, weighted_mean_of_variates, (typename)(typename))

    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_mean)
}
