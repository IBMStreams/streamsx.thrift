...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_MEAN_HPP_EAN_28_10_2005
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_MEAN_HPP_EAN_28_10_2005
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_DEFINE_EXTRACTOR(tag, mean_of_variates, (typename)(typename))

    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(mean)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(mean_of_weights)
}
