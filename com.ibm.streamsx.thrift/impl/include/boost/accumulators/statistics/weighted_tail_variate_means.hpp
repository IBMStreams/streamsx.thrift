...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_TAIL_VARIATE_MEANS_HPP_DE_01_01_2006
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_TAIL_VARIATE_MEANS_HPP_DE_01_01_2006
...
#include <streams_boost/accumulators/statistics/tail_variate_means.hpp>
#include <streams_boost/accumulators/statistics/weighted_tail_mean.hpp>
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_tail_variate_means)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(relative_weighted_tail_variate_means)
}
