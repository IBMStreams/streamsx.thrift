...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_TAIL_QUANTILE_HPP_DE_01_01_2006
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_TAIL_QUANTILE_HPP_DE_01_01_2006
...
#include <streams_boost/accumulators/statistics/tail_quantile.hpp>
    ...
    */
      ...
      : accumulator_base
    {
        ...
        result_type result(Args const &args) const
        {
            ...
            return *(streams_boost::begin(tail(args)) + n - 1);
        }
    };
} // namespace impl
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_tail_quantile)
}
