...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_DENSITY_HPP_DE_01_01_2006
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_WEIGHTED_DENSITY_HPP_DE_01_01_2006
...
#include <streams_boost/accumulators/statistics/max.hpp>
#include <streams_boost/accumulators/statistics/min.hpp>
#include <streams_boost/accumulators/statistics/density.hpp> // for named parameters density_cache_size and density_num_bins
...
namespace tag
{
      ...
      , density_num_bins
    {
        ...
        static streams_boost::parameter::keyword<density_cache_size> const cache_size;
        static streams_boost::parameter::keyword<density_num_bins> const num_bins;
        #endif
    };
}
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(weighted_density)
}
