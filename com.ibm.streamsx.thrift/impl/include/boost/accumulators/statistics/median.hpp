...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_MEDIAN_HPP_EAN_28_10_2005
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_MEDIAN_HPP_EAN_28_10_2005
...
#include <streams_boost/accumulators/statistics/p_square_quantile.hpp>
#include <streams_boost/accumulators/statistics/density.hpp>
#include <streams_boost/accumulators/statistics/p_square_cumulative_distribution.hpp>
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(median)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(with_density_median)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(with_p_square_cumulative_distribution_median)
}
