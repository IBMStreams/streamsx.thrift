...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_COVARIANCE_HPP_DE_01_01_2006
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_COVARIANCE_HPP_DE_01_01_2006
...
#include <streams_boost/numeric/ublas/io.hpp>
...
#include <streams_boost/accumulators/statistics/mean.hpp>
...
namespace streams_boost { namespace numeric
{
    ...
    {
        struct outer_product
          : streams_boost::detail::function2<functional::outer_product<_1, _2, functional::tag<_1>, functional::tag<_2> > >
        {};
    }

    namespace
    {
        op::outer_product const &outer_product = streams_boost::detail::pod_singleton<op::outer_product>::instance;
    }
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(covariance)
}
