...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_HPP_DE_01_01_2006
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_EXTENDED_SINGLE_HPP_DE_01_01_2006
...
//
STREAMS_BOOST_PARAMETER_NESTED_KEYWORD(tag, extended_p_square_probabilities, probabilities)
...
namespace tag
{
      ...
      , extended_p_square_probabilities
    {
        ...
        static streams_boost::parameter::keyword<tag::probabilities> const probabilities;
        #endif
    };
}
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(extended_p_square)
}
