...
#ifndef STREAMS_BOOST_ACCUMULATORS_STATISTICS_SUM_HPP_EAN_28_10_2005
#define STREAMS_BOOST_ACCUMULATORS_STATISTICS_SUM_HPP_EAN_28_10_2005
...
namespace extract
{
    ...
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(sum)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(sum_of_weights)
    STREAMS_BOOST_ACCUMULATORS_IGNORE_GLOBAL(sum_of_variates)
}
