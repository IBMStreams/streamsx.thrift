...
#ifndef STREAMS_BOOST_DETAIL_FUNCTION1_DWA200655_STREAMS_HPP
# define STREAMS_BOOST_DETAIL_FUNCTION1_DWA200655_STREAMS_HPP
...
// streams_boost::result_of and that handle the forwarding problem.
//
...
struct function1
{
    ...
    operator ()(A0 &a0) const
    {
        ...
        typedef A0 &arg0;
        STREAMS_BOOST_CONCEPT_ASSERT((UnaryFunction<impl, type, arg0>));
        //streams_boost::function_requires<UnaryFunctionConcept<impl, type, arg0> >();
        return impl()(a0);
    }
...
#endif // STREAMS_BOOST_DETAIL_FUNCTION1_DWA200655_STREAMS_HPP
