...
#ifndef STREAMS_BOOST_NUMERIC_FUNCTIONAL_VALARRAY_HPP_EAN_12_12_2005
#define STREAMS_BOOST_NUMERIC_FUNCTIONAL_VALARRAY_HPP_EAN_12_12_2005

#ifdef STREAMS_BOOST_NUMERIC_FUNCTIONAL_HPP_INCLUDED
# error Include this file before streams_boost/accumulators/numeric/functional.hpp
#endif
...
#include <streams_boost/typeof/std/valarray.hpp>
...
namespace streams_boost { namespace numeric
{
    ...
    #define STREAMS_BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(Name, Op)                   \
        template<typename Left, typename Right>                                         \
        ...
        STREAMS_BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(plus, +)
        STREAMS_BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(minus, -)
        STREAMS_BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(multiplies, *)
        STREAMS_BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(divides, /)
        STREAMS_BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP(modulus, %)

    #undef STREAMS_BOOST_NUMERIC_FUNCTIONAL_DEFINE_VALARRAY_BIN_OP
          ...
          : std::binary_function<Left, Right, void>
        {
            ...
            {
                STREAMS_BOOST_ASSERT(left.size() == right.size());
          ...
          : std::unary_function<From, bool>
        {
            ...
            {
                STREAMS_BOOST_MPL_ASSERT((is_same<bool, typename From::value_type>));
                for(std::size_t i = 0, size = arr.size(); i != size; ++i)
                {
                    if(!arr[i])
                    {
