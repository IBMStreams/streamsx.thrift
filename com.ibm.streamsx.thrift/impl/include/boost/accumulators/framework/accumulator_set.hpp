...
#ifndef STREAMS_BOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATOR_SET_HPP_EAN_28_10_2005
#define STREAMS_BOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATOR_SET_HPP_EAN_28_10_2005
...
#include <streams_boost/accumulators/framework/accumulators/droppable_accumulator.hpp>
#include <streams_boost/fusion/include/any.hpp>
#include <streams_boost/fusion/include/find_if.hpp>
#include <streams_boost/fusion/include/for_each.hpp>
#include <streams_boost/fusion/include/filter_view.hpp>
...
namespace detail
{
    ///////////////////////////////////////////////////////////////////////////////
    // accumulator_visitor
    //   wrap a streams_boost::parameter argument pack in a Fusion extractor object
  ...
  : detail::accumulator_set_base
{
    ...
    /// INTERNAL ONLY
    ///
    //STREAMS_BOOST_MPL_ASSERT((mpl::is_sequence<accumulators_type>));
    ...
    /// INTERNAL ONLY
    ///
#define STREAMS_BOOST_ACCUMULATORS_ACCUMULATOR_SET_CTOR(z, n, _)                                \
    template<STREAMS_BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
    accumulator_set(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS_Z(z, n, A, const &a))                   \
      : accumulators(                                                                   \
            detail::make_acc_list(                                                      \
                accumulators_mpl_vector()                                               \
              , detail::accumulator_params()(                                           \
                    *this STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS_Z(z, n, a)                      \
                )                                                                       \
            )                                                                           \
        )                                                                               \
    {                                                                                   \
    ...
    STREAMS_BOOST_PP_REPEAT_FROM_TO(
      ...
      , STREAMS_BOOST_ACCUMULATORS_ACCUMULATOR_SET_CTOR
      , _
    )
    ...
    /// INTERNAL ONLY
    ///
#define STREAMS_BOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP(z, n, _)                              \
    template<STREAMS_BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                                  \
    void operator ()(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS_Z(z, n, A, const &a))                  \
    {                                                                                   \
        this->visit(                                                                    \
            detail::make_accumulator_visitor(                                           \
                detail::accumulator_params()(                                           \
    ...
    STREAMS_BOOST_PP_REPEAT_FROM_TO(
        2
      , STREAMS_BOOST_PP_INC(STREAMS_BOOST_ACCUMULATORS_MAX_ARGS)
      , STREAMS_BOOST_ACCUMULATORS_ACCUMULATOR_SET_FUN_OP
      , _
    )
    ...
    void drop()
    {
        ...
        STREAMS_BOOST_MPL_ASSERT((detail::contains_feature_of<Features, the_accumulator>));
...
find_accumulator(AccumulatorSet &acc STREAMS_BOOST_ACCUMULATORS_PROTO_DISABLE_IF_IS_CONST(AccumulatorSet))
{
...
/// INTERNAL ONLY
///
#define STREAMS_BOOST_ACCUMULATORS_EXTRACT_RESULT_FUN(z, n, _)                      \
    template<                                                               \
        typename Feature                                                    \
...
STREAMS_BOOST_PP_REPEAT(
    STREAMS_BOOST_PP_INC(STREAMS_BOOST_ACCUMULATORS_MAX_ARGS)
  , STREAMS_BOOST_ACCUMULATORS_EXTRACT_RESULT_FUN
  , _
)
