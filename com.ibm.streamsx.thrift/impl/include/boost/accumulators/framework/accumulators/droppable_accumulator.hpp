...
#ifndef STREAMS_BOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATORS_DROPPABLE_ACCUMULATOR_HPP_EAN_13_12_2005
#define STREAMS_BOOST_ACCUMULATORS_FRAMEWORK_ACCUMULATORS_DROPPABLE_ACCUMULATOR_HPP_EAN_13_12_2005

#include <new>
#include <streams_boost/assert.hpp>
#include <streams_boost/mpl/apply.hpp>
#include <streams_boost/aligned_storage.hpp>
#include <streams_boost/accumulators/framework/depends_on.hpp> // for feature_of
#include <streams_boost/accumulators/framework/parameters/accumulator.hpp> // for accumulator
...
namespace streams_boost { namespace accumulators
{
      ...
      : Accumulator
    {
        ...
        {
            STREAMS_BOOST_ASSERT(0 < this->ref_count_);
      ...
      : Accumulator
    {
        ...
        void on_drop(Args const &args)
        {
            ...
            STREAMS_BOOST_ASSERT(!this->has_result());
