...
#ifndef STREAMS_BOOST_PARAMETER_PYTHON_060209_HPP
# define STREAMS_BOOST_PARAMETER_PYTHON_060209_HPP

# include <streams_boost/mpl/vector.hpp>
# include <streams_boost/mpl/fold.hpp>
# include <streams_boost/mpl/prior.hpp>
# include <streams_boost/mpl/shift_right.hpp>
# include <streams_boost/mpl/shift_left.hpp>
...
# include <streams_boost/python/def.hpp>
# include <streams_boost/python/make_constructor.hpp>
# include <streams_boost/python/init.hpp>
# include <streams_boost/python/to_python_converter.hpp>
# include <streams_boost/parameter/aux_/maybe.hpp>
# include <streams_boost/parameter/aux_/python/invoker.hpp>

namespace streams_boost { namespace parameter { namespace python 
{
  namespace python_ = streams_boost::python;
}}}
...
namespace aux
{
      ...
      Def def, F f, Iter, End, Keywords const& keywords, mpl::false_)
  {
      ...
      def_combination_aux(
        ...
        , (
              keywords, streams_boost::python::arg(kw::keyword_name())
          )
      );
  }
      ...
      Def def, F f, Iter, End, Keywords const& keywords, mpl::true_)
  {
      ...
      def_combination_aux(
          def, f, typename mpl::next<Iter>::type(), End()
        , (
              keywords, streams_boost::python::arg(kw::keyword_name()) = empty_tag()
          )
      );
  }
  ...
  template <class Class, class CallPolicies = streams_boost::python::default_call_policies>
  struct def_init
  {
      ...
      void operator()(F f) const
      {
          cl.def(
              "__init__"
            , streams_boost::python::make_constructor(f, call_policies)
          );
      }
      ...
      void operator()(F f, Keywords const& keywords) const
      {
          cl.def(
              "__init__"
            , streams_boost::python::make_constructor(f, call_policies, keywords)
          );
      }
  ...
  struct def_function
  {
      ...
      void operator()(F f) const
      {
          streams_boost::python::def(name, f);
      }

      template <class F, class Keywords>
      void operator()(F f, Keywords const& keywords) const
      {
          streams_boost::python::def(name, f, keywords);
      }
...
template <class ParameterSpecs, class CallPolicies = streams_boost::python::default_call_policies>
struct init 
  : streams_boost::python::def_visitor<init<ParameterSpecs, CallPolicies> >
{
    ...
    {
        cl.def(streams_boost::python::init<>()[call_policies]);
    }
...
template <class ParameterSpecs, class CallPolicies = streams_boost::python::default_call_policies>
struct call 
  : streams_boost::python::def_visitor<call<ParameterSpecs, CallPolicies> >
{
...
struct function 
  : streams_boost::python::def_visitor<function<Fwd, ParameterSpecs> >
{
...
}}} // namespace streams_boost::parameter::python

#endif // STREAMS_BOOST_PARAMETER_PYTHON_060209_HPP
