...
#ifndef STREAMS_BOOST_PARAMETERS_031014_HPP
#define STREAMS_BOOST_PARAMETERS_031014_HPP

#include <streams_boost/detail/is_xxx.hpp>
...
#include <streams_boost/parameter/aux_/arg_list.hpp>
#include <streams_boost/parameter/aux_/yesno.hpp>
...
#include <streams_boost/parameter/aux_/template_keyword.hpp>
#include <streams_boost/parameter/aux_/set.hpp>
...
namespace parameter_
{
  ...
  {
      STREAMS_BOOST_MPL_ASSERT((streams_boost::is_same<T,void>));
      typedef int type;
  }; 
} // namespace parameter_
...
namespace aux
{
  ...
  STREAMS_BOOST_DETAIL_IS_XXX_DEF(required, required, 2)
  STREAMS_BOOST_DETAIL_IS_XXX_DEF(optional, optional, 2)
  STREAMS_BOOST_DETAIL_IS_XXX_DEF(deduced_aux, deduced, 1)
  ...
  //    ...>
  //   >
#define STREAMS_BOOST_PARAMETER_make_arg_list(z, n, names)      \
      STREAMS_BOOST_PP_SEQ_ELEM(0,names)<                       \
          STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_SEQ_ELEM(1,names), n),  \
          STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_SEQ_ELEM(2,names), n), 

#define STREAMS_BOOST_PARAMETER_right_angle(z, n, text) >

#define STREAMS_BOOST_PARAMETER_build_arg_list(n, make, parameter_spec, argument_type)      \
  STREAMS_BOOST_PP_REPEAT(                                                                  \
      n, STREAMS_BOOST_PARAMETER_make_arg_list, (make)(parameter_spec)(argument_type))      \
      mpl::identity<void_>                                                          \
  STREAMS_BOOST_PP_REPEAT(n, STREAMS_BOOST_PARAMETER_right_angle, _)

#define STREAMS_BOOST_PARAMETER_make_deduced_list(z, n, names)  \
      STREAMS_BOOST_PP_SEQ_ELEM(0,names)<                       \
          STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_SEQ_ELEM(1,names), n),

#define STREAMS_BOOST_PARAMETER_build_deduced_list(n, make, parameter_spec)                 \
  STREAMS_BOOST_PP_REPEAT(                                                                  \
      n, STREAMS_BOOST_PARAMETER_make_deduced_list, (make)(parameter_spec))                 \
  mpl::identity<void_>                                                              \
  STREAMS_BOOST_PP_REPEAT(n, STREAMS_BOOST_PARAMETER_right_angle, _)
...
#define STREAMS_BOOST_PARAMETER_FORWARD_TYPEDEF(z, i, names) \
    typedef STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_SEQ_ELEM(0,names),i) STREAMS_BOOST_PP_CAT(STREAMS_BOOST_PP_SEQ_ELEM(1,names),i);

#define STREAMS_BOOST_PARAMETER_FORWARD_TYPEDEFS(n, src, dest) \
    STREAMS_BOOST_PP_REPEAT(n, STREAMS_BOOST_PARAMETER_FORWARD_TYPEDEF, (src)(dest))


#define STREAMS_BOOST_PARAMETER_TEMPLATE_ARGS(z, n, text) class STREAMS_BOOST_PP_CAT(PS, n) = void_

template<
     class PS0
   , STREAMS_BOOST_PP_ENUM_SHIFTED(STREAMS_BOOST_PARAMETER_MAX_ARITY, STREAMS_BOOST_PARAMETER_TEMPLATE_ARGS, _)
>
struct parameters
{
#undef STREAMS_BOOST_PARAMETER_TEMPLATE_ARGS

    typedef typename STREAMS_BOOST_PARAMETER_build_deduced_list(
        STREAMS_BOOST_PARAMETER_MAX_ARITY, aux::make_deduced_items, PS
    )::type deduced_list;
...
# define STREAMS_BOOST_PARAMETER_satisfies(z, n, text)                                      \
            mpl::and_<                                                              \
                aux::satisfies_requirements_of<                                     \
                    typename mpl::first<ArgumentPackAndError>::type                 \
                  , STREAMS_BOOST_PP_CAT(PS, n)>                                            \
                  ,
            mpl::and_<
                is_same<typename mpl::second<ArgumentPackAndError>::type, void_>
              , STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_PARAMETER_MAX_ARITY, STREAMS_BOOST_PARAMETER_satisfies, _)
                mpl::true_
                STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_PARAMETER_MAX_ARITY, STREAMS_BOOST_PARAMETER_right_angle, _)
            >

# undef STREAMS_BOOST_PARAMETER_satisfies
    ...
    template<
        ...
        // explicitly specify STREAMS_BOOST_PARAMETER_MAX_ARITY arguments
        STREAMS_BOOST_PP_ENUM_PARAMS(STREAMS_BOOST_PARAMETER_MAX_ARITY, class A)
#else 
        STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(
            STREAMS_BOOST_PARAMETER_MAX_ARITY, class A, = void_ STREAMS_BOOST_PP_INTERCEPT
        )
#endif
    >
    struct match
      ...
      : match_base<
            typename aux::make_arg_list<
                typename STREAMS_BOOST_PARAMETER_build_arg_list(
                    STREAMS_BOOST_PARAMETER_MAX_ARITY, aux::make_items, PS, A
                )::type
              , deduced_list
              , aux::tag_keyword_arg
...
# else
    { 
        typedef parameters<
            STREAMS_BOOST_PP_ENUM_PARAMS(STREAMS_BOOST_PARAMETER_MAX_ARITY, PS)
        > type; 
    };
# endif
    ...
    STREAMS_BOOST_PARAMETER_FORWARD_TYPEDEFS(STREAMS_BOOST_PARAMETER_MAX_ARITY, PS, parameter_spec)
    ...
    operator()(A0& a0) const
    {
        ...
        return result_type(
            ...
            STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(
                STREAMS_BOOST_PP_SUB(STREAMS_BOOST_PARAMETER_MAX_ARITY, 1)
    ...
    operator()(A0& a0, A1& a1) const
    {
        ...
        return result_type(
            ...
            // , void_(), void_() ...
            STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(
                STREAMS_BOOST_PP_SUB(STREAMS_BOOST_PARAMETER_MAX_ARITY, 2)
              , aux::void_reference() STREAMS_BOOST_PP_INTERCEPT)
        );
    }

    // Higher arities are handled by the preprocessor
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1 (3,( \
        3,STREAMS_BOOST_PARAMETER_MAX_ARITY,<streams_boost/parameter/aux_/overloads.hpp> \
    ))
...
#endif // STREAMS_BOOST_PARAMETERS_031014_HPP
