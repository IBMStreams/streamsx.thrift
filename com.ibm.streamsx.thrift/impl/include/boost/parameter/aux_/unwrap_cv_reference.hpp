...
namespace streams_boost { template<class T> class reference_wrapper; }
...
#if STREAMS_BOOST_WORKAROUND(MSVC, == 1200)
template <>
...
// Can't use streams_boost::unwrap_reference<> here because it
