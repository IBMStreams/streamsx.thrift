...
//    given keyword
//
# if STREAMS_BOOST_WORKAROUND(__EDG_VERSION__, <= 300)
...
#  define STREAMS_BOOST_PARAMETER_lazy_default_fallback lazy_default_base
# else 
template <class KW, class DefaultComputer>
struct lazy_default
{
...
#  define STREAMS_BOOST_PARAMETER_lazy_default_fallback lazy_default
# endif 
