...
#ifndef STREAMS_BOOST_SINGLETON_POOL_HPP
#define STREAMS_BOOST_SINGLETON_POOL_HPP

#include <streams_boost/pool/poolfwd.hpp>

// streams_boost::pool
#include <streams_boost/pool/pool.hpp>
// streams_boost::details::pool::singleton_default
#include <streams_boost/pool/detail/singleton.hpp>
// streams_boost::details::pool::guard
#include <streams_boost/pool/detail/guard.hpp>
...
struct singleton_pool
{
  public:
    ...
    STREAMS_BOOST_STATIC_CONSTANT(unsigned, requested_size = RequestedSize);
