...
#ifndef STREAMS_BOOST_POOL_HPP
#define STREAMS_BOOST_POOL_HPP
...
// streams_boost::details::pool::ct_lcm
#include <streams_boost/pool/detail/ct_gcd_lcm.hpp>
// streams_boost::details::pool::lcm
#include <streams_boost/pool/detail/gcd_lcm.hpp>
// streams_boost::simple_segregated_storage
#include <streams_boost/pool/simple_segregated_storage.hpp>
    ...
    typename UserAllocator::size_type>
{
  ...
  private:
    STREAMS_BOOST_STATIC_CONSTANT(unsigned, min_alloc_size =
        (::streams_boost::details::pool::ct_lcm<sizeof(void *), sizeof(size_type)>::value) );
...
void * pool<UserAllocator>::ordered_malloc(const size_type n)
{
  ...
  next_size = max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(next_size, num_chunks);
  const size_type POD_size = next_size * partition_size +
      details::pool::ct_lcm<sizeof(size_type), sizeof(void *)>::value + sizeof(size_type);
  char * const ptr = UserAllocator::malloc(POD_size);
  if (ptr == 0)
