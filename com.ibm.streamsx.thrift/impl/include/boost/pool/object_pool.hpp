...
#ifndef STREAMS_BOOST_OBJECT_POOL_HPP
#define STREAMS_BOOST_OBJECT_POOL_HPP

#include <streams_boost/pool/poolfwd.hpp>

// streams_boost::pool
#include <streams_boost/pool/pool.hpp>

// The following code will be put into Boost.Config in a later revision
#if defined(STREAMS_BOOST_MSVC) || defined(__KCC)
# define STREAMS_BOOST_NO_TEMPLATE_CV_REF_OVERLOADS
#endif
...
class object_pool: protected pool<UserAllocator>
{
  ...
  public:
    ...
    //  functions
#ifndef STREAMS_BOOST_NO_TEMPLATE_CV_REF_OVERLOADS
#   include <streams_boost/pool/detail/pool_construct.inc>
#else
#   include <streams_boost/pool/detail/pool_construct_simple.inc>
#endif
