...
#ifndef STREAMS_BOOST_BIMAP_PROPERTY_MAP_UNORDERED_SET_SUPPORT_HPP
#define STREAMS_BOOST_BIMAP_PROPERTY_MAP_UNORDERED_SET_SUPPORT_HPP
...
#include <streams_boost/bimap/unordered_set_of.hpp>
...
struct property_traits< ::streams_boost::bimaps::views::unordered_map_view<Tag,Bimap> >
{
...
const STREAMS_BOOST_DEDUCED_TYPENAME ::streams_boost::bimaps::support::data_type_by<Tag,Bimap>::type &
    get(const ::streams_boost::bimaps::views::unordered_map_view<Tag,Bimap> & m,
...
#endif // STREAMS_BOOST_BIMAP_PROPERTY_MAP_UNORDERED_SET_SUPPORT_HPP
