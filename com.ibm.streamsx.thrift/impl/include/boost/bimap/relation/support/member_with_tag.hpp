...
#ifndef STREAMS_BOOST_BIMAP_RELATION_SUPPORT_MEMBER_WITH_TAG_HPP
#define STREAMS_BOOST_BIMAP_RELATION_SUPPORT_MEMBER_WITH_TAG_HPP
...
/** \struct streams_boost::bimaps::relation::support::member_with_tag
...
struct member_with_tag
{
    STREAMS_BOOST_BIMAP_STATIC_ERROR( MEMBER_WITH_TAG_FAILURE, (Relation,Tag) );
};
...
<
    ...
    <
        ...
        <
            ...
            <
                Tag,
                STREAMS_BOOST_DEDUCED_TYPENAME Relation::left_tag
            >
        >
...
<
    ...
    <
        ...
        <
            ...
            <
                Tag,
                STREAMS_BOOST_DEDUCED_TYPENAME Relation::right_tag
            >
        >
...
<
    ...
    <
        ...
        <
            ...
            <
                Tag,
                STREAMS_BOOST_DEDUCED_TYPENAME Relation::info_tag
            >
        >
...
#endif // STREAMS_BOOST_BIMAP_RELATION_SUPPORT_MEMBER_WITH_TAG_HPP
