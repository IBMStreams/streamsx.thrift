...
#ifndef STREAMS_BOOST_BIMAP_RELATION_SUPPORT_DATA_EXTRACTOR_HPP
#define STREAMS_BOOST_BIMAP_RELATION_SUPPORT_DATA_EXTRACTOR_HPP
...
/** \struct streams_boost::bimaps::relation::support::data_extractor
...
struct data_extractor_implementation< member_at::left, Relation > :
    public std::unary_function<Relation,STREAMS_BOOST_DEDUCED_TYPENAME Relation::left_value_type>
{
    STREAMS_BOOST_DEDUCED_TYPENAME Relation::left_value_type const &
        operator()(Relation const & rel) const
    {
        return rel.left;
    }

    STREAMS_BOOST_DEDUCED_TYPENAME Relation::left_value_type &
...
struct data_extractor_implementation< member_at::right, Relation > :
    public std::unary_function<Relation,STREAMS_BOOST_DEDUCED_TYPENAME Relation::right_value_type>
{
    STREAMS_BOOST_DEDUCED_TYPENAME Relation::right_value_type const & 
        operator()(Relation const & rel) const
    {
        return rel.right;
    }

    STREAMS_BOOST_DEDUCED_TYPENAME Relation::right_value_type & 
        operator()(Relation       & rel) const
    {
        return rel.right;
    }
...
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME Relation::storage_base result_type;
...
#endif // STREAMS_BOOST_BIMAP_RELATION_SUPPORT_DATA_EXTRACTOR_HPP
