...
#ifndef STREAMS_BOOST_BIMAP_RELATION_SUPPORT_VALUE_TYPE_OF_HPP
#define STREAMS_BOOST_BIMAP_RELATION_SUPPORT_VALUE_TYPE_OF_HPP
...
/** \struct streams_boost::bimaps::relation::support::value_type_of
...
<
    ...
    <
        ::streams_boost::bimaps::relation::support::is_tag_of_member_at_info
        <
            Tag,
            SymmetricType
        >
...
>
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME SymmetricType::info_type type;
};
...
#endif // STREAMS_BOOST_BIMAP_RELATION_SUPPORT_VALUE_TYPE_OF_HPP
