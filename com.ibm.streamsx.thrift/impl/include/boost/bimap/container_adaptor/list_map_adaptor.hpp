...
#ifndef STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_LIST_MAP_ADAPTOR_HPP
#define STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_LIST_MAP_ADAPTOR_HPP
...
#include <streams_boost/bimap/container_adaptor/detail/key_extractor.hpp>
...
struct list_map_adaptor_base
{
    ...
    <
        ...
        STREAMS_BOOST_DEDUCED_TYPENAME mpl::push_front<
            ...
            STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_< ::streams_boost::mpl::is_na<KeyFromBaseValueConverter>,
            // {
...
<
    ...
    class KeyFromBaseValueConverter        = ::streams_boost::mpl::na,
...
class list_map_adaptor :
    ...
    >::type
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME list_map_adaptor_base
    <
        Base, Iterator, ConstIterator, ReverseIterator, ConstReverseIterator,
        IteratorToBaseConverter, IteratorFromBaseConverter,
        ReverseIteratorFromBaseConverter,
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_< ::streams_boost::mpl::is_na<KeyFromBaseValueConverter>,
    // {
            detail::key_from_pair_extractor< STREAMS_BOOST_DEDUCED_TYPENAME Iterator::value_type >,
    // }
    // else
    // {
            KeyFromBaseValueConverter
...
#endif // STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_LIST_MAP_ADAPTOR_HPP
