...
#ifndef STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_ORDERED_ASSOCIATIVE_CONTAINER_ADAPTOR_HPP
#define STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_ORDERED_ASSOCIATIVE_CONTAINER_ADAPTOR_HPP
    ...
    >
{
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME ordered_associative_container_adaptor_base
    <
        Base, Iterator, ConstIterator,
        ReverseIterator, ConstReverseIterator, KeyType,
        IteratorToBaseConverter, IteratorFromBaseConverter,
    ...
    <
        STREAMS_BOOST_DEDUCED_TYPENAME Base::key_compare,
        STREAMS_BOOST_DEDUCED_TYPENAME base_::key_type,
        STREAMS_BOOST_DEDUCED_TYPENAME base_::key_to_base

    > key_compare;

    typedef detail::comparison_adaptor
    <
        STREAMS_BOOST_DEDUCED_TYPENAME Base::value_compare,
    ...
    {
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_::key_to_base key_to_base_;
    ...
    {
        typedef STREAMS_BOOST_DEDUCED_TYPENAME base_::value_to_base value_to_base_;
    ...
    STREAMS_BOOST_DEDUCED_TYPENAME base_::iterator lower_bound(const CompatibleKey & k)
    {
       return this->template functor<
    ...
    template< class CompatibleKey >
    STREAMS_BOOST_DEDUCED_TYPENAME base_::const_iterator lower_bound(const CompatibleKey & k) const
    {
       return this->template functor<
            STREAMS_BOOST_DEDUCED_TYPENAME base_::iterator_from_base>()(
                this->base().lower_bound(
    ...
    template< class CompatibleKey >
    STREAMS_BOOST_DEDUCED_TYPENAME base_::iterator upper_bound(const CompatibleKey & k)
    {
       return this->template functor<
            STREAMS_BOOST_DEDUCED_TYPENAME base_::iterator_from_base>()(
    ...
    template< class CompatibleKey >
    STREAMS_BOOST_DEDUCED_TYPENAME base_::const_iterator upper_bound(const CompatibleKey & k) const
    {
        return this->template functor<
            STREAMS_BOOST_DEDUCED_TYPENAME base_::iterator_from_base>()(
                this->base().upper_bound(
...
#endif // STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_ORDERED_ASSOCIATIVE_CONTAINER_ADAPTOR_HPP
