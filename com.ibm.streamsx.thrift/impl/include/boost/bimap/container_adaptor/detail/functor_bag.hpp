...
#ifndef STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_DETAIL_FUNCTOR_BAG_HPP
#define STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_DETAIL_FUNCTOR_BAG_HPP
    ...
    >::type
{
    ...
    data_with_functor_bag(STREAMS_BOOST_DEDUCED_TYPENAME add_reference<Data>::type d)
        : data(d) {}
...
#endif // STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_DETAIL_FUNCTOR_BAG_HPP
