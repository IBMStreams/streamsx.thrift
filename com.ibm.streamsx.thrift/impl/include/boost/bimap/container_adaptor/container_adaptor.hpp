...
#ifndef STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_CONTAINER_ADAPTOR_HPP
#define STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_CONTAINER_ADAPTOR_HPP
...
#include <streams_boost/bimap/container_adaptor/detail/functor_bag.hpp>
...
class container_adaptor
{
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_value    <       iterator >::type value_type;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_pointer  <       iterator >::type pointer;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_reference<       iterator >::type reference;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_reference< const_iterator >::type const_reference;

    typedef STREAMS_BOOST_DEDUCED_TYPENAME Base::size_type size_type;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME Base::difference_type difference_type;

    typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_< ::streams_boost::mpl::is_na<IteratorToBaseConverter>,
        // {
                ::streams_boost::bimaps::container_adaptor::detail::
                    iterator_to_base_identity
                <
                    STREAMS_BOOST_DEDUCED_TYPENAME Base::iterator                , iterator,
                    STREAMS_BOOST_DEDUCED_TYPENAME Base::const_iterator          , const_iterator
                >,
        // }
        // else
        // {
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_< ::streams_boost::mpl::is_na<IteratorFromBaseConverter>,
        // {
                ::streams_boost::bimaps::container_adaptor::detail::
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_< ::streams_boost::mpl::is_na<ValueToBaseConverter>,
        // {
                ::streams_boost::bimaps::container_adaptor::detail::
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_< ::streams_boost::mpl::is_na<ValueFromBaseConverter>,
        // {
                ::streams_boost::bimaps::container_adaptor::detail::
    ...
    std::pair<iterator, bool> insert(
        STREAMS_BOOST_DEDUCED_TYPENAME ::streams_boost::call_traits< value_type >::param_type x)
    {
    ...
    ::streams_boost::bimaps::container_adaptor::detail::data_with_functor_bag
    <
        Base &,

        STREAMS_BOOST_DEDUCED_TYPENAME mpl::copy
        <
            mpl::vector
            <
                iterator_to_base,
...
#endif // STREAMS_BOOST_BIMAP_CONTAINER_ADAPTOR_CONTAINER_ADAPTOR_HPP
