...
#ifndef STREAMS_BOOST_BIMAP_DETAIL_CONCEPT_TAGS_HPP
#define STREAMS_BOOST_BIMAP_DETAIL_CONCEPT_TAGS_HPP
...
/** \struct streams_boost::bimaps::left_based
...
/** \struct streams_boost::bimaps::right_based
...
struct left_based : ::streams_boost::bimaps::detail::side_based_tag
{
...
struct right_based : ::streams_boost::bimaps::detail::side_based_tag
{
    // I run into troubles if I do not define bind for side based tags.
    // Maybe a more coherent way of binding the relation can be developped.
    template< class Relation > struct bind_to { typedef void type; };
...
#endif // STREAMS_BOOST_BIMAP_DETAIL_CONCEPT_TAGS_HPP
