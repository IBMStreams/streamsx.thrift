...
#ifndef STREAMS_BOOST_BIMAP_DETAIL_MANAGE_ADDITIONAL_PARAMETERS_HPP
#define STREAMS_BOOST_BIMAP_DETAIL_MANAGE_ADDITIONAL_PARAMETERS_HPP
...
template< class Type >
struct is_with_info : ::streams_boost::mpl::false_ {};

template< class ValueType >
struct is_with_info< with_info<ValueType> > : ::streams_boost::mpl::true_ {};

/** \struct streams_boost::bimaps::detail::manage_additional_parameters
\brief Utility class to extract the additional parameters from the template parameters.
...
struct manage_additional_parameters
{
    ...
    struct case_NNN
    {
        ...
        typedef ::streams_boost::mpl::na additional_info;
    };
    ...
    struct case_HNN
    {
        typedef left_based set_type_of_relation;
        typedef std::allocator<void> allocator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME AP1::value_type additional_info;
    };
    ...
    struct case_SHN
    {
        typedef AP1 set_type_of_relation;
        typedef std::allocator<void> allocator;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME AP2::value_type additional_info;
    };
    ...
    <
        ::streams_boost::mpl::is_na<AP1>,
        case_NNN, // (1)
        STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_
        <
            ::streams_boost::mpl::is_na<AP2>,
            STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_
            <
...
#endif // STREAMS_BOOST_BIMAP_DETAIL_MANAGE_ADDITIONAL_PARAMETERS_HPP
