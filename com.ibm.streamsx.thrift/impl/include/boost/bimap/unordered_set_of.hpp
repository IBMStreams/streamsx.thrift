...
#ifndef STREAMS_BOOST_BIMAP_UNORDERED_SET_OF_HPP
#define STREAMS_BOOST_BIMAP_UNORDERED_SET_OF_HPP
...
#include <streams_boost/bimap/views/unordered_map_view.hpp>
#include <streams_boost/bimap/views/unordered_set_view.hpp>
...
STREAMS_BOOST_STATIC_ASSERT( is_set_type_of< unordered_set_of<Type> >::value )
...
<
    ...
    class EqualKey      = std::equal_to< STREAMS_BOOST_DEDUCED_TYPENAME 
        ::streams_boost::bimaps::tags::support::value_type_of<KeyType>::type >
>
struct unordered_set_of : public ::streams_boost::bimaps::detail::set_type_of_tag
{
...
>
struct unordered_set_of_relation : public ::streams_boost::bimaps::detail::set_type_of_relation_tag
{
    /// Hash Functor that takes value_type objects
    typedef HashFunctor     hasher;
...
#endif // STREAMS_BOOST_BIMAP_UNORDERED_SET_OF_HPP
