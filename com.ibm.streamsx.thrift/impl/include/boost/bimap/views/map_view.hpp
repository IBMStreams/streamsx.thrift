...
#ifndef STREAMS_BOOST_BIMAP_VIEWS_MAP_VIEW_HPP
#define STREAMS_BOOST_BIMAP_VIEWS_MAP_VIEW_HPP
...
#include <streams_boost/bimap/container_adaptor/map_adaptor.hpp>
        ...
        unique_map_view_access< map_view<Tag,BimapType>, Tag,  BimapType>::type
{
    ...
    STREAMS_BOOST_BIMAP_MAP_VIEW_BASE_FRIEND(map_view,Tag,BimapType)
    ...
    map_view(STREAMS_BOOST_DEDUCED_TYPENAME base_::base_type & c) : base_(c) {}
...
template< class Tag, class BimapType >
struct left_map_view_extra_typedefs< ::streams_boost::bimaps::views::map_view<Tag,BimapType> >
{
    private: typedef ::streams_boost::bimaps::views::map_view<Tag,BimapType> map_view_;
    public : STREAMS_BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_,left)
};

template< class Tag, class BimapType >
struct right_map_view_extra_typedefs< ::streams_boost::bimaps::views::map_view<Tag,BimapType> >
{
    private: typedef ::streams_boost::bimaps::views::map_view<Tag,BimapType> map_view_;
