...
#ifndef STREAMS_BOOST_BIMAP_UNORDERED_MULTISET_OF_HPP
#define STREAMS_BOOST_BIMAP_UNORDERED_MULTISET_OF_HPP
...
#include <streams_boost/bimap/views/unordered_multimap_view.hpp>
#include <streams_boost/bimap/views/unordered_multiset_view.hpp>
...
STREAMS_BOOST_STATIC_ASSERT( is_set_type_of< unordered_multiset_of<Type> >::value )
...
<
    class KeyType,
    class HashFunctor   = hash< STREAMS_BOOST_DEDUCED_TYPENAME 
        ::streams_boost::bimaps::tags::support::value_type_of<KeyType>::type >,
    class EqualKey      = std::equal_to< STREAMS_BOOST_DEDUCED_TYPENAME 
        ::streams_boost::bimaps::tags::support::value_type_of<KeyType>::type >
>
struct unordered_multiset_of : public ::streams_boost::bimaps::detail::set_type_of_tag
{
    ...
    struct lazy_concept_checked
    {
        ...
        STREAMS_BOOST_CLASS_REQUIRE3( hasher, std::size_t, value_type,
                              streams_boost, UnaryFunctionConcept );

        STREAMS_BOOST_CLASS_REQUIRE4( key_equal, bool, value_type, value_type,
                              streams_boost, BinaryFunctionConcept );

        typedef unordered_multiset_of type;
    };

    STREAMS_BOOST_BIMAP_GENERATE_INDEX_BINDER_2CP(
...
>
struct unordered_multiset_of_relation : public ::streams_boost::bimaps::detail::set_type_of_relation_tag
{
    /// Hash Functor that takes value_type objects
    typedef HashFunctor     hasher;
    ...
    STREAMS_BOOST_BIMAP_GENERATE_RELATION_BINDER_2CP(
...
#endif // STREAMS_BOOST_BIMAP_UNORDERED_MULTISET_OF_HPP
