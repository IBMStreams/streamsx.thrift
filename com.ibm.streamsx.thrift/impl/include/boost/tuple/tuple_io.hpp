...
#ifndef STREAMS_BOOST_TUPLE_IO_HPP
#define STREAMS_BOOST_TUPLE_IO_HPP
...
public:   
   ...
   STREAMS_BOOST_STATIC_CONSTANT(int, number_of_manipulators = delimiter + 1);
private:
...
#endif // STREAMS_BOOST_NO_TEMPLATED_STREAMS
};
...
#endif // STREAMS_BOOST_TUPLE_IO_HPP
