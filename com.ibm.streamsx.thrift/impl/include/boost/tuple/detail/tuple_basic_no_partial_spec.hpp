...
// For more information, see http://www.streams_boost.org or http://lambda.cs.utu.fi
...
#ifndef STREAMS_BOOST_TUPLE_BASIC_NO_PARTIAL_SPEC_HPP
#define STREAMS_BOOST_TUPLE_BASIC_NO_PARTIAL_SPEC_HPP
...
// forward declaration of cons
   ...
   struct cons
   {
    ...
    private:
       typedef typename streams_boost::add_reference<head_type>::type head_ref;
       typedef typename streams_boost::add_reference<tail_type>::type tail_ref;
    ...
    struct length
    {
      STREAMS_BOOST_STATIC_CONSTANT(int, value = 1 + length<typename Tuple::tail_type>::value);
    };
...
#endif // STREAMS_BOOST_TUPLE_BASIC_NO_PARTIAL_SPEC_HPP
