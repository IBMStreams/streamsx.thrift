...
#ifndef STREAMS_BOOST_TUPLE_COMPARISON_HPP
#define STREAMS_BOOST_TUPLE_COMPARISON_HPP
...
inline bool operator==(const cons<T1, T2>& lhs, const cons<S1, S2>& rhs)
{
  ...
  STREAMS_BOOST_STATIC_ASSERT(length<T2>::value == length<S2>::value);
...
#endif // STREAMS_BOOST_TUPLE_COMPARISON_HPP
