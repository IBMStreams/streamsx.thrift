...
#ifndef STREAMS_BOOST_LOGIC_TRIBOOL_HPP
#define STREAMS_BOOST_LOGIC_TRIBOOL_HPP

#include <streams_boost/logic/tribool_fwd.hpp>
...
{
#if STREAMS_BOOST_WORKAROUND(__BORLANDC__, < 0x0600)
 ...
 * macro \c STREAMS_BOOST_TRIBOOL_THIRD_STATE.
 *
...
// Pull tribool and indeterminate into namespace "streams_boost"
 ...
 *
 * Example:
 *   STREAMS_BOOST_TRIBOOL_THIRD_STATE(true_or_false)
 *
 ...
 *   }
 */
#define STREAMS_BOOST_TRIBOOL_THIRD_STATE(Name)                                 \
inline bool                                                             \
Name(streams_boost::logic::tribool x,                                           \
     streams_boost::logic::detail::indeterminate_t dummy =                      \
       streams_boost::logic::detail::indeterminate_t())                         \
{ return x.value == streams_boost::logic::tribool::indeterminate_value; }

#endif // STREAMS_BOOST_LOGIC_TRIBOOL_HPP
