...
namespace streams_boost
{
    namespace detail
    {
        ...
        struct thread_data_base
        {
            ...
            streams_boost::detail::tss_data_node* tss_data;
            ...
            {
                STREAMS_BOOST_INTERLOCKED_INCREMENT(&p->count);
            }
            
            friend void intrusive_ptr_release(thread_data_base * p)
            {
                if(!STREAMS_BOOST_INTERLOCKED_DECREMENT(&p->count))
                {
            ...
            void interrupt()
            {
                STREAMS_BOOST_VERIFY(detail::win32::SetEvent(interruption_handle)!=0);
            }
        ...
        typedef streams_boost::intrusive_ptr<detail::thread_data_base> thread_data_ptr;
        ...
        struct timeout
        {
            ...
            bool relative;
            streams_boost::system_time abs_time;
            ...
            timeout(uintmax_t milliseconds_):
                ...
                relative(true),
                abs_time(streams_boost::get_system_time())
            {}

            timeout(streams_boost::system_time const& abs_time_):
                start(win32::GetTickCount()),
                milliseconds(0),
                relative(false),
                abs_time(abs_time_)
    ...
    namespace this_thread
    {
        ...
        bool STREAMS_BOOST_THREAD_DECL interruptible_wait(detail::win32::handle handle_to_wait_for,detail::timeout target_time);
