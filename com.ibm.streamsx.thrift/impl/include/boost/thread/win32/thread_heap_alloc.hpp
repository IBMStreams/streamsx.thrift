...
namespace streams_boost
{
    namespace detail
    {
        inline STREAMS_BOOST_THREAD_DECL void* allocate_raw_heap_memory(unsigned size)
        {
        ...
        inline STREAMS_BOOST_THREAD_DECL void free_raw_heap_memory(void* heap_memory)
        {
            STREAMS_BOOST_VERIFY(detail::win32::HeapFree(detail::win32::GetProcessHeap(),0,heap_memory)!=0);
        }
