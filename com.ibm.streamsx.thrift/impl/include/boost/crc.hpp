...
//  LICENSE_1_0.txt or a copy at <http://www.streams_boost.org/LICENSE_1_0.txt>.)

//  See <http://www.streams_boost.org/libs/crc/> for the library's home page.

#ifndef STREAMS_BOOST_CRC_HPP
#define STREAMS_BOOST_CRC_HPP
...
#if !(defined(STREAMS_BOOST_NO_DEPENDENT_TYPES_IN_TEMPLATE_VALUE_PARAMETERS) || (defined(STREAMS_BOOST_MSVC) && (STREAMS_BOOST_MSVC <= 1300)))
#define STREAMS_BOOST_CRC_PARM_TYPE  typename ::streams_boost::uint_t<Bits>::fast
#else
#define STREAMS_BOOST_CRC_PARM_TYPE  unsigned long
#endif
...
#if defined(__GNUC__) || !defined(STREAMS_BOOST_NO_EXPLICIT_FUNCTION_TEMPLATE_ARGUMENTS)
#define STREAMS_BOOST_CRC_DUMMY_PARM_TYPE
#define STREAMS_BOOST_CRC_DUMMY_INIT
#define STREAMS_BOOST_ACRC_DUMMY_PARM_TYPE
#define STREAMS_BOOST_ACRC_DUMMY_INIT
#else
namespace streams_boost { namespace detail {
    template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly,
     STREAMS_BOOST_CRC_PARM_TYPE InitRem, STREAMS_BOOST_CRC_PARM_TYPE FinalXor,
     bool ReflectIn, bool ReflectRem >
    struct dummy_crc_argument  { };
} }
#define STREAMS_BOOST_CRC_DUMMY_PARM_TYPE   , detail::dummy_crc_argument<Bits, \
 TruncPoly, InitRem, FinalXor, ReflectIn, ReflectRem> *p_
#define STREAMS_BOOST_CRC_DUMMY_INIT        STREAMS_BOOST_CRC_DUMMY_PARM_TYPE = 0
#define STREAMS_BOOST_ACRC_DUMMY_PARM_TYPE  , detail::dummy_crc_argument<Bits, \
 TruncPoly, 0, 0, false, false> *p_
#define STREAMS_BOOST_ACRC_DUMMY_INIT       STREAMS_BOOST_ACRC_DUMMY_PARM_TYPE = 0
#endif
...
template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly = 0u,
           STREAMS_BOOST_CRC_PARM_TYPE InitRem = 0u,
           STREAMS_BOOST_CRC_PARM_TYPE FinalXor = 0u, bool ReflectIn = false,
...
template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly,
    ...
    typename uint_t<Bits>::fast  crc( void const *buffer,
     ...
     STREAMS_BOOST_CRC_DUMMY_PARM_TYPE );
...
template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly >
    typename uint_t<Bits>::fast  augmented_crc( void const *buffer,
     ...
     STREAMS_BOOST_ACRC_DUMMY_PARM_TYPE );
...
namespace detail
{
    ...
    template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly, bool Reflect >
        struct crc_table_t;
...
public:
    ...
    STREAMS_BOOST_STATIC_CONSTANT( std::size_t, bit_count = Bits );
    STREAMS_BOOST_STATIC_CONSTANT( value_type, truncated_polynominal = TruncPoly );
    STREAMS_BOOST_STATIC_CONSTANT( value_type, initial_remainder = InitRem );
    STREAMS_BOOST_STATIC_CONSTANT( value_type, final_xor_value = FinalXor );
    STREAMS_BOOST_STATIC_CONSTANT( bool, reflect_input = ReflectIn );
    STREAMS_BOOST_STATIC_CONSTANT( bool, reflect_remainder = ReflectRem );
...
private:
    ...
    STREAMS_BOOST_STATIC_CONSTANT( bool, reflect_output = (ReflectRem != ReflectIn) );

    #ifndef __BORLANDC__
    #define STREAMS_BOOST_CRC_REF_OUT_VAL  reflect_output
    #else
    typedef crc_optimal  self_type;
    #define STREAMS_BOOST_CRC_REF_OUT_VAL  (self_type::reflect_output)
    #endif
    ...
    typedef detail::crc_helper<Bits, STREAMS_BOOST_CRC_REF_OUT_VAL>  reflect_out_type;

    #undef STREAMS_BOOST_CRC_REF_OUT_VAL

    // Member data
    value_type  rem_;

};  // streams_boost::crc_optimal
...
namespace detail
{
    ...
    template < std::size_t Bits >
    struct high_uint_t
        : streams_boost::uint_t< Bits >
    {
        typedef streams_boost::uint_t<Bits>        base_type;
...
#else
        STREAMS_BOOST_STATIC_CONSTANT( least, high_bit = (least( 1u ) << ( Bits
         - 1u )) );
        STREAMS_BOOST_STATIC_CONSTANT( fast, high_bit_fast = (fast( 1u ) << ( Bits
         - 1u )) );
#endif

    };  // streams_boost::detail::high_uint_t
    ...
    struct reflector
    {
        typedef typename streams_boost::uint_t<Bits>::fast  value_type;

        static  value_type  reflect( value_type x );

    };  // streams_boost::detail::reflector
        ...
        : high_uint_t< Bits >
    {
        ...
        #else
        STREAMS_BOOST_STATIC_CONSTANT( least, high_bit = base_type::high_bit );
        STREAMS_BOOST_STATIC_CONSTANT( fast, high_bit_fast = base_type::high_bit_fast );
        #endif
        ...
        STREAMS_BOOST_STATIC_CONSTANT( fast, sig_bits_fast = static_cast<fast>(sig_bits) );
#else
        STREAMS_BOOST_STATIC_CONSTANT( fast, sig_bits_fast = fast(sig_bits) );
#endif
    };  // streams_boost::detail::mask_uint_t
    ...
    struct crc_table_t
    {
        STREAMS_BOOST_STATIC_CONSTANT( std::size_t, byte_combos = (1ul << CHAR_BIT) );
    ...
    };  // streams_boost::detail::crc_table_t
    ...
    };  // streams_boost::detail::crc_helper
...
#define STREAMS_BOOST_CRC_OPTIMAL_NAME  crc_optimal<Bits, TruncPoly, InitRem, \
...
template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly,
           ...
           bool ReflectIn, bool ReflectRem >
inline
STREAMS_BOOST_CRC_OPTIMAL_NAME::crc_optimal
(
    typename STREAMS_BOOST_CRC_OPTIMAL_NAME::value_type  init_rem  // = InitRem
)
...
template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly,
           ...
           bool ReflectIn, bool ReflectRem >
inline
typename STREAMS_BOOST_CRC_OPTIMAL_NAME::value_type
STREAMS_BOOST_CRC_OPTIMAL_NAME::get_truncated_polynominal
(
) const
{
    return TruncPoly;
...
inline
typename STREAMS_BOOST_CRC_OPTIMAL_NAME::value_type
STREAMS_BOOST_CRC_OPTIMAL_NAME::get_initial_remainder
(
) const
{
    return InitRem;
...
inline
typename STREAMS_BOOST_CRC_OPTIMAL_NAME::value_type
STREAMS_BOOST_CRC_OPTIMAL_NAME::get_final_xor_value
(
) const
{
    return FinalXor;
...
inline
bool
STREAMS_BOOST_CRC_OPTIMAL_NAME::get_reflect_input
(
) const
{
    return ReflectIn;
...
inline
bool
STREAMS_BOOST_CRC_OPTIMAL_NAME::get_reflect_remainder
(
) const
{
    return ReflectRem;
...
inline
typename STREAMS_BOOST_CRC_OPTIMAL_NAME::value_type
STREAMS_BOOST_CRC_OPTIMAL_NAME::get_interim_remainder
(
) const
{
...
inline
void
STREAMS_BOOST_CRC_OPTIMAL_NAME::reset
(
    typename STREAMS_BOOST_CRC_OPTIMAL_NAME::value_type  new_rem  // = InitRem
)
{
...
inline
void
STREAMS_BOOST_CRC_OPTIMAL_NAME::process_byte
(
    unsigned char  byte
)
{
...
template < std::size_t Bits, STREAMS_BOOST_CRC_PARM_TYPE TruncPoly,
           ...
           bool ReflectIn, bool ReflectRem >
void
STREAMS_BOOST_CRC_OPTIMAL_NAME::process_block
(
    void const *  bytes_begin,
    void const *  bytes_end
)
...
inline
void
STREAMS_BOOST_CRC_OPTIMAL_NAME::process_bytes
(
    void const *   buffer,
    std::size_t  byte_count
)
...
inline
typename STREAMS_BOOST_CRC_OPTIMAL_NAME::value_type
STREAMS_BOOST_CRC_OPTIMAL_NAME::checksum
(
) const
{
...
inline
void
STREAMS_BOOST_CRC_OPTIMAL_NAME::operator ()
(
    unsigned char  byte
)
{
...
(
    void const *  buffer,
    std::size_t   byte_count
    STREAMS_BOOST_CRC_DUMMY_INIT
)
{
    STREAMS_BOOST_CRC_OPTIMAL_NAME  computer;
...
)
{
   ...
   // STREAMS_BOOST_ACRC_DUMMY_INIT added a third argument (for a workaround), the "0"
...
#undef STREAMS_BOOST_CRC_OPTIMAL_NAME
#undef STREAMS_BOOST_ACRC_DUMMY_INIT
#undef STREAMS_BOOST_ACRC_DUMMY_PARM_TYPE
#undef STREAMS_BOOST_CRC_DUMMY_INIT
#undef STREAMS_BOOST_CRC_DUMMY_PARM_TYPE
#undef STREAMS_BOOST_CRC_PARM_TYPE


#endif  // STREAMS_BOOST_CRC_HPP
