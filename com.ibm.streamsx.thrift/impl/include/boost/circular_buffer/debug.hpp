...
#if !defined(STREAMS_BOOST_CIRCULAR_BUFFER_DEBUG_HPP)
#define STREAMS_BOOST_CIRCULAR_BUFFER_DEBUG_HPP
...
#endif // #if !defined(STREAMS_BOOST_CIRCULAR_BUFFER_DEBUG_HPP)
