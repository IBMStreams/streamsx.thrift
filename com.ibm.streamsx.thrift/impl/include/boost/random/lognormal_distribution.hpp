/* streams_boost random/lognormal_distribution.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP
#define STREAMS_BOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP

#include <streams_boost/config/no_tr1/cmath.hpp>      // std::exp, std::sqrt
#include <cassert>
#include <iostream>
...
#endif // STREAMS_BOOST_RANDOM_LOGNORMAL_DISTRIBUTION_HPP
