/* streams_boost random/subtract_with_carry.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_SUBTRACT_WITH_CARRY_HPP
#define STREAMS_BOOST_RANDOM_SUBTRACT_WITH_CARRY_HPP
...
#  define STREAMS_BOOST_RANDOM_EXTRACT_SWC_01
#endif
...
# ifdef STREAMS_BOOST_RANDOM_EXTRACT_SWC_01
namespace detail
{
...
public:
  ...
  STREAMS_BOOST_STATIC_CONSTANT(result_type, min_value = 0);
  STREAMS_BOOST_STATIC_CONSTANT(result_type, max_value = m-1);
  STREAMS_BOOST_STATIC_CONSTANT(result_type, modulus = m);
  STREAMS_BOOST_STATIC_CONSTANT(unsigned int, long_lag = r);
  STREAMS_BOOST_STATIC_CONSTANT(unsigned int, short_lag = s);
  ...
  STREAMS_BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(subtract_with_carry, uint32_t, value)
  { seed(value); }
  STREAMS_BOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(subtract_with_carry, Generator, gen)
  { seed(gen); }
  ...
  STREAMS_BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(subtract_with_carry, uint32_t, value)
  {
  ...
  STREAMS_BOOST_RANDOM_DETAIL_GENERATOR_SEED(subtract_with_carry, Generator, gen)
  {
...
#endif // STREAMS_BOOST_RANDOM_SUBTRACT_WITH_CARRY_HPP
