/* streams_boost random/detail/uniform_int_float.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_DETAIL_PASS_THROUGH_ENGINE_HPP
#define STREAMS_BOOST_RANDOM_DETAIL_PASS_THROUGH_ENGINE_HPP
...
public:
  ...
  result_type min STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION () const { return (base().min)(); }
  result_type max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION () const { return (base().max)(); }
...
#endif // STREAMS_BOOST_RANDOM_DETAIL_PASS_THROUGH_ENGINE_HPP
