/* streams_boost random/detail/const_mod.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_CONST_MOD_HPP
#define STREAMS_BOOST_RANDOM_CONST_MOD_HPP
...
private:
  ...
  static IntType invert_euclidian(IntType c)
  {
    ...
    STREAMS_BOOST_STATIC_ASSERT(m > 0);
#if STREAMS_BOOST_WORKAROUND(__MWERKS__, STREAMS_BOOST_TESTED_AT(0x3003))
    assert(streams_boost::integer_traits<IntType>::is_signed);
#elif !defined(STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS)
    STREAMS_BOOST_STATIC_ASSERT(streams_boost::integer_traits<IntType>::is_signed);
#endif
    assert(c > 0);
    IntType l1 = 0;
    IntType l2 = 1;
...
#endif /* !STREAMS_BOOST_NO_INT64_T */
...
#endif // STREAMS_BOOST_RANDOM_CONST_MOD_HPP
