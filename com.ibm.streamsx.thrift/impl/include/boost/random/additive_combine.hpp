/* streams_boost random/additive_combine.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_ADDITIVE_COMBINE_HPP
#define STREAMS_BOOST_RANDOM_ADDITIVE_COMBINE_HPP
...
#endif
  result_type min STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION () const { return 1; }
  result_type max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION () const { return (_mlcg1.max)()-1; }
...
#endif // STREAMS_BOOST_RANDOM_ADDITIVE_COMBINE_HPP
