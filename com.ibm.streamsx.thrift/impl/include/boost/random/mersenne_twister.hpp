/* streams_boost random/mersenne_twister.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_MERSENNE_TWISTER_HPP
#define STREAMS_BOOST_RANDOM_MERSENNE_TWISTER_HPP
...
#include <streams_boost/random/detail/ptr_helper.hpp>
...
public:
  ...
  STREAMS_BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(mersenne_twister, UIntType, value)
  { seed(value); }
  template<class It> mersenne_twister(It& first, It last) { seed(first,last); }

  STREAMS_BOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(mersenne_twister, Generator, gen)
  { seed(gen); }
  ...
  STREAMS_BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(mersenne_twister, UIntType, value)
  {
  ...
  STREAMS_BOOST_RANDOM_DETAIL_GENERATOR_SEED(mersenne_twister, Generator, gen)
  {
#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
    STREAMS_BOOST_STATIC_ASSERT(!std::numeric_limits<result_type>::is_signed);
#endif
...
STREAMS_BOOST_RANDOM_PTR_HELPER_SPEC(streams_boost::mt19937)

#endif // STREAMS_BOOST_RANDOM_MERSENNE_TWISTER_HPP
