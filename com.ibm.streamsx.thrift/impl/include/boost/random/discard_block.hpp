/* streams_boost random/discard_block.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_DISCARD_BLOCK_HPP
#define STREAMS_BOOST_RANDOM_DISCARD_BLOCK_HPP
...
public:
  ...
  STREAMS_BOOST_STATIC_CONSTANT(unsigned int, total_block = p);
  STREAMS_BOOST_STATIC_CONSTANT(unsigned int, returned_block = r);

#ifndef STREAMS_BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
  STREAMS_BOOST_STATIC_ASSERT(total_block >= returned_block);
#endif
...
#endif // STREAMS_BOOST_RANDOM_DISCARD_BLOCK_HPP
