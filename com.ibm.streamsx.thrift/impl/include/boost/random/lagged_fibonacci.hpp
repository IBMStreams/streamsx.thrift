/* streams_boost random/lagged_fibonacci.hpp header file
 *
...
#ifndef STREAMS_BOOST_RANDOM_LAGGED_FIBONACCI_HPP
#define STREAMS_BOOST_RANDOM_LAGGED_FIBONACCI_HPP

#include <streams_boost/config/no_tr1/cmath.hpp>
#include <iostream>
#include <algorithm>     // std::max
#include <iterator>
#include <streams_boost/config/no_tr1/cmath.hpp>         // std::pow
...
#include <streams_boost/random/detail/seed.hpp>
#include <streams_boost/random/detail/pass_through_engine.hpp>

namespace streams_boost {
namespace random {

#if STREAMS_BOOST_WORKAROUND(_MSC_FULL_VER, STREAMS_BOOST_TESTED_AT(13102292)) && STREAMS_BOOST_MSVC > 1300
#  define STREAMS_BOOST_RANDOM_EXTRACT_LF
#endif
...
#  ifdef STREAMS_BOOST_RANDOM_EXTRACT_LF
namespace detail
{
...
public:
  ...
  STREAMS_BOOST_STATIC_CONSTANT(unsigned int, long_lag = p);
  STREAMS_BOOST_STATIC_CONSTANT(unsigned int, short_lag = q);
...
{
  STREAMS_BOOST_STATIC_CONSTANT(bool, is_specialized = false);
...
#define STREAMS_BOOST_RANDOM_FIBONACCI_VAL(T,P,Q,V,E) \
template<> \
...
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 607, 273, 0.4293817707235914, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 1279, 418, 0.9421630240437659, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 2281, 1252, 0.1768114046909004, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 3217, 576, 0.1956232694868209, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 4423, 2098, 0.9499762202147172, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 9689, 5502, 0.05737836943695162, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 19937, 9842, 0.5076528587449834, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 23209, 13470, 0.5414473810619185, 1e-14)
STREAMS_BOOST_RANDOM_FIBONACCI_VAL(double, 44497,21034, 0.254135073399297, 1e-14)

#undef STREAMS_BOOST_RANDOM_FIBONACCI_VAL
...
public:
  ...
  STREAMS_BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(lagged_fibonacci_01, uint32_t, value)
  { init_modulus(); seed(value); }
  STREAMS_BOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(lagged_fibonacci_01, Generator, gen)
...
public:
  void seed() { seed(331u); }
  STREAMS_BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(lagged_fibonacci_01, uint32_t, value)
  {
  ...
  STREAMS_BOOST_RANDOM_DETAIL_GENERATOR_SEED(lagged_fibonacci, Generator, gen)
  {
...
#endif // STREAMS_BOOST_RANDOM_LAGGED_FIBONACCI_HPP
