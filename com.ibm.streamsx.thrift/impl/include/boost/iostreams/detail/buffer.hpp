...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_BUFFERS_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_BUFFERS_HPP_INCLUDED
...
#include <streams_boost/config.hpp>                    // member templates.
...
#include <streams_boost/iostreams/traits.hpp>          // int_type_of.
