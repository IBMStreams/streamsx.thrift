...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CHAINBUF_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_CHAINBUF_HPP_INCLUDED
...
#include <streams_boost/iostreams/detail/translate_int_type.hpp>
...
class chainbuf
    : public STREAMS_BOOST_IOSTREAMS_BASIC_STREAMBUF(
...
public:
    ...
    STREAMS_BOOST_IOSTREAMS_STREAMBUF_TYPEDEFS(typename Chain::traits_type)
protected:
...
private:
    ...
    typedef STREAMS_BOOST_IOSTREAMS_CHAR_TRAITS(char_type)           std_traits;
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CHAINBUF_HPP_INCLUDED
