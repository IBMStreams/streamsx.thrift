...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
...
#define STREAMS_BOOST_IOSTREAMS_USING_PROTECTED_STREAMBUF_MEMBERS(base) \
...
template<typename Ch, typename Tr = STREAMS_BOOST_IOSTREAMS_CHAR_TRAITS(Ch) >
class linked_streambuf : public STREAMS_BOOST_IOSTREAMS_BASIC_STREAMBUF(Ch, Tr) {
protected:
...
protected:
...
#else
    public:
        typedef STREAMS_BOOST_IOSTREAMS_BASIC_STREAMBUF(Ch, Tr) base;
        STREAMS_BOOST_IOSTREAMS_USING_PROTECTED_STREAMBUF_MEMBERS(base)
#endif
    ...
    virtual void close_impl(STREAMS_BOOST_IOS::openmode) = 0;
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_LINKED_STREAMBUF_HPP_INCLUDED
