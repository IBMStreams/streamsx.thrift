...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED
...
{ return streams_boost::iostreams::seek(t_, off, way, which); }
    ...
    template<typename Mode, typename T>
    void mode_adapter<Mode, T>::close(STREAMS_BOOST_IOS::openmode which) 
    { iostreams::close(t_, which); }
#endif

} } } // End namespaces detail, iostreams, streams_boost.

#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_MODE_ADAPTER_HPP_INCLUDED //-----//
