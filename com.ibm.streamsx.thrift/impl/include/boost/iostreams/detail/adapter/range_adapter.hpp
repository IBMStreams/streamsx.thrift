...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_RANGE_ADAPTER_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_RANGE_ADAPTER_HPP_INCLUDED
...
#include <streams_boost/detail/iterator.hpp>             // streams_boost::iterator_traits.
...
// Description: Device based on an instance of streams_boost::iterator_range.
// Template paramters:
//     Mode - A mode tag.
...
private:
    ...
    typedef streams_boost::detail::iterator_traits<iterator>  iter_traits;
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_RANGE_ADAPTER_HPP_INCLUDED //---------------//
