...
// be confused with <streams_boost/iostreams/char_traits.hpp>, which defines the
// template streams_boost::iostreams::char_traits.

// See http://www.streams_boost.org/libs/iostreams for documentation.

#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
...
# define STREAMS_BOOST_IOSTREAMS_CHAR_TRAITS(ch) std::char_traits< ch >
#else
# define STREAMS_BOOST_IOSTREAMS_CHAR_TRAITS(ch) streams_boost::iostreams::detail::char_traits
...
#endif // #ifdef STREAMS_BOOST_IOSTREAMS_NO_STREAM_TEMPLATES //-----------------------//

#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CHAR_TRAITS_HPP_INCLUDED
