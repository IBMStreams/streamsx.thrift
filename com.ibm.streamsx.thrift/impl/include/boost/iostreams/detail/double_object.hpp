...
// streams_boost::iostreams::detail::double_object, which is similar to compressed pair
// except that both members of the pair have the same type, and 
// compression occurs only if requested using a boolean template
// parameter.

#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
...
#else
    typedef streams_boost::call_traits<T>                  traits_type;
#endif
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_DOUBLE_OBJECT_HPP_INCLUDED
