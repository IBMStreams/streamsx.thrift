...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CODECVT_HOLDER_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_CODECVT_HOLDER_HPP_INCLUDED
...
#include <streams_boost/config.hpp>  // HAS_MACRO_USE_FACET.
...
struct codecvt_holder<default_codecvt> {
    ...
    {
        using namespace std;
        #ifndef STREAMS_BOOST_HAS_MACRO_USE_FACET
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CODECVT_HOLDER_HPP_INCLUDED
