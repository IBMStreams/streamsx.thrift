...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CONFIG_ZLIB_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_CONFIG_ZLIB_HPP_INCLUDED

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
# pragma once
#endif

#include <streams_boost/config.hpp> // STREAMS_BOOST_STRINGIZE.

#if defined(STREAMS_BOOST_ZLIB_BINARY)
...
#  pragma comment(lib, STREAMS_BOOST_STRINGIZE(STREAMS_BOOST_ZLIB_BINARY))
# endif
#else 
...
#  define STREAMS_BOOST_LIB_NAME streams_boost_zlib
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_CONFIG_ZLIB_HPP_INCLUDED
