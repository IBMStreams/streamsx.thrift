...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_AUTO_LINK_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_AUTO_LINK_HPP_INCLUDED

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
# pragma once
#endif              

#if defined(STREAMS_BOOST_EXTERNAL_LIB_NAME)
# if defined(STREAMS_BOOST_MSVC) \
     || defined(__BORLANDC__) \
     || (defined(__MWERKS__) && defined(_WIN32) && (__MWERKS__ >= 0x3000)) \
     || (defined(__ICL) && defined(_MSC_EXTENSIONS) && (_MSC_VER >= 1200)) \
     /**/
#  pragma comment(lib, STREAMS_BOOST_EXTERNAL_LIB_NAME)
# endif
# undef STREAMS_BOOST_EXTERNAL_LIB_NAME
#endif
...
# define STREAMS_BOOST_LIB_NAME streams_boost_iostreams
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_AUTO_LINK_HPP_INCLUDED
