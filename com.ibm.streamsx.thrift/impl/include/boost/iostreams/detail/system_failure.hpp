...
#ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
...
inline STREAMS_BOOST_IOSTREAMS_FAILURE system_failure(const char* msg)
{
    std::string result;
#ifdef STREAMS_BOOST_IOSTREAMS_WINDOWS
    DWORD err;
...
#endif
    return STREAMS_BOOST_IOSTREAMS_FAILURE(result);
}

inline STREAMS_BOOST_IOSTREAMS_FAILURE system_failure(const std::string& msg)
{ return system_failure(msg.c_str()); }

inline void throw_system_failure(const char* msg)
{ streams_boost::throw_exception(system_failure(msg)); }
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_DETAIL_SYSTEM_FAILURE_HPP_INCLUDED
