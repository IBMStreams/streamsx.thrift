...
#ifndef STREAMS_BOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
...
#include <streams_boost/iostreams/detail/config/bzip2.hpp>
...
STREAMS_BOOST_IOSTREAMS_DECL extern const int ok;
STREAMS_BOOST_IOSTREAMS_DECL extern const int run_ok;
STREAMS_BOOST_IOSTREAMS_DECL extern const int flush_ok;
STREAMS_BOOST_IOSTREAMS_DECL extern const int finish_ok;
STREAMS_BOOST_IOSTREAMS_DECL extern const int stream_end;    
STREAMS_BOOST_IOSTREAMS_DECL extern const int sequence_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int param_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int mem_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int data_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int data_error_magic;
STREAMS_BOOST_IOSTREAMS_DECL extern const int io_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int unexpected_eof;
STREAMS_BOOST_IOSTREAMS_DECL extern const int outbuff_full;
STREAMS_BOOST_IOSTREAMS_DECL extern const int config_error;

                    // Action codes

STREAMS_BOOST_IOSTREAMS_DECL extern const int finish;
STREAMS_BOOST_IOSTREAMS_DECL extern const int run;
...
//
class STREAMS_BOOST_IOSTREAMS_DECL bzip2_error : public STREAMS_BOOST_IOSTREAMS_FAILURE {
public:
...
template< typename Alloc,
          typename Base = // VC6 workaround (C2516)
              STREAMS_BOOST_DEDUCED_TYPENAME bzip2_allocator_traits<Alloc>::type >
...
class STREAMS_BOOST_IOSTREAMS_DECL bzip2_base  { 
public:
...
STREAMS_BOOST_IOSTREAMS_PIPABLE(basic_bzip2_compressor, 1)
...
STREAMS_BOOST_IOSTREAMS_PIPABLE(basic_bzip2_decompressor, 1)
      ...
      char*& dest_begin, char* dest_end, bool flush )
{
    ...
    bzip2_error::check STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(result);
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_BZIP2_HPP_INCLUDED
