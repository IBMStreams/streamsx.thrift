...
#ifndef STREAMS_BOOST_IOSTREAMS_REGEX_FILTER_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_REGEX_FILTER_HPP_INCLUDED
...
STREAMS_BOOST_IOSTREAMS_PIPABLE(basic_regex_filter, 3)
