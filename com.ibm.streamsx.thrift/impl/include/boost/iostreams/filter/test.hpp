...
#ifndef STREAMS_BOOST_IOSTREAMS_FILTER_TEST_HPP_INCLUDED

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
# pragma once
#endif

#include <streams_boost/config.hpp>               // STREAMS_BOOST_MSVC,put size_t in std.
...
#include <streams_boost/iostreams/copy.hpp>
...
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_string, std::basic_string, 3)
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_FILTER_TEST_HPP_INCLUDED
