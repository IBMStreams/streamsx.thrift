...
#ifndef STREAMS_BOOST_IOSTREAMS_ZLIB_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_ZLIB_HPP_INCLUDED
...
#include <new>          
#include <streams_boost/config.hpp>  // MSVC, STATIC_CONSTANT, DEDUCED_TYPENAME, DINKUM.
#include <streams_boost/cstdint.hpp> // uint*_t
#include <streams_boost/detail/workaround.hpp>
#include <streams_boost/iostreams/constants.hpp>   // buffer size.
...
#include <streams_boost/iostreams/detail/config/zlib.hpp>
#include <streams_boost/iostreams/detail/ios.hpp>  // failure, streamsize.
#include <streams_boost/iostreams/filter/symmetric.hpp>                
...
STREAMS_BOOST_IOSTREAMS_DECL extern const int no_compression;
STREAMS_BOOST_IOSTREAMS_DECL extern const int best_speed;
STREAMS_BOOST_IOSTREAMS_DECL extern const int best_compression;
STREAMS_BOOST_IOSTREAMS_DECL extern const int default_compression;

                    // Compression methods

STREAMS_BOOST_IOSTREAMS_DECL extern const int deflated;

                    // Compression strategies

STREAMS_BOOST_IOSTREAMS_DECL extern const int default_strategy;
STREAMS_BOOST_IOSTREAMS_DECL extern const int filtered;
STREAMS_BOOST_IOSTREAMS_DECL extern const int huffman_only;

                    // Status codes

STREAMS_BOOST_IOSTREAMS_DECL extern const int okay;
STREAMS_BOOST_IOSTREAMS_DECL extern const int stream_end;
STREAMS_BOOST_IOSTREAMS_DECL extern const int stream_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int version_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int data_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int mem_error;
STREAMS_BOOST_IOSTREAMS_DECL extern const int buf_error;

                    // Flush codes

STREAMS_BOOST_IOSTREAMS_DECL extern const int finish;
STREAMS_BOOST_IOSTREAMS_DECL extern const int no_flush;
STREAMS_BOOST_IOSTREAMS_DECL extern const int sync_flush;

                    // Code for current OS

//STREAMS_BOOST_IOSTREAMS_DECL extern const int os_code;
...
//
class STREAMS_BOOST_IOSTREAMS_DECL zlib_error : public STREAMS_BOOST_IOSTREAMS_FAILURE {
public:
    explicit zlib_error(int error);
    int error() const { return error_; }
    static void check STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(int error);
private:
    int error_;
};
...
template< typename Alloc,
          typename Base = // VC6 workaround (C2516)
              STREAMS_BOOST_DEDUCED_TYPENAME zlib_allocator_traits<Alloc>::type >
struct zlib_allocator : private Base {
private:
    typedef typename Base::size_type size_type;
public:
    STREAMS_BOOST_STATIC_CONSTANT(bool, custom = 
...
class STREAMS_BOOST_IOSTREAMS_DECL zlib_base { 
public:
...
STREAMS_BOOST_IOSTREAMS_PIPABLE(basic_zlib_compressor, 1)
...
STREAMS_BOOST_IOSTREAMS_PIPABLE(basic_zlib_decompressor, 1)
      ...
      char*& dest_begin, char* dest_end, bool flush )
{
    ...
    zlib_error::check STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(result);
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_ZLIB_HPP_INCLUDED
