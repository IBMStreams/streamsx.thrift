...
#ifndef STREAMS_BOOST_IOSTREAMS_INVERT_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_INVERT_HPP_INCLUDED
...
#include <streams_boost/detail/workaround.hpp>           // default_filter_buffer_size.
#include <streams_boost/iostreams/char_traits.hpp>
#include <streams_boost/iostreams/compose.hpp>
...
#include <streams_boost/iostreams/detail/counted_array.hpp>
#include <streams_boost/iostreams/detail/execute.hpp>
#include <streams_boost/iostreams/detail/functional.hpp> // clear_flags, call_reset
...
private:
    filter_ref filter() { return streams_boost::ref(pimpl_->filter_); }
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_INVERT_HPP_INCLUDED
