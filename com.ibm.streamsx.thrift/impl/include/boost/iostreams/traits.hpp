...
#ifndef STREAMS_BOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
...
#include <streams_boost/config.hpp>  // partial spec, deduced typename.
...
#include <streams_boost/iostreams/detail/select_by_size.hpp>      
#include <streams_boost/iostreams/detail/wrap_unwrap.hpp>       
#include <streams_boost/iostreams/traits_fwd.hpp> 
...
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::basic_istream, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::basic_ostream, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::basic_iostream, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::basic_streambuf, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ifstream, std::basic_ifstream, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ofstream, std::basic_ofstream, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_fstream, std::basic_fstream, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_filebuf, std::basic_filebuf, 2)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istringstream, std::basic_istringstream, 3)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostringstream, std::basic_ostringstream, 3)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringstream, std::basic_stringstream, 3)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_stringbuf, std::basic_stringbuf, 3)

#else // #ifndef STREAMS_BOOST_IOSTREAMS_NO_STREAM_TEMPLATES //-----------------------//

STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_istream, std::istream, 0)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_ostream, std::ostream, 0)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_iostream, std::iostream, 0)
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_streambuf, std::streambuf, 0)
...
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_streams_boost_stream,
                                streams_boost::iostreams::stream,
                                3 )
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_streams_boost_stream_buffer,
                                streams_boost::iostreams::stream_buffer,
                                4 )
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_stream_impl,
                                streams_boost::iostreams::filtering_stream,
                                5 )
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstream_impl,
                                streams_boost::iostreams::wfiltering_stream,
                                5 )
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_streambuf_impl,
                                streams_boost::iostreams::filtering_streambuf,
                                5 )
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF( is_filtering_wstreambuf_impl,
                                streams_boost::iostreams::filtering_wstreambuf,
                                5 )
STREAMS_BOOST_IOSTREAMS_BOOL_TRAIT_DEF(is_linked, linked_streambuf, 2)
...
template<typename T>
struct is_streams_boost
    : mpl::or_<
          is_streams_boost_stream<T>, 
          is_streams_boost_stream_buffer<T>, 
...
#else // #ifndef STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION //------------------//
...
struct char_type_of {
    ...
    typedef typename 
            mpl::eval_if<
                ...
                get_value_type<T>,
                detail::member_char_type<
                    STREAMS_BOOST_DEDUCED_TYPENAME detail::unwrapped_type<T>::type
                >
            >::type type;
};

#endif // #ifndef STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION //-----------------//
...
struct category_of {
    ...
    typedef typename  
            mpl::eval_if<
                mpl::and_<
                    is_std_io<U>,
                    mpl::not_< detail::is_streams_boost<U> >
                >,
...
#define STREAMS_BOOST_IOSTREAMS_MODE_HELPER(tag_, id_) \
    case_<id_> io_mode_impl_helper(tag_); \
    template<> struct io_mode_impl<id_> { typedef tag_ type; }; \
    /**/
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(input, 1)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(output, 2)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(bidirectional, 3)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(input_seekable, 4)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(output_seekable, 5)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(seekable, 6)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(dual_seekable, 7)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(bidirectional_seekable, 8)
STREAMS_BOOST_IOSTREAMS_MODE_HELPER(dual_use, 9)
#undef STREAMS_BOOST_IOSTREAMS_MODE_HELPER

template<typename T>
struct io_mode_id {
    typedef typename category_of<T>::type category;
    STREAMS_BOOST_SELECT_BY_SIZE(int, value, detail::io_mode_impl_helper(category()));
};
...
struct has_trait_impl {
    typedef typename category_of<T>::type category;
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (is_convertible<category, Tag>::value));
};
...
//------------------Definition of STREAMS_BOOST_IOSTREAMS_STREAMBUF_TYPEDEFS----------//

#define STREAMS_BOOST_IOSTREAMS_STREAMBUF_TYPEDEFS(Tr) \
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_IO_TRAITS_HPP_INCLUDED
