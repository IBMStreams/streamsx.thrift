...
#ifndef STREAMS_BOOST_IOSTREAMS_POSITIONING_HPP_INCLUDED
#define STREAMS_BOOST_IOSTREAMS_POSITIONING_HPP_INCLUDED
...
#include <streams_boost/iostreams/detail/config/codecvt.hpp> // mbstate_t.
#include <streams_boost/iostreams/detail/config/fpos.hpp>
#include <streams_boost/iostreams/detail/ios.hpp> // streamoff, streampos.
...
typedef streams_boost::intmax_t stream_offset;
...
// streams_boost::iostreams::stream_offset by extracting the two stream offsets and
...
#endif // #ifndef STREAMS_BOOST_IOSTREAMS_POSITIONING_HPP_INCLUDED
