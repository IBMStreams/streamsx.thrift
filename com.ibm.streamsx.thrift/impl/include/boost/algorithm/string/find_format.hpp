...
#ifndef STREAMS_BOOST_STRING_FIND_FORMAT_HPP
#define STREAMS_BOOST_STRING_FIND_FORMAT_HPP
...
#include <streams_boost/algorithm/string/detail/find_format.hpp>
#include <streams_boost/algorithm/string/detail/find_format_all.hpp>
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            STREAMS_BOOST_CONCEPT_ASSERT((
                FormatterConcept<
                    FormatterT,
                    FinderT,STREAMS_BOOST_STRING_TYPENAME range_const_iterator<RangeT>::type>
                ));
            ...
            return detail::find_format_copy_impl(
                ...
                lit_input,
                Formatter,
                Finder( ::streams_boost::begin(lit_input), ::streams_boost::end(lit_input) ) );
        }
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            STREAMS_BOOST_CONCEPT_ASSERT((
                FinderConcept<
                    FinderT,
                    STREAMS_BOOST_STRING_TYPENAME range_const_iterator<SequenceT>::type>
                ));
            STREAMS_BOOST_CONCEPT_ASSERT((
                FormatterConcept<
                    FormatterT,
                    FinderT,STREAMS_BOOST_STRING_TYPENAME range_const_iterator<SequenceT>::type>
                ));

            return detail::find_format_copy_impl(
                Input,
                Formatter,
                Finder(::streams_boost::begin(Input), ::streams_boost::end(Input)));
        }
...
#endif  // STREAMS_BOOST_STRING_FIND_FORMAT_HPP
