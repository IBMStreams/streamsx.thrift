...
#ifndef STREAMS_BOOST_STRING_REGEX_HPP
#define STREAMS_BOOST_STRING_REGEX_HPP
...
#include <streams_boost/algorithm/string/regex_find_format.hpp>
#include <streams_boost/algorithm/string/formatter.hpp>
#include <streams_boost/algorithm/string/iter_find.hpp>
...
//  find_regex  -----------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            return ::streams_boost::algorithm::regex_finder(Rx,Flags)(
                ::streams_boost::begin(lit_input), ::streams_boost::end(lit_input) );
        }
        ...
        */
            ...
            match_flag_type Flags=match_default | format_default )
        {
            return ::streams_boost::algorithm::find_format_copy( 
                Output,
                Input,
                ::streams_boost::algorithm::regex_finder( Rx, Flags ),
                ::streams_boost::algorithm::regex_formatter( Format, Flags ) );
        }
...
//  find_all_regex ------------------------------------------------------------------//
        ...
        /*!
            ...
            or \c std::list<streams_boost::iterator_range<std::string::iterator>>
        ...
        */
        ...
        inline SequenceSequenceT& find_all_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::streams_boost::algorithm::iter_find(
                Result,
                Input,
                ::streams_boost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  split_regex ------------------------------------------------------------------//
        ...
        */
        ...
        inline SequenceSequenceT& split_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::streams_boost::algorithm::iter_split(
                Result,
                Input,
                ::streams_boost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  join_if ------------------------------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            // Parse input
            InputIteratorT itBegin=::streams_boost::begin(Input);
            InputIteratorT itEnd=::streams_boost::end(Input);
            ...
            while(
                itBegin!=itEnd && 
                !::streams_boost::regex_match(::streams_boost::begin(*itBegin), ::streams_boost::end(*itBegin), Rx, Flags)) ++itBegin;

            // Add this element
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::streams_boost::end(Result), *itBegin);
                ++itBegin;
            }

            for(;itBegin!=itEnd; ++itBegin)
            {
                if(::streams_boost::regex_match(::streams_boost::begin(*itBegin), ::streams_boost::end(*itBegin), Rx, Flags))
                {
                    // Add separator
                    detail::insert(Result, ::streams_boost::end(Result), ::streams_boost::as_literal(Separator));
                    // Add element
                    detail::insert(Result, ::streams_boost::end(Result), *itBegin);
                }
            }
...
#endif  // STREAMS_BOOST_STRING_REGEX_HPP
