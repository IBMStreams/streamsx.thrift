...
#ifndef STREAMS_BOOST_STRING_FIND_HPP
#define STREAMS_BOOST_STRING_FIND_HPP
...
#include <streams_boost/algorithm/string/constants.hpp>
...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::streams_boost::begin(lit_input),::streams_boost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        inline iterator_range< 
            STREAMS_BOOST_STRING_TYPENAME range_iterator<Range1T>::type>
        find_first( 
            Range1T& Input, 
            const Range2T& Search)
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::streams_boost::algorithm::find(Input, ::streams_boost::algorithm::token_finder(Pred, eCompress));
        }
...
#endif  // STREAMS_BOOST_STRING_FIND_HPP
