...
#ifndef STREAMS_BOOST_STRING_TRIM_HPP
#define STREAMS_BOOST_STRING_TRIM_HPP
...
#include <streams_boost/algorithm/string/detail/trim.hpp>
    ...
    //  left trim  -----------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT trim_left_copy_if( 
            ...
            PredicateT IsSpace)
        {
            iterator_range<STREAMS_BOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> lit_range(::streams_boost::as_literal(Input));

            std::copy( 
                ::streams_boost::algorithm::detail::trim_begin( 
                    ::streams_boost::begin(lit_range), 
                    ::streams_boost::end(lit_range), 
                    IsSpace ),
                ::streams_boost::end(lit_range),
                Output);
        ...
        */
        ...
        {
            return            
                ::streams_boost::algorithm::trim_left_copy_if(
                    Input, 
                    is_space(Loc));
        }
        ...
        */
        ...
        {
            ::streams_boost::algorithm::trim_left_if( 
                Input, 
                is_space(Loc));
        }
    ...
    //  right trim  -----------------------------------------------//
        ...
        */
            ...
            PredicateT IsSpace )
        {
            ...
            std::copy( 
                ::streams_boost::begin(lit_range),
                ::streams_boost::algorithm::detail::trim_end( 
                    ::streams_boost::begin(lit_range), 
                    ::streams_boost::end(lit_range), 
                    IsSpace ),
                Output );
        ...
        */
        ...
        {
            return 
                ::streams_boost::algorithm::trim_right_copy_if( 
                    Input, 
                    is_space(Loc));
        }
        ...
        */
        ...
        {
            ::streams_boost::algorithm::trim_right_if(
                Input, 
                is_space(Loc) );
        }
    ...
    //  both side trim  -----------------------------------------------//
        ...
        */
            ...
            PredicateT IsSpace)
        {
            ...
            std::copy( 
                detail::trim_begin( 
                    ::streams_boost::begin(lit_range), TrimEnd, IsSpace),
                TrimEnd,
                Output
                );
        ...
        */
        ...
        {
            return
                ::streams_boost::algorithm::trim_copy_if(
                    Input, 
                    is_space(Loc) );
        }
        ...
        */
        ...
        {
            ::streams_boost::algorithm::trim_right_if( Input, IsSpace );
            ::streams_boost::algorithm::trim_left_if( Input, IsSpace );
        }
        ...
        */
        ...
        {
            ::streams_boost::algorithm::trim_if(
                Input, 
                is_space( Loc ) );
        }
...
#endif  // STREAMS_BOOST_STRING_TRIM_HPP
