...
#ifndef STREAMS_BOOST_STRING_FIND_ITERATOR_HPP
#define STREAMS_BOOST_STRING_FIND_ITERATOR_HPP
...
#include <streams_boost/algorithm/string/detail/find_iterator.hpp>
...
//  find_iterator -----------------------------------------------//
        ...
        */
        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<STREAMS_BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::streams_boost::as_literal(Col));
                m_Match=::streams_boost::make_iterator_range(::streams_boost::begin(lit_col), ::streams_boost::begin(lit_col));
                m_End=::streams_boost::end(lit_col);
        ...
        make_find_iterator(
            ...
            FinderT Finder)
        {
            return find_iterator<STREAMS_BOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<STREAMS_BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::streams_boost::as_literal(Col));
                m_Match=make_iterator_range(::streams_boost::begin(lit_col), ::streams_boost::begin(lit_col));
                m_Next=::streams_boost::begin(lit_col);
                m_End=::streams_boost::end(lit_col);
        ...
        make_split_iterator(
            ...
            FinderT Finder)
        {
            return split_iterator<STREAMS_BOOST_STRING_TYPENAME range_iterator<RangeT>::type>(
                Collection, Finder);
        }
...
#endif  // STREAMS_BOOST_STRING_FIND_ITERATOR_HPP
