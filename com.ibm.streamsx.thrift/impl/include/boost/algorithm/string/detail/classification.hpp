...
#ifndef STREAMS_BOOST_STRING_CLASSIFICATION_DETAIL_HPP
#define STREAMS_BOOST_STRING_CLASSIFICATION_DETAIL_HPP
   ...
   // is_classified functor
            ...
            */
            ...
            private:
                ...
                typedef typename ::streams_boost::remove_const<CharT>::type set_value_type;
            ...
            public:     
                ...
                is_any_ofF( const RangeT& Range ) : m_Size(0)
                {
                    ...
                    std::size_t Size=::streams_boost::distance(Range);
                    m_Size=Size;
                    ...
                    // Use fixed storage
                    ::std::copy(::streams_boost::begin(Range), ::streams_boost::end(Range), Storage);
