...
#ifndef STREAMS_BOOST_STRING_PREDICATE_DETAIL_HPP
#define STREAMS_BOOST_STRING_PREDICATE_DETAIL_HPP
...
//  ends_with predicate implementation ----------------------------------//
                ...
                std::forward_iterator_tag)
            {
                ...
                iterator_range<ForwardIterator1T> Result
                    =last_finder( 
                        ::streams_boost::make_iterator_range(SubBegin, SubEnd),
                        Comp)(Begin, End);
...
#endif  // STREAMS_BOOST_STRING_PREDICATE_DETAIL_HPP
