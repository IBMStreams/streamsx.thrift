...
#ifndef STREAMS_BOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
#define STREAMS_BOOST_STRING_REPLACE_STORAGE_DETAIL_HPP

#include <streams_boost/algorithm/string/config.hpp>
#include <algorithm>
#include <streams_boost/mpl/bool.hpp>
#include <streams_boost/algorithm/string/sequence_traits.hpp>
#include <streams_boost/algorithm/string/detail/sequence.hpp>
...
//  storage handling routines -----------------------------------------------//
            ...
            inline void copy_to_storage(
                ...
                const WhatT& What )
            {
                Storage.insert( Storage.end(), ::streams_boost::begin(What), ::streams_boost::end(What) );
            }
...
//  process segment routine -----------------------------------------------//
            ...
            struct process_segment_helper
            {
                    ...
                    ForwardIteratorT SegmentEnd )
                {
                    ...
                    ForwardIteratorT It=::streams_boost::algorithm::detail::move_from_storage( Storage, InsertIt, SegmentBegin );
            ...
            struct process_segment_helper< true >
            {
...

                {
                    ...
                    ::streams_boost::algorithm::detail::replace( Input, InsertIt, SegmentBegin, Storage );
                    // Empty the storage
                    Storage.clear();
...
#endif  // STREAMS_BOOST_STRING_REPLACE_STORAGE_DETAIL_HPP
