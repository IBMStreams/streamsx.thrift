...
#ifndef STREAMS_BOOST_STRING_CONCEPT_HPP
#define STREAMS_BOOST_STRING_CONCEPT_HPP
    ...
    namespace algorithm {
        ...
        */
        ...
        public:
            ...
            {
                // Operation
                ::streams_boost::begin((*pFo)( (*pF)(i,i) ));
                ::streams_boost::end((*pFo)( (*pF)(i,i) ));
            }
        private:
            IteratorT i;
            FinderT* pF;
...
#endif  // STREAMS_BOOST_STRING_CONCEPT_HPP
