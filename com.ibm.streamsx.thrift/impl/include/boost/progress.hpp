//  streams_boost progress.hpp header file  ------------------------------------------//

//  Copyright Beman Dawes 1994-99.  Distributed under the Boost
//  Software License, Version 1.0. (See accompanying file
//  LICENSE_1_0.txt or copy at http://www.streams_boost.org/LICENSE_1_0.txt)

//  See http://www.streams_boost.org/libs/timer for documentation.
...
//   6 Jul 99  Initial streams_boost version

#ifndef STREAMS_BOOST_PROGRESS_HPP
#define STREAMS_BOOST_PROGRESS_HPP

#include <streams_boost/timer.hpp>
#include <streams_boost/utility.hpp>  // for noncopyable
#include <streams_boost/cstdint.hpp>  // for uintmax_t
...
// NOTE: (Jan 12, 2001) Tried to change unsigned long to streams_boost::uintmax_t, but
...
#endif  // STREAMS_BOOST_PROGRESS_HPP
