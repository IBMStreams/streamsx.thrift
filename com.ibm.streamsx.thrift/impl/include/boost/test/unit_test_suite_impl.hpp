...
#ifndef STREAMS_BOOST_TEST_UNIT_TEST_SUITE_IMPL_HPP_071894GER
#define STREAMS_BOOST_TEST_UNIT_TEST_SUITE_IMPL_HPP_071894GER
...
class STREAMS_BOOST_TEST_DECL test_unit {
public:
    enum { type = tut_any };
    ...
    typedef STREAMS_BOOST_READONLY_PROPERTY(test_unit_id,(framework_impl))  id_t;
    typedef STREAMS_BOOST_READONLY_PROPERTY(test_unit_id,(test_suite))      parent_id_t;
...
class STREAMS_BOOST_TEST_DECL test_unit_generator {
public:
    virtual test_unit*  next() const = 0;

protected:
    STREAMS_BOOST_TEST_PROTECTED_VIRTUAL ~test_unit_generator() {}
};
...
class STREAMS_BOOST_TEST_DECL test_case : public test_unit {
public:
    enum { type = tut_case };
...
private:
    ...
    // STREAMS_BOOST_MSVC <= 1200 have problems with callback as property
    // Data members
...
class STREAMS_BOOST_TEST_DECL test_suite : public test_unit {
public:
    enum { type = tut_suite };
...
protected:
    friend STREAMS_BOOST_TEST_DECL 
...
class STREAMS_BOOST_TEST_DECL master_test_suite_t : public test_suite {
public:
...
class STREAMS_BOOST_TEST_DECL test_tree_visitor {
public:
...
protected:
    STREAMS_BOOST_TEST_PROTECTED_VIRTUAL ~test_tree_visitor() {}
};
...
STREAMS_BOOST_TEST_DECL void    traverse_test_tree( test_case const&, test_tree_visitor& );
STREAMS_BOOST_TEST_DECL void    traverse_test_tree( test_suite const&, test_tree_visitor& );
STREAMS_BOOST_TEST_DECL void    traverse_test_tree( test_unit_id     , test_tree_visitor& );
...
public:
    ...
    STREAMS_BOOST_READONLY_PROPERTY( counter_t, (test_case_counter)) p_count;
private:
    // test tree visitor interface
    virtual void    visit( test_case const& );
...
struct STREAMS_BOOST_TEST_DECL test_being_aborted {};
...
STREAMS_BOOST_TEST_DECL std::string normalize_test_case_name( const_string tu_name );
...
make_test_case( void (UserTestCase::*           test_method )(),
                ...
                streams_boost::shared_ptr<InstanceType> user_test_case )
{
...
struct STREAMS_BOOST_TEST_DECL auto_test_unit_registrar
{
    // Constructors
...
class STREAMS_BOOST_TEST_DECL global_fixture : public test_observer { 
public: 
    // Constructor
    global_fixture();
}; 
...
public:
    void    operator()()    { TestCaseTemplate::run( (streams_boost::type<TestType>*)0 ); }
};
...
struct generate_test_case_4_type {
    ...
    void        operator()( mpl::identity<TestType> )
    {
        ...
        if( streams_boost::is_const<TestType>::value )
            full_name += " const";
        full_name += '>';
...
#endif // STREAMS_BOOST_TEST_UNIT_TEST_SUITE_IMPL_HPP_071894GER
