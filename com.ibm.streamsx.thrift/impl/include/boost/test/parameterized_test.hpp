...
#ifndef STREAMS_BOOST_TEST_PARAMETERIZED_TEST_HPP_021102GER
#define STREAMS_BOOST_TEST_PARAMETERIZED_TEST_HPP_021102GER
...
#define STREAMS_BOOST_PARAM_TEST_CASE( function, begin, end )                      \
streams_boost::unit_test::make_test_case( function,                                \
                                  STREAMS_BOOST_TEST_STRINGIZE( function ),        \
                                  (begin), (end) )                         \
/**/

#define STREAMS_BOOST_PARAM_CLASS_TEST_CASE( function, tc_instance, begin, end )   \
streams_boost::unit_test::make_test_case( function,                                \
                                  STREAMS_BOOST_TEST_STRINGIZE( function ),        \
                                  (tc_instance),                           \
                                  (begin), (end) )                         \
...
inline ut_detail::param_test_case_generator<
    STREAMS_BOOST_DEDUCED_TYPENAME remove_const<STREAMS_BOOST_DEDUCED_TYPENAME remove_reference<ParamType>::type>::type,ParamIter>
make_test_case( void (*test_func)( ParamType ),
                const_string  tc_name, 
                ParamIter     par_begin,
                ParamIter     par_end )
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME remove_const<STREAMS_BOOST_DEDUCED_TYPENAME remove_reference<ParamType>::type>::type param_value_type;
...
make_test_case( void (UserTestCase::*test_method )( ParamType ),
                const_string                           tc_name,
                streams_boost::shared_ptr<UserTestCase> const& user_test_case,
                ParamIter                              par_begin,
                ParamIter                              par_end )
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME remove_const<STREAMS_BOOST_DEDUCED_TYPENAME remove_reference<ParamType>::type>::type param_value_type;
...
#endif // STREAMS_BOOST_TEST_PARAMETERIZED_TEST_HPP_021102GER
