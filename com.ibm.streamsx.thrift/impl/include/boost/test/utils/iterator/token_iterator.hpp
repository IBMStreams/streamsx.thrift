...
#ifndef STREAMS_BOOST_TOKEN_ITERATOR_HPP_071894GER
#define STREAMS_BOOST_TOKEN_ITERATOR_HPP_071894GER
...
#include <streams_boost/test/utils/iterator/input_iterator_facade.hpp>
...
public:
    ...
    bool        operator()( CharT c )
    {
        switch( m_type ) {
        case dt_char: {
            STREAMS_BOOST_TEST_FOREACH( CharT, delim, m_delimeters )
...
#if STREAMS_BOOST_WORKAROUND( STREAMS_BOOST_DINKUMWARE_STDLIB, < 306 )
...
protected:
    ...
    {
        typedef ut_detail::token_assigner<STREAMS_BOOST_DEDUCED_TYPENAME iterator_traversal<Iter>::type> Assigner;
        Iter check_point;
...
template<typename Iter,
         typename CharCompare = ut_detail::default_char_compare<STREAMS_BOOST_DEDUCED_TYPENAME iterator_value<Iter>::type>,
         typename ValueType   = std::basic_string<STREAMS_BOOST_DEDUCED_TYPENAME iterator_value<Iter>::type>,
...
#endif // STREAMS_BOOST_TOKEN_ITERATOR_HPP_071894GER
