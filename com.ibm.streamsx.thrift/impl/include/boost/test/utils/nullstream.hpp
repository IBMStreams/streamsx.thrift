...
#ifndef STREAMS_BOOST_NULLSTREAM_HPP_071894GER
#define STREAMS_BOOST_NULLSTREAM_HPP_071894GER
...
template< typename CharType, class CharTraits = ::std::char_traits<CharType> >
class basic_onullstream : private streams_boost::base_from_member<basic_nullbuf<CharType, CharTraits> >
                        , public ::std::basic_ostream<CharType, CharTraits> {
    typedef streams_boost::base_from_member<basic_nullbuf<CharType, CharTraits> >   pbase_type;
...
#endif  // STREAMS_BOOST_NULLSTREAM_HPP_071894GER
