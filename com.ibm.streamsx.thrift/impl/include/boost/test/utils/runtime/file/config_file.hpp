...
#ifndef STREAMS_BOOST_RT_FILE_CONFIG_FILE_HPP_010105GER
#define STREAMS_BOOST_RT_FILE_CONFIG_FILE_HPP_010105GER

// Boost.Runtime.Parameter
#include <streams_boost/test/utils/runtime/config.hpp>

#include <streams_boost/test/utils/runtime/file/config_file_iterator.hpp>
...
public:
    ...
    STREAMS_BOOST_READONLY_PROPERTY( dstring, (parameter))  p_name;
    STREAMS_BOOST_READONLY_PROPERTY( dstring, (parameter))  p_value;
...
public:
    ...
    // Public properties
    STREAMS_BOOST_READONLY_PROPERTY( dstring, (param_namespace))    p_name;
    ...
    {
        cstring vm = m.has( value_marker )        ? m[value_marker]        : STREAMS_BOOST_RT_PARAM_CSTRING_LITERAL( "\"" );
        cstring vd = m.has( value_delimeter )     ? m[value_delimeter]     : STREAMS_BOOST_RT_PARAM_CSTRING_LITERAL( "= \t\n\r" );
        cstring nd = m.has( namespace_delimeter ) ? m[namespace_delimeter] : STREAMS_BOOST_RT_PARAM_CSTRING_LITERAL( "::" );
...
streams_boost::optional<cstring>
...
#endif // STREAMS_BOOST_RT_FILE_CONFIG_FILE_HPP_010105GER
