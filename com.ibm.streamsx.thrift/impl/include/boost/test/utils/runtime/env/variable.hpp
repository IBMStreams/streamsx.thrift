...
#ifndef STREAMS_BOOST_RT_ENV_VARIABLE_HPP_062604GER
#define STREAMS_BOOST_RT_ENV_VARIABLE_HPP_062604GER
...
public:
    ...
    template<typename T>
    void        value( streams_boost::optional<T>& res ) const
    {
        if( has_value() )
...
public:
    ...
    template<typename T>
    void        value( streams_boost::optional<T>& res ) const      { variable_base::value( res ); }
#else
...
#include <streams_boost/test/utils/runtime/env/environment.hpp>
...
#endif // STREAMS_BOOST_RT_ENV_VARIABLE_HPP_062604GER
