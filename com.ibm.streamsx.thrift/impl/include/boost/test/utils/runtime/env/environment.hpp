...
#ifndef STREAMS_BOOST_RT_ENV_ENVIRONMENT_HPP_062604GER
#define STREAMS_BOOST_RT_ENV_ENVIRONMENT_HPP_062604GER
...
#include <streams_boost/test/utils/runtime/env/fwd.hpp>
#include <streams_boost/test/utils/runtime/env/modifier.hpp>
...
namespace environment {
    ...
    template<typename T>
    inline void
    get( cstring var_name, streams_boost::optional<T>& res )
    {
...
#include <streams_boost/test/utils/runtime/env/environment.ipp>

#endif

#endif // STREAMS_BOOST_RT_ENV_ENVIRONMENT_HPP_062604GER
