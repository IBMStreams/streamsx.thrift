...
#ifndef STREAMS_BOOST_RT_CLA_PARSER_HPP_062604GER
#define STREAMS_BOOST_RT_CLA_PARSER_HPP_062604GER
...
public:
    ...
    template<typename T>
    void                get( cstring string_id, streams_boost::optional<T>& res ) const
    {
...
#  include <streams_boost/test/utils/runtime/cla/parser.ipp>

#endif

#endif // STREAMS_BOOST_RT_CLA_PARSER_HPP_062604GER
