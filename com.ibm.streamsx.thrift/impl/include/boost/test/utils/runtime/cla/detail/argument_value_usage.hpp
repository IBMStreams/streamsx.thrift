...
#ifndef STREAMS_BOOST_RT_CLA_ARGUMENT_VALUE_USAGE_HPP_062604GER
#define STREAMS_BOOST_RT_CLA_ARGUMENT_VALUE_USAGE_HPP_062604GER
...
{
    fs << STREAMS_BOOST_RT_PARAM_CSTRING_LITERAL( "(<value1>, ..., <valueN>)" );
}
...
{
    fs << STREAMS_BOOST_RT_PARAM_CSTRING_LITERAL( "yes|y|no|n" );
}
...
#endif // STREAMS_BOOST_RT_CLA_ARGUMENT_VALUE_USAGE_HPP_062604GER
