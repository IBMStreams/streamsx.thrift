...
#ifndef STREAMS_BOOST_TEST_CALLBACK_020505GER
#define STREAMS_BOOST_TEST_CALLBACK_020505GER
...
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, < 1300) || STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_INTEL, <= 700)
#  define STREAMS_BOOST_CALLBACK_EXPLICIT_COPY_CONSTRUCTOR
#endif
...
public:
    // Constructors
    callback0() {}
#ifdef STREAMS_BOOST_CALLBACK_EXPLICIT_COPY_CONSTRUCTOR
...
private:
    // Data members
    streams_boost::shared_ptr<ut_detail::callback0_impl<R> > m_impl;
};
...
private:
    // Data members
    streams_boost::shared_ptr<ut_detail::callback1_impl<R,T1> > m_impl;
};
...
private:
    // Data members
    streams_boost::shared_ptr<ut_detail::callback2_impl<R,T1,T2> > m_impl;
};
...
private:
    // Data members
    streams_boost::shared_ptr<ut_detail::callback3_impl<R,T1,T2,T3> > m_impl;
};
...
#undef STREAMS_BOOST_CALLBACK_EXPLICIT_COPY_CONSTRUCTOR

//____________________________________________________________________________//

#include <streams_boost/test/detail/enable_warnings.hpp>

#endif // STREAMS_BOOST_TEST_CALLBACK_020505GER
