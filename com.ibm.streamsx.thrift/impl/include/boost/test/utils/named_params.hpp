...
#ifndef STREAMS_BOOST_TEST_NAMED_PARAM_022505GER
#define STREAMS_BOOST_TEST_NAMED_PARAM_022505GER
...
#include <streams_boost/test/utils/assign_op.hpp>
...
, named_parameter_base<named_parameter_combine<NP,Rest> > {
    ...
    STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x0610))
    template<typename NP>
...
#endif // STREAMS_BOOST_TEST_NAMED_PARAM_022505GER
