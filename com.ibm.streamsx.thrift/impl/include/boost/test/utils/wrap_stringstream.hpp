...
#ifndef STREAMS_BOOST_WRAP_STRINGSTREAM_HPP_071894GER
#define STREAMS_BOOST_WRAP_STRINGSTREAM_HPP_071894GER
...
public:
#if defined(STREAMS_BOOST_CLASSIC_IOSTREAMS)
    typedef std::ostringstream               wrapped_stream;
#elif defined(STREAMS_BOOST_NO_STRINGSTREAM)
...
template <typename CharT>
inline basic_wrap_stringstream<CharT>&
operator<<( basic_wrap_stringstream<CharT>& targ, std::ios_base& (STREAMS_BOOST_TEST_CALL_DECL *man)(std::ios_base&) )
{
    targ.stream() << man;
    return targ;
}
...
inline basic_wrap_stringstream<CharT>&
operator<<( basic_wrap_stringstream<CharT>& targ, std::basic_ostream<Elem,Tr>& (STREAMS_BOOST_TEST_CALL_DECL *man)(std::basic_ostream<Elem, Tr>&) )
{
    targ.stream() << man;
    return targ;
}
...
template<typename CharT,typename Elem,typename Tr>
inline basic_wrap_stringstream<CharT>&
operator<<( basic_wrap_stringstream<CharT>& targ, std::basic_ios<Elem, Tr>& (STREAMS_BOOST_TEST_CALL_DECL *man)(std::basic_ios<Elem, Tr>&) )
{
    targ.stream() << man;
    return targ;
}
...
#endif  // STREAMS_BOOST_WRAP_STRINGSTREAM_HPP_071894GER
