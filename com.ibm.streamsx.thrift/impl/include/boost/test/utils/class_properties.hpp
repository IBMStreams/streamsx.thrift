...
#ifndef STREAMS_BOOST_TEST_CLASS_PROPERTIES_HPP_071894GER
#define STREAMS_BOOST_TEST_CLASS_PROPERTIES_HPP_071894GER

// Boost.Test
#include <streams_boost/test/detail/config.hpp>

// Boost
#if !STREAMS_BOOST_WORKAROUND(__IBMCPP__, STREAMS_BOOST_TESTED_AT(600))
...
public:
    ...
    // Data members
#ifndef STREAMS_BOOST_TEST_NO_PROTECTED_USING
protected:
#endif
    PropertyType        value;
};
...
#ifdef STREAMS_BOOST_CLASSIC_IOSTREAMS
...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return streams_boost::addressof( base_prop::value ); }
};
...
#define STREAMS_BOOST_READONLY_PROPERTY( property_type, friends ) streams_boost::unit_test::readwrite_property<property_type >

#else

#define STREAMS_BOOST_READONLY_PROPERTY_DECLARE_FRIEND(r, data, elem) friend class elem;

#define STREAMS_BOOST_READONLY_PROPERTY( property_type, friends )                           \
class STREAMS_BOOST_JOIN( readonly_property, __LINE__ )                                     \
: public streams_boost::unit_test::readonly_property<property_type > {                      \
    typedef streams_boost::unit_test::readonly_property<property_type > base_prop;          \
    STREAMS_BOOST_PP_SEQ_FOR_EACH( STREAMS_BOOST_READONLY_PROPERTY_DECLARE_FRIEND, ' ', friends )   \
    typedef base_prop::write_param_t  write_param_t;                                \
public:                                                                             \
                STREAMS_BOOST_JOIN( readonly_property, __LINE__ )() {}                      \
    explicit    STREAMS_BOOST_JOIN( readonly_property, __LINE__ )( write_param_t init_v  )  \
    : base_prop( init_v ) {}                                                        \
}                                                                                   \
/**/
...
public:
    ...
    arrow_res_t     operator->()            { return streams_boost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return streams_boost::addressof( base_prop::value ); }
...
#undef STREAMS_BOOST_TEST_NO_PROTECTED_USING

#endif // STREAMS_BOOST_TEST_CLASS_PROPERTIES_HPP_071894GER
