...
#ifndef  STREAMS_BOOST_TEST_BASIC_CSTRING_COMPARE_HPP_071894GER
#define  STREAMS_BOOST_TEST_BASIC_CSTRING_COMPARE_HPP_071894GER
...
# if defined(STREAMS_BOOST_NO_STDC_NAMESPACE) && !STREAMS_BOOST_WORKAROUND(__BORLANDC__, <= 0x570)
...
template<class CharT>
inline bool
operator <( streams_boost::unit_test::basic_cstring<CharT> const& x,
            streams_boost::unit_test::basic_cstring<CharT> const& y )
{
    typedef typename streams_boost::unit_test::basic_cstring<CharT>::traits_type traits_type;
    return x.size() != y.size() 
            ? x.size() < y.size() 
...
#endif // STREAMS_BOOST_TEST_BASIC_CSTRING_COMPARE_HPP_071894GER
