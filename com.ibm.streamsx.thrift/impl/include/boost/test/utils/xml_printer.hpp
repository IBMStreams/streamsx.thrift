...
#ifndef STREAMS_BOOST_TEST_XML_PRINTER_HPP_071894GER
#define STREAMS_BOOST_TEST_XML_PRINTER_HPP_071894GER

// Boost.Test
#include <streams_boost/test/utils/basic_cstring/basic_cstring.hpp>
#include <streams_boost/test/utils/fixed_mapping.hpp>
#include <streams_boost/test/utils/custom_manip.hpp>
...
print_escaped( std::ostream& where_to, const_string value )
{
    ...
    STREAMS_BOOST_TEST_FOREACH( char, c, value ) {
...
{
    return *p << STREAMS_BOOST_TEST_L( "<![CDATA[" ) << value << STREAMS_BOOST_TEST_L( "]]>" );
}
...
#endif // STREAMS_BOOST_TEST_XML_PRINTER_HPP_071894GER
