...
#ifndef STREAMS_BOOST_TEST_FIXED_MAPPING_HPP_071894GER
#define STREAMS_BOOST_TEST_FIXED_MAPPING_HPP_071894GER
...
#include <streams_boost/detail/binary_search.hpp>
...
#define CONSTR_DECL( z, n, dummy1 )                                 \
    fixed_mapping( STREAMS_BOOST_PP_REPEAT_ ## z( n, CONSTR_DECL_MID, "" )  \
                         value_param_type invalid_value )           \
    : m_invalid_value( invalid_value )                              \
    {                                                               \
        STREAMS_BOOST_PP_REPEAT_ ## z( n, CONSTR_BODY_MID, "" )             \
        init();                                                     \
    }                                                               \
/**/

#define CONTRUCTORS( n ) STREAMS_BOOST_PP_REPEAT( n, CONSTR_DECL, "" )
...
public:
    // Constructors
    CONTRUCTORS( STREAMS_BOOST_PP_ADD( MAX_MAP_SIZE, 1 ) )

    // key -> value access
    value_ref_type  operator[]( key_param_type key ) const
    {
        iterator it = streams_boost::detail::lower_bound( m_map.begin(), m_map.end(), key, p1() );
...
#endif // STREAMS_BOOST_TEST_FIXED_MAPPING_HPP_071894GER
