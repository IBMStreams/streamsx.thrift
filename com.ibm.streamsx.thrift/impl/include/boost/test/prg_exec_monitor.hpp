...
#ifndef STREAMS_BOOST_PRG_EXEC_MONITOR_HPP_071894GER
#define STREAMS_BOOST_PRG_EXEC_MONITOR_HPP_071894GER
...
#  define STREAMS_BOOST_LIB_NAME streams_boost_prg_exec_monitor
...
int STREAMS_BOOST_TEST_DECL prg_exec_monitor_main( int (*cpp_main)( int argc, char* argv[] ), int argc, char* argv[] );
...
#endif // STREAMS_BOOST_PRG_EXEC_MONITOR_HPP_071894GER
