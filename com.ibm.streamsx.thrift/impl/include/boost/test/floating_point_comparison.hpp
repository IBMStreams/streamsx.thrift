...
#ifndef STREAMS_BOOST_TEST_FLOATING_POINT_COMPARISON_HPP_071894GER
#define STREAMS_BOOST_TEST_FLOATING_POINT_COMPARISON_HPP_071894GER
...
#include <streams_boost/numeric/conversion/conversion_traits.hpp> // for numeric::conversion_traits
...
struct STREAMS_BOOST_TEST_DECL check_is_close_t {
    // Public typedefs
    typedef bool result_type;
                ...
                floating_point_comparison_type fpc_type = FPC_STRONG ) const
    {
        ...
        STREAMS_BOOST_STATIC_ASSERT( !is_integral<FPT>::value );
...
struct STREAMS_BOOST_TEST_DECL check_is_small_t {
    // Public typedefs
    typedef bool result_type;
...
#endif // STREAMS_BOOST_FLOATING_POINT_COMAPARISON_HPP_071894GER
