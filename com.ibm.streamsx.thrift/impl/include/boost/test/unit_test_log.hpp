...
#ifndef STREAMS_BOOST_TEST_UNIT_TEST_LOG_HPP_071894GER
#define STREAMS_BOOST_TEST_UNIT_TEST_LOG_HPP_071894GER
...
struct STREAMS_BOOST_TEST_DECL begin {
...
class STREAMS_BOOST_TEST_DECL entry_value_collector {
public:
    // Constructors
...
class STREAMS_BOOST_TEST_DECL unit_test_log_t : public test_observer, public singleton<unit_test_log_t> {
public:
...
private:
    ...
    STREAMS_BOOST_TEST_SINGLETON_CONS( unit_test_log_t );
}; // unit_test_log_t

STREAMS_BOOST_TEST_SINGLETON_INST( unit_test_log )

// helper macros
#define STREAMS_BOOST_TEST_LOG_ENTRY( ll )                                                  \
    (::streams_boost::unit_test::unit_test_log                                              \
        << ::streams_boost::unit_test::log::begin( STREAMS_BOOST_TEST_L(__FILE__), __LINE__ ))(ll)  \
/**/
...
#define STREAMS_BOOST_TEST_MESSAGE( M )                                 \
    STREAMS_BOOST_TEST_LOG_ENTRY( ::streams_boost::unit_test::log_messages )    \
    << (::streams_boost::unit_test::lazy_ostream::instance() << M)      \
/**/

//____________________________________________________________________________//

#define STREAMS_BOOST_TEST_PASSPOINT()                                  \
    ::streams_boost::unit_test::unit_test_log.set_checkpoint(           \
...
#define STREAMS_BOOST_TEST_CHECKPOINT( M )                              \
    ::streams_boost::unit_test::unit_test_log.set_checkpoint(           \
        STREAMS_BOOST_TEST_L(__FILE__),                                 \
        static_cast<std::size_t>(__LINE__),                     \
        (::streams_boost::wrap_stringstream().ref() << M).str() )       \
/**/
...
#endif // STREAMS_BOOST_TEST_UNIT_TEST_LOG_HPP_071894GER
