...
#ifndef STREAMS_BOOST_TEST_DEBUG_API_HPP_112006GER
#define STREAMS_BOOST_TEST_DEBUG_API_HPP_112006GER
...
bool STREAMS_BOOST_TEST_DECL under_debugger();
...
void STREAMS_BOOST_TEST_DECL debugger_break();
...
std::string STREAMS_BOOST_TEST_DECL set_debugger( unit_test::const_string dbg_id );

#else 

std::string STREAMS_BOOST_TEST_DECL set_debugger( unit_test::const_string dbg_id, dbg_starter s = dbg_starter() );
...
bool STREAMS_BOOST_TEST_DECL attach_debugger( bool break_or_continue = true );

// ************************************************************************** //
// **************   switch on/off detect memory leaks feature  ************** //
// ************************************************************************** //

void STREAMS_BOOST_TEST_DECL detect_memory_leaks( bool on_off );
...
void STREAMS_BOOST_TEST_DECL break_memory_alloc( long mem_alloc_order_num );
