...
#ifndef STREAMS_BOOST_TEST_DEBUG_API_IPP_112006GER
#define STREAMS_BOOST_TEST_DEBUG_API_IPP_112006GER
...
#include <streams_boost/test/debug_config.hpp>

// Implementation on Windows
#if defined(_WIN32) && !defined(UNDER_CE) && !defined(STREAMS_BOOST_DISABLE_WIN32) // ******* WIN32

#  define STREAMS_BOOST_WIN32_BASED_DEBUG
...
#    define STREAMS_BOOST_MS_CRT_BASED_DEBUG
#    include <crtdbg.h>
#  endif
...
#  define STREAMS_BOOST_UNIX_BASED_DEBUG

// Boost.Test
#include <streams_boost/test/utils/class_properties.hpp>
#include <streams_boost/test/utils/algorithm.hpp>
...
#    define STREAMS_BOOST_SUN_BASED_DEBUG

#    ifndef STREAMS_BOOST_TEST_DBG_LIST
#      define STREAMS_BOOST_TEST_DBG_LIST dbx;gdb
#    endif

#    define STREAMS_BOOST_TEST_CNL_DBG  dbx
#    define STREAMS_BOOST_TEST_GUI_DBG  dbx-ddd

#    include <procfs.h>

#  elif defined(linux) || defined(__linux)

#    define STREAMS_BOOST_LINUX_BASED_DEBUG

#    include <sys/ptrace.h>

#    ifndef STREAMS_BOOST_TEST_STAT_LINE_MAX
#      define STREAMS_BOOST_TEST_STAT_LINE_MAX 500
#    endif

#    ifndef STREAMS_BOOST_TEST_DBG_LIST
#      define STREAMS_BOOST_TEST_DBG_LIST gdb
#    endif

#    define STREAMS_BOOST_TEST_CNL_DBG  gdb
#    define STREAMS_BOOST_TEST_GUI_DBG  gdb-xterm
...
#if defined(STREAMS_BOOST_WIN32_BASED_DEBUG) // *********************** WIN32
...
#elif defined(STREAMS_BOOST_UNIX_BASED_DEBUG)
...
#if defined(STREAMS_BOOST_SUN_BASED_DEBUG)
    struct psinfo   m_psi;
#elif defined(STREAMS_BOOST_LINUX_BASED_DEBUG)
    char            m_stat_line[STREAMS_BOOST_TEST_STAT_LINE_MAX+1];
#endif
...
info_t::info_t()
{
    p_dbg.value = ::getenv( "DISPLAY" )
        ? std::string( STREAMS_BOOST_STRINGIZE( STREAMS_BOOST_TEST_GUI_DBG ) )
        : std::string( STREAMS_BOOST_STRINGIZE( STREAMS_BOOST_TEST_CNL_DBG ) );
...
#elif defined(STREAMS_BOOST_UNIX_BASED_DEBUG) // ********************** UNIX

    // !! ?? could/should we cache the result somehow?
    const_string    dbg_list = STREAMS_BOOST_TEST_STRINGIZE( STREAMS_BOOST_TEST_DBG_LIST );
...
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, >= 1300)                       ||  \
    STREAMS_BOOST_WORKAROUND(__GNUC__, >= 3) && !defined(__MINGW32__)   ||  \
    defined(__INTEL_COMPILER)
#   define STREAMS_BOOST_DEBUG_BREAK    __debugbreak
#else
#   define STREAMS_BOOST_DEBUG_BREAK    DebugBreak
#endif
    ...
    if( !under_debugger() ) {
        ...
        __except (EXCEPTION_EXECUTE_HANDLER)
        {
            ...
            // continue to let the another STREAMS_BOOST_DEBUG_BREAK to be called.
        }
    }
#endif
...
#if defined(STREAMS_BOOST_UNIX_BASED_DEBUG) // ************************ UNIX
...
#ifdef STREAMS_BOOST_MS_CRT_BASED_DEBUG
...
#endif // STREAMS_BOOST_MS_CRT_BASED_DEBUG
}
...
#endif // STREAMS_BOOST_TEST_DEBUG_API_IPP_112006GER
