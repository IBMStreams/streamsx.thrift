...
#ifndef STREAMS_BOOST_TEST_UNIT_TEST_SUITE_IPP_012205GER
#define STREAMS_BOOST_TEST_UNIT_TEST_SUITE_IPP_012205GER
...
{
    STREAMS_BOOST_TEST_FOREACH( test_unit_id, tu_id, m_dependencies ) {
...
{
    STREAMS_BOOST_TEST_FOREACH( test_unit_id, id, m_members ) {
...
auto_test_unit_registrar::auto_test_unit_registrar( const_string ts_name )
{
    ...
    if( id != INV_TEST_UNIT_ID ) {
        ...
        STREAMS_BOOST_ASSERT( ts->p_parent_id == curr_ts_store().back()->p_id );
    }
    else {
...
#endif // STREAMS_BOOST_TEST_UNIT_TEST_SUITE_IPP_012205GER
