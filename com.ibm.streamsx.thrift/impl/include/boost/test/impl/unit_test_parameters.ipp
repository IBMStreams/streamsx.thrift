...
#ifndef STREAMS_BOOST_TEST_UNIT_TEST_PARAMETERS_IPP_012205GER
#define STREAMS_BOOST_TEST_UNIT_TEST_PARAMETERS_IPP_012205GER
...
#include <streams_boost/test/utils/fixed_mapping.hpp>
...
namespace rt  = streams_boost::runtime;
...
operator>>( std::istream& in, unit_test::log_level& ll )
{
    ...
    STREAMS_BOOST_TEST_SETUP_ASSERT( ll != unit_test::invalid_log_level, "invalid log level " + val );
...
operator>>( std::istream& in, unit_test::report_level& rl )
{
    ...
    STREAMS_BOOST_TEST_SETUP_ASSERT( rl != INV_REPORT_LEVEL, "invalid report level " + val );
...
operator>>( std::istream& in, unit_test::output_format& of )
{
    ...
    STREAMS_BOOST_TEST_SETUP_ASSERT( of != unit_test::INV_OF, "invalid output format " + val );
...
fixed_mapping<const_string,const_string> parameter_2_env_var(
    AUTO_START_DBG    , "STREAMS_BOOST_TEST_AUTO_START_DBG",
    BREAK_EXEC_PATH   , "STREAMS_BOOST_TEST_BREAK_EXEC_PATH",
    BUILD_INFO        , "STREAMS_BOOST_TEST_BUILD_INFO",
    CATCH_SYS_ERRORS  , "STREAMS_BOOST_TEST_CATCH_SYSTEM_ERRORS",
    DETECT_FP_EXCEPT  , "STREAMS_BOOST_TEST_DETECT_FP_EXCEPTIONS",
    DETECT_MEM_LEAKS  , "STREAMS_BOOST_TEST_DETECT_MEMORY_LEAK",
    LOG_FORMAT        , "STREAMS_BOOST_TEST_LOG_FORMAT",
    LOG_LEVEL         , "STREAMS_BOOST_TEST_LOG_LEVEL",
    LOG_SINK          , "STREAMS_BOOST_TEST_LOG_SINK",
    OUTPUT_FORMAT     , "STREAMS_BOOST_TEST_OUTPUT_FORMAT",
    RANDOM_SEED       , "STREAMS_BOOST_TEST_RANDOM",
    REPORT_FORMAT     , "STREAMS_BOOST_TEST_REPORT_FORMAT",
    REPORT_LEVEL      , "STREAMS_BOOST_TEST_REPORT_LEVEL",
    REPORT_SINK       , "STREAMS_BOOST_TEST_REPORT_SINK",
    RESULT_CODE       , "STREAMS_BOOST_TEST_RESULT_CODE",
    TESTS_TO_RUN      , "STREAMS_BOOST_TESTS_TO_RUN",
    SAVE_TEST_PATTERN , "STREAMS_BOOST_TEST_SAVE_PATTERN",
    SHOW_PROGRESS     , "STREAMS_BOOST_TEST_SHOW_PROGRESS",
    USE_ALT_STACK     , "STREAMS_BOOST_TEST_USE_ALT_STACK",
...
#ifdef STREAMS_BOOST_TEST_DEFAULTS_TO_CORE_DUMP
        false
#else
        true 
#endif
...
#endif // STREAMS_BOOST_TEST_UNIT_TEST_PARAMETERS_IPP_012205GER
