...
#ifndef STREAMS_BOOST_TEST_UNIT_TEST_MAIN_IPP_012205GER
#define STREAMS_BOOST_TEST_UNIT_TEST_MAIN_IPP_012205GER
...
#if !defined(__BORLANDC__) && !STREAMS_BOOST_WORKAROUND( STREAMS_BOOST_MSVC, < 1300 ) && !STREAMS_BOOST_WORKAROUND( __SUNPRO_CC, < 0x5100 )
#define STREAMS_BOOST_TEST_SUPPORT_RUN_BY_NAME
#include <streams_boost/test/utils/iterator/token_iterator.hpp>
#endif
...
public:
    ...
    // Constructor
#ifndef STREAMS_BOOST_TEST_SUPPORT_RUN_BY_NAME
    ...
    void            filter_unit( test_unit const& tu )
    {
        ...
        tu.p_enabled.value =
            std::find_if( filters.begin(), filters.end(), bind( &single_filter::pass, _1, streams_boost::ref(tu) ) ) != filters.end();
    }
...
main( int argc, char* argv[] )
{
    ...
    streams_boost::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::streams_boost::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    streams_boost::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::streams_boost::unit_test::unit_test_main( init_func, argc, argv );
}
...
#endif // STREAMS_BOOST_TEST_UNIT_TEST_MAIN_IPP_012205GER
