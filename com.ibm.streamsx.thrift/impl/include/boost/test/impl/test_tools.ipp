...
#ifndef STREAMS_BOOST_TEST_TEST_TOOLS_IPP_012205GER
#define STREAMS_BOOST_TEST_TEST_TOOLS_IPP_012205GER

// Boost.Test
#include <streams_boost/test/test_tools.hpp>
#include <streams_boost/test/unit_test_log.hpp>
#include <streams_boost/test/output_test_stream.hpp>
#include <streams_boost/test/framework.hpp>
#include <streams_boost/test/execution_monitor.hpp> // execution_aborted
...
using ::streams_boost::unit_test::lazy_ostream;
...
#endif // !defined( STREAMS_BOOST_NO_CWCHAR )
...
: m_pimpl( new Impl )
{
    if( !pattern_file_name.is_empty() ) {
        ...
        STREAMS_BOOST_WARN_MESSAGE( m_pimpl->m_pattern.is_open(),
...
#ifndef STREAMS_BOOST_NO_STRINGSTREAM
    str( std::string() );
#else
    seekp( 0, std::ios::beg );
#endif
...
#endif // STREAMS_BOOST_TEST_TEST_TOOLS_IPP_012205GER
