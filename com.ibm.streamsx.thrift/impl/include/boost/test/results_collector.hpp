...
#ifndef STREAMS_BOOST_TEST_RESULTS_COLLECTOR_HPP_071894GER
#define STREAMS_BOOST_TEST_RESULTS_COLLECTOR_HPP_071894GER
...
class STREAMS_BOOST_TEST_DECL test_results {
public:
    test_results();

    typedef STREAMS_BOOST_READONLY_PROPERTY( counter_t, (results_collector_t)(test_results)(results_collect_helper) ) counter_prop;
    typedef STREAMS_BOOST_READONLY_PROPERTY( bool,      (results_collector_t)(test_results)(results_collect_helper) ) bool_prop;
...
class STREAMS_BOOST_TEST_DECL results_collector_t : public test_observer, public singleton<results_collector_t> {
public:
...
private:
    STREAMS_BOOST_TEST_SINGLETON_CONS( results_collector_t );
};

STREAMS_BOOST_TEST_SINGLETON_INST( results_collector )
...
#endif // STREAMS_BOOST_TEST_RESULTS_COLLECTOR_HPP_071894GER
