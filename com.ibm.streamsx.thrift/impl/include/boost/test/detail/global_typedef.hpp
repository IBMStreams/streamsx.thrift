...
#ifndef STREAMS_BOOST_TEST_GLOBAL_TYPEDEF_HPP_021005GER
#define STREAMS_BOOST_TEST_GLOBAL_TYPEDEF_HPP_021005GER

#include <streams_boost/test/utils/basic_cstring/basic_cstring.hpp>
#define STREAMS_BOOST_TEST_L( s )         streams_boost::unit_test::const_string( s, sizeof( s ) - 1 )
#define STREAMS_BOOST_TEST_STRINGIZE( s ) STREAMS_BOOST_TEST_L( STREAMS_BOOST_STRINGIZE( s ) )
#define STREAMS_BOOST_TEST_EMPTY_STRING   STREAMS_BOOST_TEST_L( "" )
...
#endif // STREAMS_BOOST_TEST_GLOBAL_TYPEDEF_HPP_021005GER
