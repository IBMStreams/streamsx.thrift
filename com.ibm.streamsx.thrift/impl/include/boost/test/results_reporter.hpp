...
#ifndef STREAMS_BOOST_TEST_RESULTS_REPORTER_HPP_021205GER
#define STREAMS_BOOST_TEST_RESULTS_REPORTER_HPP_021205GER
...
class STREAMS_BOOST_TEST_DECL format {
public:
    // Destructor
    virtual ~format() {}
...
STREAMS_BOOST_TEST_DECL void    set_level( report_level );
STREAMS_BOOST_TEST_DECL void    set_stream( std::ostream& );
STREAMS_BOOST_TEST_DECL void    set_format( output_format );
STREAMS_BOOST_TEST_DECL void    set_format( results_reporter::format* );

STREAMS_BOOST_TEST_DECL std::ostream& get_stream();

// ************************************************************************** //
// **************               report initiation              ************** //
// ************************************************************************** //

STREAMS_BOOST_TEST_DECL void    make_report( report_level l = INV_REPORT_LEVEL, test_unit_id = INV_TEST_UNIT_ID );
...
#endif // STREAMS_BOOST_TEST_RESULTS_REPORTER_HPP_021205GER
