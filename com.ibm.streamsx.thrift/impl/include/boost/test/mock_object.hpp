...
#ifndef STREAMS_BOOST_TEST_MOCK_OBJECT_HPP_112205GER
#define STREAMS_BOOST_TEST_MOCK_OBJECT_HPP_112205GER
...
#define MO_OP_IMPL( op, descr, ret )                        \
    STREAMS_BOOST_ITEST_SCOPE( mock_object::operator op );          \
    STREAMS_BOOST_ITEST_EPOINT( descr );                            \
    return ret                                              \
/**/
...
{                                                           \
    MO_OP_IMPL( op, descr, (!!STREAMS_BOOST_ITEST_DPOINT()) );      \
}                                                           \
/**/
...
public:
    ...
    mock_object()
    {
        STREAMS_BOOST_ITEST_SCOPE( mock_object::mock_object );
        STREAMS_BOOST_ITEST_EPOINT( "Mock object default constructor" );
    }
    ...
    {
        STREAMS_BOOST_ITEST_SCOPE( mock_object::mock_object );
        STREAMS_BOOST_ITEST_EPOINT( "Mock object constructor" );
    }
    ...
    {
        STREAMS_BOOST_ITEST_SCOPE( mock_object::mock_object );
        STREAMS_BOOST_ITEST_EPOINT( "Mock object copy constructor" );
    }
    ...
    operator safe_bool() const
    {
        MO_OP_IMPL( safe_bool, "Bool context conversion",
                    (STREAMS_BOOST_ITEST_DPOINT() ? 0 : &dummy::nonnull) );
    }
...
// !! MO_BINARY_OP( STREAMS_BOOST_PP_COMMA(), "Comma operator" )
...
#endif // STREAMS_BOOST_TEST_MOCK_OBJECT_HPP_112205GER
