...
#ifndef STREAMS_BOOST_XPRESSIVE_BASIC_REGEX_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_BASIC_REGEX_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/core/regex_domain.hpp>

// Doxygen can't handle proto :-(
#ifndef STREAMS_BOOST_XPRESSIVE_DOXYGEN_INVOKED
# include <streams_boost/xpressive/detail/static/grammar.hpp>
# include <streams_boost/proto/extends.hpp>
#endif

#if STREAMS_BOOST_XPRESSIVE_HAS_MS_STACK_GUARD
...
namespace detail
{
    ...
    {
        STREAMS_BOOST_XPR_ENSURE_(!stack_error, regex_constants::error_stack, "Regex stack space exhausted");
    }
}
...
public:
    ...
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, ECMAScript         = regex_constants::ECMAScript);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, icase              = regex_constants::icase_);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, nosubs             = regex_constants::nosubs);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, optimize           = regex_constants::optimize);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, collate            = regex_constants::collate);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, single_line        = regex_constants::single_line);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, not_dot_null       = regex_constants::not_dot_null);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, not_dot_newline    = regex_constants::not_dot_newline);
    STREAMS_BOOST_STATIC_CONSTANT(regex_constants::syntax_option_type, ignore_white_space = regex_constants::ignore_white_space);
    ...
    basic_regex(Expr const &expr)
      : base_type()
    {
        STREAMS_BOOST_XPRESSIVE_CHECK_REGEX(Expr, char_type);
...
#endif // STREAMS_BOOST_XPRESSIVE_BASIC_REGEX_HPP_EAN_10_04_2005
