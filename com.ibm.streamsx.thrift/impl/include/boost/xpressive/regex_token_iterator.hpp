...
#ifndef STREAMS_BOOST_XPRESSIVE_REGEX_TOKEN_ITERATOR_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_REGEX_TOKEN_ITERATOR_HPP_EAN_10_04_2005
  ...
  : counted_base<regex_token_iterator_impl<BidiIter> >
{
    ...
    (
      ...
      , subs_()
    {
        STREAMS_BOOST_ASSERT(0 != subs.size());
...
{
    STREAMS_BOOST_MPL_ASSERT((is_convertible<Int, int>));
