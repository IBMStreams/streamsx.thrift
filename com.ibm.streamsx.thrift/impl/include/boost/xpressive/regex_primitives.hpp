...
#ifndef STREAMS_BOOST_XPRESSIVE_REGEX_PRIMITIVES_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_REGEX_PRIMITIVES_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/core/matchers.hpp>
...
# include <streams_boost/xpressive/detail/core/icase.hpp>
# include <streams_boost/xpressive/detail/static/compile.hpp>
...
///////////////////////////////////////////////////////////////////////////////
/// INTERNAL ONLY
// STREAMS_BOOST_XPRESSIVE_GLOBAL
...
//#define STREAMS_BOOST_XPRESSIVE_GLOBAL(type, name, init)                                        \
//    namespace detail                                                                    \
//    {                                                                                   \
//        template<int Dummy>                                                             \
//        struct STREAMS_BOOST_PP_CAT(global_pod_, name)                                          \
//        {                                                                               \
...
//        };                                                                              \
//        template<int Dummy>                                                             \
//        type const STREAMS_BOOST_PP_CAT(global_pod_, name)<Dummy>::value = init;                \
//    }                                                                                   \
//    type const &name = detail::STREAMS_BOOST_PP_CAT(global_pod_, name)<0>::value
*/
...
public:
      ...
      : base_type(mark_tag::make_tag(mark_nbr))
    {
        ...
        STREAMS_BOOST_ASSERT(mark_nbr > 0);
    }
...
// would be preferable.
/// INTERNAL ONLY
#define STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(NAME, VALUE)                            \
    streams_boost::xpressive::mark_tag::proto_base_expr const NAME = {{VALUE}}          \
    /**/

///////////////////////////////////////////////////////////////////////////////
/// \brief Sub-match placeholder, like $& in Perl
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s0, 0);
...
/// sub-match.
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s1, 1);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s2, 2);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s3, 3);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s4, 4);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s5, 5);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s6, 6);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s7, 7);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s8, 8);
STREAMS_BOOST_XPRESSIVE_GLOBAL_MARK_TAG(s9, 9);
