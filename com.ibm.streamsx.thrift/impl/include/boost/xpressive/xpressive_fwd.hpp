...
#ifndef STREAMS_BOOST_XPRESSIVE_XPRESSIVE_FWD_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_XPRESSIVE_FWD_HPP_EAN_10_04_2005
...
# define STREAMS_BOOST_PROTO_FUSION_V2
#endif
...
#if defined(STREAMS_BOOST_NO_STD_LOCALE) & !defined(STREAMS_BOOST_XPRESSIVE_USE_C_TRAITS)
# define STREAMS_BOOST_XPRESSIVE_USE_C_TRAITS
#endif
...
#  define STREAMS_BOOST_XPRESSIVE_NO_WREGEX
# endif
#endif

// Stack protection under MS Windows
// Config logic taken from streams_boost/regex/config.hpp
#ifndef STREAMS_BOOST_XPRESSIVE_HAS_MS_STACK_GUARD
# if (defined(_WIN32) || defined(_WIN64) || defined(_WINCE))                    \
     && !defined(__GNUC__)                                                      \
     && !(defined(__BORLANDC__) && (__BORLANDC__ >= 0x600))                     \
     && !(defined(__MWERKS__) && (__MWERKS__ <= 0x3003))
#  define STREAMS_BOOST_XPRESSIVE_HAS_MS_STACK_GUARD 1
# else
#  define STREAMS_BOOST_XPRESSIVE_HAS_MS_STACK_GUARD 0
# endif
#endif
...
namespace streams_boost { namespace xpressive
{
    ...
    namespace detail
    {
        ...
        {
            #ifdef STREAMS_BOOST_XPRESSIVE_USE_C_TRAITS
