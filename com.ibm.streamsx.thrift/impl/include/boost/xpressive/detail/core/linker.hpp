...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_LINKER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_LINKER_HPP_EAN_10_04_2005
...
#else
# include <streams_boost/spirit/fusion/algorithm/for_each.hpp>
#endif
...
#include <streams_boost/xpressive/detail/utility/never_true.hpp>
...
private:
    ...
    {
        STREAMS_BOOST_ASSERT(*this->traits_type_ == typeid(Traits));
