...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_RESULTS_CACHE_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_RESULTS_CACHE_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/core/list.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
    ...
    struct results_cache
    {
        ...
        match_results<BidiIter> &append_new(nested_results<BidiIter> &out)
        {
            ...
            {
                STREAMS_BOOST_ASSERT(access::get_nested_results(this->cache_.back()).empty());
        ...
        {
            STREAMS_BOOST_ASSERT(!out.empty());
