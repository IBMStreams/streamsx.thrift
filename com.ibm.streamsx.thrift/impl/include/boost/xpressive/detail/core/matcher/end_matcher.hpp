...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_END_MATCHER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_END_MATCHER_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/core/flow_control.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
      ...
      : quant_style_assertion
    {
        ...
        static bool match(match_state<BidiIter> &state, Next const &)
        {
            ...
            STREAMS_BOOST_ASSERT(!s0.matched);
