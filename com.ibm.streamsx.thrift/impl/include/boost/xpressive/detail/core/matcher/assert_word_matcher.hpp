...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ASSERT_WORD_MATCHER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ASSERT_WORD_MATCHER_HPP_EAN_10_04_2005
...
namespace streams_boost { namespace xpressive { namespace detail
{
      ...
      : quant_style_assertion
    {
        ...
        {
            STREAMS_BOOST_ASSERT(0 != this->word_);
        }
