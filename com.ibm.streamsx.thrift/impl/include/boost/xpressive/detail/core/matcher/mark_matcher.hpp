...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_MARK_MATCHER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_MARK_MATCHER_HPP_EAN_10_04_2005
...
namespace streams_boost { namespace xpressive { namespace detail
{
      ...
      : quant_style_variable_width
    {
        ...
        {
            STREAMS_BOOST_ASSERT(this->mark_number_ < static_cast<int>(state.mark_count_));
