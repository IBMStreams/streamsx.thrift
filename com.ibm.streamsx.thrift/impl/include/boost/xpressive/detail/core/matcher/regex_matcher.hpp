...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_REGEX_MATCHER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_REGEX_MATCHER_HPP_EAN_10_04_2005
...
namespace streams_boost { namespace xpressive { namespace detail
{
      ...
      : quant_style<quant_variable_width, unknown_width::value, false>
    {
          ...
          : impl_()
        {
            ...
            STREAMS_BOOST_XPR_ENSURE_(this->impl_.xpr_, regex_constants::error_badref, "bad regex reference");
        }
        ...
        bool match(match_state<BidiIter> &state, Next const &next) const
        {
            ...
            STREAMS_BOOST_MPL_ASSERT((is_static_xpression<Next>));

            // wrap the static xpression in a matchable interface
            xpression_adaptor<reference_wrapper<Next const>, matchable<BidiIter> > adaptor(streams_boost::cref(next));
