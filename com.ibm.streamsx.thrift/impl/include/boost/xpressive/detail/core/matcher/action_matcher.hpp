...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ACTION_MATCHER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ACTION_MATCHER_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/core/action.hpp>
#include <streams_boost/xpressive/detail/core/state.hpp>
#include <streams_boost/proto/core.hpp>
#include <streams_boost/proto/context.hpp>
#include <streams_boost/xpressive/match_results.hpp> // for type_info_less
#include <streams_boost/xpressive/detail/static/transforms/as_action.hpp> // for 'read_attr'
...
# include <streams_boost/fusion/include/invoke.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
    ...
    struct mem_ptr_eval
    {
        ...
        result_type operator()(Expr &expr, Context &ctx) const
        {
            return fusion::invoke<function_type>(
              ...
              , evaluated_args(
                    fusion::push_front(fusion::pop_front(proto::right(expr)), streams_boost::ref(proto::left(expr)))
    ...
    struct opt
    {
        ...
        {
            STREAMS_BOOST_XPR_ENSURE_(0 != this->t_, regex_constants::error_badattr, "Use of uninitialized regex attribute");
            return *this->t_;
        }
      ...
      : quant_style<quant_none, 0, false>
    {
        ...
        bool match(match_state<BidiIter> &state, Next const &next) const
        {
            // Bind the arguments
            typedef
                typename streams_boost::result_of<BindActionArgs(
                    Actor const &
            ...
            *state.action_list_tail_ = &actor;
            ...
            STREAMS_BOOST_ASSERT(0 == actor.next);
