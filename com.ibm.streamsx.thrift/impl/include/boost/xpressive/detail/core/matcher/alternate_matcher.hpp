...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ALTERNATE_MATCHER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ALTERNATE_MATCHER_HPP_EAN_10_04_2005
...
#if STREAMS_BOOST_VERSION <= 103200
...
#include <streams_boost/xpressive/detail/utility/hash_peek_bitset.hpp>
#include <streams_boost/xpressive/detail/utility/algorithm.hpp>
#include <streams_boost/xpressive/detail/utility/any.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
    ...
    struct alt_match_pred
    {
        ...
        {
            return xpr.STREAMS_BOOST_NESTED_TEMPLATE push_match<Next>(*this->state_);
        }
        ...
        >
    {
        ...
        detail::width get_width() const
        {
            ...
            STREAMS_BOOST_MPL_ASSERT_RELATION(unknown_width::value, !=, Alternates::width);
