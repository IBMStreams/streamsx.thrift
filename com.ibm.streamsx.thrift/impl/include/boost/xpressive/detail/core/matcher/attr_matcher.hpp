...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ATTR_MATCHER_HPP_EAN_06_09_2007
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_MATCHER_ATTR_MATCHER_HPP_EAN_06_09_2007
...
#include <streams_boost/xpressive/detail/utility/symbols.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
      ...
      : quant_style<quant_none, 0, false>
    {
        ...
        int slot_;
        streams_boost::xpressive::detail::symbols<Matcher> sym_;
    };
