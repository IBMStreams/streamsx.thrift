...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_PEEKER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_PEEKER_HPP_EAN_10_04_2005
...
struct xpression_peeker
{
    ...
    {
        STREAMS_BOOST_ASSERT(0 != xpr.bset_.count());
    ...
    {
        STREAMS_BOOST_ASSERT(0 != xpr.charset_.base().count());
