...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_REGEX_IMPL_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_REGEX_IMPL_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/utility/tracking_ptr.hpp>
  ...
  : enable_reference_tracking<regex_impl<BidiIter> >
{
    ...
    {
        #ifdef STREAMS_BOOST_XPRESSIVE_DEBUG_CYCLE_TEST
        ++instances;
        #endif
    }
