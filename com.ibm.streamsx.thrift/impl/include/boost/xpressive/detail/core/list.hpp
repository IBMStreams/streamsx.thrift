...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_LIST_HPP_EAN_10_26_2009
#define STREAMS_BOOST_XPRESSIVE_DETAIL_CORE_LIST_HPP_EAN_10_26_2009
...
namespace streams_boost { namespace xpressive { namespace detail
{
    ...
    private:
        ...
        struct list_iterator
          : streams_boost::iterator_facade<list_iterator<Ref>, T, std::bidirectional_iterator_tag, Ref>
        {
