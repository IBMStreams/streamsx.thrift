...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_PARSE_CHARSET_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_PARSE_CHARSET_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/utility/chset/chset.hpp>
...
parse_escape(FwdIter &begin, FwdIter end, CompilerTraits &tr)
{
    ...
    STREAMS_BOOST_XPR_ENSURE_(begin != end, error_escape, "unexpected end of pattern found");
    ...
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'a'):
        esc.ch_ = STREAMS_BOOST_XPR_CHAR_(char_type, '\a');
        ++begin;
        break;
    // escape character
    ...
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'c'):
        ...
        (
            rxtraits.in_range(STREAMS_BOOST_XPR_CHAR_(char_type, 'a'), STREAMS_BOOST_XPR_CHAR_(char_type, 'z'), *begin)
         || rxtraits.in_range(STREAMS_BOOST_XPR_CHAR_(char_type, 'A'), STREAMS_BOOST_XPR_CHAR_(char_type, 'Z'), *begin)
          , error_escape
    ...
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'f'):
        esc.ch_ = STREAMS_BOOST_XPR_CHAR_(char_type, '\f');
        ++begin;
        break;
    // newline
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'n'):
        esc.ch_ = STREAMS_BOOST_XPR_CHAR_(char_type, '\n');
        ++begin;
        break;
    // return
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'r'):
        esc.ch_ = STREAMS_BOOST_XPR_CHAR_(char_type, '\r');
        ++begin;
        break;
    // horizontal tab
    ...
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'v'):
        esc.ch_ = STREAMS_BOOST_XPR_CHAR_(char_type, '\v');
        ++begin;
        break;
    // hex escape sequence
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'x'):
        ...
        STREAMS_BOOST_XPR_ENSURE_(2 == std::distance(tmp, begin), error_escape, "invalid hex escape : "
    ...
    case STREAMS_BOOST_XPR_CHAR_(char_type, 'u'):
        ...
        STREAMS_BOOST_XPR_ENSURE_(4 == std::distance(tmp, begin), error_escape, "invalid Unicode escape : "
...
)
{
    ...
    STREAMS_BOOST_XPR_ENSURE_(begin != end, error_brack, "unexpected end of pattern found");
    ...
    do
    {
        ...
        if(token_charset_hyphen == tok && have_prev)
        {
            ...
            case token_literal:
                ch_next = *begin++;
                STREAMS_BOOST_XPR_ENSURE_(ch_prev <= ch_next, error_range, "invalid charset range");
            ...
            case token_escape:
                ...
                {
                    STREAMS_BOOST_XPR_ENSURE_(ch_prev <= esc.ch_, error_range, "invalid charset range");
        ...
        case token_posix_charset_begin:
            {
                ...
                if(token_posix_charset_end == tok)
                {
                    ...
                    STREAMS_BOOST_XPR_ENSURE_(0 != chclass, error_ctype, "unknown class name");
    ...
    while(STREAMS_BOOST_XPR_ENSURE_((iprev = begin) != end, error_brack, "unexpected end of pattern found"),
