...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_DYNAMIC_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_DYNAMIC_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/dynamic/sequence.hpp>
...
{
    STREAMS_BOOST_STATIC_CONSTANT(std::size_t, width = unknown_width::value);
    STREAMS_BOOST_STATIC_CONSTANT(bool, pure = false);
};
...
{
    STREAMS_BOOST_ASSERT(spec.max_); // we should never get here if max is 0
