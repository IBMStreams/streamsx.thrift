...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_PARSER_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_PARSER_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/dynamic/dynamic.hpp>
...
{
    STREAMS_BOOST_ASSERT(0 != literal.size());
    if(1 == literal.size())
    {
...
)
{
    ...
    {
        STREAMS_BOOST_ASSERT(0 != chset.posix_yes());
