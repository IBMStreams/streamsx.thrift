...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_SEQUENCE_HPP_EAN_04_10_2006
#define STREAMS_BOOST_XPRESSIVE_DETAIL_DYNAMIC_SEQUENCE_HPP_EAN_04_10_2006
...
struct sequence
{
    ...
    sequence<BidiIter> &operator |=(sequence<BidiIter> that)
    {
        ...
        STREAMS_BOOST_ASSERT(0 != this->alternates_);
