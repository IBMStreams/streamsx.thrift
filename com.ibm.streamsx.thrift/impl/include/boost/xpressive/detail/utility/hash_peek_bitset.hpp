...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_HASH_PEEK_BITSET_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_HASH_PEEK_BITSET_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/utility/chset/basic_chset.ipp>
...
struct hash_peek_bitset
{
    ...
    void set_range(char_type from, char_type to, bool no, bool icase, Traits const &tr)
    {
        ...
        STREAMS_BOOST_ASSERT(ifrom <= ito);
    ...
    {
        STREAMS_BOOST_ASSERT(!this->icase_);
