...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_UTILITY_ALGORITHM_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_UTILITY_ALGORITHM_HPP_EAN_10_04_2005
...
#include <streams_boost/range/size.hpp>
...
{
    return &*streams_boost::begin(cont);
}

template<typename Cont>
typename range_data<Cont>::type const *data_end(Cont const &cont)
{
    return &*streams_boost::begin(cont) + streams_boost::size(cont) - is_null_terminated(cont);
}
