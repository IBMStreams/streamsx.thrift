...
=============================================================================*/
#ifndef STREAMS_BOOST_XPRESSIVE_SPIRIT_RANGE_RUN_IPP
#define STREAMS_BOOST_XPRESSIVE_SPIRIT_RANGE_RUN_IPP

///////////////////////////////////////////////////////////////////////////////
#include <algorithm> // for std::lower_bound
#include <streams_boost/limits.hpp>
#include <streams_boost/assert.hpp>
#include <streams_boost/xpressive/detail/utility/chset/range_run.hpp>
...
{
    STREAMS_BOOST_ASSERT(iter != this->run_.end());
    iter->merge(r);
