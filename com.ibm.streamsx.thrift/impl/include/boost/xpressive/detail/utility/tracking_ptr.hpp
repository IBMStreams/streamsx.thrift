...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_UTILITY_TRACKING_PTR_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_UTILITY_TRACKING_PTR_HPP_EAN_10_04_2005
...
#ifdef STREAMS_BOOST_XPRESSIVE_DEBUG_TRACKING_POINTER
# include <iostream>
#endif
#include <set>
#include <functional>
...
struct enable_reference_tracking
{
    ...
    void release()
    {
        STREAMS_BOOST_ASSERT(0 < this->cnt_);
        if(0 == --this->cnt_)
        {
            this->refs_.clear();
            this->self_.reset();
...
private:
    ...
    streams_boost::detail::atomic_count cnt_;
};
...
struct tracking_ptr
{
    STREAMS_BOOST_MPL_ASSERT((is_base_and_derived<enable_reference_tracking<Type>, Type>));
...
private:
    ...
    intrusive_ptr<element_type> fork_() const
    {
        ...
        {
            impl = this->impl_;
            STREAMS_BOOST_ASSERT(!this->has_deps_());
