...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_UTILITY_CONS_HPP_EAN_11_19_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_UTILITY_CONS_HPP_EAN_11_19_2005

#include <streams_boost/version.hpp>

#if STREAMS_BOOST_VERSION >= 103300

// In Boost 1.33+, we have a cons list in Fusion, so just include it.

# if STREAMS_BOOST_VERSION >= 103500
#  include <streams_boost/fusion/include/cons.hpp> // Boost 1.35+ has Fusion2
# else
#  include <streams_boost/spirit/fusion/sequence/cons.hpp> // Fusion1
# endif
...
# include <streams_boost/spirit/fusion/detail/config.hpp>
# include <streams_boost/spirit/fusion/detail/access.hpp>
# include <streams_boost/spirit/fusion/iterator/next.hpp>
# include <streams_boost/spirit/fusion/iterator/equal_to.hpp>
# include <streams_boost/spirit/fusion/iterator/as_fusion_iterator.hpp>
# include <streams_boost/spirit/fusion/iterator/detail/iterator_base.hpp>
# include <streams_boost/spirit/fusion/sequence/begin.hpp>
# include <streams_boost/spirit/fusion/sequence/end.hpp>
# include <streams_boost/spirit/fusion/sequence/as_fusion_sequence.hpp>
# include <streams_boost/spirit/fusion/sequence/detail/sequence_base.hpp>
...
}} // namespace streams_boost::fusion
...
#if STREAMS_BOOST_VERSION < 103301
namespace streams_boost { namespace mpl
{
    template<typename Iterator>
    struct next;
