...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_IS_PURE_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_IS_PURE_HPP_EAN_10_04_2005
...
#include <streams_boost/mpl/not_equal_to.hpp>
#include <streams_boost/xpressive/detail/detail_fwd.hpp>
#include <streams_boost/xpressive/detail/static/width_of.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
      ...
      : use_simple_repeat_<Expr, Char>
    {
        ...
        STREAMS_BOOST_MPL_ASSERT_RELATION(0, !=, (width_of<Expr, Char>::value));
    };
