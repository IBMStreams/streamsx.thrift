...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_SET_HPP_EAN_04_05_2007
#define STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_SET_HPP_EAN_04_05_2007
...
namespace streams_boost { namespace xpressive { namespace grammar_detail
{
    ...
    private:
        ...
        {
            // BUGBUG fixme!
            STREAMS_BOOST_MPL_ASSERT_NOT((Not));
        ...
        {
            // BUGBUG fixme!
            STREAMS_BOOST_ASSERT(!set_.not_);
