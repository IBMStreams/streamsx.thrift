...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_QUANTIFIER_HPP_EAN_04_01_2007
#define STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_QUANTIFIER_HPP_EAN_04_01_2007
    ...
    struct as_default_quantifier_impl : proto::transform<as_default_quantifier_impl<Greedy, Min, Max> >
    {
        ...
        struct impl : proto::transform_impl<Expr, State, Data>
        {
            ...
            ) const
            {
                ...
                STREAMS_BOOST_ASSERT(0 != mark_number);
