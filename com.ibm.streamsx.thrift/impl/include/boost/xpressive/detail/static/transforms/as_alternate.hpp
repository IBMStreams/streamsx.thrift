...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_ALTERNATE_HPP_EAN_04_01_2007
#define STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSFORMS_AS_ALTERNATE_HPP_EAN_04_01_2007
...
#include <streams_boost/xpressive/detail/utility/cons.hpp>
...
namespace streams_boost { namespace xpressive
{
    namespace detail
    {
        ...
        {
            STREAMS_BOOST_STATIC_CONSTANT(std::size_t, width = Head::width == Tail::width ? Head::width : detail::unknown_width::value);
            STREAMS_BOOST_STATIC_CONSTANT(bool, pure = Head::pure && Tail::pure);
        ...
        {
            STREAMS_BOOST_STATIC_CONSTANT(std::size_t, width = Head::width);
            STREAMS_BOOST_STATIC_CONSTANT(bool, pure = Head::pure);
