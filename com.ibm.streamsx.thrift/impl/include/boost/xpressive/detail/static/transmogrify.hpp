...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSMOGRIFY_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_TRANSMOGRIFY_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/utility/dont_care.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
    ...
    struct default_transmogrify<BidiIter, ICase, Traits, Matcher, typename Matcher::is_streams_boost_xpressive_xpression_>
    {
    ...
    struct transmogrify<BidiIter, ICase, Traits, range_placeholder<Char> >
    {
        ...
        STREAMS_BOOST_MPL_ASSERT((is_same<Char, char_type>));
