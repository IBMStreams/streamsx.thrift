...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_VISITOR_HPP_EAN_10_04_2005
#define STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_VISITOR_HPP_EAN_10_04_2005
...
#include <streams_boost/xpressive/detail/static/transmogrify.hpp>
...
namespace streams_boost { namespace xpressive { namespace detail
{
      ...
      : xpression_visitor_base<BidiIter>
    {
        ...
        typedef typename streams_boost::iterator_value<BidiIter>::type char_type;
