...
#ifndef STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_GRAMMAR_HPP_EAN_11_12_2006
#define STREAMS_BOOST_XPRESSIVE_DETAIL_STATIC_GRAMMAR_HPP_EAN_11_12_2006
...
#include <streams_boost/xpressive/detail/static/is_pure.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_matcher.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_alternate.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_sequence.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_quantifier.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_marker.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_set.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_independent.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_modifier.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_inverse.hpp>
#include <streams_boost/xpressive/detail/static/transforms/as_action.hpp>
#include <streams_boost/xpressive/detail/detail_fwd.hpp>

#define STREAMS_BOOST_XPRESSIVE_CHECK_REGEX(Expr, Char)\
    STREAMS_BOOST_MPL_ASSERT\
    ((\
        typename streams_boost::mpl::if_c<\
            streams_boost::xpressive::is_valid_regex<Expr, Char>::value\
          , streams_boost::mpl::true_\
          , streams_boost::xpressive::INVALID_REGULAR_EXPRESSION\
        >::type\
    ));
