...
#ifndef STREAMS_BOOST_TT_MAKE_UNSIGNED_HPP_INCLUDED
#define STREAMS_BOOST_TT_MAKE_UNSIGNED_HPP_INCLUDED
...
struct make_unsigned_imp
{
   ...
   typedef typename mpl::if_c<
      (::streams_boost::type_traits::ice_and< 
         ::streams_boost::is_unsigned<T>::value,
...
STREAMS_BOOST_TT_AUX_TYPE_TRAIT_DEF1(make_unsigned,T,typename streams_boost::detail::make_unsigned_imp<T>::type)
