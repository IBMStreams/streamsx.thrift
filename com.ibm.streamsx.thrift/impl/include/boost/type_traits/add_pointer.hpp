...
#ifndef STREAMS_BOOST_TT_ADD_POINTER_HPP_INCLUDED
#define STREAMS_BOOST_TT_ADD_POINTER_HPP_INCLUDED
...
STREAMS_BOOST_TT_AUX_TYPE_TRAIT_DEF1(add_pointer,T,typename streams_boost::detail::add_pointer_impl<T>::type)

} // namespace streams_boost

#include <streams_boost/type_traits/detail/type_trait_undef.hpp>

#endif // STREAMS_BOOST_TT_ADD_POINTER_HPP_INCLUDED
