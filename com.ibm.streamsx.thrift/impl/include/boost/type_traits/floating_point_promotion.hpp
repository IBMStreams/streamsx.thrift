...
#ifndef FILE_streams_boost_type_traits_floating_point_promotion_hpp_INCLUDED
#define FILE_streams_boost_type_traits_floating_point_promotion_hpp_INCLUDED

#include <streams_boost/config.hpp>

#ifdef STREAMS_BOOST_NO_CV_SPECIALIZATIONS
...
STREAMS_BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , STREAMS_BOOST_DEDUCED_TYPENAME
        streams_boost::type_traits::detail::floating_point_promotion<T>::type
    )
}

#include <streams_boost/type_traits/detail/type_trait_undef.hpp>

#endif // #ifndef FILE_streams_boost_type_traits_floating_point_promotion_hpp_INCLUDED
