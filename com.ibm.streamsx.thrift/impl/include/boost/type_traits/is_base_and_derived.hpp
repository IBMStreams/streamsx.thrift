...
#ifndef STREAMS_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
#define STREAMS_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED

#include <streams_boost/type_traits/intrinsics.hpp>
#ifndef STREAMS_BOOST_IS_BASE_OF
...
namespace detail {
 ...
 && !STREAMS_BOOST_WORKAROUND(__SUNPRO_CC , <= 0x540) \
...
#pragma warning(disable:6334)
    ...
    //
    STREAMS_BOOST_STATIC_ASSERT(sizeof(B) != 0);
    STREAMS_BOOST_STATIC_ASSERT(sizeof(D) != 0);
...
{
    STREAMS_BOOST_STATIC_CONSTANT(bool, value =
        (::streams_boost::is_convertible<D*,B*>::value));
};

#define STREAMS_BOOST_BROKEN_IS_BASE_AND_DERIVED
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::streams_boost::is_class<B>::value,
       ::streams_boost::is_class<D>::value,
       ::streams_boost::is_same<ncvB,ncvD>::value> selector;
    typedef typename selector::template rebind<ncvB,ncvD> binder;
    typedef typename binder::type bound_type;

    STREAMS_BOOST_STATIC_CONSTANT(bool, value = bound_type::value);
};
#else
template <typename B, typename D>
struct is_base_and_derived_impl
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = (STREAMS_BOOST_IS_BASE_OF(B,D) && ! ::streams_boost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::streams_boost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )

#ifndef STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived,false)
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base,Derived&,false)
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived&,false)
#endif

#if STREAMS_BOOST_WORKAROUND(__CODEGEARC__, STREAMS_BOOST_TESTED_AT(0x610))
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename Base,is_base_and_derived,Base,Base,false)
#endif
...
#endif // STREAMS_BOOST_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
