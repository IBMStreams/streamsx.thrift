...
#ifndef STREAMS_BOOST_TT_IS_BASE_OF_HPP_INCLUDED
#define STREAMS_BOOST_TT_IS_BASE_OF_HPP_INCLUDED
   ...
   namespace detail{
      ...
      struct is_base_of_imp
      {
          ...
          STREAMS_BOOST_STATIC_CONSTANT(bool, value = (::streams_boost::type_traits::ice_or<      
            ...
            (::streams_boost::type_traits::ice_and< ::streams_boost::is_same<ncvB,ncvD>::value, ::streams_boost::is_class<ncvB>::value>::value)>::value));
      };
   }
...
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::streams_boost::detail::is_base_of_imp<Base, Derived>::value))
