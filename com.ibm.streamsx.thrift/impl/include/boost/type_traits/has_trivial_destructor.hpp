...
#ifndef STREAMS_BOOST_TT_HAS_TRIVIAL_DESTRUCTOR_HPP_INCLUDED
#define STREAMS_BOOST_TT_HAS_TRIVIAL_DESTRUCTOR_HPP_INCLUDED
...
struct has_trivial_dtor_impl
{
   STREAMS_BOOST_STATIC_CONSTANT(bool, value =
      (::streams_boost::type_traits::ice_or<
         ...
         STREAMS_BOOST_HAS_TRIVIAL_DESTRUCTOR(T)
      >::value));
};

} // namespace detail

STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_destructor,T,::streams_boost::detail::has_trivial_dtor_impl<T>::value)

} // namespace streams_boost

#include <streams_boost/type_traits/detail/bool_trait_undef.hpp>

#endif // STREAMS_BOOST_TT_HAS_TRIVIAL_DESTRUCTOR_HPP_INCLUDED
