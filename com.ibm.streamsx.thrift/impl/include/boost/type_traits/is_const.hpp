...
#ifndef STREAMS_BOOST_TT_IS_CONST_HPP_INCLUDED
#define STREAMS_BOOST_TT_IS_CONST_HPP_INCLUDED
...
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,__is_const(T))

#elif !defined(STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)

//* is a type T  declared const - is_const<T>
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, < 1400)
   STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::streams_boost::detail::cv_traits_imp<typename remove_bounds<T>::type*>::is_const)
#else
   STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::streams_boost::detail::cv_traits_imp<T*>::is_const)
#endif
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T&,false)
...
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T& const,false)
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T& volatile,false)
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T& const volatile,false)
#endif

#if defined(__GNUC__) && (__GNUC__ < 3)
// special case for gcc where illegally cv-qualified reference types can be
// generated in some corner cases:
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T const,!(::streams_boost::is_reference<T>::value))
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T volatile const,!(::streams_boost::is_reference<T>::value))
#endif
...
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_const,void,false)
#ifndef STREAMS_BOOST_NO_CV_VOID_SPECIALIZATIONS
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_const,void const,true)
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_const,void volatile,false)
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_const,void const volatile,true)
#endif

} // namespace detail

//* is a type T  declared const - is_const<T>
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::streams_boost::detail::is_const_impl<T>::value)
...
#endif // STREAMS_BOOST_TT_IS_CONST_HPP_INCLUDED
