    ...
    #ifndef STREAMS_BOOST_PROTO_EXPR_HPP_EAN_04_01_2005
    #define STREAMS_BOOST_PROTO_EXPR_HPP_EAN_04_01_2005
    ...
    namespace streams_boost { namespace proto
    {
        ...
        #define STREAMS_BOOST_PROTO_CHILD(Z, N, DATA)                                                       \
            typedef STREAMS_BOOST_PP_CAT(Arg, N) STREAMS_BOOST_PP_CAT(proto_child, N);                              \
            STREAMS_BOOST_PP_CAT(proto_child, N) STREAMS_BOOST_PP_CAT(child, N);                                    \
            /**< INTERNAL ONLY */

        /// INTERNAL ONLY
        ///
        #define STREAMS_BOOST_PROTO_VOID(Z, N, DATA)                                                        \
            typedef void STREAMS_BOOST_PP_CAT(proto_child, N);                                              \
            /**< INTERNAL ONLY */
        ...
        #define STREAMS_BOOST_PP_ITERATION_PARAMS_1 (3, (0, STREAMS_BOOST_PP_DEC(STREAMS_BOOST_PROTO_MAX_FUNCTION_CALL_ARITY), <streams_boost/proto/detail/funop.hpp>))
        #include STREAMS_BOOST_PP_ITERATE()
        }

        // TODO consider adding a basic_expr<> that doesn't have operator=,
        // operator[] or operator() for use by STREAMS_BOOST_PROTO_BASIC_EXTENDS().
        ...
        namespace exprns_
        {
            #define STREAMS_BOOST_PP_ITERATION_PARAMS_1 (3, (0, STREAMS_BOOST_PROTO_MAX_ARITY, <streams_boost/proto/expr.hpp>))
            #include STREAMS_BOOST_PP_ITERATE()
        }

        #undef STREAMS_BOOST_PROTO_CHILD
        #undef STREAMS_BOOST_PROTO_VOID
    ...
    #endif // STREAMS_BOOST_PROTO_EXPR_HPP_EAN_04_01_2005
...
// STREAMS_BOOST_PP_ITERATION_DEPTH test inside an #else clause.
    ...
    #define ARG_COUNT STREAMS_BOOST_PP_MAX(1, STREAMS_BOOST_PP_ITERATION())
    #define IS_TERMINAL 0 == STREAMS_BOOST_PP_ITERATION()
        ...
        ///             in the \c streams_boost::proto::tag namespace, but it doesn't
        ///             have to be.
        ///
        ...
        #else
        template<typename Tag STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(ARG_COUNT, typename Arg)>
        struct expr<Tag, STREAMS_BOOST_PP_CAT(list, STREAMS_BOOST_PP_ITERATION())<STREAMS_BOOST_PP_ENUM_PARAMS(ARG_COUNT, Arg)>, STREAMS_BOOST_PP_ITERATION() >
        #endif
        {
            typedef Tag proto_tag;
            STREAMS_BOOST_STATIC_CONSTANT(long, proto_arity_c = STREAMS_BOOST_PP_ITERATION());
            typedef mpl::long_<STREAMS_BOOST_PP_ITERATION() > proto_arity;
            typedef expr proto_base_expr;
            #if IS_TERMINAL
            typedef term<Arg0> proto_args;
            #else
            typedef STREAMS_BOOST_PP_CAT(list, STREAMS_BOOST_PP_ITERATION())<STREAMS_BOOST_PP_ENUM_PARAMS(ARG_COUNT, Arg)> proto_args;
            #endif
            ...
            STREAMS_BOOST_PP_REPEAT(ARG_COUNT, STREAMS_BOOST_PROTO_CHILD, ~)
            STREAMS_BOOST_PP_REPEAT_FROM_TO(ARG_COUNT, STREAMS_BOOST_PROTO_MAX_ARITY, STREAMS_BOOST_PROTO_VOID, ~)
            ...
            /// arguments.
            ///
            template<STREAMS_BOOST_PP_ENUM_PARAMS(ARG_COUNT, typename A)>
            static expr const make(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(ARG_COUNT, A, const &a))
            {
                expr that = {STREAMS_BOOST_PP_ENUM_PARAMS(ARG_COUNT, a)};
                return that;
            }
        #endif

        #if 1 == STREAMS_BOOST_PP_ITERATION()
            /// If \c Tag is \c streams_boost::proto::tag::address_of and \c proto_child0 is
            ...
            /// \c streams_boost::proto::tag::address_of. Otherwise, this function will
            /// fail to compile.
            ///
            ...
            {
                return streams_boost::addressof(this->child0);
            }
        #else
            /// INTERNAL ONLY
            ///
            ...
            /// Encodes the return type of \c expr\<\>::operator(), for use with \c streams_boost::result_of\<\>
            ///
    ...
    #define STREAMS_BOOST_PP_ITERATION_PARAMS_2 (3, (1, STREAMS_BOOST_PP_DEC(STREAMS_BOOST_PROTO_MAX_FUNCTION_CALL_ARITY), <streams_boost/proto/expr.hpp>))
    #include STREAMS_BOOST_PP_ITERATE()
        };
    ...
    #define N STREAMS_BOOST_PP_ITERATION()
        ...
        typename result_of::STREAMS_BOOST_PP_CAT(funop, N)<
            expr const
          , default_domain STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(N, const A)
        >::type const
        operator ()(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(N, A, const &a)) const
        {
            return result_of::STREAMS_BOOST_PP_CAT(funop, N)<
                expr const
              , default_domain STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(N, const A)
            >::call(*this STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(N, a));
        }
        ...
        typename result_of::STREAMS_BOOST_PP_CAT(funop, N)<
          ...
          , default_domain STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(N, const A)
        >::type const
        operator ()(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(N, A, const &a))
        {
            return result_of::STREAMS_BOOST_PP_CAT(funop, N)<
                expr
              , default_domain STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(N, const A)
