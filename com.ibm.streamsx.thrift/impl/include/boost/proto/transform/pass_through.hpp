    ...
    #ifndef STREAMS_BOOST_PROTO_TRANSFORM_PASS_THROUGH_HPP_EAN_12_26_2006
    #define STREAMS_BOOST_PROTO_TRANSFORM_PASS_THROUGH_HPP_EAN_12_26_2006
    ...
    namespace streams_boost { namespace proto
    {
        namespace detail
        {
            ...
            #define STREAMS_BOOST_PROTO_DEFINE_TRANSFORM_TYPE(Z, N, DATA)                                   \
                typename Grammar::STREAMS_BOOST_PP_CAT(proto_child, N)::template impl<                      \
                    typename result_of::child_c<Expr, N>::type                                      \
                  , State                                                                           \
                  , Data                                                                            \
                >::result_type

            #define STREAMS_BOOST_PROTO_DEFINE_TRANSFORM(Z, N, DATA)                                        \
                typename Grammar::STREAMS_BOOST_PP_CAT(proto_child, N)::template impl<                      \
                    typename result_of::child_c<Expr, N>::type                                      \
                  , State                                                                           \
                  , Data                                                                            \
                >()(                                                                                \
                    e.proto_base().STREAMS_BOOST_PP_CAT(child, N), s, d                           \
                )

            #define STREAMS_BOOST_PP_ITERATION_PARAMS_1 (3, (1, STREAMS_BOOST_PROTO_MAX_ARITY, <streams_boost/proto/transform/pass_through.hpp>))
            #include STREAMS_BOOST_PP_ITERATE()

            #undef STREAMS_BOOST_PROTO_DEFINE_TRANSFORM
            #undef STREAMS_BOOST_PROTO_DEFINE_TRANSFORM_TYPE
              ...
              : transform_impl<Expr, State, Data>
            {
                typedef proto::expr<
                  ...
                  , STREAMS_BOOST_PP_CAT(list, N)<
                        STREAMS_BOOST_PP_ENUM(N, STREAMS_BOOST_PROTO_DEFINE_TRANSFORM_TYPE, ~)
                    >
                  , N
                > result_type;
                ...
                {
                    result_type that = {
                        STREAMS_BOOST_PP_ENUM(N, STREAMS_BOOST_PROTO_DEFINE_TRANSFORM, ~)
                    };
