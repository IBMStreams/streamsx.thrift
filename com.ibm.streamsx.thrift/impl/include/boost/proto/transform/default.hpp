    ...
    #ifndef STREAMS_BOOST_PROTO_TRANSFORM_DEFAULT_HPP_EAN_04_04_2008
    #define STREAMS_BOOST_PROTO_TRANSFORM_DEFAULT_HPP_EAN_04_04_2008
    ...
    #include <streams_boost/proto/transform/arg.hpp>
    ...
    namespace streams_boost { namespace proto
    {
          ...
          : transform<_default<Grammar> >
        {
            ...
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(+, tag::unary_plus, make)
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(-, tag::negate, make)
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(*, tag::dereference, make)
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(~, tag::complement, make)
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(&, tag::address_of, make)
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(!, tag::logical_not, make)
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(++, tag::pre_inc, make_mutable)
            STREAMS_BOOST_PROTO_UNARY_OP_RESULT(--, tag::pre_dec, make_mutable)

            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(<<, tag::shift_left, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(>>, tag::shift_right, make_mutable, make_mutable)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(*, tag::multiplies, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(/, tag::divides, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(%, tag::modulus, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(+, tag::plus, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(-, tag::minus, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(<, tag::less, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(>, tag::greater, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(<=, tag::less_equal, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(>=, tag::greater_equal, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(==, tag::equal_to, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(!=, tag::not_equal_to, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(||, tag::logical_or, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(&&, tag::logical_and, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(&, tag::bitwise_and, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(|, tag::bitwise_or, make, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(^, tag::bitwise_xor, make, make)

            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(=, tag::assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(<<=, tag::shift_left_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(>>=, tag::shift_right_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(*=, tag::multiplies_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(/=, tag::divides_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(%=, tag::modulus_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(+=, tag::plus_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(-=, tag::minus_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(&=, tag::bitwise_and_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(|=, tag::bitwise_or_assign, make_mutable, make)
            STREAMS_BOOST_PROTO_BINARY_OP_RESULT(^=, tag::bitwise_xor_assign, make_mutable, make)
            ...
            #define EVAL_TYPE(Z, N, DATA)                                                           \
                ...
                STREAMS_BOOST_PP_CAT(e, N);                                                                 \
                typedef                                                                             \
                    typename Grammar::template impl<STREAMS_BOOST_PP_CAT(e, N), State, Data>::result_type   \
                STREAMS_BOOST_PP_CAT(r, N);                                                                 \
                /**/

            #define EVAL(Z, N, DATA)                                                                \
                typename Grammar::template impl<STREAMS_BOOST_PP_CAT(e, N), State, Data>()(                 \
            ...
            private:
                ...
                ) const
                {
                    ...
                    return (STREAMS_BOOST_PROTO_GET_POINTER(class_type, EVAL(~, 1, e)) ->* EVAL(~, 0, e))();
                }
            ...
            #define STREAMS_BOOST_PP_ITERATION_PARAMS_1 (3, (3, STREAMS_BOOST_PROTO_MAX_ARITY, <streams_boost/proto/transform/default.hpp>))
    ...
    #define N STREAMS_BOOST_PP_ITERATION()
        ...
        struct impl2<Expr, State, Data, tag::function, N>
          : transform_impl<Expr, State, Data>
        {
            STREAMS_BOOST_PP_REPEAT(N, EVAL_TYPE, Expr)
            ...
            typedef
                typename streams_boost::result_of<
                    function_type(STREAMS_BOOST_PP_ENUM_SHIFTED_PARAMS(N, r))
                >::type
            result_type;
        ...
        private:
            ...
            {
                return EVAL(~, 0, e)(STREAMS_BOOST_PP_ENUM_SHIFTED(N, EVAL, e));
            }
            ...
            {
                #define M0(Z, M, e) STREAMS_BOOST_PP_COMMA_IF(STREAMS_BOOST_PP_SUB(M, 2)) EVAL(Z, M, e)
                STREAMS_BOOST_PROTO_USE_GET_POINTER();
                typedef typename detail::classtypeof<function_type>::type class_type;
                return (STREAMS_BOOST_PROTO_GET_POINTER(class_type, EVAL(~, 1, e)) ->* EVAL(~, 0, e))(
                    STREAMS_BOOST_PP_REPEAT_FROM_TO(2, N, M0, e)
                );
                #undef M0
            }
        };
