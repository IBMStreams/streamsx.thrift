...
#ifndef STREAMS_BOOST_PROTO_DOMAIN_HPP_EAN_02_13_2007
#define STREAMS_BOOST_PROTO_DOMAIN_HPP_EAN_02_13_2007
...
namespace streams_boost { namespace proto
{
    ...
    namespace result_of
    {
        ...
        ///
        template<typename T>
        struct domain_of<streams_boost::reference_wrapper<T>, void>
        {
            typedef typename domain_of<T>::type type;
        };
        ...
        ///
        template<typename T>
        struct domain_of<streams_boost::reference_wrapper<T> const, void>
        {
            typedef typename domain_of<T>::type type;
        };
    }
