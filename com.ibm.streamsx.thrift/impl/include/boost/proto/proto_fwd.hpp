...
#ifndef STREAMS_BOOST_PROTO_FWD_HPP_EAN_04_01_2005
#define STREAMS_BOOST_PROTO_FWD_HPP_EAN_04_01_2005
...
#ifndef STREAMS_BOOST_PROTO_MAX_ARITY
# define STREAMS_BOOST_PROTO_MAX_ARITY 5
#endif

#ifndef STREAMS_BOOST_PROTO_MAX_LOGICAL_ARITY
# define STREAMS_BOOST_PROTO_MAX_LOGICAL_ARITY 8
#endif

#ifndef STREAMS_BOOST_PROTO_MAX_FUNCTION_CALL_ARITY
# define STREAMS_BOOST_PROTO_MAX_FUNCTION_CALL_ARITY STREAMS_BOOST_PROTO_MAX_ARITY
#endif

#if STREAMS_BOOST_PROTO_MAX_ARITY < 3
# error STREAMS_BOOST_PROTO_MAX_ARITY must be at least 3
#endif

#if STREAMS_BOOST_PROTO_MAX_FUNCTION_CALL_ARITY > STREAMS_BOOST_PROTO_MAX_ARITY
# error STREAMS_BOOST_PROTO_MAX_FUNCTION_CALL_ARITY cannot be larger than STREAMS_BOOST_PROTO_MAX_ARITY
#endif

#ifndef STREAMS_BOOST_PROTO_BROKEN_CONST_OVERLOADS
# if STREAMS_BOOST_WORKAROUND(__GNUC__, == 3) \
  || STREAMS_BOOST_WORKAROUND(__EDG_VERSION__, STREAMS_BOOST_TESTED_AT(310))
#  define STREAMS_BOOST_PROTO_BROKEN_CONST_OVERLOADS
# endif
#endif

#ifndef STREAMS_BOOST_PROTO_BROKEN_CONST_QUALIFIED_FUNCTIONS
# if STREAMS_BOOST_WORKAROUND(__GNUC__, == 3) \
  || STREAMS_BOOST_WORKAROUND(__EDG_VERSION__, STREAMS_BOOST_TESTED_AT(310))
#  define STREAMS_BOOST_PROTO_BROKEN_CONST_QUALIFIED_FUNCTIONS
# endif
#endif

#ifdef STREAMS_BOOST_PROTO_BROKEN_CONST_OVERLOADS
# include <streams_boost/utility/enable_if.hpp>
# include <streams_boost/type_traits/is_const.hpp>
# define STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(T)\
    , typename streams_boost::disable_if_c<streams_boost::is_const<T>::value, streams_boost::proto::detail::undefined>::type * = 0
#else
# define STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(T)
#endif

#ifdef STREAMS_BOOST_PROTO_BROKEN_CONST_QUALIFIED_FUNCTIONS
# include <streams_boost/utility/enable_if.hpp>
# include <streams_boost/type_traits/is_function.hpp>
# define STREAMS_BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)\
    , typename streams_boost::disable_if_c<streams_boost::is_function<T>::value, streams_boost::proto::detail::undefined>::type * = 0
#else
# define STREAMS_BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T)
#endif

#ifndef STREAMS_BOOST_PROTO_BROKEN_PTS
# if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1400)
#  define STREAMS_BOOST_PROTO_BROKEN_PTS
# endif
#endif
...
namespace streams_boost { namespace proto
{
    namespace detail
    {
        ...
        /// INTERNAL ONLY
        ///
        #define STREAMS_BOOST_PROTO_UNCVREF(X)                                                              \
            typename streams_boost::remove_const<typename streams_boost::remove_reference<X>::type>::type
    ...
    namespace argsns_
    {
        ...
        #define M0(Z, N, DATA)                                                                      \
        template<STREAMS_BOOST_PP_ENUM_PARAMS_Z(Z, N, typename Arg)> struct STREAMS_BOOST_PP_CAT(list, N);          \
        /**/
        STREAMS_BOOST_PP_REPEAT_FROM_TO(1, STREAMS_BOOST_PP_INC(STREAMS_BOOST_PROTO_MAX_ARITY), M0, ~)
        #undef M0
    }

    using argsns_::term;

    #define M0(Z, N, DATA) using argsns_::STREAMS_BOOST_PP_CAT(list, N);
    STREAMS_BOOST_PP_REPEAT_FROM_TO(1, STREAMS_BOOST_PP_INC(STREAMS_BOOST_PROTO_MAX_ARITY), M0, ~)
    #undef M0
    ...
    namespace control
    {
        template<STREAMS_BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(STREAMS_BOOST_PROTO_MAX_LOGICAL_ARITY, typename G, void)>
        struct or_;
    ...
    namespace op
    {
        ...
        template<typename Tag, STREAMS_BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(STREAMS_BOOST_PROTO_MAX_ARITY, typename A, void)>
        struct nary_expr;
    ...
    #define STREAMS_BOOST_PROTO_UNEXPR() typedef int proto_is_expr_;
    #define STREAMS_BOOST_PROTO_CALLABLE() typedef void proto_is_callable_;
    #define STREAMS_BOOST_PROTO_AGGREGATE() typedef void proto_is_aggregate_;
    ...
    #define M0(Z, N, DATA) typedef _child_c<N> STREAMS_BOOST_PP_CAT(_child, N);
    STREAMS_BOOST_PP_REPEAT_FROM_TO(
        2
      , STREAMS_BOOST_PP_DEC(STREAMS_BOOST_PROTO_MAX_ARITY)
      , M0
      , ~
    )
    #undef M0
