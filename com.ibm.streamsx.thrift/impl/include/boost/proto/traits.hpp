    ...
    #ifndef STREAMS_BOOST_PROTO_ARG_TRAITS_HPP_EAN_04_01_2005
    #define STREAMS_BOOST_PROTO_ARG_TRAITS_HPP_EAN_04_01_2005
    ...
    #include <streams_boost/proto/transform/pass_through.hpp>
    ...
    namespace streams_boost { namespace proto
    {
        namespace detail
        {
            ...
            template<typename T STREAMS_BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(long Arity = mpl::aux::template_arity<T>::value)>
            struct is_callable_
              : is_callable2_<T>
            {};
        }
        ...
        namespace result_of
        {
            ...
            /// <tt>STREAMS_BOOST_PROTO_BASIC_EXTENDS()</tt> macro.) Otherwise,
            ...
            /// <tt>streams_boost::result_of\<Domain(expr\< tag::terminal, term\<A\> \>)\>::::type</tt>.
            template<
                typename T
              , typename Domain // = default_domain
              , typename Void   // = void
              #ifdef STREAMS_BOOST_PROTO_BROKEN_PTS
              , typename Void2  // = void
              #endif
            >
            struct as_expr
            ...
            /// <tt>streams_boost::result_of\<Domain(expr\< tag::terminal, term\<T &\> \>)\>::::type</tt>.
            template<
                typename T
              , typename Domain // = default_domain
              , typename Void   // = void
            ...
            >
            {
                // BUGBUG should be able to hold this guy by reference, no?
                    ...
                    STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_INTEL, STREAMS_BOOST_TESTED_AT(1010))
        ...
        #define STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(Op)                                           \
            template<typename T>                                                                    \
            struct Op                                                                               \
        ...
        #define STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(Op)                                          \
            ...
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(unary_plus)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(negate)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(dereference)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(complement)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(address_of)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(logical_not)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(pre_inc)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(pre_dec)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(post_inc)
            STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION(post_dec)

            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_left)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_right)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(multiplies)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(divides)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(modulus)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(plus)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(minus)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(less)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(greater)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(less_equal)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(greater_equal)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(equal_to)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(not_equal_to)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(logical_or)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(logical_and)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_or)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_and)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_xor)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(comma)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(mem_ptr)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_left_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(shift_right_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(multiplies_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(divides_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(modulus_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(plus_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(minus_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_or_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_and_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(bitwise_xor_assign)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(subscript)
            STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(member)

        #undef STREAMS_BOOST_PROTO_DEFINE_UNARY_METAFUNCTION
        #undef STREAMS_BOOST_PROTO_DEFINE_BINARY_METAFUNCTION

        } // namespace op

    #define STREAMS_BOOST_PROTO_CHILD(Z, N, DATA)                                                           \
        /** INTERNAL ONLY */                                                                        \
        typedef STREAMS_BOOST_PP_CAT(DATA, N) STREAMS_BOOST_PP_CAT(proto_child, N);                                 \
        /**/

    #define STREAMS_BOOST_PP_ITERATION_PARAMS_1 (3, (0, STREAMS_BOOST_PROTO_MAX_ARITY, <streams_boost/proto/traits.hpp>))
    #include STREAMS_BOOST_PP_ITERATE()

    #undef STREAMS_BOOST_PROTO_CHILD
    #undef STREAMS_BOOST_PROTO_IMPLICIT_ARG
        ...
        as_expr(T &t STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(T) STREAMS_BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
        {
        ...
        as_child(T &t STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(T) STREAMS_BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
        {
        ...
        typename result_of::child<Expr &, N>::type
        child(Expr &e STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return result_of::child<Expr &, N>::call(e);
        }
        ...
        child(Expr2 &expr2 STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(Expr2))
        {
        ...
        typename result_of::child_c<Expr &, N>::type
        child_c(Expr &e STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return result_of::child_c<Expr &, N>::call(e);
        }
        ...
        template<typename Expr>
        typename result_of::value<Expr &>::type
        value(Expr &e STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return e.proto_base().child0;
        }
        ...
        template<typename Expr>
        typename result_of::left<Expr &>::type
        left(Expr &e STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return e.proto_base().child0;
        }
        ...
        template<typename Expr>
        typename result_of::right<Expr &>::type
        right(Expr &e STREAMS_BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return e.proto_base().child1;
        }
    ...
    #define N STREAMS_BOOST_PP_ITERATION()
        ...
        namespace op
        {
            ...
            struct function
            #if N != STREAMS_BOOST_PROTO_MAX_ARITY
            <
                STREAMS_BOOST_PP_ENUM_PARAMS(N, A)
                STREAMS_BOOST_PP_ENUM_TRAILING_PARAMS(STREAMS_BOOST_PP_SUB(STREAMS_BOOST_PROTO_MAX_ARITY, N), void STREAMS_BOOST_PP_INTERCEPT)
            >
            #endif
              : proto::transform<
                    function<
                ...
                >
            {
                typedef proto::expr<proto::tag::function, STREAMS_BOOST_PP_CAT(list, N)<STREAMS_BOOST_PP_ENUM_PARAMS(N, A)>, N> type;
                typedef type proto_base_expr;
                ...
                STREAMS_BOOST_PP_REPEAT(N, STREAMS_BOOST_PROTO_CHILD, A)
                STREAMS_BOOST_PP_REPEAT_FROM_TO(
                    N
                  , STREAMS_BOOST_PROTO_MAX_ARITY
                  , STREAMS_BOOST_PROTO_CHILD
                  , detail::if_vararg<STREAMS_BOOST_PP_CAT(A, STREAMS_BOOST_PP_DEC(N))> STREAMS_BOOST_PP_INTERCEPT
                )
            };
            ...
            >
              ...
              : proto::transform<
                ...
                >
            {
                typedef proto::expr<Tag, STREAMS_BOOST_PP_CAT(list, N)<STREAMS_BOOST_PP_ENUM_PARAMS(N, A)>, N> type;
                typedef type proto_base_expr;
        ...
        namespace detail
        {
            ...
            >
            struct is_callable_<T<STREAMS_BOOST_PP_ENUM_PARAMS(N, A)> STREAMS_BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(N)>
              : is_same<STREAMS_BOOST_PP_CAT(A, STREAMS_BOOST_PP_DEC(N)), callable>
            {};
        }
        ...
        namespace result_of
        {
            ...
            struct child_c<Expr, N>
            {
                /// The raw type of the Nth child as it is stored within
                /// \c Expr. This may be a value or a reference
                typedef typename Expr::STREAMS_BOOST_PP_CAT(proto_child, N) value_type;
                ...
                /// \li <tt>T &</tt> becomes <tt>T</tt>
                /// \li <tt>T</tt> becomes <tt>T</tt>
                typedef typename detail::expr_traits<typename Expr::STREAMS_BOOST_PP_CAT(proto_child, N)>::value_type type;
            };
            ...
            struct child_c<Expr &, N>
            {
                ...
                /// \li <tt>T &</tt> becomes <tt>T &</tt>
                /// \li <tt>T</tt> becomes <tt>T &</tt>
                typedef typename detail::expr_traits<typename Expr::STREAMS_BOOST_PP_CAT(proto_child, N)>::reference type;

                /// INTERNAL ONLY
                ///
                static type call(Expr &e)
                {
                    return e.proto_base().STREAMS_BOOST_PP_CAT(child, N);
                }
            };
            ...
            struct child_c<Expr const &, N>
            {
                ...
                /// \li <tt>T &</tt> becomes <tt>T &</tt>
                /// \li <tt>T</tt> becomes <tt>T const &</tt>
                typedef typename detail::expr_traits<typename Expr::STREAMS_BOOST_PP_CAT(proto_child, N)>::const_reference type;
