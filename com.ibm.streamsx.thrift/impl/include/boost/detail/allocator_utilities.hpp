 ...
 *
 * See Boost website at http://www.streams_boost.org/
 */

#ifndef STREAMS_BOOST_DETAIL_ALLOCATOR_UTILITIES_HPP
#define STREAMS_BOOST_DETAIL_ALLOCATOR_UTILITIES_HPP
...
#if defined(STREAMS_BOOST_DINKUMWARE_STDLIB)
 ...
 */
  ...
  (defined(STREAMS_BOOST_HAS_PARTIAL_STD_ALLOCATOR)||defined(STREAMS_BOOST_DINKUMWARE_STDLIB))
...
struct is_partial_std_allocator
{
  STREAMS_BOOST_STATIC_CONSTANT(bool,
    value=
      (is_same<
        std::allocator<STREAMS_BOOST_DEDUCED_TYPENAME Allocator::value_type>,
        Allocator
      >::value)||
      (is_same<
        partial_std_allocator_wrapper<
          STREAMS_BOOST_DEDUCED_TYPENAME Allocator::value_type>,
        Allocator
      >::value));
};
...
struct rebinder
{
  ...
  struct result
  {
      typedef typename Allocator::STREAMS_BOOST_NESTED_TEMPLATE 
...
struct compliant_allocator_rebind_to
{
  typedef typename rebinder<Allocator>::
      STREAMS_BOOST_NESTED_TEMPLATE result<Type>::other type;
};
...
} /* namespace streams_boost::detail::allocator */
