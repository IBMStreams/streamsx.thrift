...
#ifndef STREAMS_BOOST_ALGORITHM_HPP
# define STREAMS_BOOST_ALGORITHM_HPP
...
namespace streams_boost {
  ...
  template <typename Iter1, typename Iter2>
  typename streams_boost::detail::iterator_traits<Iter1>::difference_type
...
#endif // STREAMS_BOOST_ALGORITHM_HPP
