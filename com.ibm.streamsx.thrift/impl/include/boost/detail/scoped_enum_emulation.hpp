...
//  scoped enums with C++03 namespaces and enums. The Boost.Config STREAMS_BOOST_NO_SCOPED_ENUMS
...
//  Sample usage:
//
//     STREAMS_BOOST_SCOPED_ENUM_START(algae) { green, red, cyan }; STREAMS_BOOST_SCOPED_ENUM_END
//     ...
//     STREAMS_BOOST_SCOPED_ENUM(algae) sample( algae::red );
//     void foo( STREAMS_BOOST_SCOPED_ENUM(algae) color );
//     ...
//     sample = algae::green;
//     foo( algae::cyan );

#ifndef STREAMS_BOOST_SCOPED_ENUM_EMULATION_HPP
#define STREAMS_BOOST_SCOPED_ENUM_EMULATION_HPP

#include <streams_boost/config.hpp>

#ifdef STREAMS_BOOST_NO_SCOPED_ENUMS

# define STREAMS_BOOST_SCOPED_ENUM_START(name) struct name { enum enum_t
# define STREAMS_BOOST_SCOPED_ENUM_END };
# define STREAMS_BOOST_SCOPED_ENUM(name) name::enum_t

#else

# define STREAMS_BOOST_SCOPED_ENUM_START(name) enum class name
# define STREAMS_BOOST_SCOPED_ENUM_END
# define STREAMS_BOOST_SCOPED_ENUM(name) name

#endif

#endif  // STREAMS_BOOST_SCOPED_ENUM_EMULATION_HPP
