...
//  See documentation at http://www.streams_boost.org/libs/utility

#ifndef STREAMS_BOOST_IDENTIFIER_HPP
#define STREAMS_BOOST_IDENTIFIER_HPP
...
namespace streams_boost
{
  ...
  #if !defined(STREAMS_BOOST_MSVC) || STREAMS_BOOST_MSVC > 1300  // 1300 == VC++ 7.0 bug workaround
    private:
  #endif
      T m_value;
    };
...
#endif // STREAMS_BOOST_IDENTIFIER_HPP
