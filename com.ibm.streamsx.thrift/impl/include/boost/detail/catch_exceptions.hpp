//  streams_boost/catch_exceptions.hpp -----------------------------------------------//

//  Copyright Beman Dawes 1995-2001.  Distributed under the Boost
//  Software License, Version 1.0. (See accompanying file
//  LICENSE_1_0.txt or copy at http://www.streams_boost.org/LICENSE_1_0.txt)

//  See http://www.streams_boost.org/libs/test for documentation.
...
//    5 Nov 00 Initial streams_boost version (Beman Dawes)

#ifndef STREAMS_BOOST_CATCH_EXCEPTIONS_HPP
#define STREAMS_BOOST_CATCH_EXCEPTIONS_HPP

//  header dependencies are deliberately restricted to the standard library
//  to reduce coupling to other streams_boost libraries.
...
#   define STREAMS_BOOST_BUILT_IN_EXCEPTIONS_MISSING_WHAT 
# endif
...
# ifndef STREAMS_BOOST_BUILT_IN_EXCEPTIONS_MISSING_WHAT
...
# endif
    ...
    if ( exception_thrown ) result = streams_boost::exit_exception_failure;
...
#if !defined(STREAMS_BOOST_NO_CPP_MAIN_SUCCESS_MESSAGE)
...
#endif  // STREAMS_BOOST_CATCH_EXCEPTIONS_HPP
