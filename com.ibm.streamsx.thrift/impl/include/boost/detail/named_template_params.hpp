...
#ifndef STREAMS_BOOST_DETAIL_NAMED_TEMPLATE_PARAMS_HPP
#define STREAMS_BOOST_DETAIL_NAMED_TEMPLATE_PARAMS_HPP

#include <streams_boost/type_traits/conversion_traits.hpp>
#include <streams_boost/type_traits/composite_traits.hpp> // for is_reference
...
namespace streams_boost {
  namespace detail {
   ...
   template <class Gen> struct default_generator {
    ...
    // streams_boost/iterator_adaptors.hpp for an example usage.  Also,
    // applications of this macro must be placed in namespace
    // streams_boost::detail.

#define STREAMS_BOOST_NAMED_TEMPLATE_PARAM(TYPE) \
...
#endif // STREAMS_BOOST_DETAIL_NAMED_TEMPLATE_PARAMS_HPP
