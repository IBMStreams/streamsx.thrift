...
#ifndef STREAMS_BOOST_MULTI_INDEX_SAFE_MODE_ERRORS_HPP
#define STREAMS_BOOST_MULTI_INDEX_SAFE_MODE_ERRORS_HPP
 ...
 * STREAMS_BOOST_MULTI_INDEX_SAFE_MODE_ASSERT prior to the inclusion of
