...
#ifndef STREAMS_BOOST_MULTI_INDEX_ORDERED_INDEX_HPP
#define STREAMS_BOOST_MULTI_INDEX_ORDERED_INDEX_HPP
...
#include <streams_boost/multi_index/detail/modify_key_adaptor.hpp>
#include <streams_boost/multi_index/detail/ord_index_node.hpp>
#include <streams_boost/multi_index/detail/ord_index_ops.hpp>
...
#include <streams_boost/multi_index/detail/value_compare.hpp>
...
#include <streams_boost/multi_index/detail/duplicates_iterator.hpp>
#include <streams_boost/throw_exception.hpp> 
#endif

#if defined(STREAMS_BOOST_MULTI_INDEX_ENABLE_INVARIANT_CHECKING)
#define STREAMS_BOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT                          \
...
public:
  ...
  {
    STREAMS_BOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT;
...
STREAMS_BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
   ...
   * in STREAMS_BOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT. Actually,
...
private:
  ...
  {
    lm.load(
      ::streams_boost::bind(&ordered_index::rearranger,this,_1,_2),
      ar,version);
    super::load_(ar,version,lm);
  }
...
#undef STREAMS_BOOST_MULTI_INDEX_ORD_INDEX_CHECK_INVARIANT
