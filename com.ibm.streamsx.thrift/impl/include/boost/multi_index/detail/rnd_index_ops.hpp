...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_RND_INDEX_OPS_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_RND_INDEX_OPS_HPP
...
void random_access_index_inplace_merge(
  ...
  STREAMS_BOOST_DEDUCED_TYPENAME Node::impl_ptr_pointer first1,Compare comp
  STREAMS_BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Node))
{
  typedef typename Node::value_type       value_type;
