...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_ACCESS_SPECIFIER_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_ACCESS_SPECIFIER_HPP
...
#define STREAMS_BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS public
#define STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_MEMBER_TEMPLATE_FRIENDS public
#else
#define STREAMS_BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS protected
#define STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_MEMBER_TEMPLATE_FRIENDS private
#endif
 ...
 */
    ...
    STREAMS_BOOST_WORKAROUND(__GNUC__,==3)&&(__GNUC_MINOR__<4)||\
    STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC,==1310)||\
    STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC,==1400)||\
    STREAMS_BOOST_WORKAROUND(__SUNPRO_CC,STREAMS_BOOST_TESTED_AT(0x590))
#define STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_USING_DECL_FOR_TEMPL_FUNCTIONS public
#else
#define STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_USING_DECL_FOR_TEMPL_FUNCTIONS private
#endif
