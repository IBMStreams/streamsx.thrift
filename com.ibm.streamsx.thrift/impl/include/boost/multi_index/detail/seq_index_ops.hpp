...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_SEQ_INDEX_OPS_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_SEQ_INDEX_OPS_HPP
...
void sequenced_index_collate(
  STREAMS_BOOST_DEDUCED_TYPENAME Node::impl_type* x,
  STREAMS_BOOST_DEDUCED_TYPENAME Node::impl_type* y,
  Compare comp
  STREAMS_BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Node))
{
