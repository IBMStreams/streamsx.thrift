...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_COPY_MAP_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_COPY_MAP_HPP
...
public:
  ...
  ~copy_map()
  {
    if(!released){
      for(std::size_t i=0;i<n;++i){
        streams_boost::detail::allocator::destroy(&(spc.data()+i)->second->value());
  ...
  void clone(Node* node)
  {
    ...
    STREAMS_BOOST_TRY{
      streams_boost::detail::allocator::construct(
