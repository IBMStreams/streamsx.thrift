...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_INDEX_BASE_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_INDEX_BASE_HPP
...
#include <streams_boost/multi_index/detail/copy_map.hpp>
#include <streams_boost/multi_index/detail/node_type.hpp>
...
#include <streams_boost/multi_index/detail/index_loader.hpp>
#include <streams_boost/multi_index/detail/index_saver.hpp>
#endif
...
protected:
  ...
  {
    streams_boost::detail::allocator::construct(&x->value(),v);
    return x;
  }
  ...
  {
    streams_boost::detail::allocator::destroy(&x->value());
  }
