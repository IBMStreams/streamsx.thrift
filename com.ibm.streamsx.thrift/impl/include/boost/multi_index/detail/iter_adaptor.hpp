...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_ITER_ADAPTOR_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_ITER_ADAPTOR_HPP
...
/* Poor man's version of streams_boost::iterator_adaptor. Used instead of the
