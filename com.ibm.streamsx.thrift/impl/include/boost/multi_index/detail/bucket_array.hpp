...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_BUCKET_ARRAY_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_BUCKET_ARRAY_HPP
...
#include <streams_boost/multi_index/detail/hash_index_node.hpp>
...
inline void load_construct_data(
  Archive&,streams_boost::multi_index::detail::bucket_array<Allocator>*,
  const unsigned int)
{
  throw_exception(
