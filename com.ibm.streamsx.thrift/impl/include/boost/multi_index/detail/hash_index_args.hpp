...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_HASH_INDEX_ARGS_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_HASH_INDEX_ARGS_HPP
 ...
 *     KeyFromValue,
 *     Hash=streams_boost::hash<KeyFromValue::result_type>,
...
{
  typedef ::streams_boost::hash<typename KeyFromValue::result_type> type;
};
...
struct hashed_index_args
{
  ...
  STREAMS_BOOST_STATIC_ASSERT(!mpl::is_na<hash_type>::value);
  STREAMS_BOOST_STATIC_ASSERT(!mpl::is_na<pred_type>::value);
};
