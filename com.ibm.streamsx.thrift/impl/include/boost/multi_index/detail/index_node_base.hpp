...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_INDEX_NODE_BASE_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_INDEX_NODE_BASE_HPP
...
inline void load_construct_data(
  Archive&,streams_boost::multi_index::detail::index_node_base<Value,Allocator>*,
  const unsigned int)
{
  throw_exception(
