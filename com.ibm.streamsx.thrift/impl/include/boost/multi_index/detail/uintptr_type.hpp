...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_UINTPTR_TYPE_HPP
...
template<>struct uintptr_candidates<3> {typedef streams_boost::ulong_long_type type;};
#else
...
struct uintptr_aux
{
  STREAMS_BOOST_STATIC_CONSTANT(int,index=
  ...
  STREAMS_BOOST_STATIC_CONSTANT(bool,has_uintptr_type=(index>=0));
