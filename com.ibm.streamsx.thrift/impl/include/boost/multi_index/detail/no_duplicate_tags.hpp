...
#ifndef STREAMS_BOOST_MULTI_INDEX_DETAIL_NO_DUPLICATE_TAGS_HPP
#define STREAMS_BOOST_MULTI_INDEX_DETAIL_NO_DUPLICATE_TAGS_HPP
...
struct duplicate_tag_list_marker
{
  ...
  struct apply:mpl::fold<
    STREAMS_BOOST_DEDUCED_TYPENAME Index::tag_list,
    MplSet,
    duplicate_tag_marker>
  {
  };
