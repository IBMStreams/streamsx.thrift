...
#ifndef STREAMS_BOOST_MULTI_INDEX_SEQUENCED_INDEX_HPP
#define STREAMS_BOOST_MULTI_INDEX_SEQUENCED_INDEX_HPP
...
#include <streams_boost/multi_index/detail/bidir_node_iterator.hpp>
...
#include <streams_boost/multi_index/detail/seq_index_node.hpp>
#include <streams_boost/multi_index/detail/seq_index_ops.hpp>
#include <streams_boost/multi_index/sequenced_index_fwd.hpp>
...
#define STREAMS_BOOST_MULTI_INDEX_SEQ_INDEX_CHECK_INVARIANT                          \
...
public:
  ...
  {
    STREAMS_BOOST_MULTI_INDEX_SEQ_INDEX_CHECK_INVARIANT;
    clear();
...
STREAMS_BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  {
    lm.load(
      ::streams_boost::bind(&sequenced_index::rearranger,this,_1,_2),
      ar,version);
   ...
   * in STREAMS_BOOST_MULTI_INDEX_SEQ_INDEX_CHECK_INVARIANT. Actually,
...
#undef STREAMS_BOOST_MULTI_INDEX_SEQ_INDEX_CHECK_INVARIANT
