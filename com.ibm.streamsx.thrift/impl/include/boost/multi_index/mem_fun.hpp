...
#ifndef STREAMS_BOOST_MULTI_INDEX_MEM_FUN_HPP
#define STREAMS_BOOST_MULTI_INDEX_MEM_FUN_HPP
...
/* STREAMS_BOOST_MULTI_INDEX_CONST_MEM_FUN and STREAMS_BOOST_MULTI_INDEX_MEM_FUN resolve to
...
#define STREAMS_BOOST_MULTI_INDEX_CONST_MEM_FUN(Class,Type,MemberFunName) \
::streams_boost::multi_index::const_mem_fun_explicit<\
  Class,Type,Type (Class::*)()const,&Class::MemberFunName >
#define STREAMS_BOOST_MULTI_INDEX_MEM_FUN(Class,Type,MemberFunName) \
::streams_boost::multi_index::mem_fun_explicit<\
  Class,Type,Type (Class::*)(),&Class::MemberFunName >

#else

#define STREAMS_BOOST_MULTI_INDEX_CONST_MEM_FUN(Class,Type,MemberFunName) \
::streams_boost::multi_index::const_mem_fun< Class,Type,&Class::MemberFunName >
#define STREAMS_BOOST_MULTI_INDEX_MEM_FUN(Class,Type,MemberFunName) \
::streams_boost::multi_index::mem_fun< Class,Type,&Class::MemberFunName >
