...
#ifndef STREAMS_BOOST_MULTI_INDEX_RANDOM_ACCESS_INDEX_HPP
#define STREAMS_BOOST_MULTI_INDEX_RANDOM_ACCESS_INDEX_HPP
...
#include <streams_boost/multi_index/detail/index_node_base.hpp>
#include <streams_boost/multi_index/detail/rnd_node_iterator.hpp>
#include <streams_boost/multi_index/detail/rnd_index_node.hpp>
#include <streams_boost/multi_index/detail/rnd_index_ops.hpp>
#include <streams_boost/multi_index/detail/rnd_index_ptr_array.hpp>
#include <streams_boost/multi_index/detail/safe_ctr_proxy.hpp>
#include <streams_boost/multi_index/detail/safe_mode.hpp>
#include <streams_boost/multi_index/detail/scope_guard.hpp>
#include <streams_boost/multi_index/random_access_index_fwd.hpp>
...
#include <streams_boost/multi_index/detail/rnd_index_loader.hpp>
#endif

#if defined(STREAMS_BOOST_MULTI_INDEX_ENABLE_INVARIANT_CHECKING)
#define STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT                          \
...
class random_access_index:
  STREAMS_BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS SuperMeta::type
...
public:
  ...
  typedef typename
    streams_boost::reverse_iterator<iterator>              reverse_iterator;
  typedef typename
    streams_boost::reverse_iterator<const_iterator>        const_reverse_iterator;
...
public:
  ...
  {
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
    clear();
  ...
  {
    STREAMS_BOOST_MULTI_INDEX_SAFE_MODE_ASSERT(n<size(),safe_mode::out_of_bounds);
  ...
  {
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(position);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(position,*this);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
  ...
  {
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(position);
    STREAMS_BOOST_MULTI_INDEX_CHECK_DEREFERENCEABLE_ITERATOR(position);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(position,*this);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
  ...
  {
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(first);
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(last);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(first,*this);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(last,*this);
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_RANGE(first,last);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
  ...
  void splice(iterator position,random_access_index<SuperMeta,TagList>& x)
  {
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(position);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(position,*this);
    STREAMS_BOOST_MULTI_INDEX_CHECK_DIFFERENT_CONTAINER(*this,x);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
    ...
    iterator position,random_access_index<SuperMeta,TagList>& x,iterator i)
  {
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(position);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(position,*this);
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(i);
    STREAMS_BOOST_MULTI_INDEX_CHECK_DEREFERENCEABLE_ITERATOR(i);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(i,x);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
    ...
    iterator first,iterator last)
  {
    ...
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(first);
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(last);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(first,x);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(last,x);
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_RANGE(first,last);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
  ...
  void relocate(iterator position,iterator i)
  {
    ...
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_ITERATOR(i);
    STREAMS_BOOST_MULTI_INDEX_CHECK_DEREFERENCEABLE_ITERATOR(i);
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(i,*this);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
  ...
  void relocate(iterator position,iterator first,iterator last)
  {
    ...
    STREAMS_BOOST_MULTI_INDEX_CHECK_IS_OWNER(last,*this);
    STREAMS_BOOST_MULTI_INDEX_CHECK_VALID_RANGE(first,last);
    STREAMS_BOOST_MULTI_INDEX_CHECK_OUTSIDE_RANGE(position,first,last);
    STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT;
...
STREAMS_BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  {
    {
      ...
      lm.load(::streams_boost::bind(&loader::rearrange,&ld,_1,_2),ar,version);
  ...
  /* This forwarding function eases things for the streams_boost::mem_fn construct
   * in STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT. Actually,
...
{
  STREAMS_BOOST_STATIC_ASSERT(detail::is_tag<TagList>::value);
...
#undef STREAMS_BOOST_MULTI_INDEX_RND_INDEX_CHECK_INVARIANT
