...
#ifndef STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_HPP
#define STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_HPP
...
#include <streams_boost/preprocessor/list/at.hpp>
 ...
 * streams_boost::tuple. In Boost 1.32, the limit is 10.
 */

#if !defined(STREAMS_BOOST_MULTI_INDEX_LIMIT_COMPOSITE_KEY_SIZE)
#if defined(STREAMS_BOOST_MSVC)&&(STREAMS_BOOST_MSVC<1300)
#define STREAMS_BOOST_MULTI_INDEX_LIMIT_COMPOSITE_KEY_SIZE 5
#else
#define STREAMS_BOOST_MULTI_INDEX_LIMIT_COMPOSITE_KEY_SIZE 10
#endif
#endif

/* maximum number of key extractors in a composite key */

#if STREAMS_BOOST_MULTI_INDEX_LIMIT_COMPOSITE_KEY_SIZE<10 /* max length of a tuple */
#define STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_SIZE \
  STREAMS_BOOST_MULTI_INDEX_LIMIT_COMPOSITE_KEY_SIZE
#else
#define STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_SIZE 10
#endif

/* STREAMS_BOOST_PP_ENUM of STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_SIZE elements */

#define STREAMS_BOOST_MULTI_INDEX_CK_ENUM(macro,data)                                \
  STREAMS_BOOST_PP_ENUM(STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_SIZE,macro,data)

/* STREAMS_BOOST_PP_ENUM_PARAMS of STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_SIZE elements */

#define STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(param)                              \
  STREAMS_BOOST_PP_ENUM_PARAMS(STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_SIZE,param)

/* if n==0 ->   text0
 * otherwise -> textn=tuples::null_type
 */

#define STREAMS_BOOST_MULTI_INDEX_CK_TEMPLATE_PARM(z,n,text)                         \
  typename STREAMS_BOOST_PP_CAT(text,n) STREAMS_BOOST_PP_EXPR_IF(n,=tuples::null_type)

/* const textn& kn=textn() */

#define STREAMS_BOOST_MULTI_INDEX_CK_CTOR_ARG(z,n,text)                              \
  const STREAMS_BOOST_PP_CAT(text,n)& STREAMS_BOOST_PP_CAT(k,n) = STREAMS_BOOST_PP_CAT(text,n)()

/* typename list(0)<list(1),n>::type */

#define STREAMS_BOOST_MULTI_INDEX_CK_APPLY_METAFUNCTION_N(z,n,list)                  \
  STREAMS_BOOST_DEDUCED_TYPENAME STREAMS_BOOST_PP_LIST_AT(list,0)<                           \
    STREAMS_BOOST_PP_LIST_AT(list,1),n                                               \
  >::type
...
template<typename CompositeKey,STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, N)>
...
#define STREAMS_BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(name,functor)         \
template<typename KeyFromValue>                                              \
struct STREAMS_BOOST_PP_CAT(key_,name)                                               \
{                                                                            \
  typedef functor<typename KeyFromValue::result_type> type;                  \
};                                                                           \
                                                                             \
template<>                                                                   \
struct STREAMS_BOOST_PP_CAT(key_,name)<tuples::null_type>                            \
{                                                                            \
  typedef tuples::null_type type;                                            \
};                                                                           \
                                                                             \
template<typename CompositeKey,STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, N)>              \
struct STREAMS_BOOST_PP_CAT(nth_composite_key_,name)                                 \
{                                                                            \
  typedef typename nth_key_from_value<CompositeKey,N>::type key_from_value;  \
  typedef typename STREAMS_BOOST_PP_CAT(key_,name)<key_from_value>::type type;       \
};
...
STREAMS_BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(equal_to,std::equal_to)
STREAMS_BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(less,std::less)
STREAMS_BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(greater,std::greater)
STREAMS_BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(hash,streams_boost::hash)

/* used for defining equality and comparison ops of composite_key_result */

#define STREAMS_BOOST_MULTI_INDEX_CK_IDENTITY_ENUM_MACRO(z,n,text) text
...
typedef tuple<
  STREAMS_BOOST_MULTI_INDEX_CK_ENUM(
    STREAMS_BOOST_MULTI_INDEX_CK_IDENTITY_ENUM_MACRO,
...
struct equal_ckey_ckey_normal
{
    ...
    const EqualCons& eq)
  {
    ...
    return equal_ckey_ckey<
      STREAMS_BOOST_DEDUCED_TYPENAME KeyCons1::tail_type,Value1,
      STREAMS_BOOST_DEDUCED_TYPENAME KeyCons2::tail_type,Value2,
      STREAMS_BOOST_DEDUCED_TYPENAME EqualCons::tail_type
...
struct equal_ckey_cval_normal
{
    ...
    const EqualCons& eq)
  {
    ...
    return equal_ckey_cval<
      STREAMS_BOOST_DEDUCED_TYPENAME KeyCons::tail_type,Value,
      STREAMS_BOOST_DEDUCED_TYPENAME ValCons::tail_type,
      STREAMS_BOOST_DEDUCED_TYPENAME EqualCons::tail_type
...
struct compare_ckey_ckey_normal
{
    ...
    const CompareCons& comp)
  {
    ...
    return compare_ckey_ckey<
      STREAMS_BOOST_DEDUCED_TYPENAME KeyCons1::tail_type,Value1,
      STREAMS_BOOST_DEDUCED_TYPENAME KeyCons2::tail_type,Value2,
      STREAMS_BOOST_DEDUCED_TYPENAME CompareCons::tail_type
...
struct hash_ckey_normal
{
  ...
  {
    /* same hashing formula as streams_boost::hash_combine */

    carry^=h.get_head()(c.get_head()(v))+0x9e3779b9+(carry<<6)+(carry>>2);
    return hash_ckey<
      STREAMS_BOOST_DEDUCED_TYPENAME KeyCons::tail_type,Value,
      STREAMS_BOOST_DEDUCED_TYPENAME HashCons::tail_type
...
template<
  typename Value,
  STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_TEMPLATE_PARM,KeyFromValue)
>
struct composite_key:
  private tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(KeyFromValue)>
{
private:
  typedef tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(KeyFromValue)> super;
...
public:
  ...
  composite_key(
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_CTOR_ARG,KeyFromValue)):
    super(STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(k))
  {}
...
template<
  ...
  STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(typename Value)
>
inline bool operator==(
  const composite_key_result<CompositeKey>& x,
  const tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)>& y)
{
  typedef typename CompositeKey::key_extractor_tuple     key_extractor_tuple;
  typedef typename CompositeKey::value_type              value_type;
  typedef tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)> key_tuple;
...
>
inline bool operator==(
  const tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)>& x,
...
#define STREAMS_BOOST_MULTI_INDEX_CK_COMPLETE_COMP_OPS(t1,t2,a1,a2)                  \
...
STREAMS_BOOST_MULTI_INDEX_CK_COMPLETE_COMP_OPS(
...
STREAMS_BOOST_MULTI_INDEX_CK_COMPLETE_COMP_OPS(
  ...
  tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)>
)
...
template
<
  STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_TEMPLATE_PARM,Pred)
>
struct composite_key_equal_to:
  private tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Pred)>
{
private:
  typedef tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Pred)> super;

public:
  typedef super key_eq_tuple;

  composite_key_equal_to(
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_CTOR_ARG,Pred)):
    super(STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(k))
  {}
  ...
  bool operator()(
    const composite_key_result<CompositeKey>& x,
    const tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)>& y)const
  {
    typedef typename CompositeKey::key_extractor_tuple     key_extractor_tuple;
    typedef typename CompositeKey::value_type              value_type;
    typedef tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)> key_tuple;
...
template
<
  STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_TEMPLATE_PARM,Compare)
>
struct composite_key_compare:
  private tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Compare)>
{
private:
  typedef tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Compare)> super;

public:
  typedef super key_comp_tuple;

  composite_key_compare(
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_CTOR_ARG,Compare)):
    super(STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(k))
  {}
...
template
<
  STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_TEMPLATE_PARM,Hash)
>
struct composite_key_hash:
  private tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Hash)>
{
private:
  typedef tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Hash)> super;

public:
  typedef super key_hasher_tuple;

  composite_key_hash(
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(STREAMS_BOOST_MULTI_INDEX_CK_CTOR_ARG,Hash)):
    super(STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(k))
  {}
  ...
  template<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(typename Value)>
  std::size_t operator()(
    const tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)>& x)const
  {
    typedef tuple<STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS(Value)> key_tuple;
 ...
 * composite_key_result_hash     uses streams_boost::hash.
 */

#define STREAMS_BOOST_MULTI_INDEX_CK_RESULT_EQUAL_TO_SUPER                           \
composite_key_equal_to<                                                      \
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(                                               \
      STREAMS_BOOST_MULTI_INDEX_CK_APPLY_METAFUNCTION_N,                             \
      /* the argument is a PP list */                                        \
      (detail::nth_composite_key_equal_to,                                   \
        (STREAMS_BOOST_DEDUCED_TYPENAME CompositeKeyResult::composite_key_type,      \
          STREAMS_BOOST_PP_NIL)))                                                    \
  >

template<typename CompositeKeyResult>
struct composite_key_result_equal_to:
STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_USING_DECL_FOR_TEMPL_FUNCTIONS
STREAMS_BOOST_MULTI_INDEX_CK_RESULT_EQUAL_TO_SUPER
{
private:
  typedef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_EQUAL_TO_SUPER super;
...
#define STREAMS_BOOST_MULTI_INDEX_CK_RESULT_LESS_SUPER                               \
composite_key_compare<                                                       \
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(                                               \
      STREAMS_BOOST_MULTI_INDEX_CK_APPLY_METAFUNCTION_N,                             \
      /* the argument is a PP list */                                        \
...
STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_USING_DECL_FOR_TEMPL_FUNCTIONS
STREAMS_BOOST_MULTI_INDEX_CK_RESULT_LESS_SUPER
{
private:
  typedef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_LESS_SUPER super;
...
#define STREAMS_BOOST_MULTI_INDEX_CK_RESULT_GREATER_SUPER                            \
composite_key_compare<                                                       \
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(                                               \
      STREAMS_BOOST_MULTI_INDEX_CK_APPLY_METAFUNCTION_N,                             \
      /* the argument is a PP list */                                        \
...
STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_USING_DECL_FOR_TEMPL_FUNCTIONS
STREAMS_BOOST_MULTI_INDEX_CK_RESULT_GREATER_SUPER
{
private:
  typedef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_GREATER_SUPER super;
...
#define STREAMS_BOOST_MULTI_INDEX_CK_RESULT_HASH_SUPER                               \
composite_key_hash<                                                          \
    STREAMS_BOOST_MULTI_INDEX_CK_ENUM(                                               \
      STREAMS_BOOST_MULTI_INDEX_CK_APPLY_METAFUNCTION_N,                             \
      /* the argument is a PP list */                                        \
...
STREAMS_BOOST_MULTI_INDEX_PRIVATE_IF_USING_DECL_FOR_TEMPL_FUNCTIONS
STREAMS_BOOST_MULTI_INDEX_CK_RESULT_HASH_SUPER
{
private:
  typedef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_HASH_SUPER super;
...
/* Specializations of std::equal_to, std::less, std::greater and streams_boost::hash
...
template<typename CompositeKey>
struct equal_to<streams_boost::multi_index::composite_key_result<CompositeKey> >:
  streams_boost::multi_index::composite_key_result_equal_to<
    streams_boost::multi_index::composite_key_result<CompositeKey>
  >
{
};

template<typename CompositeKey>
struct less<streams_boost::multi_index::composite_key_result<CompositeKey> >:
  streams_boost::multi_index::composite_key_result_less<
    streams_boost::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct greater<streams_boost::multi_index::composite_key_result<CompositeKey> >:
  streams_boost::multi_index::composite_key_result_greater<
    streams_boost::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct hash<streams_boost::multi_index::composite_key_result<CompositeKey> >:
  streams_boost::multi_index::composite_key_result_hash<
    streams_boost::multi_index::composite_key_result<CompositeKey>
  >
{
};
 ...
 * streams_boost::hash, we define the appropriate hash_value overload.
 */

namespace streams_boost{

#if !defined(STREAMS_BOOST_NO_ARGUMENT_DEPENDENT_LOOKUP)
namespace multi_index{
#endif

template<typename CompositeKey>
inline std::size_t hash_value(
  const streams_boost::multi_index::composite_key_result<CompositeKey>& x)
{
  streams_boost::multi_index::composite_key_result_hash<
    streams_boost::multi_index::composite_key_result<CompositeKey> > h;
  return h(x);
}
...
#undef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_HASH_SUPER
#undef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_GREATER_SUPER
#undef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_LESS_SUPER
#undef STREAMS_BOOST_MULTI_INDEX_CK_RESULT_EQUAL_TO_SUPER
#undef STREAMS_BOOST_MULTI_INDEX_CK_COMPLETE_COMP_OPS
#undef STREAMS_BOOST_MULTI_INDEX_CK_IDENTITY_ENUM_MACRO
#undef STREAMS_BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR
#undef STREAMS_BOOST_MULTI_INDEX_CK_APPLY_METAFUNCTION_N
#undef STREAMS_BOOST_MULTI_INDEX_CK_CTOR_ARG
#undef STREAMS_BOOST_MULTI_INDEX_CK_TEMPLATE_PARM
#undef STREAMS_BOOST_MULTI_INDEX_CK_ENUM_PARAMS
#undef STREAMS_BOOST_MULTI_INDEX_CK_ENUM
#undef STREAMS_BOOST_MULTI_INDEX_COMPOSITE_KEY_SIZE
