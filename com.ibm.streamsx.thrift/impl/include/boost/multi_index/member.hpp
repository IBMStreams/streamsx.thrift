...
#ifndef STREAMS_BOOST_MULTI_INDEX_MEMBER_HPP
#define STREAMS_BOOST_MULTI_INDEX_MEMBER_HPP
...
/* STREAMS_BOOST_MULTI_INDEX_MEMBER resolves to member in the normal cases,
 * and to member_offset as a workaround in those defective compilers for
 * which STREAMS_BOOST_NO_POINTER_TO_MEMBER_TEMPLATE_PARAMETERS is defined.
 */

#if defined(STREAMS_BOOST_NO_POINTER_TO_MEMBER_TEMPLATE_PARAMETERS)
#define STREAMS_BOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::streams_boost::multi_index::member_offset< Class,Type,offsetof(Class,MemberName) >
#else
#define STREAMS_BOOST_MULTI_INDEX_MEMBER(Class,Type,MemberName) \
::streams_boost::multi_index::member< Class,Type,&Class::MemberName >
#endif
