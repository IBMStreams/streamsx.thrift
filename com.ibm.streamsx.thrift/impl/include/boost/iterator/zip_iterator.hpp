...
#ifndef STREAMS_BOOST_ZIP_ITERATOR_TMB_07_13_2003_HPP_
# define STREAMS_BOOST_ZIP_ITERATOR_TMB_07_13_2003_HPP_
...
#include <streams_boost/iterator/iterator_adaptor.hpp> // for enable_if_convertible
#include <streams_boost/iterator/iterator_categories.hpp>
#include <streams_boost/detail/iterator.hpp>

#include <streams_boost/iterator/detail/minimum_category.hpp>
...
namespace streams_boost {
  ...
  namespace detail
  {
    ...
    namespace tuple_impl_specific
    {
      ...
      struct tuple_meta_transform
        : mpl::eval_if<
              streams_boost::is_same<Tuple, tuples::null_type>
      ...
      struct tuple_meta_accumulate
        : mpl::eval_if<
              ...
              mpl::or_<
                  ...
                  streams_boost::is_same<Tuple, tuples::null_type>
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, < 1300)
                , streams_boost::is_same<Tuple,int>
              >
#endif 
    ...
    || (                                                                    \
      STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_INTEL_CXX_VERSION, != 0) && defined(_MSC_VER)  \
    )
// Not sure why intel's partial ordering fails in this case, but I'm
// assuming int's an MSVC bug-compatibility feature.
      
# define STREAMS_BOOST_TUPLE_ALGO_DISPATCH
# define STREAMS_BOOST_TUPLE_ALGO(algo) algo##_impl
# define STREAMS_BOOST_TUPLE_ALGO_TERMINATOR , int
# define STREAMS_BOOST_TUPLE_ALGO_RECURSE , ...
#else 
# define STREAMS_BOOST_TUPLE_ALGO(algo) algo
# define STREAMS_BOOST_TUPLE_ALGO_TERMINATOR
# define STREAMS_BOOST_TUPLE_ALGO_RECURSE
#endif
      ...
      tuples::null_type STREAMS_BOOST_TUPLE_ALGO(tuple_transform)
          (tuples::null_type const&, Fun STREAMS_BOOST_TUPLE_ALGO_TERMINATOR)
      ...
      STREAMS_BOOST_TUPLE_ALGO(tuple_transform)(
        const Tuple& t, 
        Fun f
        STREAMS_BOOST_TUPLE_ALGO_RECURSE
      )
      { 
          typedef typename tuple_meta_transform<
              STREAMS_BOOST_DEDUCED_TYPENAME Tuple::tail_type
            , Fun
          >::type transformed_tail_type;

        return tuples::cons<
            STREAMS_BOOST_DEDUCED_TYPENAME mpl::apply1<
                Fun, STREAMS_BOOST_DEDUCED_TYPENAME Tuple::head_type
             >::type
           , transformed_tail_type
        >( 
            f(streams_boost::tuples::get<0>(t)), tuple_transform(t.get_tail(), f)
        );
      }

#ifdef STREAMS_BOOST_TUPLE_ALGO_DISPATCH
      template<typename Tuple, typename Fun>
      typename tuple_meta_transform<
          Tuple
        , Fun
      ...
      //
      template<typename Fun>
      Fun STREAMS_BOOST_TUPLE_ALGO(tuple_for_each)(
          tuples::null_type
        , Fun f STREAMS_BOOST_TUPLE_ALGO_TERMINATOR
      )
      { return f; }
      ...
      Fun STREAMS_BOOST_TUPLE_ALGO(tuple_for_each)(
          Tuple& t
        , Fun f STREAMS_BOOST_TUPLE_ALGO_RECURSE)
      { 
          f( t.get_head() );
  ...
  private:
    ...
    { 
      detail::tuple_impl_specific::tuple_for_each(
          m_iterator_tuple,
          detail::advance_iterator<STREAMS_BOOST_DEDUCED_TYPENAME super_t::difference_type>(n)
          );
    }
    ...
    { 
        return streams_boost::tuples::get<0>(other.get_iterator_tuple()) - 
            streams_boost::tuples::get<0>(this->get_iterator_tuple());
    }
