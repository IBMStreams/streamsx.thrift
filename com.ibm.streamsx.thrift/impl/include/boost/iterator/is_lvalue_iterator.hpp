...
#ifndef IS_LVALUE_ITERATOR_DWA2003112_STREAMS_HPP
# define IS_LVALUE_ITERATOR_DWA2003112_STREAMS_HPP
...
# define STREAMS_BOOST_LVALUE_PRESERVER(expr) detail::lvalue_preserver(expr,0)
  
#else
  
# define STREAMS_BOOST_LVALUE_PRESERVER(expr) expr
            ...
            , value = (
                sizeof(
                    is_lvalue_iterator_impl<Value>::tester(
                        STREAMS_BOOST_LVALUE_PRESERVER(*x), 0
                    )
                ) == 1
            )
          );
...
#undef STREAMS_BOOST_LVALUE_PRESERVER
  ...
  struct is_non_const_lvalue_iterator_impl
    : is_lvalue_iterator_impl<
          STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::detail::iterator_traits<It>::value_type
      >::template rebind<It>
  {};
} // namespace detail
...
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_lvalue_iterator,T,::streams_boost::detail::is_readable_lvalue_iterator_impl<T>::value)
    
STREAMS_BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_non_const_lvalue_iterator,T,::streams_boost::detail::is_non_const_lvalue_iterator_impl<T>::value)
...
#endif // IS_LVALUE_ITERATOR_DWA2003112_STREAMS_HPP
