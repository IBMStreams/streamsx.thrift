...
#ifndef STREAMS_BOOST_ITERATOR_ARCHETYPES_HPP
#define STREAMS_BOOST_ITERATOR_ARCHETYPES_HPP
...
>
{
    ...
    {
# if !STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1300)
        STREAMS_BOOST_STATIC_ASSERT(!is_const<Value>::value);
# endif 
...
# if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_DINKUMWARE_STDLIB, < 310)           \
    || STREAMS_BOOST_WORKAROUND(_RWSTD_VER, STREAMS_BOOST_TESTED_AT(0x20101))
...
#endif // STREAMS_BOOST_ITERATOR_ARCHETYPES_HPP
