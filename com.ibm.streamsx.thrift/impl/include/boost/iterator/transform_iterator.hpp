...
#ifndef STREAMS_BOOST_TRANSFORM_ITERATOR_23022003THW_HPP
#define STREAMS_BOOST_TRANSFORM_ITERATOR_23022003THW_HPP
...
namespace streams_boost
{
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public streams_boost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    streams_boost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
  ...
  public:
      ...
      : super_t(x)
    {
        ...
        STREAMS_BOOST_STATIC_ASSERT(is_class<UnaryFunc>::value);
#endif 
    }
...
#endif // STREAMS_BOOST_TRANSFORM_ITERATOR_23022003THW_HPP
