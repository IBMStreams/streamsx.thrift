...
// See http://www.streams_boost.org/libs/tokenizer/ for documentation.
...
//      the streams_boost CVS for a short period of time.
// 20 Feb 2002   John Maddock
//      Removed using namespace std declarations and added
//      workaround for STREAMS_BOOST_NO_STDC_NAMESPACE (the library
...
#ifndef STREAMS_BOOST_TOKEN_FUNCTIONS_JRB120303_HPP_
#define STREAMS_BOOST_TOKEN_FUNCTIONS_JRB120303_HPP_
...
// MSVC does not like the following typename
  ...
  struct assign_or_plus_equal {
    ...
    STREAMS_BOOST_WORKAROUND(__SGI_STL_PORT, < 0x500) &&\
    defined(_STLP_DEBUG) &&\
  ...
  public:
    ...
    bool operator()(InputIterator& next, InputIterator end, Token& tok)
    {
      ...
      STREAMS_BOOST_ASSERT(!offsets_.empty());
