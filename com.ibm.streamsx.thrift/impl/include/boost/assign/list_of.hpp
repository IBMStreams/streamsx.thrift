...
#ifndef STREAMS_BOOST_ASSIGN_LIST_OF_HPP
#define STREAMS_BOOST_ASSIGN_LIST_OF_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1020)
# pragma once
#endif

#include <streams_boost/assign/assignment_exception.hpp>
...
// this here is necessary to avoid compiler error in <streams_boost/array.hpp>
#if !STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x564))
...
namespace assign_detail
{
    ...
    struct assign_decay
    {
        ...
        typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::eval_if<
            ::streams_boost::is_array<T>,
            ::streams_boost::decay<const T>,
            ::streams_boost::decay<T> >::type type;
    };
    ...
    public:
        ...
        Container convert_to_container() const
        {
            ...
            STREAMS_BOOST_STATIC_CONSTANT( bool, is_array_flag = sizeof( assign_detail::assign_is_array( c ) ) 
                                   == sizeof( type_traits::yes_type ) );

            typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::if_c< is_array_flag,
                                                      array_type_tag,
...
// old Dinkumware doesn't support iterator type as template
        ...
        {
            typedef STREAMS_BOOST_DEDUCED_TYPENAME Array::value_type value_type;

#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_INTEL, <= 910 ) || STREAMS_BOOST_WORKAROUND(__SUNPRO_CC, <= 0x580 )
            STREAMS_BOOST_DEDUCED_TYPENAME remove_const<Array>::type ar;
#else
            Array ar;
#endif            
    ...
    {
        return ::streams_boost::iterator_range_detail::equal( l, r );
    }
    ...
    inline bool operator<( const converter<T,I>& l, const Range& r )
    {
        return ::streams_boost::iterator_range_detail::less_than( l, r );
    }
    ...
    {
        return Os << ::streams_boost::make_iterator_range( r.begin(), r.end() );
    }
    ...
    template< class T > 
    class generic_list : 
        public converter< generic_list< STREAMS_BOOST_DEDUCED_TYPENAME assign_decay<T>::type >,
                          STREAMS_BOOST_DEDUCED_TYPENAME std::deque<STREAMS_BOOST_DEDUCED_TYPENAME 
                                                            assign_decay<T>::type>::iterator >
    {
        typedef STREAMS_BOOST_DEDUCED_TYPENAME assign_decay<T>::type Ty;
...
#define STREAMS_BOOST_ASSIGN_PARAMS4(n) STREAMS_BOOST_PP_ENUM_PARAMS(n, U)
#define STREAMS_BOOST_ASSIGN_PARAMS2_NO_REF(n) STREAMS_BOOST_PP_ENUM_BINARY_PARAMS(n, U, u)
...
#define STREAMS_BOOST_PP_LOCAL_MACRO(n) \
    ...
    generic_list& operator()(U const& u, STREAMS_BOOST_ASSIGN_PARAMS2(n) ) \
    { \
        this->push_back( Ty(u, STREAMS_BOOST_ASSIGN_PARAMS3(n))); \
        return *this; \
    } \
    /**/
...
#include STREAMS_BOOST_PP_LOCAL_ITERATE()
        ...
        {
            return this-> STREAMS_BOOST_NESTED_TEMPLATE convert_to_container<Container>();
        }
    };
...
namespace assign
{
    ...
    inline assign_detail::static_generic_list< STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<T>::type,N>
    ref_list_of( T& t )
    {
        return assign_detail::static_generic_list<STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<T>::type,N>( t );
    }
    
    template< int N, class T >
    inline assign_detail::static_generic_list<const STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<T>::type,N>
    cref_list_of( const T& t )
    {
        return assign_detail::static_generic_list<const STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<T>::type,N>( t );
    }
...
#define STREAMS_BOOST_PP_LOCAL_MACRO(n) \
    ...
    inline assign_detail::generic_list<T> \
    list_of(U const& u, STREAMS_BOOST_ASSIGN_PARAMS2(n) ) \
    { \
        return assign_detail::generic_list<T>()(u, STREAMS_BOOST_ASSIGN_PARAMS3(n)); \
    } \
    /**/
...
#define STREAMS_BOOST_PP_LOCAL_MACRO(n) \
    template< class U, STREAMS_BOOST_ASSIGN_PARAMS1(n) > \
    inline assign_detail::generic_list< tuple<U, STREAMS_BOOST_ASSIGN_PARAMS4(n)> > \
    tuple_list_of(U u, STREAMS_BOOST_ASSIGN_PARAMS2_NO_REF(n) ) \
    { \
        return assign_detail::generic_list< tuple<U, STREAMS_BOOST_ASSIGN_PARAMS4(n)> >()( tuple<U,STREAMS_BOOST_ASSIGN_PARAMS4(n)>( u, STREAMS_BOOST_ASSIGN_PARAMS3(n) )); \
    } \
    /**/
...
#include STREAMS_BOOST_PP_LOCAL_ITERATE()
    ...
    inline assign_detail::generic_list< std::pair
        < 
            STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<Key>::type, 
            STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<T>::type
        > >
    map_list_of( const Key& k, const T& t )
    {
        typedef STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<Key>::type k_type;
        typedef STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<T>::type   t_type;
    ...
    inline assign_detail::generic_list< std::pair
        < 
            STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<F>::type, 
            STREAMS_BOOST_DEDUCED_TYPENAME assign_detail::assign_decay<S>::type
        > >
...
#undef STREAMS_BOOST_ASSIGN_PARAMS4
#undef STREAMS_BOOST_ASSIGN_PARAMS2_NO_REF
