...
#ifndef STREAMS_BOOST_FLYWEIGHT_LOCKING_TAG_HPP
#define STREAMS_BOOST_FLYWEIGHT_LOCKING_TAG_HPP
 ...
 *   2. Specialize is_locking to evaluate to streams_boost::mpl::true_.
