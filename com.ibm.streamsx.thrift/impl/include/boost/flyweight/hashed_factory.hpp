...
#ifndef STREAMS_BOOST_FLYWEIGHT_HASHED_FACTORY_HPP
#define STREAMS_BOOST_FLYWEIGHT_HASHED_FACTORY_HPP
  ...
  struct apply:
    mpl::apply2<
      hashed_factory_class<
        streams_boost::mpl::_1,streams_boost::mpl::_2,Hash,Pred,Allocator
      >,
      Entry,Key
    >
  {};
