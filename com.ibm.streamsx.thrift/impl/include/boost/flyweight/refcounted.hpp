...
#ifndef STREAMS_BOOST_FLYWEIGHT_REFCOUNTED_HPP
#define STREAMS_BOOST_FLYWEIGHT_REFCOUNTED_HPP
...
private:
  Value                               x;
  mutable streams_boost::detail::atomic_count ref;
