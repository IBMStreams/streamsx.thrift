...
#ifndef STREAMS_BOOST_FLYWEIGHT_ASSOC_CONTAINER_FACTORY_HPP
#define STREAMS_BOOST_FLYWEIGHT_ASSOC_CONTAINER_FACTORY_HPP
...
#include <streams_boost/flyweight/assoc_container_factory_fwd.hpp>
#include <streams_boost/flyweight/detail/is_placeholder_expr.hpp>
#include <streams_boost/flyweight/detail/nested_xxx_if_not_ph.hpp>
...
namespace streams_boost{namespace flyweights{namespace detail{
STREAMS_BOOST_FLYWEIGHT_NESTED_XXX_IF_NOT_PLACEHOLDER_EXPRESSION_DEF(iterator);
STREAMS_BOOST_FLYWEIGHT_NESTED_XXX_IF_NOT_PLACEHOLDER_EXPRESSION_DEF(value_type);
}}} /* namespace streams_boost::flyweights::detail */
...
public:
  ...
  STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,assoc_container_factory_class,(Container))
};
