...
#ifndef STREAMS_BOOST_FLYWEIGHT_DETAIL_VALUE_TAG_HPP
#define STREAMS_BOOST_FLYWEIGHT_DETAIL_VALUE_TAG_HPP
 ...
 *   2. Specialize is_value to evaluate to streams_boost::mpl::true_.
