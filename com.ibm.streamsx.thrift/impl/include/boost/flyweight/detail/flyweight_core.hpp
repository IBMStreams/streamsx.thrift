...
#ifndef STREAMS_BOOST_FLYWEIGHT_DETAIL_FLYWEIGHT_CORE_HPP
#define STREAMS_BOOST_FLYWEIGHT_DETAIL_FLYWEIGHT_CORE_HPP
...
#define STREAMS_BOOST_FLYWEIGHT_PERFECT_FWD_NAME static handle_type insert
#define STREAMS_BOOST_FLYWEIGHT_PERFECT_FWD_BODY(n)                \
{                                                          \
  return insert_rep(rep_type(STREAMS_BOOST_PP_ENUM_PARAMS(n,t))); \
}
