...
#ifndef STREAMS_BOOST_FLYWEIGHT_DETAIL_DEFAULT_VALUE_POLICY_HPP
#define STREAMS_BOOST_FLYWEIGHT_DETAIL_DEFAULT_VALUE_POLICY_HPP
...
#define STREAMS_BOOST_FLYWEIGHT_PERFECT_FWD_BODY(n) \
  :x(STREAMS_BOOST_PP_ENUM_PARAMS(n,t)){}
