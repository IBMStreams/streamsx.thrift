#ifndef STREAMS_BOOST_SERIALIZATION_SMART_CAST_HPP
#define STREAMS_BOOST_SERIALIZATION_SMART_CAST_HPP
...
namespace smart_cast_impl {
    ...
    struct reference {
            ...
            static T cast(U & u){
                ...
                || defined(__MWERKS__)
                    ...
                    typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::eval_if<
                            STREAMS_BOOST_DEDUCED_TYPENAME mpl::and_<
                                mpl::not_<is_base_and_derived<
                                    STREAMS_BOOST_DEDUCED_TYPENAME remove_reference<T>::type,
                                    U
                                > >,
                                mpl::not_<is_base_and_derived<
                                    U,
        ...
        static T cast(U & u){
                ...
                return mpl::eval_if<
                    streams_boost::is_polymorphic<U>,
                ...
                // if we're in debug mode
                    ...
                    typedef
                        STREAMS_BOOST_DEDUCED_TYPENAME mpl::eval_if<
                            STREAMS_BOOST_DEDUCED_TYPENAME mpl::and_<
                                mpl::not_<is_base_and_derived<
                                    STREAMS_BOOST_DEDUCED_TYPENAME remove_pointer<T>::type,
                                    U
                                > >,
                                mpl::not_<is_base_and_derived<
                                    U,
    ...
    typedef
        STREAMS_BOOST_DEDUCED_TYPENAME mpl::eval_if<
            STREAMS_BOOST_DEDUCED_TYPENAME mpl::or_<
                streams_boost::is_same<void *, U>,
                streams_boost::is_same<void *, T>,
                streams_boost::is_same<const void *, U>,
                streams_boost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer<T> >,
        // else
        STREAMS_BOOST_DEDUCED_TYPENAME mpl::eval_if<streams_boost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer<T> >,
        // else
        STREAMS_BOOST_DEDUCED_TYPENAME mpl::eval_if<streams_boost::is_reference<U>,
...
#endif // STREAMS_BOOST_SERIALIZATION_SMART_CAST_HPP
