#ifndef STREAMS_BOOST_SERIALIZATION_TRACKING_HPP
#define STREAMS_BOOST_SERIALIZATION_TRACKING_HPP
...
struct tracking_level_impl {
    ...
    struct traits_class_tracking {
        typedef STREAMS_BOOST_DEDUCED_TYPENAME U::tracking type;
    };
...
// without problem.
#define STREAMS_BOOST_CLASS_TRACKING(T, E)           \
namespace streams_boost {                            \
namespace serialization {                    \
template<>                                   \
...
#endif // STREAMS_BOOST_SERIALIZATION_TRACKING_HPP
