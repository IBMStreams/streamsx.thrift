#ifndef  STREAMS_BOOST_SERIALIZATION_COMPLEX_HPP
#define STREAMS_BOOST_SERIALIZATION_COMPLEX_HPP
...
inline void save(
    ...
    const T re = t.real();
    const T im = t.imag();
    ar << streams_boost::serialization::make_nvp("real", re);
    ar << streams_boost::serialization::make_nvp("imag", im);
}
...
#endif // STREAMS_BOOST_SERIALIZATION_COMPLEX_HPP
