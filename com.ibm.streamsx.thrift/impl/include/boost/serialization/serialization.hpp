#ifndef STREAMS_BOOST_SERIALIZATION_SERIALIZATION_HPP
#define STREAMS_BOOST_SERIALIZATION_SERIALIZATION_HPP
...
#define STREAMS_BOOST_SERIALIZATION_LIBRARY_VERSION 19
...
// by specifying friend class streams_boost::serialization::access
...
STREAMS_BOOST_STRONG_TYPEDEF(unsigned int, version_type)

// default implementation - call the member function "serialize"
template<class Archive, class T>
inline void serialize(
    Archive & ar, T & t, const STREAMS_BOOST_PFTO unsigned int file_version
){
...
// i.e. streams_boost::serialization will be searched.
// 
...
#endif //STREAMS_BOOST_SERIALIZATION_SERIALIZATION_HPP
