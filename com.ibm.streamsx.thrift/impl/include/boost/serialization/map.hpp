#ifndef  STREAMS_BOOST_SERIALIZATION_MAP_HPP
#define STREAMS_BOOST_SERIALIZATION_MAP_HPP
...
inline void load(
    ...
    streams_boost::serialization::stl::load_collection<
        Archive,
        std::map<Key, Type, Compare, Allocator>,
        streams_boost::serialization::stl::archive_input_map<
            Archive, std::map<Key, Type, Compare, Allocator> >,
            streams_boost::serialization::stl::no_reserve_imp<std::map<
...
#endif // STREAMS_BOOST_SERIALIZATION_MAP_HPP
