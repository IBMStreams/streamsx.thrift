#ifndef STREAMS_BOOST_SERIALIZATION_LIST_HPP
#define STREAMS_BOOST_SERIALIZATION_LIST_HPP
...
inline void load(
    ...
    streams_boost::serialization::stl::load_collection<
        ...
        streams_boost::serialization::stl::archive_input_seq<
            ...
            std::list<U, Allocator> 
        >,
        streams_boost::serialization::stl::no_reserve_imp<std::list<U, Allocator> >
    >(ar, t);
}
...
STREAMS_BOOST_SERIALIZATION_COLLECTION_TRAITS(std::list)

#endif // STREAMS_BOOST_SERIALIZATION_LIST_HPP
