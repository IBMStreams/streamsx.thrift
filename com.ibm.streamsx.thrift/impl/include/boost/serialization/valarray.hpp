#ifndef STREAMS_BOOST_SERIALIZATION_VALARAY_HPP
#define STREAMS_BOOST_SERIALIZATION_VALARAY_HPP
...
STREAMS_BOOST_SERIALIZATION_COLLECTION_TRAITS(STD::valarray)
#undef STD

#endif // STREAMS_BOOST_SERIALIZATION_VALARAY_HPP
