 ...
 */
#ifndef STREAMS_BOOST_SERIALIZATION_BITSET_HPP
#define STREAMS_BOOST_SERIALIZATION_BITSET_HPP
...
inline void save(
    ...
    >();
    ar << STREAMS_BOOST_SERIALIZATION_NVP( bits );
}
...
#endif // STREAMS_BOOST_SERIALIZATION_BITSET_HPP
