#ifndef STREAMS_BOOST_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
#define STREAMS_BOOST_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
...
struct type_info_implementation {
    ...
    struct traits_class_typeinfo_implementation {
      typedef STREAMS_BOOST_DEDUCED_TYPENAME U::type_info_implementation::type type;
    };
    ...
    typedef 
        ...
        //else
            mpl::identity<
                STREAMS_BOOST_DEDUCED_TYPENAME extended_type_info_impl<T>::type
            >
        >::type type;
};
...
#define STREAMS_BOOST_CLASS_TYPE_INFO(T, ETI)              \
namespace streams_boost {                                  \
namespace serialization {                          \
template<>                                         \
...
#endif /// STREAMS_BOOST_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
