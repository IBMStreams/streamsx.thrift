#ifndef STREAMS_BOOST_SERIALIZATION_HASH_COLLECTIONS_SAVE_IMP_HPP
#define STREAMS_BOOST_SERIALIZATION_HASH_COLLECTIONS_SAVE_IMP_HPP
...
inline void save_hash_collection(Archive & ar, const Container &s)
{
    ...
    if(3 < ar.get_library_version()){
        ...
        const unsigned int item_version = version<STREAMS_BOOST_DEDUCED_TYPENAME Container::value_type>::value;
...
#endif //STREAMS_BOOST_SERIALIZATION_HASH_COLLECTIONS_SAVE_IMP_HPP
