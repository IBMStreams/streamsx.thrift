#ifndef STREAMS_BOOST_SERIALIZATION_PFTO_HPP
#define STREAMS_BOOST_SERIALIZATION_PFTO_HPP
...
// or causes other problems (GCC).  note: this 
    ...
    #define STREAMS_BOOST_PFTO long
#else
    #define STREAMS_BOOST_PFTO
#endif
...
template<class T>
pfto_wrapper<T> make_pfto_wrapper(const T & t, STREAMS_BOOST_PFTO int){
...
pfto_wrapper<T> make_pfto_wrapper(const pfto_wrapper<T> & t, int){
    ...
    #define STREAMS_BOOST_PFTO_WRAPPER(T) \
        streams_boost::serialization::pfto_wrapper<T>
    #define STREAMS_BOOST_MAKE_PFTO_WRAPPER(t) \
        streams_boost::serialization::make_pfto_wrapper(t, 0)
#else
    #define STREAMS_BOOST_PFTO_WRAPPER(T) T
    #define STREAMS_BOOST_MAKE_PFTO_WRAPPER(t) t
#endif

#endif // STREAMS_BOOST_SERIALIZATION_PFTO_HPP
