#ifndef STREAMS_BOOST_SERIALIZATION_SPLIT_MEMBER_HPP
#define STREAMS_BOOST_SERIALIZATION_SPLIT_MEMBER_HPP
...
inline void split_member(
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME mpl::eval_if<
        STREAMS_BOOST_DEDUCED_TYPENAME Archive::is_saving,
...
#define STREAMS_BOOST_SERIALIZATION_SPLIT_MEMBER()                       \
template<class Archive>                                          \
void serialize(                                                  \
    Archive &ar,                                                 \
    const unsigned int file_version                              \
){                                                               \
    streams_boost::serialization::split_member(ar, *this, file_version); \
}                                                                \
/**/

#endif // STREAMS_BOOST_SERIALIZATION_SPLIT_MEMBER_HPP
