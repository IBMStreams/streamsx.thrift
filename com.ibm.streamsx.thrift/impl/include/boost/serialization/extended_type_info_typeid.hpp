#ifndef STREAMS_BOOST_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
#define STREAMS_BOOST_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
...
class STREAMS_BOOST_SERIALIZATION_DECL(STREAMS_BOOST_PP_EMPTY()) extended_type_info_typeid_0 : 
...
public:
    ...
    const char * get_key() const {
        return streams_boost::serialization::guid<T>();
    }
    virtual void * construct(unsigned int count, ...) const{
        ...
        switch(count){
        case 0:
            return factory<streams_boost::remove_const<T>, 0>(ap);
        case 1:
            return factory<streams_boost::remove_const<T>, 1>(ap);
        case 2:
            return factory<streams_boost::remove_const<T>, 2>(ap);
        case 3:
            return factory<streams_boost::remove_const<T>, 3>(ap);
        case 4:
            return factory<streams_boost::remove_const<T>, 4>(ap);
        default:
...
// before any of the other headers.
    ...
    struct extended_type_info_impl {
        typedef STREAMS_BOOST_DEDUCED_TYPENAME 
            streams_boost::serialization::extended_type_info_typeid<T> type;
    };
    } // namespace serialization
    } // namespace streams_boost
#endif
...
#endif // STREAMS_BOOST_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
