#ifndef STREAMS_BOOST_SERIALIZATION_SINGLETON_HPP
#define STREAMS_BOOST_SERIALIZATION_SINGLETON_HPP
...
// http://lists.streams_boost.org/Archives/streams_boost/2006/05/105286.php for
// details.
//
...
{
private:
    STREAMS_BOOST_DLLEXPORT static T & instance;
    // include this to provoke instantiation at pre-execution time
    static void use(T const &) {}
    STREAMS_BOOST_DLLEXPORT static T & get_instance() {
...
public:
    STREAMS_BOOST_DLLEXPORT static T & get_mutable_instance(){
        assert(! is_locked());
        return get_instance();
    }
    STREAMS_BOOST_DLLEXPORT static const T & get_const_instance(){
        return get_instance();
    }
    STREAMS_BOOST_DLLEXPORT static bool is_destroyed(){
        return detail::singleton_wrapper<T>::m_is_destroyed;
    }
};

template<class T>
STREAMS_BOOST_DLLEXPORT T & singleton<T>::instance = singleton<T>::get_instance();
...
#endif // STREAMS_BOOST_SERIALIZATION_SINGLETON_HPP
