#ifndef  STREAMS_BOOST_SERIALIZATION_SET_HPP
#define STREAMS_BOOST_SERIALIZATION_SET_HPP
...
inline void load(
    ...
    streams_boost::serialization::stl::load_collection<
        ...
        streams_boost::serialization::stl::archive_input_set<
            Archive, std::set<Key, Compare, Allocator> 
        >,
        streams_boost::serialization::stl::no_reserve_imp<std::set<
...
inline void load(
    ...
    streams_boost::serialization::stl::load_collection<
        ...
        >,
        streams_boost::serialization::stl::no_reserve_imp<
            std::multiset<Key, Compare, Allocator> 
        >
    >(ar, t);
}
...
STREAMS_BOOST_SERIALIZATION_COLLECTION_TRAITS(std::set)
STREAMS_BOOST_SERIALIZATION_COLLECTION_TRAITS(std::multiset)

#endif // STREAMS_BOOST_SERIALIZATION_SET_HPP
