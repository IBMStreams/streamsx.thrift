#ifndef STREAMS_BOOST_SERIALIZATION_NVP_HPP
#define STREAMS_BOOST_SERIALIZATION_NVP_HPP
...
#if 0 // #ifndef STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
...
struct implementation_level<nvp<T> >
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, value = implementation_level::type::value);
};
...
struct tracking_level<nvp<T> >
{
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, value = tracking_level::type::value);
};
...
#define STREAMS_BOOST_SERIALIZATION_NVP(name)                              \
    streams_boost::serialization::make_nvp(STREAMS_BOOST_PP_STRINGIZE(name), name)
/**/

#define STREAMS_BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    streams_boost::serialization::make_nvp(                                \
        STREAMS_BOOST_PP_STRINGIZE(name),                                  \
        streams_boost::serialization::base_object<name >(*this)            \
    )
/**/

#endif // STREAMS_BOOST_SERIALIZATION_NVP_HPP
