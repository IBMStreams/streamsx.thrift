...
namespace detail {
    ...
    struct channel_traits_impl<T, true> {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_mutable=T::is_mutable);
    ...
    struct channel_traits_impl<T, false> {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_mutable=true);
    ...
    struct channel_traits_impl<const T, false> : public channel_traits_impl<T, false> {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(bool, is_mutable=false);
    };
}
...
struct scoped_channel_value {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_mutable=channel_traits<BaseChannelValue>::is_mutable);
...
STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_integral<bits4>::value));
\endcode
*/
...
public:
    ...
    typedef value_type*                     pointer;
    typedef const value_type*               const_pointer;
    STREAMS_BOOST_STATIC_CONSTANT(int,  num_bits=NumBits);
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_mutable=Mutable);
...
template <typename BitField,        // A type that holds the bits of the pixel from which the channel is referenced. Typically an integral type, like streams_boost::uint16_t
...
void swap(const streams_boost::gil::packed_channel_reference<BF,FB,NB,M> x, R& y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::packed_channel_reference<BF,FB,NB,M>::value_type>(x,y); 
}
...
void swap(typename streams_boost::gil::packed_channel_reference<BF,FB,NB,M>::value_type& x, const streams_boost::gil::packed_channel_reference<BF,FB,NB,M> y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::packed_channel_reference<BF,FB,NB,M>::value_type>(x,y); 
}
...
/// \brief swap for packed_channel_reference
template <typename BF, int FB, int NB, bool M> inline
void swap(const streams_boost::gil::packed_channel_reference<BF,FB,NB,M> x, const streams_boost::gil::packed_channel_reference<BF,FB,NB,M> y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::packed_channel_reference<BF,FB,NB,M>::value_type>(x,y); 
}
}   // namespace std
...
void swap(const streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M> x, R& y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y); 
}
...
void swap(typename streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type& x, const streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M> y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y); 
}
...
/// \brief swap for packed_dynamic_channel_reference
template <typename BF, int NB, bool M> inline
void swap(const streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M> x, const streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M> y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::packed_dynamic_channel_reference<BF,NB,M>::value_type>(x,y); 
}
}   // namespace std
