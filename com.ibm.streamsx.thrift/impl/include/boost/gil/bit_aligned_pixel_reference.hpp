...
#include <functional>
#include <streams_boost/mpl/accumulate.hpp>
...
struct bit_aligned_pixel_reference {
    STREAMS_BOOST_STATIC_CONSTANT(int, bit_size = (mpl::accumulate<ChannelBitSizes, mpl::int_<0>, mpl::plus<mpl::_1, mpl::_2> >::type::value));
    typedef streams_boost::gil::bit_range<bit_size,IsMutable>                                           bit_range_t;
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool, is_mutable = IsMutable);
    ...
    explicit bit_aligned_pixel_reference(const typename kth_element_type<bit_aligned_pixel_reference,0>::type channel0) : _bit_range(static_cast<data_ptr_t>(&channel0), channel0.first_bit()) {
        STREAMS_BOOST_STATIC_ASSERT((num_channels<bit_aligned_pixel_reference>::value==1));
    }
...
private:
    static void check_gray() {  STREAMS_BOOST_STATIC_ASSERT((is_same<typename Layout::color_space_t, gray_t>::value)); }
...
void swap(const streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true> x, R& y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y); 
}


template <typename B, typename C, typename L> inline
void swap(typename streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type& x, const streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true> y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y); 
}


template <typename B, typename C, typename L> inline
void swap(const streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true> x, const streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true> y) { 
    streams_boost::gil::swap_proxy<typename streams_boost::gil::bit_aligned_pixel_reference<B,C,L,true>::value_type>(x,y); 
}
}   // namespace std
#endif
