...
private:
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int, bit_size = NonAlignedPixelReference::bit_size);
...
template <typename NonAlignedPixelReference>
streams_boost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> uninitialized_copy(streams_boost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> first, 
                                                                                   streams_boost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> last,
                                                                                   streams_boost::gil::bit_aligned_pixel_iterator<NonAlignedPixelReference> dst) {
