...
namespace streams_boost { namespace gil {
...
#ifdef STREAMS_BOOST_GIL_USE_CONCEPT_CHECK
    #define GIL_CLASS_REQUIRE(type_var, ns, concept) STREAMS_BOOST_CLASS_REQUIRE(type_var, ns, concept);
...
struct DefaultConstructible {
    void constraints() {
        function_requires<streams_boost::DefaultConstructibleConcept<T> >();
    }
};
...
struct CopyConstructible {
    void constraints() {
        function_requires<streams_boost::CopyConstructibleConcept<T> >();
    }
};
...
struct Assignable {
    void constraints() {
        function_requires<streams_boost::AssignableConcept<T> >();
    }
};
/// \ingroup BasicConcepts
/**
...
struct EqualityComparable {
    void constraints() {
        function_requires<streams_boost::EqualityComparableConcept<T> >();
    }
};
...
struct SameType {
    void constraints() {
        STREAMS_BOOST_STATIC_ASSERT((streams_boost::is_same<T,U>::value_core));
    }
};
...
struct Regular {
    void constraints() {
        gil_function_requires< streams_boost::DefaultConstructibleConcept<T> >();
        gil_function_requires< streams_boost::CopyConstructibleConcept<T> >();              
        gil_function_requires< streams_boost::EqualityComparableConcept<T> >(); // ==, !=
        gil_function_requires< streams_boost::AssignableConcept<T> >();
...
struct Point2DConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT(P::num_dimensions == 2);
        point.x=point.y;
        point[0]=point[1];
    }
    P point;
...
//
// Taken from streams_boost's concept_check.hpp. Isolating mutability to result in faster compile time 
//
////////////////////////////////////////////////////////////////////////////////////////

namespace detail {
    template <class TT> // Preconditions: TT Models streams_boost_concepts::ForwardTraversalConcept
    ...
    template <class TT> // Preconditions: TT Models streams_boost::BidirectionalIteratorConcept
    ...
    template <class TT> // Preconditions: TT Models streams_boost_concepts::RandomAccessTraversalConcept
...
struct ColorSpacesCompatibleConcept {
    void constraints() {
        STREAMS_BOOST_STATIC_ASSERT((color_spaces_are_compatible<Cs1,Cs2>::value));
    }
};
...
\code
STREAMS_BOOST_STATIC_ASSERT((channels_are_compatible<bits8, const bits8&>::value));
\endcode
*/
...
struct ChannelsCompatibleConcept {
    void constraints() {
        STREAMS_BOOST_STATIC_ASSERT((channels_are_compatible<T1,T2>::value));
    }
};
...
struct HomogeneousColorBaseConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT((is_same<T0,TN>::value));   // better than nothing
...
struct ColorBasesCompatibleConcept {
    void constraints() {
        STREAMS_BOOST_STATIC_ASSERT((is_same<typename ColorBase1::layout_t::color_space_t, 
...
struct PixelConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT((is_pixel<P>::value));
...
struct MutablePixelConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT(P::is_mutable);
    }
};
...
struct HomogeneousPixelValueConcept {
    void constraints() {
        gil_function_requires<HomogeneousPixelConcept<P> >();
        gil_function_requires<Regular<P> >();
        STREAMS_BOOST_STATIC_ASSERT((is_same<P, typename P::value_type>::value));
    }
};
...
struct PixelsCompatibleConcept {
    void constraints() {
        STREAMS_BOOST_STATIC_ASSERT((pixels_are_compatible<P1,P2>::value));
    }
};
...
/**
\code
concept PixelDereferenceAdaptorConcept<streams_boost::UnaryFunctionConcept D>
...
struct PixelDereferenceAdaptorConcept {
    void constraints() {
        gil_function_requires< streams_boost::UnaryFunctionConcept<D, 
            typename remove_const_and_reference<typename D::result_type>::type, 
            typename D::argument_type> >();
        gil_function_requires< streams_boost::DefaultConstructibleConcept<D> >();
        gil_function_requires< streams_boost::CopyConstructibleConcept<D> >();              
        gil_function_requires< streams_boost::AssignableConcept<D> >();
...
GIL's iterators must also provide the following metafunctions:
 ...
 \code
concept PixelIteratorConcept<typename Iterator> : streams_boost_concepts::RandomAccessTraversalConcept<Iterator>, PixelBasedConcept<Iterator> {
...
struct PixelIteratorConcept {   
    void constraints() {
        gil_function_requires<streams_boost_concepts::RandomAccessTraversalConcept<Iterator> >();
...
namespace detail {
    ...
    template <typename Iterator>  // Preconditions: Iterator Models streams_boost_concepts::RandomAccessTraversalConcept
...
/**
\code
concept MemoryBasedIteratorConcept<streams_boost_concepts::RandomAccessTraversalConcept Iterator> {
...
/**
\code
concept StepIteratorConcept<streams_boost_concepts::ForwardTraversalConcept Iterator> {
...
struct StepIteratorConcept {
    void constraints() {
        gil_function_requires<streams_boost_concepts::ForwardTraversalConcept<Iterator> >();
        it.set_step(0);
    }
    Iterator it;
};
...
\code
concept IteratorAdaptorConcept<streams_boost_concepts::ForwardTraversalConcept Iterator> {
    where SameType<is_iterator_adaptor<Iterator>::type, mpl::true_>;

    typename iterator_adaptor_get_base<Iterator>;
        where Metafunction<iterator_adaptor_get_base<Iterator> >;
        where streams_boost_concepts::ForwardTraversalConcept<iterator_adaptor_get_base<Iterator>::type>;
    
    typename another_iterator; 
    typename iterator_adaptor_rebind<Iterator,another_iterator>::type;
        where streams_boost_concepts::ForwardTraversalConcept<another_iterator>;
...
struct IteratorAdaptorConcept {
    void constraints() {
        ...
        typedef typename iterator_adaptor_get_base<Iterator>::type base_t;
        gil_function_requires<streams_boost_concepts::ForwardTraversalConcept<base_t> >();

        STREAMS_BOOST_STATIC_ASSERT(is_iterator_adaptor<Iterator>::value);
...
struct RandomAccessNDLocatorConcept {
    void constraints() {
        ...
        gil_function_requires<streams_boost_concepts::RandomAccessTraversalConcept<first_it_type> >();
        gil_function_requires<streams_boost_concepts::RandomAccessTraversalConcept<last_it_type> >();
        ...
        STREAMS_BOOST_STATIC_ASSERT(point_t::num_dimensions==N);
        STREAMS_BOOST_STATIC_ASSERT((is_same<typename std::iterator_traits<first_it_type>::difference_type, typename point_t::template axis<0>::coord_t>::value));
        STREAMS_BOOST_STATIC_ASSERT((is_same<typename std::iterator_traits<last_it_type>::difference_type, typename point_t::template axis<N-1>::coord_t>::value));
...
struct RandomAccess2DLocatorConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT(Loc::num_dimensions==2);
...
struct PixelLocatorConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT((is_same<typename Loc::x_coord_t, typename Loc::y_coord_t>::value));
    }
    Loc loc;
};
...
struct RandomAccessNDImageViewConcept {
    void constraints() {
        ...
        gil_function_requires<streams_boost_concepts::RandomAccessTraversalConcept<iterator> >();
        gil_function_requires<streams_boost_concepts::RandomAccessTraversalConcept<reverse_iterator> >();
...
//        STREAMS_BOOST_STATIC_ASSERT((typename std::iterator_traits<first_it_type>::difference_type, typename point_t::template axis<0>::coord_t>::value));
//        STREAMS_BOOST_STATIC_ASSERT((typename std::iterator_traits< last_it_type>::difference_type, typename point_t::template axis<N-1>::coord_t>::value));
...
struct RandomAccess2DImageViewConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT(View::num_dimensions==2);
...
struct ImageViewConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT((is_same<typename View::x_coord_t, typename View::y_coord_t>::value));
...
struct ViewsCompatibleConcept {
    void constraints() {
        STREAMS_BOOST_STATIC_ASSERT((views_are_compatible<V1,V2>::value));
    }
};
...
struct ImageConcept {
    void constraints() {
        ...
        STREAMS_BOOST_STATIC_ASSERT(num_channels<Img>::value == mpl::size<typename color_space_type<Img>::type>::value);

        STREAMS_BOOST_STATIC_ASSERT((is_same<coord_t, typename Img::x_coord_t>::value));
        STREAMS_BOOST_STATIC_ASSERT((is_same<coord_t, typename Img::y_coord_t>::value));
    }
    Img img;
};


} }  // namespace streams_boost::gil
