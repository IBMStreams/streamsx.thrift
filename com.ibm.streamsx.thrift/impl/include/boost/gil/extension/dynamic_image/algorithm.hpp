...
bool equal_pixels(const any_image_view<Types1>& src, const View2& dst) {
    return apply_operation(src,streams_boost::bind(detail::equal_pixels_fn(), _1, dst));
}
...
bool equal_pixels(const View1& src, const any_image_view<Types2>& dst) {
    return apply_operation(dst,streams_boost::bind(detail::equal_pixels_fn(), src, _1));
}
...
void copy_pixels(const any_image_view<Types1>& src, const View2& dst) {
    apply_operation(src,streams_boost::bind(detail::copy_pixels_fn(), _1, dst));
}
...
void copy_pixels(const View1& src, const any_image_view<Types2>& dst) {
    apply_operation(dst,streams_boost::bind(detail::copy_pixels_fn(), src, _1));
}
...
void copy_and_convert_pixels(const any_image_view<Types1>& src, const View2& dst, CC cc) {
    apply_operation(src,streams_boost::bind(detail::copy_and_convert_pixels_fn<CC>(cc), _1, dst));
}
...
void copy_and_convert_pixels(const any_image_view<Types1>& src, const View2& dst) {
    apply_operation(src,streams_boost::bind(detail::copy_and_convert_pixels_fn<default_color_converter>(), _1, dst));
}
...
void copy_and_convert_pixels(const View1& src, const any_image_view<Types2>& dst, CC cc) {
    apply_operation(dst,streams_boost::bind(detail::copy_and_convert_pixels_fn<CC>(cc), src, _1));
}
...
void copy_and_convert_pixels(const View1& src, const any_image_view<Types2>& dst) {
    apply_operation(dst,streams_boost::bind(detail::copy_and_convert_pixels_fn<default_color_converter>(), src, _1));
}
