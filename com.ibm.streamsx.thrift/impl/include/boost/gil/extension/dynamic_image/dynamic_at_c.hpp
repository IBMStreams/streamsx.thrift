    ...
    template <typename IntTypes, typename ValueType> inline           \
        static ValueType apply(std::size_t index) {                    \
            static ValueType table[] = {                               \
                STREAMS_BOOST_PP_REPEAT(NUM, GIL_AT_C_VALUE, STREAMS_BOOST_PP_EMPTY)    \
            };                                                          \
            return table[index];                                        \
        }                                                               \
    };
...
namespace detail {
    namespace at_c {
        ...
        STREAMS_BOOST_PP_REPEAT(GIL_DYNAMIC_AT_C_LIMIT, GIL_AT_C_LOOKUP, STREAMS_BOOST_PP_EMPTY)
