...
#define GIL_APPLY_FWD_OP(z, N, text)                                                                        \
    template <> struct apply_operation_fwd_fn<STREAMS_BOOST_PP_ADD(N,1)> {                                      \
        template <typename Types, typename Bits, typename UnaryOp>                                     \
        typename UnaryOp::result_type apply(Bits& bits, std::size_t index, UnaryOp op) const {        \
            typedef typename mpl::begin<Types>::type                                             \
            STREAMS_BOOST_PP_REPEAT(N, GIL_FWD_TYPEDEFS, STREAMS_BOOST_PP_EMPTY)                                            \
            T##N;                                                                                       \
            switch (index) {                                                                            \
                STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_PP_ADD(N,1), GIL_FWD_CASE, STREAMS_BOOST_PP_EMPTY)                            \
            }                                                                                           \
            throw;                                                                                      \
        }                                                                                               \
        template <typename Types, typename Bits, typename UnaryOp>                                     \
        typename UnaryOp::result_type applyc(const Bits& bits, std::size_t index, UnaryOp op) const { \
            ...
            T##N;                                                                                       \
            switch (index) {                                                                            \
                STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_PP_ADD(N,1), GIL_FWD_CONST_CASE,STREAMS_BOOST_PP_EMPTY)                       \
            }                                                                                           \
            throw;                                                                                      \
        }                                                                                               \
        ...
        typename UnaryOp::result_type apply(Bits& bits, std::size_t index, const Info& info, UnaryOp op) const {        \
            ...
            T##N;                                                                                       \
            switch (index) {                                                                            \
                STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_PP_ADD(N,1), GIL_FWD_CASE_WITH_INFO, STREAMS_BOOST_PP_EMPTY)                            \
            }                                                                                           \
            throw;                                                                                      \
        }                                                                                               \
        ...
        typename UnaryOp::result_type applyc(const Bits& bits, std::size_t index, const Info& info, UnaryOp op) const { \
            ...
            T##N;                                                                                       \
            switch (index) {                                                                            \
                STREAMS_BOOST_PP_REPEAT(STREAMS_BOOST_PP_ADD(N,1), GIL_FWD_CONST_CASE_WITH_INFO,STREAMS_BOOST_PP_EMPTY)                       \
            }                                                                                           \
            throw;                                                                                      \
        }                                                                                               \
    };

#define GIL_GENERATE_APPLY_FWD_OPS(N) STREAMS_BOOST_PP_REPEAT(N, GIL_APPLY_FWD_OP, STREAMS_BOOST_PP_EMPTY)
