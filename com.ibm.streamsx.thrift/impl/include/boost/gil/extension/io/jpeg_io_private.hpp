...
struct jpeg_read_support_private {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(J_COLOR_SPACE,color_type=JCS_UNKNOWN);
};
template <>
struct jpeg_read_support_private<bits8,gray_t> {
    STREAMS_BOOST_STATIC_ASSERT(BITS_IN_JSAMPLE==8);
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(J_COLOR_SPACE,color_type=JCS_GRAYSCALE);
};
template <>
struct jpeg_read_support_private<bits8,rgb_t> {
    STREAMS_BOOST_STATIC_ASSERT(BITS_IN_JSAMPLE==8);
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(J_COLOR_SPACE,color_type=JCS_RGB);
};
template <>
struct jpeg_read_support_private<bits8,cmyk_t> {
    STREAMS_BOOST_STATIC_ASSERT(BITS_IN_JSAMPLE==8);
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(J_COLOR_SPACE,color_type=JCS_CMYK);
};
template <typename Channel,typename ColorSpace>
