...
struct tiff_read_support_private<bits8,gray_t> {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PHOTOMETRIC_MINISBLACK);
};
template <>
struct tiff_read_support_private<bits8,rgb_t> {
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=8);
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PHOTOMETRIC_RGB);
};
template <>
...
struct tiff_read_support_private<bits32f,gray_t> {
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=32);
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PHOTOMETRIC_MINISBLACK);
};
template <>
...
inline void tiff_read_view(const char* filename,const View& view) {
    STREAMS_BOOST_STATIC_ASSERT(tiff_read_support<View>::is_supported);
    detail::tiff_reader m(filename);
    m.apply(view);
}
...
void tiff_read_image(const char* filename,Image& im) {
    STREAMS_BOOST_STATIC_ASSERT(tiff_read_support<typename Image::view_t>::is_supported);
    detail::tiff_reader m(filename);
    m.read_image(im);
}
...
struct tiff_write_support {
    ...
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=
                          (detail::tiff_write_support_private<typename channel_type<View>::type,
                                                              typename color_space_type<View>::type>::color_type));
    STREAMS_BOOST_STATIC_CONSTANT(bool, value=is_supported);
};
...
inline void tiff_write_view(const char* filename,const View& view) {
    STREAMS_BOOST_STATIC_ASSERT(tiff_write_support<View>::is_supported);
