...
template <typename Cs> struct png_color_type {STREAMS_BOOST_STATIC_CONSTANT(int,color_type=0);};
template<> struct png_color_type<gray_t> { STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PNG_COLOR_TYPE_GRAY); };
template<> struct png_color_type<rgb_t>  { STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PNG_COLOR_TYPE_RGB); };
template<> struct png_color_type<rgba_t> { STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PNG_COLOR_TYPE_RGBA); };

template <typename Channel,typename ColorSpace> struct png_is_supported {STREAMS_BOOST_STATIC_CONSTANT(bool,value=false);};
template <> struct png_is_supported<bits8,gray_t>  {STREAMS_BOOST_STATIC_CONSTANT(bool,value=true);};
template <> struct png_is_supported<bits8,rgb_t>   {STREAMS_BOOST_STATIC_CONSTANT(bool,value=true);};
template <> struct png_is_supported<bits8,rgba_t>  {STREAMS_BOOST_STATIC_CONSTANT(bool,value=true);};
template <> struct png_is_supported<bits16,gray_t> {STREAMS_BOOST_STATIC_CONSTANT(bool,value=true);};
template <> struct png_is_supported<bits16,rgb_t>  {STREAMS_BOOST_STATIC_CONSTANT(bool,value=true);};
template <> struct png_is_supported<bits16,rgba_t> {STREAMS_BOOST_STATIC_CONSTANT(bool,value=true);};

template <typename Channel> struct png_bit_depth {STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=sizeof(Channel)*8);};

template <typename Channel,typename ColorSpace>
struct png_read_support_private {
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=false);
    STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=0);
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=0);
};
template <>
struct png_read_support_private<bits8,gray_t> {
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=8);
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PNG_COLOR_TYPE_GRAY);
};
template <>
struct png_read_support_private<bits8,rgb_t> {
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=8);
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PNG_COLOR_TYPE_RGB);
};
template <>
struct png_read_support_private<bits8,rgba_t> {
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=8);
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PNG_COLOR_TYPE_RGBA);
};
template <>
struct png_read_support_private<bits16,gray_t> {
    STREAMS_BOOST_STATIC_CONSTANT(bool,is_supported=true);
    STREAMS_BOOST_STATIC_CONSTANT(int,bit_depth=16);
    STREAMS_BOOST_STATIC_CONSTANT(int,color_type=PNG_COLOR_TYPE_GRAY);
};
template <>
