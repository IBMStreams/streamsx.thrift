...
GIL_FORCEINLINE streams_boost::gil::pixel<T,Cs>* 
copy(streams_boost::gil::pixel<T,Cs>* first, streams_boost::gil::pixel<T,Cs>* last, 
     streams_boost::gil::pixel<T,Cs>* dst) { 
    return (streams_boost::gil::pixel<T,Cs>*)std::copy((unsigned char*)first,(unsigned char*)last, (unsigned char*)dst);
}
...
template<typename T, typename Cs> 
GIL_FORCEINLINE streams_boost::gil::pixel<T,Cs>* 
copy(const streams_boost::gil::pixel<T,Cs>* first, const streams_boost::gil::pixel<T,Cs>* last, 
     streams_boost::gil::pixel<T,Cs>* dst) { 
    return (streams_boost::gil::pixel<T,Cs>*)std::copy((unsigned char*)first,(unsigned char*)last, (unsigned char*)dst);
}
} // namespace std
...
streams_boost::gil::planar_pixel_iterator<IC2,Cs> copy(streams_boost::gil::planar_pixel_iterator<IC1,Cs> first, streams_boost::gil::planar_pixel_iterator<IC1,Cs> last, streams_boost::gil::planar_pixel_iterator<IC2,Cs> dst) { 
    streams_boost::gil::gil_function_requires<streams_boost::gil::ChannelsCompatibleConcept<typename std::iterator_traits<IC1>::value_type,typename std::iterator_traits<IC2>::value_type> >();
    static_for_each(first,last,dst,streams_boost::gil::detail::copy_fn<IC1,IC2>());
...
template <typename IL, typename OL>
GIL_FORCEINLINE streams_boost::gil::iterator_from_2d<OL> copy1(streams_boost::gil::iterator_from_2d<IL> first, streams_boost::gil::iterator_from_2d<IL> last, streams_boost::gil::iterator_from_2d<OL> dst) {
    return streams_boost::gil::detail::copy_with_2d_iterators(first,last,dst);
}
...
void fill(streams_boost::gil::iterator_from_2d<IL> first, streams_boost::gil::iterator_from_2d<IL> last, const V& val) {
    streams_boost::gil::gil_function_requires<streams_boost::gil::MutablePixelLocatorConcept<IL> >();
    if (first.is_1d_traversable()) {
...
void destruct_range_impl(It first, It last, mpl::true_) {
    ...
    if (streams_boost::has_trivial_destructor<value_t>::value)
        return;
    while (first!=last) {
        first->~value_t();
        ++first;
...
struct has_trivial_pixel_constructor : public streams_boost::has_trivial_constructor<typename View::value_type> {};
template <typename View>
struct has_trivial_pixel_constructor<View, true> : public streams_boost::has_trivial_constructor<typename channel_type<View>::type> {};
...
struct equal_n_fn<streams_boost::gil::iterator_from_2d<Loc>,I2> {
    GIL_FORCEINLINE bool operator()(streams_boost::gil::iterator_from_2d<Loc> i1, std::ptrdiff_t n, I2 i2) const {
        gil_function_requires<streams_boost::gil::PixelLocatorConcept<Loc> >();
        gil_function_requires<streams_boost::gil::PixelIteratorConcept<I2> >();
        while (n>0) {
...
struct equal_n_fn<I1,streams_boost::gil::iterator_from_2d<Loc> > {
    GIL_FORCEINLINE bool operator()(I1 i1, std::ptrdiff_t n, streams_boost::gil::iterator_from_2d<Loc> i2) const {
        gil_function_requires<streams_boost::gil::PixelIteratorConcept<I1> >();
        gil_function_requires<streams_boost::gil::PixelLocatorConcept<Loc> >();
        while (n>0) {
...
struct equal_n_fn<streams_boost::gil::iterator_from_2d<Loc1>,streams_boost::gil::iterator_from_2d<Loc2> > {
   GIL_FORCEINLINE bool operator()(streams_boost::gil::iterator_from_2d<Loc1> i1, std::ptrdiff_t n, streams_boost::gil::iterator_from_2d<Loc2> i2) const {
        gil_function_requires<streams_boost::gil::PixelLocatorConcept<Loc1> >();
        gil_function_requires<streams_boost::gil::PixelLocatorConcept<Loc2> >();
...
bool equal(streams_boost::gil::iterator_from_2d<Loc1> first, streams_boost::gil::iterator_from_2d<Loc1> last, streams_boost::gil::iterator_from_2d<Loc2> first2) {
    streams_boost::gil::gil_function_requires<streams_boost::gil::PixelLocatorConcept<Loc1> >();
    streams_boost::gil::gil_function_requires<streams_boost::gil::PixelLocatorConcept<Loc2> >();
    std::ptrdiff_t n=last-first;
    if (first.is_1d_traversable()) {
        if (first2.is_1d_traversable())
            return streams_boost::gil::detail::equal_n_fn<typename Loc1::x_iterator,typename Loc2::x_iterator>()(first.x(),n, first2.x());
        else
            return streams_boost::gil::detail::equal_n_fn<typename Loc1::x_iterator,streams_boost::gil::iterator_from_2d<Loc2> >()(first.x(),n, first2);
    } else {
        if (first2.is_1d_traversable())
            return streams_boost::gil::detail::equal_n_fn<streams_boost::gil::iterator_from_2d<Loc1>,typename Loc2::x_iterator>()(first,n, first2.x());
        else
            return streams_boost::gil::detail::equal_n_fn<streams_boost::gil::iterator_from_2d<Loc1>,streams_boost::gil::iterator_from_2d<Loc2> >()(first,n,first2);
    }
}
} // namespace std
