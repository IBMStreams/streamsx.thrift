...
Example:
\code
STREAMS_BOOST_STATIC_ASSERT((num_channels<rgb8_view_t>::value==3));
STREAMS_BOOST_STATIC_ASSERT((num_channels<cmyk16_planar_ptr_t>::value==4));

STREAMS_BOOST_STATIC_ASSERT((is_planar<rgb16_planar_image_t>::value));
STREAMS_BOOST_STATIC_ASSERT((is_same<color_space_type<rgb8_planar_ref_t>::type, rgb_t>::value));
STREAMS_BOOST_STATIC_ASSERT((is_same<channel_mapping_type<cmyk8_pixel_t>::type, 
                             channel_mapping_type<rgba8_pixel_t>::type>::value));
STREAMS_BOOST_STATIC_ASSERT((is_same<channel_type<bgr8_pixel_t>::type, bits8>::value));
\endcode
*/
...
public:
    ...
    STREAMS_BOOST_STATIC_CONSTANT(bool,                 is_mutable = channel_traits<channel_t>::is_mutable);
