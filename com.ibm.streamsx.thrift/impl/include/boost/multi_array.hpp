...
#ifndef STREAMS_BOOST_MULTI_ARRAY_RG071801_HPP
#define STREAMS_BOOST_MULTI_ARRAY_RG071801_HPP
...
#include "streams_boost/multi_array/copy_array.hpp"
#include "streams_boost/multi_array/iterator.hpp"
#include "streams_boost/multi_array/subarray.hpp"
#include "streams_boost/multi_array/multi_array_ref.hpp"
...
{
    static T x;
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = sizeof((is_multi_array_impl_help)(x)) == 1);
...
public:
  ...
  super_type(rhs), allocator_(rhs.allocator_) {
    allocate_space();
    streams_boost::detail::multi_array::copy_n(rhs.base_,rhs.num_elements(),base_);
  }
  ...
  multi_array& resize(const detail::multi_array
    ...
    streams_boost::array<size_type,NumDims> min_extents;
    ...
    typename
      multi_array::STREAMS_BOOST_NESTED_TEMPLATE array_view<NumDims>::type view_old = (*this)[old_idxes];
    typename
      multi_array::STREAMS_BOOST_NESTED_TEMPLATE array_view<NumDims>::type view_new = new_array[new_idxes];
...
#endif // STREAMS_BOOST_MULTI_ARRAY_RG071801_HPP
