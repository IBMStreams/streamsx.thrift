...
#ifndef STREAMS_BOOST_MPL_ARG_FWD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_ARG_FWD_HPP_INCLUDED
...
template< STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, N) > struct arg;

STREAMS_BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
STREAMS_BOOST_MPL_AUX_ADL_BARRIER_DECL(arg)

#endif // STREAMS_BOOST_MPL_ARG_FWD_HPP_INCLUDED
