...
#ifndef STREAMS_BOOST_MPL_AS_SEQUENCE_HPP_INCLUDED
#define STREAMS_BOOST_MPL_AS_SEQUENCE_HPP_INCLUDED
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,as_sequence,(T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC_NO_ETI(1, as_sequence)

}}

#endif // STREAMS_BOOST_MPL_AS_SEQUENCE_HPP_INCLUDED
