...
#ifndef STREAMS_BOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
#define STREAMS_BOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
...
template< 
      typename Map
    , STREAMS_BOOST_MPL_AUX_NTTP_DECL(long, order)
    , STREAMS_BOOST_MPL_AUX_NTTP_DECL(long, max_order)
    >
struct next_order;
...
#endif // STREAMS_BOOST_MPL_MAP_AUX_ITERATOR_HPP_INCLUDED
