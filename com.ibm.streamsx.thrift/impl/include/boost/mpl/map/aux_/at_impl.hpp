...
#ifndef STREAMS_BOOST_MPL_MAP_AUX_AT_IMPL_HPP_INCLUDED
#define STREAMS_BOOST_MPL_MAP_AUX_AT_IMPL_HPP_INCLUDED
...
struct m_at
{
    ...
    typedef __typeof__( STREAMS_BOOST_MPL_AUX_OVERLOAD_CALL_VALUE_BY_KEY(
          Map
        , STREAMS_BOOST_MPL_AUX_STATIC_CAST(key_*, 0)
        ) ) type;
};
...
{
    typedef __typeof__( STREAMS_BOOST_MPL_AUX_OVERLOAD_CALL_ITEM_BY_ORDER(
          Map 
        , STREAMS_BOOST_MPL_AUX_STATIC_CAST(long_<order>*, 0)
        ) ) type;
};
