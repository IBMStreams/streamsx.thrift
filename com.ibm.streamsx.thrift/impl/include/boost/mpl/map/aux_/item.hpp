...
#ifndef STREAMS_BOOST_MPL_MAP_AUX_ITEM_HPP_INCLUDED
#define STREAMS_BOOST_MPL_MAP_AUX_ITEM_HPP_INCLUDED
...
#include <streams_boost/mpl/map/aux_/map0.hpp>
    ...
    : Base
{
    ...
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<T>, VALUE_BY_KEY, m_item, aux::type_wrapper<Key>* );
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<item>, ITEM_BY_ORDER, m_item, order* );
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( order_tag_, ORDER_BY_KEY, m_item, aux::type_wrapper<Key>* );
};
    ...
    : Base
{
    ...
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<void_>, VALUE_BY_KEY, m_mask, aux::type_wrapper<Key>* );
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( aux::type_wrapper<void_>, ITEM_BY_ORDER, m_mask, key_order_* );
};

#else // STREAMS_BOOST_MPL_CFG_TYPEOF_BASED_SEQUENCES
    ...
    : Base
{
    ...
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( order_tag_, ORDER_BY_KEY, m_item_, aux::type_wrapper<Key>* );
};
    ...
    : Base
{
    ...
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( aux::no_tag, ORDER_BY_KEY, m_mask, aux::type_wrapper<Key>* );
    STREAMS_BOOST_MPL_AUX_MAP_OVERLOAD( aux::yes_tag, IS_MASKED, m_mask, key_order_* );
};
...
#endif // STREAMS_BOOST_MPL_MAP_AUX_ITEM_HPP_INCLUDED
