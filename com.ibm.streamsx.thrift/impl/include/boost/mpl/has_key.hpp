...
#ifndef STREAMS_BOOST_MPL_HAS_KEY_HPP_INCLUDED
#define STREAMS_BOOST_MPL_HAS_KEY_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/has_key_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,has_key,(AssociativeSequence,Key))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(2, has_key)

}}

#endif // STREAMS_BOOST_MPL_HAS_KEY_HPP_INCLUDED
