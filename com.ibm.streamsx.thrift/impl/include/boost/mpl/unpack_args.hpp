...
#ifndef STREAMS_BOOST_MPL_UNPACK_ARGS_HPP_INCLUDED
#define STREAMS_BOOST_MPL_UNPACK_ARGS_HPP_INCLUDED
...
#   define STREAMS_BOOST_MPL_PREPROCESSED_HEADER unpack_args.hpp
...
#   define AUX778076_UNPACKED_ARGS(n, Args) \
    STREAMS_BOOST_MPL_PP_REPEAT(n, AUX778076_UNPACK, Args) \
    /**/
...
#else
template< STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, size) > struct unpack_args_impl
{
...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, STREAMS_BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <streams_boost/mpl/unpack_args.hpp>))
...
#   endif
    {
#else // STREAMS_BOOST_MPL_CFG_NO_NESTED_FORWARDING
    {
...
STREAMS_BOOST_MPL_AUX_PASS_THROUGH_LAMBDA_SPEC(1, unpack_args)
...
#endif // STREAMS_BOOST_MPL_CFG_USE_PREPROCESSED_HEADERS
#endif // STREAMS_BOOST_MPL_UNPACK_ARGS_HPP_INCLUDED
