...
#ifndef STREAMS_BOOST_MPL_FOLD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_FOLD_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/fold_impl.hpp>
...
struct fold
{
    ...
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,fold,(Sequence,State,ForwardOp))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(3, fold)

}}

#endif // STREAMS_BOOST_MPL_FOLD_HPP_INCLUDED
