...
#ifndef STREAMS_BOOST_MPL_APPLY_FWD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_APPLY_FWD_HPP_INCLUDED
...
#   define STREAMS_BOOST_MPL_PREPROCESSED_HEADER apply_fwd.hpp
...
#   define STREAMS_BOOST_MPL_CFG_NO_APPLY_TEMPLATE
#endif
...
#else
namespace aux {
template< STREAMS_BOOST_AUX_NTTP_DECL(int, arity_) > struct apply_chooser;
}
#endif
...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, STREAMS_BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <streams_boost/mpl/apply_fwd.hpp>))
...
#endif // STREAMS_BOOST_MPL_APPLY_FWD_HPP_INCLUDED
