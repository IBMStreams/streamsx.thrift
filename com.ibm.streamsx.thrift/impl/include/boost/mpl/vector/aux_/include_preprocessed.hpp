...
#   define AUX778076_HEADER \
    AUX778076_INCLUDE_DIR/STREAMS_BOOST_MPL_PREPROCESSED_HEADER \
/**/
#else
#   define AUX778076_HEADER \
    STREAMS_BOOST_PP_CAT(AUX778076_INCLUDE_DIR,/)##STREAMS_BOOST_MPL_PREPROCESSED_HEADER \
/**/
#endif


#if STREAMS_BOOST_WORKAROUND(__IBMCPP__, STREAMS_BOOST_TESTED_AT(700))
#   define AUX778076_INCLUDE_STRING STREAMS_BOOST_PP_STRINGIZE(streams_boost/mpl/vector/aux_/preprocessed/AUX778076_HEADER)
#   include AUX778076_INCLUDE_STRING
#   undef AUX778076_INCLUDE_STRING
#else
#   include STREAMS_BOOST_PP_STRINGIZE(streams_boost/mpl/vector/aux_/preprocessed/AUX778076_HEADER)
#endif
