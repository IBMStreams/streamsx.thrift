...
#ifndef STREAMS_BOOST_MPL_COUNT_HPP_INCLUDED
#define STREAMS_BOOST_MPL_COUNT_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/count_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,count,(Sequence,T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(2, count)

}}

#endif // STREAMS_BOOST_MPL_COUNT_HPP_INCLUDED
