...
#ifndef STREAMS_BOOST_MPL_SIZE_HPP_INCLUDED
#define STREAMS_BOOST_MPL_SIZE_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/size_impl.hpp>
...
struct size
    : aux::msvc_eti_base<
      ...
      >::type
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1, size, (Sequence))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(1, size)

}}

#endif // STREAMS_BOOST_MPL_SIZE_HPP_INCLUDED
