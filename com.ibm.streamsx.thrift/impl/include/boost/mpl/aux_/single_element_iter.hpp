...
#ifndef STREAMS_BOOST_MPL_AUX_SINGLE_ELEMENT_ITER_HPP_INCLUDED
#define STREAMS_BOOST_MPL_AUX_SINGLE_ELEMENT_ITER_HPP_INCLUDED
...
template< typename T, STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, is_last_) >
struct sel_iter;
...
template< typename T, STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, is_last_), typename Distance >
struct advance< aux::sel_iter<T,is_last_>,Distance>
{
    typedef aux::sel_iter<
          T
        , ( is_last_ + STREAMS_BOOST_MPL_AUX_NESTED_VALUE_WKND(int, Distance) )
        > type;
};

template< 
      typename T
    , STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, l1)
    , STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, l2) 
    >
...
template<> struct distance_impl<aux::sel_iter_tag>
{
    template< typename Iter1, typename Iter2 > struct apply
    {
        ...
        STREAMS_BOOST_STATIC_CONSTANT(int, value = ( pos2_ - pos1_ ));
    };
};
...
#endif // STREAMS_BOOST_MPL_AUX_SINGLE_ELEMENT_ITER_HPP_INCLUDED
