...
#ifndef STREAMS_BOOST_MPL_AUX_CONFIG_DTP_HPP_INCLUDED
#define STREAMS_BOOST_MPL_AUX_CONFIG_DTP_HPP_INCLUDED
...
// able to compile a definition of nested class template with DTP
    ...
    && STREAMS_BOOST_WORKAROUND(__BORLANDC__, >= 0x560) \
    && STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x610))

#   define STREAMS_BOOST_MPL_CFG_NO_DEFAULT_PARAMETERS_IN_NESTED_TEMPLATES
    ...
    && (   STREAMS_BOOST_WORKAROUND(__MWERKS__, <= 0x3001) \
        || STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x610)) \
        || defined(STREAMS_BOOST_MPL_CFG_NO_DEFAULT_PARAMETERS_IN_NESTED_TEMPLATES) \
        )
        
#   define STREAMS_BOOST_MPL_CFG_BROKEN_DEFAULT_PARAMETERS_IN_NESTED_TEMPLATES

#endif

#endif // STREAMS_BOOST_MPL_AUX_CONFIG_DTP_HPP_INCLUDED
