...
#ifndef STREAMS_BOOST_MPL_AUX_FULL_LAMBDA_HPP_INCLUDED
#define STREAMS_BOOST_MPL_AUX_FULL_LAMBDA_HPP_INCLUDED
...
#   define STREAMS_BOOST_MPL_PREPROCESSED_HEADER full_lambda.hpp
...
#   define AUX778076_ARITY_PARAM(param) \
    STREAMS_BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(param) \
    /**/
...
#define STREAMS_BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, STREAMS_BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <streams_boost/mpl/aux_/full_lambda.hpp>))
...
struct lambda<
        ...
        , Tag
        AUX778076_ARITY_PARAM(int_<STREAMS_BOOST_PP_INC(STREAMS_BOOST_MPL_LIMIT_METAFUNCTION_ARITY)>)
        >
{
    typedef false_ is_le;
...
#elif !defined(STREAMS_BOOST_MPL_CFG_DMC_AMBIGUOUS_CTPS)
...
#if !defined(STREAMS_BOOST_MPL_CFG_EXTENDED_TEMPLATE_PARAMETERS_MATCHING)
STREAMS_BOOST_MPL_AUX_NA_SPEC(2, lambda)
#else
STREAMS_BOOST_MPL_AUX_NA_SPEC2(2, 3, lambda)
#endif

}}

#endif // STREAMS_BOOST_MPL_CFG_NO_PREPROCESSED_HEADERS
#endif // STREAMS_BOOST_MPL_AUX_FULL_LAMBDA_HPP_INCLUDED
...
#   define AUX778076_RESULT(unused, i_, T) \
    STREAMS_BOOST_PP_COMMA_IF(i_) \
    typename STREAMS_BOOST_PP_CAT(T, STREAMS_BOOST_PP_INC(i_))::result_ \
    /**/
...
template<
    ...
    >
struct STREAMS_BOOST_PP_CAT(le_result,i_)
{
    typedef F<
          STREAMS_BOOST_MPL_PP_REPEAT(i_, AUX778076_TYPE, L)
        > result_;
...
template<
    ...
    , AUX778076_LAMBDA_PARAMS(i_, typename L)
    >
struct STREAMS_BOOST_PP_CAT(le_result,i_)< true_,Tag,F,AUX778076_LAMBDA_PARAMS(i_, L) >
{
    typedef STREAMS_BOOST_PP_CAT(bind,i_)<
          STREAMS_BOOST_PP_CAT(quote,i_)<F,Tag>
        , STREAMS_BOOST_MPL_PP_REPEAT(i_, AUX778076_RESULT, L)
        > result_;
...
#   define AUX778076_LAMBDA_TYPEDEF(unused, i_, T) \
    typedef lambda< STREAMS_BOOST_PP_CAT(T, STREAMS_BOOST_PP_INC(i_)), Tag > \
...
#   define AUX778076_IS_LAMBDA_EXPR(unused, i_, unused2) \
    STREAMS_BOOST_PP_COMMA_IF(i_) \
    STREAMS_BOOST_PP_CAT(is_le,STREAMS_BOOST_PP_INC(i_))::value \
/**/
...
struct lambda< 
        ...
        >
{
    STREAMS_BOOST_MPL_PP_REPEAT(i_, AUX778076_LAMBDA_TYPEDEF, T)
    ...
    typedef aux::STREAMS_BOOST_PP_CAT(le_result,i_)<
...
struct lambda<
        ...
        , Tag
        AUX778076_ARITY_PARAM(int_<STREAMS_BOOST_PP_INC(i_)>)
        >
{
    typedef false_ is_le;
    typedef STREAMS_BOOST_PP_CAT(bind,i_)<
