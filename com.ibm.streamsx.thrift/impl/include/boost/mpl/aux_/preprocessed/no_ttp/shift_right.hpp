...
// Preprocessed version of "streams_boost/mpl/shift_right.hpp" header
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, shift_right, (N1, N2))

};

STREAMS_BOOST_MPL_AUX_NA_SPEC2(2, 2, shift_right)
...
{
    STREAMS_BOOST_STATIC_CONSTANT(T, value  = (n >> s));
