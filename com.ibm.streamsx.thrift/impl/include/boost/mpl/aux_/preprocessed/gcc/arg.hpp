...
// Preprocessed version of "streams_boost/mpl/arg.hpp" header
...
{
    STREAMS_BOOST_STATIC_CONSTANT(int, value  = 2);
    typedef arg<3> next;
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, tag)
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, type)
...
{
    STREAMS_BOOST_STATIC_CONSTANT(int, value  = 3);
    typedef arg<4> next;
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, tag)
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, type)
...
{
    STREAMS_BOOST_STATIC_CONSTANT(int, value  = 4);
    typedef arg<5> next;
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, tag)
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, type)
...
{
    STREAMS_BOOST_STATIC_CONSTANT(int, value  = 5);
    typedef arg<6> next;
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, tag)
    STREAMS_BOOST_MPL_AUX_ARG_TYPEDEF(na, type)
