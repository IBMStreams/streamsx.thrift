...
// Preprocessed version of "streams_boost/mpl/less_equal.hpp" header
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, less_equal, (N1, N2))

};

STREAMS_BOOST_MPL_AUX_NA_SPEC2(2, 2, less_equal)
