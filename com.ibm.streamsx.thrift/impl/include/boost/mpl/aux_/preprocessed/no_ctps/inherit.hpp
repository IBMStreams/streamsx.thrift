...
// Preprocessed version of "streams_boost/mpl/inherit.hpp" header
...
STREAMS_BOOST_MPL_AUX_NA_SPEC(3, inherit3)
...
STREAMS_BOOST_MPL_AUX_NA_SPEC(4, inherit4)
...
STREAMS_BOOST_MPL_AUX_NA_SPEC(5, inherit5)
...
STREAMS_BOOST_MPL_AUX_NA_SPEC_LAMBDA(5, inherit)
STREAMS_BOOST_MPL_AUX_NA_SPEC_ARITY(5, inherit)
STREAMS_BOOST_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(5, 5, inherit)
}}
