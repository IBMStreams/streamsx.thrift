...
// Preprocessed version of "streams_boost/mpl/not_equal_to.hpp" header
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, not_equal_to, (N1, N2))

};

STREAMS_BOOST_MPL_AUX_NA_SPEC2(2, 2, not_equal_to)
