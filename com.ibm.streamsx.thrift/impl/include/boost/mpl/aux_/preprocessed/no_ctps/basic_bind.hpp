...
// Preprocessed version of "streams_boost/mpl/aux_/basic_bind.hpp" header
...
STREAMS_BOOST_MPL_AUX_ARITY_SPEC(1, bind0)
STREAMS_BOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(1, bind0)
...
STREAMS_BOOST_MPL_AUX_ARITY_SPEC(2, bind1)
STREAMS_BOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(2, bind1)
...
STREAMS_BOOST_MPL_AUX_ARITY_SPEC(3, bind2)
STREAMS_BOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(3, bind2)
...
STREAMS_BOOST_MPL_AUX_ARITY_SPEC(4, bind3)
STREAMS_BOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(4, bind3)
...
STREAMS_BOOST_MPL_AUX_ARITY_SPEC(5, bind4)
STREAMS_BOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(5, bind4)
...
STREAMS_BOOST_MPL_AUX_ARITY_SPEC(6, bind5)
STREAMS_BOOST_MPL_AUX_TEMPLATE_ARITY_SPEC(6, bind5)
