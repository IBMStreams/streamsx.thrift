...
// Preprocessed version of "streams_boost/mpl/divides.hpp" header
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, divides2, (N1, N2))

};

STREAMS_BOOST_MPL_AUX_NA_SPEC2(2, 5, divides)
