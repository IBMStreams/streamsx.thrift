...
// Preprocessed version of "streams_boost/mpl/modulus.hpp" header
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, modulus, (N1, N2))

};

STREAMS_BOOST_MPL_AUX_NA_SPEC2(2, 2, modulus)
