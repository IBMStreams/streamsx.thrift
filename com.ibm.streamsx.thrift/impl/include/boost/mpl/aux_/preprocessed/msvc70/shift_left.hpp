...
// Preprocessed version of "streams_boost/mpl/shift_left.hpp" header
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2, shift_left, (N1, N2))

};

STREAMS_BOOST_MPL_AUX_NA_SPEC2(2, 2, shift_left)
