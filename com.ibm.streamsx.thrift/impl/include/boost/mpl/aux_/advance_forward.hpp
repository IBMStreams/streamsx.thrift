...
#ifndef STREAMS_BOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
#   define STREAMS_BOOST_MPL_PREPROCESSED_HEADER advance_forward.hpp
...
// forward declaration
template< STREAMS_BOOST_MPL_AUX_NTTP_DECL(long, N) > struct advance_forward;

#   define STREAMS_BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, STREAMS_BOOST_MPL_LIMIT_UNROLLING, <streams_boost/mpl/aux_/advance_forward.hpp>))
...
struct advance_forward
{
    template< typename Iterator > struct apply
    {
        typedef typename apply_wrap1<
              advance_forward<STREAMS_BOOST_MPL_LIMIT_UNROLLING>
            , Iterator
            >::type chunk_result_;
...
#endif // STREAMS_BOOST_MPL_AUX_ADVANCE_FORWARD_HPP_INCLUDED
...
template<>
struct advance_forward< STREAMS_BOOST_PP_FRAME_ITERATION(1) >
{
    template< typename Iterator > struct apply
    {
...
#   define STREAMS_BOOST_PP_ITERATION_PARAMS_2 \
    (3,(1, i_, <streams_boost/mpl/aux_/advance_forward.hpp>))
#   include STREAMS_BOOST_PP_ITERATE()
#endif
        typedef STREAMS_BOOST_PP_CAT(iter,i_) type;
    };
