...
#ifndef STREAMS_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
#define STREAMS_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
...
template< typename T > struct msvc_eti_base
    : T
{
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MPL_CFG_GCC, STREAMS_BOOST_TESTED_AT(0x0304))
    msvc_eti_base();
#endif
    typedef T type;
};
...
#endif // STREAMS_BOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
