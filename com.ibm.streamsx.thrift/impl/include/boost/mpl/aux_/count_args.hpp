...
#include <streams_boost/preprocessor/expr_if.hpp>
...
#   define AUX778076_COUNT_ARGS_REPEAT STREAMS_BOOST_MPL_PP_REPEAT
...
#   define AUX778076_COUNT_ARGS_REPEAT STREAMS_BOOST_PP_REPEAT
#   define AUX778076_COUNT_ARGS_PARAMS(param) \
    STREAMS_BOOST_PP_ENUM_SHIFTED_PARAMS( \
          STREAMS_BOOST_PP_INC(AUX778076_COUNT_ARGS_ARITY) \
        , param \
        ) \
    /**/
...
#define AUX778076_IS_ARG_TEMPLATE_NAME \
    STREAMS_BOOST_PP_CAT(is_,STREAMS_BOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_arg)) \
/**/

#define AUX778076_COUNT_ARGS_FUNC(unused, i, param) \
    STREAMS_BOOST_PP_EXPR_IF(i, +) \
    AUX778076_IS_ARG_TEMPLATE_NAME<STREAMS_BOOST_PP_CAT(param,STREAMS_BOOST_PP_INC(i))>::value \
/**/
...
template<
    ...
    >
struct STREAMS_BOOST_PP_CAT(AUX778076_COUNT_ARGS_PREFIX,_count_args)
{
    STREAMS_BOOST_STATIC_CONSTANT(int, value = AUX778076_COUNT_ARGS_REPEAT(
          AUX778076_COUNT_ARGS_ARITY
