...
#ifndef STREAMS_BOOST_MPL_BASE_HPP_INCLUDED
#define STREAMS_BOOST_MPL_BASE_HPP_INCLUDED
...
struct base
{
    ...
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,base,(T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(1, base)

}}

#endif // STREAMS_BOOST_MPL_BASE_HPP_INCLUDED
