...
#ifndef STREAMS_BOOST_MPL_NEGATE_HPP_INCLUDED
#define STREAMS_BOOST_MPL_NEGATE_HPP_INCLUDED
...
#endif
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1, negate, (N))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(1, negate)
...
{
    STREAMS_BOOST_STATIC_CONSTANT(T, value = -n);
...
#endif // STREAMS_BOOST_MPL_NEGATE_HPP_INCLUDED
