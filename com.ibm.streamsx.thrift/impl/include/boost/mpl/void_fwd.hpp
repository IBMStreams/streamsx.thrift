...
#ifndef STREAMS_BOOST_MPL_VOID_FWD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_VOID_FWD_HPP_INCLUDED
...
STREAMS_BOOST_MPL_AUX_ADL_BARRIER_DECL(void_)

#endif // STREAMS_BOOST_MPL_VOID_FWD_HPP_INCLUDED
