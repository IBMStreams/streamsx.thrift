...
#ifndef STREAMS_BOOST_MPL_JOINT_VIEW_HPP_INCLUDED
#define STREAMS_BOOST_MPL_JOINT_VIEW_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/joint_iter.hpp>
...
template<
      typename STREAMS_BOOST_MPL_AUX_NA_PARAM(Sequence1_)
    , typename STREAMS_BOOST_MPL_AUX_NA_PARAM(Sequence2_)
    >
struct joint_view
{
...
STREAMS_BOOST_MPL_AUX_NA_SPEC(2, joint_view)

}}

#endif // STREAMS_BOOST_MPL_JOINT_VIEW_HPP_INCLUDED
