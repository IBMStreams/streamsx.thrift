...
#ifndef STREAMS_BOOST_MPL_ERASE_KEY_HPP_INCLUDED
#define STREAMS_BOOST_MPL_ERASE_KEY_HPP_INCLUDED
...
#include <streams_boost/mpl/erase_key_fwd.hpp>
#include <streams_boost/mpl/sequence_tag.hpp>
#include <streams_boost/mpl/aux_/erase_key_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,erase_key,(Sequence,Key))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(2,erase_key)

}}

#endif // STREAMS_BOOST_MPL_ERASE_KEY_HPP_INCLUDED
