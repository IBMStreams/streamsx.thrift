...
#ifndef STREAMS_BOOST_MPL_CLEAR_HPP_INCLUDED
#define STREAMS_BOOST_MPL_CLEAR_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/clear_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,clear,(Sequence))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(1, clear)

}}

#endif // STREAMS_BOOST_MPL_CLEAR_HPP_INCLUDED
