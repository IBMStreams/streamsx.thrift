...
#ifndef STREAMS_BOOST_MPL_ERASE_HPP_INCLUDED
#define STREAMS_BOOST_MPL_ERASE_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/erase_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,erase,(Sequence,First,Last))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(3,erase)

}}

#endif // STREAMS_BOOST_MPL_ERASE_HPP_INCLUDED
