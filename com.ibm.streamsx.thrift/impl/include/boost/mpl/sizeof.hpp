...
#ifndef STREAMS_BOOST_MPL_SIZEOF_HPP_INCLUDED
#define STREAMS_BOOST_MPL_SIZEOF_HPP_INCLUDED
...
struct sizeof_
    : mpl::size_t< sizeof(T) >
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,sizeof_,(T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC_NO_ETI(1, sizeof_)

}}

#endif // STREAMS_BOOST_MPL_SIZEOF_HPP_INCLUDED
