...
#ifndef STREAMS_BOOST_MPL_KEY_TYPE_HPP_INCLUDED
#define STREAMS_BOOST_MPL_KEY_TYPE_HPP_INCLUDED
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,key_type,(AssociativeSequence,T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(2, key_type)

}}

#endif // STREAMS_BOOST_MPL_KEY_TYPE_HPP_INCLUDED
