...
#ifndef STREAMS_BOOST_MPL_INDEX_OF_HPP_INCLUDED
#define STREAMS_BOOST_MPL_INDEX_OF_HPP_INCLUDED
...
#include <streams_boost/mpl/index_if.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,index_of,(Sequence,T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(2, index_of)

}}

#endif // STREAMS_BOOST_MPL_INDEX_OF_HPP_INCLUDED
