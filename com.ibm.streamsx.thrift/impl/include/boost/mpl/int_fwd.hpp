...
#ifndef STREAMS_BOOST_MPL_INT_FWD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_INT_FWD_HPP_INCLUDED
...
template< STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, N) > struct int_;

STREAMS_BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
STREAMS_BOOST_MPL_AUX_ADL_BARRIER_DECL(int_)

#endif // STREAMS_BOOST_MPL_INT_FWD_HPP_INCLUDED
