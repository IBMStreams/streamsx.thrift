...
#   define AUX778076_HEADER \
    aux_/preprocessed/plain/STREAMS_BOOST_MPL_PREPROCESSED_HEADER \
/**/

#if STREAMS_BOOST_WORKAROUND(__IBMCPP__, STREAMS_BOOST_TESTED_AT(700))
#   define AUX778076_INCLUDE_STRING STREAMS_BOOST_PP_STRINGIZE(streams_boost/mpl/list/AUX778076_HEADER)
#   include AUX778076_INCLUDE_STRING
#   undef AUX778076_INCLUDE_STRING
#else
#   include STREAMS_BOOST_PP_STRINGIZE(streams_boost/mpl/list/AUX778076_HEADER)
#endif
