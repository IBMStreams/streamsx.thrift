...
#ifndef STREAMS_BOOST_MPL_BACK_HPP_INCLUDED
#define STREAMS_BOOST_MPL_BACK_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/back_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,back,(Sequence))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(1, back)

}}

#endif // STREAMS_BOOST_MPL_BACK_HPP_INCLUDED
