...
#ifndef STREAMS_BOOST_MPL_ITER_FOLD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_ITER_FOLD_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/iter_fold_impl.hpp>
...
struct iter_fold
{
    ...
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,iter_fold,(Sequence,State,ForwardOp))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(3, iter_fold)

}}

#endif // STREAMS_BOOST_MPL_ITER_FOLD_HPP_INCLUDED
