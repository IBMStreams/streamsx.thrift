...
#ifndef STREAMS_BOOST_MPL_IF_HPP_INCLUDED
#define STREAMS_BOOST_MPL_IF_HPP_INCLUDED
...
// (and possibly MWCW < 8.0); see http://article.gmane.org/gmane.comp.lib.streams_boost.devel/108959
template<
      typename STREAMS_BOOST_MPL_AUX_NA_PARAM(T1)
    , typename STREAMS_BOOST_MPL_AUX_NA_PARAM(T2)
    , typename STREAMS_BOOST_MPL_AUX_NA_PARAM(T3)
    >
struct if_
{
 private:
    ...
    typedef if_c<
          ...
          STREAMS_BOOST_MPL_AUX_VALUE_WKND(T1)::value
#else
          STREAMS_BOOST_MPL_AUX_STATIC_CAST(bool, STREAMS_BOOST_MPL_AUX_VALUE_WKND(T1)::value)
#endif
        , T2
        , T3
        > almost_type_;
 ...
 public:
    ...
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(T1,T2,T3))
};
...
template<
      typename STREAMS_BOOST_MPL_AUX_NA_PARAM(C_)
    , typename STREAMS_BOOST_MPL_AUX_NA_PARAM(T1)
    , typename STREAMS_BOOST_MPL_AUX_NA_PARAM(T2)
    >
struct if_
{
    enum { msvc_wknd_ = STREAMS_BOOST_MPL_AUX_MSVC_VALUE_WKND(C_)::value };

    typedef typename aux::if_impl< STREAMS_BOOST_MPL_AUX_STATIC_CAST(bool, msvc_wknd_) >
        ::template result_<T1,T2>::type type;

    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(3,if_,(C_,T1,T2))
};

#endif // STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION

STREAMS_BOOST_MPL_AUX_NA_SPEC(3, if_)

}}

#endif // STREAMS_BOOST_MPL_IF_HPP_INCLUDED
