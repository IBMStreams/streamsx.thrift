...
#ifndef STREAMS_BOOST_MPL_CHAR_FWD_HPP_INCLUDED
#define STREAMS_BOOST_MPL_CHAR_FWD_HPP_INCLUDED
...
template< STREAMS_BOOST_MPL_AUX_NTTP_DECL(char, N) > struct char_;

STREAMS_BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
STREAMS_BOOST_MPL_AUX_ADL_BARRIER_DECL(char_)

#endif // STREAMS_BOOST_MPL_CHAR_FWD_HPP_INCLUDED
