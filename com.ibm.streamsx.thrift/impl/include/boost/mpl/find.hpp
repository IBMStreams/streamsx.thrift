...
#ifndef STREAMS_BOOST_MPL_FIND_HPP_INCLUDED
#define STREAMS_BOOST_MPL_FIND_HPP_INCLUDED
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,find,(Sequence,T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(2, find)

}}

#endif // STREAMS_BOOST_MPL_FIND_HPP_INCLUDED
