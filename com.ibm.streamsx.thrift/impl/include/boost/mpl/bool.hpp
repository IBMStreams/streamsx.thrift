...
#ifndef STREAMS_BOOST_MPL_BOOL_HPP_INCLUDED
#define STREAMS_BOOST_MPL_BOOL_HPP_INCLUDED
...
{
    STREAMS_BOOST_STATIC_CONSTANT(bool, value = C_);
...
#endif // STREAMS_BOOST_MPL_BOOL_HPP_INCLUDED
