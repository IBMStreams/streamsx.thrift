...
#ifndef STREAMS_BOOST_MPL_PROTECT_HPP_INCLUDED
#define STREAMS_BOOST_MPL_PROTECT_HPP_INCLUDED
...
namespace aux { 
template< STREAMS_BOOST_MPL_AUX_NTTP_DECL(int, N), typename T >
...
STREAMS_BOOST_MPL_AUX_NA_SPEC_MAIN(1, protect)
#if !defined(STREAMS_BOOST_MPL_CFG_NO_FULL_LAMBDA_SUPPORT)
STREAMS_BOOST_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(1, 1, protect)
#endif

}}

#endif // STREAMS_BOOST_MPL_PROTECT_HPP_INCLUDED
