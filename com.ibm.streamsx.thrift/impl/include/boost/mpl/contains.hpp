...
#ifndef STREAMS_BOOST_MPL_CONTAINS_HPP_INCLUDED
#define STREAMS_BOOST_MPL_CONTAINS_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/contains_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,contains,(Sequence,T))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(2, contains)

}}

#endif // STREAMS_BOOST_MPL_CONTAINS_HPP_INCLUDED
