...
#ifndef STREAMS_BOOST_MPL_EMPTY_HPP_INCLUDED
#define STREAMS_BOOST_MPL_EMPTY_HPP_INCLUDED
...
#include <streams_boost/mpl/aux_/empty_impl.hpp>
...
{
    STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(1,empty,(Sequence))
};

STREAMS_BOOST_MPL_AUX_NA_SPEC(1, empty)

}}

#endif // STREAMS_BOOST_MPL_EMPTY_HPP_INCLUDED
