...
#ifndef CLASS_METADATA_DWA2004719_STREAMS_HPP
# define CLASS_METADATA_DWA2004719_STREAMS_HPP
# include <streams_boost/python/converter/shared_ptr_from_python.hpp>

# include <streams_boost/python/object/inheritance.hpp>
# include <streams_boost/python/object/class_wrapper.hpp>
# include <streams_boost/python/object/make_instance.hpp>
# include <streams_boost/python/object/value_holder.hpp>
# include <streams_boost/python/object/pointer_holder.hpp>
# include <streams_boost/python/object/make_ptr_instance.hpp>

# include <streams_boost/python/detail/force_instantiate.hpp>
# include <streams_boost/python/detail/not_specified.hpp>

# include <streams_boost/python/has_back_reference.hpp>
# include <streams_boost/python/bases.hpp>
...
# if !STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, == 1200)
        STREAMS_BOOST_MPL_ASSERT_NOT((is_same<Base,Derived>));
# else
        STREAMS_BOOST_STATIC_ASSERT(!(is_same<Base,Derived>::value));
# endif 
...
#ifndef STREAMS_BOOST_PYTHON_NO_PY_SYGNATURES
...
#endif // CLASS_METADATA_DWA2004719_STREAMS_HPP
