...
#ifndef CLASS_WRAPPER_DWA20011221_STREAMS_HPP
# define CLASS_WRAPPER_DWA20011221_STREAMS_HPP
    ...
    : to_python_converter<Src,class_cref_wrapper<Src,MakeInstance> ,true>
{
    ...
    {
        return MakeInstance::execute(streams_boost::ref(x));
    }
#ifndef STREAMS_BOOST_PYTHON_NO_PY_SIGNATURES
...
#endif // CLASS_WRAPPER_DWA20011221_STREAMS_HPP
