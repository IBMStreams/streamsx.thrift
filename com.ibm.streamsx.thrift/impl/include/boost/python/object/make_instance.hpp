...
#ifndef MAKE_INSTANCE_DWA200296_STREAMS_HPP
# define MAKE_INSTANCE_DWA200296_STREAMS_HPP
...
# include <streams_boost/python/detail/decref_guard.hpp>
...
struct make_instance_impl
{
    ...
    {
        STREAMS_BOOST_STATIC_ASSERT(is_class<T>::value);
...
#endif // MAKE_INSTANCE_DWA200296_STREAMS_HPP
