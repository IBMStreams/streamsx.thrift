...
#ifndef INHERITANCE_DWA200216_STREAMS_HPP
# define INHERITANCE_DWA200216_STREAMS_HPP
...
STREAMS_BOOST_PYTHON_DECL void register_dynamic_id_aux(
    class_id static_id, dynamic_id_function get_dynamic_id);

STREAMS_BOOST_PYTHON_DECL void add_cast(
...
struct dynamic_id_generator
  : mpl::if_<
        streams_boost::is_polymorphic<T>
        , streams_boost::python::objects::polymorphic_id_generator<T>
        , streams_boost::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
inline void register_conversion(
    bool is_downcast = ::streams_boost::is_base_and_derived<Source,Target>::value
...
#endif // INHERITANCE_DWA200216_STREAMS_HPP
