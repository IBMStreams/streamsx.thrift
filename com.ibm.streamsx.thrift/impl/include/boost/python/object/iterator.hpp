...
#ifndef ITERATOR_DWA2002510_STREAMS_HPP
# define ITERATOR_DWA2002510_STREAMS_HPP

# include <streams_boost/python/detail/prefix.hpp>

# include <streams_boost/python/class.hpp>
# include <streams_boost/python/return_value_policy.hpp>
# include <streams_boost/python/return_by_value.hpp>
# include <streams_boost/python/handle.hpp>
# include <streams_boost/python/make_function.hpp>

# include <streams_boost/python/object/iterator_core.hpp>
# include <streams_boost/python/object/class_detail.hpp>
# include <streams_boost/python/object/function_object.hpp>
...
struct iterator_range
{
    ...
    typedef streams_boost::detail::iterator_traits<Iterator> traits_t;
...
# ifdef STREAMS_BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
    ...
    typedef mpl::if_<
        is_same<
            streams_boost::detail::please_invoke_STREAMS_BOOST_TT_BROKEN_COMPILER_SPEC_on_cv_unqualified_pointee<Iterator>
          , typename traits_t::value_type
        >
      , next_ptr
      , next
...
#endif // ITERATOR_DWA2002510_STREAMS_HPP
