...
#include <streams_boost/python/list.hpp>
...
namespace detail
{
  struct STREAMS_BOOST_PYTHON_DECL dict_base : object
  {
   ...
   protected:
      ...
      STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(dict_base, object)
   private:
...
class dict : public detail::dict_base
{
 ...
 public: // implementation detail -- for internal use only
    STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(dict, base)
};
