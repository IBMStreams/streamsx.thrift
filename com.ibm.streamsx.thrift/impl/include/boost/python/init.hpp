...
#include <streams_boost/python/detail/make_keyword_range_fn.hpp>
...
///////////////////////////////////////////////////////////////////////////////
#define STREAMS_BOOST_PYTHON_OVERLOAD_TYPES_WITH_DEFAULT                                \
    STREAMS_BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(                                        \
        STREAMS_BOOST_PYTHON_MAX_ARITY,                                                 \
        class T,                                                                \
        mpl::void_)                                                             \

#define STREAMS_BOOST_PYTHON_OVERLOAD_TYPES                                             \
    STREAMS_BOOST_PP_ENUM_PARAMS_Z(1,                                                   \
        STREAMS_BOOST_PYTHON_MAX_ARITY,                                                 \
        class T)                                                                \

#define STREAMS_BOOST_PYTHON_OVERLOAD_ARGS                                              \
    STREAMS_BOOST_PP_ENUM_PARAMS_Z(1,                                                   \
        STREAMS_BOOST_PYTHON_MAX_ARITY,                                                 \
        T)                                                                      \
...
template <STREAMS_BOOST_PYTHON_OVERLOAD_TYPES_WITH_DEFAULT>
...
namespace detail
{
  ...
  //
    ...
    private:
        ...
        template <STREAMS_BOOST_PYTHON_OVERLOAD_TYPES>
        static streams_boost::type_traits::yes_type f(optional<STREAMS_BOOST_PYTHON_OVERLOAD_ARGS>);
        static streams_boost::type_traits::no_type f(...);
        static T t();
    ...
    public:
        ...
        STREAMS_BOOST_STATIC_CONSTANT(
            bool, value =
                sizeof(f(t())) == sizeof(::streams_boost::type_traits::yes_type));
    ...
    template <STREAMS_BOOST_PYTHON_OVERLOAD_TYPES>
    struct is_optional<optional<STREAMS_BOOST_PYTHON_OVERLOAD_ARGS> >
      : mpl::true_
    {};
...
template <STREAMS_BOOST_PYTHON_OVERLOAD_TYPES>
class init : public init_base<init<STREAMS_BOOST_PYTHON_OVERLOAD_ARGS> >
{
    typedef init_base<init<STREAMS_BOOST_PYTHON_OVERLOAD_ARGS> > base;
 public:
    typedef init<STREAMS_BOOST_PYTHON_OVERLOAD_ARGS> self_t;
    ...
    typedef detail::type_list<STREAMS_BOOST_PYTHON_OVERLOAD_ARGS> signature_;
...
template <STREAMS_BOOST_PYTHON_OVERLOAD_TYPES>
struct optional
    : detail::type_list<STREAMS_BOOST_PYTHON_OVERLOAD_ARGS>
{
};
...
#undef STREAMS_BOOST_PYTHON_OVERLOAD_TYPES_WITH_DEFAULT
#undef STREAMS_BOOST_PYTHON_OVERLOAD_TYPES
#undef STREAMS_BOOST_PYTHON_OVERLOAD_ARGS
#undef STREAMS_BOOST_PYTHON_IS_OPTIONAL_VALUE
#undef STREAMS_BOOST_PYTHON_APPEND_TO_INIT
