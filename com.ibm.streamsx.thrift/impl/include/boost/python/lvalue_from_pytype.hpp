...
#ifndef LVALUE_FROM_PYTYPE_DWA2002130_STREAMS_HPP
# define LVALUE_FROM_PYTYPE_DWA2002130_STREAMS_HPP
...
namespace detail
{
  ...
  struct normalized_extractor
  {
      ...
      {
          typedef typename streams_boost::add_reference<U>::type param;
          return &Extractor::execute(
              streams_boost::python::detail::void_ptr_to_reference(
                  op, (param(*)())0 )
              );
      }
  };
...
#endif // LVALUE_FROM_PYTYPE_DWA2002130_STREAMS_HPP
