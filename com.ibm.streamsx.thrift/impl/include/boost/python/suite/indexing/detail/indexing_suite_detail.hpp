...
#if defined(NDEBUG)
#define STREAMS_BOOST_PYTHON_INDEXING_CHECK_INVARIANT
#else
#define STREAMS_BOOST_PYTHON_INDEXING_CHECK_INVARIANT check_invariant()
#endif
    ...
    public:
        ...
        first_proxy(index_type i)
        {
            ...
            return streams_boost::detail::lower_bound(
        ...
        remove(Proxy& proxy)
        {
            ...
            STREAMS_BOOST_PYTHON_INDEXING_CHECK_INVARIANT;
        }
    ...
    {                
        ...
        { 
            return base_get_item_helper(
              ...
              , is_pointer<STREAMS_BOOST_DEDUCED_TYPENAME Container::value_type>()
            );
        }
            ...
            Container& container, PySliceObject* slice, Index& from_, Index& to_)
        {
            ...
            if (Py_None == slice->start) {
                ...
                if (from < 0) // Clip lower bounds to zero
                    from = 0;
                from_ = streams_boost::numeric_cast<Index>(from);
            ...
            if (Py_None == slice->stop) {
                ...
                if (to < 0)
                    to = 0;
                to_ = streams_boost::numeric_cast<Index>(to);
                if (to_ > max_index)
                    to_ = max_index;
            }
        }        
    ...
    using streams_boost::python::get_pointer;
