...
#ifndef LONG_DWA2002627_STREAMS_HPP
# define LONG_DWA2002627_STREAMS_HPP
...
namespace detail
{
  struct STREAMS_BOOST_PYTHON_DECL long_base : object
  {
   protected:
      long_base(); // new long_
      ...
      STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(long_base, object)
...
class long_ : public detail::long_base
{
 ...
 public: // implementation detail -- for internal use only
    STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(long_, base)
};
...
#endif // LONG_DWA2002627_STREAMS_HPP
