...
#ifndef PROXY_DWA2002615_STREAMS_HPP
# define PROXY_DWA2002615_STREAMS_HPP
...
# define STREAMS_BOOST_PYTHON_PROXY_INPLACE(op)                                         \
...
STREAMS_BOOST_PYTHON_PROXY_INPLACE(+=)
STREAMS_BOOST_PYTHON_PROXY_INPLACE(-=)
STREAMS_BOOST_PYTHON_PROXY_INPLACE(*=)
STREAMS_BOOST_PYTHON_PROXY_INPLACE(/=)
STREAMS_BOOST_PYTHON_PROXY_INPLACE(%=)
...
STREAMS_BOOST_PYTHON_PROXY_INPLACE(^=)
STREAMS_BOOST_PYTHON_PROXY_INPLACE(|=)
# undef STREAMS_BOOST_PYTHON_PROXY_INPLACE
...
#endif // PROXY_DWA2002615_STREAMS_HPP
