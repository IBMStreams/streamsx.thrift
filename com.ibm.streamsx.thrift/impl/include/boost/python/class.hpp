...
#ifndef CLASS_DWA200216_STREAMS_HPP
# define CLASS_DWA200216_STREAMS_HPP

# include <streams_boost/python/detail/prefix.hpp>

# include <streams_boost/noncopyable.hpp>

# include <streams_boost/python/class_fwd.hpp>
# include <streams_boost/python/object/class.hpp>

# include <streams_boost/python/object.hpp>
# include <streams_boost/python/type_id.hpp>
# include <streams_boost/python/data_members.hpp>
# include <streams_boost/python/make_function.hpp>
# include <streams_boost/python/signature.hpp>
# include <streams_boost/python/init.hpp>
# include <streams_boost/python/args_fwd.hpp>

# include <streams_boost/python/object/class_metadata.hpp>
# include <streams_boost/python/object/pickle_support.hpp>
# include <streams_boost/python/object/add_to_namespace.hpp>

# include <streams_boost/python/detail/overloads_fwd.hpp>
# include <streams_boost/python/detail/operator_id.hpp>
# include <streams_boost/python/detail/def_helper.hpp>
# include <streams_boost/python/detail/force_instantiate.hpp>
# include <streams_boost/python/detail/unwrap_type_id.hpp>
...
# include <streams_boost/mpl/for_each.hpp>
# include <streams_boost/mpl/bool.hpp>
# include <streams_boost/mpl/not.hpp>

# include <streams_boost/detail/workaround.hpp>

# if STREAMS_BOOST_WORKAROUND(__MWERKS__, <= 0x3004)                        \
    /* pro9 reintroduced the bug */                                 \
    || (STREAMS_BOOST_WORKAROUND(__MWERKS__, > 0x3100)                      \
        && STREAMS_BOOST_WORKAROUND(__MWERKS__, STREAMS_BOOST_TESTED_AT(0x3201)))   \
    || STREAMS_BOOST_WORKAROUND(__GNUC__, < 3)

#  define STREAMS_BOOST_PYTHON_NO_MEMBER_POINTER_ORDERING 1

# endif

# ifdef STREAMS_BOOST_PYTHON_NO_MEMBER_POINTER_ORDERING
...
# ifdef STREAMS_BOOST_PYTHON_NO_MEMBER_POINTER_ORDERING
#  define STREAMS_BOOST_PYTHON_DATA_MEMBER_HELPER(D) , detail::is_data_member_pointer<D>()
#  define STREAMS_BOOST_PYTHON_YES_DATA_MEMBER , mpl::true_
#  define STREAMS_BOOST_PYTHON_NO_DATA_MEMBER , mpl::false_
# elif defined(STREAMS_BOOST_NO_FUNCTION_TEMPLATE_ORDERING)
#  define STREAMS_BOOST_PYTHON_DATA_MEMBER_HELPER(D) , 0
#  define STREAMS_BOOST_PYTHON_YES_DATA_MEMBER , int
#  define STREAMS_BOOST_PYTHON_NO_DATA_MEMBER , ...
# else 
#  define STREAMS_BOOST_PYTHON_DATA_MEMBER_HELPER(D)
#  define STREAMS_BOOST_PYTHON_YES_DATA_MEMBER
#  define STREAMS_BOOST_PYTHON_NO_DATA_MEMBER
# endif
...
# if !STREAMS_BOOST_WORKAROUND(__MWERKS__, <= 0x2407)
...
class class_ : public objects::class_base
{
 ...
 public: // member functions
    ...
    {
        return this->def_readonly_impl(name, d, doc STREAMS_BOOST_PYTHON_DATA_MEMBER_HELPER(D));
    }

    template <class D>
    self& def_readwrite(char const* name, D const& d, char const* doc=0)
    {
        return this->def_readwrite_impl(name, d, doc STREAMS_BOOST_PYTHON_DATA_MEMBER_HELPER(D));
    }
...
# endif
 ...
 private: // helper functions
    ...
    self& def_readonly_impl(
        char const* name, D B::*pm_, char const* doc STREAMS_BOOST_PYTHON_YES_DATA_MEMBER)
    {
    ...
    template <class D>
    self& def_readonly_impl(
        char const* name, D& d, char const* STREAMS_BOOST_PYTHON_NO_DATA_MEMBER)
    {
    ...
    // STREAMS_BOOST_PYTHON_FUNCTION_OVERLOADS(). The final argument is used to
    // discriminate.
    //
...
# undef STREAMS_BOOST_PYTHON_DATA_MEMBER_HELPER
# undef STREAMS_BOOST_PYTHON_YES_DATA_MEMBER
# undef STREAMS_BOOST_PYTHON_NO_DATA_MEMBER
# undef STREAMS_BOOST_PYTHON_NO_MEMBER_POINTER_ORDERING

#endif // CLASS_DWA200216_STREAMS_HPP
