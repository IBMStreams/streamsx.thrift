...
#ifndef TO_PYTHON_INDIRECT_DWA200221_STREAMS_HPP
# define TO_PYTHON_INDIRECT_DWA200221_STREAMS_HPP
...
namespace detail
{
  struct make_owning_holder
  {
      ...
      static PyObject* execute(T* p)
      {
          ...
          // copy constructor.
# if defined(__ICL) && __ICL < 600 
          typedef streams_boost::shared_ptr<T> smart_pointer;
# else 
...
#endif // TO_PYTHON_INDIRECT_DWA200221_STREAMS_HPP
