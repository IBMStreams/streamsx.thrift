...
#ifndef RETURN_ARG_DWA2003719_STREAMS_HPP
# define RETURN_ARG_DWA2003719_STREAMS_HPP
...
{
 private:
    STREAMS_BOOST_STATIC_CONSTANT(bool, legal = arg_pos > 0);
 ...
 public:
    ...
    static PyObject* postcall(ArgumentPackage const& args, PyObject* result)
    {
        ...
        STREAMS_BOOST_STATIC_ASSERT(arg_pos > 0);
...
#endif // RETURN_ARG_DWA2003719_STREAMS_HPP
