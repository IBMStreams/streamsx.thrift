...
#ifndef CAST_DWA200269_STREAMS_HPP
# define CAST_DWA200269_STREAMS_HPP
...
namespace detail
{
  ...
  template <class Target, class Source>
  inline Target* downcast(Source* p, no_convertible, streams_boost::type<Target>* = 0)
  {
      typedef typename base_type_traits<Source>::type base;
  ...
  template <class T>
  inline void assert_castable(streams_boost::type<T>* = 0)
  {
...
#endif // CAST_DWA200269_STREAMS_HPP
