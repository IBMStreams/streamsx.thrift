...
#ifndef LIST_DWA2002627_STREAMS_HPP
# define LIST_DWA2002627_STREAMS_HPP
...
namespace detail
{
  struct STREAMS_BOOST_PYTHON_DECL list_base : object
  {
   ...
   protected:
      ...
      STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(list_base, object)
   private:    
...
class list : public detail::list_base
{
 ...
 public: // implementation detail -- for internal use only
    STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(list, base)
};
...
#endif // LIST_DWA2002627_STREAMS_HPP
