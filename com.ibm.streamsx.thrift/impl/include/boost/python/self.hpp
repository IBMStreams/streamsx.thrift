...
#ifndef SELF_DWA2002531_STREAMS_HPP
# define SELF_DWA2002531_STREAMS_HPP

# include <streams_boost/python/detail/prefix.hpp>

namespace streams_boost { namespace python {

#define STREAMS_BOOST_PYTHON_SELF_IS_CLASS
...
namespace self_ns
{
# ifndef STREAMS_BOOST_PYTHON_SELF_IS_CLASS
  enum self_t { self };
# else 
  struct self_t {};
  extern STREAMS_BOOST_PYTHON_DECL self_t self;
# endif
}
...
#endif // SELF_DWA2002531_STREAMS_HPP
