...
namespace detail
{
  struct STREAMS_BOOST_PYTHON_DECL str_base : object
  {
   ...
   protected:
      ...
      STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(str_base, object)
   private:
...
class str : public detail::str_base
{
 ...
 public: // implementation detail -- for internal use only
    STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(str, base)
};
