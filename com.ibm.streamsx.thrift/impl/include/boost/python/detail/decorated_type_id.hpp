...
#ifndef DECORATED_TYPE_ID_DWA2002517_STREAMS_HPP
# define DECORATED_TYPE_ID_DWA2002517_STREAMS_HPP
...
struct decorated_type_info : totally_ordered<decorated_type_info>
{
    ...
    friend STREAMS_BOOST_PYTHON_DECL std::ostream& operator<<(std::ostream&, decorated_type_info const&);
...
template <class T>
inline decorated_type_info decorated_type_id(streams_boost::type<T>* = 0)
{
...
STREAMS_BOOST_PYTHON_DECL std::ostream& operator<<(std::ostream&, decorated_type_info const&);

}}} // namespace streams_boost::python::detail

#endif // DECORATED_TYPE_ID_DWA2002517_STREAMS_HPP
