...
#ifndef IF_ELSE_DWA2002322_STREAMS_HPP
# define IF_ELSE_DWA2002322_STREAMS_HPP
...
#endif // # if defined(STREAMS_BOOST_MSVC) && (STREAMS_BOOST_MSVC == 1300)

template <class T>
struct elif_selected
{
# if !(defined(STREAMS_BOOST_MSVC) && STREAMS_BOOST_MSVC <= 1300 || defined(__MWERKS__) && __MWERKS__ <= 0x2407)
...
#endif // IF_ELSE_DWA2002322_STREAMS_HPP
