...
#ifndef MSVC_TYPEINFO_DWA200222_STREAMS_HPP
# define MSVC_TYPEINFO_DWA200222_STREAMS_HPP
...
# if defined(STREAMS_BOOST_MSVC) && STREAMS_BOOST_MSVC <= 1300 || defined(STREAMS_BOOST_INTEL_CXX_VERSION) && STREAMS_BOOST_INTEL_CXX_VERSION <= 700
...
inline char STREAMS_BOOST_TT_DECL is_ref_tester1(...) { return 0; }

template <class T>
inline typeinfo msvc_typeid(streams_boost::type<T>*)
{
    return detail::typeid_ref(
        (streams_boost::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(streams_boost::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((streams_boost::type<char const[3]>*)0)
        , msvc_typeid((streams_boost::type<char[3]>*)0);
}
#  endif
...
#endif // MSVC_TYPEINFO_DWA200222_STREAMS_HPP
