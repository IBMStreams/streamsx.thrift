...
#ifndef UNWIND_TYPE_DWA200222_STREAMS_HPP
# define UNWIND_TYPE_DWA200222_STREAMS_HPP

# include <streams_boost/python/detail/cv_category.hpp>
...
template <class Generator, class U>
inline typename Generator::result_type
unwind_type(streams_boost::type<U>*p = 0, Generator* = 0);
#endif
...
inline typename Generator::result_type
#ifndef _MSC_VER
unwind_type(streams_boost::type<U>*, Generator*)
#else
unwind_type(streams_boost::type<U>*p =0, Generator* =0)
#endif
{
    STREAMS_BOOST_STATIC_CONSTANT(int, indirection
        = (streams_boost::is_pointer<U>::value ? pointer_ : 0)
                             + (indirect_traits::is_reference_to_pointer<U>::value
                             ? reference_to_pointer_
                             : streams_boost::is_reference<U>::value
                             ? reference_
                             : 0));
...
#endif // UNWIND_TYPE_DWA200222_STREAMS_HPP
