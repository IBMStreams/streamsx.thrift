...
#ifndef MAKE_KEYWORD_RANGE_FN_DWA2002927_STREAMS_HPP
# define MAKE_KEYWORD_RANGE_FN_DWA2002927_STREAMS_HPP
    ...
    , ArgList* = 0, Arity* = 0)
{
    ...
    python_class<STREAMS_BOOST_DEDUCED_TYPENAME Holder::value_type>::register_();
#endif
...
#endif // MAKE_KEYWORD_RANGE_FN_DWA2002927_STREAMS_HPP
