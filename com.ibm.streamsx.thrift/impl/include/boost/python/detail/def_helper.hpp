...
#ifndef DEF_HELPER_DWA200287_STREAMS_HPP
# define DEF_HELPER_DWA200287_STREAMS_HPP
...
namespace detail
{
  ...
  struct tuple_extract_base_select
  {
      ...
      STREAMS_BOOST_STATIC_CONSTANT(bool, match = match_t::value);
  ...
  struct def_helper
  {
      ...
      // types.
      typedef streams_boost::tuples::tuple<
          T1 const&
          , T2 const&
          , T3 const&
          , T4 const&
...
#endif // DEF_HELPER_DWA200287_STREAMS_HPP
