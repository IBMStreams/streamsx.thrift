...
#ifndef DATA_MEMBERS_DWA2002328_STREAMS_HPP
# define DATA_MEMBERS_DWA2002328_STREAMS_HPP
...
# include <streams_boost/python/return_internal_reference.hpp>
...
namespace detail
{
  ...
  // streams_boost::python::make_getter are used to dispatch behavior.  The
  ...
  // streams_boost::python::make_setter are used to dispatch behavior.  The
...
#  if !STREAMS_BOOST_WORKAROUND(__EDG_VERSION__, <= 238) && !STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1300)
template <class D>
...
# if !(STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1300) || STREAMS_BOOST_WORKAROUND(__EDG_VERSION__, <= 238))
template <class D>
...
#endif // DATA_MEMBERS_DWA2002328_STREAMS_HPP
