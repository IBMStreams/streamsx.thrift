...
#ifndef OBJECT_OPERATORS_DWA2002617_STREAMS_HPP
# define OBJECT_OPERATORS_DWA2002617_STREAMS_HPP
...
struct enable_binary
  : streams_boost::iterators::enable_if<is_object_operators<L,R>, T>
{};
#  define STREAMS_BOOST_PYTHON_BINARY_RETURN(T) typename enable_binary<L,R,T>::type
# else
#  define STREAMS_BOOST_PYTHON_BINARY_RETURN(T) T
# endif
...
# define STREAMS_BOOST_PYTHON_COMPARE_OP(op, opid)                              \
template <class L, class R>                                             \
STREAMS_BOOST_PYTHON_BINARY_RETURN(object) operator op(L const& l, R const& r)    \
{                                                                       \
    return PyObject_RichCompare(                                    \
        object(l).ptr(), object(r).ptr(), opid);                        \
}
# undef STREAMS_BOOST_PYTHON_COMPARE_OP
    
# define STREAMS_BOOST_PYTHON_BINARY_OPERATOR(op)                               \
STREAMS_BOOST_PYTHON_DECL object operator op(object const& l, object const& r); \
template <class L, class R>                                             \
STREAMS_BOOST_PYTHON_BINARY_RETURN(object) operator op(L const& l, R const& r)  \
{                                                                       \
    return object(l) op object(r);                                      \
}
STREAMS_BOOST_PYTHON_BINARY_OPERATOR(>)
STREAMS_BOOST_PYTHON_BINARY_OPERATOR(>=)
STREAMS_BOOST_PYTHON_BINARY_OPERATOR(<)
STREAMS_BOOST_PYTHON_BINARY_OPERATOR(<=)
STREAMS_BOOST_PYTHON_BINARY_OPERATOR(==)
...
# define STREAMS_BOOST_PYTHON_INPLACE_OPERATOR(op)                              \
STREAMS_BOOST_PYTHON_DECL object& operator op(object& l, object const& r);      \
template <class R>                                                      \
object& operator op(object& l, R const& r)                              \
{                                                                       \
    return l op object(r);                                              \
}
STREAMS_BOOST_PYTHON_INPLACE_OPERATOR(+=)
STREAMS_BOOST_PYTHON_INPLACE_OPERATOR(-=)
STREAMS_BOOST_PYTHON_INPLACE_OPERATOR(*=)
STREAMS_BOOST_PYTHON_INPLACE_OPERATOR(/=)
STREAMS_BOOST_PYTHON_INPLACE_OPERATOR(%=)
...
#endif // OBJECT_OPERATORS_DWA2002617_STREAMS_HPP
