...
#ifndef HANDLE_DWA200269_STREAMS_HPP
# define HANDLE_DWA200269_STREAMS_HPP
...
# include <streams_boost/python/borrowed.hpp>
...
namespace detail
{
  ...
  template<typename T>
  yes_handle_t is_handle_test(streams_boost::type< handle<T> >);
}
...
class is_handle
{
 public:
    STREAMS_BOOST_STATIC_CONSTANT(
        bool, value = (
            sizeof(detail::is_handle_test(streams_boost::type<T>()))
...
#endif // HANDLE_DWA200269_STREAMS_HPP
