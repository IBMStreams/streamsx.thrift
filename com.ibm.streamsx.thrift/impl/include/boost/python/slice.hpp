#ifndef STREAMS_BOOST_PYTHON_SLICE_JDB20040105_HPP
#define STREAMS_BOOST_PYTHON_SLICE_JDB20040105_HPP
...
namespace detail
{
  class STREAMS_BOOST_PYTHON_DECL slice_base : public object
  {
   public:
      ...
      // equal to a default-constructed streams_boost::python::object.
   ...
   protected:
      ...
      STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(slice_base, object)
  };
}
...
class slice : public detail::slice_base
{
 ...
 public:
        ...
        const RandomAccessIterator& end) const
    {
        ...
        difference_type max_dist = streams_boost::detail::distance(begin, end);
        ...
        if (slice_start == object()) {
            ...
            if (i >= 0) {
                ...
                std::advance( ret.start, min STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(i, max_dist-1));
            }
            else {
                if (i < -max_dist && ret.step < 0)
                    throw std::invalid_argument( "Zero-length slice");
        ...
        typename iterator_difference<RandomAccessIterator>::type final_dist = 
            streams_boost::detail::distance( ret.start, ret.stop);
 ...
 public:
    ...
    STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(slice, detail::slice_base)
};
...
#endif // !defined STREAMS_BOOST_PYTHON_SLICE_JDB20040105_HPP
