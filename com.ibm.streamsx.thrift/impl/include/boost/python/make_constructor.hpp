...
namespace detail
{
  ...
  struct constructor_policy : BasePolicy_
  {
      ...
      STREAMS_BOOST_STATIC_ASSERT(same_result_converter::value) ;
#else
  ...
  // <streams_boost/python/detail/caller.hpp> for more information about how
...
#endif // MAKE_CONSTRUCTOR_DWA20011221_STREAMS_HPP
