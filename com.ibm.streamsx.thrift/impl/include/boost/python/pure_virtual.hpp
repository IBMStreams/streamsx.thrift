...
#ifndef PURE_VIRTUAL_DWA2003810_STREAMS_HPP
# define PURE_VIRTUAL_DWA2003810_STREAMS_HPP
...
# include <streams_boost/python/detail/nullary_function_adaptor.hpp>
...
namespace detail
{
  ...
  // function was called.
  void STREAMS_BOOST_PYTHON_DECL pure_virtual_called();
  ...
  error_signature(S STREAMS_BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(C))
  {
    ...
    : def_visitor<pure_virtual_visitor<PointerToMemberFunction> >
  {
   ...
   private:
      ...
      void visit(C_& c, char const* name, Options& options) const
      {
          ...
          STREAMS_BOOST_STATIC_ASSERT(!Options::has_default_implementation);
          ...
          typedef STREAMS_BOOST_DEDUCED_TYPENAME C_::metadata::held_type held_type;
...
#endif // PURE_VIRTUAL_DWA2003810_STREAMS_HPP
