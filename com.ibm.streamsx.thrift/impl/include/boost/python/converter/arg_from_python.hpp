...
#ifndef ARG_FROM_PYTHON_DWA2002127_STREAMS_HPP
# define ARG_FROM_PYTHON_DWA2002127_STREAMS_HPP

# include <streams_boost/python/detail/prefix.hpp>
# include <streams_boost/python/converter/from_python.hpp>
...
# include <streams_boost/python/detail/void_ptr.hpp>
# include <streams_boost/python/back_reference.hpp>
# include <streams_boost/python/detail/referent_storage.hpp>
# include <streams_boost/python/converter/obj_mgr_arg_from_python.hpp>
...
# if STREAMS_BOOST_MSVC < 1301 || _MSC_FULL_VER > 13102196
...
struct back_reference_arg_from_python
    : streams_boost::python::arg_from_python<typename T::type>
{
    typedef T result_type;
    ...
    T operator()();
 private:
    typedef streams_boost::python::arg_from_python<typename T::type> base;
    PyObject* m_source;
};
          ...
          , if_2<
              ...
              , if_2<
                  ...
                  , if_2<
                      ...
                      , mpl::if_<
                            streams_boost::python::is_back_reference<T>
...
#endif // ARG_FROM_PYTHON_DWA2002127_STREAMS_HPP
