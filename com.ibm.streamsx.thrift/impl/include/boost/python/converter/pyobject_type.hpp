...
#ifndef PYOBJECT_TYPE_DWA2002720_STREAMS_HPP
# define PYOBJECT_TYPE_DWA2002720_STREAMS_HPP

# include <streams_boost/python/cast.hpp>

namespace streams_boost { namespace python { namespace converter { 

STREAMS_BOOST_PYTHON_DECL PyObject* checked_downcast_impl(PyObject*, PyTypeObject*);
...
#endif // PYOBJECT_TYPE_DWA2002720_STREAMS_HPP
