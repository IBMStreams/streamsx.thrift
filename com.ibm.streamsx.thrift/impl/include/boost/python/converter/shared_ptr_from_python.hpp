...
#ifndef SHARED_PTR_FROM_PYTHON_DWA20021130_STREAMS_HPP
# define SHARED_PTR_FROM_PYTHON_DWA20021130_STREAMS_HPP
...
struct shared_ptr_from_python
{
 ...
 private:
    ...
    static void construct(PyObject* source, rvalue_from_python_stage1_data* data)
    {
        ...
        {
            streams_boost::shared_ptr<void> hold_convertible_ref_count(
...
#endif // SHARED_PTR_FROM_PYTHON_DWA20021130_STREAMS_HPP
