...
#ifndef FROM_PYTHON_AUX_DATA_DWA2002128_STREAMS_HPP
# define FROM_PYTHON_AUX_DATA_DWA2002128_STREAMS_HPP

# include <streams_boost/python/converter/constructor_function.hpp>
# include <streams_boost/python/detail/referent_storage.hpp>
# include <streams_boost/python/detail/destroy.hpp>
...
# if (!defined(__MWERKS__) || __MWERKS__ >= 0x3000) \
        ...
        && !defined(STREAMS_BOOST_PYTHON_SYNOPSIS) /* Synopsis' OpenCXX has trouble parsing this */
    // This must always be a POD struct with m_data its first member.
    STREAMS_BOOST_STATIC_ASSERT(STREAMS_BOOST_PYTHON_OFFSETOF(rvalue_from_python_storage<T>,stage1) == 0);
# endif
...
#endif // FROM_PYTHON_AUX_DATA_DWA2002128_STREAMS_HPP
