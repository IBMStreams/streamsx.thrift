...
#ifndef NUMARRAY_DWA2002922_STREAMS_HPP
# define NUMARRAY_DWA2002922_STREAMS_HPP
...
namespace streams_boost { namespace python { namespace numeric {

class array;

namespace aux
{
  struct STREAMS_BOOST_PYTHON_DECL array_base : object
  {
# define STREAMS_BOOST_PP_LOCAL_MACRO(n)                                \
      array_base(STREAMS_BOOST_PP_ENUM_PARAMS_Z(1, n, object const& x));
# define STREAMS_BOOST_PP_LOCAL_LIMITS (1, 7)
# include STREAMS_BOOST_PP_LOCAL_ITERATE()
   ...
   public: // implementation detail - do not touch.
      STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(array_base, object);
  };

  struct STREAMS_BOOST_PYTHON_DECL array_object_manager_traits
  {
...
# define STREAMS_BOOST_PP_LOCAL_MACRO(n)                                \
      void resize(STREAMS_BOOST_PP_ENUM_PARAMS_Z(1, n, long x))              \
      {                                                         \
          resize(make_tuple(STREAMS_BOOST_PP_ENUM_PARAMS_Z(1, n, x)));       \
      }
...
# define STREAMS_BOOST_PP_LOCAL_MACRO(n)                                \
    void setshape(STREAMS_BOOST_PP_ENUM_PARAMS_Z(1, n, long x))              \
    {                                                           \
        setshape(make_tuple(STREAMS_BOOST_PP_ENUM_PARAMS_Z(1, n, x)));       \
    }
# define STREAMS_BOOST_PP_LOCAL_LIMITS (1, STREAMS_BOOST_PYTHON_MAX_ARITY)
# include STREAMS_BOOST_PP_LOCAL_ITERATE()
...
# define STREAMS_BOOST_PYTHON_ENUM_AS_OBJECT(z, n, x) object(STREAMS_BOOST_PP_CAT(x,n))
# define STREAMS_BOOST_PP_LOCAL_MACRO(n)                                        \
    template <STREAMS_BOOST_PP_ENUM_PARAMS_Z(1, n, class T)>                    \
    explicit array(STREAMS_BOOST_PP_ENUM_BINARY_PARAMS_Z(1, n, T, const& x))    \
    : base(STREAMS_BOOST_PP_ENUM_1(n, STREAMS_BOOST_PYTHON_ENUM_AS_OBJECT, x))          \
    {}
# define STREAMS_BOOST_PP_LOCAL_LIMITS (1, 7)
# include STREAMS_BOOST_PP_LOCAL_ITERATE()
# undef STREAMS_BOOST_PYTHON_AS_OBJECT

    static STREAMS_BOOST_PYTHON_DECL void set_module_and_type(char const* package_name = 0, char const* type_attribute_name = 0);
    static STREAMS_BOOST_PYTHON_DECL std::string get_module_name();

 public: // implementation detail -- for internal use only
    STREAMS_BOOST_PYTHON_FORWARD_OBJECT_CONSTRUCTORS(array, base);
};

} // namespace streams_boost::python::numeric
...
#endif // NUMARRAY_DWA2002922_STREAMS_HPP
