...
#ifndef DEFAULT_CALL_POLICIES_DWA2002131_STREAMS_HPP
# define DEFAULT_CALL_POLICIES_DWA2002131_STREAMS_HPP
...
{
    typedef streams_boost::python::to_python_value<char const*const&> type;
};

template <>
struct default_result_converter::apply<PyObject*>
{
    typedef streams_boost::python::to_python_value<PyObject*const&> type;
};

}} // namespace streams_boost::python

#endif // DEFAULT_CALL_POLICIES_DWA2002131_STREAMS_HPP
