...
#ifndef ITERATOR_DWA2002512_STREAMS_HPP
# define ITERATOR_DWA2002512_STREAMS_HPP

# include <streams_boost/python/detail/prefix.hpp>

# include <streams_boost/python/detail/target.hpp>
# include <streams_boost/python/object/iterator.hpp>
...
# include <streams_boost/bind/protect.hpp>
...
namespace detail
{
  ...
  )
  {
      return objects::make_iterator_function<Target>(
          streams_boost::protect(streams_boost::bind(get_start, _1))
        , streams_boost::protect(streams_boost::bind(get_finish, _1))
        , next_policies
      );
  }
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, streams_boost::type<Target>* = 0)
{
...
#endif // ITERATOR_DWA2002512_STREAMS_HPP
