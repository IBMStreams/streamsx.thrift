...
#ifndef EXTRACT_DWA200265_STREAMS_HPP
# define EXTRACT_DWA200265_STREAMS_HPP
...
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, <= 1300) || STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_INTEL_WIN, <= 900)
// workaround for VC++ 6.x or 7.0
# define STREAMS_BOOST_EXTRACT_WORKAROUND ()
#else
# define STREAMS_BOOST_EXTRACT_WORKAROUND
#endif
...
#endif // EXTRACT_DWA200265_STREAMS_HPP
