...
#ifndef STREAMS_BOOST_FT_FUNCTION_POINTER_HPP_INCLUDED
#define STREAMS_BOOST_FT_FUNCTION_POINTER_HPP_INCLUDED
...
{ 
  namespace function_types 
  {
    template<typename Types, typename Tag = null_tag> struct function_pointer
    {
      ...
      STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,function_pointer,(Types,Tag))
    };
  } 
  STREAMS_BOOST_TT_AUX_TEMPLATE_ARITY_SPEC(2,function_types::function_pointer)
} 
