...
#ifndef STREAMS_BOOST_FT_IS_CALLABLE_BUILTIN_HPP_INCLUDED
#define STREAMS_BOOST_FT_IS_CALLABLE_BUILTIN_HPP_INCLUDED
  ...
  namespace function_types 
  {
    ...
    struct is_callable_builtin
      : function_types::represents
        ...
        >
    { 
      STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,is_callable_builtin,(T,Tag))
    };
  }
  STREAMS_BOOST_TT_AUX_TEMPLATE_ARITY_SPEC(2,function_types::is_callable_builtin)
}
