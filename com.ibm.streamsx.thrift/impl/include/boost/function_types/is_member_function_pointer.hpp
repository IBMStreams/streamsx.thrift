...
#ifndef STREAMS_BOOST_FT_IS_MEMBER_FUNCTION_POINTER_HPP_INCLUDED
#define STREAMS_BOOST_FT_IS_MEMBER_FUNCTION_POINTER_HPP_INCLUDED
...
{ 
  namespace function_types 
  {
    ...
    { 
      STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,is_member_function_pointer,(T,Tag))
    };
  }
  STREAMS_BOOST_TT_AUX_TEMPLATE_ARITY_SPEC(2,function_types::is_member_function_pointer)
} 
#endif 
