...
#ifndef STREAMS_BOOST_FT_IS_MEMBER_POINTER_HPP_INCLUDED
#define STREAMS_BOOST_FT_IS_MEMBER_POINTER_HPP_INCLUDED
  ...
  namespace function_types 
  {
    ...
    struct is_member_pointer
      : function_types::represents
        ...
        >
    {
      STREAMS_BOOST_MPL_AUX_LAMBDA_SUPPORT(2,is_member_pointer,(T,Tag))
    };
  } 
  STREAMS_BOOST_TT_AUX_TEMPLATE_ARITY_SPEC(2,function_types::is_member_pointer)
} 
