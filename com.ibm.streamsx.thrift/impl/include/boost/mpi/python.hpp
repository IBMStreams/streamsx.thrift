...
#ifndef STREAMS_BOOST_MPI_PYTHON_HPP
#define STREAMS_BOOST_MPI_PYTHON_HPP
...
#ifndef STREAMS_BOOST_MPI_PYTHON_FORWARD_ONLY
#  include <streams_boost/mpi/python/serialize.hpp>
#  include <streams_boost/mpi/python/skeleton_and_content.hpp>
#else
#  undef STREAMS_BOOST_MPI_PYTHON_FORWARD_ONLY
#endif

#endif // STREAMS_BOOST_MPI_PYTHON_HPP
