 ...
 *  process topology.
 */
#ifndef STREAMS_BOOST_MPI_GRAPH_COMMUNICATOR_HPP
#define STREAMS_BOOST_MPI_GRAPH_COMMUNICATOR_HPP
 ...
 */
class STREAMS_BOOST_MPI_DECL graph_communicator : public communicator
{
  ...
  {
#ifndef STREAMS_BOOST_DISABLE_ASSERTS
    int status;
    STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Topo_test, ((MPI_Comm)*this, &status));
    STREAMS_BOOST_ASSERT(status == MPI_GRAPH);
#endif
                                ...
                                RankMap rank, bool reorder)
{
  ...
  MPI_Comm newcomm;
  STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Graph_create,
                         ((MPI_Comm)comm, 
                          nvertices,
                          &indices[0],
...
#endif // STREAMS_BOOST_MPI_GRAPH_COMMUNICATOR_HPP
