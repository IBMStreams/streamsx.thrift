 ...
 */
#ifndef STREAMS_BOOST_MPI_PACKED_OARCHIVE_HPP
#define STREAMS_BOOST_MPI_PACKED_OARCHIVE_HPP
...
#include <streams_boost/mpi/detail/packed_oprimitive.hpp>
#include <streams_boost/mpi/detail/binary_buffer_oprimitive.hpp>
...
class STREAMS_BOOST_MPI_DECL packed_oarchive
  : public oprimitive,
...
public:
   ...
   *  default flags.
   */
  packed_oarchive( MPI_Comm const & comm, buffer_type & b, unsigned int flags = streams_boost::archive::no_header)
         : oprimitive(b,comm),
   ...
   *  default flags.
   */
  packed_oarchive ( MPI_Comm const & comm, unsigned int flags =  streams_boost::archive::no_header)
...
// required by export
STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(streams_boost::mpi::packed_oarchive)
STREAMS_BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(streams_boost::mpi::packed_oarchive)



#endif // STREAMS_BOOST_MPI_PACKED_OARCHIVE_HPP
