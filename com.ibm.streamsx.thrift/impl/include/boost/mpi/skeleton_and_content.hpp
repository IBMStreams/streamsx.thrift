 ...
 *  the content).
 */
#ifndef STREAMS_BOOST_MPI_SKELETON_AND_CONTENT_HPP
#define STREAMS_BOOST_MPI_SKELETON_AND_CONTENT_HPP
...
#include <streams_boost/mpi/detail/forward_skeleton_iarchive.hpp>
#include <streams_boost/mpi/detail/forward_skeleton_oarchive.hpp>
#include <streams_boost/mpi/detail/ignore_iprimitive.hpp>
#include <streams_boost/mpi/detail/ignore_oprimitive.hpp>
 ...
 */
template <class T>
struct STREAMS_BOOST_MPI_DECL skeleton_proxy
{
  /**
...
namespace detail {
  ...
  class STREAMS_BOOST_MPI_DECL mpi_datatype_holder : public streams_boost::noncopyable
  {
  public:
    mpi_datatype_holder()
     : is_committed(false)
    ...
    void commit()
    {
      STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Type_commit,(&d));
      is_committed=true;
    }
    ...
    {
      int finalized=0;
      STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Finalized,(&finalized));
      if (!finalized && is_committed)
        STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Type_free,(&d));
    }
 ...
 *  get_content().
 */
class STREAMS_BOOST_MPI_DECL content
{
public:
  /**
...
private:
  streams_boost::shared_ptr<detail::mpi_datatype_holder> holder;
};
 ...
 */
class STREAMS_BOOST_MPI_DECL packed_skeleton_iarchive
...
public:
  ...
  explicit packed_skeleton_iarchive(packed_iarchive & archive)
         ...
         , skeleton_archive_(MPI_COMM_WORLD, streams_boost::archive::no_header)
        {}
 ...
 *  directly. Instead, use @c skeleton or @c get_skeleton.
 */
class STREAMS_BOOST_MPI_DECL packed_skeleton_oarchive
...
namespace detail {
  typedef streams_boost::mpi::detail::forward_skeleton_oarchive<streams_boost::mpi::packed_skeleton_oarchive,streams_boost::mpi::packed_oarchive> type1;
  typedef streams_boost::mpi::detail::forward_skeleton_iarchive<streams_boost::mpi::packed_skeleton_iarchive,streams_boost::mpi::packed_iarchive> type2;
}


} } // end namespace streams_boost::mpi

#include <streams_boost/mpi/detail/content_oarchive.hpp>
...
#ifdef STREAMS_BOOST_MPI_BROADCAST_HPP
#  include <streams_boost/mpi/detail/broadcast_sc.hpp>
#endif

#ifdef STREAMS_BOOST_MPI_COMMUNICATOR_HPP
#  include <streams_boost/mpi/detail/communicator_sc.hpp>
#endif

// required by export
STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(streams_boost::mpi::packed_skeleton_oarchive)
STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(streams_boost::mpi::packed_skeleton_iarchive)
STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(streams_boost::mpi::detail::type1)
STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(streams_boost::mpi::detail::type2)

STREAMS_BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(streams_boost::mpi::packed_skeleton_oarchive)
STREAMS_BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(streams_boost::mpi::packed_skeleton_iarchive)

#endif // STREAMS_BOOST_MPI_SKELETON_AND_CONTENT_HPP
