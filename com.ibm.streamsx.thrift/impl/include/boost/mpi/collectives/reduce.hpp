...
#ifndef STREAMS_BOOST_MPI_REDUCE_HPP
#define STREAMS_BOOST_MPI_REDUCE_HPP
...
#include <streams_boost/mpi/detail/computation_tree.hpp>
...
namespace detail {
  ...
  {
    STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Reduce,
...
#endif // STREAMS_BOOST_MPI_REDUCE_HPP
