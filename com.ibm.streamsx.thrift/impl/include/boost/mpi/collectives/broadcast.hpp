...
#ifndef STREAMS_BOOST_MPI_BROADCAST_HPP
#define STREAMS_BOOST_MPI_BROADCAST_HPP
...
namespace detail {
  ...
  broadcast_impl(const communicator& comm, T* values, int n, int root, 
                 mpl::true_)
  {
    STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Bcast,
                           (values, n,
                            streams_boost::mpi::get_mpi_datatype<T>(*values),
                            root, MPI_Comm(comm)));
  }
...
#endif // STREAMS_BOOST_MPI_BROADCAST_HPP
