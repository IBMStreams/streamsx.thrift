...
#ifndef STREAMS_BOOST_MPI_ALL_REDUCE_HPP
#define STREAMS_BOOST_MPI_ALL_REDUCE_HPP
...
namespace detail {
  ...
  {
    STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Allreduce,
                           (const_cast<T*>(in_values), out_values, n,
                            streams_boost::mpi::get_mpi_datatype<T>(*in_values),
...
{
  T result;
  ::streams_boost::mpi::all_reduce(comm, in_value, result, op);
  return result;
}

} } // end namespace streams_boost::mpi

#endif // STREAMS_BOOST_MPI_ALL_REDUCE_HPP
