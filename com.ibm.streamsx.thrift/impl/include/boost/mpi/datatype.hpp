 ...
 */
#ifndef STREAMS_BOOST_MPI_DATATYPE_HPP
#define STREAMS_BOOST_MPI_DATATYPE_HPP
...
#include <streams_boost/mpi/detail/mpi_datatype_cache.hpp>
...
struct is_mpi_integer_datatype
  : public streams_boost::mpl::false_ { };
...
struct is_mpi_builtin_datatype
  : streams_boost::mpl::or_<is_mpi_integer_datatype<T>,
...
#ifndef STREAMS_BOOST_MPI_DOXYGEN

/// INTERNAL ONLY
#define STREAMS_BOOST_MPI_DATATYPE(CppType, MPIType, Kind)                      \
template<>                                                              \
inline MPI_Datatype                                                     \
get_mpi_datatype< CppType >(const CppType&) { return MPIType; }         \
                                                                        \
template<>                                                              \
 struct STREAMS_BOOST_JOIN(is_mpi_,STREAMS_BOOST_JOIN(Kind,_datatype))< CppType >       \
: streams_boost::mpl::bool_<true>                                               \
{}

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(packed, MPI_PACKED, builtin);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(char, MPI_CHAR, builtin);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(short, MPI_SHORT, integer);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(int, MPI_INT, integer);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(long, MPI_LONG, integer);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(float, MPI_FLOAT, floating_point);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(double, MPI_DOUBLE, floating_point);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(long double, MPI_LONG_DOUBLE, floating_point);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(unsigned char, MPI_UNSIGNED_CHAR, builtin);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(unsigned short, MPI_UNSIGNED_SHORT, integer);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(unsigned, MPI_UNSIGNED, integer);

/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(unsigned long, MPI_UNSIGNED_LONG, integer);

/// INTERNAL ONLY
#define STREAMS_BOOST_MPI_LIST2(A, B) A, B
/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(std::pair<STREAMS_BOOST_MPI_LIST2(float, int)>, MPI_FLOAT_INT, 
                   builtin);
/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(std::pair<STREAMS_BOOST_MPI_LIST2(double, int)>, MPI_DOUBLE_INT, 
                   builtin);
/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(std::pair<STREAMS_BOOST_MPI_LIST2(long double, int)>,
                   MPI_LONG_DOUBLE_INT, builtin);
/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(std::pair<STREAMS_BOOST_MPI_LIST2(long, int>), MPI_LONG_INT, 
                   builtin);
/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(std::pair<STREAMS_BOOST_MPI_LIST2(short, int>), MPI_SHORT_INT, 
                   builtin);
/// INTERNAL ONLY
STREAMS_BOOST_MPI_DATATYPE(std::pair<STREAMS_BOOST_MPI_LIST2(int, int>), MPI_2INT, builtin);
#undef STREAMS_BOOST_MPI_LIST2
...
STREAMS_BOOST_MPI_DATATYPE(wchar_t, MPI_WCHAR, builtin);
#endif
...
STREAMS_BOOST_MPI_DATATYPE(long long, MPI_LONG_LONG_INT, builtin);
#elif defined(STREAMS_BOOST_HAS_MS_INT64) && \
  (defined(MPI_LONG_LONG_INT) || (defined(MPI_VERSION) && MPI_VERSION >= 2))
STREAMS_BOOST_MPI_DATATYPE(__int64, MPI_LONG_LONG_INT, builtin); 
#endif
...
STREAMS_BOOST_MPI_DATATYPE(unsigned long long, MPI_UNSIGNED_LONG_LONG, builtin);
#elif defined(STREAMS_BOOST_HAS_MS_INT64) && \
  (defined(MPI_UNSIGNED_LONG_LONG) \
   || (defined(MPI_VERSION) && MPI_VERSION >= 2))
STREAMS_BOOST_MPI_DATATYPE(unsigned __int64, MPI_UNSIGNED_LONG_LONG, builtin); 
#endif
...
STREAMS_BOOST_MPI_DATATYPE(signed char, MPI_SIGNED_CHAR, builtin);
#endif
...
#define STREAMS_BOOST_IS_MPI_DATATYPE(T)              \
...
#endif // STREAMS_BOOST_MPI_MPI_DATATYPE_HPP
