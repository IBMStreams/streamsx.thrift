...
#ifndef STREAMS_BOOST_MPI_PYTHON_SKELETON_AND_CONTENT_HPP
#define STREAMS_BOOST_MPI_PYTHON_SKELETON_AND_CONTENT_HPP

/** @file skeleton_and_content.hpp
 *
 *  This file reflects the skeleton/content facilities into Python.
 */
#include <streams_boost/python.hpp>
...
#include <streams_boost/mpi/python/serialize.hpp>
 ...
 */
class content : public streams_boost::mpi::content
{
  typedef streams_boost::mpi::content inherited;

 public:
  content(const inherited& base, streams_boost::python::object object) 
    : inherited(base), object(object) { }

  inherited&       base()       { return *this; }
  const inherited& base() const { return *this; }

  streams_boost::python::object object;
};
...
{
public:
  skeleton_proxy_base(const streams_boost::python::object& object) : object(object) { }
...
{
 public:
  skeleton_proxy(const streams_boost::python::object& object) 
    : skeleton_proxy_base(object) { }
};

namespace detail {
  using streams_boost::python::object;
  using streams_boost::python::extract;
   
  extern STREAMS_BOOST_MPI_DECL streams_boost::python::object skeleton_proxy_base_type;
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(streams_boost::mpi::get_content(value), value_obj);
    }
  };
   ...
   */
  STREAMS_BOOST_MPI_PYTHON_DECL bool
   ...
   */
  STREAMS_BOOST_MPI_PYTHON_DECL void 
...
{
  using streams_boost::python::detail::direct_serialization_table;
  using streams_boost::python::detail::get_direct_serialization_table;
  using namespace streams_boost::python;
  ...
  {
    streams_boost::python::scope proxy_scope(detail::skeleton_proxy_base_type);
...
#endif // STREAMS_BOOST_MPI_PYTHON_SKELETON_AND_CONTENT_HPP
