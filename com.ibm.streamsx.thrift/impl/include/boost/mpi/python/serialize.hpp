 ...
 */
#ifndef STREAMS_BOOST_MPI_PYTHON_SERIALIZE_HPP
#define STREAMS_BOOST_MPI_PYTHON_SERIALIZE_HPP

#include <streams_boost/mpi/python/config.hpp>
...
#define STREAMS_BOOST_MPI_PYTHON_FORWARD_ONLY
#include <streams_boost/mpi/python.hpp>

/************************************************************************
 * Boost.Python Serialization Section                                   *
 ************************************************************************/
#if !defined(STREAMS_BOOST_NO_SFINAE) && !defined(STREAMS_BOOST_NO_IS_CONVERTIBLE)
/**
 ...
 * STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE instead.
 */
#  define STREAMS_BOOST_PYTHON_SERIALIZATION_ARCHIVE(IArchiver, OArchiver)        \
 ...
 * STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE_IMPL(IArchiver,
 * OArchiver) in one of your translation units.

DPG PICK UP HERE
 */
#define STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(IArchiver, OArchiver) \
STREAMS_BOOST_PYTHON_SERIALIZATION_ARCHIVE(IArchiver, OArchiver)                \
namespace streams_boost { namespace python { namespace detail {                 \
template<>                                                              \
STREAMS_BOOST_MPI_PYTHON_DECL direct_serialization_table< IArchiver , OArchiver >& \
 ...
 * STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(IArchiver, OArchiver).
 */
#define STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE_IMPL(IArchiver, OArchiver) \
namespace streams_boost { namespace python { namespace detail {                 \
template                                                                \
  class STREAMS_BOOST_MPI_PYTHON_DECL direct_serialization_table< IArchiver , OArchiver >; \
                                                                        \
template<>                                                              \
 STREAMS_BOOST_MPI_PYTHON_DECL                                                  \
 ...
 */
class STREAMS_BOOST_MPI_PYTHON_DECL pickle {
  struct data_t;
 ...
 * STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE.
 */
...
namespace detail {
   ...
   */
  template<typename IArchiver, typename OArchiver>
  class STREAMS_BOOST_MPI_PYTHON_DECL direct_serialization_table
  {
  public:
    typedef streams_boost::function3<void, OArchiver&, const object&, const unsigned int>
      saver_t;
    typedef streams_boost::function3<void, IArchiver&, object&, const unsigned int>
      loader_t;
   ...
   * STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE_IMPL to define this
...
void 
save_impl(Archiver& ar, const streams_boost::python::object& obj, 
          const unsigned int /*version*/,
          mpl::false_ /*has_direct_serialization*/)
{
  streams_boost::python::str py_string = streams_boost::python::pickle::dumps(obj);
  int len = streams_boost::python::extract<int>(py_string.attr("__len__")());
  const char* string = streams_boost::python::extract<const char*>(py_string);
  ar << len << streams_boost::serialization::make_array(string, len);
}
...
template<typename Archiver>
void 
load_impl(Archiver& ar, streams_boost::python::object& obj, 
          const unsigned int /*version*/, 
          mpl::false_ /*has_direct_serialization*/)
{
  int len;
  ...
  ar >> streams_boost::serialization::make_array(string.get(), len);
  streams_boost::python::str py_string(string.get(), len);
  obj = streams_boost::python::pickle::loads(py_string);
}
...
template<typename Archiver>
void 
save(Archiver& ar, const streams_boost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver OArchiver;
  typedef typename input_archiver<OArchiver>::type IArchiver;
...
template<typename Archiver>
void 
load(Archiver& ar, streams_boost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver IArchiver;
  typedef typename output_archiver<IArchiver>::type OArchiver;
...
inline void 
serialize(Archive& ar, streams_boost::python::object& obj, const unsigned int version)
{
  streams_boost::serialization::split_free(ar, obj, version);
}

} } // end namespace streams_boost::python
...
STREAMS_BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(
  ::streams_boost::mpi::packed_iarchive,
  ::streams_boost::mpi::packed_oarchive)

namespace streams_boost { namespace mpi { namespace python {

template<typename T>
void
register_serialized(const T& value, PyTypeObject* type)
{
  using streams_boost::python::register_serialized;
  register_serialized<packed_iarchive, packed_oarchive>(value, type);
}

} } } // end namespace streams_boost::mpi::python

#endif // STREAMS_BOOST_MPI_PYTHON_SERIALIZE_HPP
