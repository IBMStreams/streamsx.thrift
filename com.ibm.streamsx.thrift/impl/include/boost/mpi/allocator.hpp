 ...
 */
#ifndef STREAMS_BOOST_MPI_ALLOCATOR_HPP
#define STREAMS_BOOST_MPI_ALLOCATOR_HPP
...
#if defined(STREAMS_BOOST_MPI_HAS_MEMORY_ALLOCATION)
 ...
 */
template<> 
class STREAMS_BOOST_MPI_DECL allocator<void> 
{ 
public: 
 ...
 *  throughout. The macro @c STREAMS_BOOST_MPI_HAS_MEMORY_ALLOCATION will be
 *  defined when the MPI-2 memory allocation facilities are available.
 */
template<typename T> 
class STREAMS_BOOST_MPI_DECL allocator 
{
public:
  ...
  {
    pointer result;
    STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Alloc_mem,
  ...
  {
    STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Free_mem, (p));
  }
...
#endif // STREAMS_BOOST_MPI_ALLOCATOR_HPP
