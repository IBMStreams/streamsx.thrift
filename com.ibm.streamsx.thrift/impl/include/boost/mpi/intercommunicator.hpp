 ...
 */
#ifndef STREAMS_BOOST_MPI_INTERCOMMUNICATOR_HPP
#define STREAMS_BOOST_MPI_INTERCOMMUNICATOR_HPP
 ...
 * 
 */   
class STREAMS_BOOST_MPI_DECL intercommunicator : public communicator
{
private:
...
public:
   ...
   */
  streams_boost::mpi::group local_group() const;
   ...
   */
  streams_boost::mpi::group remote_group() const;
...
#endif // STREAMS_BOOST_MPI_INTERCOMMUNICATOR_HPP
