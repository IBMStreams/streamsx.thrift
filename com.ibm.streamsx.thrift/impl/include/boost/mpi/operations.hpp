 ...
 */
#ifndef STREAMS_BOOST_MPI_IS_MPI_OP_HPP
#define STREAMS_BOOST_MPI_IS_MPI_OP_HPP
 ...
 *  streams_boost/mpi/operations.hpp headers whenever possible. For
...
struct is_mpi_op<maximum<T>, T>
  : public streams_boost::mpl::or_<is_mpi_integer_datatype<T>,
...
namespace detail {
  ...
  public:
    ...
    {
      STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Op_create,
    ...
    ~user_op()
    {
      if (std::uncaught_exception()) {
        ...
        STREAMS_BOOST_MPI_CHECK_RESULT(MPI_Op_free, (&mpi_op));
      }
    }
  ...
  private:
    ...
    static void STREAMS_BOOST_MPI_CALLING_CONVENTION perform(void* vinvec, void* voutvec, int* plen, MPI_Datatype*)
    {
...
#endif // STREAMS_BOOST_MPI_GET_MPI_OP_HPP
