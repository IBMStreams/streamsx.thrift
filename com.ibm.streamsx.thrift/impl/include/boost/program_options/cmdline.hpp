...
#ifndef STREAMS_BOOST_CMDLINE_HPP_VP_2004_03_13
#define STREAMS_BOOST_CMDLINE_HPP_VP_2004_03_13

namespace streams_boost { namespace program_options { namespace command_line_style {
