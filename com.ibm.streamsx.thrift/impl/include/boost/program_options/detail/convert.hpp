...
#ifndef STREAMS_BOOST_CONVERT_HPP_VP_2004_04_28
#define STREAMS_BOOST_CONVERT_HPP_VP_2004_04_28
...
namespace streams_boost {
    ...
    namespace program_options
    {
        ...
        */
        STREAMS_BOOST_PROGRAM_OPTIONS_DECL std::string to_internal(const std::string&);
        /** @overload */
        STREAMS_BOOST_PROGRAM_OPTIONS_DECL std::string to_internal(const std::wstring&);
