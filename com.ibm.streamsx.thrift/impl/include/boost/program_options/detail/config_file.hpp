...
#ifndef STREAMS_BOOST_CONFIG_FILE_VP_2003_01_02
#define STREAMS_BOOST_CONFIG_FILE_VP_2003_01_02
...
#include <streams_boost/program_options/eof_iterator.hpp>

#include <streams_boost/detail/workaround.hpp>
#if STREAMS_BOOST_WORKAROUND(__MWERKS__, STREAMS_BOOST_TESTED_AT(0x3202))
#include <streams_boost/program_options/detail/convert.hpp>
#endif
...
#if STREAMS_BOOST_WORKAROUND(__COMO_VERSION__, STREAMS_BOOST_TESTED_AT(4303)) || \
        (defined(__sgi) && STREAMS_BOOST_WORKAROUND(_COMPILER_VERSION, STREAMS_BOOST_TESTED_AT(741)))
    template<>
    bool
