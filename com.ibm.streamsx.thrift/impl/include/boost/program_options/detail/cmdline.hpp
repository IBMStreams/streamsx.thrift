...
#ifndef STREAMS_BOOST_CMDLINE_VP_2003_05_19
#define STREAMS_BOOST_CMDLINE_VP_2003_05_19

#include <streams_boost/program_options/config.hpp>
#include <streams_boost/program_options/errors.hpp>
#include <streams_boost/program_options/cmdline.hpp>
#include <streams_boost/program_options/option.hpp>
#include <streams_boost/program_options/options_description.hpp>
#include <streams_boost/program_options/positional_options.hpp>
...
namespace streams_boost { namespace program_options { namespace detail {
    ...
    */
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL cmdline {
    public:

        typedef ::streams_boost::program_options::command_line_style::style_t style_t;
