...
#ifndef STREAMS_BOOST_OPTION_DESCRIPTION_VP_2003_05_19
#define STREAMS_BOOST_OPTION_DESCRIPTION_VP_2003_05_19

#include <streams_boost/program_options/config.hpp>
#include <streams_boost/program_options/errors.hpp>
#include <streams_boost/program_options/value_semantic.hpp>
...
namespace program_options {
    ...
    */
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL option_description {
    public:
     ...
     */        
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL options_description_easy_init {
    public:
    ...
    */
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL options_description {
    public:
    ...
    public:
        ...
        */
        ...
        friend STREAMS_BOOST_PROGRAM_OPTIONS_DECL std::ostream& operator<<(std::ostream& os, 
...
#if STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_DINKUMWARE_STDLIB, STREAMS_BOOST_TESTED_AT(313))
    ...
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL duplicate_option_error : public error {
    public:
