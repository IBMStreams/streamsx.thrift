...
#ifndef STREAMS_BOOST_VALUE_SEMANTIC_HPP_VP_2004_02_24
#define STREAMS_BOOST_VALUE_SEMANTIC_HPP_VP_2004_02_24

#include <streams_boost/program_options/config.hpp>
#include <streams_boost/program_options/errors.hpp>

#include <streams_boost/any.hpp>
...
namespace streams_boost { namespace program_options {

    /** Class which specifies how the option's value is to be parsed
        and converted into C++ types.
    */
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL value_semantic {
    public:
        ...
        */
        virtual void parse(streams_boost::any& value_store, 
        ...
        /** Called to assign default value to 'value_store'. Returns
            ...
            value exists. */
        virtual bool apply_default(streams_boost::any& value_store) const = 0;
                                   
        /** Called when final value of an option is determined. 
        */
        virtual void notify(const streams_boost::any& value_store) const = 0;
    ...
    */
    template<>
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL 
    value_semantic_codecvt_helper<char> : public value_semantic {
    private: // base overrides
        void parse(streams_boost::any& value_store, 
                   const std::vector<std::string>& new_tokens,
                   bool utf8) const;
    protected: // interface for derived classes.
        virtual void xparse(streams_boost::any& value_store, 
                            const std::vector<std::string>& new_tokens) 
            const = 0;
    };
    ...
    */
    ...
    public:
        ...
        /** If 'value_store' is already initialized, or new_tokens
            ...
            any modifications.
         */
        void xparse(streams_boost::any& value_store,
                    const std::vector<std::string>& new_tokens) const;

        /** Does nothing. */
        bool apply_default(streams_boost::any&) const { return false; }

        /** Does nothing. */
        void notify(const streams_boost::any&) const {}        
    private:
        bool m_zero_tokens;
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            m_default_value = streams_boost::any(v);
            m_default_value_as_text = streams_boost::lexical_cast<std::string>(v);
            return this;
        }
        ...
        */
        ...
        {
            m_implicit_value = streams_boost::any(v);
            m_implicit_value_as_text =
                streams_boost::lexical_cast<std::string>(v);
            return this;
        }
    ...
    public: // value semantic overrides
        ...
        */
        virtual bool apply_default(streams_boost::any& value_store) const
        {
        ...
        /** If an address of variable to store value was specified
            ...
            does nothing. */
        void notify(const streams_boost::any& value_store) const;
    ...
    private:
        ...
        // Default value is stored as streams_boost::any and not
        // as streams_boost::optional to avoid unnecessary instantiations.
        streams_boost::any m_default_value;
        std::string m_default_value_as_text;
        streams_boost::any m_implicit_value;
        std::string m_implicit_value_as_text;
        bool m_composing, m_implicit, m_multitoken, m_zero_tokens, m_required;
        streams_boost::function1<void, const T&> m_notifier;
    };
    ...
    */
    STREAMS_BOOST_PROGRAM_OPTIONS_DECL typed_value<bool>*
    bool_switch();
...
#include "streams_boost/program_options/detail/value_semantic.hpp"
