...
#ifndef STREAMS_BOOST_VARIABLES_MAP_VP_2003_05_19
#define STREAMS_BOOST_VARIABLES_MAP_VP_2003_05_19
...
namespace streams_boost { namespace program_options {
    ...
    */
    STREAMS_BOOST_PROGRAM_OPTIONS_DECL 
    ...
    */
    ...
    STREAMS_BOOST_PROGRAM_OPTIONS_DECL void notify(variables_map& m);

    /** Class holding value of option. Contains details about how the 
        value is set and allows to conveniently obtain the value.
    */
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL variable_value {
    public:
        variable_value() : m_defaulted(false) {}
        variable_value(const streams_boost::any& v, bool defaulted) 
        : v(v), m_defaulted(defaulted) 
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws streams_boost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return streams_boost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return streams_boost::any_cast<T&>(v);
       }
        ...
        const streams_boost::any& value() const;

        /** Returns the contained value. */
        streams_boost::any& value();
    private:
        streams_boost::any v;
        bool m_defaulted;
        ...
        friend STREAMS_BOOST_PROGRAM_OPTIONS_DECL
        void store(const basic_parsed_options<char>& options, 
              variables_map& m, bool);

        friend STREAMS_BOOST_PROGRAM_OPTIONS_DECL class variables_map;
    };

    /** Implements string->string mapping with convenient value casting
        facilities. */
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL abstract_variables_map {
    public:
    ...
    */
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL variables_map : public abstract_variables_map,
