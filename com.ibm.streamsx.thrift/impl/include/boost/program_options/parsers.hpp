...
#ifndef STREAMS_BOOST_PARSERS_VP_2003_05_19
#define STREAMS_BOOST_PARSERS_VP_2003_05_19

#include <streams_boost/program_options/config.hpp>
#include <streams_boost/program_options/option.hpp>
#include <streams_boost/program_options/detail/cmdline.hpp>
...
namespace streams_boost { namespace program_options {
    ...
    */
    template<>
    class STREAMS_BOOST_PROGRAM_OPTIONS_DECL basic_parsed_options<wchar_t> {
    public:
    ...
    */
    template<class charT>
#if ! STREAMS_BOOST_WORKAROUND(__ICL, STREAMS_BOOST_TESTED_AT(700))
    ...
    */
    STREAMS_BOOST_PROGRAM_OPTIONS_DECL parsed_options
    ...
    */
    STREAMS_BOOST_PROGRAM_OPTIONS_DECL std::vector<std::string>
    split_unix(const std::string& cmdline, const std::string& seperator = " \t", 
         const std::string& quote = "'\"", const std::string& escape = "\\");
         
#ifndef STREAMS_BOOST_NO_STD_WSTRING
    /** @overload */
    STREAMS_BOOST_PROGRAM_OPTIONS_DECL std::vector<std::wstring>
...
#include "streams_boost/program_options/detail/parsers.hpp"
