...
#define STREAMS_BOOST_REGEX_MATCHER_HPP

#include <streams_boost/regex/v4/iterator_category.hpp>
...
// error checking API:
//
STREAMS_BOOST_REGEX_DECL void STREAMS_BOOST_REGEX_CALL verify_options(streams_boost::regex_constants::syntax_option_type ef, match_flag_type mf);
//
// function can_start:
//
...
#if defined(WCHAR_MIN) && (WCHAR_MIN == 0) && !defined(STREAMS_BOOST_NO_INTRINSIC_WCHAR_T)
...
iterator STREAMS_BOOST_REGEX_CALL re_is_set_member(iterator next, 
                          iterator last, 
...
{   
   ...
   const ::streams_boost::regex_traits_wrapper<traits_type>& traits_inst = *(e.m_ptraits);
...
private:
   ...
   {
      return ::streams_boost::is_random_access_iterator<BidiIterator>::value ? match_dot_repeat_fast() : match_dot_repeat_slow();
   }
   bool match_backstep();
...
private:
   ...
   const ::streams_boost::regex_traits_wrapper<traits>& traits_inst;
   // the next state in the machine being matched:
   const re_syntax_base* pstate;
   // matching flags in use:
   match_flag_type m_match_flags;
   // how many states we have examined so far:
   streams_boost::uintmax_t state_count;
   // max number of states to examine before giving up:
   streams_boost::uintmax_t max_state_count;
...
//
#ifdef STREAMS_BOOST_REGEX_RECURSIVE
#include <streams_boost/regex/v4/perl_matcher_recursive.hpp>
#else
#include <streams_boost/regex/v4/perl_matcher_non_recursive.hpp>
#endif
// this one has to be last:
#include <streams_boost/regex/v4/perl_matcher_common.hpp>
