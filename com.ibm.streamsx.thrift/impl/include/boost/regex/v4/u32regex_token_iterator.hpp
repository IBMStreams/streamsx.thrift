...
#ifndef STREAMS_BOOST_REGEX_V4_U32REGEX_TOKEN_ITERATOR_HPP
#define STREAMS_BOOST_REGEX_V4_U32REGEX_TOKEN_ITERATOR_HPP

#if (STREAMS_BOOST_WORKAROUND(__BORLANDC__, >= 0x560) && STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x570)))\
      || STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, < 1300) \
      || STREAMS_BOOST_WORKAROUND(__MWERKS__, STREAMS_BOOST_TESTED_AT(0x3003))
//
...
public:
...
#elif (STREAMS_BOOST_WORKAROUND(__BORLANDC__, >= 0x560) && STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT(0x570)))\
      || STREAMS_BOOST_WORKAROUND(STREAMS_BOOST_MSVC, < 1300) \
      || STREAMS_BOOST_WORKAROUND(__MWERKS__, STREAMS_BOOST_TESTED_AT(0x3003)) \
      ...
      : end(last), re(*p), flags(f)
   {
      ...
      STREAMS_BOOST_STATIC_ASSERT(::streams_boost::is_array<T>::value);
...
#endif // STREAMS_BOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
