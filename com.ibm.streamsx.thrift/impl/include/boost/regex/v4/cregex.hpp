 ...
 */
  ...
  *                + streams_boost::RegEx high level wrapper.
  */

#ifndef STREAMS_BOOST_RE_CREGEX_HPP_INCLUDED
#define STREAMS_BOOST_RE_CREGEX_HPP_INCLUDED
...
#if defined(__cplusplus) && !defined(STREAMS_BOOST_NO_STDC_NAMESPACE)
...
STREAMS_BOOST_REGEX_DECL int STREAMS_BOOST_REGEX_CCALL regcompA(regex_tA*, const char*, int);
STREAMS_BOOST_REGEX_DECL regsize_t STREAMS_BOOST_REGEX_CCALL regerrorA(int, const regex_tA*, char*, regsize_t);
STREAMS_BOOST_REGEX_DECL int STREAMS_BOOST_REGEX_CCALL regexecA(const regex_tA*, const char*, regsize_t, regmatch_t*, int);
STREAMS_BOOST_REGEX_DECL void STREAMS_BOOST_REGEX_CCALL regfreeA(regex_tA*);

#ifndef STREAMS_BOOST_NO_WREGEX
STREAMS_BOOST_REGEX_DECL int STREAMS_BOOST_REGEX_CCALL regcompW(regex_tW*, const wchar_t*, int);
STREAMS_BOOST_REGEX_DECL regsize_t STREAMS_BOOST_REGEX_CCALL regerrorW(int, const regex_tW*, wchar_t*, regsize_t);
STREAMS_BOOST_REGEX_DECL int STREAMS_BOOST_REGEX_CCALL regexecW(const regex_tW*, const wchar_t*, regsize_t, regmatch_t*, int);
STREAMS_BOOST_REGEX_DECL void STREAMS_BOOST_REGEX_CCALL regfreeW(regex_tW*);
#endif
...
class STREAMS_BOOST_REGEX_DECL RegEx
{
private:
