...
#ifndef STREAMS_BOOST_RE_FILEITER_HPP_INCLUDED
#define STREAMS_BOOST_RE_FILEITER_HPP_INCLUDED
...
#ifndef STREAMS_BOOST_REGEX_NO_FILEITER

#if (defined(__CYGWIN__) || defined(__CYGWIN32__)) && !defined(STREAMS_BOOST_REGEX_NO_W32)
#error "Sorry, can't mix <windows.h> with STL code and gcc compiler: if you ran configure, try again with configure --disable-ms-windows"
#define STREAMS_BOOST_REGEX_FI_WIN32_MAP
#define STREAMS_BOOST_REGEX_FI_POSIX_DIR
#elif (defined(__WIN32__) || defined(_WIN32) || defined(WIN32)) && !defined(STREAMS_BOOST_REGEX_NO_W32)
#define STREAMS_BOOST_REGEX_FI_WIN32_MAP
#define STREAMS_BOOST_REGEX_FI_WIN32_DIR
#else
#define STREAMS_BOOST_REGEX_FI_POSIX_MAP
#define STREAMS_BOOST_REGEX_FI_POSIX_DIR
#endif

#if defined(STREAMS_BOOST_REGEX_FI_WIN32_MAP)||defined(STREAMS_BOOST_REGEX_FI_WIN32_DIR)
#include <windows.h>
#endif

#if defined(STREAMS_BOOST_REGEX_FI_WIN32_DIR)
...
#ifndef STREAMS_BOOST_NO_ANSI_APIS
...
#elif defined(STREAMS_BOOST_REGEX_FI_POSIX_DIR)
...
#ifdef STREAMS_BOOST_REGEX_FI_WIN32_MAP // win32 mapfile

class STREAMS_BOOST_REGEX_DECL mapfile
{
   HANDLE hfile;
   HANDLE hmap;
   const char* _first;
...
class STREAMS_BOOST_REGEX_DECL mapfile_iterator;
...
class STREAMS_BOOST_REGEX_DECL mapfile_iterator
#if !defined(STREAMS_BOOST_NO_STD_ITERATOR) || defined(STREAMS_BOOST_MSVC_STD_ITERATOR)
...
public:
   ...
   char operator* ()const
   {
      STREAMS_BOOST_ASSERT(node >= file->_first);
      STREAMS_BOOST_ASSERT(node < file->_last);
...
STREAMS_BOOST_REGEX_DECL extern const char* _fi_sep;
...
class STREAMS_BOOST_REGEX_DECL file_iterator 
{
   char* _root;
   char* _path;
   char* ptr;
...
class STREAMS_BOOST_REGEX_DECL directory_iterator
{
   char* _root;
   char* _path;
   char* ptr;
...
using streams_boost::re_detail::directory_iterator;
using streams_boost::re_detail::file_iterator;
using streams_boost::re_detail::mapfile;
} // namespace streams_boost

#endif     // STREAMS_BOOST_REGEX_NO_FILEITER
#endif     // STREAMS_BOOST_RE_FILEITER_HPP
