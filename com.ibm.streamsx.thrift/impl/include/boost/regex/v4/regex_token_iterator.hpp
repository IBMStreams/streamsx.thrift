...
#ifndef STREAMS_BOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
#define STREAMS_BOOST_REGEX_V4_REGEX_TOKEN_ITERATOR_HPP
...
template <class BidirectionalIterator, 
          class charT = STREAMS_BOOST_DEDUCED_TYPENAME re_detail::regex_iterator_traits<BidirectionalIterator>::value_type,
