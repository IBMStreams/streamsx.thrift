...
#define STREAMS_BOOST_CPP_REGEX_TRAITS_HPP_INCLUDED
...
#ifndef STREAMS_BOOST_NO_STD_MESSAGES
...
std::locale cpp_regex_traits_base<charT>::imbue(const std::locale& l)
{
   ...
   m_locale = l;
   m_pctype = &STREAMS_BOOST_USE_FACET(std::ctype<charT>, l);
#ifndef STREAMS_BOOST_NO_STD_MESSAGES
   m_pmessages = STREAMS_BOOST_HAS_FACET(std::messages<charT>, l) ? &STREAMS_BOOST_USE_FACET(std::messages<charT>, l) : 0;
#endif
   m_pcollate = &STREAMS_BOOST_USE_FACET(std::collate<charT>, l);
   return result;
}
...
//
template <>
class STREAMS_BOOST_REGEX_DECL cpp_regex_traits_char_layer<char> : public cpp_regex_traits_base<char>
{
...
#ifndef STREAMS_BOOST_REGEX_BUGGY_CTYPE_FACET
   STREAMS_BOOST_STATIC_CONSTANT(char_class_type, mask_blank = 1u << 24);
   STREAMS_BOOST_STATIC_CONSTANT(char_class_type, mask_word = 1u << 25);
   STREAMS_BOOST_STATIC_CONSTANT(char_class_type, mask_unicode = 1u << 26);
   STREAMS_BOOST_STATIC_CONSTANT(char_class_type, mask_horizontal = 1u << 27);
   STREAMS_BOOST_STATIC_CONSTANT(char_class_type, mask_vertical = 1u << 28);
#endif
...
#ifndef STREAMS_BOOST_REGEX_BUGGY_CTYPE_FACET
#if !defined(STREAMS_BOOST_NO_INCLASS_MEMBER_INITIALIZATION)
   ...
   cpp_regex_traits_implementation<charT>::transform(const charT* p1, const charT* p2) const
{
   ...
   try{
...
#if STREAMS_BOOST_WORKAROUND(__BORLANDC__, < 0x580)
      ...
      while(result.size() && (charT(0) == *result.rbegin()))
         result.erase(result.size() - 1);
#endif
      STREAMS_BOOST_ASSERT(std::find(result.begin(), result.end(), charT(0)) == result.end());
   }
   catch(...)
   {
   }
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::streams_boost::re_detail::char_class_alnum,
         ::streams_boost::re_detail::char_class_alpha,
         ::streams_boost::re_detail::char_class_cntrl,
         ::streams_boost::re_detail::char_class_digit,
         ::streams_boost::re_detail::char_class_graph,
         ::streams_boost::re_detail::char_class_horizontal_space,
         ::streams_boost::re_detail::char_class_lower,
         ::streams_boost::re_detail::char_class_print,
         ::streams_boost::re_detail::char_class_punct,
         ::streams_boost::re_detail::char_class_space,
         ::streams_boost::re_detail::char_class_upper,
         ::streams_boost::re_detail::char_class_vertical_space,
         ::streams_boost::re_detail::char_class_xdigit,
         ::streams_boost::re_detail::char_class_blank,
         ::streams_boost::re_detail::char_class_word,
         ::streams_boost::re_detail::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::streams_boost::re_detail::char_class_upper,
      ::streams_boost::re_detail::char_class_vertical_space,
      ::streams_boost::re_detail::char_class_alnum | ::streams_boost::re_detail::char_class_word, 
      ::streams_boost::re_detail::char_class_alnum | ::streams_boost::re_detail::char_class_word, 
      ::streams_boost::re_detail::char_class_xdigit,
   };
#endif
   ...
   STREAMS_BOOST_ASSERT(state_id < sizeof(masks) / sizeof(masks[0]));
...
{
   return
      ((mask & ::streams_boost::re_detail::char_class_space) && (m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::streams_boost::re_detail::char_class_print) && (m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::streams_boost::re_detail::char_class_cntrl) && (m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::streams_boost::re_detail::char_class_upper) && (m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::streams_boost::re_detail::char_class_lower) && (m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::streams_boost::re_detail::char_class_alpha) && (m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::streams_boost::re_detail::char_class_digit) && (m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::streams_boost::re_detail::char_class_punct) && (m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::streams_boost::re_detail::char_class_xdigit) && (m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::streams_boost::re_detail::char_class_blank) && (m_pctype->is(std::ctype<charT>::space, c)) && !::streams_boost::re_detail::is_separator(c))
      || ((mask & ::streams_boost::re_detail::char_class_word) && (c == '_'))
      || ((mask & ::streams_boost::re_detail::char_class_unicode) && ::streams_boost::re_detail::is_extended(c))
      || ((mask & ::streams_boost::re_detail::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::streams_boost::re_detail::char_class_horizontal_space) && m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline streams_boost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l STREAMS_BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(charT))
{
   cpp_regex_traits_base<charT> key(l);
   return ::streams_boost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
private:
   streams_boost::shared_ptr<const re_detail::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
...
int cpp_regex_traits<charT>::toi(const charT*& first, const charT* last, int radix)const
{
   ...
   last = std::find(first, last, STREAMS_BOOST_USE_FACET(std::numpunct<charT>, is.getloc()).thousands_sep());
