 ...
 */
  ...
  *   FILE         streams_boost/regex/config/borland.hpp
...
#        ifdef STREAMS_BOOST_REGEX_BUILD_DLL
...
#  endif
#  if (__BORLANDC__ <= 0x540) && !defined(STREAMS_BOOST_REGEX_NO_LIB) && !defined(_NO_VCL)
...
#     define STREAMS_BOOST_REGEX_USE_VCL
#  endif
   //
   ...
   //
#  ifndef _Windows
#     ifndef STREAMS_BOOST_REGEX_NO_LIB
#        define STREAMS_BOOST_REGEX_NO_LIB
#     endif
#     ifndef STREAMS_BOOST_REGEX_STATIC_LINK
#        define STREAMS_BOOST_REGEX_STATIC_LINK
#     endif
#  endif
