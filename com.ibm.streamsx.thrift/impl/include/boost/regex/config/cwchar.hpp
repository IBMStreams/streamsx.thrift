 ...
 */
  ...
  *   FILE         streams_boost/regex/config/cwchar.hpp
  *   VERSION      see <streams_boost/version.hpp>
  *   DESCRIPTION: regex wide character string fixes.
  */

#ifndef STREAMS_BOOST_REGEX_CONFIG_CWCHAR_HPP
#define STREAMS_BOOST_REGEX_CONFIG_CWCHAR_HPP
...
#undef wcscoll
#elif defined(STREAMS_BOOST_NO_STDC_NAMESPACE) && !defined(UNDER_CE)
using ::wcscoll;
#endif
