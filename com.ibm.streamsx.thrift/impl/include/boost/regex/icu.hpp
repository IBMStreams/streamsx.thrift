...
#ifndef STREAMS_BOOST_REGEX_ICU_HPP
#define STREAMS_BOOST_REGEX_ICU_HPP

#include <unicode/utypes.h>
#include <unicode/uchar.h>
#include <unicode/coll.h>
#include <streams_boost/regex.hpp>
#include <streams_boost/regex/pending/unicode_iterator.hpp>
...
//
class STREAMS_BOOST_REGEX_DECL icu_regex_traits_implementation
{
...
private:
   ...
   streams_boost::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_collator;          // The full collation object
   streams_boost::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_primary_collator;  // The primary collation object
};

inline streams_boost::shared_ptr<icu_regex_traits_implementation> get_icu_regex_traits_implementation(const U_NAMESPACE_QUALIFIER Locale& loc)
{
   return streams_boost::shared_ptr<icu_regex_traits_implementation>(new icu_regex_traits_implementation(loc));
}

}

class STREAMS_BOOST_REGEX_DECL icu_regex_traits
{
public:
   typedef UChar32                      char_type;
   typedef std::size_t                  size_type;
   typedef std::vector<char_type>       string_type;
   typedef U_NAMESPACE_QUALIFIER Locale locale_type;
#ifdef STREAMS_BOOST_NO_INT64_T
   typedef std::bitset<64>              char_class_type;
#else
   typedef streams_boost::uint64_t              char_class_type;
#endif
   ...
   std::string error_string(::streams_boost::regex_constants::error_type n) const
   {
...
private:
   ...
   streams_boost::shared_ptr< ::streams_boost::re_detail::icu_regex_traits_implementation> m_pimpl;
};
...
// template instances:
//
#define STREAMS_BOOST_REGEX_CHAR_T UChar32
#undef STREAMS_BOOST_REGEX_TRAITS_T
#define STREAMS_BOOST_REGEX_TRAITS_T , icu_regex_traits
#define STREAMS_BOOST_REGEX_ICU_INSTANCES
#ifdef STREAMS_BOOST_REGEX_ICU_INSTANTIATE
#  define STREAMS_BOOST_REGEX_INSTANTIATE
#endif
#include <streams_boost/regex/v4/instances.hpp>
#undef STREAMS_BOOST_REGEX_CHAR_T
#undef STREAMS_BOOST_REGEX_TRAITS_T
#undef STREAMS_BOOST_REGEX_ICU_INSTANCES
...
#if !defined(STREAMS_BOOST_NO_MEMBER_TEMPLATES) && !defined(__IBMCPP__)
template <class InputIterator>
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              streams_boost::regex_constants::syntax_option_type opt, 
                              const streams_boost::mpl::int_<1>*)
{
   typedef streams_boost::u8_to_u32_iterator<InputIterator, UChar32> conv_type;
...
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              streams_boost::regex_constants::syntax_option_type opt, 
                              const streams_boost::mpl::int_<2>*)
{
   typedef streams_boost::u16_to_u32_iterator<InputIterator, UChar32> conv_type;
   return u32regex(conv_type(i), conv_type(j), opt);
}
...
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              streams_boost::regex_constants::syntax_option_type opt, 
                              const streams_boost::mpl::int_<4>*)
{
...
inline u32regex make_u32regex(InputIterator i, 
                              ...
                              streams_boost::regex_constants::syntax_option_type opt)
{
   return re_detail::do_make_u32regex(i, j, opt, static_cast<streams_boost::mpl::int_<sizeof(*i)> const*>(0));
}
//
// construction from UTF-8 nul-terminated strings:
//
inline u32regex make_u32regex(const char* p, streams_boost::regex_constants::syntax_option_type opt = streams_boost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + std::strlen(p), opt, static_cast<streams_boost::mpl::int_<1> const*>(0));
}
inline u32regex make_u32regex(const unsigned char* p, streams_boost::regex_constants::syntax_option_type opt = streams_boost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + std::strlen(reinterpret_cast<const char*>(p)), opt, static_cast<streams_boost::mpl::int_<1> const*>(0));
}
//
// construction from UTF-16 nul-terminated strings:
//
#ifndef STREAMS_BOOST_NO_WREGEX
inline u32regex make_u32regex(const wchar_t* p, streams_boost::regex_constants::syntax_option_type opt = streams_boost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + std::wcslen(p), opt, static_cast<streams_boost::mpl::int_<sizeof(wchar_t)> const*>(0));
}
#endif
#if !defined(U_WCHAR_IS_UTF16) && (U_SIZEOF_WCHAR_T != 2)
inline u32regex make_u32regex(const UChar* p, streams_boost::regex_constants::syntax_option_type opt = streams_boost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + u_strlen(p), opt, static_cast<streams_boost::mpl::int_<2> const*>(0));
}
#endif
//
...
inline u32regex make_u32regex(const std::basic_string<C, T, A>& s, streams_boost::regex_constants::syntax_option_type opt = streams_boost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(s.begin(), s.end(), opt, static_cast<streams_boost::mpl::int_<sizeof(C)> const*>(0));
}
//
// Construction from ICU string type:
//
inline u32regex make_u32regex(const U_NAMESPACE_QUALIFIER UnicodeString& s, streams_boost::regex_constants::syntax_option_type opt = streams_boost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(s.getBuffer(), s.getBuffer() + s.length(), opt, static_cast<streams_boost::mpl::int_<2> const*>(0));
}
...
inline bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 streams_boost::mpl::int_<4> const*)
{
   return ::streams_boost::regex_match(first, last, m, e, flags);
}
template <class BidiIterator, class Allocator>
bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 const u32regex& e, 
                 match_flag_type flags,
                 streams_boost::mpl::int_<2> const*)
{
   typedef u16_to_u32_iterator<BidiIterator, UChar32> conv_type;
   typedef match_results<conv_type>                   match_type;
   typedef typename match_type::allocator_type        alloc_type;
   match_type what;
   bool result = ::streams_boost::regex_match(conv_type(first), conv_type(last), what, e, flags);
...
bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 const u32regex& e, 
                 match_flag_type flags,
                 streams_boost::mpl::int_<1> const*)
{
...
#if !defined(U_WCHAR_IS_UTF16) && (U_SIZEOF_WCHAR_T != 2) && !defined(STREAMS_BOOST_NO_WREGEX)
...
inline bool do_regex_search(BidiIterator first, BidiIterator last, 
                 ...
                 streams_boost::mpl::int_<4> const*)
{
   return ::streams_boost::regex_search(first, last, m, e, flags, base);
}
template <class BidiIterator, class Allocator>
                 ...
                 streams_boost::mpl::int_<2> const*)
{
   ...
   typedef typename match_type::allocator_type        alloc_type;
   match_type what;
   bool result = ::streams_boost::regex_search(conv_type(first), conv_type(last), what, e, flags, conv_type(base));
   // copy results across to m:
   if(result) copy_results(m, what);
   return result;
}
...
namespace re_detail{
template <class I>
inline std::pair< streams_boost::u8_to_u32_iterator<I>, streams_boost::u8_to_u32_iterator<I> >
   make_utf32_seq(I i, I j, mpl::int_<1> const*)
{
   return std::pair< streams_boost::u8_to_u32_iterator<I>, streams_boost::u8_to_u32_iterator<I> >(streams_boost::u8_to_u32_iterator<I>(i), streams_boost::u8_to_u32_iterator<I>(j));
}
template <class I>
inline std::pair< streams_boost::u16_to_u32_iterator<I>, streams_boost::u16_to_u32_iterator<I> >
   make_utf32_seq(I i, I j, mpl::int_<2> const*)
{
   return std::pair< streams_boost::u16_to_u32_iterator<I>, streams_boost::u16_to_u32_iterator<I> >(streams_boost::u16_to_u32_iterator<I>(i), streams_boost::u16_to_u32_iterator<I>(j));
}
template <class I>
inline std::pair< I, I >
...
inline std::pair< streams_boost::u8_to_u32_iterator<const charT*>, streams_boost::u8_to_u32_iterator<const charT*> >
   make_utf32_seq(const charT* p, mpl::int_<1> const*)
{
   return std::pair< streams_boost::u8_to_u32_iterator<const charT*>, streams_boost::u8_to_u32_iterator<const charT*> >(streams_boost::u8_to_u32_iterator<const charT*>(p), streams_boost::u8_to_u32_iterator<const charT*>(p+std::strlen((const char*)p)));
}
template <class charT>
inline std::pair< streams_boost::u16_to_u32_iterator<const charT*>, streams_boost::u16_to_u32_iterator<const charT*> >
   make_utf32_seq(const charT* p, mpl::int_<2> const*)
{
   return std::pair< streams_boost::u16_to_u32_iterator<const charT*>, streams_boost::u16_to_u32_iterator<const charT*> >(streams_boost::u16_to_u32_iterator<const charT*>(p), streams_boost::u16_to_u32_iterator<const charT*>(p+u_strlen((const UChar*)p)));
}
template <class charT>
                                 ...
                                 )
{
   ...
   else
   {
      ...
      while(i != j)
      {
         ...
         if(f.size())
            out = ::streams_boost::re_detail::regex_format_imp(out, *i, &*f.begin(), &*f.begin() + f.size(), flags, e.get_traits());
         else
            out = ::streams_boost::re_detail::regex_format_imp(out, *i, static_cast<UChar32 const*>(0), static_cast<UChar32 const*>(0), flags, e.get_traits());
         last_m = (*i)[0].second;
...
#include <streams_boost/regex/v4/u32regex_iterator.hpp>
#include <streams_boost/regex/v4/u32regex_token_iterator.hpp>
