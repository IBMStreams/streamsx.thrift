...
#ifndef STREAMS_BOOST_REGEX_CONCEPTS_HPP_INCLUDED
#define STREAMS_BOOST_REGEX_CONCEPTS_HPP_INCLUDED
...
#ifndef STREAMS_BOOST_TEST_TR1_REGEX
...
//
#ifndef STREAMS_BOOST_TEST_TR1_REGEX
namespace global_regex_namespace = ::streams_boost;
#else
...
struct BaseRegexConcept
{
   ...
   void global_constraints()
   {
      ...
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_enum<global_regex_namespace::regex_constants::error_type>::value));
      ...
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_base_and_derived<std::runtime_error, global_regex_namespace::regex_error>::value  ));
   ...
   void constraints() 
   {
      ...
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same< flag_type, global_regex_namespace::regex_constants::syntax_option_type>::value));
      flag_type opts
         = Regex::icase
         | Regex::nosubs
         | Regex::optimize
      ...
      // sub_match:
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_base_and_derived<std::pair<BidiIterator, BidiIterator>, sub_match_type>::value));
      ...
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<sub_value_type, value_type>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<sub_iter_type, BidiIterator>::value));
      ...
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rit_regex_type, Regex>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rit_value_type, match_results_type>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rit_difference_type, std::ptrdiff_t>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rit_pointer, const match_results_type*>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rit_reference, const match_results_type&>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_convertible<rit_iterator_category*, std::forward_iterator_tag*>::value));
      ...
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rtit_regex_type, Regex>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rtit_value_type, sub_match_type>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rtit_difference_type, std::ptrdiff_t>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rtit_pointer, const sub_match_type*>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_same<rtit_reference, const sub_match_type&>::value));
      STREAMS_BOOST_STATIC_ASSERT((::streams_boost::is_convertible<rtit_iterator_category*, std::forward_iterator_tag*>::value));
      // this takes care of most of the checks needed:
...
struct RegexConcept
{
   ...
   typedef streams_boost::bidirectional_iterator_archetype<value_type> BidiIterator;
   typedef global_regex_namespace::sub_match<BidiIterator> sub_match_type;
   typedef global_regex_namespace::match_results<BidiIterator> match_results_type;
   typedef output_iterator_archetype<value_type> OutIterator;
...
#ifndef STREAMS_BOOST_REGEX_TEST_STD
...
#endif // STREAMS_BOOST_REGEX_TEST_STD
