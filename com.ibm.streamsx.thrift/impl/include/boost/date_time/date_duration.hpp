#ifndef DATE_TIME_DATE_DURATION___STREAMS
#define DATE_TIME_DATE_DURATION___STREAMS
...
namespace date_time {
  ...
  class date_duration : private
              streams_boost::less_than_comparable1< date_duration< duration_rep_traits >
            , streams_boost::equality_comparable1< date_duration< duration_rep_traits >
            , streams_boost::addable1< date_duration< duration_rep_traits >
            , streams_boost::subtractable1< date_duration< duration_rep_traits >
            , streams_boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  { 
  public:
  ...
  {
    typedef long int_type;
    typedef streams_boost::date_time::int_adapter<long> impl_type;
