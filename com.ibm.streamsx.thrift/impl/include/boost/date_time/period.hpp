#ifndef DATE_TIME_PERIOD_STREAMS_HPP___
#define DATE_TIME_PERIOD_STREAMS_HPP___
...
namespace date_time {
  ...
  class period : private
      streams_boost::less_than_comparable<period<point_rep, duration_rep> 
    , streams_boost::equality_comparable< period<point_rep, duration_rep> 
    > >
  {
  public:
