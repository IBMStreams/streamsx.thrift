#ifndef GREGORIAN_SERIALIZE_STREAMS_HPP___
#define GREGORIAN_SERIALIZE_STREAMS_HPP___
...
// NOTE: these macros define template functions in the streams_boost::serialization namespace.
// They must be expanded *outside* of any namespace
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::date_duration)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::date_duration::duration_rep)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::date_period)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::greg_month)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::greg_day)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::greg_weekday)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::partial_date)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::nth_kday_of_month)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::first_kday_of_month)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::last_kday_of_month)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::first_kday_before)
STREAMS_BOOST_SERIALIZATION_SPLIT_FREE(::streams_boost::gregorian::first_kday_after)
...
inline void serialize(Archive & ar,                               
                      ::streams_boost::gregorian::date & d,
...
void save(Archive & ar, 
          const ::streams_boost::gregorian::date & d, 
          ...
          unsigned int /*version*/)
{
  ...
  ar & make_nvp("date", ds);
  try{
    d = ::streams_boost::gregorian::from_undelimited_string(ds);
