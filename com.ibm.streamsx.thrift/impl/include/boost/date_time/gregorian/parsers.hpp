#ifndef GREGORIAN_PARSERS_STREAMS_HPP___
#define GREGORIAN_PARSERS_STREAMS_HPP___
...
namespace gregorian {
   ...
   * return 'not_special' */
  STREAMS_BOOST_DATE_TIME_DECL special_values special_value_from_string(const std::string& s);
