#ifndef GREG_DATE_STREAMS_STREAMS_STREAMS_HPP___
#define GREG_DATE_STREAMS_STREAMS_STREAMS_HPP___
   ...
   public:
      ...
      : date_time::date<date, gregorian_calendar, date_duration>(y, m, d)
    {
      if (gregorian_calendar::end_of_month_day(y, m) < d) {
        streams_boost::throw_exception(bad_day_of_month(std::string("Day of month is not valid for year")));
      }
    }
