#ifndef GREG_DURATION_STREAMS_HPP___
#define GREG_DURATION_STREAMS_HPP___
...
#include <streams_boost/date_time/date_duration.hpp>
...
namespace gregorian {
  ...
  typedef streams_boost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public streams_boost::date_time::date_duration< date_duration_rep >
  {
    typedef streams_boost::date_time::date_duration< date_duration_rep > base_type;
...
#include <streams_boost/date_time/date_duration_types.hpp>
#endif
