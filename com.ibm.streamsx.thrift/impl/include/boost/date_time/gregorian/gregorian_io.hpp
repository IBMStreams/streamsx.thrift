#ifndef DATE_TIME_GREGORIAN_IO_STREAMS_STREAMS_STREAMS_HPP__
#define DATE_TIME_GREGORIAN_IO_STREAMS_STREAMS_STREAMS_HPP__
...
#include <streams_boost/io/ios_state.hpp>
#include <streams_boost/date_time/date_facet.hpp>
#include <streams_boost/date_time/period_parser.hpp>
#include <streams_boost/date_time/period_formatter.hpp>
#include <streams_boost/date_time/special_values_parser.hpp>
#include <streams_boost/date_time/special_values_formatter.hpp>
#include <streams_boost/date_time/gregorian/gregorian_types.hpp>
#include <streams_boost/date_time/gregorian/conversion.hpp> // to_tm will be needed in the facets

namespace streams_boost {
namespace gregorian {


  typedef streams_boost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef streams_boost::date_time::period_formatter<char>    period_formatter;
  
  typedef streams_boost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef streams_boost::date_time::date_facet<date,char>    date_facet;

  typedef streams_boost::date_time::period_parser<date,char>       period_parser;
  typedef streams_boost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef streams_boost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef streams_boost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef streams_boost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef streams_boost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef streams_boost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef streams_boost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::date& d) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    streams_boost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::date_duration& dd) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::date_period& dp) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::greg_month& gm) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::greg_weekday& gw) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::partial_date& pd) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::nth_day_of_the_week_in_month& nkd) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::first_day_of_the_week_in_month& fkd) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::last_day_of_the_week_in_month& lkd) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::first_day_of_the_week_after& fda) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const streams_boost::gregorian::first_day_of_the_week_before& fdb) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
...
#endif // DATE_TIME_GREGORIAN_IO_STREAMS_STREAMS_STREAMS_HPP__
