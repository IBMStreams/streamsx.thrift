...
#ifndef DATETIME_SPECIAL_VALUE_FORMATTER_STREAMS_HPP___
#define DATETIME_SPECIAL_VALUE_FORMATTER_STREAMS_HPP___
...
namespace streams_boost { namespace date_time {
  ...
  public:
    ...
    OutItrT put_special(OutItrT next, 
                        const streams_boost::date_time::special_values& value) const 
    {
