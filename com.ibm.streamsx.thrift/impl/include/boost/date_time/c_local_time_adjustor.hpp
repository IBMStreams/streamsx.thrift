#ifndef DATE_TIME_C_LOCAL_TIME_ADJUSTOR_STREAMS_STREAMS_HPP__
#define DATE_TIME_C_LOCAL_TIME_ADJUSTOR_STREAMS_STREAMS_HPP__
  ...
  public:
    ...
    static time_type utc_to_local(const time_type& t)
    {
      ...
      if (t < time_t_start_time) {
        streams_boost::throw_exception(std::out_of_range("Cannot convert dates prior to Jan 1, 1970"));
        STREAMS_BOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_t_start_time); // should never reach
      }
