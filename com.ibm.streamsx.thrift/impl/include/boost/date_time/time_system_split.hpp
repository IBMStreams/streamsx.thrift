#ifndef DATE_TIME_TIME_SYSTEM_SPLIT_STREAMS_HPP
#define DATE_TIME_TIME_SYSTEM_SPLIT_STREAMS_HPP
...
#if (defined(STREAMS_BOOST_DATE_TIME_NO_MEMBER_INIT))  
  template<typename config, streams_boost::int32_t ticks_per_second>
#else
...
#else
   private:
     STREAMS_BOOST_STATIC_CONSTANT(int_type, ticks_per_day = INT64_C(86400) * config::tick_per_second);
   public:
