#ifndef DATE_TIME_DATE_NAMES_PUT_STREAMS_STREAMS_HPP___
#define DATE_TIME_DATE_NAMES_PUT_STREAMS_STREAMS_HPP___
...
#include "streams_boost/date_time/locale_config.hpp" // set STREAMS_BOOST_DATE_TIME_NO_LOCALE
...
namespace date_time {
    ...
    protected:
      ...
      {
        string_type s1(streams_boost::lexical_cast<string_type>(s));
...
} } //namespace streams_boost::date_time
