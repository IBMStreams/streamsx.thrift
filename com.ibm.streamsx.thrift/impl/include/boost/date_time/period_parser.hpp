...
#ifndef DATETIME_PERIOD_PARSER_STREAMS_HPP___
#define DATETIME_PERIOD_PARSER_STREAMS_HPP___
...
namespace streams_boost { namespace date_time {
  ...
  private:
                       ...
                       const string_type& delim) const
    {
      ...
      if(s != delim) {
        streams_boost::throw_exception(std::ios_base::failure("Parse failed. Expected '"
...
#endif // DATETIME_PERIOD_PARSER_STREAMS_HPP___
