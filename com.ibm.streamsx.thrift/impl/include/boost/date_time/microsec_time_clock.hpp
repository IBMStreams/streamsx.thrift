#ifndef DATE_TIME_HIGHRES_TIME_CLOCK_STREAMS_HPP___
#define DATE_TIME_HIGHRES_TIME_CLOCK_STREAMS_HPP___
...
namespace date_time {
  ...
  private:
    ...
    {
#ifdef STREAMS_BOOST_HAS_GETTIMEOFDAY
      timeval tv;
      gettimeofday(&tv, 0); //gettimeofday does not support TZ adjust on Linux.
      std::time_t t = tv.tv_sec;
      streams_boost::uint32_t sub_sec = tv.tv_usec;
#elif defined(STREAMS_BOOST_HAS_FTIME)
      winapi::file_time ft;
      ...
      streams_boost::uint32_t sub_sec = static_cast<streams_boost::uint32_t>(micros % 1000000UL);
#else
#error Internal Boost.DateTime error: STREAMS_BOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK is defined, however neither gettimeofday nor FILETIME support is detected.
#endif
...
#endif //STREAMS_BOOST_DATE_TIME_HAS_HIGH_PRECISION_CLOCK
