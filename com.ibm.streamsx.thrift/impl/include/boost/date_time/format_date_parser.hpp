...
#ifndef DATE_TIME_FORMAT_DATE_PARSER_STREAMS_STREAMS_HPP__
#define DATE_TIME_FORMAT_DATE_PARSER_STREAMS_STREAMS_HPP__
...
#include "streams_boost/date_time/strings_from_facet.hpp"
                    ...
                    const charT& fill_char)
{
  ...
  try {
    i = streams_boost::lexical_cast<int_type>(mr.cache);
                  ...
                  unsigned int max_length)
{
  ...
  int_type i = -1;
  if(!s.empty()) {
    i = streams_boost::lexical_cast<int_type>(s);
  }
  return i;
}
