#ifndef DATE_TIME_TIME_STREAMS_HPP___
#define DATE_TIME_TIME_STREAMS_HPP___
...
namespace date_time {
  ...
  */
  ...
  public:
    ...
    //!Equality operator -- others generated by streams_boost::equality_comparable
    bool operator==(const time_type& rhs) const
    {
      return time_system::is_equal(time_,rhs.time_);
    }
    //!Equality operator -- others generated by streams_boost::less_than_comparable
    bool operator<(const time_type& rhs) const
    {
...
} } //namespace date_time::streams_boost
