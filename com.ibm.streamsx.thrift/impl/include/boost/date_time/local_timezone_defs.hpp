#ifndef DATE_TIME_LOCAL_TIMEZONE_DEFS_STREAMS_STREAMS_HPP__
#define DATE_TIME_LOCAL_TIMEZONE_DEFS_STREAMS_STREAMS_HPP__
...
namespace streams_boost {
  namespace date_time {
    ...
    /*! This class is used to configure dst_calc_engine template typically
        as follows:
        @code
          using namespace streams_boost::gregorian;
          using namespace streams_boost::posix_time;
          typedef us_dst_trait<date> us_dst_traits;
          typedef streams_boost::date_time::dst_calc_engine<date, time_duration, 
                                                    us_dst_traits>  
                                                    us_dst_calc;
          ...
          if (us_dst::local_is_dst(t.date(), t.time_of_day()) 
              == streams_boost::date_time::is_not_in_dst) 
          {
