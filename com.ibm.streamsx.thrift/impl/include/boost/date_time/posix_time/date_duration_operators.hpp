#ifndef DATE_DURATION_OPERATORS_STREAMS_HPP___
#define DATE_DURATION_OPERATORS_STREAMS_HPP___
...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const streams_boost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const streams_boost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const streams_boost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const streams_boost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
...
#endif // DATE_DURATION_OPERATORS_STREAMS_HPP___
