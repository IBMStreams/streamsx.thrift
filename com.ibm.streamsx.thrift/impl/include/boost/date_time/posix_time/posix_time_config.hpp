#ifndef POSIX_TIME_CONFIG_STREAMS_HPP___
#define POSIX_TIME_CONFIG_STREAMS_HPP___
...
#include <streams_boost/date_time/time_duration.hpp>
#include <streams_boost/date_time/time_resolution_traits.hpp>
#include <streams_boost/date_time/gregorian/gregorian_types.hpp>
#include <streams_boost/date_time/wrapping_int.hpp>
...
//#define STREAMS_BOOST_GDTL_POSIX_TIME_STD_CONFIG

#ifdef STREAMS_BOOST_DATE_TIME_POSIX_TIME_STD_CONFIG
  // set up conditional test compilations
#define STREAMS_BOOST_DATE_TIME_HAS_MILLISECONDS
#define STREAMS_BOOST_DATE_TIME_HAS_MICROSECONDS
#define STREAMS_BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<streams_boost::date_time::time_resolution_traits_adapted64_impl, streams_boost::date_time::nano,
    1000000000, 9 > time_res_traits;
#else
  // set up conditional test compilations
#define STREAMS_BOOST_DATE_TIME_HAS_MILLISECONDS
#define STREAMS_BOOST_DATE_TIME_HAS_MICROSECONDS
#undef  STREAMS_BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    streams_boost::date_time::time_resolution_traits_adapted64_impl, streams_boost::date_time::micro,
                                            1000000, 6 > time_res_traits;


// #undef STREAMS_BOOST_DATE_TIME_HAS_MILLISECONDS
// #undef STREAMS_BOOST_DATE_TIME_HAS_MICROSECONDS
// #undef STREAMS_BOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<streams_boost::int64_t, streams_boost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(streams_boost::date_time::special_values sv) :
...
#else
    STREAMS_BOOST_STATIC_CONSTANT(streams_boost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef streams_boost::int64_t time_rep_type;
...
#if (defined(STREAMS_BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    STREAMS_BOOST_STATIC_CONSTANT(streams_boost::int64_t, tick_per_second = 1000000);
#endif
  };
