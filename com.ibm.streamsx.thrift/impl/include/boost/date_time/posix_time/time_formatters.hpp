#ifndef POSIXTIME_FORMATTERS_STREAMS_HPP___
#define POSIXTIME_FORMATTERS_STREAMS_HPP___
...
#include <streams_boost/date_time/iso_format.hpp>
#include <streams_boost/date_time/date_format_simple.hpp>
#include <streams_boost/date_time/posix_time/posix_time_types.hpp>
#include <streams_boost/date_time/time_formatting_streams.hpp>
 ...
 * STREAMS_BOOST_DATE_TIME_INCLUDE_LIMITED_HEADERS, is located in
...
namespace posix_time {
  ...
  inline std::basic_string<charT> to_simple_string_type(time_duration td) {
    ...
    if(td.is_special()) {
      ...
      streams_boost::int64_t frac_sec =
