#ifndef POSIX_TIME_PRE133_OPERATORS_STREAMS_HPP___
#define POSIX_TIME_PRE133_OPERATORS_STREAMS_HPP___
...
//The following code is removed for configurations with poor std::locale support (eg: MSVC6, gcc 2.9x)
  ...
  {
    typedef streams_boost::date_time::ostream_time_duration_formatter<time_duration, charT> duration_formatter;
  ...
  {
    typedef streams_boost::date_time::ostream_time_formatter<ptime, charT> time_formatter;
  ...
  {
    typedef streams_boost::date_time::ostream_time_period_formatter<time_period, charT> period_formatter;
...
#endif //STREAMS_BOOST_DATE_TIME_NO_LOCALE

} } // namespaces

#endif // POSIX_TIME_PRE133_OPERATORS_STREAMS_HPP___
