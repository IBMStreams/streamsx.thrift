#ifndef DATE_TIME_LOCAL_TIME_ADJUSTOR_STREAMS_STREAMS_HPP__
#define DATE_TIME_LOCAL_TIME_ADJUSTOR_STREAMS_STREAMS_HPP__
...
#include <streams_boost/date_time/time_defs.hpp> // streams_boost::date_time::dst_flags
#include <streams_boost/date_time/special_defs.hpp> // not_a_date_time
  ...
  namespace date_time {
    ...
    public:
      ...
      static time_duration_type utc_to_local_offset(const time_type& t)
      {
        ...
        streams_boost::throw_exception(std::out_of_range("Unreachable case"));
        STREAMS_BOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
                                                    ...
                                                    date_time::dst_flags dst=date_time::calculate) 
      {
        ...
        streams_boost::throw_exception(std::out_of_range("Time label invalid"));
        STREAMS_BOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
