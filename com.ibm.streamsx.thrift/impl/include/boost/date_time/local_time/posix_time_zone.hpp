...
#include <streams_boost/date_time/gregorian/gregorian.hpp>
...
namespace local_time{
  ...
  typedef streams_boost::date_time::dst_adjustment_offsets<streams_boost::posix_time::time_duration> dst_adjustment_offsets;
   ...
   * A streams_boost::local_time::bad_offset exception will be thrown for:<br>
   ...
   * A streams_boost::local_time::bad_adjustment exception will be thrown for:<br>
  ...
  public:
    typedef streams_boost::posix_time::time_duration time_duration_type;
    ...
    typedef typename streams_boost::tokenizer<char_separator_type,
                             typename string_type::const_iterator,
    ...
    virtual string_type to_posix_string() const
    {
      ...
      ss.fill('0');
      streams_boost::shared_ptr<dst_calc_rule> no_rules;
      // std
      ss << std_zone_abbrev();
      // offset
  ...
  private:
    ...
    streams_boost::shared_ptr<dst_calc_rule> dst_calc_rules_;
    ...
    void calc_zone(const string_type& obj){
      ...
      if(sit != obj_end){
        ...
        {
          streams_boost::throw_exception(bad_offset(posix_time::to_simple_string(base_utc_offset_)));
        }
      }
      ...
      if(sit != obj_end){
        ...
        {
          streams_boost::throw_exception(bad_adjustment(posix_time::to_simple_string(dst_offsets_.dst_adjust_)));
        }
      }
    ...
    void calc_rules(const string_type& start, const string_type& end){
      ...
      {
        streams_boost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_start_offset_)));
      }
      ...
      {
        streams_boost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_end_offset_)));
      }
    }
...
} } // namespace streams_boost::local_time
