#ifndef LOCAL_TIME_LOCAL_TIME_TYPES_STREAMS_HPP__
#define LOCAL_TIME_LOCAL_TIME_TYPES_STREAMS_HPP__
...
#include "streams_boost/date_time/local_time/date_duration_operators.hpp"
#endif //STREAMS_BOOST_DATE_TIME_OPTIONAL_GREGORIAN_TYPES
#include "streams_boost/date_time/local_time/custom_time_zone.hpp"

namespace streams_boost {
namespace local_time {

  typedef streams_boost::date_time::period<local_date_time, 
                                   streams_boost::posix_time::time_duration> local_time_period;
  ...
  typedef streams_boost::shared_ptr<time_zone> time_zone_ptr;
  typedef streams_boost::shared_ptr<wtime_zone> wtime_zone_ptr;
...
#endif // LOCAL_TIME_LOCAL_TIME_TYPES_STREAMS_HPP__
