#ifndef LOCAL_TIME_DATE_DURATION_OPERATORS_STREAMS_STREAMS_STREAMS_HPP___
#define LOCAL_TIME_DATE_DURATION_OPERATORS_STREAMS_STREAMS_STREAMS_HPP___
...
namespace local_time {
  ...
  inline
  local_date_time 
  operator+(const local_date_time& t, const streams_boost::gregorian::months& m)
  {
  ...
  inline
  local_date_time 
  operator+=(local_date_time& t, const streams_boost::gregorian::months& m)
  {
    return t += m.get_offset(t.utc_time().date());
  }
  ...
  inline
  local_date_time 
  operator+(const local_date_time& t, const streams_boost::gregorian::years& y)
  {
  ...
  inline
  local_date_time 
  operator+=(local_date_time& t, const streams_boost::gregorian::years& y)
  {
    return t += y.get_offset(t.utc_time().date());
  }
...
#endif // LOCAL_TIME_DATE_DURATION_OPERATORS_STREAMS_STREAMS_STREAMS_HPP___
