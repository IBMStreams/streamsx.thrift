#ifndef STREAMS_BOOST_DATE_TIME_LOCAL_TIME_IO_STREAMS_STREAMS_STREAMS_HPP__
#define STREAMS_BOOST_DATE_TIME_LOCAL_TIME_IO_STREAMS_STREAMS_STREAMS_HPP__
...
#include <streams_boost/date_time/time_facet.hpp>
#include <streams_boost/date_time/string_convert.hpp>
#include <streams_boost/date_time/local_time/local_date_time.hpp>
#include <streams_boost/date_time/local_time/posix_time_zone.hpp>
#include <streams_boost/date_time/local_time/conversion.hpp> // to_tm will be needed in the facets

namespace streams_boost {
namespace local_time {

  typedef streams_boost::date_time::time_facet<local_date_time, wchar_t> wlocal_time_facet;
  typedef streams_boost::date_time::time_facet<local_date_time, char>     local_time_facet;

  typedef streams_boost::date_time::time_input_facet<local_date_time::utc_time_type,wchar_t> wlocal_time_input_facet;
  typedef streams_boost::date_time::time_input_facet<local_date_time::utc_time_type,char>     local_time_input_facet;
  ...
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
             const streams_boost::local_time::local_time_period& p) {
    streams_boost::io::ios_flags_saver iflags(os);
    typedef streams_boost::date_time::time_facet<local_date_time, CharT> custom_facet;
    typedef std::time_put<CharT> std_time_facet;
    std::ostreambuf_iterator<CharT> oitr(os);
  ...
  inline
  std::basic_istream<CharT, Traits>&
  operator>>(std::basic_istream<CharT, Traits>& is, streams_boost::local_time::local_time_period& tp)
  {
    streams_boost::io::ios_flags_saver iflags(is);
    typename std::basic_istream<CharT, Traits>::sentry strm_sentry(is, false);
    if (strm_sentry) {
...
#endif // STREAMS_BOOST_DATE_TIME_LOCAL_TIME_IO_STREAMS_STREAMS_STREAMS_HPP__
