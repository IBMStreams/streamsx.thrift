#ifndef LOCAL_TIME_CUSTOM_TIME_ZONE_STREAMS_HPP__
#define LOCAL_TIME_CUSTOM_TIME_ZONE_STREAMS_HPP__
...
namespace local_time {
  ...
  //typedef streams_boost::date_time::time_zone_names time_zone_names;
  typedef streams_boost::date_time::dst_adjustment_offsets<streams_boost::posix_time::time_duration> dst_adjustment_offsets;
  //typedef streams_boost::date_time::time_zone_base<streams_boost::posix_time::ptime> time_zone;
  typedef streams_boost::shared_ptr<dst_calc_rule> dst_calc_rule_ptr;
  ...
  public:
    ...
    custom_time_zone_base(const time_zone_names& zone_names,   
                     ...
                     streams_boost::shared_ptr<dst_calc_rule> calc_rule) :
