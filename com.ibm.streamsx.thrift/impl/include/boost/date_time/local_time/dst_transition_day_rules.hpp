#ifndef LOCAL_TIME_DST_TRANSITION_DAY_RULES_STREAMS_HPP__
#define LOCAL_TIME_DST_TRANSITION_DAY_RULES_STREAMS_HPP__
...
#include "streams_boost/date_time/dst_transition_generators.hpp"
