#ifndef DATE_TIME_TIME_FORMATTING_STREAMS_STREAMS_HPP___
#define DATE_TIME_TIME_FORMATTING_STREAMS_STREAMS_HPP___
...
#include <iomanip>
#include <iostream>
#include <streams_boost/date_time/date_formatting_locales.hpp>
