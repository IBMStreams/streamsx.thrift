#ifndef DATE_TIME_TIME_DURATION_STREAMS_HPP___
#define DATE_TIME_TIME_DURATION_STREAMS_HPP___
...
namespace date_time {
  ...
  */
  ...
  class time_duration : private
      streams_boost::less_than_comparable<T
    , streams_boost::equality_comparable<T
    > >
   ...
   */
  template<class base_duration, streams_boost::int64_t frac_of_second>
  class subsecond_duration : public base_duration
  {
  public:
    typedef typename base_duration::traits_type traits_type;
    explicit subsecond_duration(streams_boost::int64_t ss) :
