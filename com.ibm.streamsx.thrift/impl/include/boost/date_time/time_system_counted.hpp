#ifndef DATE_TIME_TIME_SYSTEM_COUNTED_STREAMS_HPP
#define DATE_TIME_TIME_SYSTEM_COUNTED_STREAMS_HPP
...
namespace date_time {
  ...
  struct counted_time_rep
  {
    ...
    {
      /* resolution_traits::as_number returns a streams_boost::int64_t & 
       * frac_sec_per_day is also a streams_boost::int64_t so, naturally, 
       * the division operation returns a streams_boost::int64_t. 
