...
#ifndef DATE_TIME_DATE_GENERATOR_PARSER_STREAMS_STREAMS_HPP__
#define DATE_TIME_DATE_GENERATOR_PARSER_STREAMS_STREAMS_HPP__
...
#include <streams_boost/date_time/string_parse_tree.hpp>
                      ...
                      const facet_type& facet) const
    {
      ...
      switch(mr.current_match) {
        ...
        default:
        {
          ...
          STREAMS_BOOST_DATE_TIME_UNREACHABLE_EXPRESSION(wn = nth_kday_type::first);
        }
      }                                         // week num
...
#endif // DATE_TIME_DATE_GENERATOR_PARSER_STREAMS_STREAMS_HPP__
