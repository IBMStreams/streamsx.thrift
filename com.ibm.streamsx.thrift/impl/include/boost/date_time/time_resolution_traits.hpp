#ifndef DATE_TIME_TIME_RESOLUTION_TRAITS_STREAMS_HPP
#define DATE_TIME_TIME_RESOLUTION_TRAITS_STREAMS_HPP
...
#include <streams_boost/date_time/time_defs.hpp>
#include <streams_boost/date_time/int_adapter.hpp>
...
namespace date_time {
  ...
  struct time_resolution_traits_bi32_impl {
    typedef streams_boost::int32_t int_type;
    typedef streams_boost::int32_t impl_type;
  ...
  struct time_resolution_traits_adapted32_impl {
    typedef streams_boost::int32_t int_type;
    typedef streams_boost::date_time::int_adapter<streams_boost::int32_t> impl_type;
  ...
  struct time_resolution_traits_bi64_impl {
    typedef streams_boost::int64_t int_type;
    typedef streams_boost::int64_t impl_type;
    static int_type as_number(impl_type i){ return i;}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return false;}
  };
  ...
  struct time_resolution_traits_adapted64_impl {
    typedef streams_boost::int64_t int_type;
    typedef streams_boost::date_time::int_adapter<streams_boost::int64_t> impl_type;
    static int_type as_number(impl_type i){ return i.as_number();}
    //! Used to determine if implemented type is int_adapter or int
    static bool is_adapted() { return true;}
  };
  ...
  template<typename frac_sec_type,
           ...
           streams_boost::int64_t resolution_adjust,
#else
           typename frac_sec_type::int_type resolution_adjust,
#endif
           unsigned short frac_digits,
           typename v_type = streams_boost::int32_t >
...
#if (defined(STREAMS_BOOST_MSVC) && (_MSC_VER < 1300))
    STREAMS_BOOST_STATIC_CONSTANT(streams_boost::int64_t, ticks_per_second = resolution_adjust);
#else
    STREAMS_BOOST_STATIC_CONSTANT(fractional_seconds_type, ticks_per_second = resolution_adjust);
#endif
