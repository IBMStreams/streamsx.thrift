#ifndef DATE_TIME_TIME_CLOCK_STREAMS_HPP___
#define DATE_TIME_TIME_CLOCK_STREAMS_HPP___
...
namespace date_time {
  ...
  public:
    ...
    static time_type local_time(streams_boost::shared_ptr<time_zone_type> tz_ptr)
    {
