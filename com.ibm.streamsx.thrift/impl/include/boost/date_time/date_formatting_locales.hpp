#ifndef DATE_TIME_DATE_FORMATTING_LOCALES_STREAMS_STREAMS_HPP___
#define DATE_TIME_DATE_FORMATTING_LOCALES_STREAMS_STREAMS_HPP___
...
#include "streams_boost/date_time/date_names_put.hpp"
