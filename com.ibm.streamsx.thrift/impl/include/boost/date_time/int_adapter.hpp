#ifndef _DATE_TIME_INT_ADAPTER_STREAMS_STREAMS_HPP__
#define _DATE_TIME_INT_ADAPTER_STREAMS_STREAMS_HPP__
...
#include "streams_boost/limits.hpp" //work around compilers without limits
#include "streams_boost/date_time/special_defs.hpp"
#include "streams_boost/date_time/locale_config.hpp"
...
public:
  ...
  static  int_adapter max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
    return (::std::numeric_limits<int_type>::max)()-2;
  }
  static  int_adapter min STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION ()
  {
