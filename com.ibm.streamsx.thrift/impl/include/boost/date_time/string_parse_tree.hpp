#ifndef STREAMS_BOOST_DATE_TIME_STRING_PARSE_TREE___STREAMS_STREAMS_HPP__
#define STREAMS_BOOST_DATE_TIME_STRING_PARSE_TREE___STREAMS_STREAMS_HPP__
...
#include "streams_boost/lexical_cast.hpp" //error without?
#include "streams_boost/algorithm/string/case_conv.hpp"
#include <map>
#include <string>
#include <vector>
#include <algorithm>
...
struct string_parse_tree
{
  ...
  string_parse_tree(collection_type names, unsigned int starting_point=0)
  {
    ...
    while (index != names.size() ) {
      string_type s = streams_boost::algorithm::to_lower_copy(names[index]);
