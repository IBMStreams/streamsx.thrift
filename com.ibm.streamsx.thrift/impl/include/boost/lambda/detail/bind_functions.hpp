...
#ifndef STREAMS_BOOST_LAMBDA_BIND_FUNCTIONS_HPP
#define STREAMS_BOOST_LAMBDA_BIND_FUNCTIONS_HPP


namespace streams_boost { 
namespace lambda {

#ifdef STREAMS_BOOST_LAMBDA_INCORRECT_BIND_OVERLOADING
...
template<class T> struct constify_non_funcs {
  typedef typename 
  detail::IF_type<streams_boost::is_function<T>::value,
    streams_boost::add_reference<T>,
    streams_boost::add_const<T>
  >::type type;
};
...
#ifndef STREAMS_BOOST_REF_TO_FUNC_CONFLICTS_WITH_REF_TO_T
...
bind(Result(& a1)()) {
 ...
 #ifndef STREAMS_BOOST_LAMBDA_INCORRECT_BIND_OVERLOADING 
template <class Arg1>
inline const
lambda_functor<
  lambda_functor_base<
