...
#ifndef STREAMS_BOOST_LAMBDA_FUNCTION_ADAPTORS_HPP
#define STREAMS_BOOST_LAMBDA_FUNCTION_ADAPTORS_HPP
...
struct function_adaptor<T Object::*> {
  ...
  template<class Args> class sig { 
    typedef typename streams_boost::tuples::element<1, Args>::type argument_type;

    typedef typename detail::IF<streams_boost::is_const<argument_type>::value,
      typename streams_boost::add_const<T>::type,
      T
    >::RET properly_consted_return_type;

    typedef typename detail::IF<
        streams_boost::is_volatile<properly_consted_return_type>::value,
      typename streams_boost::add_volatile<properly_consted_return_type>::type,
  ...
  public:
    typedef typename 
      streams_boost::add_reference<properly_cvd_return_type>::type type;
  };
