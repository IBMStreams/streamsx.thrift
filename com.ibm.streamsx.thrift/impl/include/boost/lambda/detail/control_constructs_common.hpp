...
#if !defined(STREAMS_BOOST_CONTROL_CONSTRUCTS_COMMON_HPP)
#define STREAMS_BOOST_CONTROL_CONSTRUCTS_COMMON_HPP
...
#endif // STREAMS_BOOST_CONTROL_CONSTRUCTS_COMMON_HPP
