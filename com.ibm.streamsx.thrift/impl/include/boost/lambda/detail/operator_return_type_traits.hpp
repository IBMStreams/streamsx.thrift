...
#ifndef STREAMS_BOOST_LAMBDA_OPERATOR_RETURN_TYPE_TRAITS_HPP
#define STREAMS_BOOST_LAMBDA_OPERATOR_RETURN_TYPE_TRAITS_HPP
...
struct return_type_1<other_action<addressof_action>, A> { 
  ...
  typedef typename detail::IF<
    streams_boost::is_same<type1, detail::unspecified>::value, 
...
template <class A> struct contentsof_type {
  typedef typename streams_boost::indirect_reference<A>::type type; 
};
...
struct pointer_arithmetic_traits<plus_action, A, B> { 
  ...
  typedef typename 
    array_to_pointer<typename streams_boost::remove_reference<A>::type>::type AP;
  typedef typename 
    array_to_pointer<typename streams_boost::remove_reference<B>::type>::type BP;

  static const bool is_pointer_A = streams_boost::is_pointer<AP>::value;
  static const bool is_pointer_B = streams_boost::is_pointer<BP>::value;  
    ...
    streams_boost::is_same<
      typename streams_boost::remove_const<
        typename streams_boost::remove_pointer<
          typename streams_boost::remove_const<AP>::type
        >::type
      >::type,
      typename streams_boost::remove_const<
        typename streams_boost::remove_pointer<
          typename streams_boost::remove_const<BP>::type
        >::type
      >::type
    >::value;
...
struct return_type_2<bitwise_action<Act>, A, B>
{
  ...
  // the apply function
  STREAMS_BOOST_STATIC_ASSERT(!(streams_boost::is_float<plain_A>::value && streams_boost::is_float<plain_B>::value));
...
struct leftshift_type {
private:
  typedef typename streams_boost::remove_reference<A>::type plainA;
public:
...
struct return_type_2<arithmetic_assignment_action<Act>, A, B> { 
  ...
  typedef typename 
    detail::IF<
      streams_boost::is_same<type1, detail::unspecified>::value, 
      typename streams_boost::add_reference<A>::type,
      type1
    >::RET type;
};
...
struct return_type_2<other_action<subscript_action>, A, B> {
  ...
  typedef typename streams_boost::remove_reference<A>::type nonref_A;
  typedef typename streams_boost::remove_reference<B>::type nonref_B;
