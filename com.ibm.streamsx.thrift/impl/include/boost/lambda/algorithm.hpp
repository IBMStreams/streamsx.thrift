...
#ifndef STREAMS_BOOST_LAMBDA_ALGORITHM_HPP
#define STREAMS_BOOST_LAMBDA_ALGORITHM_HPP
...
struct for_each {
  ...
  struct sig { 
    typedef typename streams_boost::remove_const<
        typename streams_boost::tuples::element<3, Args>::type 
     >::type type; 
  };
...
struct transform {
  ...
  struct sig { 
    typedef typename streams_boost::remove_const<
        typename streams_boost::tuples::element<
          streams_boost::tuples::length<Args>::value - 2, 
          Args
      >::type
     >::type type; 
  };
...
struct merge {
  ...
  struct sig { 
    typedef typename streams_boost::remove_const<
        typename streams_boost::tuples::element<5, Args>::type 
     >::type type; 
  };
...
} // end of streams_boost namespace
