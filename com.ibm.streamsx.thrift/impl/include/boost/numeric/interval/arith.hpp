...
#ifndef STREAMS_BOOST_NUMERIC_INTERVAL_ARITH_HPP
#define STREAMS_BOOST_NUMERIC_INTERVAL_ARITH_HPP

#include <streams_boost/config.hpp>
#include <streams_boost/numeric/interval/interval.hpp>
#include <streams_boost/numeric/interval/detail/bugs.hpp>
#include <streams_boost/numeric/interval/detail/test_input.hpp>
#include <streams_boost/numeric/interval/detail/division.hpp>
#include <algorithm>
    ...
    if (interval_lib::user::is_pos(xu))
      if (interval_lib::user::is_neg(yl))
        if (interval_lib::user::is_pos(yu)) // M * M
          return I(min STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(rnd.mul_down(xl, yu), rnd.mul_down(xu, yl)),
                   max STREAMS_BOOST_PREVENT_MACRO_SUBSTITUTION(rnd.mul_up  (xl, yl), rnd.mul_up  (xu, yu)), true);
        else                    // M * N
...
#endif // STREAMS_BOOST_NUMERIC_INTERVAL_ARITH_HPP
