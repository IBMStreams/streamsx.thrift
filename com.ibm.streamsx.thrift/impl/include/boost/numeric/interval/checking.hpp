...
#ifndef STREAMS_BOOST_NUMERIC_INTERVAL_CHECKING_HPP
#define STREAMS_BOOST_NUMERIC_INTERVAL_CHECKING_HPP
...
struct exception_create_empty
{
  void operator()()
  {
    throw std::runtime_error("streams_boost::interval: empty interval created");
  }
};
...
struct exception_invalid_number
{
  void operator()()
  {
    throw std::invalid_argument("streams_boost::interval: invalid number");
  }
};
...
#endif // STREAMS_BOOST_NUMERIC_INTERVAL_CHECKING_HPP
