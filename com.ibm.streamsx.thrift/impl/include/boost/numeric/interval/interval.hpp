...
#ifndef STREAMS_BOOST_NUMERIC_INTERVAL_INTERVAL_HPP
#define STREAMS_BOOST_NUMERIC_INTERVAL_INTERVAL_HPP
...
public:
  comparison_error()
    : std::runtime_error("streams_boost::interval: uncertain comparison")
  { }
};
...
#endif // STREAMS_BOOST_NUMERIC_INTERVAL_INTERVAL_HPP
