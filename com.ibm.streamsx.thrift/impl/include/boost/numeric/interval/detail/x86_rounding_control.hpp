...
#ifndef STREAMS_BOOST_NUMERIC_INTERVAL_DETAIL_X86_ROUNDING_CONTROL_HPP
#define STREAMS_BOOST_NUMERIC_INTERVAL_DETAIL_X86_ROUNDING_CONTROL_HPP

#ifdef __GNUC__
#  include <streams_boost/numeric/interval/detail/x86gcc_rounding_control.hpp>
#elif defined(__BORLANDC__)
#  include <streams_boost/numeric/interval/detail/bcc_rounding_control.hpp>
#elif defined(_MSC_VER)
#  include <streams_boost/numeric/interval/detail/msvc_rounding_control.hpp>
#elif defined(__MWERKS__) || defined(__ICC)
#  define STREAMS_BOOST_NUMERIC_INTERVAL_USE_C99_SUBSYSTEM
...
#ifdef STREAMS_BOOST_NUMERIC_INTERVAL_USE_C99_SUBSYSTEM
typedef c99_rounding x86_rounding_control;
#undef STREAMS_BOOST_NUMERIC_INTERVAL_USE_C99_SUBSYSTEM
#else
...
#endif // STREAMS_BOOST_NUMERIC_INTERVAL_USE_C99_SUBSYSTEM
...
#endif /* STREAMS_BOOST_NUMERIC_INTERVAL_DETAIL_X86_ROUNDING_CONTROL_HPP */
