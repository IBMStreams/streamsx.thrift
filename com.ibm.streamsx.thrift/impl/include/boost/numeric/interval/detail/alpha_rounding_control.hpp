...
#ifndef STREAMS_BOOST_NUMERIC_INTERVAL_DETAIL_ALPHA_ROUNDING_CONTROL_HPP
#define STREAMS_BOOST_NUMERIC_INTERVAL_DETAIL_ALPHA_ROUNDING_CONTROL_HPP
...
#if defined(__GNUC__ )
    typedef union {
    ::streams_boost::long_long_type imode;
    double dmode;
...
#endif /* STREAMS_BOOST_NUMERIC_INTERVAL_DETAIL_ALPHA_ROUNDING_CONTROL_HPP */
