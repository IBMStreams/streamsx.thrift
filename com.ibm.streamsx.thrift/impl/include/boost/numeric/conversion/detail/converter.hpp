...
//
#ifndef STREAMS_BOOST_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP
#define STREAMS_BOOST_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP

#include <functional>

#include "streams_boost/numeric/conversion/detail/meta.hpp"
#include "streams_boost/numeric/conversion/detail/conversion_traits.hpp"
#include "streams_boost/numeric/conversion/bounds.hpp"

#include "streams_boost/type_traits/is_same.hpp"

#include "streams_boost/mpl/integral_c.hpp"

namespace streams_boost { namespace numeric { namespace convdetail
{
...
//--------------------------------------------------------------------------
  ...
  //
  template<class Traits>
  struct trivial_converter_impl : public std::unary_function<  STREAMS_BOOST_DEDUCED_TYPENAME Traits::argument_type
                                                              ,STREAMS_BOOST_DEDUCED_TYPENAME Traits::result_type
                                                            >
  ...
  struct rounding_converter : public std::unary_function<  STREAMS_BOOST_DEDUCED_TYPENAME Traits::argument_type
                                                          ,STREAMS_BOOST_DEDUCED_TYPENAME Traits::result_type
                                                        >
                             ,public RangeChecker
  ...
  struct non_rounding_converter : public std::unary_function< STREAMS_BOOST_DEDUCED_TYPENAME Traits::argument_type
                                                             ,STREAMS_BOOST_DEDUCED_TYPENAME Traits::result_type
                                                           >
                                 ,public RangeChecker
                                 ,public RawConverter
...
//--------------------------------------------------------------------------
  ...
  {
#if STREAMS_BOOST_WORKAROUND(__BORLANDC__, STREAMS_BOOST_TESTED_AT( 0x0561 ) )
...
} } } // namespace streams_boost::numeric::convdetail
