...
// 
#ifndef STREAMS_BOOST_NUMERIC_CONVERSION_DETAIL_META_FLC_12NOV2002_HPP
#define STREAMS_BOOST_NUMERIC_CONVERSION_DETAIL_META_FLC_12NOV2002_HPP
...
namespace streams_boost { namespace numeric { namespace convdetail
{
   ...
   struct equal_to
   {
       ...
       enum { x = ( STREAMS_BOOST_MPL_AUX_VALUE_WKND(T1)::value == STREAMS_BOOST_MPL_AUX_VALUE_WKND(T2)::value ) };
           
       STREAMS_BOOST_STATIC_CONSTANT(bool, value = x);
       ...
       STREAMS_BOOST_STATIC_CONSTANT(bool, value = (
             STREAMS_BOOST_MPL_AUX_VALUE_WKND(T1)::value 
               == STREAMS_BOOST_MPL_AUX_VALUE_WKND(T2)::value
           ));
