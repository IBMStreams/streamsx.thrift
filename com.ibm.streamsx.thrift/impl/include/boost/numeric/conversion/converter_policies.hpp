...
//
#ifndef STREAMS_BOOST_NUMERIC_CONVERSION_CONVERTER_POLICIES_FLC_12NOV2002_HPP
#define STREAMS_BOOST_NUMERIC_CONVERSION_CONVERTER_POLICIES_FLC_12NOV2002_HPP

#include <typeinfo> // for std::bad_cast

#include <streams_boost/config/no_tr1/cmath.hpp> // for std::floor and std::ceil
