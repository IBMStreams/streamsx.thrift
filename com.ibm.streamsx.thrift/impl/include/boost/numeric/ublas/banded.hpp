...
#ifndef _STREAMS_BOOST_UBLAS_BANDED_
#define _STREAMS_BOOST_UBLAS_BANDED_
...
namespace streams_boost { namespace numeric { namespace ublas {
...
#ifdef STREAMS_BOOST_UBLAS_OWN_BANDED
    ...
    public:
        ...
        void swap (banded_adaptor &m) {
            if (this != &m) {
                STREAMS_BOOST_UBLAS_CHECK (lower_ == m.lower_, bad_size ());
                STREAMS_BOOST_UBLAS_CHECK (upper_ == m.upper_, bad_size ());
