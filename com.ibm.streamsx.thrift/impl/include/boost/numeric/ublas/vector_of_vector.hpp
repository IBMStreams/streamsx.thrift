...
#ifndef _STREAMS_BOOST_UBLAS_VECTOR_OF_VECTOR_
#define _STREAMS_BOOST_UBLAS_VECTOR_OF_VECTOR_

#include <streams_boost/type_traits.hpp>

#include <streams_boost/numeric/ublas/storage_sparse.hpp>
#include <streams_boost/numeric/ublas/matrix_sparse.hpp>
...
namespace streams_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        const_pointer find_element (size_type i, size_type j) const {
            ...
            if (streams_boost::is_convertible<typename array_type::storage_category, packed_tag>::value) {
        ...
        const_reference operator () (size_type i, size_type j) const {
            ...
            // optimise: check the storage_type and index directly if element always exists
            if (streams_boost::is_convertible<typename array_type::storage_category, packed_tag>::value) {
                STREAMS_BOOST_UBLAS_CHECK (p, internal_logic () );
                return *p;
            }
            else {
                if (p)
    ...
    public:
        ...
        public:
            ...
            size_type index1 () const {
                ...
                if (rank_ == 1) {
                    STREAMS_BOOST_UBLAS_CHECK (layout_type::index_M (itv_.index (), it_.index ()) < (*this) ().size1 (), bad_index ());
            ...
            size_type index2 () const {
                STREAMS_BOOST_UBLAS_CHECK (*this != (*this) ().find1 (0, (*this) ().size1 (), j_), bad_index ());
                if (rank_ == 1) {
                    STREAMS_BOOST_UBLAS_CHECK (layout_type::index_m (itv_.index (), it_.index ()) < (*this) ().size2 (), bad_index ());
                    return layout_type::index_m (itv_.index (), it_.index ());
                } else {
                    return j_;
                }
    ...
    private:
        ...
        {
            STREAMS_BOOST_UBLAS_CHECK (layout_type::size_M (size1_, size2_) + 1 == data_.size (), internal_logic ());
