...
#ifndef _STREAMS_BOOST_UBLAS_BLAS_
#define _STREAMS_BOOST_UBLAS_BLAS_
...
namespace streams_boost { namespace numeric { namespace ublas {
    ...
    namespace blas_1 {
          ...
          /** \namespace streams_boost::numeric::ublas::blas_1
    ...
    namespace blas_2 {
          ...
          /** \namespace streams_boost::numeric::ublas::blas_2
    ...
    namespace blas_3 {
          ...
          /** \namespace streams_boost::numeric::ublas::blas_3
