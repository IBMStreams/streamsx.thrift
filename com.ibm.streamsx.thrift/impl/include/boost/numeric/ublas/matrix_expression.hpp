...
#ifndef _STREAMS_BOOST_UBLAS_MATRIX_EXPRESSION_
#define _STREAMS_BOOST_UBLAS_MATRIX_EXPRESSION_
...
namespace streams_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename streams_boost::mpl::if_<streams_boost::is_const<E>,
    ...
    public:
        // Element access
#ifndef STREAMS_BOOST_UBLAS_REFERENCE_CONST_MEMBER
        STREAMS_BOOST_UBLAS_INLINE
    ...
    public:
...
#else
#ifdef STREAMS_BOOST_UBLAS_USE_INVARIANT_HOISTING
        ...
        public:
            ...
            difference_type operator - (const const_iterator1 &it) const {
                STREAMS_BOOST_UBLAS_CHECK ((*this) ().same_closure (it ()), external_logic ());
                STREAMS_BOOST_UBLAS_CHECK (it2_ == it.it2_, external_logic ());
                return it1_ - it.it1_;
            }
        ...
        public:
            ...
            difference_type operator - (const const_iterator2 &it) const {
                STREAMS_BOOST_UBLAS_CHECK ((*this) ().same_closure(it ()), external_logic ());
                STREAMS_BOOST_UBLAS_CHECK (it1_ == it.it1_, external_logic ());
                return it2_ - it.it2_;
            }
...
#ifndef STREAMS_BOOST_UBLAS_SIMPLE_ET_DEBUG
    ...
    outer_prod (const vector_expression<E1> &e1,
        ...
        STREAMS_BOOST_STATIC_ASSERT (E1::complexity == 0 && E2::complexity == 0);
    ...
    class matrix_unary2:
        ...
        typedef typename streams_boost::mpl::if_<streams_boost::is_same<F, scalar_identity<typename E::value_type> >,
                                          E,
                                          const E>::type expression_type;
        typedef F functor_type;
    public:
        typedef typename streams_boost::mpl::if_<streams_boost::is_const<expression_type>,
    ...
    public:
        ...
        typedef typename F::result_type value_type;
        typedef value_type const_reference;
        typedef typename streams_boost::mpl::if_<streams_boost::is_same<F, scalar_identity<value_type> >,
                                          typename E::reference,
                                          value_type>::type reference;

        typedef const self_type const_closure_type;
        typedef self_type closure_type;
        typedef typename streams_boost::mpl::if_<streams_boost::is_same<typename E::orientation_category,
                                                         row_major_tag>,
                                          column_major_tag,
                typename streams_boost::mpl::if_<streams_boost::is_same<typename E::orientation_category,
                                                         column_major_tag>,
                                          row_major_tag,
    ...
    public:
        ...
        STREAMS_BOOST_UBLAS_INLINE
        reference operator () (size_type i, size_type j) {
            STREAMS_BOOST_STATIC_ASSERT ((streams_boost::is_same<functor_type, scalar_identity<value_type > >::value));
            return e_ (j, i);
        }
    ...
    public:
        ...
        STREAMS_BOOST_UBLAS_INLINE
        size_type size1 () const { 
            return STREAMS_BOOST_UBLAS_SAME (e1_.size1 (), e2_.size1 ());
        }
        STREAMS_BOOST_UBLAS_INLINE
        size_type size2 () const {
            return STREAMS_BOOST_UBLAS_SAME (e1_.size2 (), e2_.size2 ());
        }
    ...
    public:
        ...
        const_iterator1 find1 (int rank, size_type i, size_type j) const {
            ...
            STREAMS_BOOST_UBLAS_CHECK (rank == 0 || it11 == it11_end || it11.index2 () == j, internal_logic ())
            STREAMS_BOOST_UBLAS_CHECK (rank == 0 || it21 == it21_end || it21.index2 () == j, internal_logic ())
        ...
        const_iterator2 find2 (int rank, size_type i, size_type j) const {
            ...
            STREAMS_BOOST_UBLAS_CHECK (rank == 0 || it12 == it12_end || it12.index1 () == i, internal_logic ())
            STREAMS_BOOST_UBLAS_CHECK (rank == 0 || it22 == it22_end || it22.index1 () == i, internal_logic ())
        ...
        private:
            ...
            value_type dereference (packed_random_access_iterator_tag) const {
                ...
                if (it1_ != it1_end_) {
                    STREAMS_BOOST_UBLAS_CHECK (it1_.index2 () == j_, internal_logic ());
                    if (it1_.index1 () == i_)
                        t1 = *it1_;
                }
                value_type t2 = value_type/*zero*/();
                if (it2_ != it2_end_) {
                    STREAMS_BOOST_UBLAS_CHECK (it2_.index2 () == j_, internal_logic ());
                    if (it2_.index1 () == i_)
                        t2 = *it2_;
                }
        ...
        public:
            ...
            difference_type operator - (const const_iterator1 &it) const {
                STREAMS_BOOST_UBLAS_CHECK ((*this) ().same_closure (it ()), external_logic ());
                STREAMS_BOOST_UBLAS_CHECK (index2 () == it.index2 (), external_logic ());
            ...
            size_type index2 () const {
                ...
                //    return STREAMS_BOOST_UBLAS_SAME (it1_.index2 (), it2_.index2 ());
                // else
                    return j_;
            }
        ...
        private:
            ...
            value_type dereference (packed_random_access_iterator_tag) const {
                value_type t1 = value_type/*zero*/();
                if (it1_ != it1_end_) {
                    STREAMS_BOOST_UBLAS_CHECK (it1_.index1 () == i_, internal_logic ());
                    if (it1_.index2 () == j_)
                        t1 = *it1_;
                }
                value_type t2 = value_type/*zero*/();
                if (it2_ != it2_end_) {
                    STREAMS_BOOST_UBLAS_CHECK (it2_.index1 () == i_, internal_logic ());
                    if (it2_.index2 () == j_)
                        t2 = *it2_;
                }
                return functor_type::apply (t1, t2);
        ...
        public:
            ...
            difference_type operator - (const const_iterator2 &it) const {
                STREAMS_BOOST_UBLAS_CHECK ((*this) ().same_closure (it ()), external_logic ());
                STREAMS_BOOST_UBLAS_CHECK (index1 () == it.index1 (), external_logic ());
            ...
            size_type index1 () const {
                // if (it1_ != it1_end_ && it2_ != it2_end_)
                //    return STREAMS_BOOST_UBLAS_SAME (it1_.index1 (), it2_.index1 ());
                // else
                    return i_;
            }
            STREAMS_BOOST_UBLAS_INLINE
...
#ifdef STREAMS_BOOST_UBLAS_USE_INDEXING
                return mvb (index ());
#elif STREAMS_BOOST_UBLAS_USE_ITERATING
                difference_type size = STREAMS_BOOST_UBLAS_SAME (mvb.expression1 ().size2 (), mvb.expression2 ().size ());
#ifdef STREAMS_BOOST_UBLAS_USE_INVARIANT_HOISTING
...
#else
                difference_type size = STREAMS_BOOST_UBLAS_SAME (mvb.expression1 ().size2 (), mvb.expression2 ().size ());
                if (size >= STREAMS_BOOST_UBLAS_ITERATOR_THRESHOLD)
#ifdef STREAMS_BOOST_UBLAS_USE_INVARIANT_HOISTING
                    return functor_type::apply (size, it1_.begin (), e2_begin_);
#else
                    return functor_type::apply (size, it1_.begin (), mvb.expression2 ().begin ());
...
#else
                return functor_type::apply (streams_boost::numeric::ublas::begin (it1_, iterator1_tag ()),
                                        streams_boost::numeric::ublas::end (it1_, iterator1_tag ()),
                                        mvb.expression2 ().begin (), mvb.expression2 ().end ());
#endif
#endif
            }
    ...
    prod (const matrix_expression<E1> &e1,
          const vector_expression<E2> &e2) {
        STREAMS_BOOST_STATIC_ASSERT (E2::complexity == 0);
        typedef typename matrix_vector_binary1_traits<typename E1::value_type, E1,
    ...
    public:
        ...
        private:
            ...
            value_type dereference (dense_random_access_iterator_tag) const {
                ...
                return mvb (index ());
#elif STREAMS_BOOST_UBLAS_USE_ITERATING
                difference_type size = STREAMS_BOOST_UBLAS_SAME (mvb.expression2 ().size1 (), mvb.expression1 ().size ());
#ifdef STREAMS_BOOST_UBLAS_USE_INVARIANT_HOISTING
...
#else
                return functor_type::apply (mvb.expression1 ().begin (), mvb.expression1 ().end (),
                                        streams_boost::numeric::ublas::begin (it2_, iterator2_tag ()),
                                        streams_boost::numeric::ublas::end (it2_, iterator2_tag ()));
#endif
#endif
            }
            ...
            value_type dereference (sparse_bidirectional_iterator_tag) const {
                ...
                return functor_type::apply (mvb.expression1 ().begin (), mvb.expression1 ().end (),
                                        streams_boost::numeric::ublas::begin (it2_, iterator2_tag ()),
                                        streams_boost::numeric::ublas::end (it2_, iterator2_tag ()), sparse_bidirectional_iterator_tag ());
#endif
#endif
            }
    ...
    prod (const vector_expression<E1> &e1,
          const matrix_expression<E2> &e2) {
        STREAMS_BOOST_STATIC_ASSERT (E1::complexity == 0);
        typedef typename matrix_vector_binary2_traits<typename E1::value_type, E1,
                                                      typename E2::value_type, E2>::storage_category storage_category;
        typedef typename matrix_vector_binary2_traits<typename E1::value_type, E1,
                                                      typename E2::value_type, E2>::orientation_category orientation_category;
        ...
        private:
...
#elif STREAMS_BOOST_UBLAS_USE_ITERATING
                difference_type size = STREAMS_BOOST_UBLAS_SAME (mmb.expression1 ().size2 (), mmb.expression2 ().size1 ());
#ifdef STREAMS_BOOST_UBLAS_USE_INVARIANT_HOISTING
            ...
            value_type dereference (packed_random_access_iterator_tag) const {
                ...
                return functor_type::apply (streams_boost::numeric::ublas::begin (it1_, iterator1_tag ()),
                                        streams_boost::numeric::ublas::end (it1_, iterator1_tag ()),
                                        streams_boost::numeric::ublas::begin (it2_, iterator2_tag ()),
                                        streams_boost::numeric::ublas::end (it2_, iterator2_tag ()), packed_random_access_iterator_tag ());
#endif
#endif
            }
