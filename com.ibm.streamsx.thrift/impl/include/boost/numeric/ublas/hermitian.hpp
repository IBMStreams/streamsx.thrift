...
#ifndef STREAMS_BOOST_UBLAS_HERMITIAN_H
#define STREAMS_BOOST_UBLAS_HERMITIAN_H

#include <streams_boost/numeric/ublas/matrix.hpp>
#include <streams_boost/numeric/ublas/triangular.hpp>  // for resize_preserve
...
namespace streams_boost { namespace numeric { namespace ublas {
    ...
    bool is_hermitian (const M &m) {
        ...
        if (m.size1 () != m.size2 ())
            return false;
        size_type size = STREAMS_BOOST_UBLAS_SAME (m.size1 (), m.size2 ());
...
#ifdef STREAMS_BOOST_UBLAS_STRICT_HERMITIAN
    ...
    public:
        ...
        typedef const T const_reference;
#ifndef STREAMS_BOOST_UBLAS_STRICT_HERMITIAN
        typedef T &reference;
#else
        ...
        hermitian_matrix (size_type size):
            matrix_container<self_type> (),
            size_ (STREAMS_BOOST_UBLAS_SAME (size, size)), data_ (triangular_type::packed_size (layout_type (), size, size)) {
        }
        STREAMS_BOOST_UBLAS_INLINE
        hermitian_matrix (size_type size1, size_type size2):
            matrix_container<self_type> (),
            size_ (STREAMS_BOOST_UBLAS_SAME (size1, size2)), data_ (triangular_type::packed_size (layout_type (), size1, size2)) {
        }
        STREAMS_BOOST_UBLAS_INLINE
        ...
        hermitian_matrix (const matrix_expression<AE> &ae):
            matrix_container<self_type> (),
            size_ (STREAMS_BOOST_UBLAS_SAME (ae ().size1 (), ae ().size2 ())),
        ...
        void resize (size_type size1, size_type size2, bool preserve = true) {
            resize (STREAMS_BOOST_UBLAS_SAME (size1, size2), preserve);
        }
        STREAMS_BOOST_UBLAS_INLINE
        void resize_packed_preserve (size_type size) {
            size_ = STREAMS_BOOST_UBLAS_SAME (size, size);
        ...
        const_reference operator () (size_type i, size_type j) const {
            ...
            STREAMS_BOOST_UBLAS_CHECK (j < size_, bad_index ());
            // if (i == j)
        ...
        true_reference at_element (size_type i, size_type j) {
            STREAMS_BOOST_UBLAS_CHECK (i < size_, bad_index ());
            STREAMS_BOOST_UBLAS_CHECK (j < size_, bad_index ());
            STREAMS_BOOST_UBLAS_CHECK (triangular_type::other (i, j), bad_index ());
            return data () [triangular_type::element (layout_type (), i, size_, j, size_)];
        }
        STREAMS_BOOST_UBLAS_INLINE
        ...
        hermitian_matrix& operator *= (const AT &at) {
            ...
            STREAMS_BOOST_UBLAS_CHECK (type_traits<value_type>::imag (at) == 0, non_real ());
    ...
    public:
        ...
        hermitian_adaptor (matrix_type &data):
            ...
            data_ (data) {
            STREAMS_BOOST_UBLAS_CHECK (data_.size1 () == data_.size2 (), bad_size ());
        }
        STREAMS_BOOST_UBLAS_INLINE
        ...
        STREAMS_BOOST_UBLAS_INLINE
        const_reference operator () (size_type i, size_type j) const {
            STREAMS_BOOST_UBLAS_CHECK (i < size1 (), bad_index ());
            STREAMS_BOOST_UBLAS_CHECK (j < size2 (), bad_index ());
            // if (i == j)
        ...
        public:
            ...
            const_iterator1 (const self_type &m, int begin, int end,
                ...
                if ((current_ == 0 && it1_ == it1_end_) ||
                    ...
                    current_ = end_;
                STREAMS_BOOST_UBLAS_CHECK (current_ == end_ ||
            ...
            STREAMS_BOOST_UBLAS_INLINE
            const_iterator1 &operator ++ () {
                STREAMS_BOOST_UBLAS_CHECK (current_ == 0 || current_ == 1, internal_logic ());
                if (current_ == 0) {
                    STREAMS_BOOST_UBLAS_CHECK (it1_ != it1_end_, internal_logic ());
                    ++ it1_;
                    ...
                    STREAMS_BOOST_UBLAS_CHECK (it2_ != it2_end_, internal_logic ());
                    ++ it2_;
            ...
            const_iterator1 &operator -- () {
                ...
                if (current_ == 0) {
                    if (it1_ == it1_begin_ && begin_ == 1) {
                        it2_ = it2_end_;
                        STREAMS_BOOST_UBLAS_CHECK (it2_ != it2_begin_, internal_logic ());
                        -- it2_;
                        current_ = 1;
                    } else {
                        -- it1_;
                    ...
                    if (it2_ == it2_begin_ && begin_ == 0) {
                        it1_ = it1_end_;
                        STREAMS_BOOST_UBLAS_CHECK (it1_ != it1_begin_, internal_logic ());
                        -- it1_;
                        current_ = 0;
                    } else {
                        -- it2_;
            ...
            const_iterator1 &operator += (difference_type n) {
                ...
                if (current_ == 0) {
                    ...
                    if (n > 0 || (end_ == 1 && it1_ == it1_end_)) {
                        STREAMS_BOOST_UBLAS_CHECK (end_ == 1, external_logic ());
                    ...
                    if (n > 0 || (end_ == 0 && it2_ == it2_end_)) {
                        STREAMS_BOOST_UBLAS_CHECK (end_ == 0, external_logic ());
                ...
                STREAMS_BOOST_UBLAS_CHECK (n == 0, external_logic ());
                return *this;
            }
            STREAMS_BOOST_UBLAS_INLINE
            const_iterator1 &operator -= (difference_type n) {
            ...
            difference_type operator - (const const_iterator1 &it) const {
                STREAMS_BOOST_UBLAS_CHECK (&(*this) () == &it (), external_logic ());
                STREAMS_BOOST_UBLAS_CHECK (current_ == 0 || current_ == 1, internal_logic ());
                STREAMS_BOOST_UBLAS_CHECK (it.current_ == 0 || it.current_ == 1, internal_logic ());
                STREAMS_BOOST_UBLAS_CHECK (/* begin_ == it.begin_ && */ end_ == it.end_, internal_logic ());
