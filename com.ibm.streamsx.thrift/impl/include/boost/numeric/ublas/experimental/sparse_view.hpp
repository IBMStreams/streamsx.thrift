...
#ifndef _STREAMS_BOOST_UBLAS_SPARSE_VIEW_
#define _STREAMS_BOOST_UBLAS_SPARSE_VIEW_
...
namespace streams_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename streams_boost::remove_cv<typename vector_view_traits<JA>::value_type>::type index_type;
	...
	//
	    ...
	    const_subiterator_type it_start = streams_boost::next(vector_view_traits<index_array_type>::begin(index2_data_),itv);
	    const_subiterator_type it_end = streams_boost::next(vector_view_traits<index_array_type>::begin(index2_data_),itv_next);
    ...
    private:
        void storage_invariants () const {
            STREAMS_BOOST_UBLAS_CHECK (index1_data_ [layout_type::size_M (size1_, size2_)] == k_based (nnz_), external_logic ());
        }
