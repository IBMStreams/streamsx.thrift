...
#ifndef _STREAMS_BOOST_UBLAS_MATRIX_
#define _STREAMS_BOOST_UBLAS_MATRIX_
...
namespace streams_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        public:
            ...
            difference_type operator - (const const_iterator1 &it) const {
                STREAMS_BOOST_UBLAS_CHECK (&(*this) () == &it (), external_logic ());
                STREAMS_BOOST_UBLAS_CHECK (index2 () == it.index2 (), bad_index ());
        ...
        public:
            ...
            difference_type operator - (const const_iterator2 &it) const {
                STREAMS_BOOST_UBLAS_CHECK (&(*this) () == &it (), external_logic ());
                STREAMS_BOOST_UBLAS_CHECK (index1 () == it.index1 (), bad_index ());
    ...
    public:
        ...
        public:
            ...
            STREAMS_BOOST_UBLAS_INLINE
            const_iterator1 &operator ++ () {
                STREAMS_BOOST_UBLAS_CHECK (it_ < (*this) ().size1 (), bad_index ());
                ++it_;
                return *this;
            }
            STREAMS_BOOST_UBLAS_INLINE
        ...
        public:
            ...
            STREAMS_BOOST_UBLAS_INLINE
            const_iterator2 &operator ++ () {
                STREAMS_BOOST_UBLAS_CHECK (it_ < (*this) ().size_common_, bad_index ());
                ++it_;
                return *this;
            }
            STREAMS_BOOST_UBLAS_INLINE
    ...
    public:
        ...
        void swap (c_matrix &m) {
            if (this != &m) {
                STREAMS_BOOST_UBLAS_CHECK (size1_ == m.size1_, bad_size ());
