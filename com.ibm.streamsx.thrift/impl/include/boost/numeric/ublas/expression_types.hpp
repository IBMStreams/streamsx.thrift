...
//
#ifndef _STREAMS_BOOST_UBLAS_EXPRESSION_TYPE_
#define _STREAMS_BOOST_UBLAS_EXPRESSION_TYPE_

#include <streams_boost/numeric/ublas/exception.hpp>
#include <streams_boost/numeric/ublas/traits.hpp>
#include <streams_boost/numeric/ublas/functional.hpp>
...
namespace streams_boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename streams_boost::mpl::if_<streams_boost::is_const<T>,
                                          const_reference,
...
#ifdef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
