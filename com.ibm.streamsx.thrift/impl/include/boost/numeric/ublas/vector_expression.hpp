...
#ifndef _STREAMS_BOOST_UBLAS_VECTOR_EXPRESSION_
#define _STREAMS_BOOST_UBLAS_VECTOR_EXPRESSION_

#include <streams_boost/numeric/ublas/expression_types.hpp>
...
// #endif
    ...
    public:
        ...
        STREAMS_BOOST_UBLAS_INLINE
        size_type size () const { 
            return STREAMS_BOOST_UBLAS_SAME (e1_.size (), e2_.size ()); 
        }
...
#if !defined (STREAMS_BOOST_UBLAS_SIMPLE_ET_DEBUG) && defined (STREAMS_BOOST_UBLAS_USE_SCALAR_ET)
...
// They do not work for complex types
    ...
    private:
        ...
        STREAMS_BOOST_UBLAS_INLINE
        value_type evaluate (dense_random_access_iterator_tag) const {
            STREAMS_BOOST_UBLAS_CHECK (e1_.size () == e2_.size (), external_logic());
#ifdef STREAMS_BOOST_UBLAS_USE_INDEXING
            return functor_type::apply (e1_, e2_);
#elif STREAMS_BOOST_UBLAS_USE_ITERATING
            difference_type size = STREAMS_BOOST_UBLAS_SAME (e1_.size (), e2_.size ());
