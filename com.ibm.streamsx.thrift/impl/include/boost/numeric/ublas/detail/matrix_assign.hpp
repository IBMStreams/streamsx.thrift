...
#ifndef _STREAMS_BOOST_UBLAS_MATRIX_ASSIGN_
#define _STREAMS_BOOST_UBLAS_MATRIX_ASSIGN_
...
namespace detail {
    ...
    bool expression_type_check (const matrix_expression<E1> &e1, const matrix_expression<E2> &e2) {
        ...
        return equals (e1, e2, STREAMS_BOOST_UBLAS_TYPE_CHECK_EPSILON, STREAMS_BOOST_UBLAS_TYPE_CHECK_MIN);
    }
    ...
    void make_conformant (M &m, const matrix_expression<E> &e, row_major_tag, R) {
        STREAMS_BOOST_UBLAS_CHECK (m.size1 () == e ().size1 (), bad_size ());
        STREAMS_BOOST_UBLAS_CHECK (m.size2 () == e ().size2 (), bad_size ());
    ...
    void iterating_matrix_assign_scalar (M &m, const T &t, row_major_tag) {
        ...
        typename M::iterator1 it1 (m.begin1 ());
        STREAMS_BOOST_UBLAS_CHECK (size2 == 0 || m.end1 () - it1 == size1, bad_size ());
        while (-- size1 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator2 it2 (it1.begin ());
#else
            typename M::iterator2 it2 (begin (it1, iterator1_tag ()));
#endif
            STREAMS_BOOST_UBLAS_CHECK (it1.end () - it2 == size2, bad_size ());
    ...
    void iterating_matrix_assign_scalar (M &m, const T &t, column_major_tag) {
        ...
        difference_type size1 (m.size1 ());
        typename M::iterator2 it2 (m.begin2 ());
        STREAMS_BOOST_UBLAS_CHECK (size1 == 0 || m.end2 () - it2 == size2, bad_size ());
        while (-- size2 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator1 it1 (it2.begin ());
#else
            typename M::iterator1 it1 (begin (it2, iterator2_tag ()));
#endif
            STREAMS_BOOST_UBLAS_CHECK (it2.end () - it1 == size1, bad_size ());
    ...
    void matrix_assign_scalar (M &m, const T &t, dense_proxy_tag, C) {
        ...
        size_type size1 (m.size1 ());
        size_type size2 (m.size2 ());
        if (size1 >= STREAMS_BOOST_UBLAS_ITERATOR_THRESHOLD &&
            size2 >= STREAMS_BOOST_UBLAS_ITERATOR_THRESHOLD)
            iterating_matrix_assign_scalar<F> (m, t, orientation_category ());
        else
            indexing_matrix_assign_scalar<F> (m, t, orientation_category ());
#endif
    ...
    void iterating_matrix_assign (M &m, const matrix_expression<E> &e, row_major_tag) {
        ...
        typedef typename M::difference_type difference_type;
        difference_type size1 (STREAMS_BOOST_UBLAS_SAME (m.size1 (), e ().size1 ()));
        difference_type size2 (STREAMS_BOOST_UBLAS_SAME (m.size2 (), e ().size2 ()));
        typename M::iterator1 it1 (m.begin1 ());
        STREAMS_BOOST_UBLAS_CHECK (size2 == 0 || m.end1 () - it1 == size1, bad_size ());
        typename E::const_iterator1 it1e (e ().begin1 ());
        STREAMS_BOOST_UBLAS_CHECK (size2 == 0 || e ().end1 () - it1e == size1, bad_size ());
        while (-- size1 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator2 it2 (it1.begin ());
            typename E::const_iterator2 it2e (it1e.begin ());
...
#endif
            STREAMS_BOOST_UBLAS_CHECK (it1.end () - it2 == size2, bad_size ());
            STREAMS_BOOST_UBLAS_CHECK (it1e.end () - it2e == size2, bad_size ());
            difference_type temp_size2 (size2);
#ifndef STREAMS_BOOST_UBLAS_USE_DUFF_DEVICE
            while (-- temp_size2 >= 0)
    ...
    void iterating_matrix_assign (M &m, const matrix_expression<E> &e, column_major_tag) {
        ...
        STREAMS_BOOST_UBLAS_CHECK (size1 == 0 || m.end2 () - it2 == size2, bad_size ());
        typename E::const_iterator2 it2e (e ().begin2 ());
        STREAMS_BOOST_UBLAS_CHECK (size1 == 0 || e ().end2 () - it2e == size2, bad_size ());
        while (-- size2 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator1 it1 (it2.begin ());
            typename E::const_iterator1 it1e (it2e.begin ());
...
#endif
            STREAMS_BOOST_UBLAS_CHECK (it2.end () - it1 == size1, bad_size ());
            STREAMS_BOOST_UBLAS_CHECK (it2e.end () - it1e == size1, bad_size ());
            difference_type temp_size1 (size1);
#ifndef STREAMS_BOOST_UBLAS_USE_DUFF_DEVICE
            while (-- temp_size1 >= 0)
    ...
    void indexing_matrix_assign (M &m, const matrix_expression<E> &e, row_major_tag) {
        ...
        typedef typename M::size_type size_type;
        size_type size1 (STREAMS_BOOST_UBLAS_SAME (m.size1 (), e ().size1 ()));
        size_type size2 (STREAMS_BOOST_UBLAS_SAME (m.size2 (), e ().size2 ()));
        for (size_type i = 0; i < size1; ++ i) {
#ifndef STREAMS_BOOST_UBLAS_USE_DUFF_DEVICE
            for (size_type j = 0; j < size2; ++ j)
    ...
    void matrix_assign (M &m, const matrix_expression<E> &e, packed_proxy_tag, row_major_tag) {
        ...
        if (! disable_type_check<bool>::value)
            STREAMS_BOOST_UBLAS_CHECK (detail::expression_type_check (m, cm), external_logic ());
#endif
    }
    // Packed (proxy) column major case
    template<template <class T1, class T2> class F, class R, class M, class E>
    ...
    void matrix_assign (M &m, const matrix_expression<E> &e, sparse_tag, row_major_tag) {
        typedef F<typename M::iterator2::reference, typename E::value_type> functor_type;
        // R unnecessary, make_conformant not required
        STREAMS_BOOST_STATIC_ASSERT ((!functor_type::computed));
        STREAMS_BOOST_UBLAS_CHECK (m.size1 () == e ().size1 (), bad_size ());
        STREAMS_BOOST_UBLAS_CHECK (m.size2 () == e ().size2 (), bad_size ());
        typedef typename M::value_type value_type;
    ...
    void matrix_assign (M &m, const matrix_expression<E> &e) {
        ...
        typedef typename streams_boost::mpl::if_<streams_boost::is_same<typename M::orientation_category, unknown_orientation_tag>,
    ...
    void matrix_swap (M &m, matrix_expression<E> &e, dense_proxy_tag, row_major_tag) {
        ...
        difference_type size1 (STREAMS_BOOST_UBLAS_SAME (m.size1 (), size_type (e ().end1 () - it1e)));
        while (-- size1 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator2 it2 (it1.begin ());
            typename E::iterator2 it2e (it1e.begin ());
            difference_type size2 (STREAMS_BOOST_UBLAS_SAME (m.size2 (), size_type (it1e.end () - it2e)));
#else
            typename M::iterator2 it2 (begin (it1, iterator1_tag ()));
            typename E::iterator2 it2e (begin (it1e, iterator1_tag ()));
            difference_type size2 (STREAMS_BOOST_UBLAS_SAME (m.size2 (), size_type (end (it1e, iterator1_tag ()) - it2e)));
#endif
            while (-- size2 >= 0)
                functor_type::apply (*it2, *it2e), ++ it2, ++ it2e;
            ++ it1, ++ it1e;
    ...
    void matrix_swap (M &m, matrix_expression<E> &e, dense_proxy_tag, column_major_tag) {
        ...
        difference_type size2 (STREAMS_BOOST_UBLAS_SAME (m.size2 (), size_type (e ().end2 () - it2e)));
        while (-- size2 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator1 it1 (it2.begin ());
            typename E::iterator1 it1e (it2e.begin ());
            difference_type size1 (STREAMS_BOOST_UBLAS_SAME (m.size1 (), size_type (it2e.end () - it1e)));
#else
            typename M::iterator1 it1 (begin (it2, iterator2_tag ()));
            typename E::iterator1 it1e (begin (it2e, iterator2_tag ()));
            difference_type size1 (STREAMS_BOOST_UBLAS_SAME (m.size1 (), size_type (end (it2e, iterator2_tag ()) - it1e)));
#endif
            while (-- size1 >= 0)
                functor_type::apply (*it1, *it1e), ++ it1, ++ it1e;
            ++ it2, ++ it2e;
    ...
    void matrix_swap (M &m, matrix_expression<E> &e, packed_proxy_tag, row_major_tag) {
        ...
        typename M::iterator1 it1 (m.begin1 ());
        typename E::iterator1 it1e (e ().begin1 ());
        difference_type size1 (STREAMS_BOOST_UBLAS_SAME (m.end1 () - it1, e ().end1 () - it1e));
        while (-- size1 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator2 it2 (it1.begin ());
            typename E::iterator2 it2e (it1e.begin ());
            difference_type size2 (STREAMS_BOOST_UBLAS_SAME (it1.end () - it2, it1e.end () - it2e));
#else
            typename M::iterator2 it2 (begin (it1, iterator1_tag ()));
            typename E::iterator2 it2e (begin (it1e, iterator1_tag ()));
            difference_type size2 (STREAMS_BOOST_UBLAS_SAME (end (it1, iterator1_tag ()) - it2, end (it1e, iterator1_tag ()) - it2e));
#endif
            while (-- size2 >= 0)
                functor_type::apply (*it2, *it2e), ++ it2, ++ it2e;
            ++ it1, ++ it1e;
    ...
    void matrix_swap (M &m, matrix_expression<E> &e, packed_proxy_tag, column_major_tag) {
        ...
        typename M::iterator2 it2 (m.begin2 ());
        typename E::iterator2 it2e (e ().begin2 ());
        difference_type size2 (STREAMS_BOOST_UBLAS_SAME (m.end2 () - it2, e ().end2 () - it2e));
        while (-- size2 >= 0) {
#ifndef STREAMS_BOOST_UBLAS_NO_NESTED_CLASS_RELATION
            typename M::iterator1 it1 (it2.begin ());
            typename E::iterator1 it1e (it2e.begin ());
            difference_type size1 (STREAMS_BOOST_UBLAS_SAME (it2.end () - it1, it2e.end () - it1e));
#else
            typename M::iterator1 it1 (begin (it2, iterator2_tag ()));
            typename E::iterator1 it1e (begin (it2e, iterator2_tag ()));
            difference_type size1 (STREAMS_BOOST_UBLAS_SAME (end (it2, iterator2_tag ()) - it1, end (it2e, iterator2_tag ()) - it1e));
#endif
            while (-- size1 >= 0)
                functor_type::apply (*it1, *it1e), ++ it1, ++ it1e;
            ++ it2, ++ it2e;
