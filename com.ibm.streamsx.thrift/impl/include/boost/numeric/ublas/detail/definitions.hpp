...
#ifndef _STREAMS_BOOST_UBLAS_DEFINITIONS_
#define _STREAMS_BOOST_UBLAS_DEFINITIONS_


namespace streams_boost { namespace numeric { namespace ublas {

    namespace detail {
        /* Borrowed from streams_boost/concept_checks.hpp
    ...
    namespace dimension {
        ...
        struct dimension_properties<1> {
            template <class E>
            STREAMS_BOOST_UBLAS_INLINE static
