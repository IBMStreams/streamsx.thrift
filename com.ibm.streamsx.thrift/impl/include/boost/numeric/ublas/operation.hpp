...
#ifndef _STREAMS_BOOST_UBLAS_OPERATION_
#define _STREAMS_BOOST_UBLAS_OPERATION_
...
#if STREAMS_BOOST_UBLAS_TYPE_CHECK
        STREAMS_BOOST_UBLAS_CHECK (norm_1 (v - cv) <= 2 * std::numeric_limits<real_type>::epsilon () * verrorbound, internal_logic ());
#endif
        return v;
    }
    template<class V, class T1, class L1, class IA1, class TA1, class E2>
...
#else
            typename expression1_type::const_iterator2 it2 (streams_boost::numeric::ublas::begin (it1, iterator1_tag ()));
            typename expression1_type::const_iterator2 it2_end (streams_boost::numeric::ublas::end (it1, iterator1_tag ()));
#endif
            while (it2 != it2_end) {
...
#else
            typename expression1_type::const_iterator1 it1 (streams_boost::numeric::ublas::begin (it2, iterator2_tag ()));
            typename expression1_type::const_iterator1 it1_end (streams_boost::numeric::ublas::end (it2, iterator2_tag ()));
#endif
            while (it1 != it1_end) {
...
#else
            typename expression2_type::const_iterator1 it1 (streams_boost::numeric::ublas::begin (it2, iterator2_tag ()));
            typename expression2_type::const_iterator1 it1_end (streams_boost::numeric::ublas::end (it2, iterator2_tag ()));
#endif
            while (it1 != it1_end) {
...
#else
            typename expression2_type::const_iterator2 it2 (streams_boost::numeric::ublas::begin (it1, iterator1_tag ()));
            typename expression2_type::const_iterator2 it2_end (streams_boost::numeric::ublas::end (it1, iterator1_tag ()));
#endif
            while (it2 != it2_end) {
...
#if STREAMS_BOOST_UBLAS_TYPE_CHECK
        STREAMS_BOOST_UBLAS_CHECK (norm_1 (m - cm) <= 2 * std::numeric_limits<real_type>::epsilon () * merrorbound, internal_logic ());
#endif
        return m;
    }
    template<class M, class E1, class E2, class TRI>
