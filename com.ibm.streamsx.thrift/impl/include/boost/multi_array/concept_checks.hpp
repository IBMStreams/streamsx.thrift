...
#ifndef STREAMS_BOOST_MULTI_ARRAY_CONCEPT_CHECKS_RG110101_HPP
#define STREAMS_BOOST_MULTI_ARRAY_CONCEPT_CHECKS_RG110101_HPP
...
namespace multi_array {
  ...
  struct ConstMultiArrayConcept
  {
    ...
    function_requires< streams_boost_concepts::ForwardTraversalConcept<iterator> >();
    function_requires< streams_boost_concepts::ReadableIteratorConcept<iterator> >();
    function_requires< streams_boost_concepts::ForwardTraversalConcept<const_iterator> >();
    function_requires< streams_boost_concepts::ReadableIteratorConcept<const_iterator> >();
  ...
  struct MutableMultiArrayConcept
  {
    void constraints() {
      ...
      function_requires< streams_boost_concepts::ForwardTraversalConcept<iterator> >();
      function_requires< streams_boost_concepts::ReadableIteratorConcept<iterator> >();
      function_requires< streams_boost_concepts::WritableIteratorConcept<iterator> >();
      function_requires< streams_boost_concepts::ForwardTraversalConcept<const_iterator> >();
      function_requires< streams_boost_concepts::ReadableIteratorConcept<const_iterator> >();
...
#endif // STREAMS_BOOST_MULTI_ARRAY_CONCEPT_CHECKS_RG110101_HPP
