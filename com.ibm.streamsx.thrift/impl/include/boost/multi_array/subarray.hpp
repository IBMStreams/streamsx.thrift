...
public: 
  ...
  sub_array& operator=(const ConstMultiArray& other) {
    function_requires< streams_boost::detail::multi_array::ConstMultiArrayConcept< 
...
public:
  typedef streams_boost::detail::multi_array::sub_array<element,N> type;
};
...
class const_subarray_gen {
  typedef typename Array::element element;
public:
  typedef streams_boost::detail::multi_array::const_sub_array<element,N> type;  
};
} // namespace streams_boost
