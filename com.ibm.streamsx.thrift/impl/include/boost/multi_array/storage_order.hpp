...
#ifndef STREAMS_BOOST_STORAGE_ORDER_RG071801_HPP
#define STREAMS_BOOST_STORAGE_ORDER_RG071801_HPP
...
namespace streams_boost {
  ...
  public:
    ...
    general_storage_order(OrderingIter ordering,
      ...
      streams_boost::detail::multi_array::copy_n(ordering,NumDims,ordering_.begin());
      streams_boost::detail::multi_array::copy_n(ascending,NumDims,ascending_.begin());
    }
  ...
  protected:
    streams_boost::array<size_type,NumDims> ordering_;
    streams_boost::array<bool,NumDims> ascending_;
  };
  ...
  public:
    ...
    operator general_storage_order<NumDims>() const {
      streams_boost::array<size_type,NumDims> ordering;
      streams_boost::array<bool,NumDims> ascending;
...
#endif // STREAMS_BOOST_ARRAY_STORAGE_RG071801_HPP
