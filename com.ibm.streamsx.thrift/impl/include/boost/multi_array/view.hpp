...
#ifndef STREAMS_BOOST_MULTI_ARRAY_VIEW_RG071301_HPP
#define STREAMS_BOOST_MULTI_ARRAY_VIEW_RG071301_HPP
...
class const_multi_array_view :
    public streams_boost::detail::multi_array::multi_array_impl_base<T,NumDims>
{
  typedef streams_boost::detail::multi_array::multi_array_impl_base<T,NumDims> super_type;
public: 
  ...
  operator[](const streams_boost::detail::multi_array::
...
public: // should be protected
  ...
  explicit const_multi_array_view(TPtr base,
                           ...
                           const streams_boost::array<Index,NumDims>& strides): 
...
public:
  typedef streams_boost::detail::multi_array::multi_array_view<element,N> type;
};
...
class const_array_view_gen {
  typedef typename Array::element element;
public:
  typedef streams_boost::detail::multi_array::const_multi_array_view<element,N> type;  
};

} // namespace streams_boost

#endif // STREAMS_BOOST_MULTI_ARRAY_VIEW_RG071301_HPP
