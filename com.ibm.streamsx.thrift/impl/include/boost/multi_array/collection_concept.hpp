...
namespace multi_array {
  ...
  struct CollectionConcept
  {
    ...
    void constraints() {
      streams_boost::function_requires<streams_boost::InputIteratorConcept<iterator> >();
      streams_boost::function_requires<streams_boost::InputIteratorConcept<const_iterator> >();
      streams_boost::function_requires<streams_boost::CopyConstructibleConcept<value_type> >();
      const_constraints(c);
      i = c.begin();
      i = c.end();
      c.swap(c);
