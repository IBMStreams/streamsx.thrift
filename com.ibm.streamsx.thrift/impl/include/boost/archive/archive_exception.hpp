#ifndef STREAMS_BOOST_ARCHIVE_ARCHIVE_EXCEPTION_HPP
#define STREAMS_BOOST_ARCHIVE_ARCHIVE_EXCEPTION_HPP
...
//
class STREAMS_BOOST_ARCHIVE_DECL(STREAMS_BOOST_PP_EMPTY()) archive_exception : 
...
#endif //STREAMS_BOOST_ARCHIVE_ARCHIVE_EXCEPTION_HPP
