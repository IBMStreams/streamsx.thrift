#ifndef STREAMS_BOOST_ARCHIVE_BASIC_TEXT_OARCHIVE_HPP
#define STREAMS_BOOST_ARCHIVE_BASIC_TEXT_OARCHIVE_HPP
...
|| STREAMS_BOOST_WORKAROUND(__BORLANDC__,STREAMS_BOOST_TESTED_AT(0x560))
public:
    ...
    // compilers(5.51) which don't handle STREAMS_BOOST_STRONG_TYPE properly.
...
#endif // STREAMS_BOOST_ARCHIVE_BASIC_TEXT_OARCHIVE_HPP
