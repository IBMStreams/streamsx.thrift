#ifndef STREAMS_BOOST_ARCHIVE_CODECVT_NULL_HPP
#define STREAMS_BOOST_ARCHIVE_CODECVT_NULL_HPP
...
namespace std {
// For STLport on WinCE, STREAMS_BOOST_NO_STDC_NAMESPACE can get defined if STLport is putting symbols in its own namespace.
...
{
    virtual STREAMS_BOOST_WARCHIVE_DECL(std::codecvt_base::result)
    do_out(
        std::mbstate_t & state,
...
#endif //STREAMS_BOOST_ARCHIVE_CODECVT_NULL_HPP
