#ifndef STREAMS_BOOST_ARCHIVE_DETAIL_AUTO_LINK_WARCHIVE_HPP
#define STREAMS_BOOST_ARCHIVE_DETAIL_AUTO_LINK_WARCHIVE_HPP
...
&& !defined(STREAMS_BOOST_ALL_NO_LIB) && !defined(STREAMS_BOOST_SERIALIZATION_NO_LIB)

// Set the name of our library, this will get undef'ed by auto_link.hpp
// once it's done with it:
//
#define STREAMS_BOOST_LIB_NAME streams_boost_wserialization
//
