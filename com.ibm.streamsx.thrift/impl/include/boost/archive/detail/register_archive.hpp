...
#ifndef STREAMS_BOOST_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_STREAMS_HPP
# define STREAMS_BOOST_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_STREAMS_HPP

namespace streams_boost { namespace archive { namespace detail { 

// No instantiate_ptr_serialization overloads generated by
// STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE that lexically follow the call
...
#define STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(Archive)                     \
namespace streams_boost { namespace archive { namespace detail {                  \
...
// STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE, below.
template <class Serializable>
...
// streams_boost/serialization/export.hpp
# define STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(Archive)                  \
namespace streams_boost { namespace archive { namespace detail {                \
                                                                        \
template <class Serializable>                                           \
STREAMS_BOOST_DEDUCED_TYPENAME _ptr_serialization_support<Archive, Serializable>::type  \
instantiate_ptr_serialization( Serializable*, Archive*, adl_tag );              \
                                                                        \
}}}
#endif
}}} // namespace streams_boost::archive::detail

#endif // STREAMS_BOOST_ARCHIVE_DETAIL_INSTANTIATE_SERIALIZE_DWA2006521_STREAMS_HPP
