#ifndef STREAMS_BOOST_ARCHIVE_DETAIL_BASIC_IARCHIVE_HPP
#define STREAMS_BOOST_ARCHIVE_DETAIL_BASIC_IARCHIVE_HPP
    ...
    private streams_boost::noncopyable
{
    ...
    // streams_boost::scoped_ptr<basic_iarchive_impl> pimpl;
...
STREAMS_BOOST_TT_BROKEN_COMPILER_SPEC(
    streams_boost::archive::detail::basic_iarchive  
) 

#include <streams_boost/archive/detail/abi_suffix.hpp> // pops abi_suffix.hpp pragmas

#endif //STREAMS_BOOST_ARCHIVE_DETAIL_BASIC_IARCHIVE_HPP
