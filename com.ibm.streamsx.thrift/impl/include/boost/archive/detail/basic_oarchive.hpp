#ifndef STREAMS_BOOST_ARCHIVE_BASIC_OARCHIVE_HPP
#define STREAMS_BOOST_ARCHIVE_BASIC_OARCHIVE_HPP
...
class STREAMS_BOOST_ARCHIVE_DECL(STREAMS_BOOST_PP_EMPTY()) basic_pointer_oserializer;
//////////////////////////////////////////////////////////////////////
// class basic_oarchive - write serialized objects to an output stream
class STREAMS_BOOST_ARCHIVE_OR_WARCHIVE_DECL(STREAMS_BOOST_PP_EMPTY()) basic_oarchive :
    private streams_boost::noncopyable
{
    ...
    //streams_boost::scoped_ptr<basic_oarchive_impl> pimpl;
...
STREAMS_BOOST_TT_BROKEN_COMPILER_SPEC(
    streams_boost::archive::detail::basic_oarchive
)

#include <streams_boost/archive/detail/abi_suffix.hpp> // pops abi_suffix.hpp pragmas

#endif //STREAMS_BOOST_ARCHIVE_BASIC_OARCHIVE_HPP
