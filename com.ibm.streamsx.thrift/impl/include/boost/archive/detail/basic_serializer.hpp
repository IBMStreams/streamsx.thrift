#ifndef  STREAMS_BOOST_ARCHIVE_BASIC_SERIALIZER_HPP
#define STREAMS_BOOST_ARCHIVE_BASIC_SERIALIZER_HPP
...
public:
    ...
    const streams_boost::serialization::extended_type_info & get_eti() const {
        return * m_eti;
    }
};
...
#endif // STREAMS_BOOST_ARCHIVE_BASIC_SERIALIZER_HPP
