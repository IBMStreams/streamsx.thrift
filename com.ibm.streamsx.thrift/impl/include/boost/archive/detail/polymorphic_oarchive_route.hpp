#ifndef STREAMS_BOOST_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_ROUTE_HPP
#define STREAMS_BOOST_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_ROUTE_HPP
...
#include <streams_boost/archive/polymorphic_oarchive.hpp>
...
private:
    ...
    virtual void save(const streams_boost::int64_t t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const streams_boost::uint64_t t){
        ArchiveImplementation::save(t);
    }
    #endif
...
#endif // STREAMS_BOOST_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_DISPATCH_HPP
