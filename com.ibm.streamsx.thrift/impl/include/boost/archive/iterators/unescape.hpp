#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_UNESCAPE_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_UNESCAPE_HPP
...
class unescape 
    : public streams_boost::iterator_adaptor<
        ...
        Base, 
        STREAMS_BOOST_DEDUCED_TYPENAME pointee<Base>::type,
...
public:
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME this_t::reference reference;
private:
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_UNESCAPE_HPP
