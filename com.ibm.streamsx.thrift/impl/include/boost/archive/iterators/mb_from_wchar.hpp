#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
...
public:
    ...
    template<class T>
    mb_from_wchar(STREAMS_BOOST_PFTO_WRAPPER(T) start) :
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
