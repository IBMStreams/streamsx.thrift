#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
...
#include <streams_boost/config.hpp> // for STREAMS_BOOST_DEDUCED_TYPENAME & PTFO
...
template<
    ...
    int BitsOut, 
    int BitsIn, 
    class CharType = STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_value<Base>::type // output character
>
    ...
    >
{
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_adaptor<
        transform_width<Base, BitsOut, BitsIn, CharType>,
        Base,
        CharType,
        single_pass_traversal_tag,
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME iterator_value<Base>::type base_value_type;
...
public:
    ...
    template<class T>
    transform_width(STREAMS_BOOST_PFTO_WRAPPER(T) start) : 
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_TRANSFORM_WIDTH_HPP
