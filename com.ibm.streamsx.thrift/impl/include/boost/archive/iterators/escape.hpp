#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
...
class escape : 
    public streams_boost::iterator_adaptor<
        Derived, 
        Base, 
        STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_value<Base>::type
    >
{
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_value<Base>::type base_value_type;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_reference<Base>::type reference_type;
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_ESCAPE_HPP
