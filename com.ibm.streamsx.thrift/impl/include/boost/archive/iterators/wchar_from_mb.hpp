#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
...
public:
    ...
    template<class T>
    wchar_from_mb(STREAMS_BOOST_PFTO_WRAPPER(T) start) : 
...
wchar_t wchar_from_mb<Base>::drain(){
    ...
    if(0 >= result)
        streams_boost::serialization::throw_exception(iterators::dataflow_exception(
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
