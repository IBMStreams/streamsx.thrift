#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
    ...
    >
{
    ...
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_facade<
        istream_iterator<Elem>,
        Elem,
        std::input_iterator_tag,
        Elem
    > super_t;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME std::basic_istream<Elem> istream_type;
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
