#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
...
#include <streams_boost/archive/iterators/escape.hpp>
...
public:
    ...
    template<class T>
    xml_escape(STREAMS_BOOST_PFTO_WRAPPER(T) start) :
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
