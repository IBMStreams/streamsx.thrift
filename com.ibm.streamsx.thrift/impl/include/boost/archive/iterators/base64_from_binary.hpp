#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
...
// template<class Base, class CharType = STREAMS_BOOST_DEDUCED_TYPENAME Base::value_type>
...
template<
    class Base, 
    class CharType = STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::iterator_value<Base>::type
>
    ...
    >
{
    ...
    typedef transform_iterator<
        STREAMS_BOOST_DEDUCED_TYPENAME detail::from_6_bit<CharType>,
        Base
    > super_t;
...
public:
    ...
    template<class T>
    base64_from_binary(STREAMS_BOOST_PFTO_WRAPPER(T) start) :
        super_t(
            Base(STREAMS_BOOST_MAKE_PFTO_WRAPPER(static_cast<T>(start))),
            detail::from_6_bit<CharType>()
        )
    {}
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
