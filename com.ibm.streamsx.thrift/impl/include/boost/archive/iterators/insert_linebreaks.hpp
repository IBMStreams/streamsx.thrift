#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
...
public:
    ...
    template<class T>
    insert_linebreaks(STREAMS_BOOST_PFTO_WRAPPER(T)  start) :
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
