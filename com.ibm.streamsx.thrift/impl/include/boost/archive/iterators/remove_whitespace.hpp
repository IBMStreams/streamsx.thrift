#ifndef STREAMS_BOOST_ARCHIVE_ITERATORS_REMOVE_WHITESPACE_HPP
#define STREAMS_BOOST_ARCHIVE_ITERATORS_REMOVE_WHITESPACE_HPP
...
class remove_whitespace : 
    public filter_iterator<
        remove_whitespace_predicate<STREAMS_BOOST_DEDUCED_TYPENAME Base::value_type>,
        Base
    >
{
    friend class streams_boost::iterator_core_access;
...
//    remove_whitespace(){} // why is this needed?
    ...
    template<class T>
    remove_whitespace(STREAMS_BOOST_PFTO_WRAPPER(T) start) :
...
#endif // STREAMS_BOOST_ARCHIVE_ITERATORS_REMOVE_WHITESPACE_HPP
