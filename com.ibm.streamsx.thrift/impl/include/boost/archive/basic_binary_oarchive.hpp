#ifndef STREAMS_BOOST_ARCHIVE_BASIC_BINARY_OARCHIVE_HPP
#define STREAMS_BOOST_ARCHIVE_BASIC_BINARY_OARCHIVE_HPP
...
public:
    ...
    template<class T>
    void save_override(const T & t, STREAMS_BOOST_PFTO int version){
    ...
    void save_override(const version_type & t, int){
        ...
        assert(t.t <= streams_boost::integer_traits<unsigned char>::const_max);
        const unsigned char x = static_cast<const unsigned char>(t.t);
        * this->This() << x;
    }
    void save_override(const class_id_type & t, int){
        // upto 32K classes
        assert(t.t <= streams_boost::integer_traits<streams_boost::int_least16_t>::const_max);
        const streams_boost::int_least16_t x = static_cast<const streams_boost::int_least16_t>(t.t); 
        * this->This() << x;
    }
    void save_override(const class_id_reference_type & t, int){
        // upto 32K classes
        assert(t.t <= streams_boost::integer_traits<streams_boost::int_least16_t>::const_max);
        const streams_boost::int_least16_t x = t.t;
        * this->This() << x;
    }
    void save_override(const object_id_type & t, int){
        // upto 2G objects
        assert(t.t <= streams_boost::integer_traits<streams_boost::uint_least32_t>::const_max);
        const streams_boost::uint_least32_t x = t.t;
        * this->This() << x;
    }
...
#endif // STREAMS_BOOST_ARCHIVE_BASIC_BINARY_OARCHIVE_HPP
