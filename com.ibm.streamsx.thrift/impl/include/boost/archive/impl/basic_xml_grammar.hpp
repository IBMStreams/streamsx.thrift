#ifndef STREAMS_BOOST_ARCHIVE_BASIC_XML_GRAMMAR_HPP
#define STREAMS_BOOST_ARCHIVE_BASIC_XML_GRAMMAR_HPP
...
#include <streams_boost/spirit/core/non_terminal/rule.hpp>
...
#include <streams_boost/spirit/utility/chset.hpp>
#else
...
private:
    typedef STREAMS_BOOST_DEDUCED_TYPENAME std::basic_istream<CharType> IStream;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME std::basic_string<CharType> StringType;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::spirit::chset<CharType> chset_t;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::spirit::chlit<CharType> chlit_t;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::spirit::scanner<
        STREAMS_BOOST_DEDUCED_TYPENAME  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef STREAMS_BOOST_DEDUCED_TYPENAME streams_boost::spirit::rule<scanner_t> rule_t;
...
#endif // STREAMS_BOOST_ARCHIVE_BASIC_XML_GRAMMAR_HPP
