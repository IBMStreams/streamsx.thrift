#ifndef STREAMS_BOOST_ARCHIVE_XML_OARCHIVE_HPP
#define STREAMS_BOOST_ARCHIVE_XML_OARCHIVE_HPP
...
// required by export
STREAMS_BOOST_SERIALIZATION_REGISTER_ARCHIVE(streams_boost::archive::xml_oarchive)
