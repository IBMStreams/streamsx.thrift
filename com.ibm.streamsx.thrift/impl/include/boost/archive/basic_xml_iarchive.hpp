#ifndef STREAMS_BOOST_ARCHIVE_BASIC_XML_IARCHIVE_HPP
#define STREAMS_BOOST_ARCHIVE_BASIC_XML_IARCHIVE_HPP
...
public:
    ...
    void load_override(T & t,  STREAMS_BOOST_PFTO int)
    {
        ...
        // be serialized.
        STREAMS_BOOST_MPL_ASSERT((serialization::is_wrapper<T>));
...
#endif // STREAMS_BOOST_ARCHIVE_BASIC_XML_IARCHIVE_HPP
